...
fn method_not_found_error() -> jsonrpc::ResponseError {
...
pub trait LanguageServer: Send + Sync + 'static {
    ...
    ) -> jsonrpc::Result<types::InitializeResult> {
        let _ = params;
    ...
    fn initialized(&self, _params: types::InitializedParams) {}
    ...
    fn did_change(&self, _params: types::DidChangeTextDocumentParams) {}
    ...
    fn will_save(&self, _params: types::WillSaveTextDocumentParams) {}
    ...
    ) -> jsonrpc::Result<Option<Vec<types::TextEdit>>> {
        let _ = params;
    ...
    fn did_save(&self, _params: types::DidSaveTextDocumentParams) {}
    ...
    fn did_close(&self, _params: types::DidCloseTextDocumentParams) {}
    ...
    fn notebook_did_open(&self, _params: types::DidOpenNotebookDocumentParams) {}
    ...
    fn notebook_did_change(&self, _params: types::DidChangeNotebookDocumentParams) {}
    ...
    fn notebook_did_save(&self, _params: types::DidSaveNotebookDocumentParams) {}
    ...
    fn notebook_did_close(&self, _params: types::DidCloseNotebookDocumentParams) {}
    ...
    ) -> jsonrpc::Result<Option<types::GotoDefinitionResponse>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::Location>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::CallHierarchyItem>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::CallHierarchyIncomingCall>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::CallHierarchyOutgoingCall>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::TypeHierarchyItem>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::DocumentHighlight>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::DocumentLink>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<types::DocumentLink> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::CodeLens>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn code_lens_resolve(&self, params: types::CodeLens) -> jsonrpc::Result<types::CodeLens> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::FoldingRange>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::SelectionRange>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::DocumentSymbolResponse>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::SemanticTokensResult>> {
        Ok(None)
    }
    ...
    ) -> jsonrpc::Result<Option<types::SemanticTokensFullDeltaResult>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn semantic_tokens_range(
        &self,
        _params: types::SemanticTokensRangeParams,
    ) -> jsonrpc::Result<Option<types::SemanticTokensRangeResult>> {
        Ok(None)
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::InlineValue>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::InlayHint>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ///
    /// This request was introduced in specification version 3.17.0
    fn inlay_hint_resolve(&self, params: types::InlayHint) -> jsonrpc::Result<types::InlayHint> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<Vec<types::Moniker>>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::CompletionResponse>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<types::CompletionItem> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<types::DocumentDiagnosticReportResult> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<types::WorkspaceDiagnosticReportResult> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::SignatureHelp>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::CodeActionResponse>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ///
    /// This request was introduced in specification version 3.16.0.
    fn code_action_resolve(&self, params: types::CodeAction) -> jsonrpc::Result<types::CodeAction> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Vec<types::ColorInformation>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Vec<types::ColorPresentation>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn rename(&self, params: types::RenameParams) -> jsonrpc::Result<Option<types::WorkspaceEdit>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::PrepareRenameResponse>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<Option<types::LinkedEditingRanges>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn symbol(
        ...
        Option<types::OneOf<Vec<types::SymbolInformation>, Vec<types::WorkspaceSymbol>>>,
    > {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    ) -> jsonrpc::Result<types::WorkspaceSymbol> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn did_change_configuration(&self, _params: types::DidChangeConfigurationParams) {}
    ...
    /// notification.
    fn did_change_workspace_folders(&self, _params: types::DidChangeWorkspaceFoldersParams) {}
    ...
    ) -> jsonrpc::Result<Option<types::WorkspaceEdit>> {
        let _ = params;
        Err(method_not_found_error())
    }
    ...
    fn did_create_files(&self, _params: types::CreateFilesParams) {}
    ...
    fn did_rename_files(&self, _params: types::RenameFilesParams) {}
    ...
    fn did_delete_files(&self, _params: types::DeleteFilesParams) {}
    ...
    ) -> jsonrpc::Result<Option<types::LSPAny>> {
        let _ = params;
        Err(method_not_found_error())
    }
}
