...
pub struct LspService<S: LanguageServer> {
    server: Arc<S>,
    outgoing_tx: mpsc::Sender<super::jsonrpc::JsonRpcMessage>,
}
...
impl<S: LanguageServer> LspService<S> {
    ...
    pub(crate) fn sender(&self) -> mpsc::Sender<super::jsonrpc::JsonRpcMessage> {
...
#[derive(Debug)]
pub struct Socket {
    pub(crate) rx: mpsc::Receiver<super::jsonrpc::JsonRpcMessage>,
}
