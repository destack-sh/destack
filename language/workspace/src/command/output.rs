...
use super::inspect::InspectPayload;
use super::manifest::ManifestPayload;
...
command_output!(InspectOutput, InspectPayload);
command_output!(LintOutput, LintPayload);
command_output!(ManifestOutput, ManifestPayload);
