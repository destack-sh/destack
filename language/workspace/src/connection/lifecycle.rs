...
/// Lifecycle state for protocol servers.
#[derive(Debug, Clone)]
...
impl ServerLifecycle {
    ...
    /// Create a new lifecycle handle with explicit activity tracking.
...
impl Default for ServerLifecycle {
    /// Return a default lifecycle handle.
    fn default() -> Self {
...
impl ServerActivity {
    ...
    /// Return true when the server should shut down for idleness.
    pub fn should_shutdown(&self) -> bool {
