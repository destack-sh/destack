...
impl From<EmitFormat> for BuiltinOutputFormat {
    fn from(value: EmitFormat) -> Self {
        match value {
            EmitFormat::Js | EmitFormat::Html => BuiltinOutputFormat::Js,
            EmitFormat::Ts => BuiltinOutputFormat::Ts,
            EmitFormat::Wasm => BuiltinOutputFormat::Wasm,
            EmitFormat::Native => BuiltinOutputFormat::Native,
        }
    }
}
