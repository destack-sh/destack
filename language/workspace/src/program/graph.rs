...
/// Version of a module graph (increments when graphs are invalidated).
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Default, Serialize, Deserialize)]
pub struct ModuleGraphVersion(pub u64);

impl std::fmt::Debug for ModuleGraphVersion {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "v{}", self.0)
    }
}

impl std::fmt::Display for ModuleGraphVersion {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "v{}", self.0)
    }
}

impl ModuleGraphVersion {
    /// Initial version.
    pub const INITIAL: Self = Self(0);

    /// Create a new ModuleGraphVersion.
...
/// A module graph profile and version captured together.
#[derive(Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct ModuleGraphStamp {
    /// The profile id.
    pub profile_id: ProfileId,
    /// The module graph version.
    pub version: ModuleGraphVersion,
}

impl std::fmt::Debug for ModuleGraphStamp {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "{profile}@{version}",
...
impl std::fmt::Display for ModuleGraphStamp {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "{profile}@{version}",
...
impl ModuleGraphStamp {
    /// Create a new ModuleGraphStamp.
    pub fn new(profile_id: ProfileId, version: ModuleGraphVersion) -> Self {
        Self {
            profile_id,
            version,
        }
