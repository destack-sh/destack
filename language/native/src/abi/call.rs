...
pub type Free = unsafe extern "C" fn(context: *mut Context, value: usize) -> RuntimeStatusCode;
...
pub type Unpin = unsafe extern "C" fn(context: *mut Context, value: usize) -> RuntimeStatusCode;
...
pub type Safepoint =
    unsafe extern "C" fn(context: *mut Context, safepoint: u32) -> RuntimeStatusCode;

/// Stop execution for host inspection.
pub type Stop = unsafe extern "C" fn(context: *mut Context, safepoint: u32) -> ExitCode;

/// Deoptimize native execution into interpreter state.
pub type Deopt = unsafe extern "C" fn(context: *mut Context, safepoint: u32) -> ExitCode;

/// Report one native trap.
pub type TrapExit = unsafe extern "C" fn(context: *mut Context, trap: TrapCode) -> ExitCode;

/// Report one payloadless language panic.
pub type Panic = unsafe extern "C" fn(context: *mut Context) -> ExitCode;

/// Copy one typed language panic payload into runtime ownership.
pub type PanicValue =
    unsafe extern "C" fn(context: *mut Context, ty: u32, words: *const u64) -> ExitCode;

/// Continue the active language unwind.
pub type UnwindResume = unsafe extern "C" fn(context: *mut Context) -> ExitCode;
...
pub type CancelWaiter =
    unsafe extern "C" fn(context: *mut Context, waiter: u64, result: *mut u32) -> RuntimeStatusCode;
...
pub type StartTask =
    unsafe extern "C" fn(context: *mut Context, result: *mut u64) -> RuntimeStatusCode;
...
pub type ParkTask =
    unsafe extern "C" fn(context: *mut Context, task: u64, waiter: u64) -> RuntimeStatusCode;

/// Request cooperative cancellation of one task.
pub type CancelTask = unsafe extern "C" fn(context: *mut Context, task: u64) -> RuntimeStatusCode;

/// Query whether cooperative cancellation was requested for one task.
pub type IsTaskCancelled =
    unsafe extern "C" fn(context: *mut Context, task: u64, result: *mut u32) -> RuntimeStatusCode;

/// Detach one task result.
pub type DetachTask = unsafe extern "C" fn(context: *mut Context, task: u64) -> RuntimeStatusCode;
...
pub type PopContext = unsafe extern "C" fn(context: *mut Context, token: u64) -> RuntimeStatusCode;
...
pub type ContextFamily =
    unsafe extern "C" fn(context: *mut Context, family: u32, result: *mut u64) -> RuntimeStatusCode;
