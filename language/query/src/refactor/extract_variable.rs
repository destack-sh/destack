...
impl ModuleQueryContext<'_> {
    ...
    pub fn extract_variable(&self, selection: Span, new_name: &str) -> Option<BatchEdit> {
        ...
        let (expression_id, expression_span) = ctx.resolve_extract_expression(selection)?;
        ...
        let statement_span = ctx.statement_span_for_expression(expression_id, expression_span);
