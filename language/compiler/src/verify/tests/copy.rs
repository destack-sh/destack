...
function twice<T: Copy, 'a>(v0: ref<T, borrowed, 'a, readonly, local>): T {
...
fn test_reject_a_load_of_an_unbounded_parameter_through_a_reference() {
    let mut program = TestProgram::mir(
        r#"
function take<T, 'a>(v0: ref<T, borrowed, 'a, readonly, local>): T {
entry(v0: ref<T, borrowed, 'a, readonly, local>):
    v1: T = load v0
    return v1
}
...
error[move-out-of-reference]: cannot move out through a reference
 ──▶ <test.dsm>:4:5
  │
2 │ function take<T, 'a>(v0: ref<T, borrowed, 'a, readonly, local>): T {
3 │ entry(v0: ref<T, borrowed, 'a, readonly, local>):
4 │     v1: T = load v0
  │     ^^^^^^^^^^^^^^^
5 │     return v1
6 │ }
...
function twice<T: Integer, 'a>(v0: ref<T, borrowed, 'a, readonly, local>): T {
entry(v0: ref<T, borrowed, 'a, readonly, local>):
    v1: T = load v0
    v2: T = load v0
    return v1
...
function twice<T: Copy, 'a>(v0: ref<Slot<T>, borrowed, 'a, readonly, local>): Slot<T> {
entry(v0: ref<Slot<T>, borrowed, 'a, readonly, local>):
    v1: Slot<T> = load v0
    v2: Slot<T> = load v0
    return v1
}
...
function take<T, 'a>(v0: ref<Slot<T>, borrowed, 'a, readonly, local>): Slot<T> {
entry(v0: ref<Slot<T>, borrowed, 'a, readonly, local>):
    v1: Slot<T> = load v0
    return v1
}
...
error[move-out-of-reference]: cannot move out through a reference
  ──▶ <test.dsm>:9:5
   │
 7 │ function take<T, 'a>(v0: ref<Slot<T>, borrowed, 'a, readonly, local>): Slot<T> {
 8 │ entry(v0: ref<Slot<T>, borrowed, 'a, readonly, local>):
 9 │     v1: Slot<T> = load v0
   │     ^^^^^^^^^^^^^^^^^^^^^
10 │     return v1
11 │ }
