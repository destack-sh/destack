...
impl CheckState<'_> {
    ...
    pub(in crate::sema) fn induced_site_types(
        &self,
    ...
    pub(in crate::sema) fn induced_memory_variables(
        &mut self,
        ty: dir::GlobalTypeId,
    ...
    pub(in crate::sema) fn is_lifetime_term(&self, id: dir::GlobalTypeId) -> CompilerResult<bool> {
        match self.ty(id)? {
