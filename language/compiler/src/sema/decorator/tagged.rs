...
use crate::sema::{CheckState, DecoratorApplication, Origin};
...
impl CheckState<'_> {
    ...
    pub(in crate::sema) fn apply_derive_decorators(&mut self) -> CompilerResult<()> {
    ...
    pub(in crate::sema) fn derive_tagged_definitions(&mut self) -> CompilerResult<()> {
    ...
    pub(in crate::sema) fn classify_tagged_newtype(
        &mut self,
        symbol: dir::GlobalSymbolId,
