...
use crate::sema::{BodyState, CheckState, FlowPointId, Origin};
use crate::{CompilerError, CompilerResult};

/// One instantiated tagged owner.
#[derive(Debug, Clone)]
pub(in crate::sema) struct VariantOwner {
    /// The variant owner type.
    pub(in crate::sema) owner: dir::GlobalTypeId,
    /// The variant owner instance.
    pub(in crate::sema) instance: dir::GenericApplication,
}
...
impl CheckState<'_> {
    ...
    pub(in crate::sema) fn tagged_case_key_from_discriminant(
        &self,
        owner: dir::GlobalSymbolId,
        discriminant: dir::ScalarLiteral,
    ...
    pub(in crate::sema) fn tagged_case_key_from_type(
        &mut self,
        owner: dir::GlobalTypeId,
        discriminant: dir::ScalarLiteral,
    ...
    pub(in crate::sema) fn tagged_discriminant_domain(
        &mut self,
