...
fn test_repeated_extension_method_calls_reuse_one_member_decision() {
    ...
    assert_check_stats(
        &source,
        r#"
check.stats.solve.variables=9
check.stats.solve.constraints=0
check.stats.solve.obligations=1000
check.stats.solve.solutions=9
check.stats.solve.bounds=0
check.stats.solve.decisions=3003
check.stats.judges.decided=20
check.stats.judges.replayed=4
check.stats.bindings.built=1
check.stats.bindings.replayed=0
check.stats.members.derived=1
check.stats.members.replayed=999
check.stats.members.refused=0
check.stats.probes.total=2170
check.stats.probes.selections=0
check.stats.probes.extensions=100
check.stats.instantiations=29
check.stats.interns=3255
check.stats.reduces=8258
"#,
    );
}
