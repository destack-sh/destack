...
=== dir ===
declare const shared: &readonly int32;
/// @type.symbol symbol=shared source=shared type=&'static readonly constant int32
/// @resolution.pattern source=shared kind=binding target=shared

const value = *shared;
/// @type.symbol symbol=value source=value type=int32
/// @resolution.pattern source=value kind=binding target=value
/// @resolution.operator source=*shared type=int32 operator="*" kind=builtin operands=[shared as &'static readonly constant int32]
