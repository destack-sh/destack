...
/// @resolution.name source=Negate target=ops.negate.Negate
    ...
    /// @resolution.name source=Charge target=Charge
        ...
        /// @resolution.place source=this placement="local" lifetime=negate.'a access="readonly"
        /// @resolution.access source=this root=this
        /// @resolution.place source=this.value placement="local" lifetime=negate.'a access="readonly"
...
/// @resolution.operator source=-charge type=Charge operator="-" kind=call parameters=() return=Charge kind=symbol target=negate receiver=Charge adjustments=(borrow(&'static readonly Charge))
/// @resolution.name source=charge target=charge
/// @resolution.place source=charge placement="local" lifetime="static" access="readonly"
