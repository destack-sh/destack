...
/// @definition.method symbol=multiply slot=multiply type=<multiply.'a, multiply.P1: Place>(this: Borrowed<Meters, multiply.'a & multiply.P1, "readonly">, Meters) => float64
/// @definition.conformance symbol=<module>#2 member=Output requirement=Multiply.Output
/// @definition.conformance symbol=<module>#2 member=multiply requirement=Multiply.multiply
...
/// @resolution.name source=Meters target=Meters
    ...
    multiply(&readonly this, other: Meters): float64 {
    /// @generic.template symbol=multiply parent=template#0 parameters=('a, P1: Place)
    /// @type.symbol symbol=multiply type=<multiply.'a, multiply.P1: Place>(this: Borrowed<Meters, multiply.'a & multiply.P1, "readonly">, Meters) => float64
    /// @type.symbol symbol=multiply.this source="&readonly this" type=Borrowed<this, multiply.'a & multiply.P1, "readonly">
