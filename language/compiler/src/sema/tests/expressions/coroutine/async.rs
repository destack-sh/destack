...
/// @resolution.call parameters=(^Function<(), int32, "once">) arguments=(supplied as ^Function<(), int32, "once">) return=Promise<int32> kind=symbol target=Promise.create instance=Promise.create<int32>
...
/// @resolution.call parameters=(^Function<(AsyncGeneratorProducer<int32, void, void>,), void, "once">) arguments=(supplied as ^Function<(AsyncGeneratorProducer<int32, void, void>,), void, "once">) return=AsyncGenerator<int32, void, void> kind=symbol target=AsyncGenerator.create instance="AsyncGenerator.create<int32, void, void>"
