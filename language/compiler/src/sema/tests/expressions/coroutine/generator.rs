...
/// @resolution.name source=Generator target=Generator
    ...
    /// @resolution.place source=limit placement="local" lifetime="frame" access="mutable"
    ...
    /// @resolution.access source=value root=count.value
        ...
        yield value;
        /// @resolution.call source="yield value" parameters=(int32) arguments=(provided(value) as int32) return=GeneratorRequest<void, void> regions=("local") kind=symbol target=GeneratorProducer.yield instance="GeneratorProducer.yield<\"local\">"
