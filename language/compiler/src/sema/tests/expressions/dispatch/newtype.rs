...
/// @resolution.name source=T target=T
    ...
    /// @resolution.call parameters=(^Function<(), T#2, "once">) arguments=(supplied as ^Function<(), T#2, "once">) return=Promise<T#2> kind=symbol target=Promise.create instance=Promise.create<T#2>
