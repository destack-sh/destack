...
/// @generic.instance id="memory.type.WithAccess<&'frame FixedArray<int32, 2>, \"exclusive\">" template=memory.type.WithAccess arguments=(&'frame FixedArray<int32, 2>, "exclusive")
