...
/// @resolution.place source=sharedBox.value placement="shared" lifetime="managed" access="mutable"
...
/// @resolution.place source=mixedBox.value placement="shared" lifetime="managed" access="mutable"
