...
/// @type.symbol symbol=grow type=() => void
    ...
    /// @resolution.call source=x1.push(3) parameters=(int64[]) arguments=(rest(provided(3) as int64) pack=arrayFromOwnedSlice as int64) return=isize regions=("frame") kind=symbol target=push receiver=&'frame int64[] instance=Array<int64>.<extension#6>.push
