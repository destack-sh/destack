...
/// @resolution.call source=integers.includes(integer) parameters=(&'static readonly constant int32, isize | undefined) arguments=(provided(integer) as &'static readonly constant int32, omitted as isize | undefined) return=boolean regions=("managed" & "local", "static" & "constant") kind=symbol target=includes receiver=int32[] adjustments=(borrow(Borrowed<int32[], "managed" & "local", "readonly">)) instance=Array<int32>.<extension#6>.includes<int32>
/// @resolution.place source=integers placement="local" lifetime="managed" access="mutable"
...
/// @resolution.call source=floats.includes(float) parameters=(&'static readonly constant float64, isize | undefined) arguments=(provided(float) as &'static readonly constant float64, omitted as isize | undefined) return=boolean regions=("managed" & "local", "static" & "constant") kind=symbol target=includes receiver=float64[] adjustments=(borrow(Borrowed<float64[], "managed" & "local", "readonly">)) instance=Array<float64>.<extension#6>.includes<float64>
/// @resolution.place source=floats placement="local" lifetime="managed" access="mutable"
...
/// @resolution.call source=strings.includes(stringValue) parameters=(Borrowed<string, "managed" & "local", "readonly">, isize | undefined) arguments=(provided(stringValue) as Borrowed<string, "managed" & "local", "readonly">, omitted as isize | undefined) return=boolean regions=("managed" & "local", "managed" & "local") kind=symbol target=includes receiver=string[] adjustments=(borrow(Borrowed<string[], "managed" & "local", "readonly">)) instance=Array<string>.<extension#6>.includes<string>
/// @resolution.place source=strings placement="local" lifetime="managed" access="mutable"
...
/// @resolution.name source=strings target=strings
/// @resolution.member source=strings.includes receiver=string[] type=<includes.Q, includes.'a, includes.'b>(this: &includes.'a readonly string[], &includes.'b readonly includes.Q, isize | undefined?) => boolean kind=symbol target_receiver=string[] target=includes
/// @resolution.call source=strings.includes(stringSlice) parameters=(&'static readonly constant StringSlice, isize | undefined) arguments=(provided(stringSlice) as &'static readonly constant StringSlice, omitted as isize | undefined) return=boolean regions=("managed" & "local", "static" & "constant") kind=symbol target=includes receiver=string[] adjustments=(borrow(Borrowed<string[], "managed" & "local", "readonly">)) instance=Array<string>.<extension#6>.includes<StringSlice>
/// @resolution.place source=strings placement="local" lifetime="managed" access="mutable"
/// @resolution.access source=strings root=strings
...
/// @resolution.call source=stringMap.has(stringSlice) parameters=(&'static readonly constant StringSlice) arguments=(provided(stringSlice) as &'static readonly constant StringSlice) return=boolean regions=("managed" & "local", "static" & "constant") kind=symbol target=has receiver=Map<string, int32> adjustments=(borrow(Borrowed<Map<string, int32>, "managed" & "local", "readonly">)) instance="Map<string, int32>.<extension#8>.has<StringSlice>"
/// @resolution.place source=stringMap placement="local" lifetime="managed" access="mutable"
...
/// @resolution.call source=stringSet.has(stringSlice) parameters=(&'static readonly constant StringSlice) arguments=(provided(stringSlice) as &'static readonly constant StringSlice) return=boolean regions=("managed" & "local", "static" & "constant") kind=symbol target=has receiver=Set<string> adjustments=(borrow(Borrowed<Set<string>, "managed" & "local", "readonly">)) instance=Set<string>.<extension#5>.has<StringSlice>
/// @resolution.place source=stringSet placement="local" lifetime="managed" access="mutable"
