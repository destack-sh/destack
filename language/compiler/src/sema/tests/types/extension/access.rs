...
/// @resolution.name source=Grid target=Grid
    ...
    /// @generic.instance id="view<\"readonly\", \"local\">" template=view arguments=("readonly", "local")
...
/// @resolution.name source=Grid target=Grid
    ...
    /// @generic.instance id="view<\"exclusive\", \"local\">" template=view arguments=("exclusive", "local")
