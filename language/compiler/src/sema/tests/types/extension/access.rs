...
/// @definition.method symbol=peek slot=peek type=<peek.'a>(this: Borrowed<Grid, peek.'a, A>) => int32
/// @definition.method symbol=view slot=view type=<view.'a>(this: Borrowed<Grid, view.'a, A>) => int32
...
/// @resolution.name source=Grid target=Grid
    ...
    /// @type.symbol symbol=view type=<view.'a>(this: Borrowed<Grid, view.'a, A>) => int32
    /// @type.symbol symbol=view.this source="this: WithAccess<&Grid, A>" type=Borrowed<Grid, view.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=Grid target=Grid
    /// @resolution.name source=A target=A

        this.size
        /// @type.node source=this type=Borrowed<Grid, view.'a, A>
    ...
    /// @type.symbol symbol=peek type=<peek.'a>(this: Borrowed<Grid, peek.'a, A>) => int32
    /// @type.symbol symbol=peek.this source="this: WithAccess<&Grid, A>" type=Borrowed<Grid, peek.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=Grid target=Grid
    /// @resolution.name source=A target=A

        this.view()
        /// @type.node source=this type=Borrowed<Grid, peek.'a, A>
        /// @type.node source=this.view type=<view.'a>(this: Borrowed<Grid, view.'a, A>) => int32
        ...
        /// @resolution.call source=this.view() parameters=() return=int32 regions=(peek.'a) kind=symbol target=view receiver=WithAccess<&peek.'a Grid, A> instance=Grid.<extension#1>.view
...
/// @resolution.name source=Grid target=Grid
    ...
    /// @resolution.call source=grid.view() parameters=() return=int32 regions=(read.'a) kind=symbol target=view receiver=&read.'a readonly Grid instance=Grid.<extension#1>.view
...
/// @resolution.name source=Grid target=Grid
    ...
    /// @resolution.member source=grid.view receiver=&write.'a Grid type=<view.'a>(this: WithAccess<&view.'a Grid, "mutable">) => int32 kind=symbol target_receiver=&write.'a Grid target=view
    /// @resolution.call source=grid.view() parameters=() return=int32 regions=(write.'a) kind=symbol target=view receiver=&write.'a Grid instance=Grid.<extension#1>.view
...
/// @definition.method symbol=FixedArrayAccess.inspect slot=inspect type=<FixedArrayAccess.inspect.'a>(this: Borrowed<FixedArray<T, N>, FixedArrayAccess.inspect.'a, A>) => int32
/// @definition.method symbol=FixedArrayAccess.probe slot=probe type=<FixedArrayAccess.probe.'a>(this: Borrowed<FixedArray<T, N>, FixedArrayAccess.probe.'a, A>) => int32
...
/// @resolution.name source=N target=FixedArrayAccess.N
    ...
    /// @type.symbol symbol=FixedArrayAccess.inspect type=<FixedArrayAccess.inspect.'a>(this: Borrowed<FixedArray<T, N>, FixedArrayAccess.inspect.'a, A>) => int32
    /// @type.symbol symbol=FixedArrayAccess.inspect.this source="this: WithAccess<&[T; N], A>" type=Borrowed<FixedArray<T, N>, FixedArrayAccess.inspect.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=T target=FixedArrayAccess.T
    /// @resolution.name source=N target=FixedArrayAccess.N
    ...
    /// @type.symbol symbol=FixedArrayAccess.probe type=<FixedArrayAccess.probe.'a>(this: Borrowed<FixedArray<T, N>, FixedArrayAccess.probe.'a, A>) => int32
    /// @type.symbol symbol=FixedArrayAccess.probe.this source="this: WithAccess<&[T; N], A>" type=Borrowed<FixedArray<T, N>, FixedArrayAccess.probe.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=T target=FixedArrayAccess.T
    /// @resolution.name source=N target=FixedArrayAccess.N
    /// @resolution.name source=A target=FixedArrayAccess.A
        ...
        this.inspect()
        /// @type.node source=this type=Borrowed<FixedArray<T, N>, FixedArrayAccess.probe.'a, A>
        /// @type.node source=this.inspect type=<FixedArrayAccess.inspect.'a>(this: Borrowed<FixedArray<T, N>, FixedArrayAccess.inspect.'a, A>) => int32
        ...
        /// @resolution.call source=this.inspect() parameters=() return=int32 regions=(FixedArrayAccess.probe.'a) kind=symbol target=FixedArrayAccess.inspect receiver=WithAccess<&FixedArrayAccess.probe.'a FixedArray<T, N>, A> instance="FixedArrayAccess<T, N, A>.inspect"
...
/// @definition.method symbol=ArrayAccess.inspect slot=inspect type=<ArrayAccess.inspect.'a>(this: Borrowed<T[], ArrayAccess.inspect.'a, A>) => int32
/// @definition.method symbol=ArrayAccess.probe slot=probe type=<ArrayAccess.probe.'a>(this: Borrowed<T[], ArrayAccess.probe.'a, A>) => int32
...
/// @resolution.name source=T target=ArrayAccess.T
    ...
    /// @type.symbol symbol=ArrayAccess.inspect type=<ArrayAccess.inspect.'a>(this: Borrowed<T[], ArrayAccess.inspect.'a, A>) => int32
    /// @type.symbol symbol=ArrayAccess.inspect.this source="this: WithAccess<&Array<T>, A>" type=Borrowed<T[], ArrayAccess.inspect.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=Array target=Array
    /// @resolution.name source=T target=ArrayAccess.T
    ...
    /// @type.symbol symbol=ArrayAccess.probe type=<ArrayAccess.probe.'a>(this: Borrowed<T[], ArrayAccess.probe.'a, A>) => int32
    /// @type.symbol symbol=ArrayAccess.probe.this source="this: WithAccess<&Array<T>, A>" type=Borrowed<T[], ArrayAccess.probe.'a, A>
    /// @resolution.name source=WithAccess target=WithAccess
    /// @resolution.name source=Array target=Array
    /// @resolution.name source=T target=ArrayAccess.T
    /// @resolution.name source=A target=ArrayAccess.A
        ...
        this.inspect()
        /// @type.node source=this type=Borrowed<T[], ArrayAccess.probe.'a, A>
        /// @type.node source=this.inspect type=<ArrayAccess.inspect.'a>(this: Borrowed<T[], ArrayAccess.inspect.'a, A>) => int32
        /// @type.node source=this.inspect() type=int32
        ...
        /// @resolution.call source=this.inspect() parameters=() return=int32 regions=(ArrayAccess.probe.'a) kind=symbol target=ArrayAccess.inspect receiver=WithAccess<&ArrayAccess.probe.'a T[], A> instance="ArrayAccess<T, A>.inspect"
