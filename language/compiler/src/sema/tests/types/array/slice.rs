...
/// @generic.instance id="Bound<&'frame readonly isize>" template=Bound arguments=(&'frame readonly isize)
/// @generic.instance id="Cast.truncate<isize, usize>" template=Cast.truncate arguments=(isize, usize)
/// @generic.instance id="Cast.truncate<usize, isize>" template=Cast.truncate arguments=(usize, isize)
/// @generic.instance id="endBound#1<Range<isize>, isize>" template=endBound#1 arguments=(isize)
/// @generic.instance id="excluded<&'frame readonly isize>" template=excluded arguments=(&'frame readonly isize)
/// @generic.instance id="included<&'frame readonly isize>" template=included arguments=(&'frame readonly isize)
...
/// @generic.instance id="truncateInt<isize, usize>" template=truncateInt arguments=(isize, usize)
/// @generic.instance id="truncateInt<usize, isize>" template=truncateInt arguments=(usize, isize)
/// @generic.instance id="unbounded<&'frame readonly isize>" template=unbounded arguments=(&'frame readonly isize)
/// @generic.instance id=Slice<float64> template=Slice arguments=(float64)
/// @generic.instance id=size<float64> template=size arguments=(float64)
/// @generic.instance id=sliceLength<float64> template=sliceLength arguments=(float64)
