...
"#,
        r#"
/// @diagnostic.error id=not-assignable message="type '5' is not assignable to type '0..5'"
...
"#,
        r#"
/// @diagnostic.error id=not-assignable message="type '10' is not assignable to type '0..=9'"
