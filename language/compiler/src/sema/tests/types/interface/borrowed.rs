...
/// @definition.implements symbol=<module>#2 source="Add<&readonly Foo>" target="ops.plus.Add<&<module>#2.'a readonly Foo>"
/// @definition.implements symbol=<module>#2 source=Hash target=ops.hash.Hash
...
/// @definition.method symbol=hash#1 slot=hash type=(this: this) => int32
/// @definition.conformance symbol=<module>#2 member=Output#1 requirement=ops.plus.Add.Output
/// @definition.conformance symbol=<module>#2 member=add#1 requirement=ops.plus.Add.add
/// @definition.conformance symbol=<module>#2 member=hash#1 requirement=ops.hash.Hash.hash
...
/// @resolution.name source=Hash target=ops.hash.Hash
    ...
    hash(): int32 {
    /// @type.symbol symbol=hash#1 type=(this: this) => int32
...
/// @definition.implements symbol=<module>#3 source="Add<&readonly Name>" target="ops.plus.Add<&<module>#3.'a readonly Name>"
/// @definition.implements symbol=<module>#3 source=Hash target=ops.hash.Hash
...
/// @definition.method symbol=hash#2 slot=hash type=(this: this) => int32
/// @definition.conformance symbol=<module>#3 member=Output#2 requirement=ops.plus.Add.Output
/// @definition.conformance symbol=<module>#3 member=add#2 requirement=ops.plus.Add.add
/// @definition.conformance symbol=<module>#3 member=hash#2 requirement=ops.hash.Hash.hash
...
/// @resolution.name source=Hash target=ops.hash.Hash
    ...
    /// @resolution.name source=Name target=Name
        ...
        /// @resolution.place source=this placement="local" lifetime=add#2.'a access="readonly"
        /// @resolution.access source=this root=this

    }

    hash(): int32 {
    /// @type.symbol symbol=hash#2 type=(this: this) => int32
...
declare function requireHash<T: Hash>(value: T): T;
/// @generic.template symbol=requireHash parameters=(T: ops.hash.Hash)
/// @type.symbol symbol=requireHash source="declare function requireHash<T: Hash>(value: T): T" type=<T: ops.hash.Hash>(T) => T
