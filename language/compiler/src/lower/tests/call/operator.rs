...
function test.main.Vector.add<'a>(v0: ref<Vector, borrowed, 'a, readonly, local>, v1: Vector): Vector {
entry(v0: ref<Vector, borrowed, 'a, readonly, local>, v1: Vector):
    v2: ref<int32, borrowed, readonly, local> = field.address v0, 0
    v3: int32 = load v2
    v4: int32 = field.get v1, 0
    v5: int32 = add v3, v4
    v6: ref<int32, borrowed, readonly, local> = field.address v0, 1
    v7: int32 = load v6
...
entry:
    ...
    local.set l1, v5
    v6: ref<Vector, borrowed, 'frame, readonly, local> = local.address l0
    v7: Vector = local.get l1
    v8: Vector = call test.main.Vector.add(v6, v7): <'a>(ref<Vector, borrowed, 'a, readonly, local>, Vector) => Vector
    local.set l2, v8
...
function test.main.Charge.negate<'a>(v0: ref<Charge, borrowed, 'a, readonly, local>): Charge {
entry(v0: ref<Charge, borrowed, 'a, readonly, local>):
...
entry:
    ...
    local.set l0, v1
    v2: ref<Charge, borrowed, 'frame, readonly, local> = local.address l0
    v3: Charge = call test.main.Charge.negate(v2): <'a>(ref<Charge, borrowed, 'a, readonly, local>) => Charge
    local.set l1, v3
