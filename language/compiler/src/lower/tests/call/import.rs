...
entry(v0: int32):
    ...
    local.set l0, v1
    v2: ref<test.point.Point, borrowed, 'frame, readonly> = local.address l0
    v3: int32 = call test.point.Point.length(v2): <'a>(ref<test.point.Point, borrowed, 'a, readonly>) => int32
    return v3
}
