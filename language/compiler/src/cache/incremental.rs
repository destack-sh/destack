use destack_source::{DiagnosticSeverity, File};
use std::collections::HashSet;

use destack_workspace::{ModuleGraphKey, ModuleMir, ModuleSignatureKey, TargetId};

use crate::{AnalyzeTask, Compiler, TestFileSystem, TestProgram};
