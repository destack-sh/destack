    ...
    for (_function_id, function) in tree.iter_nodes::<mir::Function>() {
        ...
        for &block_id in function.blocks() {
            ...
            for &instruction_id in &block.instructions {
                ...
                if let mir::Instruction::Release { value: pointer } = instruction
                    && let Some(global_id) =
                        global_addr_base(*pointer, &definitions, addresses, tree)
                {
                    written.insert(global_id);
...
entry:
    v0: ref<int32, borrowed, 'static, mutable, local> = global.address value
    v1: ref<int32, borrowed, 'static, mutable, local> = intrinsic.space.cast(v0)
    v2: int32 = 1
    store v1, v2
    return
}
...
function root<'a>(): ref<int32, borrowed, 'a, mutable, local> {
entry:
    v0: ref<int32, borrowed, 'static, mutable, local> = global.address value
    return v0
}
...
function write<'a>(v0: ref<int32, borrowed, 'a, mutable, local>): void {
...
function root(): void {
entry:
    v1: ref<int32, borrowed, 'static, mutable, local> = global.address value
    invoke write(v1): <'a>(ref<int32, borrowed, 'a, mutable, local>) => void => b1 | b2
