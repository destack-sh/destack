...
declare_pass! {
    ...
    /// b5(v13: uint32):
    ///     v14 = element.address v2, v13 -> ref<int32, raw, space(frame)>
    ///     v15 = 2int32
    ///     store v14, v15
    ///     v16 = int.add v13, v4
    ///     jump b4(v16)
    ...
    ///     v9 = 1int32
    ///     store v8, v9
    ///     v14 = element.address v2, v7 -> ref<int32, raw, space(frame)>
    ///     v15 = 2int32
    ///     store v14, v15
    ///     v10 = int.add v7, v4
    ///     jump b1(v10)
...
fn build_fusion_candidate(
    ...
    if !effects_are_independent(&body_effects, &second_effects, alias) {
        return None;
    }
...
fn apply_fusion(
    ...
    {
        let first_param = first_param.typed_value();
        let second_param = second_param.typed_value();
    ...
    let in_loop_is_then = then_target.block == candidate.first.latch;
...
b2(v7: uint32):
    ...
    v9: int32 = 1
    store v8, v9
    v17: ref<int32, raw, space(frame)> = element.address v2, v7
    v18: int32 = 2
    store v17, v18
    v10: uint32 = int.add v7, v4
    jump b1(v10)
...
b2(v9: uint32, v10: uint32):
    v11: ref<int32, raw, space(frame)> = element.address v1, v9
    store v11, v10
    v20: ref<int32, raw, space(frame)> = element.address v2, v9
    store v20, v10
    v12: uint32 = int.add v9, v4
    jump b1(v12, v10)
