...
declare_pass! {
    ...
    ///     local l1: [int32; 16]
    /// b0(v0: uint32):
    ///     v1: ref<[int32; 16], borrowed, 'frame, mutable, frame> = local.address l0
    ///     v2: ref<[int32; 16], borrowed, 'frame, mutable, frame> = local.address l1
    ///     v3: uint32 = 0
    ///     v4: uint32 = 1
    ///     jump b1(v3)
    /// b1(v5: uint32):
    ...
    ///     branch v6 => b2(v5) | b3
    /// b2(v7: uint32):
    ///     v8: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v7
    ///     v9: int32 = 1
    ///     store v8, v9
    ///     v10: uint32 = add v7, v4
    ///     jump b1(v10)
    /// b3:
    ///     jump b4(v3)
    /// b4(v11: uint32):
    ///     v12: boolean = lt v11, v0
    ///     branch v12 => b5(v11) | b6
    /// b5(v13: uint32):
    ///     v14: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v13
    ///     v15: int32 = 2
    ///     store v14, v15
    ///     v16: uint32 = add v13, v4
    ///     jump b4(v16)
    /// b6:
    ///     return
    /// }
    ...
    ///     v9: int32 = 1
    ///     store v8, v9
    ///     v14: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v7
    ///     v15: int32 = 2
    ///     store v14, v15
    ///     v10: uint32 = add v7, v4
    ///     jump b1(v10)
...
fn build_fusion_candidate(
    ...
    if !latch_is_speculatable(latch, function, tree, accesses, memory) {
        return None;
    }
    ...
    if !block_is_speculatable_no_reads(second_loop.header, function, tree, memory) {
        return None;
    }
...
fn guard_info(
    ...
    // require a strict integer comparison
    match operator {
        mir::BinaryOperator::LessThan | mir::BinaryOperator::GreaterThan => {}
        _ => return None,
    }
    ...
    if matches!(*operator, mir::BinaryOperator::LessThan) && step <= 0 {
        return None;
    }

    // reject greater than guards with non negative steps
    if matches!(*operator, mir::BinaryOperator::GreaterThan) && step >= 0 {
        return None;
    }
...
b2(v7: uint32):
    ...
    v9: int32 = 1
    store v8, v9
    v17: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v7
    v18: int32 = 2
    store v17, v18
    v10: uint32 = add v7, v4
    jump b1(v10)
...
b2(v9: uint32, v10: uint32):
    v11: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v9
    store v11, v10
    v12: uint32 = add v9, v4
    jump b1(v12, v10)
...
b4(v13: uint32, v14: uint32):
    v15: boolean = lt v13, v0
    branch v15 => b5(v13, v14) | b6

b5(v16: uint32, v17: uint32):
    v18: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v16
    store v18, v17
    v19: uint32 = add v16, v4
    jump b4(v19, v17)
...
b2(v9: uint32, v10: uint32):
    v11: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v9
    store v11, v10
    v20: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v9
    store v20, v10
    v12: uint32 = add v9, v4
    jump b1(v12, v10)
...
b2(v6: uint32):
    v7: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v6
    v8: int32 = 1
    store v7, v8
    v9: uint32 = add v6, v3
    jump b1(v9)
...
b5(v12: uint32):
    v13: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v12
    v14: int32 = 2
    store v13, v14
    v15: uint32 = add v12, v3
    jump b4(v15)
...
b4(v12: uint32):
    v13: boolean = lt v12, v0
    branch v13 => b5(v12) | b6

b5(v14: uint32):
    v15: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v14
    v16: int32 = 2
    store v15, v16
...
entry(v0: uint32, v1: uint32):
    v2: ref<[int32; 16], borrowed, 'frame, mutable, frame> = local.address l0
    v3: ref<[int32; 16], borrowed, 'frame, mutable, frame> = local.address l1
    v4: uint32 = 0
    v5: uint32 = 1
    jump b1(v4)
...
b2(v8: uint32):
    v9: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v8
    v10: int32 = 1
    store v9, v10
    v11: uint32 = add v8, v5
    jump b1(v11)
...
b5(v14: uint32):
    v15: ref<int32, borrowed, 'frame, mutable, frame> = element.address v3, v14
    v16: int32 = 2
    store v15, v16
    v17: uint32 = add v14, v5
    jump b4(v17)
...
b2(v10: uint32, v11: uint32):
    v12: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v10
    v13: int32 = 1
    store v12, v13
    v14: uint32 = add v10, v4
    jump b1(v14, v11)
...
b4(v15: uint32, v16: uint32):
    v17: boolean = lt v15, v0
    branch v17 => b5(v15, v16) | b6

b5(v18: uint32, v19: uint32):
    v20: ref<int32, borrowed, 'frame, mutable, frame> = element.address v2, v18
    v21: int32 = 2
    store v20, v21
    v22: uint32 = add v18, v4
    jump b4(v22, v19)
...
b2(v8: uint32):
    v9: ref<int32, borrowed, 'frame, mutable, frame> = element.address v1, v8
    v10: int32 = 1
    store v9, v10
