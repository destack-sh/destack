...
declare_pass! {
    ...
    ///     local l1: [int32; 16]
    /// b0(v0: uint32):
    ///     v1 = local.address l0 -> ref<[int32; 16], borrowed, mutable, frame>
    ///     v2 = local.address l1 -> ref<[int32; 16], borrowed, mutable, frame>
    ///     v3 = 0uint32
    ///     v4 = 1uint32
    ///     jump b1(v3)
    /// b1(v5: uint32):
    ...
    ///     branch v6 => b2(v5) | b3
    /// b2(v7: uint32):
    ///     v8 = element.address v1, v7 -> ref<int32, borrowed, mutable, frame>
    ///     v9 = 1int32
    ///     store v8, v9
    ///     v10 = int.add v7, v4
    ///     jump b1(v10)
    ...
    /// b5(v13: uint32):
    ///     v14 = element.address v2, v13 -> ref<int32, borrowed, mutable, frame>
    ///     v15 = 2int32
    ///     store v14, v15
    ///     v16 = int.add v13, v4
    ///     jump b4(v16)
    ...
    ///     v9 = 1int32
    ///     store v8, v9
    ///     v14 = element.address v2, v7 -> ref<int32, borrowed, mutable, frame>
    ///     v15 = 2int32
    ///     store v14, v15
    ///     v10 = int.add v7, v4
    ///     jump b1(v10)
