...
impl Compiler {
    ...
    pub(in crate::link::script) fn should_bundle_script_dependency(
        &self,
        span: Span,
        package_id: PackageId,
        target_id: &TargetId,
    ...
    /// Collect the bundled static dependency modules for one script module.
    pub(super) fn bundled_static_script_modules(
        &self,
        module_id: ModuleId,
        target: &Target,
        target_id: &TargetId,
    ...
    /// Collect the bundled dynamic dependency modules for one script module.
    pub(super) fn bundled_dynamic_script_modules(
        &self,
        module_id: ModuleId,
        target: &Target,
        target_id: &TargetId,
    ...
    /// Collect the retained external static imports for one script module.
    pub(super) fn retained_static_script_imports(
        &self,
        module_id: ModuleId,
        target: &Target,
        target_id: &TargetId,
    ...
    /// Collect the retained external dynamic imports for one script module.
    pub(super) fn retained_dynamic_script_imports(
        &self,
        module_id: ModuleId,
        target: &Target,
        target_id: &TargetId,
