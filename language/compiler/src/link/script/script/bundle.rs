...
impl Compiler {
    ...
    /// Rewrite one generated script module for bundled output.
    fn rewrite_module(
        &self,
        module_id: ModuleId,
        script: &ScriptOutput,
...
impl Compiler {
    ...
    /// Return the separator inserted before one later linked script part.
    ...
    /// Rewrite one generated script module for target-level bundled output.
