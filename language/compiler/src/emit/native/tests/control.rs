...
#[test]
fn test_emit_native_control_flow() {
...
#[test]
fn test_emit_native_dense_switch() {
    let program = TestProgram::mir(
        r#"
...
/// Emit unreachable control flow as one classified native trap site.
#[test]
fn test_emit_native_unreachable() {
    let program = TestProgram::mir(
        r#"
...
#[test]
fn test_emit_native_overflow_checks() {
    let program = TestProgram::mir(
        r#"
...
entry(v0: int32, v1: int32, v2: uint32, v3: uint32):
    check int.add.overflow.s v0, v1 => b1 | b7

b1:
    check int.sub.overflow.s v0, v1 => b2 | b7

b2:
    check int.mul.overflow.s v0, v1 => b3 | b7

b3:
    check int.add.overflow.u v2, v3 => b4 | b7

b4:
    check int.sub.overflow.u v2, v3 => b5 | b7

b5:
    check int.mul.overflow.u v2, v3 => b6 | b7
