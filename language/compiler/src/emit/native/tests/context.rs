...
#[test]
fn test_emit_native_context_current() {
...
#[test]
fn test_emit_native_context_replace() {
    let program = TestProgram::mir(
        r#"
type Context { }
...
#[test]
fn test_emit_native_context_bind() {
    let program = TestProgram::mir(
        r#"
type Context { }
...
block0(v0: i64, v1: i64, v2: i64, v3: i32):
    ...
    v19 = load.i64 notrap aligned v18+40
...
#[test]
fn test_emit_native_context_get() {
    let program = TestProgram::mir(
        r#"
type Context { }
