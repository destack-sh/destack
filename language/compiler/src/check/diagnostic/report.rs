...
impl CheckState<'_> {
    ...
    pub(in crate::check) fn report_unbounded_interval_type(
        &mut self,
        module: ModuleId,
    ...
    pub(in crate::check) fn report_invalid_interval_domain(
        &mut self,
        module: ModuleId,
        source: dir::LocalNodeIdAny,
    ) {
    ...
    pub(in crate::check) fn report_break_value_outside_loop(
        &mut self,
        module: ModuleId,
        source: dir::LocalNodeIdAny,
    ) {
