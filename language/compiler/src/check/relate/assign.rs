...
impl CheckState<'_> {
    ...
    pub(in crate::check) fn relate_assignable(
        &mut self,
        origin: Origin,
        cause: CauseId,
        relation: Relation,
    ...
    pub(in crate::check) fn relate_dynamic_assignable(
        &mut self,
        origin: Origin,
        cause: CauseId,
        source: dir::GlobalTypeId,
    ...
    pub(in crate::check) fn relate_parameter_bounds(
        &mut self,
        origin: Origin,
        cause: CauseId,
        relation: Relation,
    ...
    pub(in crate::check) fn relate_this_bounds(
        &mut self,
        origin: Origin,
        cause: CauseId,
        relation: Relation,
