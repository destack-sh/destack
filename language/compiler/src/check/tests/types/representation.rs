...
#[test]
fn test_check_records_layout_intrinsic_static_values() {
...
#[test]
fn test_check_records_representation_attributes() {
    let session = TestSession::single(
        r#"
@repr("transparent")
...
#[test]
fn test_check_reports_layout_queries_on_transparent_constraints() {
    let session = TestSession::single(
        r#"
type Writer = {
