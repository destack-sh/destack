...
/// @check.stats.solve variables=1 types=18 constraints=2 obligations=6 solutions=1 bounds=3 decisions=4
"#,
        r#"
"#,
    );
...
/// @check.stats.solve variables=1 types=12 constraints=1 obligations=4 solutions=1 bounds=2 decisions=5
"#,
        r#"
"#,
    );
