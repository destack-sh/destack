...
/// @check.stats.solve variables=8 types=39 constraints=7 obligations=0 solutions=8 bounds=7 decisions=2
"#,
    );
}
...
/// @check.stats.solve variables=7 types=38 constraints=7 obligations=0 solutions=7 bounds=8 decisions=2
"#,
    );
}
