...
/// @resolution.construct source="new Counter()" parameters=() return=Counter kind=class target=Counter constructor=Counter.constructor
...
/// @definition.method symbol=Base.constructor source="constructor(value: int32) {\n        this.value = value;\n    }" slot=constructor role=constructor type=(int32) => Base
    ...
    constructor(value: int32) {
    /// @type.symbol symbol=Base.constructor source="constructor(value: int32) {\n        this.value = value;\n    }" type=(int32) => Base
    /// @type.symbol symbol=value source="value: int32" type=int32
        ...
        /// @resolution.member source=this.value receiver=Base kind=symbol target=Base.value
        /// @resolution.receiver source=this kind=this owner=Base type=Base
...
/// @definition.method symbol=Derived.constructor slot=constructor role=constructor implicit=true type=(int32) => Derived
/// @resolution.name source=Base target=Base

const derived = new Derived(1);
/// @type.symbol symbol=derived source=derived type=Derived
/// @type.node source="new Derived(1)" type=Derived
/// @resolution.construct source="new Derived(1)" parameters=(int32) return=Derived kind=class target=Derived constructor=Derived.constructor
