...
/// @check.stats.solve variables=6 types=88 constraints=1 obligations=2 solutions=6 bounds=3 decisions=4
"#,
    );
}
...
/// @check.stats.solve variables=5 types=85 constraints=1 obligations=2 solutions=5 bounds=3 decisions=4
"#,
    );
}
