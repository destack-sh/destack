...
/// @check.stats.solve variables=13 types=71 constraints=4 obligations=2 solutions=13 bounds=9 decisions=4
"#,
    );
}
...
/// @check.stats.solve variables=13 types=69 constraints=4 obligations=2 solutions=13 bounds=9 decisions=4
"#,
    );
}
