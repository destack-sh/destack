...
/// @definition.method symbol=RegisterBlock.read source="read(): [uint8; this.Width]" slot=read type=(this: RegisterBlock) => FixedArray<uint8, this.Width>

    comptime const Width: usize;
    /// @type.symbol symbol=RegisterBlock.Width source="comptime const Width: usize" type=usize

    read(): [uint8; this.Width];
    /// @type.symbol symbol=RegisterBlock.read source="read(): [uint8; this.Width]" type=(this: RegisterBlock) => FixedArray<uint8, this.Width>
