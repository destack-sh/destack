...
/// @resolution.call source=identity(1) parameters=(1) return=1 kind=symbol target=lib.identity application=lib.identity<1>
...
/// @resolution.name source=identity target=lib.identity
/// @resolution.call source="identity(\"x\")" parameters=("x") return="x" kind=symbol target=lib.identity application="lib.identity<\"x\">"
/// @generic.application source="identity(\"x\")" id="lib.identity<\"x\">"
/// @type.node source="identity(\"x\")" type="x"
/// @type.node source=identity type=<lib.identity.T>(lib.identity.T) => lib.identity.T
/// @type.node source="\"x\"" type="x"
/// @generic.application id="lib.identity<\"x\">" symbol=lib.identity arguments=["x"]
/// @generic.application id=lib.identity<1> symbol=lib.identity arguments=[1]
"#);
}
