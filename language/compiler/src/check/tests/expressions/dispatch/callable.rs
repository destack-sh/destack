...
/// @generic.instance source="Function<(int32,), string>" id="types.function.Function<(int32,), string>"
...
/// @generic.instance id="types.function.Function<(int32,), string>" template=types.function.Function arguments=((int32,), string)
"#,
    );
}
