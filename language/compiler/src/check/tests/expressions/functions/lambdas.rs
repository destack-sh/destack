...
#[test]
fn test_lambda_captures_lexical_binding() {
...
#[test]
fn test_nested_lambda_uses_binding_capture_frame() {
    let session = TestSession::single(
        r#"
let a = 0;
let b = 0;
...
#[test]
fn test_owned_callable_captures_distinguish_binding_captures() {
    let session = TestSession::single(
        r#"
struct Socket {
...
#[test]
fn test_lambda_captures_lexical_this_receiver() {
    let session = TestSession::single(
        r#"
class Counter {
    value: int32;
