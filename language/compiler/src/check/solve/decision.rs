...
impl CheckState<'_> {
    ...
    pub(in crate::check) fn commit_name(
        &mut self,
        node: dir::GlobalNodeIdAny,
    ...
    pub(in crate::check) fn name_decision(
        &self,
        node: dir::GlobalNodeIdAny,
    ...
    pub(in crate::check) fn decision(&self, node: dir::GlobalNodeIdAny) -> Option<&dir::Decision> {
    ...
    pub(in crate::check) fn decisions(&self, module: ModuleId) -> &dir::DecisionSegment {
