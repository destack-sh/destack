use crate::analyze::common::{
    AnalyzeDependencyStage, RelationMode, StaticMemberSymbolKind, TypeRewriteCache,
};
...
use destack_dir::{
    ...
    IfCondition, IfKind, LocalNodeId, LocalTypeId, Member, Mutability, NodeTree, NodeType,
    NormalizationMode, PrimitiveType, Property, Resolution, ScalarLiteral, StaticArgument,
    StaticExpression, StaticKey, StaticParameterKind, StaticProperty, SymbolTable, Type,
    TypeBinaryOperator, TypeLiteral, TypeTable, UnaryOperator,
};
...
impl Compiler {
    ...
    fn static_expression_from_constant_reference_inner(
        ...
        if !visited.insert(symbol) {
            ...
            let is_constant_cycle_candidate = if is_immutable_binding_cycle_candidate {
                true
            } else {
            ...
            let error_type_id = types.insert_type_from_any(Type::Error, node);
