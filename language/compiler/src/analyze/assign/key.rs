...
pub(crate) fn index_key_kind_for_type(key_type: LocalTypeId, types: &TypeTable) -> IndexKeyKind {
...
pub(crate) fn index_key_kind_for_index(
...
pub(crate) fn index_key_kind_for_member(member_key: &StaticKey) -> IndexKeyKind {
    match member_key {
...
pub(crate) fn index_key_kinds_compatible_for_access(
...
pub(crate) fn index_key_kinds_compatible_for_assignability(
    target: IndexKeyKind,
    source: IndexKeyKind,
) -> bool {
    match (target, source) {
...
pub(crate) fn field_key_matches_index_kind(key: &StaticKey, kind: IndexKeyKind) -> bool {
    match kind {
