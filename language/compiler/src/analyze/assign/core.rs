pub(crate) use destack_dir::{
    ...
    ScalarLiteral, StaticArgument, StaticExpression, StaticParameterKind, SymbolTable, SymbolType,
    Type, TypeField, TypeIndexSignature, TypeLiteral, TypeTable, VarianceModifier, WellKnownSymbol,
};
