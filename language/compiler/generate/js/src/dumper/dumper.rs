...
use destack_core::{Color, StringId, StringPool, impl_dump_display, rebuild_tree_output};
...
impl<'a> Dumper<'a> {
    /// Create a new Dumper.
    pub fn new(strings: &'a StringPool, tree: &'a js::Tree, options: DumperOptions) -> Self {
        Self {
            strings,
            tree,
            options,
