...
use tspp_core::{Optional, SectionBuilder, SectionEntry, SectionImage, SectionSlice};
...
impl DropEntry {
    ...
    pub fn destructor(self, storage: Storage) -> Option<FunctionId> {
        match storage {
            ...
            Storage::Heap(Space::Constant) => unreachable!("a program drop in the constant image"),
        }
    }
}
