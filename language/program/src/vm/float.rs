...
impl BinaryFloat {
    ...
    #[inline(always)]
    pub const fn new(format: mir::FloatType, kernel: BinaryFloatKernel) -> Self {
        Self {
    ...
    #[inline(always)]
    pub fn decode(self) -> Result<(mir::FloatType, BinaryFloatKernel)> {
...
impl UnaryFloat {
    ...
    #[inline(always)]
    pub const fn new(format: mir::FloatType, kernel: UnaryFloatKernel) -> Self {
        Self {
            field: float_format_field(format) | (kernel.field() << FLOAT_KERNEL_SHIFT),
        }
    }
    ...
    #[inline(always)]
    pub fn decode(self) -> Result<(mir::FloatType, UnaryFloatKernel)> {
        let format = float_format_from_field(self.field & FLOAT_FORMAT_MASK)?;
