...
pub struct VectorReduce {
    ...
    pub kernel: mir::VectorReduceOperator,
    /// The source element projection.
    pub vector_element: Projection,
    /// The vector element scalar layout.
    pub element_layout: ScalarLayout,
...
pub struct TensorReduce {
    ...
    pub dest_layout: TensorLayoutId,
    /// The reduction kernel.
    pub kernel: mir::TensorReduceOperator,
}
...
pub struct TensorIndexReduce {
    ...
    pub kernel: mir::TensorIndexReduceOperator,
    /// The behavior for equal selected values.
    pub tie_break: mir::TensorIndexTieBreak,
}
...
pub struct TensorScatter {
    ...
    pub element_layout: ScalarLayout,
    /// The scatter kernel.
    pub mode: mir::TensorScatterMode,
}
...
pub struct TensorConvert {
    ...
    pub source_scalar: ScalarLayout,
    /// The destination tensor scalar layout.
    pub dest_scalar: ScalarLayout,
    /// The conversion kernel.
    pub mode: mir::TensorConvertMode,
}
...
pub struct Intrinsic {
    ...
    pub layouts: [ValueShape; INTRINSIC_ARGUMENT_CAPACITY],
    /// The argument count.
    pub layout_count: u8,
}
...
impl Intrinsic {
    ...
    pub fn layouts(&self) -> &[ValueShape] {
