...
impl SideTableBuilder {
    ...
    pub fn push_allocation_site(&mut self, allocation: AllocationSite) -> AllocationSiteId {
    ...
    pub fn push_small_allocation_site(
        &mut self,
    ...
    pub fn push_tensor_dot(&mut self, dimensions: mir::TensorDotDimensionNumbers) -> TensorDotId {
    ...
    pub fn push_tensor_window(&mut self, window: mir::TensorConvolutionWindow) -> TensorWindowId {
...
impl SideTable {
    ...
    #[inline(always)]
    pub fn tensor_dot(&self, id: TensorDotId) -> &mir::TensorDotDimensionNumbers {
    ...
    #[inline(always)]
    pub fn tensor_window(&self, id: TensorWindowId) -> &mir::TensorConvolutionWindow {
        &self.tensor_window[id.0 as usize]
    }

    /// Borrow one tensor gather descriptor.
    #[inline(always)]
    pub fn tensor_gather(&self, id: TensorGatherId) -> &mir::TensorGatherDimensionNumbers {
        &self.tensor_gather[id.0 as usize]
    }

    /// Borrow one tensor scatter descriptor.
    #[inline(always)]
    pub fn tensor_scatter(&self, id: TensorScatterId) -> &mir::TensorScatterDimensionNumbers {
    ...
    #[inline(always)]
    pub fn allocation_site(&self, id: AllocationSiteId) -> &AllocationSite {
        &self.allocation_site[id.0 as usize]
    }

    /// Borrow one pooled small allocation site.
    #[inline(always)]
    pub fn small_allocation_site(&self, id: SmallAllocationSiteId) -> &SmallAllocationSite {
