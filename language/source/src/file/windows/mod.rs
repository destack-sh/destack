...
pub fn strip_windows_prefix(path: PathBuf) -> Result<PathBuf, ResolveError> {
    ...
    let path = if let Some(p) = path_bytes
        .strip_prefix(br"\\?\UNC\")
        .or_else(|| path_bytes.strip_prefix(br"\\.\UNC\"))
    {
        // UNC paths
    ...
    } else if let Some(p) = path_bytes
        .strip_prefix(br"\\?\")
        .or_else(|| path_bytes.strip_prefix(br"\\.\"))
    {
...
fn test_strip_windows_prefix() {
    let pass = [
        ...
        (
            r"C:\Users\user\Documents\file1.txt",
            r"C:\Users\user\Documents\file1.txt",
        ),
        (r"\\?\C:\Users\user\Documents\", r"C:\Users\user\Documents\"),
        (
        ...
        (
            r"\\.\C:\Users\user\Documents\file2.txt",
            r"C:\Users\user\Documents\file2.txt",
        ),
        (
            r"\\?\UNC\server\share\file3.txt",
            r"\\server\share\file3.txt",
        ),
    ];
