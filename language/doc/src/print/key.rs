...
impl Printer<'_, '_, '_> {
    ...
    pub(crate) fn member_name(&self, member: &dir::DefinitionMember) -> DocResult<String> {
        ...
        let name = match member {
            dir::DefinitionMember::Method(method) => match method.slot {
                ...
                dir::MemberSlot::Key(_) => {
                    return Err(DocError::invalid("member key"));
                }
            },
            ...
            _ => return Err(DocError::missing("member name")),
        };
