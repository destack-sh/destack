...
pub const LIB_DECORATORS: BuiltinLib =
    BuiltinLib::language("decorators", &[LIB_ES_DECORATORS_D_TS], &[])
        .ambient()
        .with_declared_symbols(ES5_DECLARED_SYMBOLS);

pub const LIB_DECORATORS_LEGACY: BuiltinLib =
    BuiltinLib::language("decorators.legacy", &[LIB_ES_DECORATORS_LEGACY_D_TS], &[])
        .ambient()
        .with_declared_symbols(ES5_DECLARED_SYMBOLS);
