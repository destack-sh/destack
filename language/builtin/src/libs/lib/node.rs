...
const LIB_NODE_V16_INDEX_D_DS: BuiltinLibSource = BuiltinLibSource::new(
    "lib",
    "node/v16",
    "index.d.ds",
    include_str!(concat!("../../../lib/node/v16/index.d.ds")),
);
...
pub const LIB_NODE: BuiltinLib = BuiltinLib::ambient("node", &[LIB_NODE_V20_INDEX_D_DS], &["esnext"]);
...
pub const LIB_NODE_V16: BuiltinLib =
    BuiltinLib::ambient("node.v16", &[LIB_NODE_V16_INDEX_D_DS], &["esnext"]);
