...
pub const LIB_WORKER: BuiltinLib = BuiltinLib::ambient_lib("worker", &[LIB_WORKER_INDEX_D_DS], &[])
...
pub const LIB_WORKER_ITERABLE: BuiltinLib =
    BuiltinLib::ambient_lib("worker.iterable", &[LIB_WORKER_ITERABLE_D_DS], &[]);
pub const LIB_WEBWORKER_ITERABLE: BuiltinLib =
    BuiltinLib::ambient_lib("webworker.iterable", &[LIB_WORKER_ITERABLE_D_DS], &[]);
