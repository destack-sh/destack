...
use destack_workspace::config::{
    CompilerOptions, DestackOptions, DsPathAliases, builtin_libs_for_type_entries,
    discover_typescript_type_entries, normalize_typescript_lib_names,
    normalize_typescript_type_entries, typescript_default_libs, ModuleDetection, ProfileConfig,
    Target, TsConfig, TsConfigOptions,
};
use destack_workspace::target::{
    EntryResolutionMode, EntrySource, TargetDiscoveryIssue, TargetDiscoveryOptions,
};
use destack_workspace::workspace::{Module, ModuleFormat, Package, ProfileEnv};

use crate::repository::{
    ModuleTsConfigContext, Profile, Repository, RepositoryError,
