...
use destack_workspace::config::{ModuleDetection, SourceType, TsConfig};
use destack_workspace::workspace::{Module, ModuleFormat};
...
impl Repository {
    ...
    fn build_file_at_revision(
        ...
        let file_version = destack_source::FileVersion::INITIAL;
    ...
    pub(crate) fn workspace_path_for_logical_path(&self, logical_path: &str) -> Option<PathBuf> {
        ...
        Some(self.workspace.root.join(logical_path))
    }
