...
`destack_repository` owns repository state and project configuration for the language toolchain.
It is the boundary between source truth and derived toolchain work.

## Repository

`Repository` owns immutable source revisions, file contents, root discovery, package discovery, module discovery, host inputs, and published artifact versions.
...
Repository types should be stable facts about a repository or project configuration.
