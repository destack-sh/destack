...
macro_rules! dispatch_instruction {
    ($machine:ident, $function:ident, $pc:ident, $block_pc:expr, $step:ident, $transfer:ident) => {
        ...
        match instruction.op {
            ...
            Op::DropHeap => $step!(super::execute_drop_heap($machine, instruction)),
            Op::DropSharedHeap => $step!(super::execute_drop_shared_heap($machine, instruction)),
            Op::DropStack => $step!(super::execute_drop_stack($machine, instruction)),
            Op::DropSlice => $step!(super::execute_drop_slice($machine, instruction)),
            Op::DropSharedSlice => $step!(super::execute_drop_shared_slice($machine, instruction)),
