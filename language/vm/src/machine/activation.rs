...
use destack_program::vm::{FunctionCode, Instruction, Op, ProjectionId};
use program::Program;
...
impl<'run> Activation<'run> {
    ...
    pub(crate) fn stop_at(
        ...
        let operation = function
            ...
            .ok_or(Error::invalid_instruction())?;
        let point = program::ProgramPoint::new(function.function.function, operation);
    ...
    pub(crate) fn watch_memory_at(
        ...
        for site in sites {
            ...
            let operation = function
                .operation_at(block, next_pc as u32)
                .ok_or(Error::invalid_instruction())?;
            let resume_point = program::ProgramPoint::new(function.function.function, operation);
            let frame_state = self
                .program
