...
declare_program! {
    ...
    pub(crate) const CALL_PIPELINE_CHAIN,
    name: "call_pipeline_chain",
    source: include_str!("call_pipeline_chain.mir"),
...
fn pipeline_stage1(value: i64, index: i64) -> i64 {
    ...
    let mulled = added.wrapping_mul(3);
...
fn pipeline_stage2(value: i64, index: i64) -> i64 {
    ...
    let added = xored.wrapping_add(5);
...
fn pipeline_stage3(value: i64, index: i64) -> i64 {
    ...
    let added = mulled.wrapping_add(11);
...
fn pipeline_stage5(value: i64, index: i64) -> i64 {
    ...
    let shifted = added.wrapping_shl(1);
...
fn pipeline_stage7(value: i64, index: i64) -> i64 {
    ...
    let added = xored.wrapping_add(23);
