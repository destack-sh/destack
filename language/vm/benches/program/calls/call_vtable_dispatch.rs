...
declare_program! {
    ...
    pub(crate) const CALL_VTABLE_DISPATCH,
    name: "call_vtable_dispatch",
    source: include_str!("call_vtable_dispatch.mir"),
...
fn vtable_method_add(self_value: i64, acc: i64) -> i64 {
    ...
    let bumped = added.wrapping_add(1);
...
fn vtable_method_mul(self_value: i64, acc: i64) -> i64 {
    ...
    let added = mulled.wrapping_add(acc);
...
fn vtable_method_mix(self_value: i64, acc: i64) -> i64 {
    ...
    let added = xored.wrapping_add(7);
