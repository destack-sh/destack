...
pub(crate) enum BenchProfileKind {
...
#[allow(dead_code)]
pub(crate) const fn scale_axis_range(
    name: &'static str,
    arg_index: usize,
    quick: i64,
    standard: i64,
...
impl ScaleAxis {
    ...
    pub(crate) fn value_for(self, profile: BenchProfileKind) -> i64 {
        match profile {
...
impl BenchProfileKind {
    ...
    pub(crate) fn defaults(self) -> BenchProfile {
        match self {
...
impl BenchOptions {
    ...
    pub(crate) fn quick(filter: Option<&[&str]>, tags: Option<&[&str]>) -> Self {
...
#[allow(dead_code)]
pub(crate) fn quick_bench(filter: Option<&[&str]>, tags: Option<&[&str]>) {
...
#[allow(dead_code)]
pub(crate) fn quick_check(filter: Option<Vec<String>>, tags: Option<Vec<String>>) {
