...
use crate::platform::ipc::{
    ...
    UnixReceiveAncillaryReplay, UnixReceiveAncillaryVm,
};
use crate::platform::{
...
struct IpcUnixReceiveReplay {
    /// Replay result payload.
    pub result: Result<UnixReceiveAncillaryReplay, PlatformError>,
}
...
fn destack_ipc_pipe_open_replay(
    ...
    context.replay().run_binding(
        IPC_PIPE_OPEN,
        || unsafe { platform_native::destack_ipc_pipe_open(context, out, flags) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_ipc_pipe_read_replay(
    ...
    context.replay().run_binding(
        IPC_PIPE_READ,
        || unsafe { platform_native::destack_ipc_pipe_read(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_ipc_pipe_write_replay(
    ...
    context.replay().run_binding(
        IPC_PIPE_WRITE,
        || unsafe { platform_native::destack_ipc_pipe_write(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_ipc_shared_memory_open_replay(
    ...
    context.replay().run_binding(
        IPC_SHARED_MEMORY_OPEN,
        || unsafe { platform_native::destack_ipc_shared_memory_open(context, out, name, flags) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_ipc_unix_receive_replay(
    ...
    context.replay().run_binding(
        IPC_UNIX_RECEIVE,
        || unsafe { platform_native::destack_ipc_unix_receive(context, out, socket, maxhandles) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
pub unsafe extern "C" fn destack_ipc_message_queue_close(
    ...
    native_call(|context| {
        ...
        destack_ipc_message_queue_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_ipc_message_queue_receive(
    ...
    native_call(|context| {
        ...
        destack_ipc_message_queue_receive_replay(context, out, handle, timeoutns, buffer)
    })
}
...
pub unsafe extern "C" fn destack_ipc_message_queue_send(
    ...
    native_call(|context| {
        ...
        destack_ipc_message_queue_send_replay(context, handle, priority, timeoutns, payload)
    })
}
...
pub unsafe extern "C" fn destack_ipc_message_queue_unlink(name: NativeStringRef) -> RuntimeStatus {
    native_call(|context| {
        ...
        destack_ipc_message_queue_unlink_replay(context, name)
    })
}
...
pub unsafe extern "C" fn destack_ipc_pipe_close(handle: resource::PipeHandle) -> RuntimeStatus {
    native_call(|context| {
        ...
        destack_ipc_pipe_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_ipc_pipe_open(out: *mut PipePair, flags: u32) -> RuntimeStatus {
    native_call(|context| {
        ...
        destack_ipc_pipe_open_replay(context, out, flags)
    })
}
...
pub unsafe extern "C" fn destack_ipc_pipe_read(
    ...
    native_call(|context| {
        ...
        destack_ipc_pipe_read_replay(context, out, handle, buffer)
    })
}
...
pub unsafe extern "C" fn destack_ipc_pipe_write(
    ...
    native_call(|context| {
        ...
        destack_ipc_pipe_write_replay(context, out, handle, buffer)
    })
}
...
pub unsafe extern "C" fn destack_ipc_shared_memory_close(
    ...
    native_call(|context| {
        ...
        destack_ipc_shared_memory_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_ipc_shared_memory_create(
    ...
    native_call(|context| {
        ...
        destack_ipc_shared_memory_create_replay(context, out, name, size, flags)
    })
}
...
pub unsafe extern "C" fn destack_ipc_shared_memory_map(
    ...
    native_call(|context| {
        ...
        destack_ipc_shared_memory_map_replay(context, out, handle, offset, length, flags)
    })
}
...
pub unsafe extern "C" fn destack_ipc_shared_memory_open(
    ...
    native_call(|context| {
        ...
        destack_ipc_shared_memory_open_replay(context, out, name, flags)
    })
}
...
pub unsafe extern "C" fn destack_ipc_shared_memory_unmap(
    ...
    native_call(|context| {
        ...
        destack_ipc_shared_memory_unmap_replay(context, address, length)
    })
}
...
pub unsafe extern "C" fn destack_ipc_sync_futex_wait(
    ...
    native_call(|context| {
        ...
        destack_ipc_sync_futex_wait_replay(context, sharedmemory, offset, expected, timeoutns)
    })
}
...
pub unsafe extern "C" fn destack_ipc_sync_futex_wake(
    ...
    native_call(|context| {
        ...
        destack_ipc_sync_futex_wake_replay(context, out, sharedmemory, offset, count)
    })
}
...
pub unsafe extern "C" fn destack_ipc_sync_semaphore_create(
    ...
    native_call(|context| {
        ...
        destack_ipc_sync_semaphore_create_replay(context, out, name, initial, flags)
    })
}
...
pub unsafe extern "C" fn destack_ipc_sync_semaphore_post(
    ...
    native_call(|context| {
        ...
        destack_ipc_sync_semaphore_post_replay(context, handle, count)
    })
}
...
pub unsafe extern "C" fn destack_ipc_sync_semaphore_wait(
    ...
    native_call(|context| {
        ...
        destack_ipc_sync_semaphore_wait_replay(context, handle, timeoutns)
    })
}
...
pub unsafe extern "C" fn destack_ipc_unix_receive(
    ...
    native_call(|context| {
        ...
        destack_ipc_unix_receive_replay(context, out, socket, maxhandles)
    })
}
...
pub unsafe extern "C" fn destack_ipc_unix_send(
    ...
    native_call(|context| {
        ...
        destack_ipc_unix_send_replay(context, out, socket, payload, handles)
    })
}
...
fn destack_ipc_message_queue_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_MESSAGE_QUEUE_CLOSE,
        context,
        |context| platform_vm::destack_ipc_message_queue_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_message_queue_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_ipc_message_queue_open(
                runtime,
                context,
                name,
                flags,
...
fn destack_ipc_message_queue_receive_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_ipc_message_queue_receive(
...
fn destack_ipc_message_queue_send_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_ipc_message_queue_send(
...
fn destack_ipc_message_queue_unlink_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_MESSAGE_QUEUE_UNLINK,
        context,
        |context| platform_vm::destack_ipc_message_queue_unlink(runtime, context, name),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_pipe_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_PIPE_CLOSE,
        context,
        |context| platform_vm::destack_ipc_pipe_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_pipe_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_PIPE_OPEN,
        context,
        |context| platform_vm::destack_ipc_pipe_open(runtime, context, flags),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_pipe_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_PIPE_READ,
        context,
        |context| platform_vm::destack_ipc_pipe_read(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_pipe_write_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_PIPE_WRITE,
        context,
        |context| platform_vm::destack_ipc_pipe_write(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_shared_memory_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SHARED_MEMORY_CLOSE,
        context,
        |context| platform_vm::destack_ipc_shared_memory_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_shared_memory_map_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_ipc_shared_memory_map(
...
fn destack_ipc_shared_memory_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SHARED_MEMORY_OPEN,
        context,
        |context| platform_vm::destack_ipc_shared_memory_open(runtime, context, name, flags),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_shared_memory_unmap_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SHARED_MEMORY_UNMAP,
        context,
        |context| platform_vm::destack_ipc_shared_memory_unmap(runtime, context, address, length),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_sync_futex_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_ipc_futex_wait(
                runtime,
                context,
                sharedmemory,
                offset,
...
fn destack_ipc_sync_semaphore_create_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SYNC_SEMAPHORE_CREATE,
        context,
        |context| platform_vm::destack_ipc_semaphore_create(runtime, context, name, initial, flags),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_sync_semaphore_post_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SYNC_SEMAPHORE_POST,
        context,
        |context| platform_vm::destack_ipc_semaphore_post(runtime, context, handle, count),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_sync_semaphore_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_SYNC_SEMAPHORE_WAIT,
        context,
        |context| platform_vm::destack_ipc_semaphore_wait(runtime, context, handle, timeoutns),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_ipc_unix_receive_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_UNIX_RECEIVE,
        context,
        |context| platform_vm::destack_ipc_unix_receive(runtime, context, socket, maxhandles),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_ipc_unix_send_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        IPC_UNIX_SEND,
        context,
        |context| platform_vm::destack_ipc_unix_send(runtime, context, socket, payload, handles),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_message_queue_close_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_message_queue_unlink_vm_replay(runtime, context, name)
                })
                .map_err(Into::into)
            }
        );
    }
    {
        binding!(registry, isolate, IPC_PIPE_CLOSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_pipe_close_vm_replay(runtime, context, handle)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IPC_PIPE_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_pipe_open_vm_replay(runtime, context, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IPC_PIPE_READ, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_pipe_read_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IPC_PIPE_WRITE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_pipe_write_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_shared_memory_close_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_shared_memory_create_vm_replay(runtime, context, name, size, flags)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_shared_memory_open_vm_replay(runtime, context, name, flags)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_shared_memory_unmap_vm_replay(runtime, context, address, length)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_sync_semaphore_post_vm_replay(runtime, context, handle, count)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_ipc_sync_semaphore_wait_vm_replay(runtime, context, handle, timeoutns)
                })
                .map_err(Into::into)
            }
        );
    }
    {
        binding!(registry, isolate, IPC_UNIX_RECEIVE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_unix_receive_vm_replay(runtime, context, socket, maxhandles)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IPC_UNIX_SEND, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_ipc_unix_send_vm_replay(runtime, context, socket, payload, handles)
            })
            .map_err(Into::into)
        });
    }
