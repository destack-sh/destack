...
use crate::platform::ffi::simulation::{native as platform_simulation_native, vm as platform_simulation_vm};
...
pub(crate) const FFI_LIBRARY_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const FFI_LIBRARY_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const FFI_POINTER_ADDRESS: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub(crate) const FFI_POINTER_FROM_ADDRESS: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub(crate) const FFI_SYMBOL_ADDRESS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const FFI_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "ffi",
    bindings: &[
        NativeBinding::new(FFI_CALL_INVOKE, "destack.ffi.call.invoke", destack_ffi_call_invoke as *const ()),
        NativeBinding::new(FFI_LIBRARY_CLOSE, "destack.ffi.library.close", destack_ffi_library_close as *const ()),
        NativeBinding::new(FFI_LIBRARY_OPEN, "destack.ffi.library.open", destack_ffi_library_open as *const ()),
        NativeBinding::new(FFI_POINTER_ADDRESS, "destack.ffi.pointer.address", destack_ffi_pointer_address as *const ()),
        NativeBinding::new(FFI_POINTER_FROM_ADDRESS, "destack.ffi.pointer.fromAddress", destack_ffi_pointer_from_address as *const ()),
        NativeBinding::new(FFI_SYMBOL_ADDRESS, "destack.ffi.symbol.address", destack_ffi_symbol_address as *const ()),
        NativeBinding::new(FFI_SYMBOL_LOOKUP, "destack.ffi.symbol.lookup", destack_ffi_symbol_lookup as *const ()),
    ],
};
...
pub(crate) unsafe extern "C" fn destack_ffi_call_invoke(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_CALL_INVOKE)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_call(context, out, symbol, abi, flags, arguments, resultsize) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_call(context, out, symbol, abi, flags, arguments, resultsize) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_library_close(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_LIBRARY_CLOSE)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_close(context, handle) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_close(context, handle) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_library_open(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_LIBRARY_OPEN)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_open(context, out, path, flags) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_open(context, out, path, flags) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_pointer_address(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_POINTER_ADDRESS)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_address(context, out, pointer) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_address(context, out, pointer) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_pointer_from_address(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_POINTER_FROM_ADDRESS)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_from_address(context, out, address) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_from_address(context, out, address) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_symbol_address(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_SYMBOL_ADDRESS)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_symbol_address(context, out, symbol) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_symbol_address(context, out, symbol) },
            }
        }
    })
}
...
pub(crate) unsafe extern "C" fn destack_ffi_symbol_lookup(
    ...
    native_call(|context| {
        ...
        {
            let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(FFI_SYMBOL_LOOKUP)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_ffi_symbol_lookup(context, out, library, name) },
                RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_ffi_symbol_lookup(context, out, library, name) },
            }
        }
    })
}
...
pub(crate) fn register_ffi_vm_bindings(
...
) {
    {
        binding!(registry, isolate, FFI_CALL_INVOKE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (symbol, abi, flags, arguments, resultsize) = decode_destack_ffi_call_invoke_args(context, args)?;

                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_CALL_INVOKE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_call(binding, context, symbol, abi, flags, arguments, resultsize),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_call(binding, context, symbol, abi, flags, arguments, resultsize),
                        }
                    };
    ...
    {
        binding!(registry, isolate, FFI_LIBRARY_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_LIBRARY_CLOSE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_close(binding, context, handle),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_close(binding, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, FFI_LIBRARY_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_LIBRARY_OPEN)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_open(binding, context, path, flags),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_open(binding, context, path, flags),
                        }
                    };
    ...
    {
        binding!(registry, isolate, FFI_POINTER_ADDRESS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_POINTER_ADDRESS)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_address(binding, context, pointer),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_address(binding, context, pointer),
                        }
                    };
    ...
    {
        binding!(registry, isolate, FFI_POINTER_FROM_ADDRESS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_POINTER_FROM_ADDRESS)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_from_address(binding, context, address),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_from_address(binding, context, address),
                        }
                    };
    ...
    {
        binding!(registry, isolate, FFI_SYMBOL_ADDRESS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_SYMBOL_ADDRESS)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_symbol_address(binding, context, symbol),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_symbol_address(binding, context, symbol),
                        }
                    };
    ...
    {
        binding!(registry, isolate, FFI_SYMBOL_LOOKUP, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                // execute binding
                let result = {
                        let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(FFI_SYMBOL_LOOKUP)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_symbol_lookup(binding, context, library, name),
                            RuntimeWorld::Simulation => platform_simulation_vm::destack_ffi_symbol_lookup(binding, context, library, name),
                        }
                    };
