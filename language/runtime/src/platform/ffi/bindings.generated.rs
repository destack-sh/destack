...
use crate::platform::ffi::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
pub const FFI_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "ffi",
    bindings: &[
        NativeBinding::new(FFI_CALL_CALL, "destack.ffi.call.call", destack_ffi_call_call as *const ()),
...
pub unsafe extern "C" fn destack_ffi_call_call(
    ...
    native_call(|context| {
        ...
        { context.check_policy(FFI_CALL_CALL)?; unsafe { platform_runtime_native::destack_ffi_call(context, out, symbol, abi, flags, arguments, resultsize) } }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_ffi_close(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_ffi_open(context, out, path, flags) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_ffi_pointer_address(
    ...
    native_call(|context| {
        ...
        { context.check_policy(FFI_POINTER_ADDRESS)?; unsafe { platform_runtime_native::destack_ffi_address(context, out, pointer) } }
    })
}
...
pub unsafe extern "C" fn destack_ffi_pointer_from_address(
    ...
    native_call(|context| {
        ...
        { context.check_policy(FFI_POINTER_FROM_ADDRESS)?; unsafe { platform_runtime_native::destack_ffi_from_address(context, out, address) } }
    })
}
...
pub unsafe extern "C" fn destack_ffi_symbol_address(
    ...
    native_call(|context| {
        ...
        { context.check_policy(FFI_SYMBOL_ADDRESS)?; unsafe { platform_runtime_native::destack_ffi_symbol_address(context, out, symbol) } }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_ffi_symbol_lookup(context, out, library, name) },
            }
        }
    })
}
...
) {
    {
        binding!(registry, isolate, FFI_CALL_CALL, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (symbol, abi, flags, arguments, resultsize) = decode_destack_ffi_call_call_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(FFI_CALL_CALL)?; platform_runtime_vm::destack_ffi_call(runtime, context, symbol, abi, flags, arguments, resultsize) };
        ...
        binding!(registry, isolate, FFI_LIBRARY_CLOSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_close(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_ffi_close(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, FFI_LIBRARY_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_open(runtime, context, path, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_ffi_open(runtime, context, path, flags),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, FFI_POINTER_ADDRESS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = { runtime.check_policy(FFI_POINTER_ADDRESS)?; platform_runtime_vm::destack_ffi_address(runtime, context, pointer) };
    ...
    }
    {
        binding!(registry, isolate, FFI_POINTER_FROM_ADDRESS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = { runtime.check_policy(FFI_POINTER_FROM_ADDRESS)?; platform_runtime_vm::destack_ffi_from_address(runtime, context, address) };
    ...
    }
    {
        binding!(registry, isolate, FFI_SYMBOL_ADDRESS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = { runtime.check_policy(FFI_SYMBOL_ADDRESS)?; platform_runtime_vm::destack_ffi_symbol_address(runtime, context, symbol) };
        ...
        binding!(registry, isolate, FFI_SYMBOL_LOOKUP, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_ffi_symbol_lookup(runtime, context, library, name),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_ffi_symbol_lookup(runtime, context, library, name),
                        }
                    };
