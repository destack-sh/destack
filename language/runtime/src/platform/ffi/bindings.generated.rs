...
pub unsafe extern "C" fn destack_ffi_library_close(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_ffi_close(context, handle) }
    })
}
...
pub unsafe extern "C" fn destack_ffi_library_open(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_ffi_open(context, out, path, flags) }
    })
}
...
pub fn register_ffi_vm_bindings(registry: &mut BindingRegistry, isolate: &mut Isolate) {
    {
        binding!(registry, isolate, FFI_CALL_CALL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = platform_vm::destack_ffi_call(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_ffi_close(runtime, context, handle);
    ...
    }
    {
        binding!(registry, isolate, FFI_LIBRARY_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = platform_vm::destack_ffi_open(runtime, context, path, flags);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_ffi_symbol_lookup(runtime, context, library, name);
