...
fn destack_tty_io_read_replay(
    ...
    context.replay().run_binding(
        TTY_IO_READ,
        || unsafe { platform_native::destack_tty_read(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
...
fn destack_tty_io_write_replay(
    ...
    context.replay().run_binding(
        TTY_IO_WRITE,
        || unsafe { platform_native::destack_tty_write(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_tty_mode_get_mode_replay(
    ...
    context.replay().run_binding(
        TTY_MODE_GET_MODE,
        || unsafe { platform_native::destack_tty_get_mode(context, out, handle) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_tty_pty_open_replay(
    ...
    context.replay().run_binding(
        TTY_PTY_OPEN,
        || unsafe { platform_native::destack_tty_pty_open(context, out, rows, columns, flags) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_tty_size_get_size_replay(
    ...
    context.replay().run_binding(
        TTY_SIZE_GET_SIZE,
        || unsafe { platform_native::destack_tty_get_size(context, out, handle) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
pub unsafe extern "C" fn destack_tty_io_read(
    ...
    native_call(|context| {
        ...
        destack_tty_io_read_replay(context, out, handle, buffer)
    })
}
...
pub unsafe extern "C" fn destack_tty_io_write(
    ...
    native_call(|context| {
        ...
        destack_tty_io_write_replay(context, out, handle, buffer)
    })
}
...
pub unsafe extern "C" fn destack_tty_mode_get_mode(
    ...
    native_call(|context| {
        ...
        destack_tty_mode_get_mode_replay(context, out, handle)
    })
}
...
pub unsafe extern "C" fn destack_tty_mode_set_mode(
    ...
    native_call(|context| {
        ...
        destack_tty_mode_set_mode_replay(context, handle, mode)
    })
}
...
pub unsafe extern "C" fn destack_tty_pty_close(handle: resource::PtyHandle) -> RuntimeStatus {
    native_call(|context| {
        ...
        destack_tty_pty_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_tty_pty_open(
    ...
    native_call(|context| {
        ...
        destack_tty_pty_open_replay(context, out, rows, columns, flags)
    })
}
...
pub unsafe extern "C" fn destack_tty_size_get_size(
    ...
    native_call(|context| {
        ...
        destack_tty_size_get_size_replay(context, out, handle)
    })
}
...
pub unsafe extern "C" fn destack_tty_size_set_size(
    ...
    native_call(|context| {
        ...
        destack_tty_size_set_size_replay(context, handle, size)
    })
}
...
fn destack_tty_io_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_IO_READ,
        context,
        |context| platform_vm::destack_tty_read(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
...
fn destack_tty_io_write_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_IO_WRITE,
        context,
        |context| platform_vm::destack_tty_write(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_tty_mode_get_mode_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_MODE_GET_MODE,
        context,
        |context| platform_vm::destack_tty_get_mode(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_tty_mode_set_mode_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_MODE_SET_MODE,
        context,
        |context| platform_vm::destack_tty_set_mode(runtime, context, handle, mode),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_tty_pty_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_PTY_CLOSE,
        context,
        |context| platform_vm::destack_tty_pty_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_tty_pty_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_PTY_OPEN,
        context,
        |context| platform_vm::destack_tty_pty_open(runtime, context, rows, columns, flags),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_tty_size_get_size_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_SIZE_GET_SIZE,
        context,
        |context| platform_vm::destack_tty_get_size(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_tty_size_set_size_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        TTY_SIZE_SET_SIZE,
        context,
        |context| platform_vm::destack_tty_set_size(runtime, context, handle, size),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
pub fn register_tty_vm_bindings(registry: &mut BindingRegistry, isolate: &mut Isolate) {
    {
        binding!(registry, isolate, TTY_IO_READ, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_tty_io_read_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, TTY_IO_WRITE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_tty_io_write_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_tty_mode_get_mode_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_tty_mode_set_mode_vm_replay(runtime, context, handle, mode)
                })
                .map_err(Into::into)
            }
        );
    }
    {
        binding!(registry, isolate, TTY_PTY_CLOSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_tty_pty_close_vm_replay(runtime, context, handle)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, TTY_PTY_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_tty_pty_open_vm_replay(runtime, context, rows, columns, flags)
            })
            .map_err(Into::into)
        });
    }
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_tty_size_get_size_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_tty_size_set_size_vm_replay(runtime, context, handle, size)
                })
                .map_err(Into::into)
            }
        );
