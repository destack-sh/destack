...
use crate::platform::tty::{PtyPair, PtyPairVm, TtyMode, TtyModeVm, TtySize, TtySizeVm, TtyTermiosAttributes, TtyTermiosAttributesVm, TtyTermiosFlowAction, TtyTermiosQueue, TtyTermiosSetAction, TtytermiosattributesReplayRecord};
...
fn encode_destack_tty_mode_get_mode_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.input_flags, 64); let field_1 = vm::Value::uint(value.output_flags, 64); let field_2 = vm::Value::uint(value.control_flags, 64); let field_3 = vm::Value::uint(value.local_flags, 64); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3]) })
}
...
fn encode_destack_tty_pty_open_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.controller.0.0, 64); let field_1 = vm::Value::uint(value.worker.0.0, 64); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn encode_destack_tty_size_get_size_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.rows as u64, 32); let field_1 = vm::Value::uint(value.columns as u64, 32); let field_2 = vm::Value::uint(value.x_pixels as u64, 32); let field_3 = vm::Value::uint(value.y_pixels as u64, 32); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3]) })
}
...
fn decode_destack_tty_termios_flow_args(
    ...
    let action = match action_raw { 1u8 => TtyTermiosFlowAction::SuspendOutput, 2u8 => TtyTermiosFlowAction::ResumeOutput, 3u8 => TtyTermiosFlowAction::SuspendInput, 4u8 => TtyTermiosFlowAction::ResumeInput , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("action", "unknown TtyTermiosFlowAction value")).boxed()), };
    Ok((handle, action))
}
...
fn decode_destack_tty_termios_flush_args(
    ...
    let queue = match queue_raw { 1u8 => TtyTermiosQueue::Input, 2u8 => TtyTermiosQueue::Output, 3u8 => TtyTermiosQueue::InputAndOutput , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("queue", "unknown TtyTermiosQueue value")).boxed()), };
    Ok((handle, queue))
}
...
fn encode_destack_tty_termios_get_attributes_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.input_flags, 64); let field_1 = vm::Value::uint(value.output_flags, 64); let field_2 = vm::Value::uint(value.control_flags, 64); let field_3 = vm::Value::uint(value.local_flags, 64); let field_4 = value.control_characters.to_value(context); let field_5 = vm::Value::uint(value.input_speed_code, 64); let field_6 = vm::Value::uint(value.output_speed_code, 64); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6]) })
}
...
fn decode_destack_tty_termios_set_attributes_args(
    ...
    let action = match action_raw { 1u8 => TtyTermiosSetAction::Now, 2u8 => TtyTermiosSetAction::Drain, 3u8 => TtyTermiosSetAction::Flush , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("action", "unknown TtyTermiosSetAction value")).boxed()), };
...
pub const TTY_HANDLE_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_HANDLE_IS_TERMINAL_FILE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_HANDLE_STDIO_STDERR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_HANDLE_STDIO_STDIN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_HANDLE_STDIO_STDOUT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_MODE_GET_MODE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_MODE_SET_MODE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_SIZE_GET_SIZE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_SIZE_SET_SIZE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TTY_TERMIOS_DRAIN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded_controller = result_value.controller.0;
                let result_recorded_worker = result_value.worker.0;
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_control_characters_item in unsafe { result_value.control_characters.as_slice()? } {
                ...
                let result_recorded = TtyTermiosAttributesValue {
                    input_flags: result_recorded_input_flags,
                    output_flags: result_recorded_output_flags,
                    control_flags: result_recorded_control_flags,
                    local_flags: result_recorded_local_flags,
...
pub unsafe extern "C" fn destack_tty_handle_close(
    handle: resource::TtyHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_tty_pty_close(
    handle: resource::PtyHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_tty_termios_drain(
    handle: resource::TtyHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_control_flags = value.control_flags;
                    let vm_result_local_flags = value.local_flags;
                    let vm_result_control_characters = VmSlice::<u8>::from_bytes(context, &value.control_characters);
...
pub fn register_tty_vm_bindings(
...
pub fn install_tty_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
