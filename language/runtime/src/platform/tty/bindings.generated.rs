...
fn encode_destack_tty_mode_get_mode_result(
    ...
    result
        .map(|value| {
            let field_0: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.input_flags, 64));
            let field_1: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.output_flags, 64));
            let field_2: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.control_flags, 64));
            let field_3: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.local_flags, 64));
...
fn encode_destack_tty_pty_open_result(
    ...
    result
        .map(|value| {
            let field_0: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.controller.0.0, 64));
            let field_1: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.worker.0.0, 64));
            let mut value_builder = context
...
fn encode_destack_tty_size_get_size_result(
    ...
    result
        .map(|value| {
            let field_0: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.rows as u64, 32));
            let field_1: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.columns as u64, 32));
            let field_2: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.x_pixels as u64, 32));
            let field_3: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.y_pixels as u64, 32));
            let mut value_builder = context
...
fn encode_destack_tty_termios_get_attributes_result(
    ...
    result
        .map(|value| {
            ...
            let field_2: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.control_flags, 64));
            let field_3: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.local_flags, 64));
            let field_4: RuntimeResult<vm::Word> = value.control_characters.to_value(context);
            let field_5: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.input_speed_code, 64));
            let field_6: RuntimeResult<vm::Word> = Ok(vm::Word::uint(value.output_speed_code, 64));
            let mut value_builder = context
...
pub(crate) const TTY_HANDLE_CLOSE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_HANDLE_IS_TERMINAL_FILE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_HANDLE_STDIO_STDERR: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_HANDLE_STDIO_STDIN: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_HANDLE_STDIO_STDOUT: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_IO_READ: BindingDescriptor = BindingDescriptor::new(
    "destack.tty.io.read",
...
pub(crate) const TTY_IO_WRITE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_MODE_GET_MODE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_MODE_SET_MODE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_MODE_SET_RAW_MODE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_PTY_CLOSE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_PTY_OPEN: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_SIZE_GET_SIZE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_SIZE_SET_SIZE: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_DRAIN: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_FLOW: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_FLUSH: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_GET_ATTRIBUTES: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_GET_PROCESS_GROUP: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_SEND_BREAK: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_SET_ATTRIBUTES: BindingDescriptor = BindingDescriptor::new(
...
pub(crate) const TTY_TERMIOS_SET_PROCESS_GROUP: BindingDescriptor = BindingDescriptor::new(
