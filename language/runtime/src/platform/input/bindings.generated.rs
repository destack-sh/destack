...
use crate::platform::input::{InputDeviceInfo, InputDeviceInfoReplayRecord, InputDeviceInfoVm, InputDeviceKind, InputEvent, InputEventVm};
...
use crate::platform::input::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
pub const INPUT_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    ...
    bindings: &[
        ...
        NativeBinding::new(INPUT_EVENT_SET_GRAB, "destack.input.event.setGrab", destack_input_event_set_grab as *const ()),
...
fn destack_input_device_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_input_device_list_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_list(context, out) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_input_device_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_open(context, out, id) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_input_event_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_read(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_input_event_set_grab_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_input_set_grab(context, handle, enable) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_set_grab(context, handle, enable) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_input_event_try_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_input_try_read(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_list(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_kind_raw = decode_uint8(slots[2], "result_recorded_item_kind_raw", "kind")?;
                        ...
                        let result_recorded_item_vendor_id = decode_uint16(slots[3], "result_recorded_item_vendor_id", "vendorId")?;
                        let result_recorded_item_product_id = decode_uint16(slots[4], "result_recorded_item_product_id", "productId")?;
                        let result_recorded_item_connected = decode_bool(slots[5], "result_recorded_item_connected", "connected")?;
                        InputDeviceInfoVm {
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_open(runtime, context, id),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_read(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_input_event_set_grab_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_input_set_grab(runtime, context, handle, enable),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_set_grab(runtime, context, handle, enable),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_input_try_read(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_input_vm_bindings(
    ...
    {
        binding!(registry, isolate, INPUT_EVENT_SET_GRAB, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
