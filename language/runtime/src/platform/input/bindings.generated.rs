...
use crate::platform::input::{InputAxisMetadata, InputAxisMetadataVm, InputButtonMetadata, InputButtonMetadataVm, InputCapabilityMetadataFidelity, InputCapabilityMetadataOrigin, InputCompositionEvent, InputCompositionEventPayload, InputCompositionEventPayloadValue, InputCompositionEventPayloadVm, InputCompositionEventValue, InputCompositionEventVm, InputDeviceCapabilities, InputDeviceCapabilitiesValue, InputDeviceCapabilitiesVm, InputDeviceCapabilityKind, InputDeviceDescriptor, InputDeviceDescriptorValue, InputDeviceDescriptorVm, InputDeviceEvent, InputDeviceEventPayload, InputDeviceEventPayloadVm, InputDeviceEventValue, InputDeviceEventVm, InputDeviceKind, InputEvent, InputEventAction, InputEventMetadata, InputEventMetadataValue, InputEventMetadataVm, InputEventValue, InputEventVm, InputGamepadBatteryState, InputGamepadBatteryStatus, InputGamepadBatteryStatusVm, InputGamepadButtonState, InputGamepadButtonStateVm, InputGamepadConnectionType, InputGamepadEvent, InputGamepadEventPayload, InputGamepadEventPayloadVm, InputGamepadEventValue, InputGamepadEventVm, InputGamepadMappingType, InputGamepadState, InputGamepadStateValue, InputGamepadStateVm, InputGamepadTouchState, InputGamepadTouchStateVm, InputHapticEffectParameters, InputHapticEffectParametersVm, InputHapticEffectType, InputHapticsResult, InputKeyEvent, InputKeyEventPayload, InputKeyEventPayloadVm, InputKeyEventValue, InputKeyEventVm, InputKeyboardState, InputKeyboardStateValue, InputKeyboardStateVm, InputMonitorChangeEvent, InputMonitorChangeEventValue, InputMonitorChangeEventVm, InputMonitorConnectEvent, InputMonitorConnectEventValue, InputMonitorConnectEventVm, InputMonitorDisconnectEvent, InputMonitorDisconnectEventValue, InputMonitorDisconnectEventVm, InputMonitorEvent, InputMonitorEventMetadata, InputMonitorEventMetadataValue, InputMonitorEventMetadataVm, InputMonitorEventValue, InputMonitorEventVm, InputPenState, InputPenStateVm, InputPointerButtonEvent, InputPointerButtonEventPayload, InputPointerButtonEventPayloadVm, InputPointerButtonEventValue, InputPointerButtonEventVm, InputPointerGrabMode, InputPointerMotionEvent, InputPointerMotionEventPayload, InputPointerMotionEventPayloadVm, InputPointerMotionEventValue, InputPointerMotionEventVm, InputPointerState, InputPointerStateVm, InputRawHidReport, InputRawHidReportValue, InputRawHidReportVm, InputReadMode, InputScrollEvent, InputScrollEventPayload, InputScrollEventPayloadVm, InputScrollEventValue, InputScrollEventVm, InputSensorConfig, InputSensorConfigVm, InputSensorDescriptor, InputSensorDescriptorVm, InputSensorEffectiveConfig, InputSensorEffectiveConfigVm, InputSensorEvent, InputSensorEventPayload, InputSensorEventPayloadVm, InputSensorEventValue, InputSensorEventVm, InputSensorKind, InputSensorSample, InputSensorSampleVm, InputTextEvent, InputTextEventPayload, InputTextEventPayloadValue, InputTextEventPayloadVm, InputTextEventValue, InputTextEventVm, InputTextInputArea, InputTextInputAreaVm, InputTextInputType, InputTouchContactPhase, InputTouchContactState, InputTouchContactStateVm, InputTouchEvent, InputTouchEventPayload, InputTouchEventPayloadVm, InputTouchEventValue, InputTouchEventVm, InputTouchState, InputTouchStateValue, InputTouchStateVm, InputWindowTarget, InputWindowTargetVm, InputcompositioneventReplayRecord, InputcompositioneventpayloadReplayRecord, InputdevicecapabilitiesReplayRecord, InputdevicedescriptorReplayRecord, InputdeviceeventReplayRecord, InputeventReplayRecord, InputeventmetadataReplayRecord, InputgamepadeventReplayRecord, InputgamepadstateReplayRecord, InputkeyboardstateReplayRecord, InputkeyeventReplayRecord, InputmonitorchangeeventReplayRecord, InputmonitorconnecteventReplayRecord, InputmonitordisconnecteventReplayRecord, InputmonitoreventReplayRecord, InputmonitoreventmetadataReplayRecord, InputpointerbuttoneventReplayRecord, InputpointermotioneventReplayRecord, InputrawhidreportReplayRecord, InputscrolleventReplayRecord, InputsensoreventReplayRecord, InputtexteventReplayRecord, InputtexteventpayloadReplayRecord, InputtoucheventReplayRecord, InputtouchstateReplayRecord};
...
fn encode_destack_input_device_capabilities_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = value.kinds.to_value(context); let field_1: RuntimeResult<vm::Value> = value.axes.to_value(context); let field_2: RuntimeResult<vm::Value> = value.buttons.to_value(context); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata_origin as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.axis_metadata_fidelity as i32 as i64, 32)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.button_metadata_fidelity as i32 as i64, 32)); let field_6: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_relative_pointer)); let field_7: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_pointer_grab)); let field_8: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_pointer_capture)); let field_9: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_pointer_warp)); let field_10: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_text_input)); let field_11: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_composition)); let field_12: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_rumble)); let field_13: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_trigger_rumble)); let field_14: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_sensors)); let field_15: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_battery_state)); let field_16: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_light_control)); let field_17: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_raw_hid)); let field_18: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_player_index)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?, field_7?, field_8?, field_9?, field_10?, field_11?, field_12?, field_13?, field_14?, field_15?, field_16?, field_17?, field_18?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_input_event_monitor_read_result(
    ...
    result.and_then(|value| match value { InputMonitorEventVm::InputMonitorChangeEvent(value) => { let tag_value = vm::Value::uint(3150676780u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.device_kind as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.metadata.connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputMonitorEventVm::InputMonitorConnectEvent(value) => { let tag_value = vm::Value::uint(1147506405u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.device_kind as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.metadata.connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputMonitorEventVm::InputMonitorDisconnectEvent(value) => { let tag_value = vm::Value::uint(1352806727u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.device_kind as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.metadata.connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) } })
}
...
fn encode_destack_input_event_read_result(
    ...
    result.and_then(|value| match value { InputEventVm::InputCompositionEvent(value) => { let tag_value = vm::Value::uint(1953975626u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.payload.text.value()); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.selection_start as i64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.selection_end as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputDeviceEvent(value) => { let tag_value = vm::Value::uint(1711088174u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_code as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.backend_value, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputGamepadEvent(value) => { let tag_value = vm::Value::uint(4057440654u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_code as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.backend_value, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputKeyEvent(value) => { let tag_value = vm::Value::uint(2680346764u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_code as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_scan_code as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.backend_value, 64)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.modifiers as u64, 32)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.payload.repeat)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputPointerButtonEvent(value) => { let tag_value = vm::Value::uint(4073494792u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_code as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.backend_value, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.x)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.y)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.modifiers as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputPointerMotionEvent(value) => { let tag_value = vm::Value::uint(2712240874u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.x)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.y)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.buttons as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.modifiers as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputScrollEvent(value) => { let tag_value = vm::Value::uint(4279710721u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.wheel_x)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.wheel_y)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.x)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.y)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.modifiers as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputSensorEvent(value) => { let tag_value = vm::Value::uint(1143015131u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.backend_code as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.backend_value, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.x)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.y)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.z)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputTextEvent(value) => { let tag_value = vm::Value::uint(2362503160u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(value.payload.text.value()); context.allocate_aggregate(vec![field_0?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, InputEventVm::InputTouchEvent(value) => { let tag_value = vm::Value::uint(1845998728u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.contact_id as u64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.x)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.y)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.payload.pressure)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) } })
}
...
fn decode_destack_input_event_set_read_mode_args(
    ...
    let mode = match mode_raw { 1i32 => InputReadMode::Cooked, 2i32 => InputReadMode::Raw , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("mode", "unknown InputReadMode value")).boxed()), };
    Ok((handle, mode))
}
...
fn encode_destack_input_gamepad_state_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.connected)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.mapping as i32 as i64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.connection_type as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.player_index as u64, 8)); let field_5: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.battery.state as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.battery.level)); context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }; let field_6: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_rumble)); let field_7: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.supports_trigger_rumble)); let field_8: RuntimeResult<vm::Value> = value.axes.to_value(context); let field_9: RuntimeResult<vm::Value> = value.buttons.to_value(context); let field_10: RuntimeResult<vm::Value> = value.touches.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?, field_7?, field_8?, field_9?, field_10?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_input_haptics_play_args(
    ...
    let effect = match effect_raw { 1i32 => InputHapticEffectType::DualRumble, 2i32 => InputHapticEffectType::TriggerRumble , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("effect", "unknown InputHapticEffectType value")).boxed()), };
...
fn encode_destack_input_keyboard_state_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.device_id.value()); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.modifiers as u64, 32)); let field_4: RuntimeResult<vm::Value> = value.pressed_codes.to_value(context); let field_5: RuntimeResult<vm::Value> = value.pressed_scan_codes.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_input_pointer_relative_state_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.x)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.y)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.buttons as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.modifiers as u64, 32)); let field_4: RuntimeResult<vm::Value> = match value.pen { Some(value) => { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.pressure)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.tangential_pressure)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.tilt_x)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.tilt_y)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.twist)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.in_contact)); let field_6: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.in_range)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?]).map_err(Box::<RuntimeError>::from) }, None => Ok(vm::Value::VOID) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_input_pointer_set_grab_mode_args(
    ...
    let mode = match mode_raw { 0i32 => InputPointerGrabMode::None, 1i32 => InputPointerGrabMode::Confined, 2i32 => InputPointerGrabMode::Locked , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("mode", "unknown InputPointerGrabMode value")).boxed()), };
...
fn encode_destack_input_rawhid_read_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.report_id as u64, 8)); let field_3: RuntimeResult<vm::Value> = value.data.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_input_sensor_configure_args(
    ...
    let kind = match kind_raw { 1i32 => InputSensorKind::Accelerometer, 2i32 => InputSensorKind::Gyroscope, 3i32 => InputSensorKind::Magnetometer, 4i32 => InputSensorKind::Gravity, 5i32 => InputSensorKind::LinearAcceleration, 6i32 => InputSensorKind::Orientation, 7i32 => InputSensorKind::Barometer, 8i32 => InputSensorKind::AmbientLight, 9i32 => InputSensorKind::Proximity, 10i32 => InputSensorKind::StepCounter , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("kind", "unknown InputSensorKind value")).boxed()), };
...
fn encode_destack_input_sensor_configure_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.enabled)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.sample_rate_hz)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.batch_latency_ms as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.flags as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_input_sensor_read_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.kind as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.timestamp_ns, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.x)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.y)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.z)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.w)); let field_6: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.flags as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_input_text_get_area_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.x as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.y as i64, 32)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.width as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.height as u64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.cursor as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_input_text_read_composition_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.metadata.device_id.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.action as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.payload.text.value()); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.selection_start as i64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.selection_end as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_input_text_start_args(
    ...
    let inputtype = match inputtype_raw { 0i32 => InputTextInputType::Text, 1i32 => InputTextInputType::Number, 2i32 => InputTextInputType::Email, 3i32 => InputTextInputType::Url, 4i32 => InputTextInputType::Password, 5i32 => InputTextInputType::Phone , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("inputtype", "unknown InputTextInputType value")).boxed()), };
...
fn encode_destack_input_touch_state_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(value.device_id.value()); let field_3: RuntimeResult<vm::Value> = value.contacts.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) })
}
...
pub(crate) const INPUT_DEVICE_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_DEVICE_LIST: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_DEVICE_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_EVENT_MONITOR_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_EVENT_MONITOR_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_EVENT_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_EVENT_TRY_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_HAPTICS_STOP: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const INPUT_TEXT_IS_ACTIVE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_kinds_item in unsafe { result_value.kinds.as_slice()? }.iter().cloned() {
                ...
                for result_recorded_axes_item in unsafe { result_value.axes.as_slice()? }.iter().cloned() {
                ...
                for result_recorded_buttons_item in unsafe { result_value.buttons.as_slice()? }.iter().cloned() {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    let mut value_native_kinds_values = Vec::new();
                    for value_native_kinds_item in value.kinds.iter().cloned() {
                        let value_native_kinds_decoded = value_native_kinds_item;
                        value_native_kinds_values.push(value_native_kinds_decoded);
                    }
                    let value_native_kinds = binding.store_array(value_native_kinds_values);
                    let mut value_native_axes_values = Vec::new();
                    for value_native_axes_item in value.axes.iter().cloned() {
                        let value_native_axes_decoded_code = value_native_axes_item.code;
                        let value_native_axes_decoded_minimum = value_native_axes_item.minimum;
                        let value_native_axes_decoded_maximum = value_native_axes_item.maximum;
                        let value_native_axes_decoded_flat = value_native_axes_item.flat;
                        let value_native_axes_decoded_fuzz = value_native_axes_item.fuzz;
                        let value_native_axes_decoded_resolution = value_native_axes_item.resolution;
                        let value_native_axes_decoded = InputAxisMetadata {
                            code: value_native_axes_decoded_code,
                            minimum: value_native_axes_decoded_minimum,
                            maximum: value_native_axes_decoded_maximum,
                            flat: value_native_axes_decoded_flat,
                            fuzz: value_native_axes_decoded_fuzz,
                            resolution: value_native_axes_decoded_resolution,
                        };
                        value_native_axes_values.push(value_native_axes_decoded);
                    }
                    let value_native_axes = binding.store_array(value_native_axes_values);
                    let mut value_native_buttons_values = Vec::new();
                    for value_native_buttons_item in value.buttons.iter().cloned() {
                        let value_native_buttons_decoded_code = value_native_buttons_item.code;
                        let value_native_buttons_decoded_analog = value_native_buttons_item.analog;
                        let value_native_buttons_decoded = InputButtonMetadata {
                            code: value_native_buttons_decoded_code,
                            analog: value_native_buttons_decoded_analog,
                        };
                        value_native_buttons_values.push(value_native_buttons_decoded);
                    }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        ...
                        let value_native_decoded_instance_id = binding.store_string(value_native_item.instance_id.as_str());
                        let value_native_decoded_hardware_id = binding.store_string(value_native_item.hardware_id.as_str());
                        let value_native_decoded_name = binding.store_string(value_native_item.name.as_str());
                        let value_native_decoded_transport = binding.store_string(value_native_item.transport.as_str());
                        let value_native_decoded_kind = value_native_item.kind;
                        let value_native_decoded_vendor_id = value_native_item.vendor_id;
                        let value_native_decoded_product_id = value_native_item.product_id;
                        let value_native_decoded_key_count = value_native_item.key_count;
                        let value_native_decoded_button_count = value_native_item.button_count;
                        let value_native_decoded_axis_count = value_native_item.axis_count;
                        let value_native_decoded_connected = value_native_item.connected;
                        let value_native_decoded_supports_exclusive_grab = value_native_item.supports_exclusive_grab;
                        let value_native_decoded_supports_raw = value_native_item.supports_raw;
                        let value_native_decoded_supports_text = value_native_item.supports_text;
                        let value_native_decoded_supports_rumble = value_native_item.supports_rumble;
                        let value_native_decoded_supports_battery = value_native_item.supports_battery;
                        let value_native_decoded_supports_light = value_native_item.supports_light;
                        let value_native_decoded_supports_raw_hid = value_native_item.supports_raw_hid;
                        let value_native_decoded_is_virtual = value_native_item.is_virtual;
                        let value_native_decoded_is_system = value_native_item.is_system;
                        let value_native_decoded = InputDeviceDescriptor {
                            id: value_native_decoded_id,
                            instance_id: value_native_decoded_instance_id,
                            hardware_id: value_native_decoded_hardware_id,
                            ...
                            product_id: value_native_decoded_product_id,
                            key_count: value_native_decoded_key_count,
                            button_count: value_native_decoded_button_count,
                            axis_count: value_native_decoded_axis_count,
                            connected: value_native_decoded_connected,
                            supports_exclusive_grab: value_native_decoded_supports_exclusive_grab,
                            supports_raw: value_native_decoded_supports_raw,
                            supports_text: value_native_decoded_supports_text,
                            supports_rumble: value_native_decoded_supports_rumble,
                            supports_battery: value_native_decoded_supports_battery,
                            supports_light: value_native_decoded_supports_light,
                            supports_raw_hid: value_native_decoded_supports_raw_hid,
                            is_virtual: value_native_decoded_is_virtual,
                            is_system: value_native_decoded_is_system,
                        };
                ...
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        let value_native_decoded = match value_native_item {
                            InputeventReplayRecord::InputCompositionEvent(value) => {
                                let value_native_decoded_input_composition_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_composition_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_composition_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_composition_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_composition_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_composition_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_composition_event_metadata_sequence,
                                    device_id: value_native_decoded_input_composition_event_metadata_device_id,
                                };
                                let value_native_decoded_input_composition_event_payload_action = value.payload.action;
                                let value_native_decoded_input_composition_event_payload_text = binding.store_string(value.payload.text.as_str());
                                let value_native_decoded_input_composition_event_payload_selection_start = value.payload.selection_start;
                                let value_native_decoded_input_composition_event_payload_selection_end = value.payload.selection_end;
                                let value_native_decoded_input_composition_event_payload = InputCompositionEventPayload {
                                    action: value_native_decoded_input_composition_event_payload_action,
                                    text: value_native_decoded_input_composition_event_payload_text,
                                    selection_start: value_native_decoded_input_composition_event_payload_selection_start,
                                    selection_end: value_native_decoded_input_composition_event_payload_selection_end,
                                };
                                let value_native_decoded_input_composition_event = InputCompositionEvent {
                                    kind: value_native_decoded_input_composition_event_kind,
                                    metadata: value_native_decoded_input_composition_event_metadata,
                                    payload: value_native_decoded_input_composition_event_payload,
                                };
                                InputEvent::InputCompositionEvent(value_native_decoded_input_composition_event)
                            }
                            InputeventReplayRecord::InputDeviceEvent(value) => {
                                let value_native_decoded_input_device_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_device_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_device_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_device_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_device_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_device_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_device_event_metadata_sequence,
                                    device_id: value_native_decoded_input_device_event_metadata_device_id,
                                };
                                let value_native_decoded_input_device_event_payload_action = value.payload.action;
                                let value_native_decoded_input_device_event_payload_backend_code = value.payload.backend_code;
                                let value_native_decoded_input_device_event_payload_backend_value = value.payload.backend_value;
                                let value_native_decoded_input_device_event_payload = InputDeviceEventPayload {
                                    action: value_native_decoded_input_device_event_payload_action,
                                    backend_code: value_native_decoded_input_device_event_payload_backend_code,
                                    backend_value: value_native_decoded_input_device_event_payload_backend_value,
                                };
                                let value_native_decoded_input_device_event = InputDeviceEvent {
                                    kind: value_native_decoded_input_device_event_kind,
                                    metadata: value_native_decoded_input_device_event_metadata,
                                    payload: value_native_decoded_input_device_event_payload,
                                };
                                InputEvent::InputDeviceEvent(value_native_decoded_input_device_event)
                            }
                            InputeventReplayRecord::InputGamepadEvent(value) => {
                                let value_native_decoded_input_gamepad_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_gamepad_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_gamepad_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_gamepad_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_gamepad_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_gamepad_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_gamepad_event_metadata_sequence,
                                    device_id: value_native_decoded_input_gamepad_event_metadata_device_id,
                                };
                                let value_native_decoded_input_gamepad_event_payload_action = value.payload.action;
                                let value_native_decoded_input_gamepad_event_payload_backend_code = value.payload.backend_code;
                                let value_native_decoded_input_gamepad_event_payload_backend_value = value.payload.backend_value;
                                let value_native_decoded_input_gamepad_event_payload = InputGamepadEventPayload {
                                    action: value_native_decoded_input_gamepad_event_payload_action,
                                    backend_code: value_native_decoded_input_gamepad_event_payload_backend_code,
                                    backend_value: value_native_decoded_input_gamepad_event_payload_backend_value,
                                };
                                let value_native_decoded_input_gamepad_event = InputGamepadEvent {
                                    kind: value_native_decoded_input_gamepad_event_kind,
                                    metadata: value_native_decoded_input_gamepad_event_metadata,
                                    payload: value_native_decoded_input_gamepad_event_payload,
                                };
                                InputEvent::InputGamepadEvent(value_native_decoded_input_gamepad_event)
                            }
                            InputeventReplayRecord::InputKeyEvent(value) => {
                                let value_native_decoded_input_key_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_key_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_key_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_key_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_key_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_key_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_key_event_metadata_sequence,
                                    device_id: value_native_decoded_input_key_event_metadata_device_id,
                                };
                                let value_native_decoded_input_key_event_payload_action = value.payload.action;
                                let value_native_decoded_input_key_event_payload_backend_code = value.payload.backend_code;
                                let value_native_decoded_input_key_event_payload_backend_scan_code = value.payload.backend_scan_code;
                                let value_native_decoded_input_key_event_payload_backend_value = value.payload.backend_value;
                                let value_native_decoded_input_key_event_payload_modifiers = value.payload.modifiers;
                                let value_native_decoded_input_key_event_payload_repeat = value.payload.repeat;
                                let value_native_decoded_input_key_event_payload = InputKeyEventPayload {
                                    action: value_native_decoded_input_key_event_payload_action,
                                    backend_code: value_native_decoded_input_key_event_payload_backend_code,
                                    backend_scan_code: value_native_decoded_input_key_event_payload_backend_scan_code,
                                    backend_value: value_native_decoded_input_key_event_payload_backend_value,
                                    modifiers: value_native_decoded_input_key_event_payload_modifiers,
                                    repeat: value_native_decoded_input_key_event_payload_repeat,
                                };
                                let value_native_decoded_input_key_event = InputKeyEvent {
                                    kind: value_native_decoded_input_key_event_kind,
                                    metadata: value_native_decoded_input_key_event_metadata,
                                    payload: value_native_decoded_input_key_event_payload,
                                };
                                InputEvent::InputKeyEvent(value_native_decoded_input_key_event)
                            }
                            InputeventReplayRecord::InputPointerButtonEvent(value) => {
                                let value_native_decoded_input_pointer_button_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_pointer_button_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_pointer_button_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_pointer_button_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_pointer_button_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_pointer_button_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_pointer_button_event_metadata_sequence,
                                    device_id: value_native_decoded_input_pointer_button_event_metadata_device_id,
                                };
                                let value_native_decoded_input_pointer_button_event_payload_action = value.payload.action;
                                let value_native_decoded_input_pointer_button_event_payload_backend_code = value.payload.backend_code;
                                let value_native_decoded_input_pointer_button_event_payload_backend_value = value.payload.backend_value;
                                let value_native_decoded_input_pointer_button_event_payload_x = value.payload.x;
                                let value_native_decoded_input_pointer_button_event_payload_y = value.payload.y;
                                let value_native_decoded_input_pointer_button_event_payload_modifiers = value.payload.modifiers;
                                let value_native_decoded_input_pointer_button_event_payload = InputPointerButtonEventPayload {
                                    action: value_native_decoded_input_pointer_button_event_payload_action,
                                    backend_code: value_native_decoded_input_pointer_button_event_payload_backend_code,
                                    backend_value: value_native_decoded_input_pointer_button_event_payload_backend_value,
                                    x: value_native_decoded_input_pointer_button_event_payload_x,
                                    y: value_native_decoded_input_pointer_button_event_payload_y,
                                    modifiers: value_native_decoded_input_pointer_button_event_payload_modifiers,
                                };
                                let value_native_decoded_input_pointer_button_event = InputPointerButtonEvent {
                                    kind: value_native_decoded_input_pointer_button_event_kind,
                                    metadata: value_native_decoded_input_pointer_button_event_metadata,
                                    payload: value_native_decoded_input_pointer_button_event_payload,
                                };
                                InputEvent::InputPointerButtonEvent(value_native_decoded_input_pointer_button_event)
                            }
                            InputeventReplayRecord::InputPointerMotionEvent(value) => {
                                let value_native_decoded_input_pointer_motion_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_pointer_motion_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_pointer_motion_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_pointer_motion_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_pointer_motion_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_pointer_motion_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_pointer_motion_event_metadata_sequence,
                                    device_id: value_native_decoded_input_pointer_motion_event_metadata_device_id,
                                };
                                let value_native_decoded_input_pointer_motion_event_payload_x = value.payload.x;
                                let value_native_decoded_input_pointer_motion_event_payload_y = value.payload.y;
                                let value_native_decoded_input_pointer_motion_event_payload_buttons = value.payload.buttons;
                                let value_native_decoded_input_pointer_motion_event_payload_modifiers = value.payload.modifiers;
                                let value_native_decoded_input_pointer_motion_event_payload = InputPointerMotionEventPayload {
                                    x: value_native_decoded_input_pointer_motion_event_payload_x,
                                    y: value_native_decoded_input_pointer_motion_event_payload_y,
                                    buttons: value_native_decoded_input_pointer_motion_event_payload_buttons,
                                    modifiers: value_native_decoded_input_pointer_motion_event_payload_modifiers,
                                };
                                let value_native_decoded_input_pointer_motion_event = InputPointerMotionEvent {
                                    kind: value_native_decoded_input_pointer_motion_event_kind,
                                    metadata: value_native_decoded_input_pointer_motion_event_metadata,
                                    payload: value_native_decoded_input_pointer_motion_event_payload,
                                };
                                InputEvent::InputPointerMotionEvent(value_native_decoded_input_pointer_motion_event)
                            }
                            InputeventReplayRecord::InputScrollEvent(value) => {
                                let value_native_decoded_input_scroll_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_scroll_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_scroll_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_scroll_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_scroll_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_scroll_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_scroll_event_metadata_sequence,
                                    device_id: value_native_decoded_input_scroll_event_metadata_device_id,
                                };
                                let value_native_decoded_input_scroll_event_payload_wheel_x = value.payload.wheel_x;
                                let value_native_decoded_input_scroll_event_payload_wheel_y = value.payload.wheel_y;
                                let value_native_decoded_input_scroll_event_payload_x = value.payload.x;
                                let value_native_decoded_input_scroll_event_payload_y = value.payload.y;
                                let value_native_decoded_input_scroll_event_payload_modifiers = value.payload.modifiers;
                                let value_native_decoded_input_scroll_event_payload = InputScrollEventPayload {
                                    wheel_x: value_native_decoded_input_scroll_event_payload_wheel_x,
                                    wheel_y: value_native_decoded_input_scroll_event_payload_wheel_y,
                                    x: value_native_decoded_input_scroll_event_payload_x,
                                    y: value_native_decoded_input_scroll_event_payload_y,
                                    modifiers: value_native_decoded_input_scroll_event_payload_modifiers,
                                };
                                let value_native_decoded_input_scroll_event = InputScrollEvent {
                                    kind: value_native_decoded_input_scroll_event_kind,
                                    metadata: value_native_decoded_input_scroll_event_metadata,
                                    payload: value_native_decoded_input_scroll_event_payload,
                                };
                                InputEvent::InputScrollEvent(value_native_decoded_input_scroll_event)
                            }
                            InputeventReplayRecord::InputSensorEvent(value) => {
                                let value_native_decoded_input_sensor_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_sensor_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_sensor_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_sensor_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_sensor_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_sensor_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_sensor_event_metadata_sequence,
                                    device_id: value_native_decoded_input_sensor_event_metadata_device_id,
                                };
                                let value_native_decoded_input_sensor_event_payload_action = value.payload.action;
                                let value_native_decoded_input_sensor_event_payload_backend_code = value.payload.backend_code;
                                let value_native_decoded_input_sensor_event_payload_backend_value = value.payload.backend_value;
                                let value_native_decoded_input_sensor_event_payload_x = value.payload.x;
                                let value_native_decoded_input_sensor_event_payload_y = value.payload.y;
                                let value_native_decoded_input_sensor_event_payload_z = value.payload.z;
                                let value_native_decoded_input_sensor_event_payload = InputSensorEventPayload {
                                    action: value_native_decoded_input_sensor_event_payload_action,
                                    backend_code: value_native_decoded_input_sensor_event_payload_backend_code,
                                    backend_value: value_native_decoded_input_sensor_event_payload_backend_value,
                                    x: value_native_decoded_input_sensor_event_payload_x,
                                    y: value_native_decoded_input_sensor_event_payload_y,
                                    z: value_native_decoded_input_sensor_event_payload_z,
                                };
                                let value_native_decoded_input_sensor_event = InputSensorEvent {
                                    kind: value_native_decoded_input_sensor_event_kind,
                                    metadata: value_native_decoded_input_sensor_event_metadata,
                                    payload: value_native_decoded_input_sensor_event_payload,
                                };
                                InputEvent::InputSensorEvent(value_native_decoded_input_sensor_event)
                            }
                            InputeventReplayRecord::InputTextEvent(value) => {
                                let value_native_decoded_input_text_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_text_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_text_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_text_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_text_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_text_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_text_event_metadata_sequence,
                                    device_id: value_native_decoded_input_text_event_metadata_device_id,
                                };
                                let value_native_decoded_input_text_event_payload_text = binding.store_string(value.payload.text.as_str());
                                let value_native_decoded_input_text_event_payload = InputTextEventPayload {
                                    text: value_native_decoded_input_text_event_payload_text,
                                };
                                let value_native_decoded_input_text_event = InputTextEvent {
                                    kind: value_native_decoded_input_text_event_kind,
                                    metadata: value_native_decoded_input_text_event_metadata,
                                    payload: value_native_decoded_input_text_event_payload,
                                };
                                InputEvent::InputTextEvent(value_native_decoded_input_text_event)
                            }
                            InputeventReplayRecord::InputTouchEvent(value) => {
                                let value_native_decoded_input_touch_event_kind = binding.store_string(value.kind.as_str());
                                let value_native_decoded_input_touch_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_decoded_input_touch_event_metadata_sequence = value.metadata.sequence;
                                let value_native_decoded_input_touch_event_metadata_device_id = binding.store_string(value.metadata.device_id.as_str());
                                let value_native_decoded_input_touch_event_metadata = InputEventMetadata {
                                    timestamp_ns: value_native_decoded_input_touch_event_metadata_timestamp_ns,
                                    sequence: value_native_decoded_input_touch_event_metadata_sequence,
                                    device_id: value_native_decoded_input_touch_event_metadata_device_id,
                                };
                                let value_native_decoded_input_touch_event_payload_action = value.payload.action;
                                let value_native_decoded_input_touch_event_payload_contact_id = value.payload.contact_id;
                                let value_native_decoded_input_touch_event_payload_x = value.payload.x;
                                let value_native_decoded_input_touch_event_payload_y = value.payload.y;
                                let value_native_decoded_input_touch_event_payload_pressure = value.payload.pressure;
                                let value_native_decoded_input_touch_event_payload = InputTouchEventPayload {
                                    action: value_native_decoded_input_touch_event_payload_action,
                                    contact_id: value_native_decoded_input_touch_event_payload_contact_id,
                                    x: value_native_decoded_input_touch_event_payload_x,
                                    y: value_native_decoded_input_touch_event_payload_y,
                                    pressure: value_native_decoded_input_touch_event_payload_pressure,
                                };
                                let value_native_decoded_input_touch_event = InputTouchEvent {
                                    kind: value_native_decoded_input_touch_event_kind,
                                    metadata: value_native_decoded_input_touch_event_metadata,
                                    payload: value_native_decoded_input_touch_event_payload,
                                };
                                InputEvent::InputTouchEvent(value_native_decoded_input_touch_event)
                            }
                        };
                        value_native_values.push(value_native_decoded);
                    }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_touches_item in unsafe { result_value.touches.as_slice()? }.iter().cloned() {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let mut value_native_axes_values = Vec::new();
                    for value_native_axes_item in value.axes.iter().cloned() {
                        let value_native_axes_decoded = value_native_axes_item;
                        value_native_axes_values.push(value_native_axes_decoded);
                    }
                    let value_native_axes = binding.store_array(value_native_axes_values);
                    let mut value_native_buttons_values = Vec::new();
                    for value_native_buttons_item in value.buttons.iter().cloned() {
                        let value_native_buttons_decoded_pressed = value_native_buttons_item.pressed;
                        let value_native_buttons_decoded_touched = value_native_buttons_item.touched;
                        let value_native_buttons_decoded_value = value_native_buttons_item.value;
                        let value_native_buttons_decoded = InputGamepadButtonState {
                            pressed: value_native_buttons_decoded_pressed,
                            touched: value_native_buttons_decoded_touched,
                            value: value_native_buttons_decoded_value,
                        };
                        value_native_buttons_values.push(value_native_buttons_decoded);
                    }
                    let value_native_buttons = binding.store_array(value_native_buttons_values);
                    let mut value_native_touches_values = Vec::new();
                    for value_native_touches_item in value.touches.iter().cloned() {
                        let value_native_touches_decoded_touch_id = value_native_touches_item.touch_id;
                        let value_native_touches_decoded_surface_id = value_native_touches_item.surface_id;
                        let value_native_touches_decoded_x = value_native_touches_item.x;
                        let value_native_touches_decoded_y = value_native_touches_item.y;
                        let value_native_touches_decoded_pressure = value_native_touches_item.pressure;
                        let value_native_touches_decoded = InputGamepadTouchState {
                            touch_id: value_native_touches_decoded_touch_id,
                            surface_id: value_native_touches_decoded_surface_id,
                            x: value_native_touches_decoded_x,
                            y: value_native_touches_decoded_y,
                            pressure: value_native_touches_decoded_pressure,
                        };
                        value_native_touches_values.push(value_native_touches_decoded);
                    }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_pressed_codes_item in unsafe { result_value.pressed_codes.as_slice()? }.iter().cloned() {
                ...
                for result_recorded_pressed_scan_codes_item in unsafe { result_value.pressed_scan_codes.as_slice()? }.iter().cloned() {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_pressed_codes_item in value.pressed_codes.iter().cloned() {
                    ...
                    for value_native_pressed_scan_codes_item in value.pressed_scan_codes.iter().cloned() {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        let value_native_decoded_kind = value_native_item.kind;
                        let value_native_decoded_min_sample_rate_hz = value_native_item.min_sample_rate_hz;
                        let value_native_decoded_max_sample_rate_hz = value_native_item.max_sample_rate_hz;
                        let value_native_decoded_resolution = value_native_item.resolution;
                        let value_native_decoded_supports_wake = value_native_item.supports_wake;
                        let value_native_decoded = InputSensorDescriptor {
                            kind: value_native_decoded_kind,
                            min_sample_rate_hz: value_native_decoded_min_sample_rate_hz,
                            max_sample_rate_hz: value_native_decoded_max_sample_rate_hz,
                            resolution: value_native_decoded_resolution,
                            supports_wake: value_native_decoded_supports_wake,
                        };
                        value_native_values.push(value_native_decoded);
                    }
                    let value_native = binding.store_array(value_native_values);
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_contacts_item in unsafe { result_value.contacts.as_slice()? }.iter().cloned() {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_contacts_item in value.contacts.iter().cloned() {
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_kinds_item_value in result_recorded_kinds_raw {
                    let result_recorded_kinds_item_raw = decode_int32(result_recorded_kinds_item_value, "result_recorded_kinds_item_raw", "item")?;
                    let result_recorded_kinds_item = match result_recorded_kinds_item_raw { 1i32 => InputDeviceCapabilityKind::Keyboard, 2i32 => InputDeviceCapabilityKind::Pointer, 3i32 => InputDeviceCapabilityKind::Touch, 4i32 => InputDeviceCapabilityKind::Pen, 5i32 => InputDeviceCapabilityKind::Gamepad, 6i32 => InputDeviceCapabilityKind::Sensor, 7i32 => InputDeviceCapabilityKind::Haptics, 8i32 => InputDeviceCapabilityKind::TextInput , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_kinds_item", "unknown InputDeviceCapabilityKind value")).boxed()), };
                    let result_recorded_kinds_item_recorded = result_recorded_kinds_item;
                    result_recorded_kinds.push(result_recorded_kinds_item_recorded);
                }
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_kind_raw = decode_int32(slots[5], "result_recorded_item_kind_raw", "kind")?;
                        let result_recorded_item_kind = match result_recorded_item_kind_raw { 1i32 => InputDeviceKind::Keyboard, 2i32 => InputDeviceKind::Mouse, 3i32 => InputDeviceKind::Touch, 4i32 => InputDeviceKind::Gamepad, 5i32 => InputDeviceKind::Pen, 255i32 => InputDeviceKind::Raw , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_kind", "unknown InputDeviceKind value")).boxed()), };
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_instance_id = context.string_handle(vm_result_item.instance_id.as_str()).map_err(Box::<RuntimeError>::from)?;
                        let vm_result_item_value_hardware_id = context.string_handle(vm_result_item.hardware_id.as_str()).map_err(Box::<RuntimeError>::from)?;
                        let vm_result_item_value_name = context.string_handle(vm_result_item.name.as_str()).map_err(Box::<RuntimeError>::from)?;
                        let vm_result_item_value_transport = context.string_handle(vm_result_item.transport.as_str()).map_err(Box::<RuntimeError>::from)?;
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    ...
                    let result_recorded_item = match result_recorded_item_raw { 1i32 => InputHapticEffectType::DualRumble, 2i32 => InputHapticEffectType::TriggerRumble , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown InputHapticEffectType value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = InputHapticsEffectsReplayRecord {
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_device_id = context.string_handle(value.device_id.as_str()).map_err(Box::<RuntimeError>::from)?;
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_kind_raw = decode_int32(slots[0], "result_recorded_item_kind_raw", "kind")?;
                        let result_recorded_item_kind = match result_recorded_item_kind_raw { 1i32 => InputSensorKind::Accelerometer, 2i32 => InputSensorKind::Gyroscope, 3i32 => InputSensorKind::Magnetometer, 4i32 => InputSensorKind::Gravity, 5i32 => InputSensorKind::LinearAcceleration, 6i32 => InputSensorKind::Orientation, 7i32 => InputSensorKind::Barometer, 8i32 => InputSensorKind::AmbientLight, 9i32 => InputSensorKind::Proximity, 10i32 => InputSensorKind::StepCounter , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_kind", "unknown InputSensorKind value")).boxed()), };
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_payload_text = context.string_handle(value.payload.text.as_str()).map_err(Box::<RuntimeError>::from)?;
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_contacts_item_value in result_recorded_contacts_raw {
                    let result_recorded_contacts_item = {
                        ...
                        let result_recorded_contacts_item_phase_raw = decode_int32(slots[1], "result_recorded_contacts_item_phase_raw", "phase")?;
                        let result_recorded_contacts_item_phase = match result_recorded_contacts_item_phase_raw { 1i32 => InputTouchContactPhase::Begin, 2i32 => InputTouchContactPhase::Move, 3i32 => InputTouchContactPhase::End, 4i32 => InputTouchContactPhase::Cancel , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_contacts_item_phase", "unknown InputTouchContactPhase value")).boxed()), };
...
pub(crate) fn register_input_vm_bindings(
