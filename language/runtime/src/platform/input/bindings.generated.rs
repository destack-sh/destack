...
use crate::platform::input::{
    ...
    InputDeviceEventValue, InputDeviceEventVm, InputDeviceKind, InputEvent, InputEventAction,
    InputEventMetadata, InputEventMetadataValue, InputEventMetadataVm, InputEventValue,
    ...
    InputGamepadEvent, InputGamepadEventPayload, InputGamepadEventPayloadVm,
    InputGamepadEventValue, InputGamepadEventVm, InputGamepadMappingType, InputGamepadState,
    InputGamepadStateValue, InputGamepadStateVm, InputGamepadTouchState, InputGamepadTouchStateVm,
    InputHapticEffectParameters, InputHapticEffectParametersVm, InputHapticEffectType,
    InputHapticsResult, InputKeyEvent, InputKeyEventPayload, InputKeyEventPayloadVm,
    InputKeyEventValue, InputKeyEventVm, InputKeyboardState, InputKeyboardStateValue,
    InputKeyboardStateVm, InputMonitorChangeEvent, InputMonitorChangeEventValue,
    InputMonitorChangeEventVm, InputMonitorConnectEvent, InputMonitorConnectEventValue,
    InputMonitorConnectEventVm, InputMonitorDisconnectEvent, InputMonitorDisconnectEventValue,
    InputMonitorDisconnectEventVm, InputMonitorEvent, InputMonitorEventMetadata,
    InputMonitorEventMetadataValue, InputMonitorEventMetadataVm, InputMonitorEventValue,
    InputMonitorEventVm, InputPenState, InputPenStateVm, InputPointerButtonEvent,
    InputPointerButtonEventPayload, InputPointerButtonEventPayloadVm, InputPointerButtonEventValue,
    InputPointerButtonEventVm, InputPointerGrabMode, InputPointerMotionEvent,
    InputPointerMotionEventPayload, InputPointerMotionEventPayloadVm, InputPointerMotionEventValue,
    InputPointerMotionEventVm, InputPointerState, InputPointerStateVm, InputRawHidReport,
    InputRawHidReportValue, InputRawHidReportVm, InputReadMode, InputScrollEvent,
    InputScrollEventPayload, InputScrollEventPayloadVm, InputScrollEventValue, InputScrollEventVm,
    ...
    InputTouchStateValue, InputTouchStateVm, InputWindowTarget, InputWindowTargetVm,
    ...
    InputdeviceeventReplayRecord, InputeventReplayRecord, InputeventmetadataReplayRecord,
    InputgamepadeventReplayRecord, InputgamepadstateReplayRecord, InputkeyboardstateReplayRecord,
    InputkeyeventReplayRecord, InputmonitorchangeeventReplayRecord,
    InputmonitorconnecteventReplayRecord, InputmonitordisconnecteventReplayRecord,
    InputmonitoreventReplayRecord, InputmonitoreventmetadataReplayRecord,
            ...
            InputMonitorEventVm::InputMonitorChangeEvent(value) => {
                ...
                let payload_value = {
                    ...
                    let field_1: RuntimeResult<vm::Value> = {
                        ...
                        let field_3: RuntimeResult<vm::Value> =
                            Ok(vm::Value::int(value.metadata.device_kind as i32 as i64, 32));
                ...
                let payload_value = {
                    ...
                    let field_2: RuntimeResult<vm::Value> = {
                        ...
                        let field_2: RuntimeResult<vm::Value> =
                            Ok(vm::Value::int(value.payload.backend_value, 64));
                        let field_3: RuntimeResult<vm::Value> =
                            Ok(vm::Value::float64(value.payload.x));
                        let field_4: RuntimeResult<vm::Value> =
                            Ok(vm::Value::float64(value.payload.y));
                        let field_5: RuntimeResult<vm::Value> =
                            Ok(vm::Value::uint(value.payload.modifiers as u64, 32));
                        context
                            .allocate_aggregate(vec![
                ...
                let payload_value = {
                    ...
                    let field_2: RuntimeResult<vm::Value> = {
                        ...
                        let field_4: RuntimeResult<vm::Value> =
                            Ok(vm::Value::float64(value.payload.y));
                        let field_5: RuntimeResult<vm::Value> =
                            Ok(vm::Value::float64(value.payload.z));
                        context
                            .allocate_aggregate(vec![
                                field_0?, field_1?, field_2?, field_3?, field_4?, field_5?,
                            ])
...
fn encode_destack_input_gamepad_state_result(
    ...
    result
        .map(|value| {
            ...
            let field_2: RuntimeResult<vm::Value> =
                Ok(vm::Value::int(value.mapping as i32 as i64, 32));
            let field_3: RuntimeResult<vm::Value> =
                Ok(vm::Value::int(value.connection_type as i32 as i64, 32));
            let field_4: RuntimeResult<vm::Value> =
                Ok(vm::Value::uint(value.player_index as u64, 8));
            let field_5: RuntimeResult<vm::Value> = {
                let field_0: RuntimeResult<vm::Value> =
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_kinds_item in
                    unsafe { result_value.kinds.as_slice()? }.iter().cloned()
                {
                ...
                for result_recorded_axes_item in
                    unsafe { result_value.axes.as_slice()? }.iter().cloned()
                {
                ...
                for result_recorded_buttons_item in
                    unsafe { result_value.buttons.as_slice()? }.iter().cloned()
                {
            ...
            if let Err(error) = result {
                let payload = {
                    ...
                    InputDeviceCapabilitiesReplayRecord { result }
                };
                return Ok(Some(payload));
            }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_axes_item in value.axes.iter().cloned() {
                        ...
                        let value_native_axes_decoded_resolution =
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputDeviceCloseReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputDeviceListReplayRecord { result }
                };
                return Ok(Some(payload));
            }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        ...
                        let value_native_decoded_instance_id =
                            binding.store_string(value_native_item.instance_id.as_str());
                        let value_native_decoded_hardware_id =
                            binding.store_string(value_native_item.hardware_id.as_str());
                        ...
                        let value_native_decoded_supports_exclusive_grab =
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputDeviceOpenReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputEventMonitorCloseReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputEventMonitorOpenReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputEventSetExclusiveGrabReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputEventSetReadModeReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputGamepadSetLightReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputGamepadSetPlayerIndexReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_touches_item in
                    unsafe { result_value.touches.as_slice()? }.iter().cloned()
                {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputGamepadStateReplayRecord { result }
                };
                return Ok(Some(payload));
            }
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let mut value_native_buttons_values = Vec::new();
                    for value_native_buttons_item in value.buttons.iter().cloned() {
                        let value_native_buttons_decoded_pressed =
                            value_native_buttons_item.pressed;
                        let value_native_buttons_decoded_touched =
                    ...
                    for value_native_touches_item in value.touches.iter().cloned() {
                        let value_native_touches_decoded_touch_id =
                            value_native_touches_item.touch_id;
                        let value_native_touches_decoded_surface_id =
                        ...
                        let value_native_touches_decoded_pressure =
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputHapticsEffectsReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputHapticsPlayReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputHapticsStopReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_pressed_codes_item in
                ...
                for result_recorded_pressed_scan_codes_item in
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputKeyboardStateReplayRecord { result }
                };
                return Ok(Some(payload));
            }
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_pressed_scan_codes_item in
                        value.pressed_scan_codes.iter().cloned()
                    {
                        let value_native_pressed_scan_codes_decoded =
                            value_native_pressed_scan_codes_item;
                        value_native_pressed_scan_codes_values
                            .push(value_native_pressed_scan_codes_decoded);
                    }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerCaptureReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerRelativeStateReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerSetGrabModeReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerSetRelativeModeReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerStateReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputPointerWarpReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputRawhidGetFeatureReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputRawhidReadReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputRawhidSetFeatureReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputRawhidTryReadReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputRawhidWriteReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputSensorConfigureReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputSensorListReplayRecord { result }
                };
                return Ok(Some(payload));
            }
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        let value_native_decoded_kind = value_native_item.kind;
                        let value_native_decoded_min_sample_rate_hz =
                            value_native_item.min_sample_rate_hz;
                        let value_native_decoded_max_sample_rate_hz =
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputSensorReadReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputSensorTryReadReplayRecord { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_contacts_item in
                    unsafe { result_value.contacts.as_slice()? }.iter().cloned()
                {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    InputTouchStateReplayRecord { result }
                };
                return Ok(Some(payload));
            }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_contacts_item in value.contacts.iter().cloned() {
                        let value_native_contacts_decoded_contact_id =
                        ...
                        let value_native_contacts_decoded_pressure =
                            value_native_contacts_item.pressure;
                        let value_native_contacts_decoded_radius_x =
                            value_native_contacts_item.radius_x;
                        let value_native_contacts_decoded_radius_y =
                            value_native_contacts_item.radius_y;
                        let value_native_contacts_decoded_tilt_x =
                            value_native_contacts_item.tilt_x;
                        let value_native_contacts_decoded_tilt_y =
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_pressed_scan_codes_item in
                        value.pressed_scan_codes.iter().cloned()
                    {
