...
use crate::platform::input::{
    InputDeviceInfo, InputDeviceInfoReplay, InputDeviceInfoVm, InputDeviceKind, InputEvent,
    InputEventVm,
};
...
pub unsafe extern "C" fn destack_input_device_close(
    ...
    native_call(|context| {
        ...
        destack_input_device_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_input_device_list(
    ...
    native_call(|context| {
        ...
        destack_input_device_list_replay(context, out)
    })
}
...
pub unsafe extern "C" fn destack_input_device_open(
    ...
    native_call(|context| {
        ...
        destack_input_device_open_replay(context, out, id)
    })
}
...
pub unsafe extern "C" fn destack_input_event_read(
    ...
    native_call(|context| {
        ...
        destack_input_event_read_replay(context, out, handle)
    })
}
...
pub unsafe extern "C" fn destack_input_event_set_grab(
    ...
    native_call(|context| {
        ...
        destack_input_event_set_grab_replay(context, handle, enable)
    })
}
...
pub unsafe extern "C" fn destack_input_event_try_read(
    ...
    native_call(|context| {
        ...
        destack_input_event_try_read_replay(context, out, handle)
    })
}
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_input_device_close_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, _args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_input_device_list_vm_replay(runtime, context)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_input_device_open_vm_replay(runtime, context, id)
                })
                .map_err(Into::into)
            }
        );
    }
    {
        binding!(registry, isolate, INPUT_EVENT_READ, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_input_event_read_vm_replay(runtime, context, handle)
            })
            .map_err(Into::into)
        });
    }
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_input_event_set_grab_vm_replay(runtime, context, handle, enable)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_input_event_try_read_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
