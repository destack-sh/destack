...
use crate::platform::os::{BackgroundEvent, BackgroundEventOpenOptions, BackgroundStatus, BackgroundTaskDescriptor, BackgroundTaskOptions, BackgroundTaskResult, CalendarDescriptor, CalendarEvent, CalendarEventDraft, CalendarEventQuery, ClipboardBinaryFormat, Contact, ContactDraft, ContactPage, ContactQuery, CredentialAuthenticationOptions, CredentialAuthenticationResult, CredentialQuery, CredentialRecord, CredentialWriteOptions, DocumentAccess, DocumentDescriptor, DocumentPickOptions, HostIdentity, IntentEvent, IntentOpenOptions, LifecycleEvent, LifecycleState, LoadAverage, LocationSample, LocationWatchOptions, MediaAssetDescriptor, MediaAssetKind, MediaPage, MediaQuery, MountEntry, NetworkEvent, NetworkState, NotificationCategory, NotificationEvent, NotificationEventOpenOptions, NotificationPermissionState, NotificationRequest, NotificationScheduledDescriptor, Permission, PermissionEntry, PermissionState, PowerState, SystemSnapshot};
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_clipboard_clear(_binding: &BindingCallContext) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub(crate) unsafe fn destack_os_clipboard_has_text(_binding: &BindingCallContext, out: *mut bool) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = out;
...
/// # Replay
/// External, recordable.
pub(crate) unsafe fn destack_os_clipboard_read_bytes(_binding: &BindingCallContext, out: *mut NativeSlice<u8>, format: ClipboardBinaryFormat) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = (out, format);
...
/// # Replay
/// External, recordable.
pub(crate) unsafe fn destack_os_clipboard_read_text(_binding: &BindingCallContext, out: *mut NativeStringRef) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = out;
...
/// # Replay
/// External, recordable.
pub(crate) unsafe fn destack_os_clipboard_sequence(_binding: &BindingCallContext, out: *mut u64) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = out;
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_clipboard_write_bytes(_binding: &BindingCallContext, format: ClipboardBinaryFormat, argument_bytes: NativeSlice<u8>) -> RuntimeResult<()> {
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_clipboard_write_text(_binding: &BindingCallContext, text: NativeStringRef) -> RuntimeResult<()> {
    let _ = text;
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_document_pick(_binding: &BindingCallContext, out: *mut NativeArray<DocumentDescriptor>, options: DocumentPickOptions) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = (out, options);
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_notification_request_permission(_binding: &BindingCallContext, out: *mut NotificationPermissionState) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
    let _ = out;
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_permission_request(_binding: &BindingCallContext, out: *mut PermissionState, permission: Permission) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
...
/// # Replay
/// External, nonrecordable.
pub(crate) unsafe fn destack_os_permission_request_many(_binding: &BindingCallContext, out: *mut NativeArray<PermissionEntry>, permissions: NativeArray<Permission>) -> RuntimeResult<()> {
    if out.is_null() {
        return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed());
    }
