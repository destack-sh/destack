...
use crate::platform::os::tests::{
    HarnessValue, OsHarnessContext, decode_permission_entries_value, with_harness_context,
};
...
fn prime_permission_state(context: &mut OsHarnessContext<'_>) -> RuntimeResult<()> {
