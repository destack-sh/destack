...
use crate::platform::{VmValueCodec, fs};
...
pub struct MountEntryAbi<A: BindingAbi> {
    ...
    pub source: A::String,
    /// The target field.
    pub target: crate::platform::fs::OsPathAbi<A>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct MountEntryReplay {
    /// The source field.
    pub source: String,
    /// The target field.
    pub target: fs::OsPathReplay,
    /// The file_system field.
