...
use crate::platform::os::notification::storage::{
    ensure_notification_scheduler_directory, notification_wrapper_script_path,
};

/// Environment marker carrying one scheduled desktop notification identifier.
pub(crate) const DESKTOP_NOTIFICATION_IDENTIFIER_ENV: &str = "DESTACK_NOTIFICATION_IDENTIFIER";
