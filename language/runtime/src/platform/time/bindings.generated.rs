...
use crate::platform::time::{ClockId, ClockMetadata, ClockMetadataVm, ClockSource, SleepClock, TimerClock, TimerFlags, TimerOptions, TimerOptionsVm};
...
use crate::platform::time::{native as platform_runtime_native, vm as platform_runtime_vm};
...
fn decode_destack_time_clock_metadata_args(
    ...
    let clock = match clock_raw { 1u8 => ClockId::Wall, 2u8 => ClockId::Monotonic, 3u8 => ClockId::ProcessCpu, 4u8 => ClockId::ThreadCpu, 5u8 => ClockId::Boot, 6u8 => ClockId::MonotonicRaw , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("clock", "unknown ClockId value")).boxed()), };
    Ok((clock,))
}
...
fn encode_destack_time_clock_metadata_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.id as u8 as u64, 8)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.source as u8 as u64, 8)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.resolution_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_monotonic)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_time_sleep_on_ns_args(
    ...
    let clock = match clock_raw { 1u8 => SleepClock::Wall, 2u8 => SleepClock::Monotonic , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("clock", "unknown SleepClock value")).boxed()), };
    Ok((duration, clock))
}
...
pub(crate) const TIME_CLOCK_METADATA: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_CLOCK_MONO_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_CLOCK_NOW_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_CLOCK_PROCESS_CPU_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_CLOCK_THREAD_CPU_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_CLOCK_WALL_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_SLEEP_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_SLEEP_UNTIL_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_TIMER_CANCEL: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_TIMER_IS_ACTIVE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_TIMER_PAUSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_TIMER_REMAINING_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_TIMER_RESUME: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const TIME_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "time",
    bindings: &[
        NativeBinding::new(TIME_CLOCK_METADATA, "destack.time.clock.metadata", destack_time_clock_metadata as *const ()),
        NativeBinding::new(TIME_CLOCK_MONO_NS, "destack.time.clock.monoNs", destack_time_clock_mono_ns as *const ()),
        NativeBinding::new(TIME_CLOCK_NOW_NS, "destack.time.clock.nowNs", destack_time_clock_now_ns as *const ()),
        NativeBinding::new(TIME_CLOCK_PROCESS_CPU_NS, "destack.time.clock.processCpuNs", destack_time_clock_process_cpu_ns as *const ()),
        NativeBinding::new(TIME_CLOCK_THREAD_CPU_NS, "destack.time.clock.threadCpuNs", destack_time_clock_thread_cpu_ns as *const ()),
        NativeBinding::new(TIME_CLOCK_WALL_NS, "destack.time.clock.wallNs", destack_time_clock_wall_ns as *const ()),
        NativeBinding::new(TIME_SLEEP_NS, "destack.time.sleep.ns", destack_time_sleep_ns as *const ()),
        NativeBinding::new(TIME_SLEEP_ON_NS, "destack.time.sleep.onNs", destack_time_sleep_on_ns as *const ()),
        NativeBinding::new(TIME_SLEEP_UNTIL_NS, "destack.time.sleep.untilNs", destack_time_sleep_until_ns as *const ()),
        NativeBinding::new(TIME_SLEEP_UNTIL_ON_NS, "destack.time.sleep.untilOnNs", destack_time_sleep_until_on_ns as *const ()),
        NativeBinding::new(TIME_TIMER_AT, "destack.time.timer.at", destack_time_timer_at as *const ()),
        NativeBinding::new(TIME_TIMER_CANCEL, "destack.time.timer.cancel", destack_time_timer_cancel as *const ()),
        NativeBinding::new(TIME_TIMER_INTERVAL, "destack.time.timer.interval", destack_time_timer_interval as *const ()),
        NativeBinding::new(TIME_TIMER_IS_ACTIVE, "destack.time.timer.isActive", destack_time_timer_is_active as *const ()),
        NativeBinding::new(TIME_TIMER_ONCE, "destack.time.timer.once", destack_time_timer_once as *const ()),
        NativeBinding::new(TIME_TIMER_PAUSE, "destack.time.timer.pause", destack_time_timer_pause as *const ()),
        NativeBinding::new(TIME_TIMER_REMAINING_NS, "destack.time.timer.remainingNs", destack_time_timer_remaining_ns as *const ()),
        NativeBinding::new(TIME_TIMER_RESET, "destack.time.timer.reset", destack_time_timer_reset as *const ()),
        NativeBinding::new(TIME_TIMER_RESUME, "destack.time.timer.resume", destack_time_timer_resume as *const ()),
        NativeBinding::new(TIME_TIMER_UPDATE_INTERVAL, "destack.time.timer.updateInterval", destack_time_timer_update_interval as *const ()),
    ],
};
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    TimeClockProcessCpuNsReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    TimeClockThreadCpuNsReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_time_sleep_until_on_ns_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_sleep_until_on_ns(binding, deadline, clock) },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    TimeSleepUntilOnNsReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_time_timer_at_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_timer_at(binding, out, deadlinens, options) },
        |result| {
            if let Ok(()) = result {
...
fn destack_time_timer_interval_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_timer_interval(binding, out, periodns, options) },
        |result| {
            if let Ok(()) = result {
                let result_value: resource::TimerHandle = unsafe { out.read() };
                let result_recorded = result_value;
...
fn destack_time_timer_once_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_timer_once(binding, out, delayns, options) },
        |result| {
            if let Ok(()) = result {
                let result_value: resource::TimerHandle = unsafe { out.read() };
                let result_recorded = result_value;
...
fn destack_time_timer_remaining_ns_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_timer_remaining_ns(binding, out, handle) },
        |result| {
            if let Ok(()) = result {
                let result_value: u64 = unsafe { out.read() };
                let result_recorded = result_value;
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    TimeTimerRemainingNsReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_time_timer_update_interval_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || unsafe { platform_runtime_native::destack_time_timer_update_interval(binding, handle, periodns) },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    TimeTimerUpdateIntervalReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
pub(crate) unsafe extern "C" fn destack_time_clock_mono_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub(crate) unsafe extern "C" fn destack_time_clock_process_cpu_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub(crate) unsafe extern "C" fn destack_time_clock_thread_cpu_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub(crate) unsafe extern "C" fn destack_time_clock_wall_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub(crate) unsafe extern "C" fn destack_time_sleep_ns(
    duration: u64,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &duration;
...
pub(crate) unsafe extern "C" fn destack_time_sleep_until_ns(
    deadline: u64,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &deadline;
...
fn destack_time_sleep_until_on_ns_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        binding.replay_payload_for(TIME_SLEEP_UNTIL_ON_NS)?,
        context,
        |context| platform_runtime_vm::destack_time_sleep_until_on_ns(binding, context, deadline, clock),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_time_timer_interval_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        binding.replay_payload_for(TIME_TIMER_INTERVAL)?,
        context,
        |context| platform_runtime_vm::destack_time_timer_interval(binding, context, periodns, options),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value: resource::TimerHandle = value.clone();
...
fn destack_time_timer_update_interval_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        binding.replay_payload_for(TIME_TIMER_UPDATE_INTERVAL)?,
        context,
        |context| platform_runtime_vm::destack_time_timer_update_interval(binding, context, handle, periodns),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
pub(crate) fn register_time_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, TIME_CLOCK_METADATA, move |context, args| {
    ...
    {
        binding!(registry, isolate, TIME_CLOCK_MONO_NS, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let result = binding.trace().run_time_read(
                    ...
                    || {
                    {
                        let _binding_hook_guard = binding.on_before_binding(TIME_CLOCK_MONO_NS)?;
    ...
    {
        binding!(registry, isolate, TIME_CLOCK_NOW_NS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_CLOCK_PROCESS_CPU_NS, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let _binding_hook_guard = binding.on_before_binding(TIME_CLOCK_PROCESS_CPU_NS)?;
    ...
    {
        binding!(registry, isolate, TIME_CLOCK_THREAD_CPU_NS, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let _binding_hook_guard = binding.on_before_binding(TIME_CLOCK_THREAD_CPU_NS)?;
    ...
    {
        binding!(registry, isolate, TIME_CLOCK_WALL_NS, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let result = binding.trace().run_time_read(
                    EntropyKind::TimeReadWall,
                    ...
                    || {
                    {
                        let _binding_hook_guard = binding.on_before_binding(TIME_CLOCK_WALL_NS)?;
    ...
    {
        binding!(registry, isolate, TIME_SLEEP_UNTIL_NS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_SLEEP_UNTIL_ON_NS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (deadline, clock) = decode_destack_time_sleep_until_on_ns_args(context, args)?;
    ...
    {
        binding!(registry, isolate, TIME_TIMER_CANCEL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_TIMER_INTERVAL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (periodns, options) = decode_destack_time_timer_interval_args(context, args)?;
    ...
    {
        binding!(registry, isolate, TIME_TIMER_IS_ACTIVE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_TIMER_REMAINING_NS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_TIMER_RESUME, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIME_TIMER_UPDATE_INTERVAL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, periodns) = decode_destack_time_timer_update_interval_args(context, args)?;

                // execute binding
                let _binding_hook_guard = binding.on_before_binding(TIME_TIMER_UPDATE_INTERVAL)?;
