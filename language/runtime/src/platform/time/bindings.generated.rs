...
use crate::platform::time::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
pub const TIME_CLOCK_INFO: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "time",
    bindings: &[
        NativeBinding::new(TIME_CLOCK_INFO, "destack.time.clock.info", destack_time_clock_info as *const ()),
...
fn destack_time_clock_info_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_clock_info(context, out, clock) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_clock_info(context, out, clock) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_time_clock_now_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_now_ns(context, out, clock) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_now_ns(context, out, clock) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_time_clock_process_cpu_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_process_cpu_ns(context, out) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_process_cpu_ns(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_time_clock_thread_cpu_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_thread_cpu_ns(context, out) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_thread_cpu_ns(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_time_sleep_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_sleep_ns(context, duration) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_sleep_ns(context, duration) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_time_sleep_on_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_sleep_on_ns(context, duration, clock) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_sleep_on_ns(context, duration, clock) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_time_sleep_until_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_sleep_until_ns(context, deadline) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_sleep_until_ns(context, deadline) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_time_sleep_until_on_ns_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_time_sleep_until_on_ns(context, deadline, clock) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_sleep_until_on_ns(context, deadline, clock) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
pub unsafe extern "C" fn destack_time_clock_mono_ns(
    ...
    native_call(|context| {
        ...
        let value = context.replay().run_time_read(TimeEventKind::MonotonicSample, || {
            {
            let world = context.check_and_resolve_world(TIME_CLOCK_MONO_NS)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_time_mono_ns(context, out) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_mono_ns(context, out) },
            }
        }?;
            unsafe { Ok(*out) }
        })?;
...
pub unsafe extern "C" fn destack_time_clock_wall_ns(
    ...
    native_call(|context| {
        ...
        let value = context.replay().run_time_read(TimeEventKind::WallClockRead, || {
            {
            let world = context.check_and_resolve_world(TIME_CLOCK_WALL_NS)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_time_wall_ns(context, out) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_time_wall_ns(context, out) },
            }
        }?;
            unsafe { Ok(*out) }
        })?;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_clock_info(runtime, context, clock),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_now_ns(runtime, context, clock),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_process_cpu_ns(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_thread_cpu_ns(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_time_sleep_ns_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_time_sleep_ns(runtime, context, duration),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_sleep_ns(runtime, context, duration),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_time_sleep_on_ns_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_time_sleep_on_ns(runtime, context, duration, clock),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_sleep_on_ns(runtime, context, duration, clock),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_time_sleep_until_ns_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_time_sleep_until_ns(runtime, context, deadline),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_sleep_until_ns(runtime, context, deadline),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_time_sleep_until_on_ns_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_time_sleep_until_on_ns(runtime, context, deadline, clock),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_time_sleep_until_on_ns(runtime, context, deadline, clock),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_time_vm_bindings(
    ...
    }
    {
        binding!(registry, isolate, TIME_CLOCK_MONO_NS, move |context, _args| {
            with_runtime_call_context(|runtime| {
                // execute binding
                let result = runtime.replay().run_time_read(TimeEventKind::MonotonicSample, || {
                    {
                        let world = runtime.check_and_resolve_world(TIME_CLOCK_MONO_NS)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_time_mono_ns(runtime, context),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_time_mono_ns(runtime, context),
                        }
                    }
                });
    ...
    }
    {
        binding!(registry, isolate, TIME_CLOCK_WALL_NS, move |context, _args| {
            with_runtime_call_context(|runtime| {
                // execute binding
                let result = runtime.replay().run_time_read(TimeEventKind::WallClockRead, || {
                    {
                        let world = runtime.check_and_resolve_world(TIME_CLOCK_WALL_NS)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_time_wall_ns(runtime, context),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_time_wall_ns(runtime, context),
                        }
                    }
                });
    ...
    }
    {
        binding!(registry, isolate, TIME_SLEEP_UNTIL_ON_NS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_time_sleep_until_on_ns_vm_replay(runtime, context, world, deadline, clock)
            })
            .map_err(Into::into)
        });
    }
