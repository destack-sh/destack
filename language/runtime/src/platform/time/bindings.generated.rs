...
fn encode_destack_time_clock_metadata_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.id as u8 as u64, 8); let field_1 = vm::Value::uint(value.source as u8 as u64, 8); let field_2 = vm::Value::uint(value.resolution_ns, 64); let field_3 = vm::Value::bool(value.is_monotonic); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3]) })
}
...
pub const TIME_CLOCK_METADATA: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_CLOCK_MONO_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_CLOCK_NOW_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_CLOCK_PROCESS_CPU_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_CLOCK_THREAD_CPU_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_CLOCK_WALL_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_SLEEP_UNTIL_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_TIMER_CANCEL: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_TIMER_IS_ACTIVE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_TIMER_PAUSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_TIMER_REMAINING_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIME_TIMER_RESUME: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub unsafe extern "C" fn destack_time_clock_mono_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_time_clock_now_ns(
    out: *mut u64,
    clock: ClockId,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_time_clock_process_cpu_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_time_clock_thread_cpu_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_time_clock_wall_ns(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_time_sleep_ns(
    duration: u64,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &duration;
...
pub unsafe extern "C" fn destack_time_sleep_until_ns(
    deadline: u64,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &deadline;
...
pub unsafe extern "C" fn destack_time_timer_cancel(
    handle: resource::TimerHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_time_timer_pause(
    handle: resource::TimerHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_time_timer_resume(
    handle: resource::TimerHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub fn register_time_vm_bindings(
...
pub fn install_time_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
