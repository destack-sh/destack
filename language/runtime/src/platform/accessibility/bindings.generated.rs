...
use crate::platform::accessibility::{AccessibilityAction, AccessibilityActionMetadata, AccessibilityActionMetadataVm, AccessibilityActionOpenOptions, AccessibilityActionOpenOptionsVm, AccessibilityActionValue, AccessibilityActionVm, AccessibilityActivateAction, AccessibilityActivateActionValue, AccessibilityActivateActionVm, AccessibilityAutoComplete, AccessibilityCollapseAction, AccessibilityCollapseActionValue, AccessibilityCollapseActionVm, AccessibilityCurrentKind, AccessibilityDecrementAction, AccessibilityDecrementActionValue, AccessibilityDecrementActionVm, AccessibilityDismissAction, AccessibilityDismissActionValue, AccessibilityDismissActionVm, AccessibilityExpandAction, AccessibilityExpandActionValue, AccessibilityExpandActionVm, AccessibilityFocusAction, AccessibilityFocusActionValue, AccessibilityFocusActionVm, AccessibilityHasPopup, AccessibilityIncrementAction, AccessibilityIncrementActionValue, AccessibilityIncrementActionVm, AccessibilityInvalidKind, AccessibilityLiveRegionPoliteness, AccessibilityNode, AccessibilityNodeId, AccessibilityNodeRelations, AccessibilityNodeRelationsVm, AccessibilityNodeVm, AccessibilityOrientation, AccessibilityRangeValue, AccessibilityRangeValueVm, AccessibilityRelevantFlags, AccessibilityRole, AccessibilityScrollIntoViewAction, AccessibilityScrollIntoViewActionValue, AccessibilityScrollIntoViewActionVm, AccessibilitySelectAction, AccessibilitySelectActionValue, AccessibilitySelectActionVm, AccessibilitySetNumericValueAction, AccessibilitySetNumericValueActionValue, AccessibilitySetNumericValueActionVm, AccessibilitySetSelectedTextRangeAction, AccessibilitySetSelectedTextRangeActionValue, AccessibilitySetSelectedTextRangeActionVm, AccessibilitySetTextValueAction, AccessibilitySetTextValueActionValue, AccessibilitySetTextValueActionVm, AccessibilityShowContextMenuAction, AccessibilityShowContextMenuActionValue, AccessibilityShowContextMenuActionVm, AccessibilitySortDirection, AccessibilityTextSelection, AccessibilityTextSelectionVm, AccessibilityTreeUpdate, AccessibilityTreeUpdateVm, AccessibilityTristate, AccessibilityactionReplayRecord, AccessibilityactivateactionReplayRecord, AccessibilitycollapseactionReplayRecord, AccessibilitydecrementactionReplayRecord, AccessibilitydismissactionReplayRecord, AccessibilityexpandactionReplayRecord, AccessibilityfocusactionReplayRecord, AccessibilityincrementactionReplayRecord, AccessibilityscrollintoviewactionReplayRecord, AccessibilityselectactionReplayRecord, AccessibilitysetnumericvalueactionReplayRecord, AccessibilitysetselectedtextrangeactionReplayRecord, AccessibilitysettextvalueactionReplayRecord, AccessibilityshowcontextmenuactionReplayRecord};
...
use crate::platform::accessibility::simulation::{native as platform_simulation_native, vm as platform_simulation_vm};
...
fn decode_destack_accessibility_action_close_args(
    ...
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "AccessibilityActionHandle")?;
...
fn decode_destack_accessibility_action_open_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "AccessibilityActionOpenOptions")).boxed()); }
        ...
        let options_queue_capacity = decode_uint32(slots[0], "options_queue_capacity", "queueCapacity")?;
...
fn encode_destack_accessibility_action_open_result(
    ...
    result.map(|value| Ok(vm::Value::uint(value.0.0, 64))).and_then(|value| value)
}
...
fn encode_destack_accessibility_action_read_result(
    ...
    result.map(|value| match value { AccessibilityActionVm::AccessibilityActivateAction(value) => { let tag_value = vm::Value::uint(2236787214u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityCollapseAction(value) => { let tag_value = vm::Value::uint(1319128726u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityDecrementAction(value) => { let tag_value = vm::Value::uint(2031128575u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityDismissAction(value) => { let tag_value = vm::Value::uint(1872678456u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityExpandAction(value) => { let tag_value = vm::Value::uint(2586860255u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityFocusAction(value) => { let tag_value = vm::Value::uint(430558043u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityIncrementAction(value) => { let tag_value = vm::Value::uint(1748811128u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityScrollIntoViewAction(value) => { let tag_value = vm::Value::uint(1432855482u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilitySelectAction(value) => { let tag_value = vm::Value::uint(2850175718u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilitySetNumericValueAction(value) => { let tag_value = vm::Value::uint(2297349432u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.value)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilitySetSelectedTextRangeAction(value) => { let tag_value = vm::Value::uint(3095104548u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.anchor_offset as u64, 32)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.focus_offset as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilitySetTextValueAction(value) => { let tag_value = vm::Value::uint(1550276491u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = Ok(value.value.value()); context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, AccessibilityActionVm::AccessibilityShowContextMenuAction(value) => { let tag_value = vm::Value::uint(2866784432u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.window.0.0, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.node_id.0, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) } }).and_then(|value| value)
}
...
fn decode_destack_accessibility_tree_apply_args(
    ...
    let update = {
        if update_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("update", "AccessibilityTreeUpdate")).boxed()); }
        let slots = context.aggregate_slots(update_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 4 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("update", "expected 4 fields")).boxed()); }
        let update_root_node_id = if slots[0].tag() == vm::ValueTag::Void {
            None
        } else {
            let update_root_node_id_inner_inner = decode_uint64(slots[0], "update_root_node_id_inner_inner", "rootNodeId")?;
        ...
        let update_focused_node_id = if slots[1].tag() == vm::ValueTag::Void {
            ...
            let update_focused_node_id_inner_inner = decode_uint64(slots[1], "update_focused_node_id_inner_inner", "focusedNodeId")?;
            let update_focused_node_id_inner = AccessibilityNodeId(update_focused_node_id_inner_inner);
            Some(update_focused_node_id_inner)
        };
        let update_nodes = decode_slice::<AccessibilityNodeVm>(context, slots[2], "update_nodes", "nodes")?;
        let update_removed_node_ids = decode_slice::<AccessibilityNodeId>(context, slots[3], "update_removed_node_ids", "removedNodeIds")?;
...
pub(crate) const ACCESSIBILITY_TREE_CLEAR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const ACCESSIBILITY_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "accessibility",
    bindings: &[
        NativeBinding::new(ACCESSIBILITY_ACTION_CLOSE, "destack.accessibility.action.close", destack_accessibility_action_close as *const ()),
        NativeBinding::new(ACCESSIBILITY_ACTION_OPEN, "destack.accessibility.action.open", destack_accessibility_action_open as *const ()),
        NativeBinding::new(ACCESSIBILITY_ACTION_READ, "destack.accessibility.action.read", destack_accessibility_action_read as *const ()),
        NativeBinding::new(ACCESSIBILITY_ACTION_TRY_READ, "destack.accessibility.action.tryRead", destack_accessibility_action_try_read as *const ()),
        NativeBinding::new(ACCESSIBILITY_TREE_APPLY, "destack.accessibility.tree.apply", destack_accessibility_tree_apply as *const ()),
        NativeBinding::new(ACCESSIBILITY_TREE_CLEAR, "destack.accessibility.tree.clear", destack_accessibility_tree_clear as *const ()),
    ],
};
...
fn destack_accessibility_action_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_accessibility_action_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_accessibility_action_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    ...
                    AccessibilityActionCloseReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_accessibility_action_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_accessibility_action_open(binding, out, window, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_accessibility_action_open(binding, out, window, options) },
        },
        |result| {
            if let Ok(()) = result {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    AccessibilityActionOpenReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_accessibility_tree_apply_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_accessibility_tree_apply(binding, window, update) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_accessibility_tree_apply(binding, window, update) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    AccessibilityTreeApplyReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_accessibility_tree_clear_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_accessibility_tree_clear(binding, window) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_accessibility_tree_clear(binding, window) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    AccessibilityTreeClearReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
pub(crate) unsafe extern "C" fn destack_accessibility_action_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_accessibility_action_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_accessibility_action_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_READ)?;
...
pub(crate) unsafe extern "C" fn destack_accessibility_action_try_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_TRY_READ)?;
...
pub(crate) unsafe extern "C" fn destack_accessibility_tree_apply(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_TREE_APPLY)?;
...
pub(crate) unsafe extern "C" fn destack_accessibility_tree_clear(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(ACCESSIBILITY_TREE_CLEAR)?;
...
fn destack_accessibility_action_close_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_accessibility_action_close(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_accessibility_action_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_accessibility_action_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_accessibility_action_open(binding, context, window, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_accessibility_action_open(binding, context, window, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_accessibility_tree_apply_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_accessibility_tree_apply(binding, context, window, update),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_accessibility_tree_apply(binding, context, window, update),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_accessibility_tree_clear_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_accessibility_tree_clear(binding, context, window),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_accessibility_tree_clear(binding, context, window),
            }
        },
        |context, result| {
            let _ = &context;
...
pub(crate) fn register_accessibility_vm_bindings(
    ...
    {
        binding!(registry, isolate, ACCESSIBILITY_ACTION_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_accessibility_action_close_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_CLOSE)?;
    ...
    {
        binding!(registry, isolate, ACCESSIBILITY_ACTION_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (window, options) = decode_destack_accessibility_action_open_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_OPEN)?;
                destack_accessibility_action_open_vm_replay(binding, context, world, window, options)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, ACCESSIBILITY_ACTION_READ, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, timeoutns) = decode_destack_accessibility_action_read_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_READ)?;
                destack_accessibility_action_read_vm_replay(binding, context, world, handle, timeoutns)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, ACCESSIBILITY_ACTION_TRY_READ, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_accessibility_action_try_read_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_ACTION_TRY_READ)?;
    ...
    {
        binding!(registry, isolate, ACCESSIBILITY_TREE_APPLY, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (window, update) = decode_destack_accessibility_tree_apply_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_TREE_APPLY)?;
                destack_accessibility_tree_apply_vm_replay(binding, context, world, window, update)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, ACCESSIBILITY_TREE_CLEAR, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (window,) = decode_destack_accessibility_tree_clear_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(ACCESSIBILITY_TREE_CLEAR)?;
