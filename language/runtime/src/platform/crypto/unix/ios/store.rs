...
/// Snapshot codec configuration for iOS host key-store blobs.
const IOS_SNAPSHOT_CONFIG: SnapshotConfig = SnapshotConfig {
    store_label: "ios",
    associated_data: b"destack.crypto.ios.snapshot.v1",
};
