...
/// Snapshot codec configuration for Android host key-store blobs.
const ANDROID_SNAPSHOT_CONFIG: SnapshotConfig = SnapshotConfig {
    store_label: "android",
    associated_data: b"destack.crypto.android.snapshot.v1",
};
