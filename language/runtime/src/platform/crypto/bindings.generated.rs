...
use crate::platform::crypto::{CryptoCertificateFormat, CryptoCertificateMetadata, CryptoCertificateMetadataVm, CryptoCertificatePurpose, CryptoCertificateQuery, CryptoCertificateQueryVm, CryptoCertificateVerifyRequest, CryptoCertificateVerifyRequestVm, CryptoCertificateVerifyResult, CryptoCertificateVerifyResultVm, CryptoEncryptionScheme, CryptoKeyAlgorithm, CryptoKeyFormat, CryptoKeyMetadata, CryptoKeyMetadataVm, CryptoKeyQuery, CryptoKeyQueryVm, CryptoKeySpec, CryptoKeySpecVm, CryptoKeyUsageMask, CryptoSignatureScheme, CryptoStoreKind, CryptoStoreOptions, CryptoStoreOptionsVm};
...
use crate::platform::crypto::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn encode_destack_crypto_certificate_metadata_result(
    ...
    result.map(|value| { let field_0 = value.subject.value(); let field_1 = value.issuer.value(); let field_2 = value.serial_number.value(); let field_3 = value.subject_alternative_names.to_value(context); let field_4 = value.fingerprint_sha256.to_value(context); let field_5 = { let field_0 = vm::Value::uint(value.validity.not_before_unix_seconds, 64); let field_1 = vm::Value::uint(value.validity.not_after_unix_seconds, 64); context.allocate_aggregate(vec![field_0, field_1]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5]) })
}
...
fn decode_destack_crypto_certificate_verify_args(
    ...
    let request = {
        ...
        if slots.len() != 6 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("request", "expected 6 fields")).boxed()); }
        ...
        let request_verification_unix_seconds = decode_uint64(slots[5], "request_verification_unix_seconds", "verificationUnixSeconds")?;
...
fn encode_destack_crypto_certificate_verify_result(
    ...
    result.map(|value| { let field_0 = vm::Value::bool(value.valid); let field_1 = vm::Value::uint(value.error_code as u64, 32); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_crypto_key_decrypt_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::CryptoKeyHandle, CryptoEncryptionScheme, VmSlice<u8>)> {
...
fn decode_destack_crypto_key_export_public_args(
    ...
    let format = match format_raw { 1u8 => CryptoKeyFormat::Pkcs8Pem, 2u8 => CryptoKeyFormat::Pkcs8Der, 3u8 => CryptoKeyFormat::SpkiPem, 4u8 => CryptoKeyFormat::SpkiDer, 5u8 => CryptoKeyFormat::Jwk, 6u8 => CryptoKeyFormat::Raw , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("format", "unknown CryptoKeyFormat value")).boxed()), };
    Ok((handle, format))
}
...
fn decode_destack_crypto_key_generate_args(
    ...
    let spec = {
        if spec_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("spec", "CryptoKeySpec")).boxed()); }
        let slots = context.aggregate_slots(spec_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 6 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("spec", "expected 6 fields")).boxed()); }
        let spec_algorithm_raw = decode_uint8(slots[0], "spec_algorithm_raw", "algorithm")?;
        let spec_algorithm = match spec_algorithm_raw { 1u8 => CryptoKeyAlgorithm::Rsa, 2u8 => CryptoKeyAlgorithm::Ec, 3u8 => CryptoKeyAlgorithm::Ed25519, 4u8 => CryptoKeyAlgorithm::X25519, 5u8 => CryptoKeyAlgorithm::Aes, 6u8 => CryptoKeyAlgorithm::Hmac , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("spec_algorithm", "unknown CryptoKeyAlgorithm value")).boxed()), };
...
fn decode_destack_crypto_key_import_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::CryptoStoreHandle, CryptoKeyFormat, VmSlice<u8>, CryptoKeyUsageMask, vm::StringHandle)> {
    let store_value = arg_value(args, 0, "store", "CryptoStoreHandle")?;
    let store_inner_inner = decode_uint64(store_value, "store_inner_inner", "CryptoStoreHandle")?;
    let store_inner = resource::ResourceId(store_inner_inner);
    let store = resource::CryptoStoreHandle(store_inner);
    ...
    let argument_bytes = decode_slice::<u8>(context, argument_bytes_value, "argument_bytes", "Slice<uint8>")?;
...
fn encode_destack_crypto_key_metadata_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.algorithm as u8 as u64, 8); let field_1 = vm::Value::uint(value.size_bits as u64, 32); let field_2 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_3 = value.label.value(); let field_4 = vm::Value::bool(value.extractable); let field_5 = vm::Value::bool(value.hardware_backed); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5]) })
}
...
fn decode_destack_crypto_key_sign_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::CryptoKeyHandle, CryptoSignatureScheme, VmSlice<u8>)> {
    let handle_value = arg_value(args, 0, "handle", "CryptoKeyHandle")?;
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "CryptoKeyHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
    let handle = resource::CryptoKeyHandle(handle_inner);
...
fn decode_destack_crypto_key_verify_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::CryptoKeyHandle, CryptoSignatureScheme, VmSlice<u8>, VmSlice<u8>)> {
    let handle_value = arg_value(args, 0, "handle", "CryptoKeyHandle")?;
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "CryptoKeyHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
    let handle = resource::CryptoKeyHandle(handle_inner);
...
fn decode_destack_crypto_store_list_certificates_args(
    ...
    let query = {
        ...
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("query", "expected 3 fields")).boxed()); }
...
fn decode_destack_crypto_store_open_args(
    ...
    let options = {
        ...
        if slots.len() != 2 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options", "expected 2 fields")).boxed()); }
        let options_kind_raw = decode_uint8(slots[0], "options_kind_raw", "kind")?;
        let options_kind = match options_kind_raw { 0u8 => CryptoStoreKind::System, 1u8 => CryptoStoreKind::User, 2u8 => CryptoStoreKind::Machine, 3u8 => CryptoStoreKind::Provider , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_kind", "unknown CryptoStoreKind value")).boxed()), };
        let options_provider_name = decode_string(slots[1], "options_provider_name", "providerName")?;
...
pub const CRYPTO_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    ...
    bindings: &[
        ...
        NativeBinding::new(CRYPTO_CERTIFICATE_METADATA, "destack.crypto.certificate.metadata", destack_crypto_certificate_metadata as *const ()),
        ...
        NativeBinding::new(CRYPTO_KEY_GENERATE, "destack.crypto.key.generate", destack_crypto_key_generate as *const ()),
        NativeBinding::new(CRYPTO_KEY_IMPORT, "destack.crypto.key.import", destack_crypto_key_import as *const ()),
        NativeBinding::new(CRYPTO_KEY_METADATA, "destack.crypto.key.metadata", destack_crypto_key_metadata as *const ()),
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_certificate_delete(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_certificate_export(context, out, handle, format) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_certificate_import(context, out, store, format, certificate) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_certificate_metadata(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_certificate_metadata(context, out, handle) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_certificate_metadata(context, out, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_certificate_verify(context, out, request) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_decrypt(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_decrypt(context, out, handle, scheme, argument_payload) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_decrypt(context, out, handle, scheme, argument_payload) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_delete(context, handle) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_encrypt(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_encrypt(context, out, handle, scheme, argument_payload) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_encrypt(context, out, handle, scheme, argument_payload) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_export_public(context, out, handle, format) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_generate(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_generate(context, out, store, spec) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_generate(context, out, store, spec) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_import(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_import(context, out, store, format, argument_bytes, usagemask, label) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_import(context, out, store, format, argument_bytes, usagemask, label) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_metadata(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_metadata(context, out, handle) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_metadata(context, out, handle) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_sign(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_sign(context, out, handle, scheme, argument_payload) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_sign(context, out, handle, scheme, argument_payload) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_crypto_key_verify(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_crypto_key_verify(context, out, handle, scheme, argument_payload, signature) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_key_verify(context, out, handle, scheme, argument_payload, signature) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_store_close(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_store_list_certificates(context, out, handle, query) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_store_list_keys(context, out, handle, query) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_crypto_store_open(context, out, options) },
            }
        }
    })
}
...
pub fn register_crypto_vm_bindings(
        ...
        binding!(registry, isolate, CRYPTO_CERTIFICATE_DELETE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_certificate_delete(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_certificate_delete(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_CERTIFICATE_EXPORT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_certificate_export(runtime, context, handle, format),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_certificate_export(runtime, context, handle, format),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_CERTIFICATE_IMPORT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_certificate_import(runtime, context, store, format, certificate),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_certificate_import(runtime, context, store, format, certificate),
                        }
                    };
    ...
    {
        binding!(registry, isolate, CRYPTO_CERTIFICATE_METADATA, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_certificate_metadata(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_certificate_metadata(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_CERTIFICATE_VERIFY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_certificate_verify(runtime, context, request),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_certificate_verify(runtime, context, request),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_KEY_DECRYPT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, scheme, argument_payload) = decode_destack_crypto_key_decrypt_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_KEY_DECRYPT)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_decrypt(runtime, context, handle, scheme, argument_payload),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_decrypt(runtime, context, handle, scheme, argument_payload),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_KEY_DELETE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_delete(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_delete(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_KEY_ENCRYPT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, scheme, argument_payload) = decode_destack_crypto_key_encrypt_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_KEY_ENCRYPT)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_encrypt(runtime, context, handle, scheme, argument_payload),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_encrypt(runtime, context, handle, scheme, argument_payload),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_KEY_EXPORT_PUBLIC, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_export_public(runtime, context, handle, format),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_export_public(runtime, context, handle, format),
                        }
                    };
    ...
    {
        binding!(registry, isolate, CRYPTO_KEY_GENERATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_generate(runtime, context, store, spec),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_generate(runtime, context, store, spec),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_KEY_IMPORT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (store, format, argument_bytes, usagemask, label) = decode_destack_crypto_key_import_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_KEY_IMPORT)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_import(runtime, context, store, format, argument_bytes, usagemask, label),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_import(runtime, context, store, format, argument_bytes, usagemask, label),
                        }
                    };
    ...
    {
        binding!(registry, isolate, CRYPTO_KEY_METADATA, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_metadata(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_metadata(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_KEY_SIGN, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, scheme, argument_payload) = decode_destack_crypto_key_sign_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_KEY_SIGN)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_sign(runtime, context, handle, scheme, argument_payload),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_sign(runtime, context, handle, scheme, argument_payload),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_KEY_VERIFY, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, scheme, argument_payload, signature) = decode_destack_crypto_key_verify_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_KEY_VERIFY)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_key_verify(runtime, context, handle, scheme, argument_payload, signature),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_key_verify(runtime, context, handle, scheme, argument_payload, signature),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_STORE_CLOSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_store_close(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_store_close(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, CRYPTO_STORE_LIST_CERTIFICATES, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(CRYPTO_STORE_LIST_CERTIFICATES)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_store_list_certificates(runtime, context, handle, query),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_store_list_certificates(runtime, context, handle, query),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_STORE_LIST_KEYS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_store_list_keys(runtime, context, handle, query),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_store_list_keys(runtime, context, handle, query),
                        }
                    };
        ...
        binding!(registry, isolate, CRYPTO_STORE_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_crypto_store_open(runtime, context, options),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_crypto_store_open(runtime, context, options),
                        }
                    };
