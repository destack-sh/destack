...
fn decode_destack_crypto_agreement_derive_shared_secret_args(
    ...
    let algorithm_raw = decode_uint8(algorithm_value, "algorithm_raw", "CryptoKeyAgreementAlgorithm")?;
    let algorithm = match algorithm_raw { 0u8 => CryptoKeyAgreementAlgorithm::Unknown, 1u8 => CryptoKeyAgreementAlgorithm::Ecdh, 2u8 => CryptoKeyAgreementAlgorithm::X25519, 3u8 => CryptoKeyAgreementAlgorithm::X448 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("algorithm", "unknown CryptoKeyAgreementAlgorithm value")).boxed()), };
...
fn encode_destack_crypto_certificate_descriptor_result(
    ...
    result.map(|value| { let field_0 = value.subject.value(); let field_1 = value.issuer.value(); let field_2 = value.serial_number.value(); let field_3 = value.subject_alternative_names.to_value(context); let field_4 = value.fingerprint_sha256.to_value(context); let field_5 = { let field_0 = vm::Value::uint(value.validity.not_before_unix_seconds, 64); let field_1 = vm::Value::uint(value.validity.not_after_unix_seconds, 64); context.allocate_aggregate(vec![field_0, field_1]) }; let field_6 = vm::Value::bool(value.is_certificate_authority); let field_7 = vm::Value::uint(value.key_usage_mask as u64, 32); let field_8 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8]) })
}
...
fn decode_destack_crypto_certificate_export_args(
    ...
    let format = match format_raw { 1u8 => CryptoCertificateFormat::Pem, 2u8 => CryptoCertificateFormat::Der , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("format", "unknown CryptoCertificateFormat value")).boxed()), };
    Ok((handle, format))
}
...
fn decode_destack_crypto_certificate_verify_args(
    ...
    let request = {
        ...
        let request_purpose = match request_purpose_raw { 1u8 => CryptoCertificatePurpose::ServerAuth, 2u8 => CryptoCertificatePurpose::ClientAuth, 3u8 => CryptoCertificatePurpose::CodeSigning, 4u8 => CryptoCertificatePurpose::EmailProtection , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("request_purpose", "unknown CryptoCertificatePurpose value")).boxed()), };
        let request_identity = if slots[5].tag() == vm::ValueTag::Void {
            ...
            let request_identity_inner = {
                ...
                let request_identity_inner_kind_raw = decode_uint8(slots[0], "request_identity_inner_kind_raw", "kind")?;
                let request_identity_inner_kind = match request_identity_inner_kind_raw { 1u8 => CryptoCertificateIdentityKind::DnsName, 2u8 => CryptoCertificateIdentityKind::IpAddress, 3u8 => CryptoCertificateIdentityKind::Uri, 4u8 => CryptoCertificateIdentityKind::EmailAddress , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("request_identity_inner_kind", "unknown CryptoCertificateIdentityKind value")).boxed()), };
        ...
        let request_revocation_mode_raw = decode_uint8(slots[7], "request_revocation_mode_raw", "revocationMode")?;
        let request_revocation_mode = match request_revocation_mode_raw { 1u8 => CryptoCertificateRevocationMode::Default, 2u8 => CryptoCertificateRevocationMode::Strict, 3u8 => CryptoCertificateRevocationMode::Disabled , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("request_revocation_mode", "unknown CryptoCertificateRevocationMode value")).boxed()), };
...
fn encode_destack_crypto_certificate_verify_result(
    ...
    result.map(|value| { let field_0 = vm::Value::bool(value.valid); let field_1 = vm::Value::uint(value.error as u8 as u64, 8); let field_2 = vm::Value::uint(value.error_code as u64, 32); let field_3 = match value.failed_certificate_index { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_4 = match value.failed_certificate_subject { Some(value) => value.value(), None => vm::Value::VOID }; let field_5 = vm::Value::uint(value.chain_length as u64, 32); let field_6 = vm::Value::bool(value.used_system_trust_anchor); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6]) })
}
...
fn decode_destack_crypto_cipher_decrypt_args(
    ...
    let parameters = {
        ...
        let parameters_algorithm_raw = decode_uint8(slots[0], "parameters_algorithm_raw", "algorithm")?;
        let parameters_algorithm = match parameters_algorithm_raw { 0u8 => CryptoCipherAlgorithm::Unknown, 1u8 => CryptoCipherAlgorithm::AesGcm, 2u8 => CryptoCipherAlgorithm::AesCtr, 3u8 => CryptoCipherAlgorithm::AesCbc, 4u8 => CryptoCipherAlgorithm::ChaCha20Poly1305 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters_algorithm", "unknown CryptoCipherAlgorithm value")).boxed()), };
...
fn encode_destack_crypto_cipher_encrypt_result(
    ...
    result.map(|value| { let field_0 = value.bytes.to_value(context); let field_1 = value.tag.to_value(context); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_crypto_cipher_open_args(
    ...
    let direction = match direction_raw { 1u8 => CryptoCipherDirection::Encrypt, 2u8 => CryptoCipherDirection::Decrypt , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("direction", "unknown CryptoCipherDirection value")).boxed()), };
...
fn decode_destack_crypto_digest_compute_args(
    ...
    let algorithm = match algorithm_raw { 0u8 => CryptoDigestAlgorithm::Unknown, 1u8 => CryptoDigestAlgorithm::Sha1, 2u8 => CryptoDigestAlgorithm::Sha224, 3u8 => CryptoDigestAlgorithm::Sha256, 4u8 => CryptoDigestAlgorithm::Sha384, 5u8 => CryptoDigestAlgorithm::Sha512, 6u8 => CryptoDigestAlgorithm::Sha3_256, 7u8 => CryptoDigestAlgorithm::Sha3_384, 8u8 => CryptoDigestAlgorithm::Sha3_512, 9u8 => CryptoDigestAlgorithm::Blake2b512, 10u8 => CryptoDigestAlgorithm::Blake2s256 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("algorithm", "unknown CryptoDigestAlgorithm value")).boxed()), };
    let argument_payload_value = arg_value(args, 1, "argument_payload", "Slice<uint8>")?;
    let argument_payload = decode_slice::<u8>(context, argument_payload_value, "argument_payload", "Slice<uint8>")?;
...
fn encode_destack_crypto_key_descriptor_result(
    ...
    result.map(|value| match value { CryptoKeyDescriptorVm::CryptoKeyDescriptorAes(value) => { let tag_value = vm::Value::uint(3329037564u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = match value.size_bits { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_3 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_4 = value.label.value(); let field_5 = vm::Value::bool(value.extractable); let field_6 = vm::Value::uint(value.residency as u8 as u64, 8); let field_7 = vm::Value::bool(value.hardware_backed); let field_8 = vm::Value::bool(value.persistent); let field_9 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorChaCha20(value) => { let tag_value = vm::Value::uint(2610676967u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = match value.size_bits { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_3 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_4 = value.label.value(); let field_5 = vm::Value::bool(value.extractable); let field_6 = vm::Value::uint(value.residency as u8 as u64, 8); let field_7 = vm::Value::bool(value.hardware_backed); let field_8 = vm::Value::bool(value.persistent); let field_9 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorEc(value) => { let tag_value = vm::Value::uint(4256206084u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = match value.named_curve { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_3 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_4 = value.label.value(); let field_5 = vm::Value::bool(value.extractable); let field_6 = vm::Value::uint(value.residency as u8 as u64, 8); let field_7 = vm::Value::bool(value.hardware_backed); let field_8 = vm::Value::bool(value.persistent); let field_9 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorEd25519(value) => { let tag_value = vm::Value::uint(2715380390u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_3 = value.label.value(); let field_4 = vm::Value::bool(value.extractable); let field_5 = vm::Value::uint(value.residency as u8 as u64, 8); let field_6 = vm::Value::bool(value.hardware_backed); let field_7 = vm::Value::bool(value.persistent); let field_8 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorEd448(value) => { let tag_value = vm::Value::uint(1419371965u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_3 = value.label.value(); let field_4 = vm::Value::bool(value.extractable); let field_5 = vm::Value::uint(value.residency as u8 as u64, 8); let field_6 = vm::Value::bool(value.hardware_backed); let field_7 = vm::Value::bool(value.persistent); let field_8 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorHmac(value) => { let tag_value = vm::Value::uint(2590550128u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = match value.size_bits { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_3 = match value.digest { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_4 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_5 = value.label.value(); let field_6 = vm::Value::bool(value.extractable); let field_7 = vm::Value::uint(value.residency as u8 as u64, 8); let field_8 = vm::Value::bool(value.hardware_backed); let field_9 = vm::Value::bool(value.persistent); let field_10 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorRsa(value) => { let tag_value = vm::Value::uint(3734490529u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = match value.modulus_bits { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_3 = match value.public_exponent { Some(value) => vm::Value::uint(value as u64, 32), None => vm::Value::VOID }; let field_4 = match value.digest { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_5 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_6 = value.label.value(); let field_7 = vm::Value::bool(value.extractable); let field_8 = vm::Value::uint(value.residency as u8 as u64, 8); let field_9 = vm::Value::bool(value.hardware_backed); let field_10 = vm::Value::bool(value.persistent); let field_11 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorX25519(value) => { let tag_value = vm::Value::uint(2316288397u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_3 = value.label.value(); let field_4 = vm::Value::bool(value.extractable); let field_5 = vm::Value::uint(value.residency as u8 as u64, 8); let field_6 = vm::Value::bool(value.hardware_backed); let field_7 = vm::Value::bool(value.persistent); let field_8 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, CryptoKeyDescriptorVm::CryptoKeyDescriptorX448(value) => { let tag_value = vm::Value::uint(1911697504u64, 32); let payload_value = { let field_0 = value.algorithm.value(); let field_1 = vm::Value::uint(value.key_kind as u8 as u64, 8); let field_2 = vm::Value::uint(value.usage_mask.0 as u64, 32); let field_3 = value.label.value(); let field_4 = vm::Value::bool(value.extractable); let field_5 = vm::Value::uint(value.residency as u8 as u64, 8); let field_6 = vm::Value::bool(value.hardware_backed); let field_7 = vm::Value::bool(value.persistent); let field_8 = { let field_0 = { let field_0 = vm::Value::uint(value.store_provenance.identity.kind as u8 as u64, 8); let field_1 = match value.store_provenance.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.store_provenance.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8]) }; context.allocate_aggregate(vec![tag_value, payload_value]) } })
}
...
fn decode_destack_crypto_key_export_public_args(
    ...
    let format = match format_raw { 0u8 => CryptoKeyFormat::Unknown, 1u8 => CryptoKeyFormat::Pkcs8Pem, 2u8 => CryptoKeyFormat::Pkcs8Der, 3u8 => CryptoKeyFormat::SpkiPem, 4u8 => CryptoKeyFormat::SpkiDer, 5u8 => CryptoKeyFormat::Jwk, 6u8 => CryptoKeyFormat::Raw, 7u8 => CryptoKeyFormat::Sec1Pem, 8u8 => CryptoKeyFormat::Sec1Der, 9u8 => CryptoKeyFormat::Pkcs8EncryptedPem, 10u8 => CryptoKeyFormat::Pkcs8EncryptedDer , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("format", "unknown CryptoKeyFormat value")).boxed()), };
    Ok((handle, format))
}
...
fn encode_destack_crypto_key_generate_pair_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.public_key.0.0, 64); let field_1 = vm::Value::uint(value.private_key.0.0, 64); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_crypto_key_unwrap_args(
    ...
    let parameters = {
        ...
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters", "expected 3 fields")).boxed()); }
        let parameters_algorithm_raw = decode_uint8(slots[0], "parameters_algorithm_raw", "algorithm")?;
        let parameters_algorithm = match parameters_algorithm_raw { 0u8 => CryptoKeyWrapAlgorithm::Unknown, 1u8 => CryptoKeyWrapAlgorithm::RsaOaep, 2u8 => CryptoKeyWrapAlgorithm::AesKw, 3u8 => CryptoKeyWrapAlgorithm::AesKwp , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters_algorithm", "unknown CryptoKeyWrapAlgorithm value")).boxed()), };
        let parameters_digest = if slots[1].tag() == vm::ValueTag::Void {
            None
        } else {
            let parameters_digest_inner_raw = decode_uint8(slots[1], "parameters_digest_inner_raw", "digest")?;
...
fn decode_destack_crypto_mac_compute_args(
    ...
    let parameters = {
        ...
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters", "expected 3 fields")).boxed()); }
        let parameters_algorithm_raw = decode_uint8(slots[0], "parameters_algorithm_raw", "algorithm")?;
        let parameters_algorithm = match parameters_algorithm_raw { 0u8 => CryptoMacAlgorithm::Unknown, 1u8 => CryptoMacAlgorithm::Hmac , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters_algorithm", "unknown CryptoMacAlgorithm value")).boxed()), };
        let parameters_digest_raw = decode_uint8(slots[1], "parameters_digest_raw", "digest")?;
        let parameters_digest = match parameters_digest_raw { 0u8 => CryptoDigestAlgorithm::Unknown, 1u8 => CryptoDigestAlgorithm::Sha1, 2u8 => CryptoDigestAlgorithm::Sha224, 3u8 => CryptoDigestAlgorithm::Sha256, 4u8 => CryptoDigestAlgorithm::Sha384, 5u8 => CryptoDigestAlgorithm::Sha512, 6u8 => CryptoDigestAlgorithm::Sha3_256, 7u8 => CryptoDigestAlgorithm::Sha3_384, 8u8 => CryptoDigestAlgorithm::Sha3_512, 9u8 => CryptoDigestAlgorithm::Blake2b512, 10u8 => CryptoDigestAlgorithm::Blake2s256 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("parameters_digest", "unknown CryptoDigestAlgorithm value")).boxed()), };
...
fn encode_destack_crypto_store_list_certificates_result(
    ...
    result.map(|value| { let field_0 = value.entries.to_value(context); let field_1 = match value.next_cursor { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_crypto_store_list_keys_args(
    ...
    let query = {
        ...
        let query_algorithm = if slots[1].tag() == vm::ValueTag::Void {
            ...
            let query_algorithm_inner_raw = decode_uint8(slots[1], "query_algorithm_inner_raw", "algorithm")?;
...
fn decode_destack_crypto_store_open_args(
    ...
    let options = {
        ...
        let options_kind = match options_kind_raw { 0u8 => CryptoStoreKind::System, 1u8 => CryptoStoreKind::User, 2u8 => CryptoStoreKind::Machine, 3u8 => CryptoStoreKind::Provider, 4u8 => CryptoStoreKind::Ephemeral , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_kind", "unknown CryptoStoreKind value")).boxed()), };
        let options_provider = if slots[1].tag() == vm::ValueTag::Void {
            None
        } else {
            let options_provider_inner_raw = decode_uint8(slots[1], "options_provider_inner_raw", "provider")?;
            let options_provider_inner = match options_provider_inner_raw { 1u8 => CryptoStoreProvider::OpenSsl , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_provider_inner", "unknown CryptoStoreProvider value")).boxed()), };
...
fn decode_destack_crypto_store_probe_capability_args(
    ...
    let kind = match kind_raw { 0u8 => CryptoStoreKind::System, 1u8 => CryptoStoreKind::User, 2u8 => CryptoStoreKind::Machine, 3u8 => CryptoStoreKind::Provider, 4u8 => CryptoStoreKind::Ephemeral , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("kind", "unknown CryptoStoreKind value")).boxed()), };
    let provider_value = arg_value(args, 1, "provider", "CryptoStoreProvider")?;
    let provider = if provider_value.tag() == vm::ValueTag::Void {
        None
    } else {
        let provider_inner_raw = decode_uint8(provider_value, "provider_inner_raw", "CryptoStoreProvider")?;
        let provider_inner = match provider_inner_raw { 1u8 => CryptoStoreProvider::OpenSsl , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("provider_inner", "unknown CryptoStoreProvider value")).boxed()), };
        Some(provider_inner)
    };
    Ok((kind, provider))
}
...
fn encode_destack_crypto_store_probe_capability_result(
    ...
    result.map(|value| { let field_0 = { let field_0 = vm::Value::uint(value.identity.kind as u8 as u64, 8); let field_1 = match value.identity.provider { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_2 = match value.identity.namespace { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; let field_1 = vm::Value::bool(value.is_available); let field_2 = vm::Value::bool(value.supports_hardware_backed); let field_3 = vm::Value::bool(value.supports_persistent); let field_4 = vm::Value::bool(value.supports_key_export); let field_5 = value.supported_key_algorithms.to_value(context); let field_6 = value.supported_key_formats.to_value(context); let field_7 = value.supported_key_residencies.to_value(context); let field_8 = value.key_capabilities.to_value(context); let field_9 = value.signature_capabilities.to_value(context); let field_10 = value.asymmetric_encryption_capabilities.to_value(context); let field_11 = value.key_wrap_capabilities.to_value(context); let field_12 = value.cipher_capabilities.to_value(context); let field_13 = value.mac_capabilities.to_value(context); let field_14 = value.agreement_capabilities.to_value(context); let field_15 = { let field_0 = vm::Value::bool(value.certificate_capabilities.supports_import); let field_1 = vm::Value::bool(value.certificate_capabilities.supports_export); let field_2 = vm::Value::bool(value.certificate_capabilities.supports_descriptor); let field_3 = vm::Value::bool(value.certificate_capabilities.supports_verify); let field_4 = vm::Value::bool(value.certificate_capabilities.supports_delete); let field_5 = vm::Value::bool(value.certificate_capabilities.supports_system_trust_anchors); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5]) }; context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13, field_14, field_15]) })
}
...
pub const CRYPTO_CIPHER_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_DIGEST_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_DIGEST_RESET: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_KDF_HKDF: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_KEY_DELETE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_MAC_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_MAC_FINISH: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_MAC_RESET: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_KDF_ALGORITHMS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_KEY_ALGORITHMS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_KEY_FORMATS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_KEY_RESIDENCIES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_MAC_ALGORITHMS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_PROBE_NAMED_CURVES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_RANDOM_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_RANDOM_FILL: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_STORE_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CRYPTO_STORE_PROBE_KINDS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded_identity = CryptoStoreIdentityValue {
                ...
                for result_recorded_supported_key_algorithms_item in unsafe { result_value.supported_key_algorithms.as_slice()? } {
                ...
                for result_recorded_supported_key_formats_item in unsafe { result_value.supported_key_formats.as_slice()? } {
                ...
                for result_recorded_supported_key_residencies_item in unsafe { result_value.supported_key_residencies.as_slice()? } {
                ...
                for result_recorded_key_capabilities_item in unsafe { result_value.key_capabilities.as_slice()? } {
                    ...
                    let result_recorded_key_capabilities_item_recorded_supported_usage_mask = result_recorded_key_capabilities_item.supported_usage_mask.0;
                    let mut result_recorded_key_capabilities_item_recorded_supported_import_formats = Vec::new();
                    for result_recorded_key_capabilities_item_recorded_supported_import_formats_item in unsafe { result_recorded_key_capabilities_item.supported_import_formats.as_slice()? } {
                    ...
                    for result_recorded_key_capabilities_item_recorded_supported_export_formats_item in unsafe { result_recorded_key_capabilities_item.supported_export_formats.as_slice()? } {
                    ...
                    let result_recorded_key_capabilities_item_recorded = CryptoStoreKeyCapabilityValue {
                ...
                for result_recorded_signature_capabilities_item in unsafe { result_value.signature_capabilities.as_slice()? } {
                    ...
                    for result_recorded_signature_capabilities_item_recorded_supported_digests_item in unsafe { result_recorded_signature_capabilities_item.supported_digests.as_slice()? } {
                    ...
                    let result_recorded_signature_capabilities_item_recorded = CryptoStoreSignatureCapabilityValue {
                ...
                for result_recorded_asymmetric_encryption_capabilities_item in unsafe { result_value.asymmetric_encryption_capabilities.as_slice()? } {
                    ...
                    for result_recorded_asymmetric_encryption_capabilities_item_recorded_supported_digests_item in unsafe { result_recorded_asymmetric_encryption_capabilities_item.supported_digests.as_slice()? } {
                    ...
                    let result_recorded_asymmetric_encryption_capabilities_item_recorded = CryptoStoreAsymmetricEncryptionCapabilityValue {
                ...
                for result_recorded_key_wrap_capabilities_item in unsafe { result_value.key_wrap_capabilities.as_slice()? } {
                    ...
                    for result_recorded_key_wrap_capabilities_item_recorded_supported_digests_item in unsafe { result_recorded_key_wrap_capabilities_item.supported_digests.as_slice()? } {
                    ...
                    let result_recorded_key_wrap_capabilities_item_recorded = CryptoStoreKeyWrapCapabilityValue {
                ...
                for result_recorded_cipher_capabilities_item in unsafe { result_value.cipher_capabilities.as_slice()? } {
                ...
                for result_recorded_mac_capabilities_item in unsafe { result_value.mac_capabilities.as_slice()? } {
                    ...
                    for result_recorded_mac_capabilities_item_recorded_supported_digests_item in unsafe { result_recorded_mac_capabilities_item.supported_digests.as_slice()? } {
                    ...
                    let result_recorded_mac_capabilities_item_recorded = CryptoStoreMacCapabilityValue {
                ...
                for result_recorded_agreement_capabilities_item in unsafe { result_value.agreement_capabilities.as_slice()? } {
                ...
                let result_recorded = CryptoStoreCapabilityValue {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_supported_key_algorithms_item in value.supported_key_algorithms.iter() {
                    ...
                    for value_native_supported_key_formats_item in value.supported_key_formats.iter() {
                    ...
                    for value_native_supported_key_residencies_item in value.supported_key_residencies.iter() {
                    ...
                    for value_native_key_capabilities_item in value.key_capabilities.iter() {
                        ...
                        let value_native_key_capabilities_decoded_supported_usage_mask = CryptoKeyUsageMask(value_native_key_capabilities_item.supported_usage_mask);
                        let mut value_native_key_capabilities_decoded_supported_import_formats_values = Vec::new();
                        for value_native_key_capabilities_decoded_supported_import_formats_item in value_native_key_capabilities_item.supported_import_formats.iter() {
                        ...
                        let value_native_key_capabilities_decoded_supported_import_formats = binding.store_array(value_native_key_capabilities_decoded_supported_import_formats_values);
                        let mut value_native_key_capabilities_decoded_supported_export_formats_values = Vec::new();
                        for value_native_key_capabilities_decoded_supported_export_formats_item in value_native_key_capabilities_item.supported_export_formats.iter() {
                        ...
                        let value_native_key_capabilities_decoded_supported_export_formats = binding.store_array(value_native_key_capabilities_decoded_supported_export_formats_values);
                    ...
                    for value_native_signature_capabilities_item in value.signature_capabilities.iter() {
                        ...
                        for value_native_signature_capabilities_decoded_supported_digests_item in value_native_signature_capabilities_item.supported_digests.iter() {
                        ...
                        let value_native_signature_capabilities_decoded_supported_digests = binding.store_array(value_native_signature_capabilities_decoded_supported_digests_values);
                    ...
                    for value_native_asymmetric_encryption_capabilities_item in value.asymmetric_encryption_capabilities.iter() {
                        ...
                        for value_native_asymmetric_encryption_capabilities_decoded_supported_digests_item in value_native_asymmetric_encryption_capabilities_item.supported_digests.iter() {
                        ...
                        let value_native_asymmetric_encryption_capabilities_decoded_supported_digests = binding.store_array(value_native_asymmetric_encryption_capabilities_decoded_supported_digests_values);
                    ...
                    for value_native_key_wrap_capabilities_item in value.key_wrap_capabilities.iter() {
                        ...
                        for value_native_key_wrap_capabilities_decoded_supported_digests_item in value_native_key_wrap_capabilities_item.supported_digests.iter() {
                        ...
                        let value_native_key_wrap_capabilities_decoded_supported_digests = binding.store_array(value_native_key_wrap_capabilities_decoded_supported_digests_values);
                    ...
                    for value_native_cipher_capabilities_item in value.cipher_capabilities.iter() {
                    ...
                    for value_native_mac_capabilities_item in value.mac_capabilities.iter() {
                        ...
                        for value_native_mac_capabilities_decoded_supported_digests_item in value_native_mac_capabilities_item.supported_digests.iter() {
                        ...
                        let value_native_mac_capabilities_decoded_supported_digests = binding.store_array(value_native_mac_capabilities_decoded_supported_digests_values);
                    ...
                    for value_native_agreement_capabilities_item in value.agreement_capabilities.iter() {
...
pub unsafe extern "C" fn destack_crypto_random_fill(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    ...
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoKeyAgreementAlgorithm::Unknown, 1u8 => CryptoKeyAgreementAlgorithm::Ecdh, 2u8 => CryptoKeyAgreementAlgorithm::X25519, 3u8 => CryptoKeyAgreementAlgorithm::X448 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoKeyAgreementAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeAgreementAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoCipherAlgorithm::Unknown, 1u8 => CryptoCipherAlgorithm::AesGcm, 2u8 => CryptoCipherAlgorithm::AesCtr, 3u8 => CryptoCipherAlgorithm::AesCbc, 4u8 => CryptoCipherAlgorithm::ChaCha20Poly1305 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoCipherAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeCipherAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoDigestAlgorithm::Unknown, 1u8 => CryptoDigestAlgorithm::Sha1, 2u8 => CryptoDigestAlgorithm::Sha224, 3u8 => CryptoDigestAlgorithm::Sha256, 4u8 => CryptoDigestAlgorithm::Sha384, 5u8 => CryptoDigestAlgorithm::Sha512, 6u8 => CryptoDigestAlgorithm::Sha3_256, 7u8 => CryptoDigestAlgorithm::Sha3_384, 8u8 => CryptoDigestAlgorithm::Sha3_512, 9u8 => CryptoDigestAlgorithm::Blake2b512, 10u8 => CryptoDigestAlgorithm::Blake2s256 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoDigestAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeDigestAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoKdfAlgorithm::Unknown, 1u8 => CryptoKdfAlgorithm::Hkdf, 2u8 => CryptoKdfAlgorithm::Pbkdf2, 3u8 => CryptoKdfAlgorithm::Scrypt, 4u8 => CryptoKdfAlgorithm::Argon2id , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoKdfAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeKdfAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoKeyAlgorithm::Unknown, 1u8 => CryptoKeyAlgorithm::Rsa, 2u8 => CryptoKeyAlgorithm::Ec, 3u8 => CryptoKeyAlgorithm::Ed25519, 4u8 => CryptoKeyAlgorithm::Ed448, 5u8 => CryptoKeyAlgorithm::X25519, 6u8 => CryptoKeyAlgorithm::X448, 7u8 => CryptoKeyAlgorithm::Aes, 8u8 => CryptoKeyAlgorithm::ChaCha20, 9u8 => CryptoKeyAlgorithm::Hmac , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoKeyAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeKeyAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoKeyFormat::Unknown, 1u8 => CryptoKeyFormat::Pkcs8Pem, 2u8 => CryptoKeyFormat::Pkcs8Der, 3u8 => CryptoKeyFormat::SpkiPem, 4u8 => CryptoKeyFormat::SpkiDer, 5u8 => CryptoKeyFormat::Jwk, 6u8 => CryptoKeyFormat::Raw, 7u8 => CryptoKeyFormat::Sec1Pem, 8u8 => CryptoKeyFormat::Sec1Der, 9u8 => CryptoKeyFormat::Pkcs8EncryptedPem, 10u8 => CryptoKeyFormat::Pkcs8EncryptedDer , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoKeyFormat value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeKeyFormatsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoKeyWrapAlgorithm::Unknown, 1u8 => CryptoKeyWrapAlgorithm::RsaOaep, 2u8 => CryptoKeyWrapAlgorithm::AesKw, 3u8 => CryptoKeyWrapAlgorithm::AesKwp , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoKeyWrapAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeKeyWrapAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoMacAlgorithm::Unknown, 1u8 => CryptoMacAlgorithm::Hmac , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoMacAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeMacAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoNamedCurve::Unknown, 1u8 => CryptoNamedCurve::P256, 2u8 => CryptoNamedCurve::P384, 3u8 => CryptoNamedCurve::P521, 4u8 => CryptoNamedCurve::Secp256k1, 5u8 => CryptoNamedCurve::X25519, 6u8 => CryptoNamedCurve::X448, 7u8 => CryptoNamedCurve::Ed25519, 8u8 => CryptoNamedCurve::Ed448 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoNamedCurve value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeNamedCurvesReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoSignatureAlgorithm::Unknown, 1u8 => CryptoSignatureAlgorithm::RsaPkcs1v15, 2u8 => CryptoSignatureAlgorithm::RsaPss, 3u8 => CryptoSignatureAlgorithm::Ecdsa, 4u8 => CryptoSignatureAlgorithm::Ed25519, 5u8 => CryptoSignatureAlgorithm::Ed448 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoSignatureAlgorithm value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoProbeSignatureAlgorithmsReplayRecord {
    ...
    let result = binding.trace().run_binding(
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item_raw = decode_uint8(result_recorded_item_value, "result_recorded_item_raw", "item")?;
                    let result_recorded_item = match result_recorded_item_raw { 0u8 => CryptoStoreKind::System, 1u8 => CryptoStoreKind::User, 2u8 => CryptoStoreKind::Machine, 3u8 => CryptoStoreKind::Provider, 4u8 => CryptoStoreKind::Ephemeral , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "unknown CryptoStoreKind value")).boxed()), };
                    let result_recorded_item_recorded = result_recorded_item;
                    result_recorded.push(result_recorded_item_recorded);
                }
                let payload = CryptoStoreProbeKindsReplayRecord {
...
pub fn register_crypto_vm_bindings(
...
pub fn install_crypto_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
