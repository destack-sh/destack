...
pub(super) use crate::platform::core::{DynamicLibrary, load_library_with_api};
pub(super) use crate::platform::device::{
    ...
    UsbEndpointSelectorValue, UsbEndpointTransferType, UsbHotplugDetachedEvent, UsbHotplugEvent,
    UsbHotplugEventMetadata, UsbHotplugEventMetadataValue, UsbHotplugInstanceEvent,
    UsbInTransferResult, UsbInTransferResultValue, UsbInterfaceDescriptorValue,
    UsbIsochronousPacketResultValue, UsbIsochronousTransferResult,
