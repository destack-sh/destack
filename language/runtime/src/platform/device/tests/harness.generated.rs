...
use crate::platform::device::{
    ...
    CameraTorchMode, SerialErrorPayload, SerialErrorPayloadVm, SerialEvent, SerialEventKind,
    SerialEventPayload, SerialEventPayloadVm, SerialEventVm, SerialFlowControl, SerialParity,
    SerialPortConfig, SerialPortConfigVm, SerialPortDescriptor, SerialPortDescriptorVm,
    SerialReadReadyPayload, SerialReadReadyPayloadVm, SerialSignalsChangedPayload,
    SerialSignalsChangedPayloadVm, SerialStopBits, SerialWriteReadyPayload,
    ...
    UsbEndpointDescriptor, UsbEndpointDescriptorVm, UsbHotplugEvent, UsbHotplugEventKind,
    UsbHotplugEventVm, UsbInterfaceDescriptor, UsbInterfaceDescriptorVm,
    UsbIsochronousTransferResult, UsbIsochronousTransferResultVm, UsbStringDescriptor,
    UsbStringDescriptorVm, native as device_native, vm as device_vm,
};
use crate::platform::{
