...
use crate::platform::device::midi::core::{MidiRecordBytes, canonical_midi1_message_length};
...
pub(crate) fn decode_short_message(
    ...
    timestamp_ms: u32,
    packed_message: u32,
) -> Option<crate::platform::device::midi::core::MidiInputRecordValue> {
    ...
    Some(crate::platform::device::midi::core::MidiInputRecordValue {
