...
fn destack_device_control_control_replay(
    ...
    context.replay().run_binding(
        DEVICE_CONTROL_CONTROL,
        || unsafe {
            platform_native::destack_device_control(context, out, handle, operation, input, output)
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_device_io_open_replay(
    ...
    context.replay().run_binding(
        DEVICE_IO_OPEN,
        || unsafe { platform_native::destack_device_open(context, out, path, flags, mode) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_device_io_read_replay(
    ...
    context.replay().run_binding(
        DEVICE_IO_READ,
        || unsafe { platform_native::destack_device_read(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_device_io_write_replay(
    ...
    context.replay().run_binding(
        DEVICE_IO_WRITE,
        || unsafe { platform_native::destack_device_write(context, out, handle, buffer) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
pub unsafe extern "C" fn destack_device_control_control(
    ...
    native_call(|context| {
        ...
        destack_device_control_control_replay(context, out, handle, operation, input, output)
    })
}
...
pub unsafe extern "C" fn destack_device_io_close(handle: resource::DeviceHandle) -> RuntimeStatus {
    native_call(|context| {
        ...
        destack_device_io_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_device_io_open(
    ...
    native_call(|context| {
        ...
        destack_device_io_open_replay(context, out, path, flags, mode)
    })
}
...
pub unsafe extern "C" fn destack_device_io_read(
    ...
    native_call(|context| {
        ...
        destack_device_io_read_replay(context, out, handle, buffer)
    })
}
...
pub unsafe extern "C" fn destack_device_io_write(
    ...
    native_call(|context| {
        ...
        destack_device_io_write_replay(context, out, handle, buffer)
    })
}
...
fn destack_device_control_control_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        ...
        context,
        |context| {
            platform_vm::destack_device_control(runtime, context, handle, operation, input, output)
        },
        |context, result| {
            let _ = &context;
...
fn destack_device_io_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        DEVICE_IO_CLOSE,
        context,
        |context| platform_vm::destack_device_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_device_io_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        DEVICE_IO_OPEN,
        context,
        |context| platform_vm::destack_device_open(runtime, context, path, flags, mode),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_device_io_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        DEVICE_IO_READ,
        context,
        |context| platform_vm::destack_device_read(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_device_io_write_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        DEVICE_IO_WRITE,
        context,
        |context| platform_vm::destack_device_write(runtime, context, handle, buffer),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
    ...
    }
    {
        binding!(registry, isolate, DEVICE_IO_CLOSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_device_io_close_vm_replay(runtime, context, handle)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, DEVICE_IO_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_device_io_open_vm_replay(runtime, context, path, flags, mode)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, DEVICE_IO_READ, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_device_io_read_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, DEVICE_IO_WRITE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                destack_device_io_write_vm_replay(runtime, context, handle, buffer)
            })
            .map_err(Into::into)
        });
    }
