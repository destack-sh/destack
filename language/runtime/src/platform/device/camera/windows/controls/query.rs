use super::super::core::camera_control_capabilities;
use super::super::metadata::camera_control_modes;
use super::super::stream::{stream_resource, video_device_controller};
use super::color::*;
...
pub(crate) unsafe fn destack_device_camera_stream_control_capabilities(
    ...
    let mut capabilities = camera_control_capabilities(&camera_control_modes(&controller)?);
