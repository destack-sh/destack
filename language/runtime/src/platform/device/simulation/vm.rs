...
use crate::platform::device::{
    ...
    CameraStreamConfigVm, CameraWatchEventVm, SerialEventVm, SerialInputSignalsVm,
    SerialOutputSignalsVm, SerialPortConfigVm, SerialPortDescriptorVm, SerialPortOpenOptionsVm,
    SerialWatchEventVm, UsbBosCapabilityDescriptorVm, UsbConfigurationDescriptorVm,
