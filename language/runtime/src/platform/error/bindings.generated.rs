...
use crate::platform::error::{
    PlatformErrorContextAudio, PlatformErrorContextDevice, PlatformErrorContextDisplay,
    PlatformErrorContextFfi, PlatformErrorContextGeneric, PlatformErrorContextGpu,
    PlatformErrorContextIo, PlatformErrorContextIoDriver, PlatformErrorContextIpc,
    PlatformErrorContextNet, PlatformErrorContextProcess, PlatformErrorContextResource,
    PlatformErrorContextSecurity, PlatformErrorContextThread, PlatformErrorContextTimer,
    PlatformErrorContextVm, PlatformErrorVm, PlatformPathPayloadBytes, PlatformPathPayloadUtf16,
    PlatformPathPayloadVm, PlatformSystemSourceEai, PlatformSystemSourceErrno,
    PlatformSystemSourceHResult, PlatformSystemSourceOther, PlatformSystemSourceSignal,
    PlatformSystemSourceVm, PlatformSystemSourceWinsock,
};
use crate::platform::{
    ...
    result.map(|value| {
        ...
        let field_3 = match value.context {
            PlatformErrorContextVm::PlatformErrorContextAudio(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = value.feature.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextDevice(value) => {
                ...
                let payload_value = {
                    ...
                    let field_3 = value.path_text.value();
                    let field_4 = value.feature.value();
            ...
            PlatformErrorContextVm::PlatformErrorContextFfi(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = value.library.value();
                    let field_3 = value.symbol.value();
            ...
            PlatformErrorContextVm::PlatformErrorContextGeneric(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = value.argument.value();
                    let field_3 = value.pointer.value();
                    let field_4 = value.feature.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            ...
            PlatformErrorContextVm::PlatformErrorContextIo(value) => {
                ...
                let payload_value = {
                    ...
                    let field_4 = value.path_text.value();
                    let field_5 = value.dest_text.value();
                    let field_6 = vm::Value::int(value.fd as i64, 32);
            ...
            PlatformErrorContextVm::PlatformErrorContextIoDriver(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = vm::Value::int(value.fd as i64, 32);
                    let field_3 = value.feature.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextIpc(value) => {
                ...
                let payload_value = {
                    ...
                    let field_3 = value.path_text.value();
                    let field_4 = vm::Value::int(value.fd as i64, 32);
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextNet(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = value.address.value();
                    let field_3 = vm::Value::uint(value.port as u64, 16);
                    let field_4 = value.hostname.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextProcess(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = vm::Value::uint(value.pid, 64);
                    let field_3 = value.signal.value();
                    let field_4 = vm::Value::int(value.exit_code as i64, 32);
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextResource(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = vm::Value::uint(value.resource_id, 64);
                    let field_3 = value.resource_kind.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextSecurity(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = value.capability.value();
                    let field_3 = value.policy.value();
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextThread(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = vm::Value::uint(value.thread_id, 64);
                    context.allocate_aggregate(vec![field_0, field_1, field_2])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
            PlatformErrorContextVm::PlatformErrorContextTimer(value) => {
                ...
                let payload_value = {
                    let field_0 = value.kind.value();
                    let field_1 = value.syscall.value();
                    let field_2 = vm::Value::uint(value.timer_id, 64);
                    let field_3 = vm::Value::uint(value.deadline_ns, 64);
                    context.allocate_aggregate(vec![field_0, field_1, field_2, field_3])
                };
                context.allocate_aggregate(vec![tag_value, payload_value])
            }
