...
pub(crate) fn destack_gpu_command_buffer_destroy(
    ...
    let _ = handle;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.command.bufferDestroy is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_command_transition_resources(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.command.transitionResources is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_close(
    ...
    let _ = handle;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationClose is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_open(
    ...
    let _ = (surface, options);
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationOpen is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_read(
    ...
    let _ = (handle, timeoutns);
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationRead is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_read_batch(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationReadBatch is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_try_read(
    ...
    let _ = handle;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationTryRead is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_presentation_try_read_batch(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfacePresentationTryReadBatch is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_surface_status(
    ...
    let _ = surface;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.present.surfaceStatus is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_external_texture_create(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.resource.externalTextureCreate is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_gpu_external_texture_destroy(
    ...
    let _ = handle;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.gpu.resource.externalTextureDestroy is not available in the VM yet",
    ))
    .boxed())
}
