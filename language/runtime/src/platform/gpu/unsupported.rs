...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_adapter_info(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_bind_compute_pipeline(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_bind_render_pipeline(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
    pipeline: resource::GpuPipelineHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_compute_pass_begin(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_compute_pass_end(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_copy_buffer_to_texture(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_copy_texture_to_buffer(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_copy_texture_to_texture(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
    source: GpuTextureCopy,
    destination: GpuTextureCopy,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_draw(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
    vertexcount: u32,
    instancecount: u32,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_draw_indexed(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
    indexcount: u32,
    instancecount: u32,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_encoder_close(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_encoder_finish(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_encoder_open(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_queue_write_buffer(
    context: &RuntimeCallContext,
    queue: resource::GpuQueueHandle,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_queue_write_texture(
    context: &RuntimeCallContext,
    queue: resource::GpuQueueHandle,
    destination: GpuTextureCopy,
    data: NativeSlice<u8>,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_render_pass_begin(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_command_render_pass_end(
    context: &RuntimeCallContext,
    handle: resource::GpuCommandListHandle,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_device_info(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_device_poll(
    context: &RuntimeCallContext,
    out: *mut u32,
    device: resource::GpuDeviceHandle,
    wait: bool,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_compute_pipeline_create(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_gpu_render_pipeline_create(
    context: &RuntimeCallContext,
    out: *mut resource::GpuPipelineHandle,
    device: resource::GpuDeviceHandle,
...
/// # Replay
/// External, nonrecordable.
pub unsafe fn destack_gpu_surface_configure(
    context: &RuntimeCallContext,
    device: resource::GpuDeviceHandle,
    window: resource::WindowHandle,
