...
pub(crate) unsafe fn destack_net_resolve_raw(
    ...
    unsafe {
        crate::platform::net::host::destack_net_resolve(context, out, host, port, family, flags)
    }
}
...
pub(crate) unsafe fn destack_net_reverse_lookup_raw(
    ...
    unsafe { crate::platform::net::host::destack_net_reverse_lookup(context, out, address) }
}
...
pub(crate) unsafe fn destack_net_get_keep_alive(
    ...
    unsafe { crate::platform::net::host::destack_net_get_keep_alive(context, out, handle) }
}
