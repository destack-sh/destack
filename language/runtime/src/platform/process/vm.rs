...
use crate::platform::process::{
    ExecAtFlags, GroupId, ProcessCpuSetVm, ProcessFdActionKind, ProcessFdActionVm, ProcessFdFlags,
    ProcessFdSignalFlags, ProcessGroupIdsVm, ProcessId, ProcessLimitResource, ProcessLimitVm,
    ProcessNamespaceKind, ProcessSchedulerConfigVm, ProcessSchedulerPolicy, ProcessSpawnOptionsVm,
    ProcessStdioKind, ProcessStdioVm, ProcessUnshareFlags, ProcessUserIdsVm, ProcessWaitFlags,
    ProcessWaitKind, ProcessWaitStatusVm, Signal, SignalEventVm, SignalFdFlags, SignalMaskHow,
...
pub(crate) fn destack_process_egid(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.egid is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_euid(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.euid is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_group_ids(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.groupIds is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_groups(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.groups is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_set_egid(
    ...
    let _ = groupid;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.setEgid is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_set_euid(
    ...
    let _ = userid;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.setEuid is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_set_group_ids(
    ...
    let _ = ids;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.setGroupIds is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_set_user_ids(
    ...
    let _ = ids;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.setUserIds is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_user_ids(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.ids.userIds is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_get_scheduler(
    ...
    let _ = pid;
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.sched.getScheduler is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_set_scheduler(
    ...
    let _ = (pid, config);
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.sched.setScheduler is not available in the VM yet",
    ))
    .boxed())
}
...
pub(crate) fn destack_process_yield_now(
    ...
    Err(RuntimeError::from(PlatformError::not_supported(
        "destack.process.sched.yieldNow is not available in the VM yet",
    ))
    .boxed())
}
