...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_egid(
    context: &RuntimeCallContext,
    out: *mut GroupId,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_euid(
    context: &RuntimeCallContext,
    out: *mut UserId,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_group_ids(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_groups(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_set_egid(
    context: &RuntimeCallContext,
    groupid: GroupId,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_set_euid(
    context: &RuntimeCallContext,
    userid: UserId,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_set_group_ids(
    context: &RuntimeCallContext,
    ids: ProcessGroupIds,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_set_user_ids(
    context: &RuntimeCallContext,
    ids: ProcessUserIds,
) -> RuntimeResult<()> {
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_user_ids(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_get_scheduler(
    context: &RuntimeCallContext,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_set_scheduler(
    context: &RuntimeCallContext,
    pid: ProcessId,
...
/// # Replay
/// External, recordable.
pub unsafe fn destack_process_yield_now(context: &RuntimeCallContext) -> RuntimeResult<()> {
