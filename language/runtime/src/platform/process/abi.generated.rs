...
pub struct ProcessSpawnOptionsAbi<A: BindingAbi> {
    /// The cwd field.
    pub cwd: crate::platform::fs::OsPathAbi<A>,
    /// The detached field.
    pub detached: bool,
...
pub struct ProcessCpuSetReplay {
    /// The cpus field.
    pub cpus: Vec<u32>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ProcessFdActionReplay {
    /// The op field.
    pub op: ProcessFdActionKind,
    /// The source field.
    pub source: i32,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ProcessSpawnOptionsReplay {
    /// The cwd field.
    pub cwd: fs::OsPathReplay,
    /// The detached field.
    pub detached: bool,
    /// The reset_signals field.
    pub reset_signals: bool,
