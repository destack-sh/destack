...
use crate::platform::process::{ExecAtFlags, GroupId, ProcessCpuSet, ProcessCpuSetReplayRecord, ProcessCpuSetVm, ProcessFdAction, ProcessFdActionVm, ProcessFdFlags, ProcessFdSignalFlags, ProcessGroupIds, ProcessGroupIdsVm, ProcessId, ProcessLimit, ProcessLimitResource, ProcessLimitVm, ProcessNamespaceKind, ProcessSchedulerConfig, ProcessSchedulerConfigVm, ProcessSchedulerPolicy, ProcessSpawnOptions, ProcessSpawnOptionsVm, ProcessStdio, ProcessStdioVm, ProcessUnshareFlags, ProcessUserIds, ProcessUserIdsVm, ProcessWaitFlags, ProcessWaitStatus, ProcessWaitStatusVm, Signal, SignalEvent, SignalEventVm, SignalFdFlags, SignalMaskHow, SyscallFilterFlags, UserId};
...
use crate::platform::process::runtime::{native as platform_runtime_native, vm as platform_runtime_vm};
use crate::platform::process::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_process_exec_exec_args(
    ...
    let command = {
        if command_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("command", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(command_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("command", "expected 3 fields")).boxed()); }
        let command_encoding_raw = decode_uint8(slots[0], "command_encoding_raw", "encoding")?;
        let command_encoding = match command_encoding_raw { 1u8 => fs::PathEncoding::Bytes, 2u8 => fs::PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("command_encoding", "unknown fs::PathEncoding value")).boxed()), };
        let command_bytes_inner = decode_array::<u8>(context, slots[1], "command_bytes_inner", "bytes")?;
        let command_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(command_bytes_inner);
        let command_utf16_inner = decode_array::<u16>(context, slots[2], "command_utf16_inner", "utf16")?;
...
fn encode_destack_process_fd_process_fd_try_wait_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.pid.0 as u64, 32); let field_1 = vm::Value::uint(value.kind as u8 as u64, 8); let field_2 = vm::Value::int(value.exit_code as i64, 32); let field_3 = vm::Value::uint(value.signal.0 as u64, 32); let field_4 = vm::Value::bool(value.core_dumped); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) })
}
...
fn decode_destack_process_spawn_spawn_args(
    ...
    let options = {
        ...
        let options_cwd = {
            if slots[0].tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options_cwd", "cwd")).boxed()); }
            let slots = context.aggregate_slots(slots[0]).map_err(|error| RuntimeError::from(error).boxed())?;
            if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_cwd", "expected 3 fields")).boxed()); }
            let options_cwd_encoding_raw = decode_uint8(slots[0], "options_cwd_encoding_raw", "encoding")?;
            let options_cwd_encoding = match options_cwd_encoding_raw { 1u8 => fs::PathEncoding::Bytes, 2u8 => fs::PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_cwd_encoding", "unknown fs::PathEncoding value")).boxed()), };
            let options_cwd_bytes_inner = decode_array::<u8>(context, slots[1], "options_cwd_bytes_inner", "bytes")?;
            let options_cwd_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(options_cwd_bytes_inner);
            let options_cwd_utf16_inner = decode_array::<u16>(context, slots[2], "options_cwd_utf16_inner", "utf16")?;
            let options_cwd_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(options_cwd_utf16_inner);
            fs::OsPathVm {
...
pub const PROCESS_ARGS_ARGS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const PROCESS_CWD_CWD: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const PROCESS_EXIT_EXIT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const PROCESS_UMASK_UMASK: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const PROCESS_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "process",
    bindings: &[
        NativeBinding::new(PROCESS_ARGS_ARGS, "destack.process.args.args", destack_process_args_args as *const ()),
        NativeBinding::new(PROCESS_CWD_CHDIR, "destack.process.cwd.chdir", destack_process_cwd_chdir as *const ()),
        NativeBinding::new(PROCESS_CWD_CWD, "destack.process.cwd.cwd", destack_process_cwd_cwd as *const ()),
        ...
        NativeBinding::new(PROCESS_EXEC_EXEC, "destack.process.exec.exec", destack_process_exec_exec as *const ()),
        NativeBinding::new(PROCESS_EXEC_EXECAT, "destack.process.exec.execat", destack_process_exec_execat as *const ()),
        NativeBinding::new(PROCESS_EXEC_FEXEC, "destack.process.exec.fexec", destack_process_exec_fexec as *const ()),
        NativeBinding::new(PROCESS_EXIT_EXIT, "destack.process.exit.exit", destack_process_exit_exit as *const ()),
        ...
        NativeBinding::new(PROCESS_SPAWN_SPAWN, "destack.process.spawn.spawn", destack_process_spawn_spawn as *const ()),
        ...
        NativeBinding::new(PROCESS_UMASK_UMASK, "destack.process.umask.umask", destack_process_umask_umask as *const ()),
        ...
        NativeBinding::new(PROCESS_WAIT_WAIT, "destack.process.wait.wait", destack_process_wait_wait as *const ()),
    ],
};
...
fn destack_process_cwd_chdir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_chdir(context, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_cwd_cwd_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_cwd(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_env_set_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_process_env_set(context, name, argument_value) },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_env_set_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_process_env_set_bytes(context, name, argument_value) },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_exec_exec_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_exec(context, command, arguments, environment) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_exec(context, command, arguments, environment) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_exec_execat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_execat(context, directory, path, arguments, environment, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_execat(context, directory, path, arguments, environment, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_exec_fexec_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_fexec(context, executable, arguments, environment) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_fexec(context, executable, arguments, environment) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_exit_exit_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_exit(context, code) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_fd_process_fd_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_process_fd_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_process_fd_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_fd_process_fd_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_process_fd_open(context, out, pid, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_process_fd_open(context, out, pid, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_fd_process_fd_send_signal_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_process_fd_send_signal(context, handle, signal, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_process_fd_send_signal(context, handle, signal, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessFdProcessFdSendSignalReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_fd_process_fd_try_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_process_fd_try_wait(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_process_fd_try_wait(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessFdProcessFdTryWaitReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_fd_process_fd_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_process_fd_wait(context, out, handle, timeoutns) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_process_fd_wait(context, out, handle, timeoutns) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_fd_signal_fd_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_fd_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_fd_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_fd_signal_fd_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_fd_open(context, out, signals, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_fd_open(context, out, signals, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_fd_signal_fd_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_fd_read(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_fd_read(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_fd_signal_fd_set_mask_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_fd_set_mask(context, handle, signals) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_fd_set_mask(context, handle, signals) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessFdSignalFdSetMaskReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_fd_signal_fd_try_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_fd_try_read(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_fd_try_read(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessFdSignalFdTryReadReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_ids_egid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_egid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_euid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_euid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_gid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_gid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_group_ids_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_group_ids(context, out) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_group_ids(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_groups_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_groups(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_pid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_pid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_ppid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_ppid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_set_egid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_egid(context, groupid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_egid(context, groupid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_euid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_euid(context, userid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_euid(context, userid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_gid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_gid(context, groupid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_gid(context, groupid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_group_ids_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_group_ids(context, ids) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_group_ids(context, ids) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_groups_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_groups(context, groups) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_groups(context, groups) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_uid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_uid(context, userid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_uid(context, userid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_set_user_ids_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_user_ids(context, ids) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_user_ids(context, ids) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_ids_uid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_uid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_ids_user_ids_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_user_ids(context, out) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_user_ids(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_limits_get_limit_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_get_limit(context, out, resource) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_get_limit(context, out, resource) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_limits_set_limit_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_limit(context, resource, limit) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_limit(context, resource, limit) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_sched_get_affinity_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_get_affinity(context, out, pid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_get_affinity(context, out, pid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_sched_get_priority_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_get_priority(context, out, pid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_get_priority(context, out, pid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_sched_get_scheduler_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_get_scheduler(context, out, pid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_get_scheduler(context, out, pid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSchedGetSchedulerReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_sched_set_affinity_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_affinity(context, pid, cpus) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_affinity(context, pid, cpus) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_sched_set_priority_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_priority(context, pid, priority) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_priority(context, pid, priority) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_sched_set_scheduler_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_set_scheduler(context, pid, config) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_scheduler(context, pid, config) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSchedSetSchedulerReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_sched_yield_now_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_yield_now(context) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_session_getpgid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_getpgid(context, out, pid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_getpgid(context, out, pid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_session_setpgid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_setpgid(context, pid, pgid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_setpgid(context, pid, pgid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_session_setsid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_setsid(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_signals_kill_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_kill(context, pid, signal) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_kill(context, pid, signal) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_signals_signal_mask_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_mask_read(context, out) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_mask_read(context, out) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalMaskReadReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_signals_signal_mask_update_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_mask_update(context, how, signals) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_mask_update(context, how, signals) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalMaskUpdateReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalReceiveReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_signals_signal_subscribe_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_process_signal_subscribe(context, out, signal) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() { return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed()); }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalSubscribeReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_signals_signal_try_receive_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_process_signal_try_receive(context, out, handle) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() { return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed()); }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalTryReceiveReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_signals_signal_try_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_try_wait(context, out, signals) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_try_wait(context, out, signals) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalTryWaitReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalUnsubscribeReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_signals_signal_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_signal_wait(context, out, signals) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_signal_wait(context, out, signals) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    ProcessSignalsSignalWaitReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_process_spawn_spawn_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_spawn(context, out, command, arguments, environment, options) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_spawn(context, out, command, arguments, environment, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_spawn_with_actions_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_spawn_with_actions(context, out, command, arguments, environment, options, stdio, actions) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_spawn_with_actions(context, out, command, arguments, environment, options, stdio, actions) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_umask_umask_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_umask(context, out, mask) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_umask(context, out, mask) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_wait_pid_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_wait_pid(context, out, pid, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_wait_pid(context, out, pid, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_wait_try_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_try_wait(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_try_wait(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_process_wait_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_process_wait(context, out, handle, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_wait(context, out, handle, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
pub unsafe extern "C" fn destack_process_args_args(
    out: *mut NativeStringSlice,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_process_cwd_cwd(
    out: *mut fs::OsPath,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub unsafe extern "C" fn destack_process_exec_execat(
    ...
    native_call(|context| {
        ...
        destack_process_exec_execat_replay(context, world, directory, path, arguments, environment, flags)
    })
}
...
pub unsafe extern "C" fn destack_process_exit_exit(
    code: u32,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &code;
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_cgroup_get_limit(context, out, path, resource) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_cgroup_join(context, path) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_cgroup_set_limit(context, path, resource, limit) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_job_assign(context, name, pids) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_job_set_limit(context, name, resource, limit) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_chroot(context, path) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_process_isolation_install_syscall_filter(
    ...
    native_call(|context| {
        ...
        {
            let world = context.check_and_resolve_world(PROCESS_ISOLATION_INSTALL_SYSCALL_FILTER)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_process_install_syscall_filter(context, program, flags) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_install_syscall_filter(context, program, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_host_name(context, name) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_set_network_namespace(context, path) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_setns(context, pid, namespace) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_process_unshare(context, flags) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_process_spawn_spawn(
    ...
    native_call(|context| {
        ...
        destack_process_spawn_spawn_replay(context, world, out, command, arguments, environment, options)
    })
}
...
pub unsafe extern "C" fn destack_process_umask_umask(
    out: *mut u32,
    mask: u32,
) -> RuntimeStatus {
    native_call(|context| {
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_chdir(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_cwd(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_env_set_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_process_env_set(runtime, context, name, argument_value),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_env_set_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_process_env_set_bytes(runtime, context, name, argument_value),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_exec_exec_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_exec(runtime, context, command, arguments, environment),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_exec(runtime, context, command, arguments, environment),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_exec_execat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_execat(runtime, context, directory, path, arguments, environment, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_execat(runtime, context, directory, path, arguments, environment, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_exec_fexec_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_fexec(runtime, context, executable, arguments, environment),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_fexec(runtime, context, executable, arguments, environment),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_exit(runtime, context, code),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_process_fd_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_process_fd_close(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_process_fd_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_process_fd_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_process_fd_open(runtime, context, pid, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_process_fd_open(runtime, context, pid, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_process_fd_send_signal_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_process_fd_send_signal(runtime, context, handle, signal, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_process_fd_send_signal(runtime, context, handle, signal, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_process_fd_try_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_process_fd_try_wait(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_process_fd_try_wait(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_process_fd_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_process_fd_wait(runtime, context, handle, timeoutns),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_process_fd_wait(runtime, context, handle, timeoutns),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_signal_fd_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_fd_close(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_fd_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_signal_fd_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_fd_open(runtime, context, signals, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_fd_open(runtime, context, signals, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_signal_fd_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_fd_read(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_fd_read(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_signal_fd_set_mask_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_fd_set_mask(runtime, context, handle, signals),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_fd_set_mask(runtime, context, handle, signals),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_fd_signal_fd_try_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_fd_try_read(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_fd_try_read(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_egid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_euid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_gid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_group_ids(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_groups(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_pid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_ppid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_egid(runtime, context, groupid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_euid(runtime, context, userid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_gid(runtime, context, groupid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_group_ids(runtime, context, ids),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_groups(runtime, context, groups),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_uid(runtime, context, userid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_user_ids(runtime, context, ids),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_uid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_user_ids(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_limits_get_limit_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_get_limit(runtime, context, resource),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_get_limit(runtime, context, resource),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_limits_set_limit_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_set_limit(runtime, context, resource, limit),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_limit(runtime, context, resource, limit),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_get_affinity(runtime, context, pid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_get_priority(runtime, context, pid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_get_scheduler(runtime, context, pid),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_sched_set_affinity_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_set_affinity(runtime, context, pid, cpus),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_affinity(runtime, context, pid, cpus),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_sched_set_priority_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_set_priority(runtime, context, pid, priority),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_priority(runtime, context, pid, priority),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_sched_set_scheduler_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_set_scheduler(runtime, context, pid, config),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_scheduler(runtime, context, pid, config),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_yield_now(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_getpgid(runtime, context, pid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_setpgid(runtime, context, pid, pgid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_setsid(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_kill(runtime, context, pid, signal),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_mask_read(runtime, context),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_signals_signal_mask_update_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_mask_update(runtime, context, how, signals),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_mask_update(runtime, context, how, signals),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_signals_signal_subscribe_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_process_signal_subscribe(runtime, context, signal),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
...
fn destack_process_signals_signal_try_receive_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_process_signal_try_receive(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value: SignalEventVm = value.clone();
...
fn destack_process_signals_signal_try_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_try_wait(runtime, context, signals),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_try_wait(runtime, context, signals),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_signals_signal_unsubscribe_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_process_signal_unsubscribe(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_process_signals_signal_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_signal_wait(runtime, context, signals),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_signal_wait(runtime, context, signals),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_spawn_spawn_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_spawn(runtime, context, command, arguments, environment, options),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_spawn(runtime, context, command, arguments, environment, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_spawn_with_actions_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_spawn_with_actions(runtime, context, command, arguments, environment, options, stdio, actions),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_spawn_with_actions(runtime, context, command, arguments, environment, options, stdio, actions),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_umask(runtime, context, mask),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_wait_pid_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_wait_pid(runtime, context, pid, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_wait_pid(runtime, context, pid, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_try_wait(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_process_wait_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_process_wait(runtime, context, handle, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_process_wait(runtime, context, handle, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_process_vm_bindings(
    ...
    {
        binding!(registry, isolate, PROCESS_ARGS_ARGS, move |context, _args| {
    ...
    {
        binding!(registry, isolate, PROCESS_EXEC_EXEC, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (command, arguments, environment) = decode_destack_process_exec_exec_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_EXEC_EXEC)?;
                destack_process_exec_exec_vm_replay(runtime, context, world, command, arguments, environment)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_EXEC_EXECAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (directory, path, arguments, environment, flags) = decode_destack_process_exec_execat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_EXEC_EXECAT)?;
                destack_process_exec_execat_vm_replay(runtime, context, world, directory, path, arguments, environment, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_EXEC_FEXEC, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_exec_fexec_vm_replay(runtime, context, world, executable, arguments, environment)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_EXIT_EXIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    }
    {
        binding!(registry, isolate, PROCESS_FD_PROCESS_FD_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_fd_process_fd_open_vm_replay(runtime, context, world, pid, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_FD_PROCESS_FD_SEND_SIGNAL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_FD_PROCESS_FD_SEND_SIGNAL)?;
                destack_process_fd_process_fd_send_signal_vm_replay(runtime, context, world, handle, signal, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_FD_PROCESS_FD_TRY_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_fd_process_fd_try_wait_vm_replay(runtime, context, world, handle)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_FD_PROCESS_FD_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_fd_process_fd_wait_vm_replay(runtime, context, world, handle, timeoutns)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_FD_SIGNAL_FD_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_fd_signal_fd_open_vm_replay(runtime, context, world, signals, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_FD_SIGNAL_FD_SET_MASK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_fd_signal_fd_set_mask_vm_replay(runtime, context, world, handle, signals)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_GROUP_CGROUP_GET_LIMIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(PROCESS_GROUP_CGROUP_GET_LIMIT)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_cgroup_get_limit(runtime, context, path, resource),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_cgroup_get_limit(runtime, context, path, resource),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_GROUP_CGROUP_JOIN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_cgroup_join(runtime, context, path),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_cgroup_join(runtime, context, path),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, PROCESS_GROUP_CGROUP_SET_LIMIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(PROCESS_GROUP_CGROUP_SET_LIMIT)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_cgroup_set_limit(runtime, context, path, resource, limit),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_cgroup_set_limit(runtime, context, path, resource, limit),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_GROUP_JOB_ASSIGN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_job_assign(runtime, context, name, pids),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_job_assign(runtime, context, name, pids),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_GROUP_JOB_SET_LIMIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_job_set_limit(runtime, context, name, resource, limit),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_job_set_limit(runtime, context, name, resource, limit),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_ISOLATION_CHROOT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_chroot(runtime, context, path),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_chroot(runtime, context, path),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, PROCESS_ISOLATION_INSTALL_SYSCALL_FILTER, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(PROCESS_ISOLATION_INSTALL_SYSCALL_FILTER)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_install_syscall_filter(runtime, context, program, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_install_syscall_filter(runtime, context, program, flags),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, PROCESS_ISOLATION_SET_HOST_NAME, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(PROCESS_ISOLATION_SET_HOST_NAME)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_set_host_name(runtime, context, name),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_host_name(runtime, context, name),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, PROCESS_ISOLATION_SET_NETWORK_NAMESPACE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(PROCESS_ISOLATION_SET_NETWORK_NAMESPACE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_set_network_namespace(runtime, context, path),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_set_network_namespace(runtime, context, path),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_ISOLATION_SETNS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_setns(runtime, context, pid, namespace),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_setns(runtime, context, pid, namespace),
                        }
                    };
        ...
        binding!(registry, isolate, PROCESS_ISOLATION_UNSHARE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_process_unshare(runtime, context, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_process_unshare(runtime, context, flags),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, PROCESS_LIMITS_SET_LIMIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_limits_set_limit_vm_replay(runtime, context, world, resource, limit)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_SCHED_SET_PRIORITY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_sched_set_priority_vm_replay(runtime, context, world, pid, priority)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_SCHED_SET_SCHEDULER, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_sched_set_scheduler_vm_replay(runtime, context, world, pid, config)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_SIGNALS_SIGNAL_MASK_READ, move |context, _args| {
            with_runtime_call_context(|runtime| {
                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_SIGNALS_SIGNAL_MASK_READ)?;
    ...
    }
    {
        binding!(registry, isolate, PROCESS_SIGNALS_SIGNAL_MASK_UPDATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_SIGNALS_SIGNAL_MASK_UPDATE)?;
                destack_process_signals_signal_mask_update_vm_replay(runtime, context, world, how, signals)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, PROCESS_SIGNALS_SIGNAL_TRY_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_signals_signal_try_wait_vm_replay(runtime, context, world, signals)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, PROCESS_SPAWN_SPAWN, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (command, arguments, environment, options) = decode_destack_process_spawn_spawn_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(PROCESS_SPAWN_SPAWN)?;
                destack_process_spawn_spawn_vm_replay(runtime, context, world, command, arguments, environment, options)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_SPAWN_WITH_ACTIONS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_process_spawn_with_actions_vm_replay(runtime, context, world, command, arguments, environment, options, stdio, actions)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, PROCESS_UMASK_UMASK, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, PROCESS_WAIT_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
