...
impl VmValueCodec for TlsHandshakeStatus {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        ...
        let decoded = match raw {
            0u8 => Self::Complete, 1u8 => Self::WantRead, 2u8 => Self::WantWrite,
...
impl VmValueCodec for TlsHostnameVerificationMode {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        let raw = <u8 as VmValueCodec>::decode(value)?;
        let decoded = match raw {
            0u8 => Self::Strict, 1u8 => Self::AllowMismatch, 2u8 => Self::Disabled,
...
impl VmValueCodec for TlsRole {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        let raw = <u8 as VmValueCodec>::decode(value)?;
        let decoded = match raw {
            0u8 => Self::Client, 1u8 => Self::Server,
...
impl VmValueCodec for TlsSessionResumptionMode {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        let raw = <u8 as VmValueCodec>::decode(value)?;
        let decoded = match raw {
            0u8 => Self::Disabled, 1u8 => Self::Stateful, 2u8 => Self::Stateless, 3u8 => Self::StatefulAndStateless,
...
impl VmValueCodec for TlsSessionResumptionState {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        let raw = <u8 as VmValueCodec>::decode(value)?;
        let decoded = match raw {
            0u8 => Self::Fresh, 1u8 => Self::Resumed,
...
impl VmValueCodec for TlsVersion {
    fn decode(value: vm::Value) -> RuntimeResult<Self> {
        ...
        let decoded = match raw {
            771u16 => Self::Tls12, 772u16 => Self::Tls13,
