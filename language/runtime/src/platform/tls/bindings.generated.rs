...
use crate::platform::tls::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_tls_context_open_args(
    ...
    let options = {
        ...
        let options_alpn_protocols = decode_slice::<vm::StringHandle>(context, slots[4], "options_alpn_protocols", "alpnProtocols")?;
        TlsContextOptionsVm {
            role: options_role,
...
pub const TLS_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    ...
    bindings: &[
        ...
        NativeBinding::new(TLS_CONTEXT_SET_KEYLOG_ENABLED, "destack.tls.context.setKeylogEnabled", destack_tls_context_set_keylog_enabled as *const ()),
...
fn destack_tls_context_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_context_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_tls_context_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_context_open(context, out, options) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_open(context, out, options) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_tls_session_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_tls_session_handshake_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_handshake(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_handshake(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_tls_session_negotiated_alpn_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_negotiated_alpn(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_negotiated_alpn(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    TlsSessionNegotiatedAlpnReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_tls_session_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_open(context, out, argument_context, socket, servername) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_open(context, out, argument_context, socket, servername) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_tls_session_resumption_state_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_resumption_state(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_resumption_state(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    TlsSessionResumptionStateReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_tls_session_shutdown_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_tls_session_shutdown(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_shutdown(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_cipher_suites(context, handle, suites) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_groups(context, handle, groups) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_tls_context_set_hostname_verification_mode(
    ...
    native_call(|context| {
        ...
        {
            let world = context.check_and_resolve_world(TLS_CONTEXT_SET_HOSTNAME_VERIFICATION_MODE)?;
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_tls_context_set_hostname_verification_mode(context, handle, mode) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_hostname_verification_mode(context, handle, mode) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_identity_pem(context, handle, certificatechainpem, privatekeypem) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_tls_context_set_keylog_enabled(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_tls_context_set_keylog_enabled(context, handle, enabled) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_keylog_enabled(context, handle, enabled) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_session_resumption(context, handle, mode) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_signature_algorithms(context, handle, algorithms) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_context_set_trust_anchors_pem(context, handle, trustanchorspem) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_export_keying_material(context, out, handle, label, argument_context, outputlength) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_peer_certificates_pem(context, out, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_read(context, out, handle, buffer) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_tls_session_write(context, out, handle, buffer) },
            }
        }
    })
}
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_open(runtime, context, options),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_tls_session_handshake_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_tls_session_handshake(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_handshake(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_tls_session_negotiated_alpn_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_tls_session_negotiated_alpn(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_negotiated_alpn(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_tls_session_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_tls_session_open(runtime, context, argument_context, socket, servername),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_open(runtime, context, argument_context, socket, servername),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_tls_session_resumption_state_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_tls_session_resumption_state(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_resumption_state(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_tls_session_shutdown_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_tls_session_shutdown(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_shutdown(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_tls_vm_bindings(
    ...
    }
    {
        binding!(registry, isolate, TLS_CONTEXT_SET_CIPHER_SUITES, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_CONTEXT_SET_CIPHER_SUITES)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_cipher_suites(runtime, context, handle, suites),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_cipher_suites(runtime, context, handle, suites),
                        }
                    };
        ...
        binding!(registry, isolate, TLS_CONTEXT_SET_GROUPS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_groups(runtime, context, handle, groups),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_groups(runtime, context, handle, groups),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, TLS_CONTEXT_SET_IDENTITY_PEM, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_CONTEXT_SET_IDENTITY_PEM)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_identity_pem(runtime, context, handle, certificatechainpem, privatekeypem),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_identity_pem(runtime, context, handle, certificatechainpem, privatekeypem),
                        }
                    };
    ...
    {
        binding!(registry, isolate, TLS_CONTEXT_SET_KEYLOG_ENABLED, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, enabled) = decode_destack_tls_context_set_keylog_enabled_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_CONTEXT_SET_KEYLOG_ENABLED)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_keylog_enabled(runtime, context, handle, enabled),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_keylog_enabled(runtime, context, handle, enabled),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, TLS_CONTEXT_SET_SESSION_RESUMPTION, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_CONTEXT_SET_SESSION_RESUMPTION)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_session_resumption(runtime, context, handle, mode),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_session_resumption(runtime, context, handle, mode),
                        }
                    };
            ...
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            ...
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_signature_algorithms(runtime, context, handle, algorithms),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, TLS_CONTEXT_SET_TRUST_ANCHORS_PEM, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_CONTEXT_SET_TRUST_ANCHORS_PEM)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_context_set_trust_anchors_pem(runtime, context, handle, trustanchorspem),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_context_set_trust_anchors_pem(runtime, context, handle, trustanchorspem),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, TLS_SESSION_EXPORT_KEYING_MATERIAL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_SESSION_EXPORT_KEYING_MATERIAL)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_session_export_keying_material(runtime, context, handle, label, argument_context, outputlength),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_export_keying_material(runtime, context, handle, label, argument_context, outputlength),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, TLS_SESSION_OPEN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_tls_session_open_vm_replay(runtime, context, world, argument_context, socket, servername)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, TLS_SESSION_PEER_CERTIFICATES_PEM, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(TLS_SESSION_PEER_CERTIFICATES_PEM)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_session_peer_certificates_pem(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_peer_certificates_pem(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, TLS_SESSION_READ, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_session_read(runtime, context, handle, buffer),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_read(runtime, context, handle, buffer),
                        }
                    };
        ...
        binding!(registry, isolate, TLS_SESSION_WRITE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_tls_session_write(runtime, context, handle, buffer),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_tls_session_write(runtime, context, handle, buffer),
                        }
                    };
