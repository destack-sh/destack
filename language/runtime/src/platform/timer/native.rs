...
use crate::scheduler::Timer as SchedulerTimer;
...
pub(crate) unsafe fn destack_timer_timer_fd_close(
    ...
    unsafe { host_timer::destack_timer_timer_fd_close(context, handle) }
}
...
pub(crate) unsafe fn destack_timer_timer_fd_get(
    ...
    unsafe { host_timer::destack_timer_timer_fd_get(context, out, handle) }
}
...
pub(crate) unsafe fn destack_timer_timer_fd_open(
    ...
    unsafe { host_timer::destack_timer_timer_fd_open(context, out, clock, flags) }
}
...
pub(crate) unsafe fn destack_timer_timer_fd_read(
    ...
    unsafe { host_timer::destack_timer_timer_fd_read(context, out, handle) }
}
...
pub(crate) unsafe fn destack_timer_timer_fd_set(
    ...
    unsafe { host_timer::destack_timer_timer_fd_set(context, handle, spec, flags) }
}
