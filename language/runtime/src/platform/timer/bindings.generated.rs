...
use crate::platform::timer::{TimerClock, TimerFdClock, TimerFdFlags, TimerFdSetFlags, TimerFdSpec, TimerFdSpecVm, TimerFlags, TimerOptions, TimerOptionsVm};
...
use crate::platform::timer::runtime::{native as platform_runtime_native, vm as platform_runtime_vm};
use crate::platform::timer::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_timer_schedule_at_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "TimerOptions")).boxed()); }
        ...
        let options_clock = match options_clock_raw { 1u8 => TimerClock::Wall, 2u8 => TimerClock::Monotonic , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_clock", "unknown TimerClock value")).boxed()), };
...
pub const TIMER_CONTROL_CANCEL: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_CONTROL_IS_ACTIVE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_CONTROL_PAUSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_CONTROL_REMAINING_NS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_CONTROL_RESET: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_CONTROL_RESUME: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_FD_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const TIMER_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "timer",
    bindings: &[
        NativeBinding::new(TIMER_CONTROL_CANCEL, "destack.timer.control.cancel", destack_timer_control_cancel as *const ()),
        NativeBinding::new(TIMER_CONTROL_IS_ACTIVE, "destack.timer.control.isActive", destack_timer_control_is_active as *const ()),
        NativeBinding::new(TIMER_CONTROL_PAUSE, "destack.timer.control.pause", destack_timer_control_pause as *const ()),
        NativeBinding::new(TIMER_CONTROL_REMAINING_NS, "destack.timer.control.remainingNs", destack_timer_control_remaining_ns as *const ()),
        NativeBinding::new(TIMER_CONTROL_RESET, "destack.timer.control.reset", destack_timer_control_reset as *const ()),
        NativeBinding::new(TIMER_CONTROL_RESUME, "destack.timer.control.resume", destack_timer_control_resume as *const ()),
        NativeBinding::new(TIMER_CONTROL_UPDATE_INTERVAL, "destack.timer.control.updateInterval", destack_timer_control_update_interval as *const ()),
        NativeBinding::new(TIMER_FD_CLOSE, "destack.timer.fd.close", destack_timer_fd_close as *const ()),
        NativeBinding::new(TIMER_FD_GET, "destack.timer.fd.get", destack_timer_fd_get as *const ()),
        NativeBinding::new(TIMER_FD_OPEN, "destack.timer.fd.open", destack_timer_fd_open as *const ()),
        NativeBinding::new(TIMER_FD_READ, "destack.timer.fd.read", destack_timer_fd_read as *const ()),
        NativeBinding::new(TIMER_FD_SET, "destack.timer.fd.set", destack_timer_fd_set as *const ()),
        NativeBinding::new(TIMER_SCHEDULE_AT, "destack.timer.schedule.at", destack_timer_schedule_at as *const ()),
        NativeBinding::new(TIMER_SCHEDULE_INTERVAL, "destack.timer.schedule.interval", destack_timer_schedule_interval as *const ()),
        NativeBinding::new(TIMER_SCHEDULE_ONCE, "destack.timer.schedule.once", destack_timer_schedule_once as *const ()),
    ],
};
...
fn destack_timer_control_update_interval_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_timer_update_interval(context, handle, periodns) },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    TimerControlUpdateIntervalReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_timer_fd_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_timer_timer_fd_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_timer_timer_fd_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_timer_fd_get_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_timer_timer_fd_get(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_timer_timer_fd_get(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_timer_fd_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_timer_timer_fd_open(context, out, clock, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_timer_timer_fd_open(context, out, clock, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_timer_fd_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_timer_timer_fd_read(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_timer_timer_fd_read(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_timer_fd_set_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_timer_timer_fd_set(context, handle, spec, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_timer_timer_fd_set(context, handle, spec, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_timer_schedule_interval_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || unsafe { platform_runtime_native::destack_timer_interval(context, out, periodns, options) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() { return Err(RuntimeError::from(PlatformError::null_pointer("out")).boxed()); }
...
pub unsafe extern "C" fn destack_timer_fd_close(
    handle: resource::TimerFdHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
fn destack_timer_control_update_interval_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_timer_update_interval(runtime, context, handle, periodns),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_timer_fd_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_timer_timer_fd_close(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_timer_timer_fd_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_timer_fd_get_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_timer_timer_fd_get(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_timer_timer_fd_get(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_timer_fd_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_timer_timer_fd_open(runtime, context, clock, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_timer_timer_fd_open(runtime, context, clock, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_timer_fd_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_timer_timer_fd_read(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_timer_timer_fd_read(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_timer_fd_set_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_timer_timer_fd_set(runtime, context, handle, spec, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_timer_timer_fd_set(runtime, context, handle, spec, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_timer_schedule_interval_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        context,
        |context| platform_runtime_vm::destack_timer_interval(runtime, context, periodns, options),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value: resource::TimerHandle = value.clone();
...
pub fn register_timer_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, TIMER_CONTROL_CANCEL, move |context, args| {
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_IS_ACTIVE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_PAUSE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_REMAINING_NS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_RESET, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_RESUME, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, TIMER_CONTROL_UPDATE_INTERVAL, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, periodns) = decode_destack_timer_control_update_interval_args(context, args)?;

                // execute binding
                runtime.check_policy(TIMER_CONTROL_UPDATE_INTERVAL)?;
                destack_timer_control_update_interval_vm_replay(runtime, context, handle, periodns)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, TIMER_SCHEDULE_AT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (deadlinens, options) = decode_destack_timer_schedule_at_args(context, args)?;
    ...
    {
        binding!(registry, isolate, TIMER_SCHEDULE_INTERVAL, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (periodns, options) = decode_destack_timer_schedule_interval_args(context, args)?;
    ...
    {
        binding!(registry, isolate, TIMER_SCHEDULE_ONCE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (delayns, options) = decode_destack_timer_schedule_once_args(context, args)?;
...
pub fn install_timer_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
