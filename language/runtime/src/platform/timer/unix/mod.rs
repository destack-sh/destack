...
pub(crate) unsafe fn destack_timer_timer_fd_close(
    ...
    if !timerfd_available() {
        return Err(
            RuntimeError::from(PlatformError::not_supported("destack.timer.fd.close")).boxed(),
        );
    }
...
pub(crate) unsafe fn destack_timer_timer_fd_get(
    ...
    if !timerfd_available() {
        return Err(
            RuntimeError::from(PlatformError::not_supported("destack.timer.fd.get")).boxed(),
        );
    }
...
pub(crate) unsafe fn destack_timer_timer_fd_open(
    ...
    if !timerfd_available() {
        return Err(
            RuntimeError::from(PlatformError::not_supported("destack.timer.fd.open")).boxed(),
        );
    }
...
pub(crate) unsafe fn destack_timer_timer_fd_read(
    ...
    if !timerfd_available() {
        return Err(
            RuntimeError::from(PlatformError::not_supported("destack.timer.fd.read")).boxed(),
        );
    }
...
pub(crate) unsafe fn destack_timer_timer_fd_set(
    ...
    if !timerfd_available() {
        return Err(
            RuntimeError::from(PlatformError::not_supported("destack.timer.fd.set")).boxed(),
        );
    }
