...
use crate::platform::thread::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
pub const THREAD_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    ...
    bindings: &[
        ...
        NativeBinding::new(THREAD_SPAWN_SPAWN, "destack.thread.spawn.spawn", destack_thread_spawn_spawn as *const ()),
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_local_create(context, out) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_local_delete(context, key) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_local_get(context, out, key) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_local_set(context, key, argument_value) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_get_affinity(context, out, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_get_priority(context, out, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_set_affinity(context, handle, mask) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_set_priority(context, handle, priority) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_detach(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_join(context, out, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_spawn(context, out, entry, argument, options) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_address_wait(context, address, expected, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_address_wake_all(context, address) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_address_wake_one(context, address) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_barrier_create(context, out, participants, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_barrier_wait(context, out, handle, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_cond_var_create(context, out, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_cond_var_notify_all(context, condvar) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_cond_var_notify_one(context, condvar) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_cond_var_wait(context, condvar, mutex, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_mutex_create(context, out, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_mutex_lock(context, handle, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_mutex_unlock(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_rwlock_create(context, out, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_rwlock_read_lock(context, handle, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_rwlock_unlock(context, handle) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_rwlock_write_lock(context, handle, timeoutns) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_semaphore_create(context, out, initial, maximum, flags) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_semaphore_post(context, handle, count) },
            }
        }
    })
}
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                ...
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_thread_semaphore_wait(context, handle, timeoutns) },
            }
        }
    })
}
...
pub fn register_thread_vm_bindings(
        ...
        binding!(registry, isolate, THREAD_LOCAL_CREATE, move |context, _args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_local_create(runtime, context),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_local_create(runtime, context),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_LOCAL_DELETE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_local_delete(runtime, context, key),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_local_delete(runtime, context, key),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_LOCAL_GET, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_local_get(runtime, context, key),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_local_get(runtime, context, key),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_LOCAL_SET, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_local_set(runtime, context, key, argument_value),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_local_set(runtime, context, key, argument_value),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_PRIORITY_GET_AFFINITY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_PRIORITY_GET_AFFINITY)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_get_affinity(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_get_affinity(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_PRIORITY_GET_PRIORITY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_PRIORITY_GET_PRIORITY)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_get_priority(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_get_priority(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_PRIORITY_SET_AFFINITY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_PRIORITY_SET_AFFINITY)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_set_affinity(runtime, context, handle, mask),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_set_affinity(runtime, context, handle, mask),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_PRIORITY_SET_PRIORITY, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_PRIORITY_SET_PRIORITY)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_set_priority(runtime, context, handle, priority),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_set_priority(runtime, context, handle, priority),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SPAWN_DETACH, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_detach(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_detach(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SPAWN_JOIN, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_join(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_join(runtime, context, handle),
                        }
                    };
    ...
    {
        binding!(registry, isolate, THREAD_SPAWN_SPAWN, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (entry, argument, options) = decode_destack_thread_spawn_spawn_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SPAWN_SPAWN)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_spawn(runtime, context, entry, argument, options),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_spawn(runtime, context, entry, argument, options),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_ADDRESS_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_address_wait(runtime, context, address, expected, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_address_wait(runtime, context, address, expected, timeoutns),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_ADDRESS_WAKE_ALL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_ADDRESS_WAKE_ALL)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_address_wake_all(runtime, context, address),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_address_wake_all(runtime, context, address),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_ADDRESS_WAKE_ONE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_ADDRESS_WAKE_ONE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_address_wake_one(runtime, context, address),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_address_wake_one(runtime, context, address),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_BARRIER_CREATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_barrier_create(runtime, context, participants, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_barrier_create(runtime, context, participants, flags),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_BARRIER_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_barrier_wait(runtime, context, handle, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_barrier_wait(runtime, context, handle, timeoutns),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_COND_VAR_CREATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_cond_var_create(runtime, context, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_cond_var_create(runtime, context, flags),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_COND_VAR_NOTIFY_ALL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_COND_VAR_NOTIFY_ALL)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_cond_var_notify_all(runtime, context, condvar),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_cond_var_notify_all(runtime, context, condvar),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_COND_VAR_NOTIFY_ONE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_COND_VAR_NOTIFY_ONE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_cond_var_notify_one(runtime, context, condvar),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_cond_var_notify_one(runtime, context, condvar),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_COND_VAR_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_cond_var_wait(runtime, context, condvar, mutex, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_cond_var_wait(runtime, context, condvar, mutex, timeoutns),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_MUTEX_CREATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_mutex_create(runtime, context, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_mutex_create(runtime, context, flags),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_MUTEX_LOCK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_mutex_lock(runtime, context, handle, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_mutex_lock(runtime, context, handle, timeoutns),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_MUTEX_UNLOCK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_mutex_unlock(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_mutex_unlock(runtime, context, handle),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_RWLOCK_CREATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_rwlock_create(runtime, context, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_rwlock_create(runtime, context, flags),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_RWLOCK_READ_LOCK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_RWLOCK_READ_LOCK)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_rwlock_read_lock(runtime, context, handle, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_rwlock_read_lock(runtime, context, handle, timeoutns),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_RWLOCK_UNLOCK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_rwlock_unlock(runtime, context, handle),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_rwlock_unlock(runtime, context, handle),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_RWLOCK_WRITE_LOCK, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_RWLOCK_WRITE_LOCK)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_rwlock_write_lock(runtime, context, handle, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_rwlock_write_lock(runtime, context, handle, timeoutns),
                        }
                    };
    ...
    }
    {
        binding!(registry, isolate, THREAD_SYNC_SEMAPHORE_CREATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(THREAD_SYNC_SEMAPHORE_CREATE)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_semaphore_create(runtime, context, initial, maximum, flags),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_semaphore_create(runtime, context, initial, maximum, flags),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_SEMAPHORE_POST, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_semaphore_post(runtime, context, handle, count),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_semaphore_post(runtime, context, handle, count),
                        }
                    };
        ...
        binding!(registry, isolate, THREAD_SYNC_SEMAPHORE_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                let result = {
                        ...
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_thread_semaphore_wait(runtime, context, handle, timeoutns),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_thread_semaphore_wait(runtime, context, handle, timeoutns),
                        }
                    };
