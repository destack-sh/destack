...
pub unsafe extern "C" fn destack_thread_local_create(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_local_create(context, out) }
    })
}
...
pub unsafe extern "C" fn destack_thread_local_delete(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_local_delete(context, key) }
    })
}
...
pub unsafe extern "C" fn destack_thread_local_get(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_local_get(context, out, key) }
    })
}
...
pub unsafe extern "C" fn destack_thread_local_set(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_local_set(context, key, value) }
    })
}
...
pub unsafe extern "C" fn destack_thread_priority_get_affinity(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_get_affinity(context, out, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_priority_get_priority(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_get_priority(context, out, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_priority_set_affinity(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_set_affinity(context, handle, mask) }
    })
}
...
pub unsafe extern "C" fn destack_thread_priority_set_priority(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_set_priority(context, handle, priority) }
    })
}
...
pub unsafe extern "C" fn destack_thread_spawn_detach(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_detach(context, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_spawn_join(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_join(context, out, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_spawn_spawn(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_spawn(context, out, entry, argument, options) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_address_wait(
    ...
    native_call(|context| {
        ...
        unsafe {
            platform_native::destack_thread_address_wait(context, address, expected, timeoutns)
        }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_address_wake_all(address: u64) -> RuntimeStatus {
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_address_wake_all(context, address) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_address_wake_one(address: u64) -> RuntimeStatus {
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_address_wake_one(context, address) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_barrier_create(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_barrier_create(context, out, participants, flags) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_barrier_wait(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_barrier_wait(context, out, handle, timeoutns) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_cond_var_create(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_cond_var_create(context, out, flags) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_cond_var_notify_all(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_cond_var_notify_all(context, condvar) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_cond_var_notify_one(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_cond_var_notify_one(context, condvar) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_cond_var_wait(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_cond_var_wait(context, condvar, mutex, timeoutns) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_mutex_create(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_mutex_create(context, out, flags) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_mutex_lock(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_mutex_lock(context, handle, timeoutns) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_mutex_unlock(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_mutex_unlock(context, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_rwlock_create(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_rwlock_create(context, out, flags) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_rwlock_read_lock(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_rwlock_read_lock(context, handle, timeoutns) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_rwlock_unlock(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_rwlock_unlock(context, handle) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_rwlock_write_lock(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_rwlock_write_lock(context, handle, timeoutns) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_semaphore_create(
    ...
    native_call(|context| {
        ...
        unsafe {
            platform_native::destack_thread_semaphore_create(context, out, initial, maximum, flags)
        }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_semaphore_post(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_semaphore_post(context, handle, count) }
    })
}
...
pub unsafe extern "C" fn destack_thread_sync_semaphore_wait(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_thread_semaphore_wait(context, handle, timeoutns) }
    })
}
        ...
        binding!(
            ...
            move |context, _args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_local_create(runtime, context);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_local_delete(runtime, context, key);
    ...
    }
    {
        binding!(registry, isolate, THREAD_LOCAL_GET, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = platform_vm::destack_thread_local_get(runtime, context, key);
    ...
    }
    {
        binding!(registry, isolate, THREAD_LOCAL_SET, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                // execute binding
                let result = platform_vm::destack_thread_local_set(runtime, context, key, value);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_get_affinity(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_get_priority(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_set_affinity(runtime, context, handle, mask);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_set_priority(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_detach(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_join(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_spawn(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_address_wait(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_address_wake_all(runtime, context, address);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_address_wake_one(runtime, context, address);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_barrier_create(
                        runtime,
                        context,
                        participants,
                        flags,
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_barrier_wait(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_cond_var_notify_all(runtime, context, condvar);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_cond_var_notify_one(runtime, context, condvar);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_cond_var_wait(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_mutex_create(runtime, context, flags);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_mutex_lock(runtime, context, handle, timeoutns);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_mutex_unlock(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_rwlock_create(runtime, context, flags);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_rwlock_read_lock(
                        runtime, context, handle, timeoutns,
                    );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_rwlock_write_lock(
                        runtime, context, handle, timeoutns,
                    );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_semaphore_create(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_thread_semaphore_post(runtime, context, handle, count);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_thread_semaphore_wait(
                        runtime, context, handle, timeoutns,
                    );
