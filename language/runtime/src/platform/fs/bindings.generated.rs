...
use crate::platform::fs::{AccessMode, AllocFlags, AtFlags, CopyFlags, Dirent, DirentKind, DirentNext, DirentNextReplayRecord, DirentNextVm, DirentReplayRecord, DirentVm, FdFlags, FileAdvice, FileLockFlags, FileMode, FileOffset, FileSize, MmapAdvice, MmapFlags, MmapProt, MmapSyncFlags, NodeDevice, OpenFlags, OpenOptions, OpenOptionsVm, OpenResolveFlags, OsPath, OsPathReplayRecord, OsPathVm, PathEncoding, ReadWriteFlags, RenameFlags, SeekWhence, SpliceCursor, SpliceCursorVm, SpliceFlags, Stat, StatFs, StatFsVm, StatVm, StatusFlags, Statx, StatxFlags, StatxMask, StatxVm, SymlinkType, SyncFlags, WatchBatch, WatchBatchReplayRecord, WatchBatchVm, WatchEvent, WatchEventKind, WatchEventReplayRecord, WatchEventVm, WatchMask, WatchOptions, WatchOptionsVm, XattrFlags};
...
use crate::platform::fs::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_fs_attrs_access_args(
    ...
    let path = {
        ...
        let path_encoding = match path_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("path_encoding", "unknown PathEncoding value")).boxed()), };
...
fn decode_destack_fs_dir_mkdtemp_args(
    ...
    let template = {
        if template_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("template", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(template_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("template", "expected 3 fields")).boxed()); }
        let template_encoding_raw = decode_uint8(slots[0], "template_encoding_raw", "encoding")?;
        let template_encoding = match template_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("template_encoding", "unknown PathEncoding value")).boxed()), };
        let template_bytes_inner = decode_array::<u8>(context, slots[1], "template_bytes_inner", "bytes")?;
        let template_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(template_bytes_inner);
        let template_utf16_inner = decode_array::<u16>(context, slots[2], "template_utf16_inner", "utf16")?;
        let template_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(template_utf16_inner);
        OsPathVm {
...
fn encode_destack_fs_dir_mkdtemp_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.encoding as u8 as u64, 8); let field_1 = value.bytes.0.to_value(context); let field_2 = value.utf16.0.to_value(context); context.allocate_aggregate(vec![field_0, field_1, field_2]) })
}
...
fn encode_destack_fs_dir_readdir_next_result(
    ...
    result.map(|value| { let field_0 = vm::Value::bool(value.has_entry); let field_1 = { let field_0 = { let field_0 = vm::Value::uint(value.entry.name.encoding as u8 as u64, 8); let field_1 = value.entry.name.bytes.0.to_value(context); let field_2 = value.entry.name.utf16.0.to_value(context); context.allocate_aggregate(vec![field_0, field_1, field_2]) }; let field_1 = vm::Value::uint(value.entry.kind as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1]) }; context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_fs_file_copy_file_range_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::FileHandle, FileOffset, resource::FileHandle, FileOffset, FileSize)> {
    // ignore unused context
    let _ = context;
...
fn decode_destack_fs_file_fadvise_args(
    ...
    let advice = match advice_raw { 0u8 => FileAdvice::Normal, 1u8 => FileAdvice::Sequential, 2u8 => FileAdvice::Random, 3u8 => FileAdvice::WillNeed, 4u8 => FileAdvice::DontNeed, 5u8 => FileAdvice::NoReuse , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("advice", "unknown FileAdvice value")).boxed()), };
...
fn decode_destack_fs_file_openat2_args(
    ...
    let how = {
        if how_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("how", "OpenOptions")).boxed()); }
        let slots = context.aggregate_slots(how_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("how", "expected 3 fields")).boxed()); }
...
fn decode_destack_fs_file_preadv_args(
    ...
    let buffers = decode_slice::<VmSlice<u8>>(context, buffers_value, "buffers", "Slice<Slice<uint8>>")?;
    let offset_value = arg_value(args, 2, "offset", "FileOffset")?;
    let offset_inner = decode_int64(offset_value, "offset_inner", "FileOffset")?;
    let offset = FileOffset(offset_inner);
...
#[inline]
fn decode_destack_fs_file_preadv2_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::FileHandle, VmSlice<VmSlice<u8>>, FileOffset, ReadWriteFlags)> {
    let handle_value = arg_value(args, 0, "handle", "FileHandle")?;
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "FileHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
    let handle = resource::FileHandle(handle_inner);
    ...
    let offset_inner = decode_int64(offset_value, "offset_inner", "FileOffset")?;
    let offset = FileOffset(offset_inner);
    let flags_value = arg_value(args, 3, "flags", "ReadWriteFlags")?;
    let flags_inner = decode_uint32(flags_value, "flags_inner", "ReadWriteFlags")?;
    let flags = ReadWriteFlags(flags_inner);
    Ok((handle, buffers, offset, flags))
}
...
#[inline]
fn decode_destack_fs_file_pwritev2_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::FileHandle, VmSlice<VmSlice<u8>>, FileOffset, ReadWriteFlags)> {
    let handle_value = arg_value(args, 0, "handle", "FileHandle")?;
...
fn decode_destack_fs_file_seek_args(
    ...
    let whence = match whence_raw { 0u8 => SeekWhence::Set, 1u8 => SeekWhence::Cur, 2u8 => SeekWhence::End , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("whence", "unknown SeekWhence value")).boxed()), };
...
fn decode_destack_fs_file_sendfile_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::SocketHandle, resource::FileHandle, FileOffset, FileSize)> {
    // ignore unused context
    let _ = context;
...
/// Decode arguments for destack.fs.file.splice.
#[inline]
fn decode_destack_fs_file_splice_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::ResourceId, SpliceCursorVm, resource::ResourceId, SpliceCursorVm, FileSize, SpliceFlags)> {
    let source_value = arg_value(args, 0, "source", "ResourceId")?;
    let source_inner = decode_uint64(source_value, "source_inner", "ResourceId")?;
    let source = resource::ResourceId(source_inner);
    let sourcecursor_value = arg_value(args, 1, "sourcecursor", "SpliceCursor")?;
    let sourcecursor = {
        if sourcecursor_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("sourcecursor", "SpliceCursor")).boxed()); }
        let slots = context.aggregate_slots(sourcecursor_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 2 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("sourcecursor", "expected 2 fields")).boxed()); }
        let sourcecursor_has_offset = decode_bool(slots[0], "sourcecursor_has_offset", "hasOffset")?;
        let sourcecursor_offset_inner = decode_int64(slots[1], "sourcecursor_offset_inner", "offset")?;
        let sourcecursor_offset = FileOffset(sourcecursor_offset_inner);
        SpliceCursorVm {
            has_offset: sourcecursor_has_offset,
            offset: sourcecursor_offset,
        }
    };
    let target_value = arg_value(args, 2, "target", "ResourceId")?;
    let target_inner = decode_uint64(target_value, "target_inner", "ResourceId")?;
    let target = resource::ResourceId(target_inner);
    let targetcursor_value = arg_value(args, 3, "targetcursor", "SpliceCursor")?;
    let targetcursor = {
        if targetcursor_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("targetcursor", "SpliceCursor")).boxed()); }
        let slots = context.aggregate_slots(targetcursor_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 2 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("targetcursor", "expected 2 fields")).boxed()); }
        let targetcursor_has_offset = decode_bool(slots[0], "targetcursor_has_offset", "hasOffset")?;
        let targetcursor_offset_inner = decode_int64(slots[1], "targetcursor_offset_inner", "offset")?;
        let targetcursor_offset = FileOffset(targetcursor_offset_inner);
        SpliceCursorVm {
            has_offset: targetcursor_has_offset,
            offset: targetcursor_offset,
        }
    };
    let length_value = arg_value(args, 4, "length", "FileSize")?;
    let length_inner = decode_uint64(length_value, "length_inner", "FileSize")?;
    let length = FileSize(length_inner);
    let flags_value = arg_value(args, 5, "flags", "SpliceFlags")?;
    let flags_inner = decode_uint32(flags_value, "flags_inner", "SpliceFlags")?;
    let flags = SpliceFlags(flags_inner);
    Ok((source, sourcecursor, target, targetcursor, length, flags))
}
...
fn decode_destack_fs_file_tee_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::PipeHandle, resource::PipeHandle, FileSize, SpliceFlags)> {
    // ignore unused context
    let _ = context;

    let sourcepipe_value = arg_value(args, 0, "sourcepipe", "PipeHandle")?;
    let sourcepipe_inner_inner = decode_uint64(sourcepipe_value, "sourcepipe_inner_inner", "PipeHandle")?;
    let sourcepipe_inner = resource::ResourceId(sourcepipe_inner_inner);
    let sourcepipe = resource::PipeHandle(sourcepipe_inner);
    let targetpipe_value = arg_value(args, 1, "targetpipe", "PipeHandle")?;
    let targetpipe_inner_inner = decode_uint64(targetpipe_value, "targetpipe_inner_inner", "PipeHandle")?;
    let targetpipe_inner = resource::ResourceId(targetpipe_inner_inner);
    let targetpipe = resource::PipeHandle(targetpipe_inner);
    let length_value = arg_value(args, 2, "length", "FileSize")?;
    let length_inner = decode_uint64(length_value, "length_inner", "FileSize")?;
    let length = FileSize(length_inner);
    let flags_value = arg_value(args, 3, "flags", "SpliceFlags")?;
    let flags_inner = decode_uint32(flags_value, "flags_inner", "SpliceFlags")?;
    let flags = SpliceFlags(flags_inner);
    Ok((sourcepipe, targetpipe, length, flags))
}
...
/// Decode arguments for destack.fs.file.vmsplice.
#[inline]
fn decode_destack_fs_file_vmsplice_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::PipeHandle, VmSlice<VmSlice<u8>>, SpliceFlags)> {
    let pipe_value = arg_value(args, 0, "pipe", "PipeHandle")?;
    let pipe_inner_inner = decode_uint64(pipe_value, "pipe_inner_inner", "PipeHandle")?;
    let pipe_inner = resource::ResourceId(pipe_inner_inner);
    let pipe = resource::PipeHandle(pipe_inner);
    let buffers_value = arg_value(args, 1, "buffers", "Slice<Slice<uint8>>")?;
    let buffers = decode_slice::<VmSlice<u8>>(context, buffers_value, "buffers", "Slice<Slice<uint8>>")?;
    let flags_value = arg_value(args, 2, "flags", "SpliceFlags")?;
    let flags_inner = decode_uint32(flags_value, "flags_inner", "SpliceFlags")?;
    let flags = SpliceFlags(flags_inner);
    Ok((pipe, buffers, flags))
}
...
fn decode_destack_fs_mmap_madvise_args(
    ...
    let advice = match advice_raw { 0u8 => MmapAdvice::Normal, 1u8 => MmapAdvice::Sequential, 2u8 => MmapAdvice::Random, 3u8 => MmapAdvice::WillNeed, 4u8 => MmapAdvice::DontNeed , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("advice", "unknown MmapAdvice value")).boxed()), };
    Ok((mapping, advice))
}
...
fn decode_destack_fs_mmap_file_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::FileHandle, FileOffset, FileSize, MmapProt, MmapFlags)> {
    // ignore unused context
    let _ = context;
...
fn decode_destack_fs_path_copyfile_args(
    ...
    let from = {
        if from_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("from", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(from_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("from", "expected 3 fields")).boxed()); }
        let from_encoding_raw = decode_uint8(slots[0], "from_encoding_raw", "encoding")?;
        let from_encoding = match from_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("from_encoding", "unknown PathEncoding value")).boxed()), };
        let from_bytes_inner = decode_array::<u8>(context, slots[1], "from_bytes_inner", "bytes")?;
        let from_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(from_bytes_inner);
        let from_utf16_inner = decode_array::<u16>(context, slots[2], "from_utf16_inner", "utf16")?;
        let from_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(from_utf16_inner);
        OsPathVm {
    ...
    let to = {
        if to_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("to", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(to_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("to", "expected 3 fields")).boxed()); }
        let to_encoding_raw = decode_uint8(slots[0], "to_encoding_raw", "encoding")?;
        let to_encoding = match to_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("to_encoding", "unknown PathEncoding value")).boxed()), };
        let to_bytes_inner = decode_array::<u8>(context, slots[1], "to_bytes_inner", "bytes")?;
        let to_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(to_bytes_inner);
        let to_utf16_inner = decode_array::<u16>(context, slots[2], "to_utf16_inner", "utf16")?;
        let to_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(to_utf16_inner);
        OsPathVm {
...
fn decode_destack_fs_path_link_args(
    ...
    let existingpath = {
        if existingpath_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("existingpath", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(existingpath_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("existingpath", "expected 3 fields")).boxed()); }
        let existingpath_encoding_raw = decode_uint8(slots[0], "existingpath_encoding_raw", "encoding")?;
        let existingpath_encoding = match existingpath_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("existingpath_encoding", "unknown PathEncoding value")).boxed()), };
        let existingpath_bytes_inner = decode_array::<u8>(context, slots[1], "existingpath_bytes_inner", "bytes")?;
        let existingpath_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(existingpath_bytes_inner);
        let existingpath_utf16_inner = decode_array::<u16>(context, slots[2], "existingpath_utf16_inner", "utf16")?;
        let existingpath_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(existingpath_utf16_inner);
        OsPathVm {
    ...
    let newpath = {
        if newpath_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("newpath", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(newpath_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("newpath", "expected 3 fields")).boxed()); }
        let newpath_encoding_raw = decode_uint8(slots[0], "newpath_encoding_raw", "encoding")?;
        let newpath_encoding = match newpath_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("newpath_encoding", "unknown PathEncoding value")).boxed()), };
        let newpath_bytes_inner = decode_array::<u8>(context, slots[1], "newpath_bytes_inner", "bytes")?;
        let newpath_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(newpath_bytes_inner);
        let newpath_utf16_inner = decode_array::<u16>(context, slots[2], "newpath_utf16_inner", "utf16")?;
        let newpath_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(newpath_utf16_inner);
        OsPathVm {
...
fn decode_destack_fs_path_linkat_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::DirectoryHandle, OsPathVm, resource::DirectoryHandle, OsPathVm, AtFlags)> {
    let existingdir_value = arg_value(args, 0, "existingdir", "DirectoryHandle")?;
    let existingdir_inner_inner = decode_uint64(existingdir_value, "existingdir_inner_inner", "DirectoryHandle")?;
...
fn decode_destack_fs_path_renameat_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::DirectoryHandle, OsPathVm, resource::DirectoryHandle, OsPathVm)> {
    let fromdir_value = arg_value(args, 0, "fromdir", "DirectoryHandle")?;
    let fromdir_inner_inner = decode_uint64(fromdir_value, "fromdir_inner_inner", "DirectoryHandle")?;
...
fn decode_destack_fs_path_renameat2_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::DirectoryHandle, OsPathVm, resource::DirectoryHandle, OsPathVm, RenameFlags)> {
    let fromdir_value = arg_value(args, 0, "fromdir", "DirectoryHandle")?;
    let fromdir_inner_inner = decode_uint64(fromdir_value, "fromdir_inner_inner", "DirectoryHandle")?;
    let fromdir_inner = resource::ResourceId(fromdir_inner_inner);
    let fromdir = resource::DirectoryHandle(fromdir_inner);
...
fn decode_destack_fs_path_symlink_args(
    ...
    let target = {
        if target_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("target", "OsPath")).boxed()); }
        let slots = context.aggregate_slots(target_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("target", "expected 3 fields")).boxed()); }
        let target_encoding_raw = decode_uint8(slots[0], "target_encoding_raw", "encoding")?;
        let target_encoding = match target_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("target_encoding", "unknown PathEncoding value")).boxed()), };
        let target_bytes_inner = decode_array::<u8>(context, slots[1], "target_bytes_inner", "bytes")?;
        let target_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(target_bytes_inner);
        let target_utf16_inner = decode_array::<u16>(context, slots[2], "target_utf16_inner", "utf16")?;
    ...
    let kind = match kind_raw { 0u8 => SymlinkType::Auto, 1u8 => SymlinkType::File, 2u8 => SymlinkType::Directory , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("kind", "unknown SymlinkType value")).boxed()), };
    Ok((target, path, kind))
}
...
fn encode_destack_fs_stat_fstat_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.dev, 64); let field_1 = vm::Value::uint(value.ino, 64); let field_2 = vm::Value::uint(value.mode.0 as u64, 32); let field_3 = vm::Value::uint(value.nlink as u64, 32); let field_4 = vm::Value::uint(value.uid as u64, 32); let field_5 = vm::Value::uint(value.gid as u64, 32); let field_6 = vm::Value::uint(value.rdev, 64); let field_7 = vm::Value::uint(value.size.0, 64); let field_8 = vm::Value::uint(value.blksize, 64); let field_9 = vm::Value::uint(value.blocks, 64); let field_10 = vm::Value::uint(value.atime_ns, 64); let field_11 = vm::Value::uint(value.mtime_ns, 64); let field_12 = vm::Value::uint(value.ctime_ns, 64); let field_13 = vm::Value::uint(value.birthtime_ns, 64); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13]) })
}
...
fn encode_destack_fs_stat_fstatfs_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.bsize, 64); let field_1 = vm::Value::uint(value.frsize, 64); let field_2 = vm::Value::uint(value.blocks, 64); let field_3 = vm::Value::uint(value.bfree, 64); let field_4 = vm::Value::uint(value.bavail, 64); let field_5 = vm::Value::uint(value.files, 64); let field_6 = vm::Value::uint(value.ffree, 64); let field_7 = vm::Value::uint(value.fsid, 64); let field_8 = vm::Value::uint(value.flags.0, 64); let field_9 = vm::Value::uint(value.namelen, 64); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9]) })
}
...
fn encode_destack_fs_stat_statx_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.mask.0 as u64, 32); let field_1 = vm::Value::uint(value.blksize as u64, 32); let field_2 = vm::Value::uint(value.mount_id, 64); let field_3 = vm::Value::uint(value.dev_major as u64, 32); let field_4 = vm::Value::uint(value.dev_minor as u64, 32); let field_5 = vm::Value::uint(value.ino, 64); let field_6 = vm::Value::uint(value.mode.0 as u64, 32); let field_7 = vm::Value::uint(value.nlink as u64, 32); let field_8 = vm::Value::uint(value.uid as u64, 32); let field_9 = vm::Value::uint(value.gid as u64, 32); let field_10 = vm::Value::uint(value.rdev_major as u64, 32); let field_11 = vm::Value::uint(value.rdev_minor as u64, 32); let field_12 = vm::Value::uint(value.size.0, 64); let field_13 = vm::Value::uint(value.blocks, 64); let field_14 = vm::Value::uint(value.atime_ns, 64); let field_15 = vm::Value::uint(value.btime_ns, 64); let field_16 = vm::Value::uint(value.ctime_ns, 64); let field_17 = vm::Value::uint(value.mtime_ns, 64); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13, field_14, field_15, field_16, field_17]) })
}
...
fn decode_destack_fs_watch_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "WatchOptions")).boxed()); }
        ...
        let options_follow_symlinks = decode_bool(slots[2], "options_follow_symlinks", "followSymlinks")?;
        WatchOptionsVm {
            mask: options_mask,
...
fn encode_destack_fs_watch_read_result(
    ...
    result.map(|value| { let field_0 = value.events.to_value(context); let field_1 = vm::Value::bool(value.overflowed); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_fs_xattr_fsetxattr_args(
    context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::FileHandle, vm::StringHandle, VmSlice<u8>, XattrFlags)> {
    let handle_value = arg_value(args, 0, "handle", "FileHandle")?;
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "FileHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
    let handle = resource::FileHandle(handle_inner);
...
pub const FS_ATTRS_ACCESS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_ATTRS_CHMOD: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_ATTRS_FCHMOD: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_CLOSEDIR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_MKDTEMP: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_OPENDIR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_READDIR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_READDIR_NEXT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_DIR_REWINDDIR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_FILE_FDATASYNC: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_FILE_GET_FD_FLAGS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_FILE_GET_STATUS_FLAGS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_FILE_SYNCFS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_FILE_TRUNCATE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_MMAP_MUNMAP: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_PATH_MKFIFO: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_PATH_READLINK: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_PATH_REALPATH: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_PATH_RENAME: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_PATH_UNLINK: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_STAT_FSTATFS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_STAT_STATFS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_WATCH_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_FLISTXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_FLISTXATTR_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_GETXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LGETXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LISTXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LISTXATTR_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LLISTXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LLISTXATTR_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_LREMOVEXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_XATTR_REMOVEXATTR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const FS_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "fs",
    bindings: &[
        NativeBinding::new(FS_ATTRS_ACCESS, "destack.fs.attrs.access", destack_fs_attrs_access as *const ()),
        NativeBinding::new(FS_ATTRS_ACCESSAT, "destack.fs.attrs.accessat", destack_fs_attrs_accessat as *const ()),
        NativeBinding::new(FS_ATTRS_CHMOD, "destack.fs.attrs.chmod", destack_fs_attrs_chmod as *const ()),
        NativeBinding::new(FS_ATTRS_CHOWN, "destack.fs.attrs.chown", destack_fs_attrs_chown as *const ()),
        NativeBinding::new(FS_ATTRS_FCHMOD, "destack.fs.attrs.fchmod", destack_fs_attrs_fchmod as *const ()),
        NativeBinding::new(FS_ATTRS_FCHMODAT, "destack.fs.attrs.fchmodat", destack_fs_attrs_fchmodat as *const ()),
        NativeBinding::new(FS_ATTRS_FCHOWN, "destack.fs.attrs.fchown", destack_fs_attrs_fchown as *const ()),
        NativeBinding::new(FS_ATTRS_FCHOWNAT, "destack.fs.attrs.fchownat", destack_fs_attrs_fchownat as *const ()),
        NativeBinding::new(FS_ATTRS_FUTIMES, "destack.fs.attrs.futimes", destack_fs_attrs_futimes as *const ()),
        NativeBinding::new(FS_ATTRS_LUTIMES, "destack.fs.attrs.lutimes", destack_fs_attrs_lutimes as *const ()),
        NativeBinding::new(FS_ATTRS_UTIMENSAT, "destack.fs.attrs.utimensat", destack_fs_attrs_utimensat as *const ()),
        NativeBinding::new(FS_ATTRS_UTIMES, "destack.fs.attrs.utimes", destack_fs_attrs_utimes as *const ()),
        NativeBinding::new(FS_DIR_CLOSEDIR, "destack.fs.dir.closedir", destack_fs_dir_closedir as *const ()),
        NativeBinding::new(FS_DIR_DIRFD, "destack.fs.dir.dirfd", destack_fs_dir_dirfd as *const ()),
        NativeBinding::new(FS_DIR_MKDIR, "destack.fs.dir.mkdir", destack_fs_dir_mkdir as *const ()),
        NativeBinding::new(FS_DIR_MKDIRAT, "destack.fs.dir.mkdirat", destack_fs_dir_mkdirat as *const ()),
        NativeBinding::new(FS_DIR_MKDTEMP, "destack.fs.dir.mkdtemp", destack_fs_dir_mkdtemp as *const ()),
        NativeBinding::new(FS_DIR_OPENDIR, "destack.fs.dir.opendir", destack_fs_dir_opendir as *const ()),
        NativeBinding::new(FS_DIR_READDIR, "destack.fs.dir.readdir", destack_fs_dir_readdir as *const ()),
        NativeBinding::new(FS_DIR_READDIR_NEXT, "destack.fs.dir.readdirNext", destack_fs_dir_readdir_next as *const ()),
        NativeBinding::new(FS_DIR_REWINDDIR, "destack.fs.dir.rewinddir", destack_fs_dir_rewinddir as *const ()),
        NativeBinding::new(FS_DIR_RMDIR, "destack.fs.dir.rmdir", destack_fs_dir_rmdir as *const ()),
        NativeBinding::new(FS_FILE_CLOSE, "destack.fs.file.close", destack_fs_file_close as *const ()),
        NativeBinding::new(FS_FILE_COPY_FILE_RANGE, "destack.fs.file.copyFileRange", destack_fs_file_copy_file_range as *const ()),
        NativeBinding::new(FS_FILE_DUP, "destack.fs.file.dup", destack_fs_file_dup as *const ()),
        NativeBinding::new(FS_FILE_DUP2, "destack.fs.file.dup2", destack_fs_file_dup2 as *const ()),
        NativeBinding::new(FS_FILE_DUP3, "destack.fs.file.dup3", destack_fs_file_dup3 as *const ()),
        NativeBinding::new(FS_FILE_FADVISE, "destack.fs.file.fadvise", destack_fs_file_fadvise as *const ()),
        NativeBinding::new(FS_FILE_FALLOCATE, "destack.fs.file.fallocate", destack_fs_file_fallocate as *const ()),
        NativeBinding::new(FS_FILE_FDATASYNC, "destack.fs.file.fdatasync", destack_fs_file_fdatasync as *const ()),
        NativeBinding::new(FS_FILE_FSYNC, "destack.fs.file.fsync", destack_fs_file_fsync as *const ()),
        NativeBinding::new(FS_FILE_FTRUNCATE, "destack.fs.file.ftruncate", destack_fs_file_ftruncate as *const ()),
        NativeBinding::new(FS_FILE_GET_FD_FLAGS, "destack.fs.file.getFdFlags", destack_fs_file_get_fd_flags as *const ()),
        NativeBinding::new(FS_FILE_GET_STATUS_FLAGS, "destack.fs.file.getStatusFlags", destack_fs_file_get_status_flags as *const ()),
        NativeBinding::new(FS_FILE_LOCK, "destack.fs.file.lock", destack_fs_file_lock as *const ()),
        NativeBinding::new(FS_FILE_OPEN, "destack.fs.file.open", destack_fs_file_open as *const ()),
        NativeBinding::new(FS_FILE_OPENAT, "destack.fs.file.openat", destack_fs_file_openat as *const ()),
        NativeBinding::new(FS_FILE_OPENAT2, "destack.fs.file.openat2", destack_fs_file_openat2 as *const ()),
        NativeBinding::new(FS_FILE_PREAD, "destack.fs.file.pread", destack_fs_file_pread as *const ()),
        NativeBinding::new(FS_FILE_PREADV, "destack.fs.file.preadv", destack_fs_file_preadv as *const ()),
        NativeBinding::new(FS_FILE_PREADV2, "destack.fs.file.preadv2", destack_fs_file_preadv2 as *const ()),
        NativeBinding::new(FS_FILE_PWRITE, "destack.fs.file.pwrite", destack_fs_file_pwrite as *const ()),
        NativeBinding::new(FS_FILE_PWRITEV, "destack.fs.file.pwritev", destack_fs_file_pwritev as *const ()),
        NativeBinding::new(FS_FILE_PWRITEV2, "destack.fs.file.pwritev2", destack_fs_file_pwritev2 as *const ()),
        NativeBinding::new(FS_FILE_READ, "destack.fs.file.read", destack_fs_file_read as *const ()),
        NativeBinding::new(FS_FILE_READV, "destack.fs.file.readv", destack_fs_file_readv as *const ()),
        NativeBinding::new(FS_FILE_SEEK, "destack.fs.file.seek", destack_fs_file_seek as *const ()),
        NativeBinding::new(FS_FILE_SENDFILE, "destack.fs.file.sendfile", destack_fs_file_sendfile as *const ()),
        NativeBinding::new(FS_FILE_SET_FD_FLAGS, "destack.fs.file.setFdFlags", destack_fs_file_set_fd_flags as *const ()),
        NativeBinding::new(FS_FILE_SET_STATUS_FLAGS, "destack.fs.file.setStatusFlags", destack_fs_file_set_status_flags as *const ()),
        NativeBinding::new(FS_FILE_SPLICE, "destack.fs.file.splice", destack_fs_file_splice as *const ()),
        NativeBinding::new(FS_FILE_SYNC_FILE_RANGE, "destack.fs.file.syncFileRange", destack_fs_file_sync_file_range as *const ()),
        NativeBinding::new(FS_FILE_SYNCFS, "destack.fs.file.syncfs", destack_fs_file_syncfs as *const ()),
        NativeBinding::new(FS_FILE_TEE, "destack.fs.file.tee", destack_fs_file_tee as *const ()),
        NativeBinding::new(FS_FILE_TRUNCATE, "destack.fs.file.truncate", destack_fs_file_truncate as *const ()),
        NativeBinding::new(FS_FILE_VMSPLICE, "destack.fs.file.vmsplice", destack_fs_file_vmsplice as *const ()),
        NativeBinding::new(FS_FILE_WRITE, "destack.fs.file.write", destack_fs_file_write as *const ()),
        NativeBinding::new(FS_FILE_WRITEV, "destack.fs.file.writev", destack_fs_file_writev as *const ()),
        NativeBinding::new(FS_MMAP_MADVISE, "destack.fs.mmap.madvise", destack_fs_mmap_madvise as *const ()),
        NativeBinding::new(FS_MMAP_MPROTECT, "destack.fs.mmap.mprotect", destack_fs_mmap_mprotect as *const ()),
        NativeBinding::new(FS_MMAP_MSYNC, "destack.fs.mmap.msync", destack_fs_mmap_msync as *const ()),
        NativeBinding::new(FS_MMAP_MUNMAP, "destack.fs.mmap.munmap", destack_fs_mmap_munmap as *const ()),
        NativeBinding::new(FS_MMAP_ANONYMOUS, "destack.fs.mmapAnonymous", destack_fs_mmap_anonymous as *const ()),
        NativeBinding::new(FS_MMAP_FILE, "destack.fs.mmapFile", destack_fs_mmap_file as *const ()),
        NativeBinding::new(FS_PATH_COPYFILE, "destack.fs.path.copyfile", destack_fs_path_copyfile as *const ()),
        NativeBinding::new(FS_PATH_LINK, "destack.fs.path.link", destack_fs_path_link as *const ()),
        NativeBinding::new(FS_PATH_LINKAT, "destack.fs.path.linkat", destack_fs_path_linkat as *const ()),
        NativeBinding::new(FS_PATH_MKFIFO, "destack.fs.path.mkfifo", destack_fs_path_mkfifo as *const ()),
        NativeBinding::new(FS_PATH_MKFIFOAT, "destack.fs.path.mkfifoat", destack_fs_path_mkfifoat as *const ()),
        NativeBinding::new(FS_PATH_MKNOD, "destack.fs.path.mknod", destack_fs_path_mknod as *const ()),
        NativeBinding::new(FS_PATH_MKNODAT, "destack.fs.path.mknodat", destack_fs_path_mknodat as *const ()),
        NativeBinding::new(FS_PATH_READLINK, "destack.fs.path.readlink", destack_fs_path_readlink as *const ()),
        NativeBinding::new(FS_PATH_READLINKAT, "destack.fs.path.readlinkat", destack_fs_path_readlinkat as *const ()),
        NativeBinding::new(FS_PATH_REALPATH, "destack.fs.path.realpath", destack_fs_path_realpath as *const ()),
        NativeBinding::new(FS_PATH_RENAME, "destack.fs.path.rename", destack_fs_path_rename as *const ()),
        NativeBinding::new(FS_PATH_RENAMEAT, "destack.fs.path.renameat", destack_fs_path_renameat as *const ()),
        NativeBinding::new(FS_PATH_RENAMEAT2, "destack.fs.path.renameat2", destack_fs_path_renameat2 as *const ()),
        NativeBinding::new(FS_PATH_SYMLINK, "destack.fs.path.symlink", destack_fs_path_symlink as *const ()),
        NativeBinding::new(FS_PATH_SYMLINKAT, "destack.fs.path.symlinkat", destack_fs_path_symlinkat as *const ()),
        NativeBinding::new(FS_PATH_UNLINK, "destack.fs.path.unlink", destack_fs_path_unlink as *const ()),
        NativeBinding::new(FS_PATH_UNLINKAT, "destack.fs.path.unlinkat", destack_fs_path_unlinkat as *const ()),
        NativeBinding::new(FS_STAT_FSTAT, "destack.fs.stat.fstat", destack_fs_stat_fstat as *const ()),
        NativeBinding::new(FS_STAT_FSTATFS, "destack.fs.stat.fstatfs", destack_fs_stat_fstatfs as *const ()),
        NativeBinding::new(FS_STAT_LSTAT, "destack.fs.stat.lstat", destack_fs_stat_lstat as *const ()),
        NativeBinding::new(FS_STAT_STAT, "destack.fs.stat.stat", destack_fs_stat_stat as *const ()),
        NativeBinding::new(FS_STAT_STATAT, "destack.fs.stat.statat", destack_fs_stat_statat as *const ()),
        NativeBinding::new(FS_STAT_STATFS, "destack.fs.stat.statfs", destack_fs_stat_statfs as *const ()),
        NativeBinding::new(FS_STAT_STATX, "destack.fs.stat.statx", destack_fs_stat_statx as *const ()),
        NativeBinding::new(FS_WATCH, "destack.fs.watch", destack_fs_watch as *const ()),
        NativeBinding::new(FS_WATCH_CLOSE, "destack.fs.watchClose", destack_fs_watch_close as *const ()),
        NativeBinding::new(FS_WATCH_READ, "destack.fs.watchRead", destack_fs_watch_read as *const ()),
        NativeBinding::new(FS_WATCHAT, "destack.fs.watchat", destack_fs_watchat as *const ()),
        NativeBinding::new(FS_XATTR_FGETXATTR, "destack.fs.xattr.fgetxattr", destack_fs_xattr_fgetxattr as *const ()),
        NativeBinding::new(FS_XATTR_FGETXATTR_BYTES, "destack.fs.xattr.fgetxattrBytes", destack_fs_xattr_fgetxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_FLISTXATTR, "destack.fs.xattr.flistxattr", destack_fs_xattr_flistxattr as *const ()),
        NativeBinding::new(FS_XATTR_FLISTXATTR_BYTES, "destack.fs.xattr.flistxattrBytes", destack_fs_xattr_flistxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_FREMOVEXATTR, "destack.fs.xattr.fremovexattr", destack_fs_xattr_fremovexattr as *const ()),
        NativeBinding::new(FS_XATTR_FREMOVEXATTR_BYTES, "destack.fs.xattr.fremovexattrBytes", destack_fs_xattr_fremovexattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_FSETXATTR, "destack.fs.xattr.fsetxattr", destack_fs_xattr_fsetxattr as *const ()),
        NativeBinding::new(FS_XATTR_FSETXATTR_BYTES, "destack.fs.xattr.fsetxattrBytes", destack_fs_xattr_fsetxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_GETXATTR, "destack.fs.xattr.getxattr", destack_fs_xattr_getxattr as *const ()),
        NativeBinding::new(FS_XATTR_GETXATTR_BYTES, "destack.fs.xattr.getxattrBytes", destack_fs_xattr_getxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_LGETXATTR, "destack.fs.xattr.lgetxattr", destack_fs_xattr_lgetxattr as *const ()),
        NativeBinding::new(FS_XATTR_LGETXATTR_BYTES, "destack.fs.xattr.lgetxattrBytes", destack_fs_xattr_lgetxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_LISTXATTR, "destack.fs.xattr.listxattr", destack_fs_xattr_listxattr as *const ()),
        NativeBinding::new(FS_XATTR_LISTXATTR_BYTES, "destack.fs.xattr.listxattrBytes", destack_fs_xattr_listxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_LLISTXATTR, "destack.fs.xattr.llistxattr", destack_fs_xattr_llistxattr as *const ()),
        NativeBinding::new(FS_XATTR_LLISTXATTR_BYTES, "destack.fs.xattr.llistxattrBytes", destack_fs_xattr_llistxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_LREMOVEXATTR, "destack.fs.xattr.lremovexattr", destack_fs_xattr_lremovexattr as *const ()),
        NativeBinding::new(FS_XATTR_LREMOVEXATTR_BYTES, "destack.fs.xattr.lremovexattrBytes", destack_fs_xattr_lremovexattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_LSETXATTR, "destack.fs.xattr.lsetxattr", destack_fs_xattr_lsetxattr as *const ()),
        NativeBinding::new(FS_XATTR_LSETXATTR_BYTES, "destack.fs.xattr.lsetxattrBytes", destack_fs_xattr_lsetxattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_REMOVEXATTR, "destack.fs.xattr.removexattr", destack_fs_xattr_removexattr as *const ()),
        NativeBinding::new(FS_XATTR_REMOVEXATTR_BYTES, "destack.fs.xattr.removexattrBytes", destack_fs_xattr_removexattr_bytes as *const ()),
        NativeBinding::new(FS_XATTR_SETXATTR, "destack.fs.xattr.setxattr", destack_fs_xattr_setxattr as *const ()),
        NativeBinding::new(FS_XATTR_SETXATTR_BYTES, "destack.fs.xattr.setxattrBytes", destack_fs_xattr_setxattr_bytes as *const ()),
    ],
};
...
fn destack_fs_attrs_access_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_access(context, path, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_access(context, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_accessat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_accessat(context, dir, path, mode, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_accessat(context, dir, path, mode, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_chmod_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_chmod(context, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_chown_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_chown(context, path, uid, gid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_chown(context, path, uid, gid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_fchmod_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fchmod(context, handle, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fchmod(context, handle, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_fchmodat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fchmodat(context, dir, path, mode, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fchmodat(context, dir, path, mode, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_fchown_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fchown(context, handle, uid, gid) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fchown(context, handle, uid, gid) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_fchownat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fchownat(context, dir, path, uid, gid, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fchownat(context, dir, path, uid, gid, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_futimes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_futimes(context, handle, atimens, mtimens) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_futimes(context, handle, atimens, mtimens) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_lutimes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lutimes(context, path, atimens, mtimens) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lutimes(context, path, atimens, mtimens) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_utimensat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_utimensat(context, dir, path, atimens, mtimens, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_utimensat(context, dir, path, atimens, mtimens, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_attrs_utimes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_utimes(context, path, atimens, mtimens) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_utimes(context, path, atimens, mtimens) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_dir_closedir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_closedir(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_dir_dirfd_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_dirfd(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_dirfd(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_fs_dir_mkdir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mkdir(context, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_dir_mkdirat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mkdirat(context, dir, path, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mkdirat(context, dir, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_dir_mkdtemp_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mkdtemp(context, out, template) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mkdtemp(context, out, template) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_bytes_inner = context.store_array(value_native_bytes_inner_values);
                    let value_native_bytes = platform_fs::PathBytesAbi::<platform_abi::NativeAbi>(value_native_bytes_inner);
                    ...
                    let value_native_utf16_inner = context.store_array(value_native_utf16_inner_values);
                    let value_native_utf16 = platform_fs::PathUtf16Abi::<platform_abi::NativeAbi>(value_native_utf16_inner);
...
fn destack_fs_dir_opendir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_opendir(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_opendir(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_dir_readdir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_readdir(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_readdir(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    ...
                    let result_recorded_item_recorded_name_encoding = result_recorded_item.name.encoding;
                    let result_recorded_item_recorded_name_bytes_raw = unsafe { result_recorded_item.name.bytes.0.as_slice()? };
                    let mut result_recorded_item_recorded_name_bytes = Vec::with_capacity(result_recorded_item_recorded_name_bytes_raw.len());
                    for result_recorded_item_recorded_name_bytes_item_value in result_recorded_item_recorded_name_bytes_raw {
                        let result_recorded_item_recorded_name_bytes_item = *result_recorded_item_recorded_name_bytes_item_value;
                        let result_recorded_item_recorded_name_bytes_item_recorded = result_recorded_item_recorded_name_bytes_item;
                        result_recorded_item_recorded_name_bytes.push(result_recorded_item_recorded_name_bytes_item_recorded);
                    }
                    let result_recorded_item_recorded_name_utf16_raw = unsafe { result_recorded_item.name.utf16.0.as_slice()? };
                    let mut result_recorded_item_recorded_name_utf16 = Vec::with_capacity(result_recorded_item_recorded_name_utf16_raw.len());
                    for result_recorded_item_recorded_name_utf16_item_value in result_recorded_item_recorded_name_utf16_raw {
                        let result_recorded_item_recorded_name_utf16_item = *result_recorded_item_recorded_name_utf16_item_value;
                        let result_recorded_item_recorded_name_utf16_item_recorded = result_recorded_item_recorded_name_utf16_item;
                        result_recorded_item_recorded_name_utf16.push(result_recorded_item_recorded_name_utf16_item_recorded);
                    }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value {
                        let value_native_item_native_name_encoding = value_native_item.name.encoding;
                        let mut value_native_item_native_name_bytes_inner_values = Vec::with_capacity(value_native_item.name.bytes.len());
                        for value_native_item_native_name_bytes_inner_item in value_native_item.name.bytes {
                            let value_native_item_native_name_bytes_inner_item_native = value_native_item_native_name_bytes_inner_item;
                            value_native_item_native_name_bytes_inner_values.push(value_native_item_native_name_bytes_inner_item_native);
                        }
                        let value_native_item_native_name_bytes_inner = context.store_array(value_native_item_native_name_bytes_inner_values);
                        let value_native_item_native_name_bytes = platform_fs::PathBytesAbi::<platform_abi::NativeAbi>(value_native_item_native_name_bytes_inner);
                        let mut value_native_item_native_name_utf16_inner_values = Vec::with_capacity(value_native_item.name.utf16.len());
                        for value_native_item_native_name_utf16_inner_item in value_native_item.name.utf16 {
                            let value_native_item_native_name_utf16_inner_item_native = value_native_item_native_name_utf16_inner_item;
                            value_native_item_native_name_utf16_inner_values.push(value_native_item_native_name_utf16_inner_item_native);
                        }
                        let value_native_item_native_name_utf16_inner = context.store_array(value_native_item_native_name_utf16_inner_values);
                        let value_native_item_native_name_utf16 = platform_fs::PathUtf16Abi::<platform_abi::NativeAbi>(value_native_item_native_name_utf16_inner);
...
fn destack_fs_dir_readdir_next_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_readdir_next(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_readdir_next(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                ...
                let result_recorded_entry_name_bytes_raw = unsafe { result_value.entry.name.bytes.0.as_slice()? };
                let mut result_recorded_entry_name_bytes = Vec::with_capacity(result_recorded_entry_name_bytes_raw.len());
                for result_recorded_entry_name_bytes_item_value in result_recorded_entry_name_bytes_raw {
                    let result_recorded_entry_name_bytes_item = *result_recorded_entry_name_bytes_item_value;
                    let result_recorded_entry_name_bytes_item_recorded = result_recorded_entry_name_bytes_item;
                    result_recorded_entry_name_bytes.push(result_recorded_entry_name_bytes_item_recorded);
                }
                let result_recorded_entry_name_utf16_raw = unsafe { result_value.entry.name.utf16.0.as_slice()? };
                let mut result_recorded_entry_name_utf16 = Vec::with_capacity(result_recorded_entry_name_utf16_raw.len());
                for result_recorded_entry_name_utf16_item_value in result_recorded_entry_name_utf16_raw {
                    let result_recorded_entry_name_utf16_item = *result_recorded_entry_name_utf16_item_value;
                    let result_recorded_entry_name_utf16_item_recorded = result_recorded_entry_name_utf16_item;
                    result_recorded_entry_name_utf16.push(result_recorded_entry_name_utf16_item_recorded);
                }
                let result_recorded_entry_name = OsPathReplayRecord {
                    encoding: result_recorded_entry_name_encoding,
                    bytes: result_recorded_entry_name_bytes,
                    utf16: result_recorded_entry_name_utf16,
                };
                let result_recorded_entry_kind = result_value.entry.kind;
                let result_recorded_entry = DirentReplayRecord {
                    name: result_recorded_entry_name,
                    kind: result_recorded_entry_kind,
                };
                let result_recorded = DirentNextReplayRecord {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let mut value_native_entry_name_bytes_inner_values = Vec::with_capacity(value.entry.name.bytes.len());
                    for value_native_entry_name_bytes_inner_item in value.entry.name.bytes {
                        let value_native_entry_name_bytes_inner_item_native = value_native_entry_name_bytes_inner_item;
                        value_native_entry_name_bytes_inner_values.push(value_native_entry_name_bytes_inner_item_native);
                    }
                    let value_native_entry_name_bytes_inner = context.store_array(value_native_entry_name_bytes_inner_values);
                    let value_native_entry_name_bytes = platform_fs::PathBytesAbi::<platform_abi::NativeAbi>(value_native_entry_name_bytes_inner);
                    let mut value_native_entry_name_utf16_inner_values = Vec::with_capacity(value.entry.name.utf16.len());
                    for value_native_entry_name_utf16_inner_item in value.entry.name.utf16 {
                        let value_native_entry_name_utf16_inner_item_native = value_native_entry_name_utf16_inner_item;
                        value_native_entry_name_utf16_inner_values.push(value_native_entry_name_utf16_inner_item_native);
                    }
                    let value_native_entry_name_utf16_inner = context.store_array(value_native_entry_name_utf16_inner_values);
                    let value_native_entry_name_utf16 = platform_fs::PathUtf16Abi::<platform_abi::NativeAbi>(value_native_entry_name_utf16_inner);
...
fn destack_fs_dir_rewinddir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_rewinddir(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_dir_rmdir_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_rmdir(context, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_copy_file_range_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_copy_file_range(context, out, src, srcoffset, dst, dstoffset, length) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_copy_file_range(context, out, src, srcoffset, dst, dstoffset, length) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_dup_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_dup(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_dup2_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_dup2(context, out, handle, target) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_dup2(context, out, handle, target) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_dup3_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_dup3(context, out, handle, target, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_dup3(context, out, handle, target, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_fadvise_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fadvise(context, handle, offset, length, advice) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fadvise(context, handle, offset, length, advice) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_fallocate_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fallocate(context, handle, offset, length, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fallocate(context, handle, offset, length, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_fdatasync_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fdatasync(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_fsync_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fsync(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_ftruncate_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_ftruncate(context, handle, size) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_ftruncate(context, handle, size) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_get_fd_flags_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_get_fd_flags(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_get_fd_flags(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_get_status_flags_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_get_status_flags(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_get_status_flags(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_lock_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lock(context, handle, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lock(context, handle, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_open(context, out, path, flags, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_open(context, out, path, flags, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_openat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_openat(context, out, dir, path, flags, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_openat(context, out, dir, path, flags, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_openat2_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_openat2(context, out, dir, path, how) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_openat2(context, out, dir, path, how) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_pread_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_pread(context, out, handle, buffer, offset) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_pread(context, out, handle, buffer, offset) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_preadv_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_preadv(context, out, handle, buffers, offset) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_preadv(context, out, handle, buffers, offset) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_preadv2_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_preadv2(context, out, handle, buffers, offset, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_preadv2(context, out, handle, buffers, offset, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_pwrite_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_pwrite(context, out, handle, buffer, offset) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_pwrite(context, out, handle, buffer, offset) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_pwritev_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_pwritev(context, out, handle, buffers, offset) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_pwritev(context, out, handle, buffers, offset) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_pwritev2_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_pwritev2(context, out, handle, buffers, offset, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_pwritev2(context, out, handle, buffers, offset, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_read_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_read(context, out, handle, buffer) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_read(context, out, handle, buffer) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_readv_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_readv(context, out, handle, buffers) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_readv(context, out, handle, buffers) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_seek_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_seek(context, out, handle, offset, whence) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_seek(context, out, handle, offset, whence) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_sendfile_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_sendfile(context, out, socket, file, offset, length) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_sendfile(context, out, socket, file, offset, length) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_set_fd_flags_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_set_fd_flags(context, handle, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_set_fd_flags(context, handle, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_set_status_flags_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_set_status_flags(context, handle, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_set_status_flags(context, handle, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_splice_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_splice(context, out, source, sourcecursor, target, targetcursor, length, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_splice(context, out, source, sourcecursor, target, targetcursor, length, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_sync_file_range_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_sync_file_range(context, handle, offset, length, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_sync_file_range(context, handle, offset, length, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_syncfs_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_syncfs(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_tee_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_tee(context, out, sourcepipe, targetpipe, length, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_tee(context, out, sourcepipe, targetpipe, length, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_truncate_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_truncate(context, path, size) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_truncate(context, path, size) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_file_vmsplice_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_vmsplice(context, out, pipe, buffers, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_vmsplice(context, out, pipe, buffers, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_write_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_write(context, out, handle, buffer) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_write(context, out, handle, buffer) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_file_writev_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_writev(context, out, handle, buffers) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_writev(context, out, handle, buffers) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_mmap_madvise_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_madvise(context, mapping, advice) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_madvise(context, mapping, advice) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_mmap_mprotect_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mprotect(context, mapping, prot) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mprotect(context, mapping, prot) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_mmap_msync_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_msync(context, mapping, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_msync(context, mapping, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_mmap_munmap_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_munmap(context, mapping) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_mmap_anonymous_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mmap_anonymous(context, out, length, prot, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mmap_anonymous(context, out, length, prot, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_mmap_file_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mmap_file(context, out, handle, offset, length, prot, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mmap_file(context, out, handle, offset, length, prot, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_path_copyfile_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_copyfile(context, from, to, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_copyfile(context, from, to, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_link_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_link(context, existingpath, newpath) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_link(context, existingpath, newpath) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_linkat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_linkat(context, existingdir, existingpath, newdir, newpath, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_linkat(context, existingdir, existingpath, newdir, newpath, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_mkfifo_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mkfifo(context, path, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mkfifo(context, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_mkfifoat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mkfifoat(context, dir, path, mode) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mkfifoat(context, dir, path, mode) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_mknod_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mknod(context, path, mode, device) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mknod(context, path, mode, device) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_mknodat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_mknodat(context, dir, path, mode, device) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_mknodat(context, dir, path, mode, device) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_readlink_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_readlink(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_readlink(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_path_readlinkat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_readlinkat(context, out, dir, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_readlinkat(context, out, dir, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_path_realpath_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_realpath(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_realpath(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_path_rename_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_rename(context, from, to) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_renameat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_renameat(context, fromdir, from, todir, to) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_renameat(context, fromdir, from, todir, to) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_renameat2_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_renameat2(context, fromdir, from, todir, to, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_renameat2(context, fromdir, from, todir, to, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_symlink_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_symlink(context, target, path, kind) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_symlink(context, target, path, kind) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_symlinkat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_symlinkat(context, target, dir, path, kind) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_symlinkat(context, target, dir, path, kind) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_unlink_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_unlink(context, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_path_unlinkat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_unlinkat(context, dir, path, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_unlinkat(context, dir, path, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_stat_fstat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fstat(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fstat(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_fstatfs_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fstatfs(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fstatfs(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_lstat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lstat(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_stat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_stat(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_statat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_statat(context, out, dir, path, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_statat(context, out, dir, path, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_statfs_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            ...
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_statfs(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_stat_statx_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_statx(context, out, dir, path, flags, mask) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_statx(context, out, dir, path, flags, mask) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_watch_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_watch(context, out, path, options) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_watch(context, out, path, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_watch_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_watch_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_watch_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_events_item_value in result_recorded_events_raw {
                    ...
                    let result_recorded_events_item_recorded_path_bytes_raw = unsafe { result_recorded_events_item.path.bytes.0.as_slice()? };
                    let mut result_recorded_events_item_recorded_path_bytes = Vec::with_capacity(result_recorded_events_item_recorded_path_bytes_raw.len());
                    for result_recorded_events_item_recorded_path_bytes_item_value in result_recorded_events_item_recorded_path_bytes_raw {
                        let result_recorded_events_item_recorded_path_bytes_item = *result_recorded_events_item_recorded_path_bytes_item_value;
                        let result_recorded_events_item_recorded_path_bytes_item_recorded = result_recorded_events_item_recorded_path_bytes_item;
                        result_recorded_events_item_recorded_path_bytes.push(result_recorded_events_item_recorded_path_bytes_item_recorded);
                    }
                    let result_recorded_events_item_recorded_path_utf16_raw = unsafe { result_recorded_events_item.path.utf16.0.as_slice()? };
                    let mut result_recorded_events_item_recorded_path_utf16 = Vec::with_capacity(result_recorded_events_item_recorded_path_utf16_raw.len());
                    for result_recorded_events_item_recorded_path_utf16_item_value in result_recorded_events_item_recorded_path_utf16_raw {
                        let result_recorded_events_item_recorded_path_utf16_item = *result_recorded_events_item_recorded_path_utf16_item_value;
                        let result_recorded_events_item_recorded_path_utf16_item_recorded = result_recorded_events_item_recorded_path_utf16_item;
                        result_recorded_events_item_recorded_path_utf16.push(result_recorded_events_item_recorded_path_utf16_item_recorded);
                    }
                    let result_recorded_events_item_recorded_path = OsPathReplayRecord {
                        encoding: result_recorded_events_item_recorded_path_encoding,
                        bytes: result_recorded_events_item_recorded_path_bytes,
                        utf16: result_recorded_events_item_recorded_path_utf16,
                    };
                    let result_recorded_events_item_recorded_related_path_encoding = result_recorded_events_item.related_path.encoding;
                    let result_recorded_events_item_recorded_related_path_bytes_raw = unsafe { result_recorded_events_item.related_path.bytes.0.as_slice()? };
                    let mut result_recorded_events_item_recorded_related_path_bytes = Vec::with_capacity(result_recorded_events_item_recorded_related_path_bytes_raw.len());
                    for result_recorded_events_item_recorded_related_path_bytes_item_value in result_recorded_events_item_recorded_related_path_bytes_raw {
                        let result_recorded_events_item_recorded_related_path_bytes_item = *result_recorded_events_item_recorded_related_path_bytes_item_value;
                        let result_recorded_events_item_recorded_related_path_bytes_item_recorded = result_recorded_events_item_recorded_related_path_bytes_item;
                        result_recorded_events_item_recorded_related_path_bytes.push(result_recorded_events_item_recorded_related_path_bytes_item_recorded);
                    }
                    let result_recorded_events_item_recorded_related_path_utf16_raw = unsafe { result_recorded_events_item.related_path.utf16.0.as_slice()? };
                    let mut result_recorded_events_item_recorded_related_path_utf16 = Vec::with_capacity(result_recorded_events_item_recorded_related_path_utf16_raw.len());
                    for result_recorded_events_item_recorded_related_path_utf16_item_value in result_recorded_events_item_recorded_related_path_utf16_raw {
                        let result_recorded_events_item_recorded_related_path_utf16_item = *result_recorded_events_item_recorded_related_path_utf16_item_value;
                        let result_recorded_events_item_recorded_related_path_utf16_item_recorded = result_recorded_events_item_recorded_related_path_utf16_item;
                        result_recorded_events_item_recorded_related_path_utf16.push(result_recorded_events_item_recorded_related_path_utf16_item_recorded);
                    }
                    let result_recorded_events_item_recorded_related_path = OsPathReplayRecord {
                        encoding: result_recorded_events_item_recorded_related_path_encoding,
                        bytes: result_recorded_events_item_recorded_related_path_bytes,
                        utf16: result_recorded_events_item_recorded_related_path_utf16,
                    };
                    let result_recorded_events_item_recorded_cookie = result_recorded_events_item.cookie;
                    let result_recorded_events_item_recorded = WatchEventReplayRecord {
                ...
                let result_recorded = WatchBatchReplayRecord {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_events_item in value.events {
                        ...
                        let value_native_events_item_native_path_bytes = platform_fs::PathBytesAbi::<platform_abi::NativeAbi>(value_native_events_item_native_path_bytes_inner);
                        ...
                        let value_native_events_item_native_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::NativeAbi>(value_native_events_item_native_path_utf16_inner);
                        ...
                        let value_native_events_item_native_related_path_bytes = platform_fs::PathBytesAbi::<platform_abi::NativeAbi>(value_native_events_item_native_related_path_bytes_inner);
                        ...
                        let value_native_events_item_native_related_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::NativeAbi>(value_native_events_item_native_related_path_utf16_inner);
...
fn destack_fs_watchat_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_watchat(context, out, directory, path, options) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_watchat(context, out, directory, path, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_fgetxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fgetxattr(context, out, handle, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fgetxattr(context, out, handle, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_fgetxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fgetxattr_bytes(context, out, handle, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fgetxattr_bytes(context, out, handle, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_flistxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_flistxattr(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_flistxattr(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_flistxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_flistxattr_bytes(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_flistxattr_bytes(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = *result_recorded_item_value;
                    let result_recorded_item_recorded_raw = unsafe { result_recorded_item.as_slice()? };
                    let mut result_recorded_item_recorded = Vec::with_capacity(result_recorded_item_recorded_raw.len());
                    for result_recorded_item_recorded_item_value in result_recorded_item_recorded_raw {
                        let result_recorded_item_recorded_item = *result_recorded_item_recorded_item_value;
                        let result_recorded_item_recorded_item_recorded = result_recorded_item_recorded_item;
                        result_recorded_item_recorded.push(result_recorded_item_recorded_item_recorded);
                    }
                    result_recorded.push(result_recorded_item_recorded);
                }
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    let mut value_native_values = Vec::with_capacity(value.len());
                    for value_native_item in value {
                        let mut value_native_item_native_values = Vec::with_capacity(value_native_item.len());
                        for value_native_item_native_item in value_native_item {
                            let value_native_item_native_item_native = value_native_item_native_item;
                            value_native_item_native_values.push(value_native_item_native_item_native);
                        }
                        let value_native_item_native = context.store_array(value_native_item_native_values);
                        value_native_values.push(value_native_item_native);
                    }
                    let value_native = context.store_array(value_native_values);
                    unsafe { std::ptr::write(out, value_native); }
...
fn destack_fs_xattr_fremovexattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fremovexattr(context, handle, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fremovexattr(context, handle, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_fremovexattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fremovexattr_bytes(context, handle, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fremovexattr_bytes(context, handle, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    FsXattrFremovexattrBytesReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_fs_xattr_fsetxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fsetxattr(context, handle, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fsetxattr(context, handle, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_fsetxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_fsetxattr_bytes(context, handle, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_fsetxattr_bytes(context, handle, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_getxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_getxattr(context, out, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_getxattr(context, out, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_getxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_getxattr_bytes(context, out, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_getxattr_bytes(context, out, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_lgetxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lgetxattr(context, out, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lgetxattr(context, out, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_lgetxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lgetxattr_bytes(context, out, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lgetxattr_bytes(context, out, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_listxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_listxattr(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_listxattr(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_listxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_listxattr_bytes(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_listxattr_bytes(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_llistxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_llistxattr(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_llistxattr(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_llistxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_llistxattr_bytes(context, out, path) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_llistxattr_bytes(context, out, path) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_fs_xattr_lremovexattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lremovexattr(context, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lremovexattr(context, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_lremovexattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lremovexattr_bytes(context, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lremovexattr_bytes(context, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    FsXattrLremovexattrBytesReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_fs_xattr_lsetxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lsetxattr(context, path, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lsetxattr(context, path, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_lsetxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_lsetxattr_bytes(context, path, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_lsetxattr_bytes(context, path, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_removexattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_removexattr(context, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_removexattr(context, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_removexattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_removexattr_bytes(context, path, name) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_removexattr_bytes(context, path, name) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_setxattr_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_setxattr(context, path, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_setxattr(context, path, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_fs_xattr_setxattr_bytes_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_fs_setxattr_bytes(context, path, name, argument_value, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_fs_setxattr_bytes(context, path, name, argument_value, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
pub unsafe extern "C" fn destack_fs_attrs_access(
    path: OsPath,
    mode: AccessMode,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_attrs_chmod(
    path: OsPath,
    mode: FileMode,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_attrs_chown(
    path: OsPath,
    uid: u32,
    gid: u32,
) -> RuntimeStatus {
...
pub unsafe extern "C" fn destack_fs_dir_mkdir(
    path: OsPath,
    mode: FileMode,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_dir_rmdir(
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &path;
...
pub unsafe extern "C" fn destack_fs_file_close(
    handle: resource::FileHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_fs_file_copy_file_range(
    ...
    native_call(|context| {
        ...
        destack_fs_file_copy_file_range_replay(context, world, out, src, srcoffset, dst, dstoffset, length)
    })
}
...
pub unsafe extern "C" fn destack_fs_file_fdatasync(
    handle: resource::FileHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_fs_file_fsync(
    handle: resource::FileHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_fs_file_splice(
    ...
    native_call(|context| {
        ...
        let _ = (&out, &source, &sourcecursor, &target, &targetcursor, &length, &flags);

        let world = context.check_and_resolve_world(FS_FILE_SPLICE)?;
        destack_fs_file_splice_replay(context, world, out, source, sourcecursor, target, targetcursor, length, flags)
    })
}
...
pub unsafe extern "C" fn destack_fs_file_syncfs(
    handle: resource::FileHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_fs_file_truncate(
    path: OsPath,
    size: FileOffset,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_mmap_munmap(
    mapping: NativeSlice<u8>,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &mapping;
...
pub unsafe extern "C" fn destack_fs_path_linkat(
    ...
    native_call(|context| {
        ...
        destack_fs_path_linkat_replay(context, world, existingdir, existingpath, newdir, newpath, flags)
    })
}

#[unsafe(export_name = "destack.fs.path.mkfifo")]
pub unsafe extern "C" fn destack_fs_path_mkfifo(
    path: OsPath,
    mode: FileMode,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_path_readlink(
    out: *mut OsPath,
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_path_realpath(
    out: *mut OsPath,
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_path_rename(
    from: OsPath,
    to: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_path_unlink(
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &path;
...
pub unsafe extern "C" fn destack_fs_stat_lstat(
    out: *mut Stat,
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_stat_stat(
    out: *mut Stat,
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_stat_statfs(
    out: *mut StatFs,
    path: OsPath,
) -> RuntimeStatus {
    native_call(|context| {
...
pub unsafe extern "C" fn destack_fs_watch_close(
    handle: resource::WatchHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_access(runtime, context, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_accessat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_accessat(runtime, context, dir, path, mode, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_accessat(runtime, context, dir, path, mode, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_chmod(runtime, context, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_chown(runtime, context, path, uid, gid),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fchmod(runtime, context, handle, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_fchmodat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fchmodat(runtime, context, dir, path, mode, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fchmodat(runtime, context, dir, path, mode, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_fchown_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fchown(runtime, context, handle, uid, gid),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fchown(runtime, context, handle, uid, gid),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_fchownat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fchownat(runtime, context, dir, path, uid, gid, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fchownat(runtime, context, dir, path, uid, gid, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_futimes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_futimes(runtime, context, handle, atimens, mtimens),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_futimes(runtime, context, handle, atimens, mtimens),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_lutimes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lutimes(runtime, context, path, atimens, mtimens),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lutimes(runtime, context, path, atimens, mtimens),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_utimensat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_utimensat(runtime, context, dir, path, atimens, mtimens, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_utimensat(runtime, context, dir, path, atimens, mtimens, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_attrs_utimes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_utimes(runtime, context, path, atimens, mtimens),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_utimes(runtime, context, path, atimens, mtimens),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_closedir(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_dirfd(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mkdir(runtime, context, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_dir_mkdirat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mkdirat(runtime, context, dir, path, mode),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mkdirat(runtime, context, dir, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mkdtemp(runtime, context, template),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                let mut result_recorded_utf16_inner = Vec::with_capacity(result_recorded_utf16_inner_raw.len());
                for result_recorded_utf16_inner_item_value in result_recorded_utf16_inner_raw {
                    let result_recorded_utf16_inner_item = decode_uint16(result_recorded_utf16_inner_item_value, "result_recorded_utf16_inner_item", "item")?;
                    let result_recorded_utf16_inner_item_recorded = result_recorded_utf16_inner_item;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_bytes_inner = VmArray::from_bytes(context, value.bytes.as_slice());
                    let vm_result_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(vm_result_bytes_inner);
                    ...
                    let vm_result_utf16_inner = VmArray::from_values(context, &vm_result_utf16_inner_values)?;
                    let vm_result_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(vm_result_utf16_inner);
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_opendir(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_readdir(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_name = {
                            if slots[0].tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("result_recorded_item_name", "name")).boxed()); }
                            let slots = context.aggregate_slots(slots[0]).map_err(|error| RuntimeError::from(error).boxed())?;
                            if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_name", "expected 3 fields")).boxed()); }
                            let result_recorded_item_name_encoding_raw = decode_uint8(slots[0], "result_recorded_item_name_encoding_raw", "encoding")?;
                            let result_recorded_item_name_encoding = match result_recorded_item_name_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_name_encoding", "unknown PathEncoding value")).boxed()), };
                            let result_recorded_item_name_bytes_inner = decode_array::<u8>(context, slots[1], "result_recorded_item_name_bytes_inner", "bytes")?;
                            let result_recorded_item_name_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(result_recorded_item_name_bytes_inner);
                            let result_recorded_item_name_utf16_inner = decode_array::<u16>(context, slots[2], "result_recorded_item_name_utf16_inner", "utf16")?;
                            let result_recorded_item_name_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(result_recorded_item_name_utf16_inner);
                            OsPathVm {
                    ...
                    let result_recorded_item_recorded_name_encoding = result_recorded_item.name.encoding;
                    let result_recorded_item_recorded_name_bytes_inner = result_recorded_item.name.bytes.0.read_bytes(context)?;
                    let result_recorded_item_recorded_name_bytes = result_recorded_item_recorded_name_bytes_inner;
                    let result_recorded_item_recorded_name_utf16_inner_raw = result_recorded_item.name.utf16.0.raw_values(context)?;
                    let mut result_recorded_item_recorded_name_utf16_inner = Vec::with_capacity(result_recorded_item_recorded_name_utf16_inner_raw.len());
                    for result_recorded_item_recorded_name_utf16_inner_item_value in result_recorded_item_recorded_name_utf16_inner_raw {
                        let result_recorded_item_recorded_name_utf16_inner_item = decode_uint16(result_recorded_item_recorded_name_utf16_inner_item_value, "result_recorded_item_recorded_name_utf16_inner_item", "item")?;
                        let result_recorded_item_recorded_name_utf16_inner_item_recorded = result_recorded_item_recorded_name_utf16_inner_item;
                        result_recorded_item_recorded_name_utf16_inner.push(result_recorded_item_recorded_name_utf16_inner_item_recorded);
                    }
                    let result_recorded_item_recorded_name_utf16 = result_recorded_item_recorded_name_utf16_inner;
                    let result_recorded_item_recorded_name = OsPathReplayRecord {
                        encoding: result_recorded_item_recorded_name_encoding,
                        bytes: result_recorded_item_recorded_name_bytes,
                        utf16: result_recorded_item_recorded_name_utf16,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_name_bytes_inner = VmArray::from_bytes(context, vm_result_item.name.bytes.as_slice());
                        let vm_result_item_value_name_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(vm_result_item_value_name_bytes_inner);
                        let mut vm_result_item_value_name_utf16_inner_values = Vec::with_capacity(vm_result_item.name.utf16.len());
                        for vm_result_item_value_name_utf16_inner_item in vm_result_item.name.utf16.iter() {
                            let vm_result_item_value_name_utf16_inner_item = *vm_result_item_value_name_utf16_inner_item;
                            let vm_result_item_value_name_utf16_inner_item_value = vm_result_item_value_name_utf16_inner_item;
                            vm_result_item_value_name_utf16_inner_values.push(vm_result_item_value_name_utf16_inner_item_value);
                        }
                        let vm_result_item_value_name_utf16_inner = VmArray::from_values(context, &vm_result_item_value_name_utf16_inner_values)?;
                        let vm_result_item_value_name_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(vm_result_item_value_name_utf16_inner);
                        ...
                        let vm_result_item_value_encoded = { let field_0 = { let field_0 = vm::Value::uint(vm_result_item_value.name.encoding as u8 as u64, 8); let field_1 = vm_result_item_value.name.bytes.0.to_value(context); let field_2 = vm_result_item_value.name.utf16.0.to_value(context); context.allocate_aggregate(vec![field_0, field_1, field_2]) }; let field_1 = vm::Value::uint(vm_result_item_value.kind as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1]) };
...
fn destack_fs_dir_readdir_next_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_readdir_next(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_readdir_next(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value: DirentNextVm = value.clone();
                let result_recorded_has_entry = result_value.has_entry;
                let result_recorded_entry_name_encoding = result_value.entry.name.encoding;
                let result_recorded_entry_name_bytes_inner = result_value.entry.name.bytes.0.read_bytes(context)?;
                let result_recorded_entry_name_bytes = result_recorded_entry_name_bytes_inner;
                let result_recorded_entry_name_utf16_inner_raw = result_value.entry.name.utf16.0.raw_values(context)?;
                let mut result_recorded_entry_name_utf16_inner = Vec::with_capacity(result_recorded_entry_name_utf16_inner_raw.len());
                for result_recorded_entry_name_utf16_inner_item_value in result_recorded_entry_name_utf16_inner_raw {
                    let result_recorded_entry_name_utf16_inner_item = decode_uint16(result_recorded_entry_name_utf16_inner_item_value, "result_recorded_entry_name_utf16_inner_item", "item")?;
                    let result_recorded_entry_name_utf16_inner_item_recorded = result_recorded_entry_name_utf16_inner_item;
                    result_recorded_entry_name_utf16_inner.push(result_recorded_entry_name_utf16_inner_item_recorded);
                }
                let result_recorded_entry_name_utf16 = result_recorded_entry_name_utf16_inner;
                let result_recorded_entry_name = OsPathReplayRecord {
                    encoding: result_recorded_entry_name_encoding,
                    bytes: result_recorded_entry_name_bytes,
                    utf16: result_recorded_entry_name_utf16,
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_entry_name_bytes_inner = VmArray::from_bytes(context, value.entry.name.bytes.as_slice());
                    let vm_result_entry_name_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(vm_result_entry_name_bytes_inner);
                    let mut vm_result_entry_name_utf16_inner_values = Vec::with_capacity(value.entry.name.utf16.len());
                    for vm_result_entry_name_utf16_inner_item in value.entry.name.utf16.iter() {
                        let vm_result_entry_name_utf16_inner_item = *vm_result_entry_name_utf16_inner_item;
                        let vm_result_entry_name_utf16_inner_item_value = vm_result_entry_name_utf16_inner_item;
                        vm_result_entry_name_utf16_inner_values.push(vm_result_entry_name_utf16_inner_item_value);
                    }
                    let vm_result_entry_name_utf16_inner = VmArray::from_values(context, &vm_result_entry_name_utf16_inner_values)?;
                    let vm_result_entry_name_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(vm_result_entry_name_utf16_inner);
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_rewinddir(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_rmdir(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_copy_file_range_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_copy_file_range(runtime, context, src, srcoffset, dst, dstoffset, length),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_copy_file_range(runtime, context, src, srcoffset, dst, dstoffset, length),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_dup(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_dup2(runtime, context, handle, target),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_dup3_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_dup3(runtime, context, handle, target, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_dup3(runtime, context, handle, target, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_fadvise_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fadvise(runtime, context, handle, offset, length, advice),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fadvise(runtime, context, handle, offset, length, advice),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_fallocate_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fallocate(runtime, context, handle, offset, length, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fallocate(runtime, context, handle, offset, length, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fdatasync(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fsync(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_ftruncate(runtime, context, handle, size),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_get_fd_flags(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_get_status_flags_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_get_status_flags(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_get_status_flags(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lock(runtime, context, handle, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_open(runtime, context, path, flags, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_openat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_openat(runtime, context, dir, path, flags, mode),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_openat(runtime, context, dir, path, flags, mode),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_openat2(runtime, context, dir, path, how),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_pread_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_pread(runtime, context, handle, buffer, offset),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_pread(runtime, context, handle, buffer, offset),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_preadv_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_preadv(runtime, context, handle, buffers, offset),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_preadv(runtime, context, handle, buffers, offset),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_preadv2_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_preadv2(runtime, context, handle, buffers, offset, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_preadv2(runtime, context, handle, buffers, offset, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_pwrite_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_pwrite(runtime, context, handle, buffer, offset),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_pwrite(runtime, context, handle, buffer, offset),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_pwritev_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_pwritev(runtime, context, handle, buffers, offset),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_pwritev(runtime, context, handle, buffers, offset),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_pwritev2_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_pwritev2(runtime, context, handle, buffers, offset, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_pwritev2(runtime, context, handle, buffers, offset, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_read(runtime, context, handle, buffer),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_readv(runtime, context, handle, buffers),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_seek_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_seek(runtime, context, handle, offset, whence),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_seek(runtime, context, handle, offset, whence),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_sendfile_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_sendfile(runtime, context, socket, file, offset, length),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_sendfile(runtime, context, socket, file, offset, length),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_set_fd_flags_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_set_fd_flags(runtime, context, handle, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_set_fd_flags(runtime, context, handle, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_set_status_flags_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_set_status_flags(runtime, context, handle, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_set_status_flags(runtime, context, handle, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_splice_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_splice(runtime, context, source, sourcecursor, target, targetcursor, length, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_splice(runtime, context, source, sourcecursor, target, targetcursor, length, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_sync_file_range_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_sync_file_range(runtime, context, handle, offset, length, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_sync_file_range(runtime, context, handle, offset, length, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_syncfs(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_tee_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_tee(runtime, context, sourcepipe, targetpipe, length, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_tee(runtime, context, sourcepipe, targetpipe, length, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_truncate(runtime, context, path, size),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_file_vmsplice_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_vmsplice(runtime, context, pipe, buffers, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_vmsplice(runtime, context, pipe, buffers, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_write(runtime, context, handle, buffer),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_writev(runtime, context, handle, buffers),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_mmap_madvise_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_madvise(runtime, context, mapping, advice),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_madvise(runtime, context, mapping, advice),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mprotect(runtime, context, mapping, prot),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_msync(runtime, context, mapping, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_munmap(runtime, context, mapping),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_mmap_anonymous_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mmap_anonymous(runtime, context, length, prot, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mmap_anonymous(runtime, context, length, prot, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_mmap_file_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mmap_file(runtime, context, handle, offset, length, prot, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mmap_file(runtime, context, handle, offset, length, prot, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_copyfile_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_copyfile(runtime, context, from, to, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_copyfile(runtime, context, from, to, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_link_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_link(runtime, context, existingpath, newpath),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_link(runtime, context, existingpath, newpath),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_linkat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_linkat(runtime, context, existingdir, existingpath, newdir, newpath, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_linkat(runtime, context, existingdir, existingpath, newdir, newpath, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mkfifo(runtime, context, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_mkfifoat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mkfifoat(runtime, context, dir, path, mode),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mkfifoat(runtime, context, dir, path, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_mknod_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mknod(runtime, context, path, mode, device),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mknod(runtime, context, path, mode, device),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_mknodat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_mknodat(runtime, context, dir, path, mode, device),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_mknodat(runtime, context, dir, path, mode, device),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_readlink(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_readlinkat(runtime, context, dir, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_realpath(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_rename(runtime, context, from, to),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_renameat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_renameat(runtime, context, fromdir, from, todir, to),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_renameat(runtime, context, fromdir, from, todir, to),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_renameat2_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_renameat2(runtime, context, fromdir, from, todir, to, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_renameat2(runtime, context, fromdir, from, todir, to, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_symlink_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_symlink(runtime, context, target, path, kind),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_symlink(runtime, context, target, path, kind),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_symlinkat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_symlinkat(runtime, context, target, dir, path, kind),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_symlinkat(runtime, context, target, dir, path, kind),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_unlink(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_path_unlinkat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_unlinkat(runtime, context, dir, path, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_unlinkat(runtime, context, dir, path, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fstat(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fstatfs(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lstat(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_stat(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_stat_statat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_statat(runtime, context, dir, path, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_statat(runtime, context, dir, path, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_statfs(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_stat_statx_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_statx(runtime, context, dir, path, flags, mask),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_statx(runtime, context, dir, path, flags, mask),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_watch(runtime, context, path, options),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_watch_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_events_item_value in result_recorded_events_raw {
                    let result_recorded_events_item = {
                        if result_recorded_events_item_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("result_recorded_events_item", "item")).boxed()); }
                        let slots = context.aggregate_slots(result_recorded_events_item_value).map_err(|error| RuntimeError::from(error).boxed())?;
                        if slots.len() != 4 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item", "expected 4 fields")).boxed()); }
                        let result_recorded_events_item_kind_raw = decode_uint8(slots[0], "result_recorded_events_item_kind_raw", "kind")?;
                        let result_recorded_events_item_kind = match result_recorded_events_item_kind_raw { 1u8 => WatchEventKind::Create, 2u8 => WatchEventKind::Remove, 3u8 => WatchEventKind::Modify, 4u8 => WatchEventKind::Rename, 5u8 => WatchEventKind::Metadata, 6u8 => WatchEventKind::Overflow , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item_kind", "unknown WatchEventKind value")).boxed()), };
                        let result_recorded_events_item_path = {
                            if slots[1].tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("result_recorded_events_item_path", "path")).boxed()); }
                            let slots = context.aggregate_slots(slots[1]).map_err(|error| RuntimeError::from(error).boxed())?;
                            if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item_path", "expected 3 fields")).boxed()); }
                            let result_recorded_events_item_path_encoding_raw = decode_uint8(slots[0], "result_recorded_events_item_path_encoding_raw", "encoding")?;
                            let result_recorded_events_item_path_encoding = match result_recorded_events_item_path_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item_path_encoding", "unknown PathEncoding value")).boxed()), };
                            let result_recorded_events_item_path_bytes_inner = decode_array::<u8>(context, slots[1], "result_recorded_events_item_path_bytes_inner", "bytes")?;
                            let result_recorded_events_item_path_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(result_recorded_events_item_path_bytes_inner);
                            let result_recorded_events_item_path_utf16_inner = decode_array::<u16>(context, slots[2], "result_recorded_events_item_path_utf16_inner", "utf16")?;
                            let result_recorded_events_item_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(result_recorded_events_item_path_utf16_inner);
                            OsPathVm {
                                encoding: result_recorded_events_item_path_encoding,
                                bytes: result_recorded_events_item_path_bytes,
                                utf16: result_recorded_events_item_path_utf16,
                            }
                        };
                        let result_recorded_events_item_related_path = {
                            if slots[2].tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("result_recorded_events_item_related_path", "relatedPath")).boxed()); }
                            let slots = context.aggregate_slots(slots[2]).map_err(|error| RuntimeError::from(error).boxed())?;
                            if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item_related_path", "expected 3 fields")).boxed()); }
                            let result_recorded_events_item_related_path_encoding_raw = decode_uint8(slots[0], "result_recorded_events_item_related_path_encoding_raw", "encoding")?;
                            let result_recorded_events_item_related_path_encoding = match result_recorded_events_item_related_path_encoding_raw { 1u8 => PathEncoding::Bytes, 2u8 => PathEncoding::Utf16 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_events_item_related_path_encoding", "unknown PathEncoding value")).boxed()), };
                            let result_recorded_events_item_related_path_bytes_inner = decode_array::<u8>(context, slots[1], "result_recorded_events_item_related_path_bytes_inner", "bytes")?;
                            let result_recorded_events_item_related_path_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(result_recorded_events_item_related_path_bytes_inner);
                            let result_recorded_events_item_related_path_utf16_inner = decode_array::<u16>(context, slots[2], "result_recorded_events_item_related_path_utf16_inner", "utf16")?;
                            let result_recorded_events_item_related_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(result_recorded_events_item_related_path_utf16_inner);
                            OsPathVm {
                                encoding: result_recorded_events_item_related_path_encoding,
                                bytes: result_recorded_events_item_related_path_bytes,
                                utf16: result_recorded_events_item_related_path_utf16,
                            }
                        };
                        let result_recorded_events_item_cookie = decode_uint64(slots[3], "result_recorded_events_item_cookie", "cookie")?;
                        WatchEventVm {
                    ...
                    let result_recorded_events_item_recorded_kind = result_recorded_events_item.kind;
                    let result_recorded_events_item_recorded_path_encoding = result_recorded_events_item.path.encoding;
                    let result_recorded_events_item_recorded_path_bytes_inner = result_recorded_events_item.path.bytes.0.read_bytes(context)?;
                    let result_recorded_events_item_recorded_path_bytes = result_recorded_events_item_recorded_path_bytes_inner;
                    let result_recorded_events_item_recorded_path_utf16_inner_raw = result_recorded_events_item.path.utf16.0.raw_values(context)?;
                    let mut result_recorded_events_item_recorded_path_utf16_inner = Vec::with_capacity(result_recorded_events_item_recorded_path_utf16_inner_raw.len());
                    for result_recorded_events_item_recorded_path_utf16_inner_item_value in result_recorded_events_item_recorded_path_utf16_inner_raw {
                        let result_recorded_events_item_recorded_path_utf16_inner_item = decode_uint16(result_recorded_events_item_recorded_path_utf16_inner_item_value, "result_recorded_events_item_recorded_path_utf16_inner_item", "item")?;
                        let result_recorded_events_item_recorded_path_utf16_inner_item_recorded = result_recorded_events_item_recorded_path_utf16_inner_item;
                        result_recorded_events_item_recorded_path_utf16_inner.push(result_recorded_events_item_recorded_path_utf16_inner_item_recorded);
                    }
                    let result_recorded_events_item_recorded_path_utf16 = result_recorded_events_item_recorded_path_utf16_inner;
                    let result_recorded_events_item_recorded_path = OsPathReplayRecord {
                        encoding: result_recorded_events_item_recorded_path_encoding,
                        bytes: result_recorded_events_item_recorded_path_bytes,
                        utf16: result_recorded_events_item_recorded_path_utf16,
                    ...
                    let result_recorded_events_item_recorded_related_path_encoding = result_recorded_events_item.related_path.encoding;
                    let result_recorded_events_item_recorded_related_path_bytes_inner = result_recorded_events_item.related_path.bytes.0.read_bytes(context)?;
                    let result_recorded_events_item_recorded_related_path_bytes = result_recorded_events_item_recorded_related_path_bytes_inner;
                    let result_recorded_events_item_recorded_related_path_utf16_inner_raw = result_recorded_events_item.related_path.utf16.0.raw_values(context)?;
                    let mut result_recorded_events_item_recorded_related_path_utf16_inner = Vec::with_capacity(result_recorded_events_item_recorded_related_path_utf16_inner_raw.len());
                    for result_recorded_events_item_recorded_related_path_utf16_inner_item_value in result_recorded_events_item_recorded_related_path_utf16_inner_raw {
                        let result_recorded_events_item_recorded_related_path_utf16_inner_item = decode_uint16(result_recorded_events_item_recorded_related_path_utf16_inner_item_value, "result_recorded_events_item_recorded_related_path_utf16_inner_item", "item")?;
                        let result_recorded_events_item_recorded_related_path_utf16_inner_item_recorded = result_recorded_events_item_recorded_related_path_utf16_inner_item;
                        result_recorded_events_item_recorded_related_path_utf16_inner.push(result_recorded_events_item_recorded_related_path_utf16_inner_item_recorded);
                    }
                    let result_recorded_events_item_recorded_related_path_utf16 = result_recorded_events_item_recorded_related_path_utf16_inner;
                    let result_recorded_events_item_recorded_related_path = OsPathReplayRecord {
                        encoding: result_recorded_events_item_recorded_related_path_encoding,
                        bytes: result_recorded_events_item_recorded_related_path_bytes,
                        utf16: result_recorded_events_item_recorded_related_path_utf16,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_events_item in value.events.iter() {
                        ...
                        let vm_result_events_item_value_path_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(vm_result_events_item_value_path_bytes_inner);
                        ...
                        let vm_result_events_item_value_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(vm_result_events_item_value_path_utf16_inner);
                        ...
                        let vm_result_events_item_value_related_path_bytes = platform_fs::PathBytesAbi::<platform_abi::VmAbi>(vm_result_events_item_value_related_path_bytes_inner);
                        ...
                        let vm_result_events_item_value_related_path_utf16 = platform_fs::PathUtf16Abi::<platform_abi::VmAbi>(vm_result_events_item_value_related_path_utf16_inner);
...
fn destack_fs_watchat_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_watchat(runtime, context, directory, path, options),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_watchat(runtime, context, directory, path, options),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fgetxattr(runtime, context, handle, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_fgetxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fgetxattr_bytes(runtime, context, handle, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fgetxattr_bytes(runtime, context, handle, name),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_flistxattr(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_flistxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_flistxattr_bytes(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_flistxattr_bytes(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                let mut result_recorded = Vec::with_capacity(result_recorded_raw.len());
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = decode_array::<u8>(context, result_recorded_item_value, "result_recorded_item", "item")?;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        let vm_result_item = vm_result_item.clone();
                        let vm_result_item_value = VmArray::from_bytes(context, vm_result_item.as_slice());
                        let vm_result_item_value_encoded = vm_result_item_value.to_value(context);
                        vm_result_values.push(vm_result_item_value_encoded);
                    }
                    let vm_result_data = context.allocate_raw_values(vm_result_values);
                    let vm_result: VmArray<VmArray<u8>> = VmArray { data: vm_result_data, len: value.len() as u32, capacity: value.len() as u32, _marker: std::marker::PhantomData };
                    Ok(vm_result)
                }
                Err(error) => Err(RuntimeError::from(error).boxed()),
            }
...
fn destack_fs_xattr_fremovexattr_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fremovexattr(runtime, context, handle, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fremovexattr(runtime, context, handle, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_fremovexattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fremovexattr_bytes(runtime, context, handle, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fremovexattr_bytes(runtime, context, handle, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_fsetxattr_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fsetxattr(runtime, context, handle, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fsetxattr(runtime, context, handle, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_fsetxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_fsetxattr_bytes(runtime, context, handle, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_fsetxattr_bytes(runtime, context, handle, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_getxattr(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_getxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_getxattr_bytes(runtime, context, path, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_getxattr_bytes(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lgetxattr(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_lgetxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lgetxattr_bytes(runtime, context, path, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lgetxattr_bytes(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_listxattr(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_listxattr_bytes(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_llistxattr(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_llistxattr_bytes(runtime, context, path),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_lremovexattr_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lremovexattr(runtime, context, path, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lremovexattr(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_lremovexattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lremovexattr_bytes(runtime, context, path, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lremovexattr_bytes(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_lsetxattr_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lsetxattr(runtime, context, path, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lsetxattr(runtime, context, path, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_lsetxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_lsetxattr_bytes(runtime, context, path, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_lsetxattr_bytes(runtime, context, path, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_removexattr(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_removexattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_removexattr_bytes(runtime, context, path, name),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_removexattr_bytes(runtime, context, path, name),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_setxattr_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_setxattr(runtime, context, path, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_setxattr(runtime, context, path, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_fs_xattr_setxattr_bytes_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_fs_setxattr_bytes(runtime, context, path, name, argument_value, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_fs_setxattr_bytes(runtime, context, path, name, argument_value, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_fs_vm_bindings(
    ...
    {
        binding!(registry, isolate, FS_ATTRS_ACCESSAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (dir, path, mode, flags) = decode_destack_fs_attrs_accessat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_ATTRS_ACCESSAT)?;
                destack_fs_attrs_accessat_vm_replay(runtime, context, world, dir, path, mode, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_ATTRS_FCHMODAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (dir, path, mode, flags) = decode_destack_fs_attrs_fchmodat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_ATTRS_FCHMODAT)?;
                destack_fs_attrs_fchmodat_vm_replay(runtime, context, world, dir, path, mode, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_ATTRS_FCHOWNAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (dir, path, uid, gid, flags) = decode_destack_fs_attrs_fchownat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_ATTRS_FCHOWNAT)?;
                destack_fs_attrs_fchownat_vm_replay(runtime, context, world, dir, path, uid, gid, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_ATTRS_FUTIMES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, atimens, mtimens) = decode_destack_fs_attrs_futimes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_ATTRS_FUTIMES)?;
                destack_fs_attrs_futimes_vm_replay(runtime, context, world, handle, atimens, mtimens)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_ATTRS_UTIMENSAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (dir, path, atimens, mtimens, flags) = decode_destack_fs_attrs_utimensat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_ATTRS_UTIMENSAT)?;
                destack_fs_attrs_utimensat_vm_replay(runtime, context, world, dir, path, atimens, mtimens, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_DIR_READDIR_NEXT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_FILE_COPY_FILE_RANGE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (src, srcoffset, dst, dstoffset, length) = decode_destack_fs_file_copy_file_range_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_COPY_FILE_RANGE)?;
                destack_fs_file_copy_file_range_vm_replay(runtime, context, world, src, srcoffset, dst, dstoffset, length)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, FS_FILE_FADVISE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, offset, length, advice) = decode_destack_fs_file_fadvise_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_FADVISE)?;
                destack_fs_file_fadvise_vm_replay(runtime, context, world, handle, offset, length, advice)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_FILE_FALLOCATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, offset, length, flags) = decode_destack_fs_file_fallocate_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_FALLOCATE)?;
                destack_fs_file_fallocate_vm_replay(runtime, context, world, handle, offset, length, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_FILE_FDATASYNC, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_FILE_FTRUNCATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_FILE_GET_FD_FLAGS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_FILE_GET_STATUS_FLAGS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    }
    {
        binding!(registry, isolate, FS_FILE_PREADV2, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, buffers, offset, flags) = decode_destack_fs_file_preadv2_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_PREADV2)?;
                destack_fs_file_preadv2_vm_replay(runtime, context, world, handle, buffers, offset, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, FS_FILE_PWRITEV2, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, buffers, offset, flags) = decode_destack_fs_file_pwritev2_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_PWRITEV2)?;
                destack_fs_file_pwritev2_vm_replay(runtime, context, world, handle, buffers, offset, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, FS_FILE_SENDFILE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (socket, file, offset, length) = decode_destack_fs_file_sendfile_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_SENDFILE)?;
                destack_fs_file_sendfile_vm_replay(runtime, context, world, socket, file, offset, length)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_FILE_SET_FD_FLAGS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_FILE_SET_STATUS_FLAGS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, flags) = decode_destack_fs_file_set_status_flags_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_SET_STATUS_FLAGS)?;
                destack_fs_file_set_status_flags_vm_replay(runtime, context, world, handle, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_FILE_SPLICE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (source, sourcecursor, target, targetcursor, length, flags) = decode_destack_fs_file_splice_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_SPLICE)?;
                destack_fs_file_splice_vm_replay(runtime, context, world, source, sourcecursor, target, targetcursor, length, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_FILE_SYNC_FILE_RANGE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, offset, length, flags) = decode_destack_fs_file_sync_file_range_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_SYNC_FILE_RANGE)?;
                destack_fs_file_sync_file_range_vm_replay(runtime, context, world, handle, offset, length, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, FS_FILE_TEE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (sourcepipe, targetpipe, length, flags) = decode_destack_fs_file_tee_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_FILE_TEE)?;
                destack_fs_file_tee_vm_replay(runtime, context, world, sourcepipe, targetpipe, length, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_MMAP_ANONYMOUS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                ...
                destack_fs_mmap_anonymous_vm_replay(runtime, context, world, length, prot, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_MMAP_FILE, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, offset, length, prot, flags) = decode_destack_fs_mmap_file_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_MMAP_FILE)?;
                destack_fs_mmap_file_vm_replay(runtime, context, world, handle, offset, length, prot, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, FS_PATH_LINKAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (existingdir, existingpath, newdir, newpath, flags) = decode_destack_fs_path_linkat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_PATH_LINKAT)?;
                destack_fs_path_linkat_vm_replay(runtime, context, world, existingdir, existingpath, newdir, newpath, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_PATH_READLINKAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    }
    {
        binding!(registry, isolate, FS_PATH_RENAMEAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (fromdir, from, todir, to) = decode_destack_fs_path_renameat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_PATH_RENAMEAT)?;
                destack_fs_path_renameat_vm_replay(runtime, context, world, fromdir, from, todir, to)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_PATH_RENAMEAT2, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (fromdir, from, todir, to, flags) = decode_destack_fs_path_renameat2_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_PATH_RENAMEAT2)?;
                destack_fs_path_renameat2_vm_replay(runtime, context, world, fromdir, from, todir, to, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_PATH_SYMLINKAT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (target, dir, path, kind) = decode_destack_fs_path_symlinkat_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_PATH_SYMLINKAT)?;
                destack_fs_path_symlinkat_vm_replay(runtime, context, world, target, dir, path, kind)
            })
            .map_err(Into::into)
        });
    }
    ...
    {
        binding!(registry, isolate, FS_XATTR_FGETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_FGETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, name) = decode_destack_fs_xattr_fgetxattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_FGETXATTR_BYTES)?;
                destack_fs_xattr_fgetxattr_bytes_vm_replay(runtime, context, world, handle, name)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_FLISTXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_FLISTXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_FREMOVEXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_FREMOVEXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, name) = decode_destack_fs_xattr_fremovexattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_FREMOVEXATTR_BYTES)?;
                destack_fs_xattr_fremovexattr_bytes_vm_replay(runtime, context, world, handle, name)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_FSETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, name, argument_value, flags) = decode_destack_fs_xattr_fsetxattr_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_FSETXATTR)?;
                destack_fs_xattr_fsetxattr_vm_replay(runtime, context, world, handle, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_FSETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, name, argument_value, flags) = decode_destack_fs_xattr_fsetxattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_FSETXATTR_BYTES)?;
                destack_fs_xattr_fsetxattr_bytes_vm_replay(runtime, context, world, handle, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_GETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_GETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LGETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LGETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LISTXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LISTXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LLISTXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LLISTXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LREMOVEXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_LREMOVEXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name) = decode_destack_fs_xattr_lremovexattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_LREMOVEXATTR_BYTES)?;
                destack_fs_xattr_lremovexattr_bytes_vm_replay(runtime, context, world, path, name)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_LSETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name, argument_value, flags) = decode_destack_fs_xattr_lsetxattr_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_LSETXATTR)?;
                destack_fs_xattr_lsetxattr_vm_replay(runtime, context, world, path, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_LSETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name, argument_value, flags) = decode_destack_fs_xattr_lsetxattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_LSETXATTR_BYTES)?;
                destack_fs_xattr_lsetxattr_bytes_vm_replay(runtime, context, world, path, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_REMOVEXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, FS_XATTR_REMOVEXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name) = decode_destack_fs_xattr_removexattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_REMOVEXATTR_BYTES)?;
                destack_fs_xattr_removexattr_bytes_vm_replay(runtime, context, world, path, name)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_SETXATTR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name, argument_value, flags) = decode_destack_fs_xattr_setxattr_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_SETXATTR)?;
                destack_fs_xattr_setxattr_vm_replay(runtime, context, world, path, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, FS_XATTR_SETXATTR_BYTES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (path, name, argument_value, flags) = decode_destack_fs_xattr_setxattr_bytes_args(context, args)?;

                // execute binding
                let world = runtime.check_and_resolve_world(FS_XATTR_SETXATTR_BYTES)?;
                destack_fs_xattr_setxattr_bytes_vm_replay(runtime, context, world, path, name, argument_value, flags)
            })
            .map_err(Into::into)
        });
    }
