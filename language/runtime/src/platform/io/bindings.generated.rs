...
use crate::platform::io::{CompletionEvent, CompletionEventVm, CompletionOperation, CompletionOperationKind, CompletionOperationVm, DescriptorControlCommand, DescriptorControlFlags, DescriptorRequest, DescriptorRequestVm, DescriptorResult, DescriptorResultValue, DescriptorResultVm, DescriptorresultReplayRecord, EventToken, PollBackend, PollEvent, PollEventVm, PollInterest, TimerFdClock, TimerFdFlags, TimerFdSetFlags, TimerFdSpec, TimerFdSpecVm, UringFeatures, UringFeaturesVm, UringParameters, UringParametersVm};
...
use crate::platform::io::simulation::{native as platform_simulation_native, vm as platform_simulation_vm};
...
fn decode_destack_io_completion_submit_args(
    ...
    let operation = {
        if operation_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("operation", "CompletionOperation")).boxed()); }
        let slots = context.aggregate_slots(operation_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 8 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("operation", "expected 8 fields")).boxed()); }
        let operation_kind_raw = decode_int32(slots[0], "operation_kind_raw", "kind")?;
        let operation_kind = match operation_kind_raw { 1i32 => CompletionOperationKind::Read, 2i32 => CompletionOperationKind::Write, 3i32 => CompletionOperationKind::Accept, 4i32 => CompletionOperationKind::Connect, 5i32 => CompletionOperationKind::Timeout, 6i32 => CompletionOperationKind::Fsync, 7i32 => CompletionOperationKind::Send, 8i32 => CompletionOperationKind::Receive , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("operation_kind", "unknown CompletionOperationKind value")).boxed()), };
...
fn decode_destack_io_completion_submit_batch_args(
    ...
    let operationwords = decode_slice::<u64>(context, operationwords_value, "operationwords", "Slice<uint64>")?;
    ...
    let operationwordstride = decode_uint32(operationwordstride_value, "operationwordstride", "uint32")?;
...
fn decode_destack_io_control_fcntl_args(
    _context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::ResourceId, DescriptorControlCommand, u64, DescriptorControlFlags)> {
...
fn decode_destack_io_control_ioctl_args(
    ...
    let request = {
        if request_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("request", "DescriptorRequest")).boxed()); }
        let slots = context.aggregate_slots(request_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 4 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("request", "expected 4 fields")).boxed()); }
...
fn encode_destack_io_control_ioctl_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.return_value, 64)); let field_1: RuntimeResult<vm::Value> = value.output.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_io_poll_open_args(
    ...
    let backend = match backend_raw { 0i32 => PollBackend::Auto, 1i32 => PollBackend::Epoll, 2i32 => PollBackend::Kqueue, 3i32 => PollBackend::Poll , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("backend", "unknown PollBackend value")).boxed()), };
    Ok((backend,))
}
...
fn decode_destack_io_poll_register_args(
    _context: &mut vm::ExternalCallContext<'_>,
    args: &[vm::Value],
) -> RuntimeResult<(resource::PollHandle, resource::ResourceId, u64, PollInterest)> {
    let handle_value = arg_value(args, 0, "handle", "PollHandle")?;
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "PollHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
    let handle = resource::PollHandle(handle_inner);
...
fn encode_destack_io_timerfd_get_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.initial_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.interval_ns, 64)); context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_io_timerfd_open_args(
    ...
    let clock = match clock_raw { 1i32 => TimerFdClock::Realtime, 2i32 => TimerFdClock::Monotonic, 3i32 => TimerFdClock::Boottime , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("clock", "unknown TimerFdClock value")).boxed()), };
...
fn decode_destack_io_timerfd_set_args(
    ...
    let spec = {
        if spec_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("spec", "TimerFdSpec")).boxed()); }
        let slots = context.aggregate_slots(spec_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 2 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("spec", "expected 2 fields")).boxed()); }
...
fn encode_destack_io_uring_features_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.has_submission_polling)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.has_kernel_polling)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.has_fixed_files)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.has_fixed_buffers)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.max_entries as u64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_io_uring_open_args(
    ...
    let parameters = {
        if parameters_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("parameters", "UringParameters")).boxed()); }
        ...
        let parameters_sq_thread_idle_ms = decode_uint32(slots[2], "parameters_sq_thread_idle_ms", "sqThreadIdleMs")?;
        UringParametersVm {
...
fn decode_destack_io_uring_register_files_args(
    ...
    let files = decode_slice::<resource::ResourceId>(context, files_value, "files", "Slice<ResourceId>")?;
    Ok((handle, files))
}
...
pub(crate) const IO_COMPLETION_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_COMPLETION_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_DEVICE_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_EVENT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_EVENT_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_POLL_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_POLL_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_TIMERFD_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_TIMERFD_GET: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_TIMERFD_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_URING_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_URING_FEATURES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_URING_UNREGISTER_BUFFERS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_URING_UNREGISTER_FILES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const IO_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "io",
    bindings: &[
        NativeBinding::new(IO_COMPLETION_CANCEL, "destack.io.completion.cancel", destack_io_completion_cancel as *const ()),
        NativeBinding::new(IO_COMPLETION_CLOSE, "destack.io.completion.close", destack_io_completion_close as *const ()),
        NativeBinding::new(IO_COMPLETION_ENTER, "destack.io.completion.enter", destack_io_completion_enter as *const ()),
        NativeBinding::new(IO_COMPLETION_OPEN, "destack.io.completion.open", destack_io_completion_open as *const ()),
        NativeBinding::new(IO_COMPLETION_SUBMIT, "destack.io.completion.submit", destack_io_completion_submit as *const ()),
        NativeBinding::new(IO_COMPLETION_SUBMIT_BATCH, "destack.io.completion.submitBatch", destack_io_completion_submit_batch as *const ()),
        NativeBinding::new(IO_COMPLETION_WAIT, "destack.io.completion.wait", destack_io_completion_wait as *const ()),
        NativeBinding::new(IO_CONTROL_FCNTL, "destack.io.control.fcntl", destack_io_control_fcntl as *const ()),
        NativeBinding::new(IO_CONTROL_IOCTL, "destack.io.control.ioctl", destack_io_control_ioctl as *const ()),
        NativeBinding::new(IO_DEVICE_CLOSE, "destack.io.device.close", destack_io_device_close as *const ()),
        NativeBinding::new(IO_DEVICE_CONTROL, "destack.io.device.control", destack_io_device_control as *const ()),
        NativeBinding::new(IO_DEVICE_OPEN, "destack.io.device.open", destack_io_device_open as *const ()),
        NativeBinding::new(IO_DEVICE_READ, "destack.io.device.read", destack_io_device_read as *const ()),
        NativeBinding::new(IO_DEVICE_WRITE, "destack.io.device.write", destack_io_device_write as *const ()),
        NativeBinding::new(IO_EVENT_ATTACH, "destack.io.event.attach", destack_io_event_attach as *const ()),
        NativeBinding::new(IO_EVENT_CLOSE, "destack.io.event.close", destack_io_event_close as *const ()),
        NativeBinding::new(IO_EVENT_OPEN, "destack.io.event.open", destack_io_event_open as *const ()),
        NativeBinding::new(IO_EVENT_SIGNAL, "destack.io.event.signal", destack_io_event_signal as *const ()),
        NativeBinding::new(IO_POLL_CLOSE, "destack.io.poll.close", destack_io_poll_close as *const ()),
        NativeBinding::new(IO_POLL_DEREGISTER, "destack.io.poll.deregister", destack_io_poll_deregister as *const ()),
        NativeBinding::new(IO_POLL_OPEN, "destack.io.poll.open", destack_io_poll_open as *const ()),
        NativeBinding::new(IO_POLL_REGISTER, "destack.io.poll.register", destack_io_poll_register as *const ()),
        NativeBinding::new(IO_POLL_UPDATE, "destack.io.poll.update", destack_io_poll_update as *const ()),
        NativeBinding::new(IO_POLL_WAIT, "destack.io.poll.wait", destack_io_poll_wait as *const ()),
        NativeBinding::new(IO_TIMERFD_CLOSE, "destack.io.timerfd.close", destack_io_timerfd_close as *const ()),
        NativeBinding::new(IO_TIMERFD_GET, "destack.io.timerfd.get", destack_io_timerfd_get as *const ()),
        NativeBinding::new(IO_TIMERFD_OPEN, "destack.io.timerfd.open", destack_io_timerfd_open as *const ()),
        NativeBinding::new(IO_TIMERFD_READ, "destack.io.timerfd.read", destack_io_timerfd_read as *const ()),
        NativeBinding::new(IO_TIMERFD_SET, "destack.io.timerfd.set", destack_io_timerfd_set as *const ()),
        NativeBinding::new(IO_URING_CLOSE, "destack.io.uring.close", destack_io_uring_close as *const ()),
        NativeBinding::new(IO_URING_FEATURES, "destack.io.uring.features", destack_io_uring_features as *const ()),
        NativeBinding::new(IO_URING_OPEN, "destack.io.uring.open", destack_io_uring_open as *const ()),
        NativeBinding::new(IO_URING_REGISTER_BUFFERS, "destack.io.uring.registerBuffers", destack_io_uring_register_buffers as *const ()),
        NativeBinding::new(IO_URING_REGISTER_FILES, "destack.io.uring.registerFiles", destack_io_uring_register_files as *const ()),
        NativeBinding::new(IO_URING_UNREGISTER_BUFFERS, "destack.io.uring.unregisterBuffers", destack_io_uring_unregister_buffers as *const ()),
        NativeBinding::new(IO_URING_UNREGISTER_FILES, "destack.io.uring.unregisterFiles", destack_io_uring_unregister_files as *const ()),
    ],
};
...
fn destack_io_completion_cancel_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_cancel(binding, out, handle, target) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_cancel(binding, out, handle, target) },
        },
        |result| {
            if let Ok(()) = result {
            ...
            if let Err(error) = result {
                let payload = {
                    ...
                    IoCompletionCancelReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_completion_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_completion_enter_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_enter(binding, out, handle, mincomplete, timeoutns, flags) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_enter(binding, out, handle, mincomplete, timeoutns, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: u32 = unsafe { out.read() };
...
fn destack_io_completion_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_open(binding, out, entries) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_open(binding, out, entries) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_completion_submit_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_submit(binding, handle, operation) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_submit(binding, handle, operation) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoCompletionSubmitReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_completion_submit_batch_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_submit_batch(binding, out, handle, operationwords, operationcount, operationwordstride) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_submit_batch(binding, out, handle, operationwords, operationcount, operationwordstride) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: u32 = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoCompletionSubmitBatchReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_completion_wait_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_wait(binding, out, handle, timeoutns, maxevents) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_completion_wait(binding, out, handle, timeoutns, maxevents) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_control_fcntl_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_control_fcntl(binding, out, handle, command, argument, flags) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_control_fcntl(binding, out, handle, command, argument, flags) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_control_ioctl_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_control_ioctl(binding, out, handle, request) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_control_ioctl(binding, out, handle, request) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_output_item in unsafe { result_value.output.as_slice()? }.iter().cloned() {
...
fn destack_io_device_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_device_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_device_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_device_control_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_device_control(binding, out, handle, request) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_device_control(binding, out, handle, request) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: DescriptorResult = unsafe { out.read() };
...
fn destack_io_device_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_device_open(binding, out, path, flags, mode) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_device_open(binding, out, path, flags, mode) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_device_read_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_device_read(binding, out, handle, buffer) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_device_read(binding, out, handle, buffer) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_device_write_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_device_write(binding, out, handle, buffer) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_device_write(binding, out, handle, buffer) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: u64 = unsafe { out.read() };
...
fn destack_io_event_attach_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_attach(binding, token, target, key) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_event_attach(binding, token, target, key) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_event_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_close(binding, token) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_event_close(binding, token) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_event_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_open(binding, out, initial) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_event_open(binding, out, initial) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_event_signal_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_signal(binding, token, argument_value) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_event_signal(binding, token, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_deregister_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_deregister(binding, handle, target) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_deregister(binding, handle, target) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_open(binding, out, backend) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_open(binding, out, backend) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_poll_register_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_register(binding, handle, target, key, interest) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_register(binding, handle, target, key, interest) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_update_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_update(binding, handle, target, key, interest) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_update(binding, handle, target, key, interest) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_wait_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_wait(binding, out, handle, timeoutns, maxevents) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_poll_wait(binding, out, handle, timeoutns, maxevents) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_timerfd_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_timer_fd_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_timer_fd_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_timerfd_get_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_timer_fd_get(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_timer_fd_get(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_timerfd_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_timer_fd_open(binding, out, clock, flags) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_timer_fd_open(binding, out, clock, flags) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_timerfd_read_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_timer_fd_read(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_timer_fd_read(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: u64 = unsafe { out.read() };
...
fn destack_io_timerfd_set_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_timer_fd_set(binding, handle, spec, flags) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_timer_fd_set(binding, handle, spec, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_uring_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_uring_features_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_features(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_features(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_uring_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_open(binding, out, parameters) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_open(binding, out, parameters) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_uring_register_buffers_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_register_buffers(binding, handle, addresses, lengths) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_register_buffers(binding, handle, addresses, lengths) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoUringRegisterBuffersReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_uring_register_files_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_register_files(binding, handle, files) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_register_files(binding, handle, files) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoUringRegisterFilesReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_uring_unregister_buffers_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_unregister_buffers(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_unregister_buffers(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoUringUnregisterBuffersReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_uring_unregister_files_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_unregister_files(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_io_uring_unregister_files(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    IoUringUnregisterFilesReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
pub(crate) unsafe extern "C" fn destack_io_completion_cancel(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_CANCEL)?;
...
pub(crate) unsafe extern "C" fn destack_io_completion_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_completion_enter(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_ENTER)?;
        destack_io_completion_enter_replay(context, world, out, handle, mincomplete, timeoutns, flags)
    })
}
...
pub(crate) unsafe extern "C" fn destack_io_completion_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_io_completion_submit(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_SUBMIT)?;
...
pub(crate) unsafe extern "C" fn destack_io_completion_submit_batch(
    ...
    native_call(|context| {
        ...
        let _ = (&out, &handle, &operationwords, &operationcount, &operationwordstride);

        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_SUBMIT_BATCH)?;
        destack_io_completion_submit_batch_replay(context, world, out, handle, operationwords, operationcount, operationwordstride)
    })
}
...
pub(crate) unsafe extern "C" fn destack_io_completion_wait(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_COMPLETION_WAIT)?;
...
pub(crate) unsafe extern "C" fn destack_io_control_fcntl(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_CONTROL_FCNTL)?;
...
pub(crate) unsafe extern "C" fn destack_io_control_ioctl(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_CONTROL_IOCTL)?;
...
pub(crate) unsafe extern "C" fn destack_io_device_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_DEVICE_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_device_control(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_DEVICE_CONTROL)?;
...
pub(crate) unsafe extern "C" fn destack_io_device_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_DEVICE_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_io_device_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_DEVICE_READ)?;
...
pub(crate) unsafe extern "C" fn destack_io_device_write(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_DEVICE_WRITE)?;
...
pub(crate) unsafe extern "C" fn destack_io_event_attach(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_EVENT_ATTACH)?;
        destack_io_event_attach_replay(context, world, token, target, key)
    })
}

#[unsafe(export_name = "destack.io.event.close")]
pub(crate) unsafe extern "C" fn destack_io_event_close(
    token: EventToken,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &token;

        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_EVENT_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_event_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_EVENT_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_io_event_signal(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_EVENT_SIGNAL)?;
...
pub(crate) unsafe extern "C" fn destack_io_poll_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_POLL_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_poll_deregister(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_POLL_DEREGISTER)?;
...
pub(crate) unsafe extern "C" fn destack_io_poll_register(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_POLL_REGISTER)?;
...
pub(crate) unsafe extern "C" fn destack_io_poll_update(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_POLL_UPDATE)?;
...
pub(crate) unsafe extern "C" fn destack_io_timerfd_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_TIMERFD_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_timerfd_get(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_TIMERFD_GET)?;
...
pub(crate) unsafe extern "C" fn destack_io_timerfd_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_TIMERFD_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_io_timerfd_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_TIMERFD_READ)?;
...
pub(crate) unsafe extern "C" fn destack_io_timerfd_set(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_TIMERFD_SET)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_features(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_FEATURES)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_register_buffers(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_REGISTER_BUFFERS)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_register_files(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_REGISTER_FILES)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_unregister_buffers(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_UNREGISTER_BUFFERS)?;
...
pub(crate) unsafe extern "C" fn destack_io_uring_unregister_files(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(IO_URING_UNREGISTER_FILES)?;
...
fn destack_io_completion_cancel_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_cancel(binding, context, handle, target),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_cancel(binding, context, handle, target),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_close_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_close(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_enter_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_enter(binding, context, handle, mincomplete, timeoutns, flags),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_enter(binding, context, handle, mincomplete, timeoutns, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_open(binding, context, entries),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_open(binding, context, entries),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_submit_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_submit(binding, context, handle, operation),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_submit(binding, context, handle, operation),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_submit_batch_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_submit_batch(binding, context, handle, operationwords, operationcount, operationwordstride),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_submit_batch(binding, context, handle, operationwords, operationcount, operationwordstride),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_wait_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_wait(binding, context, handle, timeoutns, maxevents),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_completion_wait(binding, context, handle, timeoutns, maxevents),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_key = decode_uint64(slots[0], "result_recorded_item_key", "key")?;
                        let result_recorded_item_result = decode_int64(slots[1], "result_recorded_item_result", "result")?;
                        let result_recorded_item_flags = decode_uint32(slots[2], "result_recorded_item_flags", "flags")?;
                        CompletionEventVm {
...
fn destack_io_control_fcntl_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_control_fcntl(binding, context, handle, command, argument, flags),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_control_fcntl(binding, context, handle, command, argument, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_control_ioctl_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_control_ioctl(binding, context, handle, request),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_control_ioctl(binding, context, handle, request),
            }
        },
        |context, result| {
            let _ = &context;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_output = VmSlice::<u8>::from_bytes(context, value.output.as_ref())?;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_device_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_device_control_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_device_control(binding, context, handle, request),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_device_control(binding, context, handle, request),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_device_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_device_open(binding, context, path, flags, mode),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_device_open(binding, context, path, flags, mode),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_device_read_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_device_read(binding, context, handle, buffer),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_device_read(binding, context, handle, buffer),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_device_write_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_device_write(binding, context, handle, buffer),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_device_write(binding, context, handle, buffer),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_event_attach_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_event_attach(binding, context, token, target, key),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_event_attach(binding, context, token, target, key),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_event_close(binding, context, token),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_event_open(binding, context, initial),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_event_signal_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_event_signal(binding, context, token, argument_value),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_event_signal(binding, context, token, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_deregister_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_deregister(binding, context, handle, target),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_deregister(binding, context, handle, target),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_open(binding, context, backend),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_register_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_register(binding, context, handle, target, key, interest),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_register(binding, context, handle, target, key, interest),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_update_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_update(binding, context, handle, target, key, interest),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_update(binding, context, handle, target, key, interest),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_wait_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_wait(binding, context, handle, timeoutns, maxevents),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_poll_wait(binding, context, handle, timeoutns, maxevents),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        if slots.len() != 3 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "expected 3 fields")).boxed()); }
                        let result_recorded_item_key = decode_uint64(slots[0], "result_recorded_item_key", "key")?;
                        let result_recorded_item_ready_inner = decode_uint32(slots[1], "result_recorded_item_ready_inner", "ready")?;
                        let result_recorded_item_ready = PollInterest(result_recorded_item_ready_inner);
                        let result_recorded_item_data = decode_int32(slots[2], "result_recorded_item_data", "data")?;
                        PollEventVm {
                            key: result_recorded_item_key,
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_timer_fd_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_timer_fd_get(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_timerfd_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_timer_fd_open(binding, context, clock, flags),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_timer_fd_open(binding, context, clock, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_timer_fd_read(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_timerfd_set_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_timer_fd_set(binding, context, handle, spec, flags),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_timer_fd_set(binding, context, handle, spec, flags),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_features(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_open(binding, context, parameters),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_register_buffers_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_register_buffers(binding, context, handle, addresses, lengths),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_register_buffers(binding, context, handle, addresses, lengths),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_register_files_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_register_files(binding, context, handle, files),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_register_files(binding, context, handle, files),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_unregister_buffers_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_unregister_buffers(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_unregister_buffers(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_unregister_files_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_unregister_files(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_io_uring_unregister_files(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
pub(crate) fn register_io_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, IO_COMPLETION_CANCEL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, target) = decode_destack_io_completion_cancel_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_CANCEL)?;
    ...
    {
        binding!(registry, isolate, IO_COMPLETION_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_io_completion_close_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_CLOSE)?;
    ...
    {
        binding!(registry, isolate, IO_COMPLETION_ENTER, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, mincomplete, timeoutns, flags) = decode_destack_io_completion_enter_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_ENTER)?;
                destack_io_completion_enter_vm_replay(binding, context, world, handle, mincomplete, timeoutns, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_COMPLETION_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (entries,) = decode_destack_io_completion_open_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_OPEN)?;
    ...
    {
        binding!(registry, isolate, IO_COMPLETION_SUBMIT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, operation) = decode_destack_io_completion_submit_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_SUBMIT)?;
                destack_io_completion_submit_vm_replay(binding, context, world, handle, operation)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_COMPLETION_SUBMIT_BATCH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, operationwords, operationcount, operationwordstride) = decode_destack_io_completion_submit_batch_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_SUBMIT_BATCH)?;
                destack_io_completion_submit_batch_vm_replay(binding, context, world, handle, operationwords, operationcount, operationwordstride)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_COMPLETION_WAIT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, timeoutns, maxevents) = decode_destack_io_completion_wait_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_COMPLETION_WAIT)?;
                destack_io_completion_wait_vm_replay(binding, context, world, handle, timeoutns, maxevents)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_CONTROL_FCNTL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, command, argument, flags) = decode_destack_io_control_fcntl_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_CONTROL_FCNTL)?;
                destack_io_control_fcntl_vm_replay(binding, context, world, handle, command, argument, flags)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_CONTROL_IOCTL, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_CONTROL_IOCTL)?;
    ...
    }
    {
        binding!(registry, isolate, IO_DEVICE_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_DEVICE_CLOSE)?;
    ...
    {
        binding!(registry, isolate, IO_DEVICE_CONTROL, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, request) = decode_destack_io_device_control_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_DEVICE_CONTROL)?;
    ...
    }
    {
        binding!(registry, isolate, IO_DEVICE_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_DEVICE_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, IO_DEVICE_READ, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_DEVICE_READ)?;
    ...
    }
    {
        binding!(registry, isolate, IO_DEVICE_WRITE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_DEVICE_WRITE)?;
    ...
    }
    {
        binding!(registry, isolate, IO_EVENT_ATTACH, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_EVENT_ATTACH)?;
    ...
    }
    {
        binding!(registry, isolate, IO_EVENT_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_EVENT_CLOSE)?;
    ...
    }
    {
        binding!(registry, isolate, IO_EVENT_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_EVENT_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, IO_EVENT_SIGNAL, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_EVENT_SIGNAL)?;
    ...
    }
    {
        binding!(registry, isolate, IO_POLL_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_CLOSE)?;
    ...
    {
        binding!(registry, isolate, IO_POLL_DEREGISTER, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, target) = decode_destack_io_poll_deregister_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_DEREGISTER)?;
    ...
    }
    {
        binding!(registry, isolate, IO_POLL_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, IO_POLL_REGISTER, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, target, key, interest) = decode_destack_io_poll_register_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_REGISTER)?;
                destack_io_poll_register_vm_replay(binding, context, world, handle, target, key, interest)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_POLL_UPDATE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, target, key, interest) = decode_destack_io_poll_update_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_UPDATE)?;
                destack_io_poll_update_vm_replay(binding, context, world, handle, target, key, interest)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_POLL_WAIT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, timeoutns, maxevents) = decode_destack_io_poll_wait_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_POLL_WAIT)?;
                destack_io_poll_wait_vm_replay(binding, context, world, handle, timeoutns, maxevents)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_TIMERFD_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_TIMERFD_CLOSE)?;
    ...
    }
    {
        binding!(registry, isolate, IO_TIMERFD_GET, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_TIMERFD_GET)?;
    ...
    }
    {
        binding!(registry, isolate, IO_TIMERFD_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_TIMERFD_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, IO_TIMERFD_READ, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_TIMERFD_READ)?;
    ...
    }
    {
        binding!(registry, isolate, IO_TIMERFD_SET, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_TIMERFD_SET)?;
    ...
    }
    {
        binding!(registry, isolate, IO_URING_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_CLOSE)?;
    ...
    {
        binding!(registry, isolate, IO_URING_FEATURES, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_io_uring_features_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_FEATURES)?;
    ...
    }
    {
        binding!(registry, isolate, IO_URING_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_OPEN)?;
    ...
    {
        binding!(registry, isolate, IO_URING_REGISTER_BUFFERS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, addresses, lengths) = decode_destack_io_uring_register_buffers_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_REGISTER_BUFFERS)?;
                destack_io_uring_register_buffers_vm_replay(binding, context, world, handle, addresses, lengths)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_URING_REGISTER_FILES, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, files) = decode_destack_io_uring_register_files_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_REGISTER_FILES)?;
                destack_io_uring_register_files_vm_replay(binding, context, world, handle, files)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_URING_UNREGISTER_BUFFERS, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_io_uring_unregister_buffers_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_UNREGISTER_BUFFERS)?;
    ...
    {
        binding!(registry, isolate, IO_URING_UNREGISTER_FILES, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_io_uring_unregister_files_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(IO_URING_UNREGISTER_FILES)?;
