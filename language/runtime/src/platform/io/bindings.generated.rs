...
use crate::platform::io::{CompletionEvent, CompletionEventVm, CompletionOperation, CompletionOperationKind, CompletionOperationVm, DescriptorControlCommand, DescriptorControlFlags, DescriptorRequest, DescriptorRequestVm, DescriptorResult, DescriptorResultVm, DescriptorresultReplayRecord, EventToken, PollBackend, PollEvent, PollEventVm, PollInterest, PollInterestVm, TimerFdClock, TimerFdFlags, TimerFdSetFlags, TimerFdSpec, TimerFdSpecVm, UringFeatures, UringFeaturesVm, UringParameters, UringParametersVm};
...
fn decode_destack_io_completion_submit_args(
    ...
    let operation = {
        ...
        let operation_kind = match operation_kind_raw { 1u8 => CompletionOperationKind::Read, 2u8 => CompletionOperationKind::Write, 3u8 => CompletionOperationKind::Accept, 4u8 => CompletionOperationKind::Connect, 5u8 => CompletionOperationKind::Timeout, 6u8 => CompletionOperationKind::Fsync, 7u8 => CompletionOperationKind::Send, 8u8 => CompletionOperationKind::Receive , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("operation_kind", "unknown CompletionOperationKind value")).boxed()), };
...
fn encode_destack_io_control_ioctl_result(
    ...
    result.map(|value| { let field_0 = vm::Value::int(value.return_value, 64); let field_1 = value.output.to_value(context); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_io_poll_open_args(
    ...
    let backend = match backend_raw { 0u8 => PollBackend::Auto, 1u8 => PollBackend::Epoll, 2u8 => PollBackend::Kqueue, 3u8 => PollBackend::Poll , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("backend", "unknown PollBackend value")).boxed()), };
    Ok((backend,))
}
...
fn encode_destack_io_timerfd_get_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.initial_ns, 64); let field_1 = vm::Value::uint(value.interval_ns, 64); context.allocate_aggregate(vec![field_0, field_1]) })
}
...
fn decode_destack_io_timerfd_open_args(
    ...
    let clock = match clock_raw { 1u8 => TimerFdClock::Realtime, 2u8 => TimerFdClock::Monotonic, 3u8 => TimerFdClock::Boottime , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("clock", "unknown TimerFdClock value")).boxed()), };
...
fn encode_destack_io_uring_features_result(
    ...
    result.map(|value| { let field_0 = vm::Value::bool(value.has_submission_polling); let field_1 = vm::Value::bool(value.has_kernel_polling); let field_2 = vm::Value::bool(value.has_fixed_files); let field_3 = vm::Value::bool(value.has_fixed_buffers); let field_4 = vm::Value::uint(value.max_entries as u64, 32); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) })
}
...
pub const IO_COMPLETION_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_COMPLETION_OPEN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_DEVICE_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_EVENT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_TIMERFD_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_TIMERFD_GET: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_TIMERFD_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_URING_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_URING_FEATURES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_URING_UNREGISTER_BUFFERS: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const IO_URING_UNREGISTER_FILES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_output_item in unsafe { result_value.output.as_slice()? } {
                ...
                let result_recorded = DescriptorResultValue {
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? } {
                    let result_recorded_item_recorded_key = result_recorded_item.key;
                    let result_recorded_item_recorded_ready = result_recorded_item.ready.0;
...
pub unsafe extern "C" fn destack_io_device_close(
    handle: resource::DeviceHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_io_event_close(
    token: EventToken,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &token;
...
pub unsafe extern "C" fn destack_io_poll_close(
    handle: resource::PollHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
...
pub unsafe extern "C" fn destack_io_uring_close(
    handle: resource::UringHandle,
) -> RuntimeStatus {
    native_call(|context| {
        let _ = &handle;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_output = VmSlice::<u8>::from_bytes(context, &value.output);
...
pub fn register_io_vm_bindings(
