...
use crate::platform::bindings::{BindingDescriptor, BindingBlocking, BindingRegistry, NativeBinding, NativeBindingSet, BindingScope, native_call, BindingReplayKind, ReplayPolicy, RuntimeWorld};
...
use crate::platform::io::{CompletionEvent, CompletionEventVm, CompletionOperation, CompletionOperationKind, CompletionOperationVm, DescriptorControlCommand, DescriptorControlFlags, DescriptorRequest, DescriptorRequestVm, DescriptorResult, DescriptorResultReplayRecord, DescriptorResultVm, EventToken, PollBackend, PollEvent, PollEventVm, PollInterest, UringFeatures, UringFeaturesVm, UringParameters, UringParametersVm};
...
use crate::platform::io::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_io_poll_open_args(
    ...
    let backend = match backend_raw { 0u8 => PollBackend::Auto, 1u8 => PollBackend::Epoll, 2u8 => PollBackend::Kqueue, 3u8 => PollBackend::Poll, 4u8 => PollBackend::Iocp , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("backend", "unknown PollBackend value")).boxed()), };
    Ok((backend,))
}
...
fn destack_io_completion_cancel_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_cancel(context, out, handle, target) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_cancel(context, out, handle, target) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_io_completion_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_completion_enter_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_enter(context, out, handle, mincomplete, timeoutns, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_enter(context, out, handle, mincomplete, timeoutns, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_completion_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_open(context, out, entries) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_open(context, out, entries) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_completion_submit_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_submit(context, handle, operation) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_submit(context, handle, operation) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_completion_submit_batch_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_submit_batch(context, out, handle, operationwords, operationcount, operationwordstride) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_submit_batch(context, out, handle, operationwords, operationcount, operationwordstride) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_completion_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_completion_wait(context, out, handle, timeoutns, maxevents) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_completion_wait(context, out, handle, timeoutns, maxevents) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_control_fcntl_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_control_fcntl(context, out, handle, command, argument, flags) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_control_fcntl(context, out, handle, command, argument, flags) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_control_ioctl_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_control_ioctl(context, out, handle, request) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_control_ioctl(context, out, handle, request) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                ...
                let mut result_recorded_output = Vec::with_capacity(result_recorded_output_raw.len());
...
fn destack_io_event_attach_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_attach(context, token, target, key) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_event_attach(context, token, target, key) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_event_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_close(context, token) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_event_close(context, token) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_event_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_open(context, out, initial) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_event_open(context, out, initial) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_event_signal_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_event_signal(context, token, argument_value) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_event_signal(context, token, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_deregister_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_deregister(context, handle, target) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_deregister(context, handle, target) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_open(context, out, backend) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_open(context, out, backend) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_poll_register_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_register(context, handle, target, key, interest) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_register(context, handle, target, key, interest) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_update_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_update(context, handle, target, key, interest) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_update(context, handle, target, key, interest) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_poll_wait_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_poll_wait(context, out, handle, timeoutns, maxevents) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_poll_wait(context, out, handle, timeoutns, maxevents) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_uring_close_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_close(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_close(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_uring_features_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_features(context, out, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_features(context, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_uring_open_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_open(context, out, parameters) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_open(context, out, parameters) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
...
fn destack_io_uring_register_buffers_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_register_buffers(context, handle, addresses, lengths) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_register_buffers(context, handle, addresses, lengths) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_uring_register_files_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_register_files(context, handle, files) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_register_files(context, handle, files) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_uring_unregister_buffers_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_unregister_buffers(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_unregister_buffers(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(PlatformError::from(error.as_ref()));
                    IoUringUnregisterBuffersReplay {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_io_uring_unregister_files_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_io_uring_unregister_files(context, handle) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_io_uring_unregister_files(context, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_io_completion_cancel_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_cancel(runtime, context, handle, target),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_cancel(runtime, context, handle, target),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_close(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_enter_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_enter(runtime, context, handle, mincomplete, timeoutns, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_enter(runtime, context, handle, mincomplete, timeoutns, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_open(runtime, context, entries),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_open(runtime, context, entries),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_submit_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_submit(runtime, context, handle, operation),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_submit(runtime, context, handle, operation),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_submit_batch_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_submit_batch(runtime, context, handle, operationwords, operationcount, operationwordstride),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_submit_batch(runtime, context, handle, operationwords, operationcount, operationwordstride),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_completion_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_completion_wait(runtime, context, handle, timeoutns, maxevents),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_completion_wait(runtime, context, handle, timeoutns, maxevents),
            }
        },
        |context, result| {
            let _ = &context;
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_encoded = { let field_0 = vm::Value::uint(vm_result_item_value.key, 64); let field_1 = vm::Value::int(vm_result_item_value.result, 64); let field_2 = vm::Value::uint(vm_result_item_value.flags as u64, 32); context.allocate_aggregate(vec![field_0, field_1, field_2]) };
                        vm_result_values.push(vm_result_item_value_encoded);
                    }
                    let vm_result_data = context.allocate_raw_values(vm_result_values);
                    let vm_result: VmArray<CompletionEventVm> = VmArray { data: vm_result_data, len: value.len() as u32, capacity: value.len() as u32, _marker: std::marker::PhantomData };
                    Ok(vm_result)
                }
                Err(error) => Err(RuntimeError::from(error).boxed()),
            }
...
fn destack_io_control_fcntl_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_control_fcntl(runtime, context, handle, command, argument, flags),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_control_fcntl(runtime, context, handle, command, argument, flags),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_control_ioctl_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_control_ioctl(runtime, context, handle, request),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_control_ioctl(runtime, context, handle, request),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_event_attach_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_event_attach(runtime, context, token, target, key),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_event_attach(runtime, context, token, target, key),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_event_close(runtime, context, token),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_event_open(runtime, context, initial),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_event_signal_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_event_signal(runtime, context, token, argument_value),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_event_signal(runtime, context, token, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_deregister_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_deregister(runtime, context, handle, target),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_deregister(runtime, context, handle, target),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_open(runtime, context, backend),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_register_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_register(runtime, context, handle, target, key, interest),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_register(runtime, context, handle, target, key, interest),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_update_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_update(runtime, context, handle, target, key, interest),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_update(runtime, context, handle, target, key, interest),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_poll_wait_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_poll_wait(runtime, context, handle, timeoutns, maxevents),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_poll_wait(runtime, context, handle, timeoutns, maxevents),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_error = decode_int32(slots[2], "result_recorded_item_error", "error")?;
                        PollEventVm {
                            key: result_recorded_item_key,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_encoded = { let field_0 = vm::Value::uint(vm_result_item_value.key, 64); let field_1 = vm::Value::uint(vm_result_item_value.ready.0 as u64, 32); let field_2 = vm::Value::int(vm_result_item_value.error as i64, 32); context.allocate_aggregate(vec![field_0, field_1, field_2]) };
                        vm_result_values.push(vm_result_item_value_encoded);
                    }
                    let vm_result_data = context.allocate_raw_values(vm_result_values);
                    let vm_result: VmArray<PollEventVm> = VmArray { data: vm_result_data, len: value.len() as u32, capacity: value.len() as u32, _marker: std::marker::PhantomData };
                    Ok(vm_result)
                }
                Err(error) => Err(RuntimeError::from(error).boxed()),
            }
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_close(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_features(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_open(runtime, context, parameters),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_register_buffers_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_register_buffers(runtime, context, handle, addresses, lengths),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_register_buffers(runtime, context, handle, addresses, lengths),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_register_files_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_register_files(runtime, context, handle, files),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_register_files(runtime, context, handle, files),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_unregister_buffers_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_unregister_buffers(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_unregister_buffers(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_io_uring_unregister_files_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_io_uring_unregister_files(runtime, context, handle),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_io_uring_unregister_files(runtime, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    }
    {
        binding!(registry, isolate, IO_COMPLETION_ENTER, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_completion_enter_vm_replay(runtime, context, world, handle, mincomplete, timeoutns, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, IO_COMPLETION_SUBMIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_completion_submit_vm_replay(runtime, context, world, handle, operation)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_COMPLETION_SUBMIT_BATCH, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_completion_submit_batch_vm_replay(runtime, context, world, handle, operationwords, operationcount, operationwordstride)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_COMPLETION_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_completion_wait_vm_replay(runtime, context, world, handle, timeoutns, maxevents)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_CONTROL_FCNTL, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_control_fcntl_vm_replay(runtime, context, world, handle, command, argument, flags)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, IO_POLL_REGISTER, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_poll_register_vm_replay(runtime, context, world, handle, target, key, interest)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_POLL_UPDATE, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_poll_update_vm_replay(runtime, context, world, handle, target, key, interest)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_POLL_WAIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_poll_wait_vm_replay(runtime, context, world, handle, timeoutns, maxevents)
            })
            .map_err(Into::into)
        });
    }
    ...
    }
    {
        binding!(registry, isolate, IO_URING_REGISTER_BUFFERS, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_uring_register_buffers_vm_replay(runtime, context, world, handle, addresses, lengths)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, IO_URING_REGISTER_FILES, move |context, args| {
            with_runtime_call_context(|runtime| {
                ...
                destack_io_uring_register_files_vm_replay(runtime, context, world, handle, files)
            })
            .map_err(Into::into)
        });
    }
