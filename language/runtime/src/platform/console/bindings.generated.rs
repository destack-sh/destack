...
use crate::platform::{NativeStringRef, RuntimeStatus};
...
use crate::platform::console::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
pub const CONSOLE_CONSOLE_ERROR: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CONSOLE_CONSOLE_INFO: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CONSOLE_CONSOLE_LOG: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CONSOLE_CONSOLE_WARN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const CONSOLE_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "console",
    bindings: &[
        NativeBinding::new(CONSOLE_CONSOLE_ERROR, "destack.console.console.error", destack_console_console_error as *const ()),
        NativeBinding::new(CONSOLE_CONSOLE_INFO, "destack.console.console.info", destack_console_console_info as *const ()),
        NativeBinding::new(CONSOLE_CONSOLE_LOG, "destack.console.console.log", destack_console_console_log as *const ()),
        NativeBinding::new(CONSOLE_CONSOLE_WARN, "destack.console.console.warn", destack_console_console_warn as *const ()),
    ],
};
...
fn destack_console_console_error_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_console_error(context, argument_value) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_console_error(context, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_console_console_info_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_console_info(context, argument_value) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_console_info(context, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_console_console_log_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_console_log(context, argument_value) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_console_log(context, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_console_console_warn_replay(
    ...
    context.replay().run_binding_with_payload_policy(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_console_warn(context, argument_value) },
            RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_console_warn(context, argument_value) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_console_console_error_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_console_error(runtime, context, argument_value),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_console_error(runtime, context, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_console_console_info_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_console_info(runtime, context, argument_value),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_console_info(runtime, context, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_console_console_log_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_console_log(runtime, context, argument_value),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_console_log(runtime, context, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_console_console_warn_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context_and_payload_policy(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_console_warn(runtime, context, argument_value),
                RuntimeWorld::Simulated => platform_simulated_vm::destack_console_warn(runtime, context, argument_value),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_console_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, CONSOLE_CONSOLE_ERROR, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (argument_value,) = decode_destack_console_console_error_args(context, args)?;
    ...
    {
        binding!(registry, isolate, CONSOLE_CONSOLE_INFO, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (argument_value,) = decode_destack_console_console_info_args(context, args)?;
    ...
    {
        binding!(registry, isolate, CONSOLE_CONSOLE_LOG, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, CONSOLE_CONSOLE_WARN, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (argument_value,) = decode_destack_console_console_warn_args(context, args)?;
...
pub fn install_console_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
