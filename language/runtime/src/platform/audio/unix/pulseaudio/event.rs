...
pub(crate) fn native_device_events_supported() -> bool {
    #[cfg(target_os = "linux")]
    {
        pactl::native_device_events_supported(AudioBackend::PulseAudio)
    }
...
pub(crate) fn start_native_device_event_monitor(
    ...
    #[cfg(target_os = "linux")]
    {
        pactl::start_native_device_event_monitor(_binding, AudioBackend::PulseAudio, "pulseaudio")
    }
...
pub(crate) fn stop_native_device_event_monitor(_binding: &BindingCallContext) {
    #[cfg(target_os = "linux")]
    {
        pactl::stop_native_device_event_monitor(_binding, AudioBackend::PulseAudio);
    }
}
