...
use crate::platform::audio::{
    AudioDeviceDirection, AudioDeviceInfo, AudioDeviceInfoReplay, AudioDeviceInfoVm,
...
struct AudioDeviceListReplay {
    /// Replay result payload.
    pub result: Result<Vec<AudioDeviceInfoReplay>, PlatformError>,
}
...
fn destack_audio_device_list_replay(
    ...
    context.replay().run_binding(
        AUDIO_DEVICE_LIST,
        || unsafe { platform_native::destack_audio_device_list(context, out) },
        |result| {
            if let Ok(()) = result {
...
fn destack_audio_device_open_replay(
    ...
    context.replay().run_binding(
        AUDIO_DEVICE_OPEN,
        || unsafe { platform_native::destack_audio_device_open(context, out, id, direction) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_audio_stream_open_replay(
    ...
    context.replay().run_binding(
        AUDIO_STREAM_OPEN,
        || unsafe { platform_native::destack_audio_stream_open(context, out, device, config) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_audio_stream_read_replay(
    ...
    context.replay().run_binding(
        AUDIO_STREAM_READ,
        || unsafe { platform_native::destack_audio_stream_read(context, out, handle, maxbytes) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_audio_stream_state_replay(
    ...
    context.replay().run_binding(
        AUDIO_STREAM_STATE,
        || unsafe { platform_native::destack_audio_stream_state(context, out, handle) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
fn destack_audio_stream_write_replay(
    ...
    context.replay().run_binding(
        AUDIO_STREAM_WRITE,
        || unsafe { platform_native::destack_audio_stream_write(context, out, handle, data) },
        |result| {
            if let Ok(()) = result {
                let result_value = unsafe {
                    if out.is_null() {
...
pub unsafe extern "C" fn destack_audio_device_close(
    ...
    native_call(|context| {
        ...
        destack_audio_device_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_audio_device_list(
    ...
    native_call(|context| {
        ...
        destack_audio_device_list_replay(context, out)
    })
}
...
pub unsafe extern "C" fn destack_audio_device_open(
    ...
    native_call(|context| {
        ...
        destack_audio_device_open_replay(context, out, id, direction)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_close(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_close_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_open(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_open_replay(context, out, device, config)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_read(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_read_replay(context, out, handle, maxbytes)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_start(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_start_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_state(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_state_replay(context, out, handle)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_stop(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_stop_replay(context, handle)
    })
}
...
pub unsafe extern "C" fn destack_audio_stream_write(
    ...
    native_call(|context| {
        ...
        destack_audio_stream_write_replay(context, out, handle, data)
    })
}
...
fn destack_audio_device_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_DEVICE_CLOSE,
        context,
        |context| platform_vm::destack_audio_device_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_audio_device_list_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_DEVICE_LIST,
        context,
        |context| platform_vm::destack_audio_device_list(runtime, context),
        |context, result| {
            let _ = &context;
...
fn destack_audio_device_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_DEVICE_OPEN,
        context,
        |context| platform_vm::destack_audio_device_open(runtime, context, id, direction),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_audio_stream_close_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_CLOSE,
        context,
        |context| platform_vm::destack_audio_stream_close(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_audio_stream_open_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_OPEN,
        context,
        |context| platform_vm::destack_audio_stream_open(runtime, context, device, config),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_audio_stream_read_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_READ,
        context,
        |context| platform_vm::destack_audio_stream_read(runtime, context, handle, maxbytes),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_audio_stream_start_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_START,
        context,
        |context| platform_vm::destack_audio_stream_start(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_audio_stream_state_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_STATE,
        context,
        |context| platform_vm::destack_audio_stream_state(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
...
fn destack_audio_stream_stop_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_STOP,
        context,
        |context| platform_vm::destack_audio_stream_stop(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
...
fn destack_audio_stream_write_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        AUDIO_STREAM_WRITE,
        context,
        |context| platform_vm::destack_audio_stream_write(runtime, context, handle, data),
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                let result_value = *value;
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_device_close_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, _args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_device_list_vm_replay(runtime, context)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_device_open_vm_replay(runtime, context, id, direction)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_close_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_open_vm_replay(runtime, context, device, config)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_read_vm_replay(runtime, context, handle, maxbytes)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_start_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_state_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_stop_vm_replay(runtime, context, handle)
                })
                .map_err(Into::into)
            }
        );
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    destack_audio_stream_write_vm_replay(runtime, context, handle, data)
                })
                .map_err(Into::into)
            }
        );
