...
use crate::platform::audio::{
    ...
    AudioBackendDisconnectedEvent, AudioBackendDisconnectedEventVm,
    ...
    AudioDefaultCaptureChangedEventVm, AudioDefaultCaptureChangedPayload,
    AudioDefaultCaptureChangedPayloadVm, AudioDefaultLoopbackChangedEvent,
    AudioDefaultLoopbackChangedEventVm, AudioDefaultLoopbackChangedPayload,
    AudioDefaultLoopbackChangedPayloadVm, AudioDefaultPlaybackChangedEvent,
    AudioDefaultPlaybackChangedEventVm, AudioDefaultPlaybackChangedPayload,
    AudioDefaultPlaybackChangedPayloadVm, AudioDeviceAddedEvent, AudioDeviceAddedEventVm,
    AudioDeviceAddedPayload, AudioDeviceAddedPayloadVm, AudioDeviceCapabilityFlags,
    AudioDeviceDescriptor, AudioDeviceDescriptorVm, AudioDeviceDirection,
    AudioDeviceFormatChangedEvent, AudioDeviceFormatChangedEventVm,
    AudioDeviceFormatChangedPayload, AudioDeviceFormatChangedPayloadVm, AudioDeviceListFlags,
    AudioDeviceListRequest, AudioDeviceListRequestVm, AudioDeviceOpenFlags, AudioDeviceOpenOptions,
    AudioDeviceOpenOptionsVm, AudioDeviceRemovedEvent, AudioDeviceRemovedEventVm,
    AudioDeviceRemovedPayload, AudioDeviceRemovedPayloadVm, AudioDeviceReroutedEvent,
    AudioDeviceReroutedEventVm, AudioDeviceReroutedPayload, AudioDeviceReroutedPayloadVm,
    AudioEvent, AudioEventDeliveryMode, AudioEventMetadata, AudioEventMetadataVm,
    ...
    AudioInterruptionBeganEvent, AudioInterruptionBeganEventVm, AudioInterruptionBeganPayload,
    AudioInterruptionBeganPayloadVm, AudioInterruptionEndedEvent, AudioInterruptionEndedEventVm,
    ...
    AudioStreamDeviceChangedEvent, AudioStreamDeviceChangedEventVm,
    AudioStreamDeviceChangedPayload, AudioStreamDeviceChangedPayloadVm, AudioStreamFlags,
    AudioStreamOpenOptions, AudioStreamOpenOptionsVm, AudioStreamRequirementFlags,
    AudioStreamState, AudioStreamStateChangedEvent, AudioStreamStateChangedEventVm,
    AudioStreamStateChangedPayload, AudioStreamStateChangedPayloadVm, AudioStreamStateKind,
    AudioStreamStateVm, AudioStreamStatusFlags, AudioStreamSupport, AudioStreamSupportVm,
    AudioStreamTiming, AudioStreamTimingVm, AudioStreamTransferMode, AudioStreamXRunEvent,
    AudioStreamXRunEventVm, AudioStreamXRunPayload, AudioStreamXRunPayloadVm,
    AudioSupportedEventSubscriptionFlags, AudioSupportedStreamClockDomains,
    AudioSupportedStreamFlags, AudioSupportedStreamRequirementFlags, MidiMessage, MidiMessageVm,
    MidiPortDescriptor, MidiPortDescriptorVm, MidiPortDirection, native as audio_native,
    vm as audio_vm,
};
use crate::platform::{
...
impl<'call> AudioHarnessContext<'call> {
    ...
    pub(crate) fn destack_audio_midi_flush(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => audio_vm::destack_audio_midi_flush(self.call_context, context, handle),
            None => unsafe { audio_native::destack_audio_midi_flush(self.call_context, handle) },
        }
    }
    ...
    pub(crate) fn destack_audio_midi_port_close(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                audio_vm::destack_audio_midi_port_close(self.call_context, context, handle)
            }
            None => unsafe {
                audio_native::destack_audio_midi_port_close(self.call_context, handle)
            },
        }
    }
    ...
    ) -> RuntimeResult<HarnessValue<NativeSlice<MidiPortDescriptor>, VmSlice<MidiPortDescriptorVm>>>
    {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out =
                    audio_vm::destack_audio_midi_port_list(self.call_context, context, direction)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let mut out = std::mem::MaybeUninit::<NativeSlice<MidiPortDescriptor>>::uninit();
                unsafe {
                    audio_native::destack_audio_midi_port_list(
                        self.call_context,
                        out.as_mut_ptr(),
                        direction,
                    )?;
    ...
    pub(crate) fn destack_audio_midi_port_open(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let id = id.into_vm("id")?;
                let out = audio_vm::destack_audio_midi_port_open(
                    self.call_context,
                    context,
                    id,
                    direction,
            ...
            None => {
                let id = id.into_native("id")?;
                let mut out = std::mem::MaybeUninit::<resource::MidiPortHandle>::uninit();
                unsafe {
                    audio_native::destack_audio_midi_port_open(
                        self.call_context,
                        out.as_mut_ptr(),
                        id,
                        direction,
    ...
    pub(crate) fn destack_audio_midi_read(
        ...
        maxmessages: u32,
        timeoutns: u64,
    ) -> RuntimeResult<HarnessValue<NativeArray<MidiMessage>, VmArray<MidiMessageVm>>> {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = audio_vm::destack_audio_midi_read(
                    self.call_context,
                    context,
                    handle,
                    maxmessages,
            ...
            None => {
                let mut out = std::mem::MaybeUninit::<NativeArray<MidiMessage>>::uninit();
                unsafe {
                    audio_native::destack_audio_midi_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxmessages,
    ...
    pub(crate) fn destack_audio_midi_try_read(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = audio_vm::destack_audio_midi_try_read(
                    self.call_context,
                    context,
                    handle,
                    maxmessages,
            ...
            None => {
                let mut out = std::mem::MaybeUninit::<NativeArray<MidiMessage>>::uninit();
                unsafe {
                    audio_native::destack_audio_midi_try_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxmessages,
    ...
    pub(crate) fn destack_audio_midi_write(
        &mut self,
        handle: resource::MidiPortHandle,
        messages: HarnessValue<NativeArray<MidiMessage>, VmArray<MidiMessageVm>>,
    ) -> RuntimeResult<u32> {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let messages = messages.into_vm("messages")?;
                let out = audio_vm::destack_audio_midi_write(
                    self.call_context,
                    context,
                    handle,
                    messages,
            ...
            None => {
                ...
                unsafe {
                    audio_native::destack_audio_midi_write(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        messages,
