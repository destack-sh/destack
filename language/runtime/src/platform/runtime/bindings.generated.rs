...
use crate::platform::runtime::{
    ...
    CheckpointFilterVm, CheckpointId, EngineDescriptor, EngineDescriptorVm, EventLoopDescriptor,
    EventLoopDescriptorVm, HeapDescriptor, HeapDescriptorVm, ImageDescriptor, ImageDescriptorVm,
    ImageFilter, ImageFilterVm, ImageId, ObservationHandle, ObservationOptions,
    ObservationOptionsVm, ObservationRecord, ObservationRecordVm, ResourceDescriptor,
    ResourceDescriptorVm, ResourceFilter, ResourceFilterVm, RevisionDescriptor,
    ...
    SnapshotDescriptor, SnapshotDescriptorVm, SnapshotFormat, SnapshotId, TopologyEdge,
    TopologyEdgeFilter, TopologyEdgeFilterVm, TopologyEdgeId, TopologyEdgeIdVm, TopologyEdgeVm,
    TopologyEntity, TopologyEntityFilter, TopologyEntityFilterVm, TopologyEntityId,
    TopologyEntityIdVm, TopologyEntityVm, TraceCursorHandle, TraceCursorOptions,
    TraceCursorOptionsVm, TraceDescriptor, TraceDescriptorVm, TraceRecord, TraceRecordVm,
    TraceSequence, WorldCreateOptions, WorldCreateOptionsVm, WorldDescriptor, WorldDescriptorVm,
    WorldHandle, WorldResourceId, WorldResourceIdVm, WorldViewHandle, WorldViewOptions,
    WorldViewOptionsVm,
};
use crate::platform::{
        ...
        let options_inner = {
            ...
            let options_inner_engine = if slots[0].tag() == vm::ValueTag::Void {
                ...
                let options_inner_engine_inner_raw =
                    decode_uint8(slots[0], "options_inner_engine_inner_raw", "engine")?;
                let options_inner_engine_inner = match options_inner_engine_inner_raw {
                    1u8 => RuntimeEngineKind::Vm,
                    2u8 => RuntimeEngineKind::Native,
                    _ => {
                        return Err(RuntimeError::from(PlatformError::invalid_argument_value(
            ...
            let options_inner_execution = if slots[1].tag() == vm::ValueTag::Void {
                ...
                let options_inner_execution_inner_raw =
                    decode_uint8(slots[1], "options_inner_execution_inner_raw", "execution")?;
                let options_inner_execution_inner = match options_inner_execution_inner_raw {
                    1u8 => RuntimeExecutionMode::Fast,
                    2u8 => RuntimeExecutionMode::Deterministic,
                    3u8 => RuntimeExecutionMode::Record,
                    4u8 => RuntimeExecutionMode::Replay,
                    _ => {
                        return Err(RuntimeError::from(PlatformError::invalid_argument_value(
            ...
            let options_inner_world = if slots[2].tag() == vm::ValueTag::Void {
                ...
                let options_inner_world_inner_raw =
                    decode_uint8(slots[2], "options_inner_world_inner_raw", "world")?;
                let options_inner_world_inner = match options_inner_world_inner_raw {
                    1u8 => RuntimeWorldKind::Host,
                    2u8 => RuntimeWorldKind::Simulation,
                    _ => {
                        return Err(RuntimeError::from(PlatformError::invalid_argument_value(
...
fn decode_destack_runtime_snapshot_create_args(
    ...
    let format = match format_raw {
        1u8 => SnapshotFormat::Fast,
        2u8 => SnapshotFormat::Portable,
        _ => {
            return Err(RuntimeError::from(PlatformError::invalid_argument_value(
                "format",
