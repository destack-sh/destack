...
macro_rules! define_backend_midi_resource_inserters {
    (
        ...
        $vis fn $input_fn(
            ...
            crate::platform::midi::core::insert_backend_midi_input_resource(
                binding,
                $backend,
        ...
        $vis fn $output_fn(
            ...
            crate::platform::midi::core::insert_backend_midi_output_resource(
                binding,
                $backend,
        ...
        $vis fn $event_fn(
            ...
            crate::platform::midi::core::insert_backend_midi_event_resource(
                binding,
                $backend,
...
macro_rules! define_backend_midi_resource_accessors {
    (
        ...
        $vis fn $input_fn(
            ...
            crate::platform::midi::core::read_backend_midi_input_resource_arc(
                binding,
                handle.0,
                $backend,
                operation,
        ...
        $vis fn $output_fn(
            ...
            crate::platform::midi::core::read_backend_midi_output_resource_arc(
                binding,
                handle.0,
                $backend,
                operation,
        ...
        $vis fn $event_fn(
            ...
            crate::platform::midi::core::read_backend_midi_event_resource_arc(
                binding,
                handle.0,
                $backend,
                operation,
