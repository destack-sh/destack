...
pub(crate) fn midi_output_port_list(
    ...
    list_output_descriptors(binding, options.flags, "destack.midi.output.port.list")
}
...
pub(crate) fn midi_output_write(
    ...
    let description = binding
        ...
        .platform_state
        .midi
        .describe_android_backend(binding, "destack.midi.output.write")?;
...
pub(crate) fn midi_output_virtual_create(
    ...
    validate_record_shape("destack.midi.output.virtual.create", data_format, protocol)?;
