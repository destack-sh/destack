...
use crate::platform::midi::{MidiBackend, MidiBackendSelectionPolicy};
...
fn android_backend_support(binding: &BindingCallContext) -> BackendSupport {
    let description = binding
        ...
        .platform_state
        .midi
        .describe_android_backend(binding, "destack.midi.backend.support");
...
fn backend_description(binding: &BindingCallContext) -> Option<AndroidBackendDescription> {
    binding
        ...
        .platform_state
        .midi
        .describe_android_backend(binding, "destack.midi.backend.list")
        .ok()
}
