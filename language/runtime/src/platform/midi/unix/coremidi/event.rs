...
use super::core::{
    BoundedQueue, CoreMidiEventDeliveryKind, CoreMidiEventSession, SnapshotKey,
...
use super::service::{
    CoreMidiNativeEventRegistry, CoreMidiService, core_midi_service, register_native_event_session,
...
pub(super) fn refresh_native_event_sessions(
    ...
    let Ok(service) = core_midi_service("destack.midi.event.refresh") else {
        return;
    };
...
pub(crate) fn midi_event_open(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .core_midi_service("destack.midi.event.open")?;
...
pub(crate) fn midi_event_read(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .core_midi_service("destack.midi.event.read")?;
...
pub(crate) fn midi_event_read_batch(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .core_midi_service("destack.midi.event.readBatch")?;
...
pub(crate) fn midi_event_try_read(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .core_midi_service("destack.midi.event.tryRead")?;
...
pub(crate) fn midi_event_try_read_batch(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .core_midi_service("destack.midi.event.tryReadBatch")?;
