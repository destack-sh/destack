...
use crate::platform::midi::{MIDI_DATA_FORMAT_FLAG_UMP, MIDI_PROTOCOL_FLAG_MIDI2, MidiProtocol};
...
fn test_midi_input_port_list_returns_stable_ids_when_available_or_expected_error() {
    with_harness_context(|mut context| {
        ...
        let input_result = assert_ok_or_expected_error(
            context.destack_midi_input_port_list(options),
...
fn test_midi_missing_input_endpoints_and_handles_fail_with_expected_errors() {
    with_harness_context(|mut context| {
        ...
        assert_platform_error_codes(
            context.destack_midi_input_port_open(missing_input_id, input_options),
            &[
                PlatformErrorCode::NotSupported,
        ...
        // handle failures
        assert_platform_error_codes(
            context.destack_midi_input_port_close(missing_input_handle),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_input_port_descriptor(missing_input_handle),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_input_read(missing_input_handle, 0),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_input_read_batch(missing_input_handle, 1, 0),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_input_try_read(missing_input_handle),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_input_try_read_batch(missing_input_handle, 1),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
