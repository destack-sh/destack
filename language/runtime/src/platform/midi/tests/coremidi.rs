...
use crate::platform::midi::{
    ...
    MidiEventSource, MidiOutputRecord, MidiPortDirection, MidiProtocol, MidiRecordFraming,
};
...
/// Advertise the real CoreMIDI capability surface on macOS.
#[test]
fn test_midi_coremidi_backend_row_advertises_real_host_capabilities() {
