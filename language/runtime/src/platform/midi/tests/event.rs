use super::{
    ...
    decode_event, harness_event_open_options, harness_event_open_options_for_backend,
...
fn test_midi_missing_event_handles_fail_with_expected_errors() {
    with_harness_context(|mut context| {
        ...
        assert_platform_error_codes(
            context.destack_midi_event_close(missing_event_handle),
            &[
                PlatformErrorCode::NotSupported,
        ...
        assert_platform_error_codes(
            context.destack_midi_event_read(missing_event_handle, 0),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_event_read_batch(missing_event_handle, 1, 0),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_event_try_read(missing_event_handle),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
        ...
        assert_platform_error_codes(
            context.destack_midi_event_try_read_batch(missing_event_handle, 1),
            &[
                PlatformErrorCode::NotSupported,
                PlatformErrorCode::IoNotFound,
                PlatformErrorCode::InvalidArgument,
