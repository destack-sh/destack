...
impl<'call> MidiHarnessContext<'call> {
    ...
    > {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_backend_list(self.call_context, context)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let mut out = std::mem::MaybeUninit::<NativeSlice<MidiBackendDescriptor>>::uninit();
                unsafe {
                    midi_native::destack_midi_backend_list(self.call_context, out.as_mut_ptr())?;
                }
    ...
    pub(crate) fn destack_midi_event_close(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => midi_vm::destack_midi_event_close(self.call_context, context, handle),
            None => unsafe { midi_native::destack_midi_event_close(self.call_context, handle) },
        }
    }
    ...
    pub(crate) fn destack_midi_event_open(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                ...
                let out = midi_vm::destack_midi_event_open(self.call_context, context, options)?;
                Ok(out)
            }
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_event_open(
                        self.call_context,
                        out.as_mut_ptr(),
                        options,
                    )?;
    ...
    pub(crate) fn destack_midi_event_read(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_event_read(
                    self.call_context,
                    context,
                    handle,
                    timeoutns,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_event_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        timeoutns,
    ...
    pub(crate) fn destack_midi_event_read_batch(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_event_read_batch(
                    self.call_context,
                    context,
                    handle,
                    maxevents,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_event_read_batch(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxevents,
    ...
    pub(crate) fn destack_midi_event_try_read(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_event_try_read(self.call_context, context, handle)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let mut out = std::mem::MaybeUninit::<MidiEvent>::uninit();
                unsafe {
                    midi_native::destack_midi_event_try_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                    )?;
    ...
    pub(crate) fn destack_midi_event_try_read_batch(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_event_try_read_batch(
                    self.call_context,
                    context,
                    handle,
                    maxevents,
            ...
            None => {
                let mut out = std::mem::MaybeUninit::<NativeSlice<MidiEvent>>::uninit();
                unsafe {
                    midi_native::destack_midi_event_try_read_batch(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxevents,
    ...
    pub(crate) fn destack_midi_input_port_close(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                midi_vm::destack_midi_input_port_close(self.call_context, context, handle)
            }
            None => unsafe {
                midi_native::destack_midi_input_port_close(self.call_context, handle)
            },
        }
    }
    ...
    pub(crate) fn destack_midi_input_port_descriptor(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_input_port_descriptor(
                    self.call_context,
                    context,
                    handle,
                )?;
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_input_port_descriptor(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                    )?;
    ...
    ) -> RuntimeResult<HarnessValue<NativeSlice<MidiPortDescriptor>, VmSlice<MidiPortDescriptorVm>>>
    {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let options = options.into_vm("options")?;
                let out =
                    midi_vm::destack_midi_input_port_list(self.call_context, context, options)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let options = options.into_native("options")?;
                ...
                unsafe {
                    midi_native::destack_midi_input_port_list(
                        self.call_context,
                        out.as_mut_ptr(),
                        options,
                    )?;
    ...
    pub(crate) fn destack_midi_input_port_open(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                ...
                let options = options.into_vm("options")?;
                let out =
                    midi_vm::destack_midi_input_port_open(self.call_context, context, id, options)?;
                Ok(out)
            }
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_input_port_open(
                        self.call_context,
                        out.as_mut_ptr(),
                        id,
                        options,
    ...
    pub(crate) fn destack_midi_input_read(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_input_read(
                    self.call_context,
                    context,
                    handle,
                    timeoutns,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_input_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        timeoutns,
    ...
    pub(crate) fn destack_midi_input_read_batch(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_input_read_batch(
                    self.call_context,
                    context,
                    handle,
                    maxrecords,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_input_read_batch(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxrecords,
    ...
    pub(crate) fn destack_midi_input_try_read(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_input_try_read(self.call_context, context, handle)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let mut out = std::mem::MaybeUninit::<MidiInputRecord>::uninit();
                unsafe {
                    midi_native::destack_midi_input_try_read(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                    )?;
    ...
    pub(crate) fn destack_midi_input_try_read_batch(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_input_try_read_batch(
                    self.call_context,
                    context,
                    handle,
                    maxrecords,
            ...
            None => {
                let mut out = std::mem::MaybeUninit::<NativeArray<MidiInputRecord>>::uninit();
                unsafe {
                    midi_native::destack_midi_input_try_read_batch(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        maxrecords,
    ...
    pub(crate) fn destack_midi_input_virtual_create(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let options = options.into_vm("options")?;
                let out = midi_vm::destack_midi_input_virtual_create(
                    self.call_context,
                    context,
                    options,
                )?;
            ...
            None => {
                ...
                let mut out = std::mem::MaybeUninit::<resource::MidiInputPortHandle>::uninit();
                unsafe {
                    midi_native::destack_midi_input_virtual_create(
                        self.call_context,
                        out.as_mut_ptr(),
                        options,
                    )?;
    ...
    pub(crate) fn destack_midi_output_port_close(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                midi_vm::destack_midi_output_port_close(self.call_context, context, handle)
            }
            None => unsafe {
                midi_native::destack_midi_output_port_close(self.call_context, handle)
            },
        }
    }
    ...
    pub(crate) fn destack_midi_output_port_descriptor(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let out = midi_vm::destack_midi_output_port_descriptor(
                    self.call_context,
                    context,
                    handle,
                )?;
            ...
            None => {
                let mut out = std::mem::MaybeUninit::<MidiPortDescriptor>::uninit();
                unsafe {
                    midi_native::destack_midi_output_port_descriptor(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                    )?;
    ...
    ) -> RuntimeResult<HarnessValue<NativeSlice<MidiPortDescriptor>, VmSlice<MidiPortDescriptorVm>>>
    {
        match self.generated_vm_context_mut() {
            Some(context) => {
                let options = options.into_vm("options")?;
                let out =
                    midi_vm::destack_midi_output_port_list(self.call_context, context, options)?;
                Ok(HarnessValue::Vm(out))
            }
            None => {
                let options = options.into_native("options")?;
                let mut out = std::mem::MaybeUninit::<NativeSlice<MidiPortDescriptor>>::uninit();
                unsafe {
                    midi_native::destack_midi_output_port_list(
                        self.call_context,
                        out.as_mut_ptr(),
                        options,
                    )?;
    ...
    pub(crate) fn destack_midi_output_port_open(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let id = id.into_vm("id")?;
                let options = options.into_vm("options")?;
                let out = midi_vm::destack_midi_output_port_open(
                    self.call_context,
                    context,
                    id,
                    options,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_output_port_open(
                        self.call_context,
                        out.as_mut_ptr(),
                        id,
                        options,
    ...
    pub(crate) fn destack_midi_output_virtual_create(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                let options = options.into_vm("options")?;
                let out = midi_vm::destack_midi_output_virtual_create(
                    self.call_context,
                    context,
                    options,
                )?;
            ...
            None => {
                ...
                let mut out = std::mem::MaybeUninit::<resource::MidiOutputPortHandle>::uninit();
                unsafe {
                    midi_native::destack_midi_output_virtual_create(
                        self.call_context,
                        out.as_mut_ptr(),
                        options,
                    )?;
    ...
    pub(crate) fn destack_midi_output_write(
        ...
        match self.generated_vm_context_mut() {
            Some(context) => {
                ...
                let out = midi_vm::destack_midi_output_write(
                    self.call_context,
                    context,
                    handle,
                    records,
            ...
            None => {
                ...
                unsafe {
                    midi_native::destack_midi_output_write(
                        self.call_context,
                        out.as_mut_ptr(),
                        handle,
                        records,
