...
use crate::platform::midi::{MidiBackend, MidiBackendCapabilityFlags, MidiBackendCapabilityFlagsVm, MidiBackendDescriptor, MidiBackendDescriptorVm, MidiBackendDisconnectedEvent, MidiBackendDisconnectedEventVm, MidiBackendDisconnectedPayload, MidiBackendDisconnectedPayloadVm, MidiBackendSelectionPolicy, MidiDataFormat, MidiDataFormatFlags, MidiDataFormatFlagsVm, MidiEvent, MidiEventDeliveryMode, MidiEventMetadata, MidiEventMetadataVm, MidiEventOverflowPolicy, MidiEventSource, MidiEventSubscriptionFlags, MidiEventSubscriptionOptions, MidiEventSubscriptionOptionsVm, MidiEventVm, MidiInputPortOpenOptions, MidiInputPortOpenOptionsVm, MidiInputRecord, MidiInputRecordVm, MidiOutputPortOpenOptions, MidiOutputPortOpenOptionsVm, MidiOutputRecord, MidiOutputRecordVm, MidiPortAddedEvent, MidiPortAddedEventVm, MidiPortAddedPayload, MidiPortAddedPayloadVm, MidiPortChangedEvent, MidiPortChangedEventVm, MidiPortChangedPayload, MidiPortChangedPayloadVm, MidiPortDescriptor, MidiPortDescriptorVm, MidiPortDirection, MidiPortDirectionFlags, MidiPortListFlags, MidiPortListOptions, MidiPortListOptionsVm, MidiPortRemovedEvent, MidiPortRemovedEventVm, MidiPortRemovedPayload, MidiPortRemovedPayloadVm, MidiProtocol, MidiProtocolFlags, MidiProtocolFlagsVm, MidiRecordFraming, MidiVirtualInputCreateOptions, MidiVirtualInputCreateOptionsVm, MidiVirtualOutputCreateOptions, MidiVirtualOutputCreateOptionsVm, MidibackenddescriptorReplayRecord, MidibackenddisconnectedeventReplayRecord, MidieventReplayRecord, MidiinputrecordReplayRecord, MidiportaddedeventReplayRecord, MidiportaddedpayloadReplayRecord, MidiportchangedeventReplayRecord, MidiportchangedpayloadReplayRecord, MidiportdescriptorReplayRecord, MidiportremovedeventReplayRecord, MidiportremovedpayloadReplayRecord};
...
fn decode_destack_midi_event_open_args(
    ...
    let options = {
        ...
        let options_backend = match options_backend_raw { 0u8 => MidiBackend::Auto, 1u8 => MidiBackend::AlsaSequencer, 2u8 => MidiBackend::JackMidi, 3u8 => MidiBackend::CoreMIDI, 4u8 => MidiBackend::WinMM, 5u8 => MidiBackend::WinRT, 255u8 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend", "unknown MidiBackend value")).boxed()), };
        let options_backend_policy_raw = decode_uint8(slots[1], "options_backend_policy_raw", "backendPolicy")?;
        let options_backend_policy = match options_backend_policy_raw { 1u8 => MidiBackendSelectionPolicy::Strict, 2u8 => MidiBackendSelectionPolicy::AllowFallback , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend_policy", "unknown MidiBackendSelectionPolicy value")).boxed()), };
        ...
        let options_delivery_mode_raw = decode_uint8(slots[4], "options_delivery_mode_raw", "deliveryMode")?;
        let options_delivery_mode = match options_delivery_mode_raw { 1u8 => MidiEventDeliveryMode::Auto, 2u8 => MidiEventDeliveryMode::NativeOnly, 3u8 => MidiEventDeliveryMode::PollOnly , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_delivery_mode", "unknown MidiEventDeliveryMode value")).boxed()), };
        let options_overflow_policy_raw = decode_uint8(slots[5], "options_overflow_policy_raw", "overflowPolicy")?;
        let options_overflow_policy = match options_overflow_policy_raw { 1u8 => MidiEventOverflowPolicy::DropOldest, 2u8 => MidiEventOverflowPolicy::DropNewest, 3u8 => MidiEventOverflowPolicy::Error , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_overflow_policy", "unknown MidiEventOverflowPolicy value")).boxed()), };
...
fn encode_destack_midi_event_read_result(
    ...
    result.map(|value| match value { MidiEventVm::MidiBackendDisconnectedEvent(value) => { let tag_value = vm::Value::uint(4143034202u64, 32); let payload_value = { let field_0 = value.kind.value(); let field_1 = { let field_0 = vm::Value::uint(value.metadata.timestamp_ns, 64); let field_1 = vm::Value::uint(value.metadata.sequence, 64); let field_2 = vm::Value::uint(value.metadata.dropped_count, 64); let field_3 = vm::Value::uint(value.metadata.source as u8 as u64, 8); let field_4 = vm::Value::uint(value.metadata.backend as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) }; let field_2 = { let field_0 = vm::Value::uint(value.payload.flags as u64, 32); context.allocate_aggregate(vec![field_0]) }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, MidiEventVm::MidiPortAddedEvent(value) => { let tag_value = vm::Value::uint(639313437u64, 32); let payload_value = { let field_0 = value.kind.value(); let field_1 = { let field_0 = vm::Value::uint(value.metadata.timestamp_ns, 64); let field_1 = vm::Value::uint(value.metadata.sequence, 64); let field_2 = vm::Value::uint(value.metadata.dropped_count, 64); let field_3 = vm::Value::uint(value.metadata.source as u8 as u64, 8); let field_4 = vm::Value::uint(value.metadata.backend as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) }; let field_2 = { let field_0 = vm::Value::uint(value.payload.direction as u8 as u64, 8); let field_1 = { let field_0 = vm::Value::uint(value.payload.descriptor.backend as u8 as u64, 8); let field_1 = value.payload.descriptor.id.value(); let field_2 = match value.payload.descriptor.group_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_3 = match value.payload.descriptor.backend_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_4 = value.payload.descriptor.name.value(); let field_5 = match value.payload.descriptor.group_name { Some(value) => value.value(), None => vm::Value::VOID }; let field_6 = match value.payload.descriptor.manufacturer { Some(value) => value.value(), None => vm::Value::VOID }; let field_7 = match value.payload.descriptor.model { Some(value) => value.value(), None => vm::Value::VOID }; let field_8 = match value.payload.descriptor.version { Some(value) => value.value(), None => vm::Value::VOID }; let field_9 = vm::Value::uint(value.payload.descriptor.supported_data_formats.0 as u64, 32); let field_10 = match value.payload.descriptor.default_data_format { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_11 = vm::Value::uint(value.payload.descriptor.supported_protocols.0 as u64, 32); let field_12 = match value.payload.descriptor.default_protocol { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_13 = vm::Value::bool(value.payload.descriptor.is_virtual); let field_14 = vm::Value::bool(value.payload.descriptor.is_connected); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13, field_14]) }; context.allocate_aggregate(vec![field_0, field_1]) }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, MidiEventVm::MidiPortChangedEvent(value) => { let tag_value = vm::Value::uint(2166240247u64, 32); let payload_value = { let field_0 = value.kind.value(); let field_1 = { let field_0 = vm::Value::uint(value.metadata.timestamp_ns, 64); let field_1 = vm::Value::uint(value.metadata.sequence, 64); let field_2 = vm::Value::uint(value.metadata.dropped_count, 64); let field_3 = vm::Value::uint(value.metadata.source as u8 as u64, 8); let field_4 = vm::Value::uint(value.metadata.backend as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) }; let field_2 = { let field_0 = vm::Value::uint(value.payload.direction as u8 as u64, 8); let field_1 = { let field_0 = vm::Value::uint(value.payload.descriptor.backend as u8 as u64, 8); let field_1 = value.payload.descriptor.id.value(); let field_2 = match value.payload.descriptor.group_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_3 = match value.payload.descriptor.backend_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_4 = value.payload.descriptor.name.value(); let field_5 = match value.payload.descriptor.group_name { Some(value) => value.value(), None => vm::Value::VOID }; let field_6 = match value.payload.descriptor.manufacturer { Some(value) => value.value(), None => vm::Value::VOID }; let field_7 = match value.payload.descriptor.model { Some(value) => value.value(), None => vm::Value::VOID }; let field_8 = match value.payload.descriptor.version { Some(value) => value.value(), None => vm::Value::VOID }; let field_9 = vm::Value::uint(value.payload.descriptor.supported_data_formats.0 as u64, 32); let field_10 = match value.payload.descriptor.default_data_format { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_11 = vm::Value::uint(value.payload.descriptor.supported_protocols.0 as u64, 32); let field_12 = match value.payload.descriptor.default_protocol { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_13 = vm::Value::bool(value.payload.descriptor.is_virtual); let field_14 = vm::Value::bool(value.payload.descriptor.is_connected); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13, field_14]) }; context.allocate_aggregate(vec![field_0, field_1]) }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![tag_value, payload_value]) }, MidiEventVm::MidiPortRemovedEvent(value) => { let tag_value = vm::Value::uint(1791639446u64, 32); let payload_value = { let field_0 = value.kind.value(); let field_1 = { let field_0 = vm::Value::uint(value.metadata.timestamp_ns, 64); let field_1 = vm::Value::uint(value.metadata.sequence, 64); let field_2 = vm::Value::uint(value.metadata.dropped_count, 64); let field_3 = vm::Value::uint(value.metadata.source as u8 as u64, 8); let field_4 = vm::Value::uint(value.metadata.backend as u8 as u64, 8); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4]) }; let field_2 = { let field_0 = vm::Value::uint(value.payload.direction as u8 as u64, 8); let field_1 = value.payload.id.value(); let field_2 = match value.payload.group_id { Some(value) => value.value(), None => vm::Value::VOID }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![field_0, field_1, field_2]) }; context.allocate_aggregate(vec![tag_value, payload_value]) } })
}
...
fn encode_destack_midi_input_port_descriptor_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.backend as u8 as u64, 8); let field_1 = value.id.value(); let field_2 = match value.group_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_3 = match value.backend_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_4 = value.name.value(); let field_5 = match value.group_name { Some(value) => value.value(), None => vm::Value::VOID }; let field_6 = match value.manufacturer { Some(value) => value.value(), None => vm::Value::VOID }; let field_7 = match value.model { Some(value) => value.value(), None => vm::Value::VOID }; let field_8 = match value.version { Some(value) => value.value(), None => vm::Value::VOID }; let field_9 = vm::Value::uint(value.supported_data_formats.0 as u64, 32); let field_10 = match value.default_data_format { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_11 = vm::Value::uint(value.supported_protocols.0 as u64, 32); let field_12 = match value.default_protocol { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_13 = vm::Value::bool(value.is_virtual); let field_14 = vm::Value::bool(value.is_connected); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5, field_6, field_7, field_8, field_9, field_10, field_11, field_12, field_13, field_14]) })
}
...
fn decode_destack_midi_input_port_open_args(
    ...
    let options = {
        ...
        let options_data_format = if slots[2].tag() == vm::ValueTag::Void {
            ...
            let options_data_format_inner_raw = decode_uint8(slots[2], "options_data_format_inner_raw", "dataFormat")?;
            let options_data_format_inner = match options_data_format_inner_raw { 1u8 => MidiDataFormat::Midi1Bytes, 2u8 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_data_format_inner", "unknown MidiDataFormat value")).boxed()), };
            Some(options_data_format_inner)
        };
        let options_protocol = if slots[3].tag() == vm::ValueTag::Void {
            None
        } else {
            let options_protocol_inner_raw = decode_uint8(slots[3], "options_protocol_inner_raw", "protocol")?;
            let options_protocol_inner = match options_protocol_inner_raw { 1u8 => MidiProtocol::Midi1, 2u8 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_protocol_inner", "unknown MidiProtocol value")).boxed()), };
...
fn encode_destack_midi_input_read_result(
    ...
    result.map(|value| { let field_0 = vm::Value::uint(value.received_at_ns, 64); let field_1 = match value.source_id { Some(value) => value.value(), None => vm::Value::VOID }; let field_2 = vm::Value::uint(value.data_format as u8 as u64, 8); let field_3 = match value.protocol { Some(value) => vm::Value::uint(value as u8 as u64, 8), None => vm::Value::VOID }; let field_4 = vm::Value::uint(value.framing as u8 as u64, 8); let field_5 = value.data.to_value(context); context.allocate_aggregate(vec![field_0, field_1, field_2, field_3, field_4, field_5]) })
}
...
fn decode_destack_midi_input_virtual_create_args(
    ...
    let options = {
        ...
        let options_data_format_raw = decode_uint8(slots[6], "options_data_format_raw", "dataFormat")?;
        let options_data_format = match options_data_format_raw { 1u8 => MidiDataFormat::Midi1Bytes, 2u8 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_data_format", "unknown MidiDataFormat value")).boxed()), };
        let options_protocol_raw = decode_uint8(slots[7], "options_protocol_raw", "protocol")?;
        let options_protocol = match options_protocol_raw { 1u8 => MidiProtocol::Midi1, 2u8 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_protocol", "unknown MidiProtocol value")).boxed()), };
...
fn decode_destack_midi_output_write_args(
    ...
    let records = decode_array::<MidiOutputRecordVm>(context, records_value, "records", "MidiOutputRecord[]")?;
    Ok((handle, records))
}
...
pub const MIDI_BACKEND_LIST: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const MIDI_EVENT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const MIDI_EVENT_TRY_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const MIDI_INPUT_PORT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const MIDI_OUTPUT_FLUSH: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const MIDI_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    ...
    bindings: &[
        ...
        NativeBinding::new(MIDI_OUTPUT_FLUSH, "destack.midi.output.flush", destack_midi_output_flush as *const ()),
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? } {
                    ...
                    let result_recorded_item_recorded_capability_flags = result_recorded_item.capability_flags.0;
                    let result_recorded_item_recorded_supported_data_formats = result_recorded_item.supported_data_formats.0;
                    let result_recorded_item_recorded_supported_protocols = result_recorded_item.supported_protocols.0;
                    let result_recorded_item_recorded = MidiBackendDescriptorValue {
            ...
            if let Ok(()) = result {
                ...
                let result_recorded = match result_value {
                    MidiEvent::MidiBackendDisconnectedEvent(value) => {
                        ...
                        let result_recorded_midi_backend_disconnected_event = MidiBackendDisconnectedEventValue {
                        ...
                        MidiEventValue::MidiBackendDisconnectedEvent(result_recorded_midi_backend_disconnected_event)
                    }
                    MidiEvent::MidiPortAddedEvent(value) => {
                        ...
                        let result_recorded_midi_port_added_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats.0;
                        ...
                        let result_recorded_midi_port_added_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols.0;
                        ...
                        let result_recorded_midi_port_added_event_payload_descriptor = MidiPortDescriptorValue {
                        ...
                        let result_recorded_midi_port_added_event_payload = MidiPortAddedPayloadValue {
                        ...
                        let result_recorded_midi_port_added_event = MidiPortAddedEventValue {
                        ...
                        MidiEventValue::MidiPortAddedEvent(result_recorded_midi_port_added_event)
                    }
                    MidiEvent::MidiPortChangedEvent(value) => {
                        ...
                        let result_recorded_midi_port_changed_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats.0;
                        ...
                        let result_recorded_midi_port_changed_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols.0;
                        ...
                        let result_recorded_midi_port_changed_event_payload_descriptor = MidiPortDescriptorValue {
                        ...
                        let result_recorded_midi_port_changed_event_payload = MidiPortChangedPayloadValue {
                        ...
                        let result_recorded_midi_port_changed_event = MidiPortChangedEventValue {
                        ...
                        MidiEventValue::MidiPortChangedEvent(result_recorded_midi_port_changed_event)
                    }
                    MidiEvent::MidiPortRemovedEvent(value) => {
                        ...
                        let result_recorded_midi_port_removed_event_payload = MidiPortRemovedPayloadValue {
                        ...
                        let result_recorded_midi_port_removed_event = MidiPortRemovedEventValue {
                        ...
                        MidiEventValue::MidiPortRemovedEvent(result_recorded_midi_port_removed_event)
                    }
                };
            ...
            match payload.result {
                Ok(value) => {
                    let value_native = match value {
                        ...
                        MidiEventValue::MidiPortAddedEvent(value) => {
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_supported_data_formats = MidiDataFormatFlags(value.payload.descriptor.supported_data_formats);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_supported_protocols = MidiProtocolFlags(value.payload.descriptor.supported_protocols);
                        ...
                        MidiEventValue::MidiPortChangedEvent(value) => {
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_supported_data_formats = MidiDataFormatFlags(value.payload.descriptor.supported_data_formats);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_supported_protocols = MidiProtocolFlags(value.payload.descriptor.supported_protocols);
                        ...
                        MidiEventValue::MidiPortRemovedEvent(value) => {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? } {
                    let result_recorded_item_recorded = match result_recorded_item {
                        MidiEvent::MidiBackendDisconnectedEvent(value) => {
                            ...
                            let result_recorded_item_recorded_midi_backend_disconnected_event = MidiBackendDisconnectedEventValue {
                            ...
                            MidiEventValue::MidiBackendDisconnectedEvent(result_recorded_item_recorded_midi_backend_disconnected_event)
                        }
                        MidiEvent::MidiPortAddedEvent(value) => {
                            ...
                            let result_recorded_item_recorded_midi_port_added_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats.0;
                            ...
                            let result_recorded_item_recorded_midi_port_added_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols.0;
                            ...
                            let result_recorded_item_recorded_midi_port_added_event_payload_descriptor = MidiPortDescriptorValue {
                            ...
                            let result_recorded_item_recorded_midi_port_added_event_payload = MidiPortAddedPayloadValue {
                            ...
                            let result_recorded_item_recorded_midi_port_added_event = MidiPortAddedEventValue {
                            ...
                            MidiEventValue::MidiPortAddedEvent(result_recorded_item_recorded_midi_port_added_event)
                        }
                        MidiEvent::MidiPortChangedEvent(value) => {
                            ...
                            let result_recorded_item_recorded_midi_port_changed_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats.0;
                            ...
                            let result_recorded_item_recorded_midi_port_changed_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols.0;
                            ...
                            let result_recorded_item_recorded_midi_port_changed_event_payload_descriptor = MidiPortDescriptorValue {
                            ...
                            let result_recorded_item_recorded_midi_port_changed_event_payload = MidiPortChangedPayloadValue {
                            ...
                            let result_recorded_item_recorded_midi_port_changed_event = MidiPortChangedEventValue {
                            ...
                            MidiEventValue::MidiPortChangedEvent(result_recorded_item_recorded_midi_port_changed_event)
                        }
                        MidiEvent::MidiPortRemovedEvent(value) => {
                            ...
                            let result_recorded_item_recorded_midi_port_removed_event_payload = MidiPortRemovedPayloadValue {
                            ...
                            let result_recorded_item_recorded_midi_port_removed_event = MidiPortRemovedEventValue {
                            ...
                            MidiEventValue::MidiPortRemovedEvent(result_recorded_item_recorded_midi_port_removed_event)
                        }
                    };
                    result_recorded.push(result_recorded_item_recorded);
                }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded_supported_data_formats = result_value.supported_data_formats.0;
                ...
                let result_recorded_supported_protocols = result_value.supported_protocols.0;
                ...
                let result_recorded = MidiPortDescriptorValue {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_supported_data_formats = MidiDataFormatFlags(value.supported_data_formats);
                    ...
                    let value_native_supported_protocols = MidiProtocolFlags(value.supported_protocols);
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? } {
                    ...
                    let result_recorded_item_recorded = MidiPortDescriptorValue {
                        backend: result_recorded_item_recorded_backend,
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = MidiInputRecordValue {
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_data_item in value.data.iter() {
                        let value_native_data_decoded = value_native_data_item;
                        value_native_data_values.push(value_native_data_decoded);
                    }
                    let value_native_data = binding.store_array(value_native_data_values);
        ...
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? } {
                    ...
                    for result_recorded_item_recorded_data_item in unsafe { result_recorded_item.data.as_slice()? } {
                    ...
                    let result_recorded_item_recorded = MidiInputRecordValue {
...
fn destack_midi_output_flush_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_flush(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_flush(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
pub unsafe extern "C" fn destack_midi_output_flush(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_FLUSH)?;
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_backend_raw = decode_uint8(slots[0], "result_recorded_item_backend_raw", "backend")?;
                        let result_recorded_item_backend = match result_recorded_item_backend_raw { 0u8 => MidiBackend::Auto, 1u8 => MidiBackend::AlsaSequencer, 2u8 => MidiBackend::JackMidi, 3u8 => MidiBackend::CoreMIDI, 4u8 => MidiBackend::WinMM, 5u8 => MidiBackend::WinRT, 255u8 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_backend", "unknown MidiBackend value")).boxed()), };
                        let result_recorded_item_name = decode_string(slots[1], "result_recorded_item_name", "name")?;
                        let result_recorded_item_support_raw = decode_uint8(slots[2], "result_recorded_item_support_raw", "support")?;
                        let result_recorded_item_support = match result_recorded_item_support_raw { 0u8 => core::BackendSupport::Available, 1u8 => core::BackendSupport::UnsupportedTarget, 2u8 => core::BackendSupport::DisabledByBuild, 3u8 => core::BackendSupport::HostUnavailable , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_support", "unknown core::BackendSupport value")).boxed()), };
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_group_id = if let Some(value) = value.group_id {
                        ...
                        let vm_result_group_id_inner = vm::StringHandle::new(vm_result_group_id_inner_value);
                        Some(vm_result_group_id_inner)
                    } else {
                        None
                    };
                    let vm_result_backend_id = if let Some(value) = value.backend_id {
                        let vm_result_backend_id_inner_value = context.intern_string(value.as_str());
                        let vm_result_backend_id_inner = vm::StringHandle::new(vm_result_backend_id_inner_value);
                    ...
                    let vm_result_group_name = if let Some(value) = value.group_name {
                        let vm_result_group_name_inner_value = context.intern_string(value.as_str());
                        let vm_result_group_name_inner = vm::StringHandle::new(vm_result_group_name_inner_value);
                        Some(vm_result_group_name_inner)
                    } else {
                        None
                    };
                    let vm_result_manufacturer = if let Some(value) = value.manufacturer {
                        let vm_result_manufacturer_inner_value = context.intern_string(value.as_str());
                        let vm_result_manufacturer_inner = vm::StringHandle::new(vm_result_manufacturer_inner_value);
                    ...
                    let vm_result_model = if let Some(value) = value.model {
                        ...
                        let vm_result_model_inner = vm::StringHandle::new(vm_result_model_inner_value);
                    ...
                    let vm_result_version = if let Some(value) = value.version {
                        ...
                        let vm_result_version_inner = vm::StringHandle::new(vm_result_version_inner_value);
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_default_data_format = if slots[10].tag() == vm::ValueTag::Void {
                            ...
                            let result_recorded_item_default_data_format_inner_raw = decode_uint8(slots[10], "result_recorded_item_default_data_format_inner_raw", "defaultDataFormat")?;
                            let result_recorded_item_default_data_format_inner = match result_recorded_item_default_data_format_inner_raw { 1u8 => MidiDataFormat::Midi1Bytes, 2u8 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_default_data_format_inner", "unknown MidiDataFormat value")).boxed()), };
                        ...
                        let result_recorded_item_default_protocol = if slots[12].tag() == vm::ValueTag::Void {
                            ...
                            let result_recorded_item_default_protocol_inner_raw = decode_uint8(slots[12], "result_recorded_item_default_protocol_inner_raw", "defaultProtocol")?;
                            let result_recorded_item_default_protocol_inner = match result_recorded_item_default_protocol_inner_raw { 1u8 => MidiProtocol::Midi1, 2u8 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_default_protocol_inner", "unknown MidiProtocol value")).boxed()), };
                ...
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_group_id = if let Some(value) = vm_result_item.group_id {
                            let vm_result_item_value_group_id_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_group_id_inner = vm::StringHandle::new(vm_result_item_value_group_id_inner_value);
                            Some(vm_result_item_value_group_id_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_backend_id = if let Some(value) = vm_result_item.backend_id {
                            let vm_result_item_value_backend_id_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_backend_id_inner = vm::StringHandle::new(vm_result_item_value_backend_id_inner_value);
                        ...
                        let vm_result_item_value_group_name = if let Some(value) = vm_result_item.group_name {
                            let vm_result_item_value_group_name_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_group_name_inner = vm::StringHandle::new(vm_result_item_value_group_name_inner_value);
                        ...
                        let vm_result_item_value_manufacturer = if let Some(value) = vm_result_item.manufacturer {
                            let vm_result_item_value_manufacturer_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_manufacturer_inner = vm::StringHandle::new(vm_result_item_value_manufacturer_inner_value);
                            Some(vm_result_item_value_manufacturer_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_model = if let Some(value) = vm_result_item.model {
                            let vm_result_item_value_model_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_model_inner = vm::StringHandle::new(vm_result_item_value_model_inner_value);
                            Some(vm_result_item_value_model_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_version = if let Some(value) = vm_result_item.version {
                            let vm_result_item_value_version_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_version_inner = vm::StringHandle::new(vm_result_item_value_version_inner_value);
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_source_id = if let Some(value) = value.source_id {
                        ...
                        let vm_result_source_id_inner = vm::StringHandle::new(vm_result_source_id_inner_value);
            ...
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_data_format_raw = decode_uint8(slots[2], "result_recorded_item_data_format_raw", "dataFormat")?;
                        let result_recorded_item_data_format = match result_recorded_item_data_format_raw { 1u8 => MidiDataFormat::Midi1Bytes, 2u8 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_data_format", "unknown MidiDataFormat value")).boxed()), };
                        let result_recorded_item_protocol = if slots[3].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_protocol_inner_raw = decode_uint8(slots[3], "result_recorded_item_protocol_inner_raw", "protocol")?;
                            let result_recorded_item_protocol_inner = match result_recorded_item_protocol_inner_raw { 1u8 => MidiProtocol::Midi1, 2u8 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_protocol_inner", "unknown MidiProtocol value")).boxed()), };
                            Some(result_recorded_item_protocol_inner)
                        };
                        let result_recorded_item_framing_raw = decode_uint8(slots[4], "result_recorded_item_framing_raw", "framing")?;
                        let result_recorded_item_framing = match result_recorded_item_framing_raw { 1u8 => MidiRecordFraming::Complete, 2u8 => MidiRecordFraming::Start, 3u8 => MidiRecordFraming::Continue, 4u8 => MidiRecordFraming::End , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_framing", "unknown MidiRecordFraming value")).boxed()), };
                ...
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_source_id = if let Some(value) = vm_result_item.source_id {
                            let vm_result_item_value_source_id_inner_value = context.intern_string(value.as_str());
                            let vm_result_item_value_source_id_inner = vm::StringHandle::new(vm_result_item_value_source_id_inner_value);
                        ...
                        let vm_result_item_value_data = VmSlice::<u8>::from_bytes(context, &vm_result_item.data);
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_flush(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
pub fn register_midi_vm_bindings(
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_FLUSH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_output_flush_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_FLUSH)?;
...
pub fn install_midi_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
