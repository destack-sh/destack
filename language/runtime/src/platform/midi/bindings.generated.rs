...
use crate::platform::midi::{MidiBackend, MidiBackendCapabilityFlags, MidiBackendDescriptor, MidiBackendDescriptorValue, MidiBackendDescriptorVm, MidiBackendDisconnectedEvent, MidiBackendDisconnectedEventValue, MidiBackendDisconnectedEventVm, MidiBackendDisconnectedPayload, MidiBackendDisconnectedPayloadVm, MidiBackendSelectionPolicy, MidiDataFormat, MidiDataFormatFlags, MidiEvent, MidiEventDeliveryMode, MidiEventMetadata, MidiEventMetadataVm, MidiEventOverflowPolicy, MidiEventSource, MidiEventSubscriptionFlags, MidiEventSubscriptionOptions, MidiEventSubscriptionOptionsVm, MidiEventValue, MidiEventVm, MidiInputPortOpenOptions, MidiInputPortOpenOptionsVm, MidiInputRecord, MidiInputRecordValue, MidiInputRecordVm, MidiOutputPortOpenOptions, MidiOutputPortOpenOptionsVm, MidiOutputRecord, MidiOutputRecordVm, MidiPortAddedEvent, MidiPortAddedEventValue, MidiPortAddedEventVm, MidiPortAddedPayload, MidiPortAddedPayloadValue, MidiPortAddedPayloadVm, MidiPortChangedEvent, MidiPortChangedEventValue, MidiPortChangedEventVm, MidiPortChangedPayload, MidiPortChangedPayloadValue, MidiPortChangedPayloadVm, MidiPortDescriptor, MidiPortDescriptorValue, MidiPortDescriptorVm, MidiPortDirection, MidiPortDirectionFlags, MidiPortListFlags, MidiPortListOptions, MidiPortListOptionsVm, MidiPortRemovedEvent, MidiPortRemovedEventValue, MidiPortRemovedEventVm, MidiPortRemovedPayload, MidiPortRemovedPayloadValue, MidiPortRemovedPayloadVm, MidiProtocol, MidiProtocolFlags, MidiRecordFraming, MidiVirtualInputCreateOptions, MidiVirtualInputCreateOptionsVm, MidiVirtualOutputCreateOptions, MidiVirtualOutputCreateOptionsVm, MidibackenddescriptorReplayRecord, MidibackenddisconnectedeventReplayRecord, MidieventReplayRecord, MidiinputrecordReplayRecord, MidiportaddedeventReplayRecord, MidiportaddedpayloadReplayRecord, MidiportchangedeventReplayRecord, MidiportchangedpayloadReplayRecord, MidiportdescriptorReplayRecord, MidiportremovedeventReplayRecord, MidiportremovedpayloadReplayRecord};
...
use crate::platform::midi::simulation::{native as platform_simulation_native, vm as platform_simulation_vm};
...
fn decode_destack_midi_event_open_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiEventSubscriptionOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 8 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options", "expected 8 fields")).boxed()); }
        let options_backend_raw = decode_int32(slots[0], "options_backend_raw", "backend")?;
        let options_backend = match options_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend", "unknown MidiBackend value")).boxed()), };
        let options_backend_policy_raw = decode_int32(slots[1], "options_backend_policy_raw", "backendPolicy")?;
        let options_backend_policy = match options_backend_policy_raw { 1i32 => MidiBackendSelectionPolicy::Strict, 2i32 => MidiBackendSelectionPolicy::AllowFallback , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend_policy", "unknown MidiBackendSelectionPolicy value")).boxed()), };
        ...
        let options_direction_mask_inner = decode_uint32(slots[3], "options_direction_mask_inner", "directionMask")?;
        let options_direction_mask = MidiPortDirectionFlags(options_direction_mask_inner);
        let options_delivery_mode_raw = decode_int32(slots[4], "options_delivery_mode_raw", "deliveryMode")?;
        let options_delivery_mode = match options_delivery_mode_raw { 1i32 => MidiEventDeliveryMode::Auto, 2i32 => MidiEventDeliveryMode::NativeOnly, 3i32 => MidiEventDeliveryMode::PollOnly , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_delivery_mode", "unknown MidiEventDeliveryMode value")).boxed()), };
        let options_overflow_policy_raw = decode_int32(slots[5], "options_overflow_policy_raw", "overflowPolicy")?;
        let options_overflow_policy = match options_overflow_policy_raw { 1i32 => MidiEventOverflowPolicy::DropOldest, 2i32 => MidiEventOverflowPolicy::DropNewest, 3i32 => MidiEventOverflowPolicy::Error , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_overflow_policy", "unknown MidiEventOverflowPolicy value")).boxed()), };
        let options_queue_capacity = decode_uint32(slots[6], "options_queue_capacity", "queueCapacity")?;
        let options_poll_interval_ns = decode_uint64(slots[7], "options_poll_interval_ns", "pollIntervalNs")?;
...
fn encode_destack_midi_event_read_result(
    ...
    result.and_then(|value| match value { MidiEventVm::MidiBackendDisconnectedEvent(value) => { let tag_value = vm::Value::uint(4143034202u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.dropped_count, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.source as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.backend as i32 as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.flags as u64, 32)); context.allocate_aggregate(vec![field_0?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, MidiEventVm::MidiPortAddedEvent(value) => { let tag_value = vm::Value::uint(639313437u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.dropped_count, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.source as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.backend as i32 as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.direction as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.descriptor.backend as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.payload.descriptor.id.value()); let field_2: RuntimeResult<vm::Value> = match value.payload.descriptor.group_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_3: RuntimeResult<vm::Value> = match value.payload.descriptor.backend_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_4: RuntimeResult<vm::Value> = Ok(value.payload.descriptor.name.value()); let field_5: RuntimeResult<vm::Value> = match value.payload.descriptor.group_name { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_6: RuntimeResult<vm::Value> = match value.payload.descriptor.manufacturer { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_7: RuntimeResult<vm::Value> = match value.payload.descriptor.model { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_8: RuntimeResult<vm::Value> = match value.payload.descriptor.version { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_9: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.descriptor.supported_data_formats.0 as u64, 32)); let field_10: RuntimeResult<vm::Value> = match value.payload.descriptor.default_data_format { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_11: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.descriptor.supported_protocols.0 as u64, 32)); let field_12: RuntimeResult<vm::Value> = match value.payload.descriptor.default_protocol { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_13: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.payload.descriptor.is_virtual)); let field_14: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.payload.descriptor.is_connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?, field_7?, field_8?, field_9?, field_10?, field_11?, field_12?, field_13?, field_14?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, MidiEventVm::MidiPortChangedEvent(value) => { let tag_value = vm::Value::uint(2166240247u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.dropped_count, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.source as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.backend as i32 as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.direction as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.descriptor.backend as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.payload.descriptor.id.value()); let field_2: RuntimeResult<vm::Value> = match value.payload.descriptor.group_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_3: RuntimeResult<vm::Value> = match value.payload.descriptor.backend_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_4: RuntimeResult<vm::Value> = Ok(value.payload.descriptor.name.value()); let field_5: RuntimeResult<vm::Value> = match value.payload.descriptor.group_name { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_6: RuntimeResult<vm::Value> = match value.payload.descriptor.manufacturer { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_7: RuntimeResult<vm::Value> = match value.payload.descriptor.model { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_8: RuntimeResult<vm::Value> = match value.payload.descriptor.version { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_9: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.descriptor.supported_data_formats.0 as u64, 32)); let field_10: RuntimeResult<vm::Value> = match value.payload.descriptor.default_data_format { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_11: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.payload.descriptor.supported_protocols.0 as u64, 32)); let field_12: RuntimeResult<vm::Value> = match value.payload.descriptor.default_protocol { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_13: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.payload.descriptor.is_virtual)); let field_14: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.payload.descriptor.is_connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?, field_7?, field_8?, field_9?, field_10?, field_11?, field_12?, field_13?, field_14?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) }, MidiEventVm::MidiPortRemovedEvent(value) => { let tag_value = vm::Value::uint(1791639446u64, 32); let payload_value = { let field_0: RuntimeResult<vm::Value> = Ok(value.kind.value()); let field_1: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.timestamp_ns, 64)); let field_1: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.sequence, 64)); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.metadata.dropped_count, 64)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.source as i32 as i64, 32)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.metadata.backend as i32 as i64, 32)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?]).map_err(Box::<RuntimeError>::from) }; let field_2: RuntimeResult<vm::Value> = { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.payload.direction as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.payload.id.value()); let field_2: RuntimeResult<vm::Value> = match value.payload.group_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }; context.allocate_aggregate(vec![field_0?, field_1?, field_2?]).map_err(Box::<RuntimeError>::from) }?; context.allocate_aggregate(vec![tag_value, payload_value]).map_err(Box::<RuntimeError>::from) } })
}
...
fn decode_destack_midi_input_port_close_args(
    ...
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "MidiInputPortHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
...
fn encode_destack_midi_input_port_descriptor_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.backend as i32 as i64, 32)); let field_1: RuntimeResult<vm::Value> = Ok(value.id.value()); let field_2: RuntimeResult<vm::Value> = match value.group_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_3: RuntimeResult<vm::Value> = match value.backend_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_4: RuntimeResult<vm::Value> = Ok(value.name.value()); let field_5: RuntimeResult<vm::Value> = match value.group_name { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_6: RuntimeResult<vm::Value> = match value.manufacturer { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_7: RuntimeResult<vm::Value> = match value.model { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_8: RuntimeResult<vm::Value> = match value.version { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_9: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.supported_data_formats.0 as u64, 32)); let field_10: RuntimeResult<vm::Value> = match value.default_data_format { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_11: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.supported_protocols.0 as u64, 32)); let field_12: RuntimeResult<vm::Value> = match value.default_protocol { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_13: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_virtual)); let field_14: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_connected)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?, field_7?, field_8?, field_9?, field_10?, field_11?, field_12?, field_13?, field_14?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_midi_input_port_list_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiPortListOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
...
fn decode_destack_midi_input_port_open_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiInputPortOpenOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 5 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options", "expected 5 fields")).boxed()); }
        let options_backend_raw = decode_int32(slots[0], "options_backend_raw", "backend")?;
        let options_backend = match options_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend", "unknown MidiBackend value")).boxed()), };
        let options_backend_policy_raw = decode_int32(slots[1], "options_backend_policy_raw", "backendPolicy")?;
        let options_backend_policy = match options_backend_policy_raw { 1i32 => MidiBackendSelectionPolicy::Strict, 2i32 => MidiBackendSelectionPolicy::AllowFallback , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend_policy", "unknown MidiBackendSelectionPolicy value")).boxed()), };
        let options_data_format = if slots[2].tag() == vm::ValueTag::Void {
            ...
            let options_data_format_inner_raw = decode_int32(slots[2], "options_data_format_inner_raw", "dataFormat")?;
            let options_data_format_inner = match options_data_format_inner_raw { 1i32 => MidiDataFormat::Midi1Bytes, 2i32 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_data_format_inner", "unknown MidiDataFormat value")).boxed()), };
            Some(options_data_format_inner)
        };
        let options_protocol = if slots[3].tag() == vm::ValueTag::Void {
            None
        } else {
            let options_protocol_inner_raw = decode_int32(slots[3], "options_protocol_inner_raw", "protocol")?;
            let options_protocol_inner = match options_protocol_inner_raw { 1i32 => MidiProtocol::Midi1, 2i32 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_protocol_inner", "unknown MidiProtocol value")).boxed()), };
            Some(options_protocol_inner)
        };
        let options_queue_capacity = decode_uint32(slots[4], "options_queue_capacity", "queueCapacity")?;
...
fn encode_destack_midi_input_read_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.received_at_ns, 64)); let field_1: RuntimeResult<vm::Value> = match value.source_id { Some(value) => Ok(value.value()), None => Ok(vm::Value::VOID) }; let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.data_format as i32 as i64, 32)); let field_3: RuntimeResult<vm::Value> = match value.protocol { Some(value) => Ok(vm::Value::int(value as i32 as i64, 32)), None => Ok(vm::Value::VOID) }; let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::int(value.framing as i32 as i64, 32)); let field_5: RuntimeResult<vm::Value> = value.data.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_midi_input_virtual_create_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiVirtualInputCreateOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 9 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options", "expected 9 fields")).boxed()); }
        let options_backend_raw = decode_int32(slots[0], "options_backend_raw", "backend")?;
        let options_backend = match options_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend", "unknown MidiBackend value")).boxed()), };
        let options_backend_policy_raw = decode_int32(slots[1], "options_backend_policy_raw", "backendPolicy")?;
        let options_backend_policy = match options_backend_policy_raw { 1i32 => MidiBackendSelectionPolicy::Strict, 2i32 => MidiBackendSelectionPolicy::AllowFallback , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend_policy", "unknown MidiBackendSelectionPolicy value")).boxed()), };
        ...
        let options_manufacturer = if slots[3].tag() == vm::ValueTag::Void {
            ...
            let options_manufacturer_inner = decode_string(slots[3], "options_manufacturer_inner", "manufacturer")?;
        ...
        let options_version = if slots[5].tag() == vm::ValueTag::Void {
            ...
            let options_version_inner = decode_string(slots[5], "options_version_inner", "version")?;
            Some(options_version_inner)
        };
        let options_data_format_raw = decode_int32(slots[6], "options_data_format_raw", "dataFormat")?;
        let options_data_format = match options_data_format_raw { 1i32 => MidiDataFormat::Midi1Bytes, 2i32 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_data_format", "unknown MidiDataFormat value")).boxed()), };
        let options_protocol_raw = decode_int32(slots[7], "options_protocol_raw", "protocol")?;
        let options_protocol = match options_protocol_raw { 1i32 => MidiProtocol::Midi1, 2i32 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_protocol", "unknown MidiProtocol value")).boxed()), };
        let options_queue_capacity = decode_uint32(slots[8], "options_queue_capacity", "queueCapacity")?;
...
fn decode_destack_midi_output_port_close_args(
    ...
    let handle_inner_inner = decode_uint64(handle_value, "handle_inner_inner", "MidiOutputPortHandle")?;
    let handle_inner = resource::ResourceId(handle_inner_inner);
...
fn decode_destack_midi_output_port_open_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiOutputPortOpenOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
...
fn decode_destack_midi_output_virtual_create_args(
    ...
    let options = {
        if options_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("options", "MidiVirtualOutputCreateOptions")).boxed()); }
        let slots = context.aggregate_slots(options_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 8 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("options", "expected 8 fields")).boxed()); }
        let options_backend_raw = decode_int32(slots[0], "options_backend_raw", "backend")?;
        let options_backend = match options_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("options_backend", "unknown MidiBackend value")).boxed()), };
...
fn decode_destack_midi_output_write_args(
    ...
    let records = decode_array::<MidiOutputRecordVm>(context, records_value, "records", "Array<MidiOutputRecord>")?;
    Ok((handle, records))
}
...
pub(crate) const MIDI_BACKEND_LIST: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const MIDI_EVENT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const MIDI_EVENT_TRY_READ: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const MIDI_INPUT_PORT_CLOSE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const MIDI_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "midi",
    bindings: &[
        NativeBinding::new(MIDI_BACKEND_LIST, "destack.midi.backend.list", destack_midi_backend_list as *const ()),
        NativeBinding::new(MIDI_EVENT_CLOSE, "destack.midi.event.close", destack_midi_event_close as *const ()),
        NativeBinding::new(MIDI_EVENT_OPEN, "destack.midi.event.open", destack_midi_event_open as *const ()),
        NativeBinding::new(MIDI_EVENT_READ, "destack.midi.event.read", destack_midi_event_read as *const ()),
        NativeBinding::new(MIDI_EVENT_READ_BATCH, "destack.midi.event.readBatch", destack_midi_event_read_batch as *const ()),
        NativeBinding::new(MIDI_EVENT_TRY_READ, "destack.midi.event.tryRead", destack_midi_event_try_read as *const ()),
        NativeBinding::new(MIDI_EVENT_TRY_READ_BATCH, "destack.midi.event.tryReadBatch", destack_midi_event_try_read_batch as *const ()),
        NativeBinding::new(MIDI_INPUT_PORT_CLOSE, "destack.midi.input.port.close", destack_midi_input_port_close as *const ()),
        NativeBinding::new(MIDI_INPUT_PORT_DESCRIPTOR, "destack.midi.input.port.descriptor", destack_midi_input_port_descriptor as *const ()),
        NativeBinding::new(MIDI_INPUT_PORT_LIST, "destack.midi.input.port.list", destack_midi_input_port_list as *const ()),
        NativeBinding::new(MIDI_INPUT_PORT_OPEN, "destack.midi.input.port.open", destack_midi_input_port_open as *const ()),
        NativeBinding::new(MIDI_INPUT_READ, "destack.midi.input.read", destack_midi_input_read as *const ()),
        NativeBinding::new(MIDI_INPUT_READ_BATCH, "destack.midi.input.readBatch", destack_midi_input_read_batch as *const ()),
        NativeBinding::new(MIDI_INPUT_TRY_READ, "destack.midi.input.tryRead", destack_midi_input_try_read as *const ()),
        NativeBinding::new(MIDI_INPUT_TRY_READ_BATCH, "destack.midi.input.tryReadBatch", destack_midi_input_try_read_batch as *const ()),
        NativeBinding::new(MIDI_INPUT_VIRTUAL_CREATE, "destack.midi.input.virtual.create", destack_midi_input_virtual_create as *const ()),
        NativeBinding::new(MIDI_OUTPUT_PORT_CLOSE, "destack.midi.output.port.close", destack_midi_output_port_close as *const ()),
        NativeBinding::new(MIDI_OUTPUT_PORT_DESCRIPTOR, "destack.midi.output.port.descriptor", destack_midi_output_port_descriptor as *const ()),
        NativeBinding::new(MIDI_OUTPUT_PORT_LIST, "destack.midi.output.port.list", destack_midi_output_port_list as *const ()),
        NativeBinding::new(MIDI_OUTPUT_PORT_OPEN, "destack.midi.output.port.open", destack_midi_output_port_open as *const ()),
        NativeBinding::new(MIDI_OUTPUT_VIRTUAL_CREATE, "destack.midi.output.virtual.create", destack_midi_output_virtual_create as *const ()),
        NativeBinding::new(MIDI_OUTPUT_WRITE, "destack.midi.output.write", destack_midi_output_write as *const ()),
    ],
};
...
fn destack_midi_backend_list_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_backend_list(binding, out) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_backend_list(binding, out) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? }.iter().cloned() {
                    ...
                    let result_recorded_item_recorded_capability_flags = result_recorded_item.capability_flags;
                    let result_recorded_item_recorded_supported_data_formats = result_recorded_item.supported_data_formats;
                    let result_recorded_item_recorded_supported_protocols = result_recorded_item.supported_protocols;
                    let result_recorded_item_recorded = MidibackenddescriptorReplayRecord {
                        ...
                        supported_data_formats: result_recorded_item_recorded_supported_data_formats,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        ...
                        let value_native_decoded_capability_flags = value_native_item.capability_flags;
                        let value_native_decoded_supported_data_formats = value_native_item.supported_data_formats;
                        let value_native_decoded_supported_protocols = value_native_item.supported_protocols;
...
fn destack_midi_event_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_event_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_event_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
...
fn destack_midi_event_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_event_open(binding, out, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_event_open(binding, out, options) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_midi_input_port_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_port_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_port_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortCloseReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_input_port_descriptor_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_port_descriptor(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_port_descriptor(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded_default_data_format = if let Some(value) = result_value.default_data_format {
                ...
                let result_recorded_default_protocol = if let Some(value) = result_value.default_protocol {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortDescriptorReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_default_data_format = if let Some(value) = value.default_data_format {
...
fn destack_midi_input_port_list_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_port_list(binding, out, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_port_list(binding, out, options) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_item in unsafe { result_value.as_slice()? }.iter().cloned() {
                    ...
                    let result_recorded_item_recorded_group_id = if let Some(value) = result_recorded_item.group_id {
                        let result_recorded_item_recorded_group_id_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_group_id_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_backend_id = if let Some(value) = result_recorded_item.backend_id {
                        let result_recorded_item_recorded_backend_id_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_backend_id_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_name = unsafe { result_recorded_item.name.as_str()? }.to_string();
                    let result_recorded_item_recorded_group_name = if let Some(value) = result_recorded_item.group_name {
                        let result_recorded_item_recorded_group_name_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_group_name_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_manufacturer = if let Some(value) = result_recorded_item.manufacturer {
                        let result_recorded_item_recorded_manufacturer_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_manufacturer_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_model = if let Some(value) = result_recorded_item.model {
                        let result_recorded_item_recorded_model_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_model_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_version = if let Some(value) = result_recorded_item.version {
                        let result_recorded_item_recorded_version_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_version_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_supported_data_formats = result_recorded_item.supported_data_formats;
                    let result_recorded_item_recorded_default_data_format = if let Some(value) = result_recorded_item.default_data_format {
                    ...
                    let result_recorded_item_recorded_supported_protocols = result_recorded_item.supported_protocols;
                    let result_recorded_item_recorded_default_protocol = if let Some(value) = result_recorded_item.default_protocol {
                    ...
                    let result_recorded_item_recorded_is_connected = result_recorded_item.is_connected;
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        ...
                        let value_native_decoded_group_id = if let Some(value) = value_native_item.group_id {
                            let value_native_decoded_group_id_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_group_id_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_backend_id = if let Some(value) = value_native_item.backend_id {
                            let value_native_decoded_backend_id_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_backend_id_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_name = binding.store_string(value_native_item.name.as_str());
                        let value_native_decoded_group_name = if let Some(value) = value_native_item.group_name {
                            let value_native_decoded_group_name_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_group_name_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_manufacturer = if let Some(value) = value_native_item.manufacturer {
                            let value_native_decoded_manufacturer_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_manufacturer_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_model = if let Some(value) = value_native_item.model {
                            let value_native_decoded_model_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_model_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_version = if let Some(value) = value_native_item.version {
                            let value_native_decoded_version_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_version_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_supported_data_formats = value_native_item.supported_data_formats;
                        let value_native_decoded_default_data_format = if let Some(value) = value_native_item.default_data_format {
                        ...
                        let value_native_decoded_supported_protocols = value_native_item.supported_protocols;
                        let value_native_decoded_default_protocol = if let Some(value) = value_native_item.default_protocol {
...
fn destack_midi_input_port_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_port_open(binding, out, id, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_port_open(binding, out, id, options) },
        },
        |result| {
            if let Ok(()) = result {
...
fn destack_midi_input_read_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_read(binding, out, handle, timeoutns) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_read(binding, out, handle, timeoutns) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                for result_recorded_data_item in unsafe { result_value.data.as_slice()? }.iter().cloned() {
...
fn destack_midi_input_read_batch_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_read_batch(binding, out, handle, maxrecords, timeoutns) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_read_batch(binding, out, handle, maxrecords, timeoutns) },
        },
        |result| {
            if let Ok(()) = result {
                ...
                let mut result_recorded = Vec::new();
                for result_recorded_item in unsafe { result_value.as_slice()? }.iter().cloned() {
                    let result_recorded_item_recorded_received_at_ns = result_recorded_item.received_at_ns;
                    let result_recorded_item_recorded_source_id = if let Some(value) = result_recorded_item.source_id {
                        let result_recorded_item_recorded_source_id_inner = unsafe { value.as_str()? }.to_string();
                        Some(result_recorded_item_recorded_source_id_inner)
                    } else {
                        None
                    };
                    let result_recorded_item_recorded_data_format = result_recorded_item.data_format;
                    let result_recorded_item_recorded_protocol = if let Some(value) = result_recorded_item.protocol {
                    ...
                    for result_recorded_item_recorded_data_item in unsafe { result_recorded_item.data.as_slice()? }.iter().cloned() {
                        let result_recorded_item_recorded_data_item_recorded = result_recorded_item_recorded_data_item;
                        result_recorded_item_recorded_data.push(result_recorded_item_recorded_data_item_recorded);
                    }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputReadBatchReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value.iter().cloned() {
                        ...
                        let value_native_decoded_source_id = if let Some(value) = value_native_item.source_id {
                            let value_native_decoded_source_id_inner = binding.store_string(value.as_str());
                            Some(value_native_decoded_source_id_inner)
                        } else {
                            None
                        };
                        let value_native_decoded_data_format = value_native_item.data_format;
                        let value_native_decoded_protocol = if let Some(value) = value_native_item.protocol {
                        ...
                        for value_native_decoded_data_item in value_native_item.data.iter().cloned() {
                            ...
                            value_native_decoded_data_values.push(value_native_decoded_data_decoded);
                        }
                        let value_native_decoded_data = binding.store_slice(value_native_decoded_data_values);
...
fn destack_midi_input_try_read_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_try_read(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_try_read(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: MidiInputRecord = unsafe { out.read() };
...
fn destack_midi_input_try_read_batch_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_try_read_batch(binding, out, handle, maxrecords) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_try_read_batch(binding, out, handle, maxrecords) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: NativeArray<MidiInputRecord> = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputTryReadBatchReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_input_virtual_create_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_input_virtual_create(binding, out, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_input_virtual_create(binding, out, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: resource::MidiInputPortHandle = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputVirtualCreateReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_port_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_port_close(binding, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_port_close(binding, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortCloseReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_port_descriptor_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_port_descriptor(binding, out, handle) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_port_descriptor(binding, out, handle) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: MidiPortDescriptor = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortDescriptorReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_port_list_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_port_list(binding, out, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_port_list(binding, out, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: NativeSlice<MidiPortDescriptor> = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortListReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_port_open_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_port_open(binding, out, id, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_port_open(binding, out, id, options) },
        },
        |result| {
            if let Ok(()) = result {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortOpenReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_virtual_create_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_virtual_create(binding, out, options) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_virtual_create(binding, out, options) },
        },
        |result| {
            if let Ok(()) = result {
                let result_value: resource::MidiOutputPortHandle = unsafe { out.read() };
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputVirtualCreateReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
fn destack_midi_output_write_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        || match world {
            RuntimeWorld::Host => unsafe { platform_native::destack_midi_output_write(binding, out, handle, records) },
            RuntimeWorld::Simulation => unsafe { platform_simulation_native::destack_midi_output_write(binding, out, handle, records) },
        },
        |result| {
            if let Ok(()) = result {
...
pub(crate) unsafe extern "C" fn destack_midi_backend_list(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_BACKEND_LIST)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_READ)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_read_batch(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_READ_BATCH)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_try_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_TRY_READ)?;
...
pub(crate) unsafe extern "C" fn destack_midi_event_try_read_batch(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_EVENT_TRY_READ_BATCH)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_port_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_PORT_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_port_descriptor(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_PORT_DESCRIPTOR)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_port_list(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_PORT_LIST)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_port_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_PORT_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_READ)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_read_batch(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_READ_BATCH)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_try_read(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_TRY_READ)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_try_read_batch(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_TRY_READ_BATCH)?;
...
pub(crate) unsafe extern "C" fn destack_midi_input_virtual_create(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_INPUT_VIRTUAL_CREATE)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_port_close(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_CLOSE)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_port_descriptor(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_DESCRIPTOR)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_port_list(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_LIST)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_port_open(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_OPEN)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_virtual_create(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_VIRTUAL_CREATE)?;
...
pub(crate) unsafe extern "C" fn destack_midi_output_write(
    ...
    native_call(|context| {
        ...
        let (world, _binding_hook_guard) = context.on_before_binding_resolve_world(MIDI_OUTPUT_WRITE)?;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_backend_list(binding, context),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_backend = match result_recorded_item_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_backend", "unknown MidiBackend value")).boxed()), };
                        let result_recorded_item_name = decode_string(slots[1], "result_recorded_item_name", "name")?;
                        let result_recorded_item_support_raw = decode_int32(slots[2], "result_recorded_item_support_raw", "support")?;
                        let result_recorded_item_support = match result_recorded_item_support_raw { 0i32 => core::BackendSupport::Available, 1i32 => core::BackendSupport::UnsupportedTarget, 2i32 => core::BackendSupport::DisabledByBuild, 3i32 => core::BackendSupport::HostUnavailable , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_support", "unknown core::BackendSupport value")).boxed()), };
                        let result_recorded_item_priority = decode_uint16(slots[3], "result_recorded_item_priority", "priority")?;
                        let result_recorded_item_capability_flags_inner = decode_uint64(slots[4], "result_recorded_item_capability_flags_inner", "capabilityFlags")?;
                        let result_recorded_item_capability_flags = MidiBackendCapabilityFlags(result_recorded_item_capability_flags_inner);
                        let result_recorded_item_supported_data_formats_inner = decode_uint32(slots[5], "result_recorded_item_supported_data_formats_inner", "supportedDataFormats")?;
                        let result_recorded_item_supported_data_formats = MidiDataFormatFlags(result_recorded_item_supported_data_formats_inner);
                        let result_recorded_item_supported_protocols_inner = decode_uint32(slots[6], "result_recorded_item_supported_protocols_inner", "supportedProtocols")?;
                        let result_recorded_item_supported_protocols = MidiProtocolFlags(result_recorded_item_supported_protocols_inner);
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_supported_data_formats = vm_result_item.supported_data_formats;
                        let vm_result_item_value_supported_protocols = vm_result_item.supported_protocols;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_event_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                ...
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_event_open(binding, context, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_input_port_close_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_port_close(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_port_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_input_port_descriptor_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_port_descriptor(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_port_descriptor(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                let result_recorded_group_id = if let Some(value) = result_value.group_id {
                    let result_recorded_group_id_inner = {
                        let result_recorded_group_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                ...
                let result_recorded_backend_id = if let Some(value) = result_value.backend_id {
                    let result_recorded_backend_id_inner = {
                        let result_recorded_backend_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                ...
                let result_recorded_name = {
                    let result_recorded_name_ref = context.string_ref(result_value.name).map_err(|error| RuntimeError::from(error).boxed())?;
                    result_recorded_name_ref.as_str().to_string()
                };
                let result_recorded_group_name = if let Some(value) = result_value.group_name {
                    let result_recorded_group_name_inner = {
                        let result_recorded_group_name_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                ...
                let result_recorded_manufacturer = if let Some(value) = result_value.manufacturer {
                    let result_recorded_manufacturer_inner = {
                        let result_recorded_manufacturer_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                ...
                let result_recorded_model = if let Some(value) = result_value.model {
                    let result_recorded_model_inner = {
                        let result_recorded_model_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                ...
                let result_recorded_version = if let Some(value) = result_value.version {
                    let result_recorded_version_inner = {
                        let result_recorded_version_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_group_id = if let Some(value) = value.group_id {
                        let vm_result_group_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_group_id_inner)
                    } else {
                        None
                    };
                    let vm_result_backend_id = if let Some(value) = value.backend_id {
                        let vm_result_backend_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_backend_id_inner)
                    } else {
                        None
                    };
                    let vm_result_name = context.string_handle(value.name.as_str()).map_err(Box::<RuntimeError>::from)?;
                    let vm_result_group_name = if let Some(value) = value.group_name {
                        let vm_result_group_name_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_group_name_inner)
                    } else {
                        None
                    };
                    let vm_result_manufacturer = if let Some(value) = value.manufacturer {
                        let vm_result_manufacturer_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_manufacturer_inner)
                    } else {
                        None
                    };
                    let vm_result_model = if let Some(value) = value.model {
                        let vm_result_model_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_model_inner)
                    } else {
                        None
                    };
                    let vm_result_version = if let Some(value) = value.version {
                        let vm_result_version_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                        Some(vm_result_version_inner)
                    } else {
                        None
                    };
                    let vm_result_supported_data_formats = value.supported_data_formats;
                    let vm_result_default_data_format = if let Some(value) = value.default_data_format {
...
fn destack_midi_input_port_list_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_port_list(binding, context, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_port_list(binding, context, options),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        if result_recorded_item_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("result_recorded_item", "item")).boxed()); }
                        let slots = context.aggregate_slots(result_recorded_item_value).map_err(|error| RuntimeError::from(error).boxed())?;
                        if slots.len() != 15 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item", "expected 15 fields")).boxed()); }
                        let result_recorded_item_backend_raw = decode_int32(slots[0], "result_recorded_item_backend_raw", "backend")?;
                        let result_recorded_item_backend = match result_recorded_item_backend_raw { 0i32 => MidiBackend::Auto, 1i32 => MidiBackend::Alsa, 2i32 => MidiBackend::JackMidi, 3i32 => MidiBackend::CoreMIDI, 4i32 => MidiBackend::WindowsMidi, 5i32 => MidiBackend::WinMM, 6i32 => MidiBackend::WinRT, 7i32 => MidiBackend::AndroidMidi, 255i32 => MidiBackend::Null , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_backend", "unknown MidiBackend value")).boxed()), };
                        ...
                        let result_recorded_item_group_id = if slots[2].tag() == vm::ValueTag::Void {
                            ...
                            let result_recorded_item_group_id_inner = decode_string(slots[2], "result_recorded_item_group_id_inner", "groupId")?;
                            Some(result_recorded_item_group_id_inner)
                        };
                        let result_recorded_item_backend_id = if slots[3].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_backend_id_inner = decode_string(slots[3], "result_recorded_item_backend_id_inner", "backendId")?;
                            Some(result_recorded_item_backend_id_inner)
                        };
                        let result_recorded_item_name = decode_string(slots[4], "result_recorded_item_name", "name")?;
                        let result_recorded_item_group_name = if slots[5].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_group_name_inner = decode_string(slots[5], "result_recorded_item_group_name_inner", "groupName")?;
                            Some(result_recorded_item_group_name_inner)
                        };
                        let result_recorded_item_manufacturer = if slots[6].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_manufacturer_inner = decode_string(slots[6], "result_recorded_item_manufacturer_inner", "manufacturer")?;
                            Some(result_recorded_item_manufacturer_inner)
                        };
                        let result_recorded_item_model = if slots[7].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_model_inner = decode_string(slots[7], "result_recorded_item_model_inner", "model")?;
                            Some(result_recorded_item_model_inner)
                        };
                        let result_recorded_item_version = if slots[8].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_version_inner = decode_string(slots[8], "result_recorded_item_version_inner", "version")?;
                            Some(result_recorded_item_version_inner)
                        };
                        let result_recorded_item_supported_data_formats_inner = decode_uint32(slots[9], "result_recorded_item_supported_data_formats_inner", "supportedDataFormats")?;
                        let result_recorded_item_supported_data_formats = MidiDataFormatFlags(result_recorded_item_supported_data_formats_inner);
                        let result_recorded_item_default_data_format = if slots[10].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_default_data_format_inner_raw = decode_int32(slots[10], "result_recorded_item_default_data_format_inner_raw", "defaultDataFormat")?;
                            let result_recorded_item_default_data_format_inner = match result_recorded_item_default_data_format_inner_raw { 1i32 => MidiDataFormat::Midi1Bytes, 2i32 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_default_data_format_inner", "unknown MidiDataFormat value")).boxed()), };
                            Some(result_recorded_item_default_data_format_inner)
                        };
                        let result_recorded_item_supported_protocols_inner = decode_uint32(slots[11], "result_recorded_item_supported_protocols_inner", "supportedProtocols")?;
                        let result_recorded_item_supported_protocols = MidiProtocolFlags(result_recorded_item_supported_protocols_inner);
                        let result_recorded_item_default_protocol = if slots[12].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_default_protocol_inner_raw = decode_int32(slots[12], "result_recorded_item_default_protocol_inner_raw", "defaultProtocol")?;
                            let result_recorded_item_default_protocol_inner = match result_recorded_item_default_protocol_inner_raw { 1i32 => MidiProtocol::Midi1, 2i32 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_default_protocol_inner", "unknown MidiProtocol value")).boxed()), };
                            Some(result_recorded_item_default_protocol_inner)
                        };
                        let result_recorded_item_is_virtual = decode_bool(slots[13], "result_recorded_item_is_virtual", "isVirtual")?;
                        let result_recorded_item_is_connected = decode_bool(slots[14], "result_recorded_item_is_connected", "isConnected")?;
                    ...
                    let result_recorded_item_recorded_group_id = if let Some(value) = result_recorded_item.group_id {
                        let result_recorded_item_recorded_group_id_inner = {
                            let result_recorded_item_recorded_group_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_group_id_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_group_id_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_backend_id = if let Some(value) = result_recorded_item.backend_id {
                        let result_recorded_item_recorded_backend_id_inner = {
                            let result_recorded_item_recorded_backend_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_backend_id_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_backend_id_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_group_name = if let Some(value) = result_recorded_item.group_name {
                        let result_recorded_item_recorded_group_name_inner = {
                            let result_recorded_item_recorded_group_name_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_group_name_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_group_name_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_manufacturer = if let Some(value) = result_recorded_item.manufacturer {
                        let result_recorded_item_recorded_manufacturer_inner = {
                            let result_recorded_item_recorded_manufacturer_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_manufacturer_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_manufacturer_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_model = if let Some(value) = result_recorded_item.model {
                        let result_recorded_item_recorded_model_inner = {
                            let result_recorded_item_recorded_model_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_model_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_model_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_version = if let Some(value) = result_recorded_item.version {
                        let result_recorded_item_recorded_version_inner = {
                            let result_recorded_item_recorded_version_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_version_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_version_inner)
                    } else {
                        None
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_group_id = if let Some(value) = vm_result_item.group_id {
                            let vm_result_item_value_group_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_group_id_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_backend_id = if let Some(value) = vm_result_item.backend_id {
                            let vm_result_item_value_backend_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_backend_id_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_name = context.string_handle(vm_result_item.name.as_str()).map_err(Box::<RuntimeError>::from)?;
                        let vm_result_item_value_group_name = if let Some(value) = vm_result_item.group_name {
                            let vm_result_item_value_group_name_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_group_name_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_manufacturer = if let Some(value) = vm_result_item.manufacturer {
                            let vm_result_item_value_manufacturer_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_manufacturer_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_model = if let Some(value) = vm_result_item.model {
                            let vm_result_item_value_model_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_model_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_version = if let Some(value) = vm_result_item.version {
                            let vm_result_item_value_version_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_version_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_supported_data_formats = vm_result_item.supported_data_formats;
                        let vm_result_item_value_default_data_format = if let Some(value) = vm_result_item.default_data_format {
                        ...
                        let vm_result_item_value_supported_protocols = vm_result_item.supported_protocols;
                        let vm_result_item_value_default_protocol = if let Some(value) = vm_result_item.default_protocol {
...
fn destack_midi_input_port_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_port_open(binding, context, id, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_port_open(binding, context, id, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_input_read_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_read(binding, context, handle, timeoutns),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_read(binding, context, handle, timeoutns),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                let result_recorded_source_id = if let Some(value) = result_value.source_id {
                    let result_recorded_source_id_inner = {
                        let result_recorded_source_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_source_id = if let Some(value) = value.source_id {
                        let vm_result_source_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
...
fn destack_midi_input_read_batch_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_read_batch(binding, context, handle, maxrecords, timeoutns),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_read_batch(binding, context, handle, maxrecords, timeoutns),
            }
        },
        |context, result| {
            let _ = &context;
            if let Ok(value) = result {
                ...
                for result_recorded_item_value in result_recorded_raw {
                    let result_recorded_item = {
                        ...
                        let result_recorded_item_received_at_ns = decode_uint64(slots[0], "result_recorded_item_received_at_ns", "receivedAtNs")?;
                        let result_recorded_item_source_id = if slots[1].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_source_id_inner = decode_string(slots[1], "result_recorded_item_source_id_inner", "sourceId")?;
                            Some(result_recorded_item_source_id_inner)
                        };
                        let result_recorded_item_data_format_raw = decode_int32(slots[2], "result_recorded_item_data_format_raw", "dataFormat")?;
                        let result_recorded_item_data_format = match result_recorded_item_data_format_raw { 1i32 => MidiDataFormat::Midi1Bytes, 2i32 => MidiDataFormat::Ump , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_data_format", "unknown MidiDataFormat value")).boxed()), };
                        let result_recorded_item_protocol = if slots[3].tag() == vm::ValueTag::Void {
                            None
                        } else {
                            let result_recorded_item_protocol_inner_raw = decode_int32(slots[3], "result_recorded_item_protocol_inner_raw", "protocol")?;
                            let result_recorded_item_protocol_inner = match result_recorded_item_protocol_inner_raw { 1i32 => MidiProtocol::Midi1, 2i32 => MidiProtocol::Midi2 , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_protocol_inner", "unknown MidiProtocol value")).boxed()), };
                            Some(result_recorded_item_protocol_inner)
                        };
                        let result_recorded_item_framing_raw = decode_int32(slots[4], "result_recorded_item_framing_raw", "framing")?;
                        let result_recorded_item_framing = match result_recorded_item_framing_raw { 1i32 => MidiRecordFraming::Complete, 2i32 => MidiRecordFraming::Start, 3i32 => MidiRecordFraming::Continue, 4i32 => MidiRecordFraming::End , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("result_recorded_item_framing", "unknown MidiRecordFraming value")).boxed()), };
                        let result_recorded_item_data = decode_slice::<u8>(context, slots[5], "result_recorded_item_data", "data")?;
                        MidiInputRecordVm {
                    ...
                    let result_recorded_item_recorded_source_id = if let Some(value) = result_recorded_item.source_id {
                        let result_recorded_item_recorded_source_id_inner = {
                            let result_recorded_item_recorded_source_id_inner_ref = context.string_ref(value).map_err(|error| RuntimeError::from(error).boxed())?;
                            result_recorded_item_recorded_source_id_inner_ref.as_str().to_string()
                        };
                        Some(result_recorded_item_recorded_source_id_inner)
                    } else {
                        None
                    ...
                    let result_recorded_item_recorded_framing = result_recorded_item.framing;
                    let result_recorded_item_recorded_data = result_recorded_item.data.read_bytes(context)?;
                    let result_recorded_item_recorded = MidiinputrecordReplayRecord {
                        received_at_ns: result_recorded_item_recorded_received_at_ns,
                        source_id: result_recorded_item_recorded_source_id,
                        data_format: result_recorded_item_recorded_data_format,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter().cloned() {
                        ...
                        let vm_result_item_value_source_id = if let Some(value) = vm_result_item.source_id {
                            let vm_result_item_value_source_id_inner = context.string_handle(value.as_str()).map_err(Box::<RuntimeError>::from)?;
                            Some(vm_result_item_value_source_id_inner)
                        } else {
                            None
                        };
                        let vm_result_item_value_data_format = vm_result_item.data_format;
                        let vm_result_item_value_protocol = if let Some(value) = vm_result_item.protocol {
                        ...
                        let vm_result_item_value_data = VmSlice::<u8>::from_bytes(context, vm_result_item.data.as_ref())?;
...
fn destack_midi_input_try_read_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_try_read(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_try_read(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_input_try_read_batch_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_try_read_batch(binding, context, handle, maxrecords),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_try_read_batch(binding, context, handle, maxrecords),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_input_virtual_create_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_input_virtual_create(binding, context, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_input_virtual_create(binding, context, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_port_close_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_port_close(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_port_close(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_port_descriptor_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_port_descriptor(binding, context, handle),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_port_descriptor(binding, context, handle),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_port_list_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_port_list(binding, context, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_port_list(binding, context, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_port_open_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_port_open(binding, context, id, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_port_open(binding, context, id, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_virtual_create_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_virtual_create(binding, context, options),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_virtual_create(binding, context, options),
            }
        },
        |context, result| {
            let _ = &context;
...
fn destack_midi_output_write_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        |context| {
            match world {
                RuntimeWorld::Host => platform_vm::destack_midi_output_write(binding, context, handle, records),
                RuntimeWorld::Simulation => platform_simulation_vm::destack_midi_output_write(binding, context, handle, records),
            }
        },
        |context, result| {
            let _ = &context;
...
pub(crate) fn register_midi_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, MIDI_BACKEND_LIST, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_BACKEND_LIST)?;
    ...
    }
    {
        binding!(registry, isolate, MIDI_EVENT_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_CLOSE)?;
    ...
    }
    {
        binding!(registry, isolate, MIDI_EVENT_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, MIDI_EVENT_READ, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_READ)?;
    ...
    {
        binding!(registry, isolate, MIDI_EVENT_READ_BATCH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, maxevents, timeoutns) = decode_destack_midi_event_read_batch_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_READ_BATCH)?;
                destack_midi_event_read_batch_vm_replay(binding, context, world, handle, maxevents, timeoutns)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, MIDI_EVENT_TRY_READ, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_event_try_read_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_TRY_READ)?;
    ...
    {
        binding!(registry, isolate, MIDI_EVENT_TRY_READ_BATCH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, maxevents) = decode_destack_midi_event_try_read_batch_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_EVENT_TRY_READ_BATCH)?;
                destack_midi_event_try_read_batch_vm_replay(binding, context, world, handle, maxevents)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, MIDI_INPUT_PORT_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_input_port_close_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_PORT_CLOSE)?;
    ...
    {
        binding!(registry, isolate, MIDI_INPUT_PORT_DESCRIPTOR, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_input_port_descriptor_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_PORT_DESCRIPTOR)?;
    ...
    {
        binding!(registry, isolate, MIDI_INPUT_PORT_LIST, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (options,) = decode_destack_midi_input_port_list_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_PORT_LIST)?;
    ...
    {
        binding!(registry, isolate, MIDI_INPUT_PORT_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (id, options) = decode_destack_midi_input_port_open_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_PORT_OPEN)?;
    ...
    }
    {
        binding!(registry, isolate, MIDI_INPUT_READ, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_READ)?;
    ...
    {
        binding!(registry, isolate, MIDI_INPUT_READ_BATCH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, maxrecords, timeoutns) = decode_destack_midi_input_read_batch_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_READ_BATCH)?;
                destack_midi_input_read_batch_vm_replay(binding, context, world, handle, maxrecords, timeoutns)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, MIDI_INPUT_TRY_READ, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_input_try_read_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_TRY_READ)?;
    ...
    {
        binding!(registry, isolate, MIDI_INPUT_TRY_READ_BATCH, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, maxrecords) = decode_destack_midi_input_try_read_batch_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_TRY_READ_BATCH)?;
                destack_midi_input_try_read_batch_vm_replay(binding, context, world, handle, maxrecords)
            })
            .map_err(Into::into)
        });
    }
    {
        binding!(registry, isolate, MIDI_INPUT_VIRTUAL_CREATE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (options,) = decode_destack_midi_input_virtual_create_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_INPUT_VIRTUAL_CREATE)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_PORT_CLOSE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_output_port_close_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_CLOSE)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_PORT_DESCRIPTOR, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle,) = decode_destack_midi_output_port_descriptor_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_DESCRIPTOR)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_PORT_LIST, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (options,) = decode_destack_midi_output_port_list_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_LIST)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_PORT_OPEN, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (id, options) = decode_destack_midi_output_port_open_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_PORT_OPEN)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_VIRTUAL_CREATE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (options,) = decode_destack_midi_output_virtual_create_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_VIRTUAL_CREATE)?;
    ...
    {
        binding!(registry, isolate, MIDI_OUTPUT_WRITE, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (handle, records) = decode_destack_midi_output_write_args(context, args)?;

                // execute binding
                let (world, _binding_hook_guard) = binding.on_before_binding_resolve_world(MIDI_OUTPUT_WRITE)?;
...
pub(crate) fn install_midi_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
