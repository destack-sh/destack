...
use crate::platform::midi::{
    MidiBackend, MidiBackendCapabilityFlags, MidiBackendDescriptor,
    MidiBackendDescriptorReplayRecord, MidiBackendDescriptorVm, MidiBackendDisconnectedEvent,
    MidiBackendDisconnectedEventReplayRecord, MidiBackendDisconnectedEventVm,
    MidiBackendDisconnectedPayload, MidiBackendDisconnectedPayloadVm, MidiBackendSelectionPolicy,
    MidiDataFormat, MidiDataFormatFlags, MidiEvent, MidiEventDeliveryMode, MidiEventMetadata,
    MidiEventMetadataVm, MidiEventOverflowPolicy, MidiEventReplayRecord,
    MidiEventSubscriptionFlags, MidiEventSubscriptionOptions, MidiEventSubscriptionOptionsVm,
    MidiEventVm, MidiInputPortOpenOptions, MidiInputPortOpenOptionsVm, MidiInputRecord,
    MidiInputRecordReplayRecord, MidiInputRecordVm, MidiOutputPortOpenOptions,
    MidiOutputPortOpenOptionsVm, MidiOutputRecord, MidiOutputRecordVm, MidiPortAddedEvent,
    MidiPortAddedEventReplayRecord, MidiPortAddedEventVm, MidiPortAddedPayload,
    MidiPortAddedPayloadReplayRecord, MidiPortAddedPayloadVm, MidiPortChangedEvent,
    MidiPortChangedEventReplayRecord, MidiPortChangedEventVm, MidiPortChangedPayload,
    MidiPortChangedPayloadReplayRecord, MidiPortChangedPayloadVm, MidiPortDescriptor,
    MidiPortDescriptorReplayRecord, MidiPortDescriptorVm, MidiPortDirectionFlags,
    MidiPortListFlags, MidiPortListOptions, MidiPortListOptionsVm, MidiPortRemovedEvent,
    MidiPortRemovedEventReplayRecord, MidiPortRemovedEventVm, MidiPortRemovedPayload,
    MidiPortRemovedPayloadReplayRecord, MidiPortRemovedPayloadVm, MidiProtocol, MidiProtocolFlags,
    ...
    result.map(|value| match value {
        ...
        MidiEventVm::MidiPortAddedEvent(value) => {
            ...
            let payload_value = {
                ...
                let field_2 = {
                    let field_0 = vm::Value::uint(value.payload.direction as u8 as u64, 8);
                    let field_1 = {
                        let field_0 =
...
fn encode_destack_midi_input_read_result(
    ...
    result.map(|value| {
        ...
        let field_2 = vm::Value::uint(value.data_format as u8 as u64, 8);
        let field_3 = match value.protocol {
            Some(value) => vm::Value::uint(value as u8 as u64, 8),
            None => vm::Value::VOID,
        };
        let field_4 = vm::Value::uint(value.framing as u8 as u64, 8);
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiEventReadBatchReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiEventTryReadBatchReplay {
    /// Replay result payload.
    pub result: Result<Vec<MidiEventReplayRecord>, TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputPortCloseReplay {
    /// Replay result payload.
    pub result: Result<(), TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputPortDescriptorReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputPortListReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputPortOpenReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputReadBatchReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputTryReadBatchReplay {
    /// Replay result payload.
    pub result: Result<Vec<MidiInputRecordReplayRecord>, TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiInputVirtualCreateReplay {
    /// Replay result payload.
    pub result: Result<resource::MidiInputPortHandle, TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiOutputPortCloseReplay {
    /// Replay result payload.
    pub result: Result<(), TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiOutputPortDescriptorReplay {
    /// Replay result payload.
    pub result: Result<MidiPortDescriptorReplayRecord, TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiOutputPortListReplay {
    /// Replay result payload.
    pub result: Result<Vec<MidiPortDescriptorReplayRecord>, TraceError>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiOutputPortOpenReplay {
    /// Replay result payload.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
struct MidiOutputVirtualCreateReplay {
    /// Replay result payload.
    pub result: Result<resource::MidiOutputPortHandle, TraceError>,
}
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiBackendListReplay {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for value_native_item in value {
                        ...
                        let value_native_item_native_supported_data_formats =
                            value_native_item.supported_data_formats;
                        let value_native_item_native_supported_protocols =
                            value_native_item.supported_protocols;
                        let value_native_item_native = MidiBackendDescriptor {
                            ...
                            supported_data_formats: value_native_item_native_supported_data_formats,
                            supported_protocols: value_native_item_native_supported_protocols,
                        };
...
fn destack_midi_event_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
                let payload = MidiEventCloseReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiEventOpenReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiEventReadReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
                ...
                Ok(value) => {
                    let value_native = match value {
                        MidiEventReplayRecord::MidiBackendDisconnectedEvent(value) => {
                            let value_native_midi_backend_disconnected_event_kind = binding.store_string(&value.kind);
                        ...
                        MidiEventReplayRecord::MidiPortAddedEvent(value) => {
                            let value_native_midi_port_added_event_kind = binding.store_string(&value.kind);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_id = binding.store_string(&value.payload.descriptor.id);
                            let value_native_midi_port_added_event_payload_descriptor_group_id = if let Some(value) = value.payload.descriptor.group_id {
                                let value_native_midi_port_added_event_payload_descriptor_group_id_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_backend_id = if let Some(value) = value.payload.descriptor.backend_id {
                                let value_native_midi_port_added_event_payload_descriptor_backend_id_inner = binding.store_string(&value);
                                Some(value_native_midi_port_added_event_payload_descriptor_backend_id_inner)
                            } else {
                                None
                            };
                            let value_native_midi_port_added_event_payload_descriptor_name = binding.store_string(&value.payload.descriptor.name);
                            let value_native_midi_port_added_event_payload_descriptor_group_name = if let Some(value) = value.payload.descriptor.group_name {
                                let value_native_midi_port_added_event_payload_descriptor_group_name_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_manufacturer = if let Some(value) = value.payload.descriptor.manufacturer {
                                let value_native_midi_port_added_event_payload_descriptor_manufacturer_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_model = if let Some(value) = value.payload.descriptor.model {
                                let value_native_midi_port_added_event_payload_descriptor_model_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_added_event_payload_descriptor_version = if let Some(value) = value.payload.descriptor.version {
                                let value_native_midi_port_added_event_payload_descriptor_version_inner = binding.store_string(&value);
                        ...
                        MidiEventReplayRecord::MidiPortChangedEvent(value) => {
                            let value_native_midi_port_changed_event_kind = binding.store_string(&value.kind);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_id = binding.store_string(&value.payload.descriptor.id);
                            let value_native_midi_port_changed_event_payload_descriptor_group_id = if let Some(value) = value.payload.descriptor.group_id {
                                let value_native_midi_port_changed_event_payload_descriptor_group_id_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_backend_id = if let Some(value) = value.payload.descriptor.backend_id {
                                let value_native_midi_port_changed_event_payload_descriptor_backend_id_inner = binding.store_string(&value);
                                Some(value_native_midi_port_changed_event_payload_descriptor_backend_id_inner)
                            } else {
                                None
                            };
                            let value_native_midi_port_changed_event_payload_descriptor_name = binding.store_string(&value.payload.descriptor.name);
                            let value_native_midi_port_changed_event_payload_descriptor_group_name = if let Some(value) = value.payload.descriptor.group_name {
                                let value_native_midi_port_changed_event_payload_descriptor_group_name_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_manufacturer = if let Some(value) = value.payload.descriptor.manufacturer {
                                let value_native_midi_port_changed_event_payload_descriptor_manufacturer_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_model = if let Some(value) = value.payload.descriptor.model {
                                let value_native_midi_port_changed_event_payload_descriptor_model_inner = binding.store_string(&value);
                            ...
                            let value_native_midi_port_changed_event_payload_descriptor_version = if let Some(value) = value.payload.descriptor.version {
                                let value_native_midi_port_changed_event_payload_descriptor_version_inner = binding.store_string(&value);
                        ...
                        MidiEventReplayRecord::MidiPortRemovedEvent(value) => {
                            let value_native_midi_port_removed_event_kind = binding.store_string(&value.kind);
                            ...
                            let value_native_midi_port_removed_event_payload_id = binding.store_string(&value.payload.id);
                            let value_native_midi_port_removed_event_payload_group_id = if let Some(value) = value.payload.group_id {
                                let value_native_midi_port_removed_event_payload_group_id_inner = binding.store_string(&value);
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiEventReadBatchReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
                ...
                Ok(value) => {
                    ...
                    for value_native_item in value {
                        let value_native_item_native = match value_native_item {
                            MidiEventReplayRecord::MidiBackendDisconnectedEvent(value) => {
                                let value_native_item_native_midi_backend_disconnected_event_kind = binding.store_string(&value.kind);
                                let value_native_item_native_midi_backend_disconnected_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_item_native_midi_backend_disconnected_event_metadata_sequence = value.metadata.sequence;
                                let value_native_item_native_midi_backend_disconnected_event_metadata_dropped_count = value.metadata.dropped_count;
                                let value_native_item_native_midi_backend_disconnected_event_metadata_source = value.metadata.source;
                                let value_native_item_native_midi_backend_disconnected_event_metadata_backend = value.metadata.backend;
                                let value_native_item_native_midi_backend_disconnected_event_metadata = MidiEventMetadata {
                                    timestamp_ns: value_native_item_native_midi_backend_disconnected_event_metadata_timestamp_ns,
                                    sequence: value_native_item_native_midi_backend_disconnected_event_metadata_sequence,
                                    dropped_count: value_native_item_native_midi_backend_disconnected_event_metadata_dropped_count,
                                    source: value_native_item_native_midi_backend_disconnected_event_metadata_source,
                                    backend: value_native_item_native_midi_backend_disconnected_event_metadata_backend,
                                };
                                let value_native_item_native_midi_backend_disconnected_event_payload_flags = value.payload.flags;
                                let value_native_item_native_midi_backend_disconnected_event_payload = MidiBackendDisconnectedPayload {
                                    flags: value_native_item_native_midi_backend_disconnected_event_payload_flags,
                                };
                                let value_native_item_native_midi_backend_disconnected_event = MidiBackendDisconnectedEvent {
                                    kind: value_native_item_native_midi_backend_disconnected_event_kind,
                                    metadata: value_native_item_native_midi_backend_disconnected_event_metadata,
                                    payload: value_native_item_native_midi_backend_disconnected_event_payload,
                                };
                                MidiEvent::MidiBackendDisconnectedEvent(value_native_item_native_midi_backend_disconnected_event)
                            }
                            MidiEventReplayRecord::MidiPortAddedEvent(value) => {
                                let value_native_item_native_midi_port_added_event_kind = binding.store_string(&value.kind);
                                let value_native_item_native_midi_port_added_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_item_native_midi_port_added_event_metadata_sequence = value.metadata.sequence;
                                let value_native_item_native_midi_port_added_event_metadata_dropped_count = value.metadata.dropped_count;
                                let value_native_item_native_midi_port_added_event_metadata_source = value.metadata.source;
                                let value_native_item_native_midi_port_added_event_metadata_backend = value.metadata.backend;
                                let value_native_item_native_midi_port_added_event_metadata = MidiEventMetadata {
                                    timestamp_ns: value_native_item_native_midi_port_added_event_metadata_timestamp_ns,
                                    sequence: value_native_item_native_midi_port_added_event_metadata_sequence,
                                    dropped_count: value_native_item_native_midi_port_added_event_metadata_dropped_count,
                                    source: value_native_item_native_midi_port_added_event_metadata_source,
                                    backend: value_native_item_native_midi_port_added_event_metadata_backend,
                                };
                                let value_native_item_native_midi_port_added_event_payload_direction = value.payload.direction;
                                let value_native_item_native_midi_port_added_event_payload_descriptor_backend = value.payload.descriptor.backend;
                                let value_native_item_native_midi_port_added_event_payload_descriptor_id = binding.store_string(&value.payload.descriptor.id);
                                let value_native_item_native_midi_port_added_event_payload_descriptor_group_id = if let Some(value) = value.payload.descriptor.group_id {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_group_id_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_group_id_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_backend_id = if let Some(value) = value.payload.descriptor.backend_id {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_backend_id_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_backend_id_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_name = binding.store_string(&value.payload.descriptor.name);
                                let value_native_item_native_midi_port_added_event_payload_descriptor_group_name = if let Some(value) = value.payload.descriptor.group_name {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_group_name_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_group_name_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_manufacturer = if let Some(value) = value.payload.descriptor.manufacturer {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_manufacturer_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_manufacturer_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_model = if let Some(value) = value.payload.descriptor.model {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_model_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_model_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_version = if let Some(value) = value.payload.descriptor.version {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_version_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_version_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats;
                                let value_native_item_native_midi_port_added_event_payload_descriptor_default_data_format = if let Some(value) = value.payload.descriptor.default_data_format {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_default_data_format_inner = value;
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_default_data_format_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols;
                                let value_native_item_native_midi_port_added_event_payload_descriptor_default_protocol = if let Some(value) = value.payload.descriptor.default_protocol {
                                    let value_native_item_native_midi_port_added_event_payload_descriptor_default_protocol_inner = value;
                                    Some(value_native_item_native_midi_port_added_event_payload_descriptor_default_protocol_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_added_event_payload_descriptor_is_virtual = value.payload.descriptor.is_virtual;
                                let value_native_item_native_midi_port_added_event_payload_descriptor_is_connected = value.payload.descriptor.is_connected;
                                let value_native_item_native_midi_port_added_event_payload_descriptor = MidiPortDescriptor {
                                    backend: value_native_item_native_midi_port_added_event_payload_descriptor_backend,
                                    id: value_native_item_native_midi_port_added_event_payload_descriptor_id,
                                    group_id: value_native_item_native_midi_port_added_event_payload_descriptor_group_id,
                                    backend_id: value_native_item_native_midi_port_added_event_payload_descriptor_backend_id,
                                    name: value_native_item_native_midi_port_added_event_payload_descriptor_name,
                                    group_name: value_native_item_native_midi_port_added_event_payload_descriptor_group_name,
                                    manufacturer: value_native_item_native_midi_port_added_event_payload_descriptor_manufacturer,
                                    model: value_native_item_native_midi_port_added_event_payload_descriptor_model,
                                    version: value_native_item_native_midi_port_added_event_payload_descriptor_version,
                                    supported_data_formats: value_native_item_native_midi_port_added_event_payload_descriptor_supported_data_formats,
                                    default_data_format: value_native_item_native_midi_port_added_event_payload_descriptor_default_data_format,
                                    supported_protocols: value_native_item_native_midi_port_added_event_payload_descriptor_supported_protocols,
                                    default_protocol: value_native_item_native_midi_port_added_event_payload_descriptor_default_protocol,
                                    is_virtual: value_native_item_native_midi_port_added_event_payload_descriptor_is_virtual,
                                    is_connected: value_native_item_native_midi_port_added_event_payload_descriptor_is_connected,
                                };
                                let value_native_item_native_midi_port_added_event_payload = MidiPortAddedPayload {
                                    direction: value_native_item_native_midi_port_added_event_payload_direction,
                                    descriptor: value_native_item_native_midi_port_added_event_payload_descriptor,
                                };
                                let value_native_item_native_midi_port_added_event = MidiPortAddedEvent {
                                    kind: value_native_item_native_midi_port_added_event_kind,
                                    metadata: value_native_item_native_midi_port_added_event_metadata,
                                    payload: value_native_item_native_midi_port_added_event_payload,
                                };
                                MidiEvent::MidiPortAddedEvent(value_native_item_native_midi_port_added_event)
                            }
                            MidiEventReplayRecord::MidiPortChangedEvent(value) => {
                                let value_native_item_native_midi_port_changed_event_kind = binding.store_string(&value.kind);
                                let value_native_item_native_midi_port_changed_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_item_native_midi_port_changed_event_metadata_sequence = value.metadata.sequence;
                                let value_native_item_native_midi_port_changed_event_metadata_dropped_count = value.metadata.dropped_count;
                                let value_native_item_native_midi_port_changed_event_metadata_source = value.metadata.source;
                                let value_native_item_native_midi_port_changed_event_metadata_backend = value.metadata.backend;
                                let value_native_item_native_midi_port_changed_event_metadata = MidiEventMetadata {
                                    timestamp_ns: value_native_item_native_midi_port_changed_event_metadata_timestamp_ns,
                                    sequence: value_native_item_native_midi_port_changed_event_metadata_sequence,
                                    dropped_count: value_native_item_native_midi_port_changed_event_metadata_dropped_count,
                                    source: value_native_item_native_midi_port_changed_event_metadata_source,
                                    backend: value_native_item_native_midi_port_changed_event_metadata_backend,
                                };
                                let value_native_item_native_midi_port_changed_event_payload_direction = value.payload.direction;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_backend = value.payload.descriptor.backend;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_id = binding.store_string(&value.payload.descriptor.id);
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_group_id = if let Some(value) = value.payload.descriptor.group_id {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_group_id_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_group_id_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_backend_id = if let Some(value) = value.payload.descriptor.backend_id {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_backend_id_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_backend_id_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_name = binding.store_string(&value.payload.descriptor.name);
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_group_name = if let Some(value) = value.payload.descriptor.group_name {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_group_name_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_group_name_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_manufacturer = if let Some(value) = value.payload.descriptor.manufacturer {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_manufacturer_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_manufacturer_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_model = if let Some(value) = value.payload.descriptor.model {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_model_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_model_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_version = if let Some(value) = value.payload.descriptor.version {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_version_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_version_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_supported_data_formats = value.payload.descriptor.supported_data_formats;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_default_data_format = if let Some(value) = value.payload.descriptor.default_data_format {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_default_data_format_inner = value;
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_default_data_format_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_supported_protocols = value.payload.descriptor.supported_protocols;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_default_protocol = if let Some(value) = value.payload.descriptor.default_protocol {
                                    let value_native_item_native_midi_port_changed_event_payload_descriptor_default_protocol_inner = value;
                                    Some(value_native_item_native_midi_port_changed_event_payload_descriptor_default_protocol_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_is_virtual = value.payload.descriptor.is_virtual;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor_is_connected = value.payload.descriptor.is_connected;
                                let value_native_item_native_midi_port_changed_event_payload_descriptor = MidiPortDescriptor {
                                    backend: value_native_item_native_midi_port_changed_event_payload_descriptor_backend,
                                    id: value_native_item_native_midi_port_changed_event_payload_descriptor_id,
                                    group_id: value_native_item_native_midi_port_changed_event_payload_descriptor_group_id,
                                    backend_id: value_native_item_native_midi_port_changed_event_payload_descriptor_backend_id,
                                    name: value_native_item_native_midi_port_changed_event_payload_descriptor_name,
                                    group_name: value_native_item_native_midi_port_changed_event_payload_descriptor_group_name,
                                    manufacturer: value_native_item_native_midi_port_changed_event_payload_descriptor_manufacturer,
                                    model: value_native_item_native_midi_port_changed_event_payload_descriptor_model,
                                    version: value_native_item_native_midi_port_changed_event_payload_descriptor_version,
                                    supported_data_formats: value_native_item_native_midi_port_changed_event_payload_descriptor_supported_data_formats,
                                    default_data_format: value_native_item_native_midi_port_changed_event_payload_descriptor_default_data_format,
                                    supported_protocols: value_native_item_native_midi_port_changed_event_payload_descriptor_supported_protocols,
                                    default_protocol: value_native_item_native_midi_port_changed_event_payload_descriptor_default_protocol,
                                    is_virtual: value_native_item_native_midi_port_changed_event_payload_descriptor_is_virtual,
                                    is_connected: value_native_item_native_midi_port_changed_event_payload_descriptor_is_connected,
                                };
                                let value_native_item_native_midi_port_changed_event_payload = MidiPortChangedPayload {
                                    direction: value_native_item_native_midi_port_changed_event_payload_direction,
                                    descriptor: value_native_item_native_midi_port_changed_event_payload_descriptor,
                                };
                                let value_native_item_native_midi_port_changed_event = MidiPortChangedEvent {
                                    kind: value_native_item_native_midi_port_changed_event_kind,
                                    metadata: value_native_item_native_midi_port_changed_event_metadata,
                                    payload: value_native_item_native_midi_port_changed_event_payload,
                                };
                                MidiEvent::MidiPortChangedEvent(value_native_item_native_midi_port_changed_event)
                            }
                            MidiEventReplayRecord::MidiPortRemovedEvent(value) => {
                                let value_native_item_native_midi_port_removed_event_kind = binding.store_string(&value.kind);
                                let value_native_item_native_midi_port_removed_event_metadata_timestamp_ns = value.metadata.timestamp_ns;
                                let value_native_item_native_midi_port_removed_event_metadata_sequence = value.metadata.sequence;
                                let value_native_item_native_midi_port_removed_event_metadata_dropped_count = value.metadata.dropped_count;
                                let value_native_item_native_midi_port_removed_event_metadata_source = value.metadata.source;
                                let value_native_item_native_midi_port_removed_event_metadata_backend = value.metadata.backend;
                                let value_native_item_native_midi_port_removed_event_metadata = MidiEventMetadata {
                                    timestamp_ns: value_native_item_native_midi_port_removed_event_metadata_timestamp_ns,
                                    sequence: value_native_item_native_midi_port_removed_event_metadata_sequence,
                                    dropped_count: value_native_item_native_midi_port_removed_event_metadata_dropped_count,
                                    source: value_native_item_native_midi_port_removed_event_metadata_source,
                                    backend: value_native_item_native_midi_port_removed_event_metadata_backend,
                                };
                                let value_native_item_native_midi_port_removed_event_payload_direction = value.payload.direction;
                                let value_native_item_native_midi_port_removed_event_payload_id = binding.store_string(&value.payload.id);
                                let value_native_item_native_midi_port_removed_event_payload_group_id = if let Some(value) = value.payload.group_id {
                                    let value_native_item_native_midi_port_removed_event_payload_group_id_inner = binding.store_string(&value);
                                    Some(value_native_item_native_midi_port_removed_event_payload_group_id_inner)
                                } else {
                                    None
                                };
                                let value_native_item_native_midi_port_removed_event_payload = MidiPortRemovedPayload {
                                    direction: value_native_item_native_midi_port_removed_event_payload_direction,
                                    id: value_native_item_native_midi_port_removed_event_payload_id,
                                    group_id: value_native_item_native_midi_port_removed_event_payload_group_id,
                                };
                                let value_native_item_native_midi_port_removed_event = MidiPortRemovedEvent {
                                    kind: value_native_item_native_midi_port_removed_event_kind,
                                    metadata: value_native_item_native_midi_port_removed_event_metadata,
                                    payload: value_native_item_native_midi_port_removed_event_payload,
                                };
                                MidiEvent::MidiPortRemovedEvent(value_native_item_native_midi_port_removed_event)
                            }
                        };
                        value_native_values.push(value_native_item_native);
                    }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiEventTryReadReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiEventTryReadBatchReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
...
fn destack_midi_input_port_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
                let payload = MidiInputPortCloseReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortCloseReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputPortDescriptorReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortDescriptorReplay { result }
                };
                return Ok(Some(payload));
            }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_group_id = if let Some(value) = value.group_id {
                        let value_native_group_id_inner = binding.store_string(&value);
                        Some(value_native_group_id_inner)
                    } else {
                        None
                    };
                    let value_native_backend_id = if let Some(value) = value.backend_id {
                        let value_native_backend_id_inner = binding.store_string(&value);
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputPortListReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortListReplay { result }
                };
                return Ok(Some(payload));
            }
                    ...
                    for value_native_item in value {
                        ...
                        let value_native_item_native_group_id =
                            if let Some(value) = value_native_item.group_id {
                                let value_native_item_native_group_id_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_group_id_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_backend_id =
                            if let Some(value) = value_native_item.backend_id {
                                let value_native_item_native_backend_id_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_backend_id_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_name =
                            binding.store_string(&value_native_item.name);
                        let value_native_item_native_group_name =
                            if let Some(value) = value_native_item.group_name {
                                let value_native_item_native_group_name_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_group_name_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_manufacturer =
                            if let Some(value) = value_native_item.manufacturer {
                                let value_native_item_native_manufacturer_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_manufacturer_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_model = if let Some(value) =
                            value_native_item.model
                        {
                            let value_native_item_native_model_inner = binding.store_string(&value);
                            Some(value_native_item_native_model_inner)
                        } else {
                            None
                        };
                        let value_native_item_native_version =
                            if let Some(value) = value_native_item.version {
                                let value_native_item_native_version_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_version_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_supported_data_formats =
                            value_native_item.supported_data_formats;
                        let value_native_item_native_default_data_format =
                            if let Some(value) = value_native_item.default_data_format {
                                let value_native_item_native_default_data_format_inner = value;
                                Some(value_native_item_native_default_data_format_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_supported_protocols =
                            value_native_item.supported_protocols;
                        let value_native_item_native_default_protocol =
                            if let Some(value) = value_native_item.default_protocol {
                                let value_native_item_native_default_protocol_inner = value;
                                Some(value_native_item_native_default_protocol_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_is_virtual = value_native_item.is_virtual;
                        let value_native_item_native_is_connected = value_native_item.is_connected;
                        let value_native_item_native = MidiPortDescriptor {
                            backend: value_native_item_native_backend,
                            id: value_native_item_native_id,
                            group_id: value_native_item_native_group_id,
                            backend_id: value_native_item_native_backend_id,
                            name: value_native_item_native_name,
                            group_name: value_native_item_native_group_name,
                            manufacturer: value_native_item_native_manufacturer,
                            model: value_native_item_native_model,
                            version: value_native_item_native_version,
                            supported_data_formats: value_native_item_native_supported_data_formats,
                            default_data_format: value_native_item_native_default_data_format,
                            supported_protocols: value_native_item_native_supported_protocols,
                            default_protocol: value_native_item_native_default_protocol,
                            is_virtual: value_native_item_native_is_virtual,
                            is_connected: value_native_item_native_is_connected,
                        };
                        value_native_values.push(value_native_item_native);
                    }
                    let value_native = binding.store_slice(value_native_values);
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = result_value;
                let payload = MidiInputPortOpenReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputPortOpenReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputReadReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_source_id = if let Some(value) = value.source_id {
                        let value_native_source_id_inner = binding.store_string(&value);
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputReadBatchReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputReadBatchReplay { result }
                };
                return Ok(Some(payload));
            }
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    let mut value_native_values = Vec::with_capacity(value.len());
                    for value_native_item in value {
                        let value_native_item_native_received_at_ns =
                            value_native_item.received_at_ns;
                        let value_native_item_native_source_id =
                            if let Some(value) = value_native_item.source_id {
                                let value_native_item_native_source_id_inner =
                                    binding.store_string(&value);
                                Some(value_native_item_native_source_id_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_data_format = value_native_item.data_format;
                        let value_native_item_native_protocol =
                            if let Some(value) = value_native_item.protocol {
                                let value_native_item_native_protocol_inner = value;
                                Some(value_native_item_native_protocol_inner)
                            } else {
                                None
                            };
                        let value_native_item_native_framing = value_native_item.framing;
                        ...
                        let value_native_item_native = MidiInputRecord {
                            received_at_ns: value_native_item_native_received_at_ns,
                            source_id: value_native_item_native_source_id,
                            data_format: value_native_item_native_data_format,
                            protocol: value_native_item_native_protocol,
                            framing: value_native_item_native_framing,
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputTryReadReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiInputTryReadBatchReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputTryReadBatchReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = result_value;
                let payload = MidiInputVirtualCreateReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiInputVirtualCreateReplay { result }
                };
                return Ok(Some(payload));
            }
...
fn destack_midi_output_flush_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
                let payload = MidiOutputFlushReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
...
fn destack_midi_output_port_close_replay(
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                let result_recorded = ();
                let payload = MidiOutputPortCloseReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortCloseReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiOutputPortDescriptorReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortDescriptorReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let payload = MidiOutputPortListReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortListReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = result_value;
                let payload = MidiOutputPortOpenReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputPortOpenReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = result_value;
                let payload = MidiOutputVirtualCreateReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    MidiOutputVirtualCreateReplay { result }
                };
                return Ok(Some(payload));
            }
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded = result_value;
                let payload = MidiOutputWriteReplay {
                    result: Ok(result_recorded),
                };
                return Ok(Some(payload));
            }
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_encoded = {
                            ...
                            let field_5 = vm::Value::uint(
                                vm_result_item_value.supported_data_formats.0 as u64,
                                32,
                            );
                            let field_6 = vm::Value::uint(
                                vm_result_item_value.supported_protocols.0 as u64,
                                32,
                            );
                            context.allocate_aggregate(vec![
                    ...
                    let vm_result: VmSlice<MidiBackendDescriptorVm> = VmSlice {
                        data: vm_result_data,
                ...
                Ok(value) => {
                    let vm_result = match value {
                        MidiEventReplayRecord::MidiBackendDisconnectedEvent(value) => {
                            ...
                            let vm_result_midi_backend_disconnected_event_metadata = MidiEventMetadataVm {
                            ...
                            let vm_result_midi_backend_disconnected_event_payload = MidiBackendDisconnectedPayloadVm {
                        ...
                        MidiEventReplayRecord::MidiPortAddedEvent(value) => {
                            ...
                            let vm_result_midi_port_added_event_metadata = MidiEventMetadataVm {
                        ...
                        MidiEventReplayRecord::MidiPortChangedEvent(value) => {
                            ...
                            let vm_result_midi_port_changed_event_metadata = MidiEventMetadataVm {
                        ...
                        MidiEventReplayRecord::MidiPortRemovedEvent(value) => {
                            ...
                            let vm_result_midi_port_removed_event_metadata = MidiEventMetadataVm {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value = match vm_result_item {
                            MidiEventReplayRecord::MidiBackendDisconnectedEvent(value) => {
                                ...
                                let vm_result_item_value_midi_backend_disconnected_event_metadata = MidiEventMetadataVm {
                                ...
                                let vm_result_item_value_midi_backend_disconnected_event_payload = MidiBackendDisconnectedPayloadVm {
                            ...
                            MidiEventReplayRecord::MidiPortAddedEvent(value) => {
                                ...
                                let vm_result_item_value_midi_port_added_event_metadata = MidiEventMetadataVm {
                            ...
                            MidiEventReplayRecord::MidiPortChangedEvent(value) => {
                                ...
                                let vm_result_item_value_midi_port_changed_event_metadata = MidiEventMetadataVm {
                            ...
                            MidiEventReplayRecord::MidiPortRemovedEvent(value) => {
                                ...
                                let vm_result_item_value_midi_port_removed_event_metadata = MidiEventMetadataVm {
                ...
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_encoded = {
                            ...
                            let field_2 = match vm_result_item_value.group_id {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_3 = match vm_result_item_value.backend_id {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_4 = vm_result_item_value.name.value();
                            let field_5 = match vm_result_item_value.group_name {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_6 = match vm_result_item_value.manufacturer {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_7 = match vm_result_item_value.model {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_8 = match vm_result_item_value.version {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_9 = vm::Value::uint(
                            ...
                            let field_10 = match vm_result_item_value.default_data_format {
                                Some(value) => vm::Value::uint(value as u8 as u64, 8),
                                None => vm::Value::VOID,
                            };
                            let field_11 = vm::Value::uint(
                            ...
                            let field_12 = match vm_result_item_value.default_protocol {
                                Some(value) => vm::Value::uint(value as u8 as u64, 8),
                                None => vm::Value::VOID,
                            };
                            let field_13 = vm::Value::bool(vm_result_item_value.is_virtual);
                            let field_14 = vm::Value::bool(vm_result_item_value.is_connected);
                            context.allocate_aggregate(vec![
                                field_0, field_1, field_2, field_3, field_4, field_5, field_6,
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    for vm_result_item in value.iter() {
                        ...
                        let vm_result_item_value_encoded = {
                            let field_0 = vm::Value::uint(vm_result_item_value.received_at_ns, 64);
                            let field_1 = match vm_result_item_value.source_id {
                                Some(value) => value.value(),
                                None => vm::Value::VOID,
                            };
                            let field_2 =
                                vm::Value::uint(vm_result_item_value.data_format as u8 as u64, 8);
                            let field_3 = match vm_result_item_value.protocol {
                                Some(value) => vm::Value::uint(value as u8 as u64, 8),
                                None => vm::Value::VOID,
                            };
                            let field_4 =
                                vm::Value::uint(vm_result_item_value.framing as u8 as u64, 8);
                            let field_5 = vm_result_item_value.data.to_value(context);
                            context.allocate_aggregate(vec![
                    ...
                    let vm_result_data = context.allocate_raw_values(vm_result_values);
                    let vm_result: VmArray<MidiInputRecordVm> = VmArray {
                        data: vm_result_data,
                        len: value.len() as u32,
