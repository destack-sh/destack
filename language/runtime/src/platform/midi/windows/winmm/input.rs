...
pub(crate) fn midi_input_port_list(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .winmm_service("destack.midi.input.port.list")?;
    service.refresh_topology("destack.midi.input.port.list")?;
...
pub(crate) fn midi_input_port_open(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .winmm_service("destack.midi.input.port.open")?;
    service.refresh_topology("destack.midi.input.port.open")?;
    ...
    for buffer in &mut buffers {
        ...
        queue_input_buffer(handle, &mut buffer.header, "destack.midi.input.port.open")?;
    }
