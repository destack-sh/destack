...
pub(crate) fn midi_input_port_descriptor(
    ...
    let backend =
        require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.port.descriptor")?;
...
pub(crate) fn midi_input_port_close(
    ...
    let backend =
        require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.port.close")?;
...
pub(crate) fn midi_input_read(
    ...
    let backend = require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.read")?;
...
pub(crate) fn midi_input_read_batch(
    ...
    let backend =
        require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.readBatch")?;
...
pub(crate) fn midi_input_try_read(
    ...
    let backend =
        require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.tryRead")?;
...
pub(crate) fn midi_input_try_read_batch(
    ...
    let backend =
        require_midi_input_handle_backend(binding, handle.0, "destack.midi.input.tryReadBatch")?;
...
pub(crate) fn midi_output_port_close(
    ...
    let backend =
        require_midi_output_handle_backend(binding, handle.0, "destack.midi.output.port.close")?;
...
pub(crate) fn midi_output_write(
    ...
    let backend =
        require_midi_output_handle_backend(binding, handle.0, "destack.midi.output.write")?;
...
pub(crate) fn midi_event_close(
    ...
    let backend = require_midi_event_handle_backend(binding, handle.0, "destack.midi.event.close")?;
...
pub(crate) fn midi_event_read(
    ...
    let backend = require_midi_event_handle_backend(binding, handle.0, "destack.midi.event.read")?;
...
pub(crate) fn midi_event_read_batch(
    ...
    let backend =
        require_midi_event_handle_backend(binding, handle.0, "destack.midi.event.readBatch")?;
...
pub(crate) fn midi_event_try_read(
    ...
    let backend =
        require_midi_event_handle_backend(binding, handle.0, "destack.midi.event.tryRead")?;
...
pub(crate) fn midi_event_try_read_batch(
    ...
    let backend =
        require_midi_event_handle_backend(binding, handle.0, "destack.midi.event.tryReadBatch")?;
