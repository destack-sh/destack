...
pub(crate) fn midi_event_open(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .windows_midi_service("destack.midi.event.open")?;
...
pub(crate) fn midi_event_read(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .windows_midi_service("destack.midi.event.read")?;
...
pub(crate) fn midi_event_read_batch(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .windows_midi_service("destack.midi.event.readBatch")?;
...
pub(crate) fn midi_event_try_read(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .windows_midi_service("destack.midi.event.tryRead")?;
    ...
    let mut session = session.lock();
    if matches!(session.delivery_kind, WindowsMidiEventDeliveryKind::Poll) {
        refresh_poll_event_subscription(&service.topology, &mut session)?;
    }
...
pub(crate) fn midi_event_try_read_batch(
    ...
    let service = binding
        ...
        .platform_state
        .midi
        .windows_midi_service("destack.midi.event.tryReadBatch")?;
