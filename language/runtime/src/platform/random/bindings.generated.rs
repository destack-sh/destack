...
use crate::platform::random::{RandomStream, RandomStreamDomain, RandomStreamState, RandomStreamStateValue, RandomStreamStateVm, RandomstreamstateReplayRecord, SecureRandomMetadata, SecureRandomMetadataValue, SecureRandomMetadataVm, SecureRandomSource, SecurerandommetadataReplayRecord};
...
use crate::platform::random::{native as platform_runtime_native, vm as platform_runtime_vm};
...
fn encode_destack_random_secure_metadata_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.source as u8 as u64, 8)); let field_1: RuntimeResult<vm::Value> = Ok(value.backend_name.value()); let field_2: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.may_block)); let field_3: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_cryptographic)); let field_4: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_seeded)); let field_5: RuntimeResult<vm::Value> = Ok(vm::Value::bool(value.is_fips_approved)); let field_6: RuntimeResult<vm::Value> = Ok(vm::Value::float64(value.entropy_bits_per_byte)); context.allocate_aggregate(vec![field_0?, field_1?, field_2?, field_3?, field_4?, field_5?, field_6?]).map_err(Box::<RuntimeError>::from) })
}
...
fn encode_destack_random_stream_export_result(
    ...
    result.and_then(|value| { let field_0: RuntimeResult<vm::Value> = Ok(vm::Value::uint(value.version as u64, 32)); let field_1: RuntimeResult<vm::Value> = value.bytes.to_value(context); context.allocate_aggregate(vec![field_0?, field_1?]).map_err(Box::<RuntimeError>::from) })
}
...
fn decode_destack_random_stream_import_args(
    ...
    let state = {
        if state_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("state", "RandomStreamState")).boxed()); }
        let slots = context.aggregate_slots(state_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 2 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("state", "expected 2 fields")).boxed()); }
...
fn decode_destack_random_stream_in_args(
    ...
    let domain = match domain_raw { 1u8 => RandomStreamDomain::Process, 2u8 => RandomStreamDomain::Task , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("domain", "unknown RandomStreamDomain value")).boxed()), };
    Ok((domain,))
}
...
pub(crate) const RANDOM_SECURE_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_SECURE_BYTES_TRY: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_SECURE_METADATA: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_CREATE: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_FILL_BYTES: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_IN: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_NEXT_U64: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_NEXT_U64_FROM: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_STREAM_SPLIT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const RANDOM_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "random",
    bindings: &[
        NativeBinding::new(RANDOM_SECURE_BYTES, "destack.random.secure.bytes", destack_random_secure_bytes as *const ()),
        NativeBinding::new(RANDOM_SECURE_BYTES_TRY, "destack.random.secure.bytesTry", destack_random_secure_bytes_try as *const ()),
        NativeBinding::new(RANDOM_SECURE_METADATA, "destack.random.secure.metadata", destack_random_secure_metadata as *const ()),
        NativeBinding::new(RANDOM_STREAM_CREATE, "destack.random.stream.create", destack_random_stream_create as *const ()),
        NativeBinding::new(RANDOM_STREAM_EXPORT, "destack.random.stream.export", destack_random_stream_export as *const ()),
        NativeBinding::new(RANDOM_STREAM_FILL_BYTES, "destack.random.stream.fillBytes", destack_random_stream_fill_bytes as *const ()),
        NativeBinding::new(RANDOM_STREAM_FILL_BYTES_FROM, "destack.random.stream.fillBytesFrom", destack_random_stream_fill_bytes_from as *const ()),
        NativeBinding::new(RANDOM_STREAM_IMPORT, "destack.random.stream.import", destack_random_stream_import as *const ()),
        NativeBinding::new(RANDOM_STREAM_IN, "destack.random.stream.in", destack_random_stream_in as *const ()),
        NativeBinding::new(RANDOM_STREAM_JUMP, "destack.random.stream.jump", destack_random_stream_jump as *const ()),
        NativeBinding::new(RANDOM_STREAM_NEXT_U64, "destack.random.stream.nextU64", destack_random_stream_next_u64 as *const ()),
        NativeBinding::new(RANDOM_STREAM_NEXT_U64_FROM, "destack.random.stream.nextU64From", destack_random_stream_next_u64_from as *const ()),
        NativeBinding::new(RANDOM_STREAM_SPLIT, "destack.random.stream.split", destack_random_stream_split as *const ()),
    ],
};
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            if let Ok(()) = result {
                ...
                let result_recorded_backend_name = unsafe { result_value.backend_name.as_str()? }.to_string();
            ...
            if let Err(error) = result {
                let payload = {
                    ...
                    RandomSecureMetadataReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
        ...
        |payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let value_native_backend_name = binding.store_string(value.backend_name.as_str());
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    RandomStreamExportReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
    ...
    binding.trace().run_binding_without_context(
        ...
        |result| {
            ...
            if let Err(error) = result {
                let payload = {
                    let result = Err(TraceError::from(error.as_ref()));
                    RandomStreamImportReplayRecord {
                        result,
                    }
                };
                return Ok(Some(payload));
...
pub(crate) unsafe extern "C" fn destack_random_stream_fill_bytes_from(
    ...
    native_call(|context| {
        ...
        context.trace().run_random_bytes(
            ...
            || {
                {
            let _binding_hook_guard = context.on_before_binding(RANDOM_STREAM_FILL_BYTES_FROM)?;
            unsafe { platform_runtime_native::destack_random_fill_bytes_from(context, stream, buffer) }
        }
            },
            || {
                let slice = unsafe { buffer.as_slice()? };
...
pub(crate) unsafe extern "C" fn destack_random_stream_next_u64(
    out: *mut u64,
) -> RuntimeStatus {
    native_call(|context| {
        if out.is_null() {
...
pub(crate) unsafe extern "C" fn destack_random_stream_next_u64_from(
    ...
    native_call(|context| {
        ...
        let value = context.trace().run_random_u64(
            ...
            || {
            {
            let _binding_hook_guard = context.on_before_binding(RANDOM_STREAM_NEXT_U64_FROM)?;
            unsafe { platform_runtime_native::destack_random_next_u64_from(context, out, stream) }
        }?;
            unsafe { Ok(*out) }
            },
        )?;
        ...
        |context, result| {
            ...
            if let Ok(value) = result {
                ...
                let result_recorded_backend_name = {
                    let result_recorded_backend_name_ref = context.string_ref(result_value.backend_name).map_err(|error| RuntimeError::from(error).boxed())?;
        ...
        |context, payload| {
            ...
            match payload.result {
                Ok(value) => {
                    ...
                    let vm_result_backend_name = context.string_handle(value.backend_name.as_str()).map_err(Box::<RuntimeError>::from)?;
...
fn destack_random_stream_import_vm_replay(
    ...
    let result = binding.trace().run_binding(
        ...
        binding.replay_payload_for(RANDOM_STREAM_IMPORT)?,
        context,
        |context| platform_runtime_vm::destack_random_stream_import(binding, context, stream, state),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_recorded = ();
...
pub(crate) fn register_random_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, RANDOM_SECURE_BYTES, move |context, args| {
            with_binding_call_context(|binding| {
                ...
                let result = binding.trace().run_random_bytes(
                    ...
                    || {
                        unsafe { {
                        let _binding_hook_guard = binding.on_before_binding(RANDOM_SECURE_BYTES)?;
                        platform_runtime_vm::destack_random_secure_bytes(binding, &mut *context_ptr, buffer)
                    } }
                    },
    ...
    {
        binding!(registry, isolate, RANDOM_SECURE_BYTES_TRY, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                let result = binding.trace().run_random_bytes(
                    ...
                    || {
                        ...
                        platform_runtime_vm::destack_random_secure_bytes_try(binding, &mut *context_ptr, buffer)
                    } }
                    },
                    || unsafe { buffer.read_bytes(&*context_ptr) },
                    |bytes| unsafe { buffer.write_bytes(&mut *context_ptr, &bytes) },
    ...
    {
        binding!(registry, isolate, RANDOM_SECURE_METADATA, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_CREATE, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_EXPORT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_FILL_BYTES, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                let result = binding.trace().run_random_bytes(
                    ...
                    || {
                        unsafe { {
                        let _binding_hook_guard = binding.on_before_binding(RANDOM_STREAM_FILL_BYTES)?;
                        platform_runtime_vm::destack_random_fill_bytes(binding, &mut *context_ptr, buffer)
                    } }
                    },
                    || unsafe { buffer.read_bytes(&*context_ptr) },
                    |bytes| unsafe { buffer.write_bytes(&mut *context_ptr, &bytes) },
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_FILL_BYTES_FROM, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                let (stream, buffer) = decode_destack_random_stream_fill_bytes_from_args(context, args)?;
                ...
                let result = binding.trace().run_random_bytes(
                    ...
                    || {
                        unsafe { {
                        let _binding_hook_guard = binding.on_before_binding(RANDOM_STREAM_FILL_BYTES_FROM)?;
                        platform_runtime_vm::destack_random_fill_bytes_from(binding, &mut *context_ptr, stream, buffer)
                    } }
                    },
                    || unsafe { buffer.read_bytes(&*context_ptr) },
                    |bytes| unsafe { buffer.write_bytes(&mut *context_ptr, &bytes) },
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_IMPORT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_JUMP, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_NEXT_U64, move |context, _args| {
            with_binding_call_context(|binding| {
                // execute binding
                let result = binding.trace().run_random_u64(
                    ...
                    || {
                    {
                        let _binding_hook_guard = binding.on_before_binding(RANDOM_STREAM_NEXT_U64)?;
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_NEXT_U64_FROM, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
                ...
                let result = binding.trace().run_random_u64(
                    ...
                    || {
                    {
                        let _binding_hook_guard = binding.on_before_binding(RANDOM_STREAM_NEXT_U64_FROM)?;
                        platform_runtime_vm::destack_random_next_u64_from(binding, context, stream)
                    }
                    },
                );
    ...
    {
        binding!(registry, isolate, RANDOM_STREAM_SPLIT, move |context, args| {
            with_binding_call_context(|binding| {
                // decode args
