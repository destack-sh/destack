...
fn decode_destack_security_capability_has_args(
    ...
    let capability = crate::platform::security::PlatformCapabilityAbi::<crate::platform::abi::VmAbi>(
        capability_inner,
    );
    Ok((capability,))
}
...
fn destack_security_sandbox_enter_replay(
    ...
    context.replay().run_binding(
        SECURITY_SANDBOX_ENTER,
        || unsafe { platform_native::destack_security_sandbox_enter(context, out, name) },
        |result| {
            if let Ok(()) = result {
...
fn destack_security_sandbox_exit_replay(
    ...
    context.replay().run_binding(
        SECURITY_SANDBOX_EXIT,
        || unsafe { platform_native::destack_security_sandbox_exit(context, handle) },
        |result| {
            if let Ok(()) = result {
                let result_replay = ();
...
pub unsafe extern "C" fn destack_security_capability_has(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_capability_has(context, out, capability) }
    })
}
...
pub unsafe extern "C" fn destack_security_capability_list(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_capability_list(context, out) }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_install_filter(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_sandbox_install_filter(context, handle, filter) }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_seal(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_sandbox_seal(context, handle) }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_set_capabilities(
    ...
    native_call(|context| {
        ...
        unsafe {
            platform_native::destack_security_sandbox_set_capabilities(
                context,
                handle,
                capabilities,
            )
...
pub unsafe extern "C" fn destack_security_policy_get(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_policy_get(context, out, scope) }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_get_rules(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_policy_get_rules(context, out, scope) }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_set(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_policy_set(context, scope, capabilities) }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_set_rules(
    ...
    native_call(|context| {
        ...
        unsafe { platform_native::destack_security_policy_set_rules(context, scope, rules) }
    })
}
...
fn destack_security_sandbox_enter_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        SECURITY_SANDBOX_ENTER,
        context,
        |context| platform_vm::destack_security_sandbox_enter(runtime, context, name),
        |context, result| {
            let _ = &context;
...
fn destack_security_sandbox_exit_vm_replay(
    ...
    let result = runtime.replay().run_binding_with_context(
        SECURITY_SANDBOX_EXIT,
        context,
        |context| platform_vm::destack_security_sandbox_exit(runtime, context, handle),
        |context, result| {
            let _ = &context;
            if let Ok(()) = result {
                let result_replay = ();
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_security_capability_has(runtime, context, capability);
        ...
        binding!(
            ...
            move |context, _args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_capability_list(runtime, context);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_sandbox_install_filter(
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_security_sandbox_seal(runtime, context, handle);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_sandbox_set_capabilities(
                        runtime,
                        context,
                        handle,
                        capabilities,
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_policy_get(runtime, context, scope);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result =
                        platform_vm::destack_security_policy_get_rules(runtime, context, scope);
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_policy_set(
                        runtime,
                        context,
                        scope,
                        capabilities,
        ...
        binding!(
            ...
            move |context, args| {
                with_runtime_call_context(|runtime| {
                    ...
                    // execute binding
                    let result = platform_vm::destack_security_policy_set_rules(
