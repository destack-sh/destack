...
use crate::platform::security::{PlatformCapability, PlatformCapabilityVm, SecurityFilter, SecurityFilterKind, SecurityFilterVm, SecurityPolicyRule, SecurityPolicyRuleVm};
...
use crate::platform::security::runtime::{native as platform_runtime_native, vm as platform_runtime_vm};
use crate::platform::security::simulated::{native as platform_simulated_native, vm as platform_simulated_vm};
...
fn decode_destack_security_capability_has_args(
    ...
    let capability_inner = decode_string(capability_value, "capability_inner", "PlatformCapability")?;
    let capability = platform_security::PlatformCapabilityAbi::<platform_abi::VmAbi>(capability_inner);
    Ok((capability,))
}
...
fn decode_destack_security_enforce_sandbox_install_filter_args(
    ...
    let filter = {
        if filter_value.tag() != vm::ValueTag::Aggregate { return Err(RuntimeError::from(PlatformError::invalid_argument_type("filter", "SecurityFilter")).boxed()); }
        let slots = context.aggregate_slots(filter_value).map_err(|error| RuntimeError::from(error).boxed())?;
        if slots.len() != 4 { return Err(RuntimeError::from(PlatformError::invalid_argument_value("filter", "expected 4 fields")).boxed()); }
        let filter_kind_raw = decode_uint8(slots[0], "filter_kind_raw", "kind")?;
        let filter_kind = match filter_kind_raw { 1u8 => SecurityFilterKind::SeccompBpf, 2u8 => SecurityFilterKind::Landlock, 3u8 => SecurityFilterKind::Pledge, 4u8 => SecurityFilterKind::Unveil, 5u8 => SecurityFilterKind::Seatbelt, 6u8 => SecurityFilterKind::WindowsToken, 255u8 => SecurityFilterKind::Custom , _ => return Err(RuntimeError::from(PlatformError::invalid_argument_value("filter_kind", "unknown SecurityFilterKind value")).boxed()), };
...
fn decode_destack_security_enforce_sandbox_set_capabilities_args(
    ...
    let capabilities = decode_slice::<PlatformCapabilityVm>(context, capabilities_value, "capabilities", "Slice<PlatformCapability>")?;
...
fn decode_destack_security_policy_set_rules_args(
    ...
    let rules = decode_slice::<SecurityPolicyRuleVm>(context, rules_value, "rules", "Slice<SecurityPolicyRule>")?;
    Ok((scope, rules))
}
...
pub const SECURITY_CAPABILITY_LIST: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub const SECURITY_ENFORCE_SANDBOX_SEAL: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub const SECURITY_SANDBOX_ENTER: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const SECURITY_SANDBOX_EXIT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub const SECURITY_NATIVE_BINDINGS: NativeBindingSet = NativeBindingSet {
    name: "security",
    bindings: &[
        NativeBinding::new(SECURITY_CAPABILITY_HAS, "destack.security.capability.has", destack_security_capability_has as *const ()),
        NativeBinding::new(SECURITY_CAPABILITY_LIST, "destack.security.capability.list", destack_security_capability_list as *const ()),
        NativeBinding::new(SECURITY_ENFORCE_SANDBOX_INSTALL_FILTER, "destack.security.enforce.sandboxInstallFilter", destack_security_enforce_sandbox_install_filter as *const ()),
        NativeBinding::new(SECURITY_ENFORCE_SANDBOX_SEAL, "destack.security.enforce.sandboxSeal", destack_security_enforce_sandbox_seal as *const ()),
        NativeBinding::new(SECURITY_ENFORCE_SANDBOX_SET_CAPABILITIES, "destack.security.enforce.sandboxSetCapabilities", destack_security_enforce_sandbox_set_capabilities as *const ()),
        NativeBinding::new(SECURITY_POLICY_GET, "destack.security.policy.get", destack_security_policy_get as *const ()),
        NativeBinding::new(SECURITY_POLICY_GET_RULES, "destack.security.policy.getRules", destack_security_policy_get_rules as *const ()),
        NativeBinding::new(SECURITY_POLICY_SET, "destack.security.policy.set", destack_security_policy_set as *const ()),
        NativeBinding::new(SECURITY_POLICY_SET_RULES, "destack.security.policy.setRules", destack_security_policy_set_rules as *const ()),
        NativeBinding::new(SECURITY_SANDBOX_ENTER, "destack.security.sandbox.enter", destack_security_sandbox_enter as *const ()),
        NativeBinding::new(SECURITY_SANDBOX_EXIT, "destack.security.sandbox.exit", destack_security_sandbox_exit as *const ()),
    ],
};
...
pub unsafe extern "C" fn destack_security_capability_has(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_CAPABILITY_HAS)?; unsafe { platform_runtime_native::destack_security_capability_has(context, out, capability) } }
    })
}
...
pub unsafe extern "C" fn destack_security_capability_list(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_CAPABILITY_LIST)?; unsafe { platform_runtime_native::destack_security_capability_list(context, out) } }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_install_filter(
    ...
    native_call(|context| {
...

        {
            ...
            match world {
                RuntimeWorld::Host => unsafe { platform_native::destack_security_sandbox_install_filter(context, handle, filter) },
                RuntimeWorld::Simulated => unsafe { platform_simulated_native::destack_security_sandbox_install_filter(context, handle, filter) },
            }
        }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_seal(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_ENFORCE_SANDBOX_SEAL)?; unsafe { platform_runtime_native::destack_security_sandbox_seal(context, handle) } }
    })
}
...
pub unsafe extern "C" fn destack_security_enforce_sandbox_set_capabilities(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_ENFORCE_SANDBOX_SET_CAPABILITIES)?; unsafe { platform_runtime_native::destack_security_sandbox_set_capabilities(context, handle, capabilities) } }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_get(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_POLICY_GET)?; unsafe { platform_runtime_native::destack_security_policy_get(context, out, scope) } }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_get_rules(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_POLICY_GET_RULES)?; unsafe { platform_runtime_native::destack_security_policy_get_rules(context, out, scope) } }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_set(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_POLICY_SET)?; unsafe { platform_runtime_native::destack_security_policy_set(context, scope, capabilities) } }
    })
}
...
pub unsafe extern "C" fn destack_security_policy_set_rules(
    ...
    native_call(|context| {
        ...
        { context.check_policy(SECURITY_POLICY_SET_RULES)?; unsafe { platform_runtime_native::destack_security_policy_set_rules(context, scope, rules) } }
    })
}
...
pub fn register_security_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
    {
        binding!(registry, isolate, SECURITY_CAPABILITY_HAS, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (capability,) = decode_destack_security_capability_has_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_CAPABILITY_HAS)?; platform_runtime_vm::destack_security_capability_has(runtime, context, capability) };
    ...
    {
        binding!(registry, isolate, SECURITY_CAPABILITY_LIST, move |context, _args| {
            with_runtime_call_context(|runtime| {
                // execute binding
                let result = { runtime.check_policy(SECURITY_CAPABILITY_LIST)?; platform_runtime_vm::destack_security_capability_list(runtime, context) };
    ...
    {
        binding!(registry, isolate, SECURITY_ENFORCE_SANDBOX_INSTALL_FILTER, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, filter) = decode_destack_security_enforce_sandbox_install_filter_args(context, args)?;

                // execute binding
                let result = {
                        let world = runtime.check_and_resolve_world(SECURITY_ENFORCE_SANDBOX_INSTALL_FILTER)?;
                        match world {
                            RuntimeWorld::Host => platform_vm::destack_security_sandbox_install_filter(runtime, context, handle, filter),
                            RuntimeWorld::Simulated => platform_simulated_vm::destack_security_sandbox_install_filter(runtime, context, handle, filter),
                        }
                    };
    ...
    {
        binding!(registry, isolate, SECURITY_ENFORCE_SANDBOX_SEAL, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle,) = decode_destack_security_enforce_sandbox_seal_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_ENFORCE_SANDBOX_SEAL)?; platform_runtime_vm::destack_security_sandbox_seal(runtime, context, handle) };
    ...
    {
        binding!(registry, isolate, SECURITY_ENFORCE_SANDBOX_SET_CAPABILITIES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (handle, capabilities) = decode_destack_security_enforce_sandbox_set_capabilities_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_ENFORCE_SANDBOX_SET_CAPABILITIES)?; platform_runtime_vm::destack_security_sandbox_set_capabilities(runtime, context, handle, capabilities) };
    ...
    {
        binding!(registry, isolate, SECURITY_POLICY_GET, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (scope,) = decode_destack_security_policy_get_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_POLICY_GET)?; platform_runtime_vm::destack_security_policy_get(runtime, context, scope) };
    ...
    {
        binding!(registry, isolate, SECURITY_POLICY_GET_RULES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (scope,) = decode_destack_security_policy_get_rules_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_POLICY_GET_RULES)?; platform_runtime_vm::destack_security_policy_get_rules(runtime, context, scope) };
    ...
    {
        binding!(registry, isolate, SECURITY_POLICY_SET, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (scope, capabilities) = decode_destack_security_policy_set_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_POLICY_SET)?; platform_runtime_vm::destack_security_policy_set(runtime, context, scope, capabilities) };
    ...
    {
        binding!(registry, isolate, SECURITY_POLICY_SET_RULES, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
                let (scope, rules) = decode_destack_security_policy_set_rules_args(context, args)?;

                // execute binding
                let result = { runtime.check_policy(SECURITY_POLICY_SET_RULES)?; platform_runtime_vm::destack_security_policy_set_rules(runtime, context, scope, rules) };
    ...
    {
        binding!(registry, isolate, SECURITY_SANDBOX_ENTER, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
    ...
    {
        binding!(registry, isolate, SECURITY_SANDBOX_EXIT, move |context, args| {
            with_runtime_call_context(|runtime| {
                // decode args
...
pub fn install_security_vm_bindings(
    registry: &mut BindingRegistry,
    isolate: &mut Isolate,
) {
