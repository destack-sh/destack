...
pub(crate) const SECURITY_CAPABILITY_LIST: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub(crate) const SECURITY_ENFORCE_SANDBOX_SEAL: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub(crate) const SECURITY_ENFORCE_SET_WRITE_XOR_EXECUTE: BindingDescriptor = BindingDescriptor::deterministic_with_requires_and_behavior(
...
pub(crate) const SECURITY_SANDBOX_ENTER: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) const SECURITY_SANDBOX_EXIT: BindingDescriptor = BindingDescriptor::external_with_requires_and_behavior(
...
pub(crate) fn register_security_vm_bindings(
