...
/// Resolve one stable application identifier for macOS host integrations.
...
/// Return the current executable path for macOS host identity fallback logic.
...
/// Return one best-effort executable display name for macOS host identity fallbacks.
