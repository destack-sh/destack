...
pub(crate) const MACOS_LIFECYCLE_DID_BECOME_ACTIVE: u32 = 1;
/// macOS lifecycle code for `applicationWillResignActive`.
pub(crate) const MACOS_LIFECYCLE_WILL_RESIGN_ACTIVE: u32 = 2;
/// macOS lifecycle code for `applicationWillTerminate`.
pub(crate) const MACOS_LIFECYCLE_WILL_TERMINATE: u32 = 3;
/// macOS memory pressure code for normal state.
pub(crate) const MACOS_MEMORY_PRESSURE_NORMAL: u32 = 0;
/// macOS memory pressure code for warning state.
pub(crate) const MACOS_MEMORY_PRESSURE_WARNING: u32 = 1;
/// macOS memory pressure code for critical state.
pub(crate) const MACOS_MEMORY_PRESSURE_CRITICAL: u32 = 2;
/// macOS thermal code for nominal state.
pub(crate) const MACOS_THERMAL_NOMINAL: u32 = 0;
/// macOS thermal code for fair state.
pub(crate) const MACOS_THERMAL_FAIR: u32 = 1;
/// macOS thermal code for serious state.
pub(crate) const MACOS_THERMAL_SERIOUS: u32 = 2;
/// macOS thermal code for critical state.
pub(crate) const MACOS_THERMAL_CRITICAL: u32 = 3;
/// macOS power mode code for normal state.
pub(crate) const MACOS_POWER_MODE_NORMAL: u32 = 0;
/// macOS power mode code for low power state.
pub(crate) const MACOS_POWER_MODE_LOW_POWER: u32 = 1;
...
// lifecycle decode
pub(crate) fn decode_macos_application_lifecycle(
    lifecycle_code: u32,
...
pub(crate) fn decode_macos_memory_pressure_level(
    level_code: u32,
...
// thermal decode
pub(crate) fn decode_macos_thermal_state(thermal_code: u32) -> RuntimeResult<HostThermalState> {
...
// power mode decode
pub(crate) fn decode_macos_power_mode(power_mode_code: u32) -> RuntimeResult<HostPowerMode> {
