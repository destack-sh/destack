...
macro_rules! for_each_resource_handle_kind {
    ($macro:ident) => {
        $macro! {
            ...
            (ComputeDeviceHandle, ComputeDevice, "host.compute.device", "compute_device", "The handle for one compute device."),
            (ComputeStreamHandle, ComputeStream, "host.compute.stream", "compute_stream", "The handle for one compute command stream."),
            (ComputeEventHandle, ComputeEvent, "host.compute.event", "compute_event", "The handle for one compute stream completion event."),
            (ComputeProgramHandle, ComputeProgram, "host.compute.program", "compute_program", "The handle for one compiled compute program."),
            (ComputeKernelHandle, ComputeKernel, "host.compute.kernel", "compute_kernel", "The handle for one compute kernel entry point."),
            (ComputeKernelArgumentHandle, ComputeKernelArgument, "host.compute.kernel.argument", "compute_kernel_argument", "The handle for one encoded compute kernel argument."),
            (ComputeMeshHandle, ComputeMesh, "host.compute.mesh", "compute_mesh", "The handle for one compute device mesh."),
