...
/// Notify the runtime host about one NetBsd application lifecycle transition.
#[unsafe(no_mangle)]
...
/// Notify the runtime host with one NetBsd permission result.
#[unsafe(no_mangle)]
...
/// Notify the runtime host that interruption state changed on NetBsd.
#[unsafe(no_mangle)]
...
/// Notify the runtime host that memory pressure changed on NetBsd.
#[unsafe(no_mangle)]
...
/// Notify the runtime host that thermal state changed on NetBsd.
#[unsafe(no_mangle)]
...
/// Notify the runtime host that power mode changed on NetBsd.
#[unsafe(no_mangle)]
...
/// Notify the runtime host that wall clock changed on NetBsd.
#[unsafe(no_mangle)]
