...
use crate::host::abi::text::{HostTextInputConfiguration, HostTextInputGeometry, HostTextInputGeometryRequest, HostTextInputOpenRequest, HostTextInputRange, HostTextInputRectangle, HostTextInputState, HostTextInputStateRequest, HostTextInputTransform2D, HostTextInputType};
use crate::platform::NativeAbiCodec;
use crate::platform::abi::{NativeStringRef, NativeStringRef as PlatformNativeStringRef};
use crate::platform::input::{InputTextInputType, InputTextRange, InputTextRectangle, InputTextSessionConfig, InputTextSessionStateValue, InputTextTransform2D};
    ...
    pub(crate) fn new(
        ...
        let abi = HostTextInputGeometryRequest {
            ...
            geometry: HostTextInputGeometry {
                ...
                composing_rectangle: composing_rectangle.map(host_text_rectangle).unwrap_or_default(),
            },
        };
