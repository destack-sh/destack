...
impl HostBackgroundTaskOptionsPayload {
    ...
    pub(crate) fn new(options: &BackgroundTaskOptionsValue) -> Self {
        ...
        Self {
            _identifier_storage: identifier_storage,
            abi,
        }
    }
...
pub(crate) fn decode_event(event: HostBackgroundEvent) -> RuntimeResult<BackgroundEventValue> {
    ...
    match event.kind {
        HostBackgroundEventKind::TaskReady => Ok(BackgroundEventValue::BackgroundTaskReadyEvent(
            BackgroundTaskReadyEventValue {
                kind: "taskReady".to_string(),
                metadata,
            },
        )),
        HostBackgroundEventKind::TaskExpired => Ok(
