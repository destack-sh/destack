...
/// Haiku host adapter implementation.
#[derive(Debug)]
...
impl HaikuHostAdapter {
    ...
    pub(crate) fn new() -> Self {
        ...
        let registration = register_host_bridge(HostPlatform::Haiku, &bridge);
        let services = build_haiku_services(bridge.state_store());
...
/// Build Haiku host service trait surfaces from one shared state object.
fn build_haiku_services(state_store: &Arc<HostStateStore>) -> HostServices {
