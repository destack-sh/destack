...
pub use android::{
    ...
    AndroidHostMidiPortDescriptorHeader, AndroidHostSignHardwareKeyCallback,
    ...
    destack_host_android_midi_output_write, destack_host_android_notify_activity_lifecycle,
