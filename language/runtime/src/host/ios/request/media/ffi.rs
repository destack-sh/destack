use super::call_ios_media_callback;
use crate::host::core::HOST_STATUS_INVALID_ARGUMENT;
use crate::runtime::{NativeSlice, NativeStringRef};

/// List iOS media assets through the host.
#[unsafe(no_mangle)]
...
/// Describe one iOS media asset through the host.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_media_describe(
    runtime_id: u64,
    id: NativeStringRef,
    output: NativeSlice<u8>,
    output_written: *mut u32,
...
/// Import one path into the iOS media library through the host.
#[unsafe(no_mangle)]
...
/// Delete iOS media assets through the host.
#[unsafe(no_mangle)]
...
/// Open one iOS media watch through the host.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_media_watch_open(
    runtime_id: u64,
...
/// Close one iOS media watch through the host.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_media_watch_close(
    runtime_id: u64,
    watch_id: NativeStringRef,
) -> u32 {
    call_ios_media_callback(
