...
pub(crate) type IosHostLocationServicesEnabledCallback =
    unsafe extern "C" fn(session_handle: u64, is_enabled: *mut bool) -> u32;

/// The host callback for `last_known`.
pub(crate) type IosHostLocationLastKnownCallback =
    unsafe extern "C" fn(session_handle: u64, sample: *mut LocationSample) -> u32;

/// The host callback for `watch_open`.
pub(crate) type IosHostLocationWatchOpenCallback =
    unsafe extern "C" fn(session_handle: u64, watch_id: NativeStringRef, options: LocationWatchOptions) -> u32;
...
pub(super) fn call_ios_location_callback<T: Copy>(
    ...
    invoke_ios_binding_callback(session_handle, |bindings| resolve(&bindings.location), invoke)
}
