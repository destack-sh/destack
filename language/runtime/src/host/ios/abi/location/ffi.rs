use super::callbacks::call_ios_location_callback;
...
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_location_services_enabled(
    runtime_id: u64,
    is_enabled: *mut bool,
) -> u32 {
...
/// Read one iOS last-known location sample.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_location_last_known(
    runtime_id: u64,
...
/// Open one iOS location watch.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_location_watch_open(
    runtime_id: u64,
...
/// Close one iOS location watch.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_location_watch_close(
    runtime_id: u64,
    watch_id: NativeStringRef,
) -> u32 {
    call_ios_location_callback(
