...
use super::callbacks::{call_ios_text_callback, IosHostTextCallbacks};
...
/// Forward the `open` text request through the iOS host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `close` text request through the iOS host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `set_geometry` text request through the iOS host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `set_state` text request through the iOS host ABI.
#[unsafe(no_mangle)]
