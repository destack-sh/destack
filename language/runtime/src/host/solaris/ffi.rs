...
/// Notify the runtime host state that one solaris window became available.
#[unsafe(no_mangle)]
...
/// Notify the runtime host state that one solaris window terminated.
#[unsafe(no_mangle)]
...
/// Notify the runtime host state that one solaris window resized.
#[unsafe(no_mangle)]
...
/// Notify the runtime host state that one solaris window focus changed.
#[unsafe(no_mangle)]
