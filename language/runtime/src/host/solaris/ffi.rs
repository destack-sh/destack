...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_host_solaris_notify_window_available(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_host_solaris_notify_window_terminated(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_host_solaris_notify_window_resized(
    runtime_id: u64,
    width_px: u32,
    height_px: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_host_solaris_notify_window_focus_changed(
    runtime_id: u64,
    is_focused: bool,
) -> RuntimeStatus {
