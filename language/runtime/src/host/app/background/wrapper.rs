...
use super::runtime::DESKTOP_BACKGROUND_TASK_IDENTIFIER_ENV;
use super::storage::{background_wrapper_script_path, ensure_background_scheduler_directory};

/// Write one persisted background wrapper script for the current runtime invocation.
pub(super) fn write_background_wrapper_script(
