...
pub(in crate::host::app::background) fn background_scheduler_directory(
...
pub(in crate::host::app::background) fn ensure_background_scheduler_directory(
    context: &HostRequestContext,
) -> RuntimeResult<PathBuf> {
...
pub(in crate::host::app::background) fn background_scheduler_key(identifier: &str) -> String {
...
pub(in crate::host::app::background) fn background_wrapper_script_path(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<PathBuf> {
    let directory = background_scheduler_directory(context)?;
...
pub(in crate::host::app::background) fn background_launchd_label(
    context: &HostRequestContext,
    identifier: &str,
...
pub(in crate::host::app::background) fn background_launchd_plist_path(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<PathBuf> {
...
#[cfg(target_os = "linux")]
pub(in crate::host::app::background) fn background_systemd_service_path(
    identifier: &str,
) -> RuntimeResult<PathBuf> {
...
#[cfg(target_os = "linux")]
pub(in crate::host::app::background) fn background_systemd_timer_path(
    identifier: &str,
) -> RuntimeResult<PathBuf> {
    let directory = background_systemd_user_directory()?;
    let key = background_scheduler_key(identifier);
...
pub(in crate::host::app::background) fn background_task_directory(
    context: &HostRequestContext,
) -> RuntimeResult<PathBuf> {
    let root = background_state_directory(context)?;
...
pub(in crate::host::app::background) fn background_task_record_path(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<PathBuf> {
