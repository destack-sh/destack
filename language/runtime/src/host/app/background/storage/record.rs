...
pub(in crate::host::app::background) fn ensure_background_task_directory(
...
pub(in crate::host::app::background) fn read_background_task_records(
    context: &HostRequestContext,
...
pub(in crate::host::app::background) fn read_background_task_record(
    context: &HostRequestContext,
    identifier: &str,
...
pub(in crate::host::app::background) fn write_background_task_record(
    context: &HostRequestContext,
...
pub(in crate::host::app::background) fn remove_background_task_record(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<()> {
    let path = background_task_record_path(context, identifier)?;
