...
use crate::host::app::background::runtime::{
    desktop_background_test_mode_enabled, enqueue_test_background_launch,
};
use crate::host::app::background::storage::{
...
use crate::host::app::background::wrapper::write_background_wrapper_script;

/// Return whether the active host exposes one desktop background scheduler.
pub(in crate::host::app::background) fn background_status() -> RuntimeResult<BackgroundStatusValue>
{
...
pub(in crate::host::app::background) fn register_background_task(
...
pub(in crate::host::app::background) fn unregister_background_task(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<()> {
...
pub(in crate::host::app::background) fn trigger_background_task(
    context: &HostRequestContext,
    identifier: &str,
) -> RuntimeResult<bool> {
    if desktop_background_test_mode_enabled() {
