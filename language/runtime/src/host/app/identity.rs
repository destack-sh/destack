...
/// Resolve one stable application identifier for host-facing integrations.
...
/// Resolve one human-facing display name for host integrations.
...
/// Resolve one host-facing icon path for desktop integrations.
#[cfg(windows)]
...
/// Return the current executable path for host identity fallback logic.
...
/// Return one best-effort executable display name for host identity fallbacks.
