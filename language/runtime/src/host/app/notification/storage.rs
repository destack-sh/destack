...
pub(super) struct DesktopScheduledNotificationRecord {
...
impl DesktopScheduledNotificationRecord {
    ...
    pub(super) fn descriptor(&self) -> NotificationScheduledDescriptorValue {
...
pub(super) fn read_notification_records(
...
pub(super) fn read_notification_record(
    context: &HostRequestContext,
    id: &str,
...
pub(super) fn write_notification_record(
    context: &HostRequestContext,
...
pub(super) fn remove_notification_record(
    context: &HostRequestContext,
    id: &str,
) -> RuntimeResult<()> {
    let path = notification_record_path(context, id)?;
...
pub(super) fn ensure_notification_record_directory(
    context: &HostRequestContext,
...
pub(super) fn notification_scheduler_directory(
    context: &HostRequestContext,
) -> RuntimeResult<PathBuf> {
...
pub(super) fn ensure_notification_scheduler_directory(
    context: &HostRequestContext,
) -> RuntimeResult<PathBuf> {
...
pub(super) fn notification_scheduler_key(id: &str) -> String {
...
pub(super) fn notification_wrapper_script_path(
    context: &HostRequestContext,
    id: &str,
) -> RuntimeResult<PathBuf> {
    let directory = notification_scheduler_directory(context)?;
...
#[cfg(target_os = "linux")]
pub(super) fn notification_systemd_service_path(id: &str) -> RuntimeResult<PathBuf> {
...
#[cfg(target_os = "linux")]
pub(super) fn notification_systemd_timer_path(id: &str) -> RuntimeResult<PathBuf> {
    let directory = notification_systemd_user_directory()?;
    let key = notification_scheduler_key(id);
