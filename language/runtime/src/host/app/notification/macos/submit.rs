...
pub(in crate::host::app::notification) fn deliver_notification(
    ...
    submit_notification_request(
        ...
        MacosNotificationPayload {
            host_runtime_id: context.host_runtime_id.0,
        ...
        let completion = RcBlock::new(
            ...
            >| {
                ...
                for request in pending.iter() {
                    match pending_descriptor_from_native_request(&request, host_runtime_id) {
...
pub(in crate::host::app::notification) fn unregister_runtime(_host_runtime_id: HostRuntimeId) {}
