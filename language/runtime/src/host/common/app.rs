...
pub(crate) fn require_declared_request(
    ...
    let requirements = declaration_requirements_for_request(platform, request);
...
pub(crate) fn declaration_requirements_for_request(
    platform: Platform,
    request: &HostRequest,
...
#[cfg(test)]
mod tests {
    use super::{HostRequestRequirement, declaration_requirements_for_request};
    ...
    fn test_request_requirements_leave_document_pick_declaration_free() {
        ...
        let requirements = declaration_requirements_for_request(Platform::MacOS, &request);
    ...
    fn test_request_requirements_require_ios_query_scheme_for_can_open_url() {
        ...
        let requirements = declaration_requirements_for_request(Platform::IOS, &request);
    ...
    fn test_request_requirements_require_android_file_share_declaration() {
        ...
        let requirements = declaration_requirements_for_request(Platform::Android, &request);
    ...
    fn test_request_requirements_leave_non_android_file_share_declaration_free() {
        ...
        let requirements = declaration_requirements_for_request(Platform::Windows, &request);
