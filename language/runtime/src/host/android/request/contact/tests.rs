...
use crate::host::android::{
    AndroidHostBindings, AndroidHostContactCallbacks, destack_host_android_contact_create,
    destack_host_android_contact_delete, destack_host_android_contact_list,
    destack_host_android_contact_read, destack_host_android_contact_search,
