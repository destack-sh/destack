        ...
        HostRequest::OsCalendarList => {
            let calendars = read_buffered_callback_host_json::<Vec<CalendarDescriptorValue>>(
                ...
                |output, output_written| unsafe {
                    destack_host_android_calendar_list(runtime_id, output, output_written)
                },
            )?;
...
fn submit_calendar_event_list(
    ...
    read_buffered_callback_host_json(
        ...
        "calendar events",
        |output, output_written| unsafe {
            destack_host_android_calendar_event_list(runtime_id, payload, output, output_written)
        },
    )
}
...
fn submit_calendar_event_read(
    ...
    read_buffered_callback_host_json(
        ...
        "calendar event",
        |output, output_written| unsafe {
            destack_host_android_calendar_event_read(runtime_id, id, output, output_written)
        },
    )
}
...
fn submit_calendar_event_create(
    ...
    read_buffered_callback_host_string(operation, |output_id, output_written| unsafe {
        destack_host_android_calendar_event_create(runtime_id, payload, output_id, output_written)
    })
}
...
fn submit_calendar_event_update(
    ...
    let call_status =
        unsafe { destack_host_android_calendar_event_update(runtime_id, id, payload) };
