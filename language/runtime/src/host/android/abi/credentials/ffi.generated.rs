...
use super::callbacks::{call_android_credentials_callback, AndroidHostCredentialsCallbacks};
...
pub(crate) unsafe extern "C" fn destack_host_android_credentials_read(
    ...
    call_android_credentials_callback(
        ...
        |callback| unsafe { callback(session_handle, service, account, access_group, require_authentication, output, output_written, created_unix_ns, modified_unix_ns) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_credentials_write(
    ...
    call_android_credentials_callback(
        ...
        |callback| unsafe { callback(session_handle, service, account, access_group, payload, accessibility, authentication_policy, replace_existing) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_credentials_authenticate(
    ...
    call_android_credentials_callback(
        ...
        |callback| unsafe { callback(session_handle, title, subtitle, message, requirement, authenticated, mechanism) },
    )
}
