...
use crate::host::abi::text::HostTextRepositoryState;
...
pub(crate) unsafe extern "C" fn destack_host_android_notify_text_input_state(
    runtime_id: u64,
    session_id: u64,
    state: *const HostTextRepositoryState,
) -> RuntimeStatus {
...
unsafe fn decode_text_input_state(state: HostTextRepositoryState) -> InputTextSessionStateValue {
    let text =
