...
pub(crate) struct AndroidHostUsbDeviceDescriptorHeader {
    ...
    pub usb_version_bcd: crate::host::abi::core::HostAbiOptional<u16>,
    /// Device release version in binary coded decimal form.
    pub device_version_bcd: crate::host::abi::core::HostAbiOptional<u16>,
    ...
    /// Device speed code.
    pub speed: crate::host::abi::core::HostAbiOptional<u32>,
    /// Bus number when available.
    pub bus_number: crate::host::abi::core::HostAbiOptional<u8>,
}
