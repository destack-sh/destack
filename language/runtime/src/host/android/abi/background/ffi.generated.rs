...
/// Forward the `status` background request through the Android host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `list` background request through the Android host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `register_task` background request through the Android host ABI.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_android_background_register_task(
    session_handle: u64,
...
/// Forward the `unregister` background request through the Android host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `trigger_test` background request through the Android host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `complete` background request through the Android host ABI.
#[unsafe(no_mangle)]
