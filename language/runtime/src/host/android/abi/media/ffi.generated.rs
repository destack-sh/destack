...
/// Forward the `read` media request through the Android host ABI.
#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_android_media_read(
    session_handle: u64,
...
/// Forward the `import_path` media request through the Android host ABI.
#[unsafe(no_mangle)]
...
/// Forward the `delete` media request through the Android host ABI.
#[unsafe(no_mangle)]
