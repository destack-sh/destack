...
use super::callbacks::{call_android_crypto_callback, AndroidHostCryptoCallbacks};
use crate::host::core::HOST_STATUS_INVALID_ARGUMENT;
use crate::platform::abi::{NativeSlice};
use crate::platform::abi::NativeStringRef;
use crate::host::android::abi::bindings::resolve_android_binding_callback;
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_generate_hardware_key_pair(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, store_kind, key_algorithm, named_curve, modulus_bits, public_exponent, key_label) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_generate_hardware_secret_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, store_kind, key_algorithm, digest_algorithm, key_size_bits, key_usage_mask, key_label) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_export_hardware_public_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, output, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_sign_hardware_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, signature_algorithm, digest_algorithm, salt_length_bytes, payload, output_signature, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_decrypt_hardware_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, encryption_algorithm, digest_algorithm, label, payload, output_plaintext, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_encrypt_hardware_secret_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, cipher_algorithm, nonce, additional_data, tag_length_bytes, payload, output_ciphertext, output_tag, output_ciphertext_written, output_tag_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_decrypt_hardware_secret_key(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, cipher_algorithm, nonce, additional_data, tag, payload, output_plaintext, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_compute_hardware_mac(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, mac_algorithm, digest_algorithm, tag_length_bytes, payload, output_tag, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_derive_hardware_shared_secret(
    ...
    call_android_crypto_callback(
        ...
        |callback| unsafe { callback(session_handle, key_algorithm, key_label, named_curve, peer_public_spki, output_shared_secret, output_written) },
    )
}
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_supports_hardware_key_pair(
    ...
    let callbacks = match resolve_android_binding_callback(session_handle, |bindings| Some(bindings.crypto)) {
    ...
    let is_supported = (callbacks.generate_hardware_key_pair.is_some()) && (callbacks.export_hardware_public_key.is_some()) && (callbacks.sign_hardware_key.is_some()) && (callbacks.delete_hardware_key.is_some()) && (((key_algorithm == 1) && (callbacks.decrypt_hardware_key.is_some())) || ((key_algorithm == 2) && (callbacks.derive_hardware_shared_secret.is_some())));
    if !is_supported {
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_supports_hardware_secret_key(
    ...
    let is_supported = (callbacks.generate_hardware_secret_key.is_some()) && (callbacks.delete_hardware_key.is_some()) && (((key_algorithm == 3) && (callbacks.encrypt_hardware_secret_key.is_some()) && (callbacks.decrypt_hardware_secret_key.is_some())) || ((key_algorithm == 4) && (callbacks.compute_hardware_mac.is_some())));
    if !is_supported {
        return HOST_STATUS_NOT_SUPPORTED;
    }
...
pub(crate) unsafe extern "C" fn destack_host_android_crypto_supports_certificate_write(
    ...
    let is_supported = ((store_kind == 1) || (store_kind == 2) || (store_kind == 3)) && (callbacks.import_certificate.is_some()) && (callbacks.delete_certificate.is_some());
    if !is_supported {
        return HOST_STATUS_NOT_SUPPORTED;
    }
