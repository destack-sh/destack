use crate::host::android::abi::{HOST_STATUS_NOT_FOUND, HOST_STATUS_NOT_SUPPORTED, HOST_STATUS_OK};
use crate::host::android::bridge::midi::tests::callbacks::test_callbacks;
