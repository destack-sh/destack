...
use crate::host::os::apple::ingress::ios_notify_text_input_state;

#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_notify_text_input_state(
    runtime_id: u64,
    event: *const HostTextInputEvent,
) -> RuntimeStatus {
    let result = (|| {
        if event.is_null() {
        ...
        ios_notify_text_input_state(runtime_id, event)
    })();
