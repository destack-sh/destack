...
pub unsafe fn destack_host_ios_notify_interruption_changed(
    runtime_id: u64,
    interrupted: bool,
) -> RuntimeStatus {
...
pub unsafe fn destack_host_ios_notify_memory_pressure_changed(
    runtime_id: u64,
    level_code: u32,
) -> RuntimeStatus {
...
pub unsafe fn destack_host_ios_notify_thermal_state_changed(
    runtime_id: u64,
    thermal_code: u32,
) -> RuntimeStatus {
...
pub unsafe fn destack_host_ios_notify_power_mode_changed(
    runtime_id: u64,
    power_mode_code: u32,
) -> RuntimeStatus {
...
pub unsafe fn destack_host_ios_notify_wall_clock_changed(runtime_id: u64) -> RuntimeStatus {
    runtime_status(ios_notify_wall_clock_changed(runtime_id))
}

pub unsafe fn destack_host_ios_notify_wake(runtime_id: u64) -> RuntimeStatus {
