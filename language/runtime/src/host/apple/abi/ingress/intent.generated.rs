...
use crate::host::os::apple::ingress::ios_notify_intent_event;

#[unsafe(no_mangle)]
pub(crate) unsafe extern "C" fn destack_host_ios_notify_intent_event(
    runtime_id: u64,
    ...
    let result = (|| {
        ...
        ios_notify_intent_event(runtime_id, event)
    })();
