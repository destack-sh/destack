...
impl Clock {
    ...
    pub(crate) fn image(&self) -> ClockImage {
        ClockImage {
    ...
    pub(crate) fn restore(&self, image: &ClockImage) {
        self.runtime_clock.restore(image.wall, image.monotonic);
    }
}
...
impl RuntimeClock {
    ...
    pub(crate) fn restore(&self, wall: Instant, mono: Instant) {
