...
#[cfg(any(test, target_os = "android"))]
pub use android::{
    AndroidActivityLifecycle, AndroidHostCryptoCallbacks, AndroidHostDecryptHardwareKeyCallback,
    ...
    android_notify_window_terminated, destack_runtime_host_android_crypto_callbacks_abi_version,
    ...
    destack_runtime_host_android_notify_window_terminated, set_android_host_crypto_callbacks,
};
...
pub use windows::{
    ...
    destack_runtime_host_windows_notify_memory_pressure_changed,
    destack_runtime_host_windows_notify_permission_result,
    destack_runtime_host_windows_notify_power_mode_changed,
    destack_runtime_host_windows_notify_thermal_state_changed,
    destack_runtime_host_windows_notify_wake,
    destack_runtime_host_windows_notify_wall_clock_changed,
    destack_runtime_host_windows_notify_window_available,
    destack_runtime_host_windows_notify_window_focus_changed,
...
#[cfg(any(test, target_os = "linux"))]
pub use linux::{
    LinuxApplicationLifecycle, destack_runtime_host_linux_notify_application_lifecycle,
    ...
    destack_runtime_host_linux_notify_window_terminated, linux_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "freebsd"))]
pub use freebsd::{
    FreeBsdApplicationLifecycle, destack_runtime_host_freebsd_notify_application_lifecycle,
    ...
    destack_runtime_host_freebsd_notify_window_terminated, freebsd_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "dragonfly"))]
pub use dragonfly::{
    DragonflyApplicationLifecycle, destack_runtime_host_dragonfly_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "netbsd"))]
pub use netbsd::{
    NetBsdApplicationLifecycle, destack_runtime_host_netbsd_notify_application_lifecycle,
    ...
    destack_runtime_host_netbsd_notify_window_terminated, netbsd_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "openbsd"))]
pub use openbsd::{
    OpenBsdApplicationLifecycle, destack_runtime_host_openbsd_notify_application_lifecycle,
    ...
    destack_runtime_host_openbsd_notify_window_terminated, openbsd_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "illumos"))]
pub use illumos::{
    IllumosApplicationLifecycle, destack_runtime_host_illumos_notify_application_lifecycle,
    ...
    destack_runtime_host_illumos_notify_window_terminated, illumos_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "solaris"))]
pub use solaris::{
    SolarisApplicationLifecycle, destack_runtime_host_solaris_notify_application_lifecycle,
    ...
    destack_runtime_host_solaris_notify_window_terminated, solaris_notify_application_lifecycle,
...
#[cfg(any(test, target_os = "haiku"))]
pub use haiku::{
    HaikuApplicationLifecycle, destack_runtime_host_haiku_notify_application_lifecycle,
    destack_runtime_host_haiku_notify_interruption_changed,
    destack_runtime_host_haiku_notify_memory_pressure_changed,
    destack_runtime_host_haiku_notify_permission_result,
    destack_runtime_host_haiku_notify_power_mode_changed,
    destack_runtime_host_haiku_notify_thermal_state_changed,
    destack_runtime_host_haiku_notify_wake, destack_runtime_host_haiku_notify_wall_clock_changed,
    destack_runtime_host_haiku_notify_window_available,
    destack_runtime_host_haiku_notify_window_focus_changed,
    destack_runtime_host_haiku_notify_window_resized,
    destack_runtime_host_haiku_notify_window_terminated, haiku_notify_application_lifecycle,
