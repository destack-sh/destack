...
/// Notify the runtime host bridge about one illumos application lifecycle transition.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_application_lifecycle(
    runtime_id: u64,
    lifecycle_code: u32,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that one illumos window became available.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_window_available(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_window_terminated(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_window_resized(
    runtime_id: u64,
    width_px: u32,
    height_px: u32,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that one illumos window focus changed.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_window_focus_changed(
    runtime_id: u64,
    is_focused: bool,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_permission_result(
    runtime_id: u64,
...
/// Notify the runtime host bridge that interruption state changed on illumos.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_interruption_changed(
    runtime_id: u64,
    interrupted: bool,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that memory pressure changed on illumos.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_memory_pressure_changed(
    runtime_id: u64,
    level_code: u32,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that thermal state changed on illumos.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_thermal_state_changed(
    runtime_id: u64,
    thermal_code: u32,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that power mode changed on illumos.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_power_mode_changed(
    runtime_id: u64,
    power_mode_code: u32,
) -> RuntimeStatus {
...
/// Notify the runtime host bridge that wall clock changed on illumos.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_wall_clock_changed(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_illumos_notify_wake(
    runtime_id: u64,
) -> RuntimeStatus {
