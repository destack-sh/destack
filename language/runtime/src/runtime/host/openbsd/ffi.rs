...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_application_lifecycle(
    runtime_id: u64,
    lifecycle_code: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_window_available(
    runtime_id: u64,
) -> RuntimeStatus {
    unix_runtime_status(openbsd_notify_window_available(runtime_id))
}

/// Notify the runtime host bridge that one openbsd window terminated.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_window_terminated(
    runtime_id: u64,
) -> RuntimeStatus {
    unix_runtime_status(openbsd_notify_window_terminated(runtime_id))
}

/// Notify the runtime host bridge that one openbsd window resized.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_window_resized(
    runtime_id: u64,
    width_px: u32,
    height_px: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_window_focus_changed(
    runtime_id: u64,
    is_focused: bool,
) -> RuntimeStatus {
    unix_runtime_status(openbsd_notify_window_focus_changed(runtime_id, is_focused))
}

/// Notify the runtime host bridge with one openbsd permission result.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_permission_result(
    runtime_id: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_interruption_changed(
    runtime_id: u64,
    interrupted: bool,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_memory_pressure_changed(
    runtime_id: u64,
    level_code: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_thermal_state_changed(
    runtime_id: u64,
    thermal_code: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_power_mode_changed(
    runtime_id: u64,
    power_mode_code: u32,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_wall_clock_changed(
    runtime_id: u64,
) -> RuntimeStatus {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn destack_runtime_host_openbsd_notify_wake(
    runtime_id: u64,
) -> RuntimeStatus {
