...
/// macOS host adapter implementation.
#[derive(Debug)]
...
impl MacosHostAdapter {
    ...
    pub(crate) fn new() -> Self {
        ...
        let services = build_macos_services(bridge.state_store());
...
/// Build macOS host service trait surfaces from one shared state object.
fn build_macos_services(state_store: &Arc<HostStateStore>) -> HostServices {
