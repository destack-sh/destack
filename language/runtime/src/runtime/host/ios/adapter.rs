...
impl IosHostAdapter {
    ...
    pub(crate) fn new() -> Self {
        ...
        let services = build_ios_services(bridge.state_store());
...
/// Build iOS host service trait surfaces from one shared state object.
fn build_ios_services(state_store: &Arc<HostStateStore>) -> HostServices {
