...
impl RuntimeGenerator {
    ...
    fn write_module_stubs(
        ...
        use crate::emit::{
            render_host_router_stub, render_host_stub, render_module_mod_stub, render_native_stub,
            render_os_backend_mod_stub, render_simulation_mod_stub, render_simulation_native_stub,
            render_simulation_vm_stub, render_vm_stub,
        };
        ...
        let native_stub = render_native_stub(&module.name, bindings);
