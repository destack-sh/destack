use crate::time::{HostClock, VirtualClock, WallClockPolicy};
...
pub struct Clock {
    ...
    // NOTE #Incomplete: enforce wall clock policy in bindings
    /// Wall clock policy used for host time access.
    wall_clock_policy: WallClockPolicy,
    // NOTE #Incomplete: apply the time zone to wall clock formatting helpers
