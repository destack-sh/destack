...
use crate::host::android::abi::crypto::destack_host_android_crypto_compute_hardware_mac as runtime_crypto_compute_hardware_mac;
use crate::host::android::abi::crypto::destack_host_android_crypto_decrypt_hardware_key as runtime_crypto_decrypt_hardware_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_decrypt_hardware_secret_key as runtime_crypto_decrypt_hardware_secret_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_delete_certificate as runtime_crypto_delete_certificate;
use crate::host::android::abi::crypto::destack_host_android_crypto_delete_hardware_key as runtime_crypto_delete_hardware_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_derive_hardware_shared_secret as runtime_crypto_derive_hardware_shared_secret;
use crate::host::android::abi::crypto::destack_host_android_crypto_encrypt_hardware_secret_key as runtime_crypto_encrypt_hardware_secret_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_export_hardware_public_key as runtime_crypto_export_hardware_public_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_generate_hardware_key_pair as runtime_crypto_generate_hardware_key_pair;
use crate::host::android::abi::crypto::destack_host_android_crypto_generate_hardware_secret_key as runtime_crypto_generate_hardware_secret_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_import_certificate as runtime_crypto_import_certificate;
use crate::host::android::abi::crypto::destack_host_android_crypto_sign_hardware_key as runtime_crypto_sign_hardware_key;
use crate::host::android::abi::crypto::destack_host_android_crypto_supports_hardware_key as runtime_crypto_supports_hardware_key;
...
pub unsafe extern "C" fn destack_host_android_crypto_supports_hardware_key(
    ...
    unsafe {
        runtime_crypto_supports_hardware_key(
            session_handle,
            store_kind,
        )
    }
...
pub unsafe extern "C" fn destack_host_android_crypto_delete_hardware_key(
    ...
    unsafe {
        runtime_crypto_delete_hardware_key(
            session_handle,
            key_algorithm,
            key_label,
        )
...
pub unsafe extern "C" fn destack_host_android_crypto_import_certificate(
    ...
    unsafe {
        runtime_crypto_import_certificate(
            session_handle,
            store_kind,
            certificate_der,
        )
...
pub unsafe extern "C" fn destack_host_android_crypto_delete_certificate(
    ...
    unsafe {
        runtime_crypto_delete_certificate(
            session_handle,
            store_kind,
            certificate_der,
        )
