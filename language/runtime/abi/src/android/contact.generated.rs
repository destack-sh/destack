...
use crate::host::android::abi::contact::{
    destack_host_android_contact_create as runtime_contact_create,
    destack_host_android_contact_delete_contact as runtime_contact_delete_contact,
    destack_host_android_contact_list as runtime_contact_list,
    destack_host_android_contact_read as runtime_contact_read,
    destack_host_android_contact_search as runtime_contact_search,
    destack_host_android_contact_update as runtime_contact_update,
};
