...
use crate::host::android::abi::credentials::{
    destack_host_android_credentials_authenticate as runtime_credentials_authenticate,
    destack_host_android_credentials_contains as runtime_credentials_contains,
    destack_host_android_credentials_delete as runtime_credentials_delete,
    destack_host_android_credentials_read as runtime_credentials_read,
    destack_host_android_credentials_write as runtime_credentials_write,
};
...
pub unsafe extern "C" fn destack_host_android_credentials_contains(
    ...
    unsafe {
        runtime_credentials_contains(session_handle, service, account, access_group, is_present)
    }
}
