...
use crate::host::apple::abi::contact::{
    destack_host_ios_contact_create as runtime_contact_create,
    destack_host_ios_contact_delete_contact as runtime_contact_delete_contact,
    destack_host_ios_contact_list as runtime_contact_list,
    destack_host_ios_contact_read as runtime_contact_read,
    destack_host_ios_contact_search as runtime_contact_search,
    destack_host_ios_contact_update as runtime_contact_update,
};
...
pub unsafe extern "C" fn destack_host_ios_contact_delete_contact(
    ...
    unsafe { runtime_contact_delete_contact(session_handle, id) }
}
