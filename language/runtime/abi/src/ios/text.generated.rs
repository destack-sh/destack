...
use crate::host::apple::abi::text::{
    destack_host_ios_text_close as runtime_text_close,
    destack_host_ios_text_open as runtime_text_open,
    destack_host_ios_text_set_geometry as runtime_text_set_geometry,
