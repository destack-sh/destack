...
import RuntimeHostAppleCore
  ...
  /// The iOS text request surface backed by one hidden UIKit editor.
  @MainActor
  public final class UIKitTextRequests: NSObject, TextRequests, UITextViewDelegate {
    ...
    /// Create one UIKit text request surface.
    public init(
...
#else
  /// The explicit non-UIKit text request surface used for host builds without UIKit.
  @MainActor
  public final class UIKitTextRequests: TextRequests {
    /// Create one unsupported UIKit text request surface.
    public init(
      events: any TextEvents
    ) {
      let _ = events
