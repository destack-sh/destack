...
define_language_items! {
    ...
    /// Simulation types.
    simulation {
        /// `destack:simulation/binding`.
        binding {
            /// Simulated binding attempt.
            SimulationAttempt => (
                Struct,
                "simulation/binding/attempt",
                "Attempt",
                "simulation.binding.Attempt"
            ),

            /// Simulated call identity.
            SimulationCallId => (
                Newtype,
                "simulation/binding/attempt",
                "CallId",
                "simulation.binding.CallId"
            ),

            /// Simulated binding event kind.
            SimulationEventKind => (
                Enum,
                "simulation/binding/attempt",
                "EventKind",
                "simulation.binding.EventKind"
            ),

            /// Simulated binding selector.
            SimulationBindingSelector => (
                Struct,
                "simulation/binding/selector",
                "Selector",
                "simulation.binding.Selector"
            ),
        }

        /// `destack:simulation/fault`.
        fault {
            /// Simulated clock fault.
            SimulationClockFault => (
                Newtype,
                "simulation/fault/fault",
                "ClockFault",
                "simulation.fault.ClockFault"
            ),

            /// Simulated consistency fault.
            SimulationConsistencyFault => (
                Enum,
                "simulation/fault/fault",
                "ConsistencyFault",
                "simulation.fault.ConsistencyFault"
            ),

            /// Simulated corruption mode.
            SimulationCorruptionMode => (
                Enum,
                "simulation/fault/fault",
                "CorruptionMode",
                "simulation.fault.CorruptionMode"
            ),

            /// Simulated corruption target.
            SimulationCorruptionTarget => (
                Enum,
                "simulation/fault/fault",
                "CorruptionTarget",
                "simulation.fault.CorruptionTarget"
            ),

            /// Custom simulated fault.
            SimulationCustomFault => (
                Struct,
                "simulation/fault/fault",
                "CustomFault",
                "simulation.fault.CustomFault"
            ),

            /// Simulated durability fault.
            SimulationDurabilityFault => (
                Enum,
                "simulation/fault/fault",
                "DurabilityFault",
                "simulation.fault.DurabilityFault"
            ),
            ...
            SimulationError => (
                ...
                "simulation/fault/fault",
                "Error",
                "simulation.fault.Error"
            ),

            /// Simulated operation error code.
            SimulationErrorCode => (
                Newtype,
                "simulation/fault/fault",
                "ErrorCode",
                "simulation.fault.ErrorCode"
            ),
            ...
            SimulationFaultSet => (
                ...
                "simulation/fault/fault",
                "FaultSet",
                "simulation.fault.FaultSet"
            ),

            /// Simulated jitter distribution.
            SimulationJitterDistribution => (
                Enum,
                "simulation/fault/fault",
                "JitterDistribution",
                "simulation.fault.JitterDistribution"
            ),

            /// Simulated lifecycle fault.
            SimulationLifecycleFault => (
                Newtype,
                "simulation/fault/fault",
                "LifecycleFault",
                "simulation.fault.LifecycleFault"
            ),

            /// Simulated operation fault.
            SimulationOperationFault => (
                Newtype,
                "simulation/fault/fault",
                "OperationFault",
                "simulation.fault.OperationFault"
            ),

            /// Simulated ordering fault.
            SimulationOrderFault => (
                Enum,
                "simulation/fault/fault",
                "OrderFault",
                "simulation.fault.OrderFault"
            ),

            /// Simulated random fault.
            SimulationRandomFault => (
                Newtype,
                "simulation/fault/fault",
                "RandomFault",
                "simulation.fault.RandomFault"
            ),

            /// Simulated constrained resource.
            SimulationResource => (
                Enum,
                "simulation/fault/fault",
                "Resource",
                "simulation.fault.Resource"
            ),

            /// Simulated resource fault.
            SimulationResourceFault => (
                Newtype,
                "simulation/fault/fault",
                "ResourceFault",
                "simulation.fault.ResourceFault"
            ),

            /// Simulated resource limit value.
            SimulationResourceLimitValue => (
                Newtype,
                "simulation/fault/fault",
                "ResourceLimitValue",
                "simulation.fault.ResourceLimitValue"
            ),

            /// Simulated storage fault.
            SimulationStorageFault => (
                Newtype,
                "simulation/fault/fault",
                "StorageFault",
                "simulation.fault.StorageFault"
            ),

            /// Simulated transport fault.
            SimulationTransportFault => (
                Newtype,
                "simulation/fault/fault",
                "TransportFault",
                "simulation.fault.TransportFault"
            ),

            /// Simulated transport limit mode.
            SimulationTransportLimitMode => (
                Newtype,
                "simulation/fault/fault",
                "TransportLimitMode",
                "simulation.fault.TransportLimitMode"
            ),

            /// Triggered simulated fault.
            SimulationTriggeredFault => (
                Struct,
                "simulation/fault/fault",
                "TriggeredFault",
                "simulation.fault.TriggeredFault"
            ),
        }
        ...
        scenario {
            ...
            /// Simulation scenario rule identity.
            ScenarioRuleId => (
                Newtype,
                "simulation/scenario/rule",
                "RuleId",
                "simulation.scenario.RuleId"
            ),
        ...
        /// `destack:simulation/simulation`.
        simulation {
            /// Registered simulation case.
            SimulationCase => (Struct, "simulation/simulation/case", "Case"),
            ...
            /// Simulation runner.
            Simulation => (Class, "simulation/simulation/simulation", "Simulation"),

            /// Registered simulation suite.
            SimulationSuite => (Struct, "simulation/simulation/case", "Suite"),
        }
    }
