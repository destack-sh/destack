/// One named HTML entity table.
///
/// The leading ampersand is omitted from the key.
use std::collections::HashMap;
use std::sync::LazyLock;

pub(crate) static NAMED_ENTITIES: &[(&str, (u32, u32))] = &[
    ("COP", (0, 0)),
    ("dblac;", (733, 0)),
    ("dw", (0, 0)),
    ("Zf", (0, 0)),
...
/// Return one named HTML entity value.
pub(crate) fn lookup_named_entity(name: &str) -> Option<(u32, u32)> {
    // indexed lookup
    static ENTITY_LOOKUP: LazyLock<HashMap<&'static str, (u32, u32)>> = LazyLock::new(|| {
        NAMED_ENTITIES
            .iter()
            .copied()
            .collect::<HashMap<&'static str, (u32, u32)>>()
    });

    ENTITY_LOOKUP.get(name).copied()
}
