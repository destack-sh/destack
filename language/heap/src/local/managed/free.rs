use super::{EdgeId, ManagedLocation, ManagedSpace};
...
impl ManagedSpace {
    ...
    pub(crate) fn release_small_slot(&mut self, slot: crate::arena::SpanSlot) -> HeapResult<()> {
        let pages = {
            ...
            span.set_edge_id(slot_index, EdgeId::empty());
            ...
            if span.occupied_count == 0 {
                ...
                span.pages = crate::arena::PageView::empty();
