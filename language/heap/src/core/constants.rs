...
use crate::allocator::{DEFAULT_MAX_SMALL_ALLOCATION_BYTES, DEFAULT_PAGE_SIZE_BYTES};

/// The standard small-span width for size-classed allocation.
pub const DEFAULT_SMALL_SIZE_BYTES: usize = DEFAULT_PAGE_SIZE_BYTES * 10;
...
pub(crate) const DEFAULT_CARD_SIZE_BYTES: usize = DEFAULT_PAGE_SIZE_BYTES / 32;
