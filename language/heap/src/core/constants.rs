use crate::{DEFAULT_HEAP_PAGE_SIZE_BYTES, SizeClassPolicy};
...
pub const DEFAULT_SHARED_SMALL_SIZE_BYTES: usize = 1024 * 1024;

/// The standard virtual byte capacity for one forkable heap space.
pub const DEFAULT_MEMORY_MAP_SIZE_BYTES: usize = if cfg!(target_pointer_width = "64") {
    64 * 1024 * 1024 * 1024
} else {
    256 * 1024 * 1024
};
