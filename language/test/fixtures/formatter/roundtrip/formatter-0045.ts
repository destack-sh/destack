...
interface AnimationDefinition {
    ...
    options: Omit<NativeAnimationOptions, "keyframes"> & { keyframes?: ValueKeyframe[] };
}
...
export function animateElements(
    ...
    const elements = resolveElements(elementOrSelector, scope) as Array<HTMLElement | SVGElement>;
    ...
    for (let i = 0; i < animationDefinitions.length; i++) {
        ...
        const animation = new NativeAnimation(animationOptions as NativeAnimationOptions);
