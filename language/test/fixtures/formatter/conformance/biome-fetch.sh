...
SUITE_NAME="biome"
SUITE_VERSION="1.x"
SUITE_REF="${BIOME_REF:-9f1b3b06586401b39e0aa886bf7c8484fd2a6ded}"
...
PATHS=(
    "crates/biome_js_formatter/tests/specs"
    "crates/biome_js_formatter/tests/prettier_tests"
    "crates/biome_js_formatter/tests"
)
