declare namespace "bun" {
  ...
  export class RedisClient {
     ...
     */
    onconnect: ((self: RedisClient) => void) | null;
     ...
     *
     * @param source File list key
     * @param destination BlockTarget list key
    ...
    /**
     * Return a serializsed version of the value stored at the specified key
     * @param key The key to dump
     * @returns Promise that resolves with the serializsed value, or null if the
     * key doesn't exist
     */
    ...
    zdiff(
      numkeys: number,
      ...args: [string, ...RedisClient.KeyLike[], "WITHSCORES"]
    ): Promise<[string, number][]>;
