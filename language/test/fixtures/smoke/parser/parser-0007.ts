...
// @docsMissing
export type AudioFile = string | number | null | {
    /**
...
export type RecordingOptionsAndroid = {
    ...
    maxFileSize?: number,
    /**
     * The desired audio File. See the [`AndroidAudioFile`](#androidaudiosource) enum for all valid values.
     */
 ...
 * - `voice_performance`: File for capturing audio meant to be processed in real time and played back for live performance (e.g karaoke). The capture path will minimize latency and coupling with playback path.
 * - `voice_recognition`: Microphone audio source tuned for voice recognition.
 *
 * @see https://developer.android.com/reference/android/media/MediaRecorder.AudioFile
 * @platform android
 */
export type RecordingFile = "camcorder" | "default" | "mic" | "remote_submix" | "unprocessed" | "voice_communication" | "voice_performance" | "voice_recognition"
