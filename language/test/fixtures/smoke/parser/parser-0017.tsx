...
const hasPosthogJsFailedToLoadFeaturePreviews = (): boolean =>
  !!window.POSTHOG_GLOBAL_ERRORS?.onFeatureFlagsLoadError;
...
export function FeaturePreviews(): JSX.Element {
  ...
  const failedToLoadFeaturePreviews =
    earlyAccessFeatures.length === 0 && hasPosthogJsFailedToLoadFeaturePreviews();
      ...
      <div className="flex flex-col">
        <div>
          ...
          <LemonBanner type="info" className="mb-4">
            "Note that toggling these features will enable it for your account only. Each individual
            user in your organization will need to enable it separately."
          </LemonBanner>
            ...
            <LemonBanner type="warning" className="mb-4">
              <div className="flex flex-col gap-2">
                ...
                <span className="italic">
                  "Note: If you use feature flags for your app, you can avoid this issue for your
                  users by using a reverse proxy."
                </span>
              </div>
            </LemonBanner>
          )}
...
function ConceptPreview({ feature }: { feature: EnrichedEarlyAccessFeature }): JSX.Element {
  const { updateEarlyAccessFeatureEnrollment, copyExternalFeaturePreviewLink } =
      ...
      actions={
        <div className="flex flex-col gap-2">
          <LemonButton
            ...
            disabledReason={
              enabled &&
              "You have already expressed your interest. We'll contact you when it's ready"
            }
