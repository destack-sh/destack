...
export namespace JSC {
  ...
  export namespace Debugger {
    ...
    export type ScriptFailedToParseEvent = {
      ...
      url: string;
      /**
       * File text of the script that failed to parse.
       */
      scriptFile: string;
      /**
     ...
     * @request `Debugger.getScriptFile`
     */
    export type GetScriptFileRequest = {
      /**
    ...
    /**
     * Returns source for the script with given id.
     * @response `Debugger.getScriptFile`
     */
    export type GetScriptFileResponse = {
      /**
       * Script source.
       */
      scriptFile: string;
  ...
  export namespace LifecycleReporter {
    ...
    export type ErrorEvent = {
      ...
      lineColumns: number[];
      /**
       * File code preview associated with the error for up to 5 lines before the error, relative to the first non-internal stack frame.
       */
      sourceLines: string[];
    };
    /**
  ...
  export namespace TestReporter {
    export type TestStatus = "pass" | "fail" | "timeout" | "skip" | "skipped_because_label";
  ...
  export type RequestMap = {
    ...
    "Debugger.getScriptFile": Debugger.GetScriptFileRequest;
  ...
  export type ResponseMap = {
    ...
    "Debugger.getScriptFile": Debugger.GetScriptFileResponse;
