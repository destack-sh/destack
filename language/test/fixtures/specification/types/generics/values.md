...
Comptime value parameters used in type expressions.
Comptime value parameters must be marked with `comptime`.

## value parameters

### comptime value parameters require comptime modifiers
...
### comptime value parameters apply to sized arrays
...
### comptime value parameters pass through type aliases

> Comptime value parameters can be passed through type aliases.
...
### comptime value defaults can reference earlier parameters
...
### comptime value parameters accept string literals
...
### comptime value parameters accept boolean literals
...
### comptime value parameters accept bigint literals
...
### comptime value parameters accept arithmetic expressions
...
### comptime value parameters accept string unions
...
### comptime value parameters reject non members from unions
...
### comptime value parameters reject mismatched string arguments
...
### comptime value parameters reject mismatched boolean arguments
...
### comptime value parameters reject mismatched bigint arguments
...
### comptime value parameters reject non static expressions
...
### comptime value parameters reject enum members for numeric types
...
### comptime value parameters accept tuple expressions
...
### comptime value parameters reject mismatched tuples

> Tuple comptime arguments must match the declared tuple type.
...
### comptime value parameters accept array expressions
...
### comptime value parameters reject mismatched arrays
...
### comptime value parameters accept object expressions
...
### comptime value parameters reject mismatched objects
...
### comptime value inference uses literal arguments
...
### comptime value inference uses boolean literals
...
### comptime value inference uses string literals
...
### comptime value inference uses number literals
...
### comptime value inference uses bigint literals
...
### comptime value inference accepts tuple literals
...
### comptime value inference accepts object literals
...
### comptime value inference accepts enum members
...
### comptime value parameters accept local constants
...
### comptime value inference rejects non literals
...
### comptime value parameters reject non static constants
