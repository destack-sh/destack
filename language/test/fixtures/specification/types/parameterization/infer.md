...
Renamed re-exports should preserve const literal precision at imported call sites.
...
Export-star forwarding should keep mutable-source widening behavior.
...
Namespace imports should preserve const ternary union precision at generic call sites.
...
Namespace imports should keep mutable ternary widening behavior at generic call sites.
...
Const literals should satisfy constrained generic parameters with literal precision.
...
Widened mutable literals should not satisfy constrained literal generic parameters.
...
Const ternary unions should remain precise when inferring constrained generic parameters.
...
Mutable ternary literals should widen and fail constrained literal generic inference.
...
Const object literals should preserve discriminants through constrained generic inference.
...
Widened object discriminants should fail constrained literal generic inference.
...
Template span inference should keep const span literals under constrained generics.
...
Widened mutable strings should not satisfy constrained template span generics.
