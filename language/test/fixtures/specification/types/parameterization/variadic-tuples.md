...
Tail extraction with a variadic tuple should keep the literal precision of preserved head elements.
...
Concatenating const tuples through variadic parameters should retain fixed-length literal tuple precision.
...
Concatenating mutable arrays through variadic tuples should widen to array-compatible element types.
...
Rest-parameter inference over tuple inputs should preserve element order in the inferred tuple result.
