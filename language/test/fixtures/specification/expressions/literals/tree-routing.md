# Tree Literal Routing

Tree literal routing and resolution behavior.

## Value Tags

### structural component tag is allowed

> Value tags can be resolved from TSX-style structural component shape.
...
### open shape spread is rejected when noDynamicShapes is enabled
