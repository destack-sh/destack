...
- **Array shapes**: Vector and tensor style array-shape composition through associated values and aliases.
- **Type operators**: Conditional and mapped type interactions with associated projections.
...
- `array-shapes.md`: Array-shape composition through associated members.
- `type-operators.md`: Type-operator interactions with associated members.
