...
declare_program! {
    /// Matrix multiply with fixed 32x32 tiles.
    pub const MATMUL_32,
    name: "matmul_32",
    source: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../fixtures/mirbench/arithmetic/matmul_32.mir")),
    entry: "matmul_32",
    expected: || matmul_32(10_000),
...
/// Compute the expected value for the matmul 32 benchmark.
fn matmul_32(iterations: i64) -> Value {
    // return value
    Value::int64(matmul_tile(iterations, 32))
}
