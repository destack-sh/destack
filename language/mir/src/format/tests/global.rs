...
entry:
    v0: ref<int32, borrowed, 'static & local, mutable> = global.address counter
    v1: int32 = load v0
    v2: int32 = 1
    v3: int32 = add v1, v2
    store v0, v3
...
entry:
    v0: ref<int64, borrowed, 'static & local, readonly> = global.address MAGIC
    v1: int64 = load v0
    return v1
}
"#,
...
entry:
    v0: ref<[uint8; 11], borrowed, 'static & local, readonly> = global.address stringLiteralHelloWorldNl
    v1: [uint8; 11] = load v0
    return
}
"#,
