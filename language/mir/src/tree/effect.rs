...
use crate::{AddressSpace, EffectRegionSet};
...
impl MemoryEffect {
    ...
    pub const fn read_only(regions: EffectRegionSet) -> Self {
        Self {
            reads: true,
            writes: false,
            regions,
    ...
    pub const fn write_only(regions: EffectRegionSet) -> Self {
        Self {
            reads: false,
            writes: true,
            regions,
    ...
    pub const fn read_write(regions: EffectRegionSet) -> Self {
        Self {
            reads: true,
            writes: true,
            regions,
