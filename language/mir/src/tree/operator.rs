...
impl BinaryOperator {
    ...
    pub fn to_str(self) -> &'static str {
        match self {
            ...
            BinaryOperator::ShiftLeft => "int.shiftLeft",
            BinaryOperator::ArithmeticShiftRight => "int.shiftRight.s",
            BinaryOperator::LogicalShiftRight => "int.shiftRight.u",
            // integer comparison
...
impl FromStr for BinaryOperator {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "int.shiftLeft" => Ok(BinaryOperator::ShiftLeft),
            "int.shiftRight.s" => Ok(BinaryOperator::ArithmeticShiftRight),
            "int.shiftRight.u" => Ok(BinaryOperator::LogicalShiftRight),
            // integer comparison
