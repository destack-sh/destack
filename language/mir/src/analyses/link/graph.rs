...
use crate::{
    Analysis, CallComponentGraph, CallTable, DropTable, EffectTable, Function, FunctionBehavior,
    Global, GlobalInitializer, Instruction, Linkage, MemoryEffect, Mutation, Storage, Symbol,
