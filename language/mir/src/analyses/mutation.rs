/// MIR input changes used to invalidate cached analyses.
///
/// Combine every category changed by an edit.
...
impl Mutation {
    ...
    /// Block membership, entry blocks, or control-flow edges changed.
