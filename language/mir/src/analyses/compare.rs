...
pub fn is_comparison_operator(operator: mir::BinaryOperator) -> bool {
    matches!(
        operator,
...
pub fn swap_comparison_operator(operator: mir::BinaryOperator) -> Option<mir::BinaryOperator> {
    match operator {
...
pub fn bool_from_range(range: Option<&ValueRange>) -> Option<bool> {
...
pub fn evaluate_integer_range_comparison(
