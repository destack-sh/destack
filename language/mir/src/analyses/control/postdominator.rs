...
use crate::{Analysis, Block, ControlTable, Function, LocalNodeId, Mutation, NodeTable, Tree};
...
impl PostdominatorTable {
    ...
    pub fn analyse(function: &Function, cfg: &ControlTable, tree: &Tree) -> Self {
...
"#,
        ...
        let postdom = PostdominatorTable::analyse(function, &cfg, &tree);
