...
use crate::{Analysis, AnalysisId, CallGraph, ModuleAnalyses, ModuleAnalysis};
...
b0:
    ...
    return v0
        ...
        let call_targets = analyses.get::<CallTargetAnalysis>(&test.tree);
