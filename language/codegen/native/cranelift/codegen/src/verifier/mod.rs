...
use crate::ir::{
    self, types, ArgumentExtension, ArgumentPurpose, Block, BlockArg, Constant, DynamicStackSlot,
    ExceptionTable, ExceptionTableItem, FuncRef, Function, GlobalValue, Inst, JumpTable, MemFlags,
    MemoryTypeData, Opcode, SigRef, Signature, StackSlot, Type, Value, ValueDef, ValueList,
};
