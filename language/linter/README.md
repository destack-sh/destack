...
| `LS008` | `no-regex-injection` | Destack | DIR | ✓ | None | Disallow tainted values in dynamic regular expression patterns |
...
| `LS006` | `no-tainted-sink` | Destack | DIR | ✓ | None | Disallow passing tainted values into security sinks |
