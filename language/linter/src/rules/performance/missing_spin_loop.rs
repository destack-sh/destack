...
mod tests {
    ...
    fn test_reports_atomic_load_polling_loop() {
        let session = TestSession::mir(
            &MISSING_SPIN_LOOP,
            r#"function wait<'a>(v0: ref<atomic<boolean>, borrowed, 'a, mutable, shared>): void {
entry(v0: ref<atomic<boolean>, borrowed, 'a, mutable, shared>):
    jump poll
...
"#,
    ...
    fn test_reports_atomic_compare_exchange_loop() {
        let session = TestSession::mir(
            &MISSING_SPIN_LOOP,
            r#"function wait<'a>(v0: ref<atomic<uint32>, borrowed, 'a, mutable, shared>): void {
entry(v0: ref<atomic<uint32>, borrowed, 'a, mutable, shared>):
    v1: uint32 = 0
    v2: uint32 = 1
    jump poll(v1, v2)
...
"#,
    ...
    fn test_ignores_unrelated_atomic_load() {
        let session = TestSession::mir(
            &MISSING_SPIN_LOOP,
            r#"function wait<'a>(v0: ref<atomic<boolean>, borrowed, 'a, mutable, shared>, v1: boolean): void {
entry(v0: ref<atomic<boolean>, borrowed, 'a, mutable, shared>, v1: boolean):
    jump poll
