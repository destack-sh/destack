...
impl LintRule for PreferSetOverEmptyMap {
    ...
    fn check_module<'a>(&self, _severity: LintSeverity, ctx: &mut LintModuleContext<'a>) {
        ...
        for (declaration_id, declaration) in ctx.dir.iter_nodes_of_type::<dir::Declaration>() {
            ...
            if !contains_map_with_empty_value_type(ctx, alias_target_type_id, map_symbol) {
                continue;
            }
...
fn generic_argument_value_expression(
    ...
    match generic_argument {
        ...
        | dir::GenericArgument::AssociatedType { .. } => None,
        dir::GenericArgument::Value { value }
        | dir::GenericArgument::AssociatedConst { value, .. } => Some(*value),
...
fn expression_is_void_or_never_type(
    ...
    expression_type_map(ctx, expression_id, is_void_or_never_type).unwrap_or(false)
}
