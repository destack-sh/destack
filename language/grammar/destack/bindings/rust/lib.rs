//! This crate provides Destack, TypeScript, and TSX language support for the [tree-sitter][] parsing library.
//!
//! Typically, you will use the [LANGUAGE_DESTACK] constant to add this language to a
...
//! let language = tree_sitter_destack::LANGUAGE_DESTACK;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading Destack parser");
...
/// The tree-sitter [`LanguageFn`] for Destack.
///
/// [LanguageFn]: https://docs.rs/tree-sitter-language/*/tree_sitter_language/struct.LanguageFn.html
pub const LANGUAGE_DESTACK: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_destack) };
...
/// The content of the [`node-types.json`][] file for Destack.
///
/// [`node-types.json`]: https://tree-sitter.github.io/tree-sitter/using-parsers#static-node-types
pub const DESTACK_NODE_TYPES: &str = include_str!("../../destack/src/node-types.json");
...
mod tests {
    #[test]
    fn test_can_load_destack_grammar() {
        let mut parser = tree_sitter::Parser::new();
        parser
            .set_language(&super::LANGUAGE_DESTACK.into())
            .expect("Error loading Destack parser");
    }
