  ...
  return grammar(JavaScript, {
    ...
    rules: {
      ...
      primary_expression: ($, previous) => choice(
        ...(dialect === 'destack' ? [$.struct_literal_expression, $.try_propagation_expression] : []),
        previous,
        $.non_null_expression,
      ),
      ...
      ambient_generator_function_signature: $ => seq(
        optional('async'),
        'function',
        '*',
        field('name', $.identifier),
      ...
      class_heritage: $ => choice(
        ...
        $.implements_clause,
        ...(dialect === 'destack' ? ['extends', 'implements'] : []),
      ),
      ...
      ambient_declaration: $ => seq(
        'declare',
        choice(
          $.ambient_generator_function_signature,
          $.ambient_const_declaration,
          $.ambient_variable_declaration,
          ...(dialect === 'destack' ? [$.function_declaration, $.generator_function_declaration] : []),
          $.function_signature,
          $.class_declaration,
          $.abstract_class_declaration,
          $.module,
      ...
      ambient_variable_declaration: $ => prec('declaration', seq(
        choice('let', 'var'),
        commaSep1($.variable_declarator),
        $._semicolon,
      )),
