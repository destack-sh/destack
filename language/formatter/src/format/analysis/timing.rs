...
pub const FORMAT_EXPRESSION_PRIMARY_PARENTHESES_DROP_MODE: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.primary.parenthesized.drop_mode");
...
pub const FORMAT_EXPRESSION_CALL_ARGUMENTS_COMMENT_SCAN: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.call.arguments.comment_scan");
pub const FORMAT_EXPRESSION_CALL_ARGUMENTS_EXPANSION_SCAN: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.call.arguments.expansion_scan");
pub const FORMAT_EXPRESSION_CALL_ARGUMENTS_LAYOUT: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.call.arguments.layout");
pub const FORMAT_EXPRESSION_CALL_ARGUMENTS_LAYOUT_DECIDE: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.call.arguments.layout.select");
pub const FORMAT_EXPRESSION_CALL_ARGUMENTS_LAYOUT_RENDER: FormatterTimingTag =
    FormatterTimingTag::new("format.expression.call.arguments.layout.render");
...
pub const FORMAT_NODE_MEMBER: FormatterTimingTag = FormatterTimingTag::new("format.node.member");
...
pub const FORMAT_NODE_PATTERN: FormatterTimingTag = FormatterTimingTag::new("format.node.pattern");
...
pub const FORMAT_NODE_COMMENT: FormatterTimingTag = FormatterTimingTag::new("format.node.comment");
