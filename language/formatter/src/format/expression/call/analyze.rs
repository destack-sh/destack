use super::super::*;
pub(super) use super::analyze_layout::*;
use super::classify::*;
use crate::{CachedCallArgumentExpansionProfile, CachedCallArgumentExpansionProfiles};
...
#[derive(Clone, Copy)]
pub(super) struct CallArgumentExpansionProfile {
    /// The final force expand decision.
    pub(super) force_expand: bool,
    ...
    pub(super) trailing_collection_argument: bool,
}
...
#[derive(Clone, Copy)]
pub(super) struct CallArgumentExpansionProfiles {
    /// The regular call formatting expansion profile.
    pub(super) regular: CallArgumentExpansionProfile,
    /// Whether chain formatting should force expansion.
    pub(super) chain_force_expand: bool,
}
...
#[derive(Default)]
pub(super) struct CallArgumentCommentProfile {
...
pub(super) fn collect_single_call_argument_facts(
    context: &DestackFormatContext<'_>,
...
pub(super) fn argument_has_callback_blocking_comment_annotation(
    context: &DestackFormatContext<'_>,
    argument_id: LocalNodeId<Argument>,
) -> bool {
...
pub(super) fn call_force_expand_single_long_with_static_arguments(
    context: &DestackFormatContext<'_>,
...
pub(super) fn call_force_expand_single_collection_for_type_binary_callee(
    context: &DestackFormatContext<'_>,
    call_node_id: LocalNodeId<Expression>,
    dynamic_arguments: &[LocalNodeId<Argument>],
) -> bool {
...
pub(super) fn single_argument_requires_expanded_list(
    context: &DestackFormatContext<'_>,
    dynamic_arguments: &[LocalNodeId<Argument>],
) -> bool {
    if dynamic_arguments.len() != 1 {
...
pub(super) fn build_call_argument_expansion_profiles(
    context: &DestackFormatContext<'_>,
    call_node_id: LocalNodeId<Expression>,
    dynamic_arguments: &[LocalNodeId<Argument>],
...
pub(super) fn resolve_regular_call_argument_expansion_profile(
    context: &DestackFormatContext<'_>,
    call_node_id: LocalNodeId<Expression>,
    dynamic_arguments: &[LocalNodeId<Argument>],
...
pub(super) fn call_should_force_hugged_expand(
...
pub(super) fn call_inline_len_without_static_arguments(
    context: &DestackFormatContext<'_>,
    call_node_id: LocalNodeId<Expression>,
...
pub(super) fn write_inline_call_argument_list<'ast>(
...
pub(super) fn argument_is_plain_call_argument(
    context: &DestackFormatContext<'_>,
    argument_id: LocalNodeId<Argument>,
) -> bool {
...
pub(super) fn write_plain_call_argument<'ast>(
    f: &mut DestackFormatter<'ast, '_>,
    argument_id: LocalNodeId<Argument>,
) -> FormatResult<()> {
...
pub(super) fn write_plain_call_argument_or_node<'ast>(
    f: &mut DestackFormatter<'ast, '_>,
    argument_id: LocalNodeId<Argument>,
) -> FormatResult<()> {
