...
pub(crate) use self::member::{
    ...
    has_comment_between_expressions, has_own_line_or_multiline_comment_between_expressions,
    is_chain_root, is_expression_chain, is_numeric_index, member_has_intervening_comment,
    member_is_private_hash, member_property_start, transparent_inner_expression,
};
