...
pub(crate) use self::member::{
    ...
    chain_member_has_promotable_boundary_comment, chain_nodes, chain_operation_is_index,
    chain_operation_node_id, expression_has_ternary_ancestor, expression_trivia_anchor_end,
    extract_parenthesized_index_chain, first_grouped_line_operation, format_maybe_expression,
    has_chain_parent, has_comment_between_expressions, has_line_comment_between_expressions,
    is_chain_root, is_expression_chain, is_numeric_index, member_has_intervening_comment,
    member_is_private_hash, should_use_trailing_coalesce, transparent_inner_expression,
};
