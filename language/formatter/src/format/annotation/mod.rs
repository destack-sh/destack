...
pub(crate) use self::sequence::{
    ...
    prefix_annotations_without_comments, prefix_annotations_without_decorators,
    prefix_comment_nodes, write_annotation_sequence, write_inline_prefix_annotations,
};
