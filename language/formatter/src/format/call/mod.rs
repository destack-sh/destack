...
pub(crate) use self::arguments::{
    ...
    separator_line_comment_has_blank_line_before_first_comment, separator_line_comment_is_own_line,
    separator_line_comment_source_from_annotations, single_argument_separator_line_comment_source,
    write_argument_without_separator_line_comment, write_separator_line_comment_after_comma,
};
