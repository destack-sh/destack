...
fn test_lex_unicode_escape_braced_single() {
    ...
    assert_tokenize_eq_roundtrip!(r"\u{41}", token(TokenType::Identifier, 6, None),);
}
...
fn test_lex_unicode_escape_braced_with_suffix() {
    ...
    assert_tokenize_eq_roundtrip!(r"\u{41}BC", token(TokenType::Identifier, 8, None),);
}
...
fn test_lex_unicode_escape_es5_style() {
    ...
    assert_tokenize_eq_roundtrip!(r"\u0041", token(TokenType::Identifier, 6, None),);
}
...
fn test_lex_unicode_escape_es5_with_suffix() {
    ...
    assert_tokenize_eq_roundtrip!(r"\u0041BC", token(TokenType::Identifier, 8, None),);
}
...
fn test_lex_unicode_escape_multiple() {
    ...
    assert_tokenize_eq_roundtrip!(
        r"\u{41}\u{42}\u{43}",
        token(TokenType::Identifier, 18, None),
    );
}
...
fn test_lex_unicode_escape_in_let() {
    ...
    assert_tokenize_eq_roundtrip!(
        ...
        token(TokenType::Identifier, 8, None),
...
fn test_lex_identifier_with_unicode_escape_suffix() {
    ...
    assert_tokenize_eq_roundtrip!(r"AB\u{43}", token(TokenType::Identifier, 8, None),);
}
...
fn test_lex_invalid_unicode_escape_too_short() {
    ...
    assert_tokenize_eq_roundtrip!(
        ...
        token(TokenType::Unknown, 4, None),    // "\u11"
        token(TokenType::Identifier, 1, None), // "z"
    );
}
...
fn test_lex_invalid_unicode_escape_one_digit() {
    ...
    assert_tokenize_eq_roundtrip!(
        r"a\u1z",
        token(TokenType::Identifier, 1, None), // "a"
        token(TokenType::Unknown, 3, None),    // "\u1"
        token(TokenType::Identifier, 1, None), // "z"
    );
}
...
fn test_lex_identifier_unicode_escape_backslash_is_not_continuation() {
    ...
    assert_tokenize_eq_roundtrip!(
        ...
        token(TokenType::Unknown, 6, None),    // "\u005c"
    );
}
