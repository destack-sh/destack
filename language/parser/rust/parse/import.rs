...
impl<'a> Parser<'a> {
    ...
    fn eat_dependency_items_block(&mut self, ty: Option<DependencyType>) -> ParserResult<Vec<NodeId<DependencyItem>>> {
...
#[cfg(test)]
mod tests {
    use dyst_ast::{DependencyTarget, DependencyType, ExportType};
