...
class DocInput:
    ...
    def encode(self, writer: BinaryWriter) -> None:
        """Encode this value."""
        encode_doc_input(writer, self)

    @classmethod
    def decode(cls, reader: BinaryReader) -> DocInput:
        """Decode one DocInput."""
        return decode_doc_input(reader)

    def to_json(self) -> Json:
        """Return this value as JSON."""
        return to_json_doc_input(self)

    @classmethod
    def from_json(cls, value: Json) -> DocInput:
        """Return one DocInput from one JSON value."""
        return from_json_doc_input(value)


def encode_doc_input(writer: BinaryWriter, value: DocInput) -> None:
    """Encode one DocInput."""
...
def decode_doc_input(reader: BinaryReader) -> DocInput:
    """Decode one DocInput."""
    revision = (
...
def to_json_doc_input(value: DocInput) -> Json:
    """Return one JSON value for one DocInput."""
    return {
...
def from_json_doc_input(value: Json) -> DocInput:
    """Return one DocInput from one JSON value."""
