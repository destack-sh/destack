...
export type TraceReport = {
    ...
    readonly counters: ReadonlyArray<TraceCounter>;
    /** Busy time per toolchain stage. */
    readonly stages: ReadonlyArray<TraceStage>;
    /** Summed time per named trace span. */
    readonly times: ReadonlyArray<TraceTime>;
    /** Detailed artifact attempts. */
    readonly artifacts: ReadonlyArray<TraceArtifact>;
};
