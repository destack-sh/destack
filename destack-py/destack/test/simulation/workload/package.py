...
from destack.test.simulation.workload.client import ClientWorkload, ClientWorkloadSpec
from destack.test.utils import assert_graph_equals
...
class WritePageTreeWorkload(ClientWorkload[WritePageTreeSpec]):
    ...
    async def run_once_in_session(self):
        ...
        while n_transactions < max_transactions:
            ...
            host = self.simulation.get_host(self.spec.destack)
            assert_graph_equals(
