...
class SignupUserRequest(_message.Message):
    ...
    def __init__(
        ...
        region: _Optional[_Union[_language_pb2.Region, str]] = ...,
        client: _Optional[_Union[_language_pb2.ClientData, _Mapping]] = ...,
    ) -> None: ...
...
class SignupUserResponse(_message.Message):
    ...
    def __init__(
        self,
        user: _Optional[_Union[_language_pb2.UserData, _Mapping]] = ...,
        client: _Optional[_Union[_language_pb2.ClientData, _Mapping]] = ...,
        space: _Optional[_Union[_language_pb2.SpaceData, _Mapping]] = ...,
...
class LogoutUserRequest(_message.Message):
    ...
    def __init__(
        self,
        clients: _Optional[_Iterable[_Union[_language_pb2.NodeReferenceData, _Mapping]]] = ...,
        logout_all: bool = ...,
    ) -> None: ...
...
class CreateOrganizationRequest(_message.Message):
    ...
    def __init__(
        self, organization: _Optional[_Union[_language_pb2.OrganizationData, _Mapping]] = ...
    ) -> None: ...
...
class CreateOrganizationResponse(_message.Message):
    ...
    def __init__(
        self,
        organization: _Optional[_Union[_language_pb2.OrganizationData, _Mapping]] = ...,
        epoch: _Optional[int] = ...,
    ) -> None: ...
...
class ResolveHostsRequest(_message.Message):
    ...
    def __init__(
        self, spaces: _Optional[_Iterable[_Union[ResolveHostsRequest.SpaceKey, _Mapping]]] = ...
    ) -> None: ...
...
class ResolveHostsResponse(_message.Message):
    ...
    class HostInfo(_message.Message):
        ...
        def __init__(
            ...
            ssl: bool = ...,
            space: _Optional[_Union[_language_pb2.NodeReferenceData, _Mapping]] = ...,
        ) -> None: ...
