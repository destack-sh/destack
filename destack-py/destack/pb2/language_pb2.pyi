...
class EnumType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    ENUM_TYPE_INSTANCE_TYPE: _ClassVar[EnumType]
...
class InstanceType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INSTANCE_TYPE_PARTIAL: _ClassVar[InstanceType]
    INSTANCE_TYPE_FULL: _ClassVar[InstanceType]
...
ENUM_TYPE_INSTANCE_TYPE: EnumType
...
INSTANCE_TYPE_PARTIAL: InstanceType
INSTANCE_TYPE_FULL: InstanceType
