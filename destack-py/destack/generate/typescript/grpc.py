...
def _generate_pack_proto_property(prop: "Property") -> list[str]:
...
def _generate_unpack_proto_property(prop: "Property") -> list[str]:
...
def _generate_pack_proto_scalar(prop: "Property | IntoType", value_expr: str) -> str:
...
def _generate_unpack_proto_scalar(prop: "Property | IntoType", value_expr: str) -> str:
