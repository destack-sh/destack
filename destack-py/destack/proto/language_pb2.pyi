...
class IndexTypeProto(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    INDEX_TYPE_UNIQUE: _ClassVar[IndexTypeProto]
...
INDEX_TYPE_UNIQUE: IndexTypeProto
