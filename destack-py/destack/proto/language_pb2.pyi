...
class SomeEntityProto(_message.Message):
    __slots__ = ("custom_entity_definition", "custom_trait_definition", "custom_enum_definition", "custom_event_definition", "gauge_metric", "counter_metric", "histogram_metric", "custom_option", "custom_property", "snapshot", "branch", "custom_struct_definition", "entitlement", "invite", "membership", "permission", "role", "sanction", "frame_view", "label_view", "split_view", "text_view", "number_input_view", "slider_input_view", "internal_view", "annotation_shape", "arrow_shape", "canvas", "line_shape", "polygon_shape", "file", "link", "environment", "folder", "tag", "tagging", "database", "machine", "action", "event_cursor", "screen_cursor", "thread_cursor", "route", "script", "service", "timer", "trigger", "interruption", "run", "layer", "scene", "variant", "window", "follow", "message", "notification", "reaction", "star", "thread", "agent", "client", "friendship", "friendship_invite", "handle", "organization", "space", "team", "user", "color_style", "border_style", "transition_style", "effect_style", "gradient_style", "fill_style", "font_style", "shadow_style", "stroke_style", "theme")
    CUSTOM_ENTITY_DEFINITION_FIELD_NUMBER: _ClassVar[int]
    CUSTOM_TRAIT_DEFINITION_FIELD_NUMBER: _ClassVar[int]
    CUSTOM_ENUM_DEFINITION_FIELD_NUMBER: _ClassVar[int]
    CUSTOM_EVENT_DEFINITION_FIELD_NUMBER: _ClassVar[int]
