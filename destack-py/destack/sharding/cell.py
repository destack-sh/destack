...
if TYPE_CHECKING:
    from destack.language import CellInfo
...
class CellProvider(abc.ABC):
    ...
    @abc.abstractmethod
    async def acquire(self, region: Region, space: Space) -> "CellInfo":
        """Acquires a new (shared) Cell for the Space."""
        ...
...
class StaticCellProvider(CellProvider):
    ...
    def parse(cls, cell_str: str) -> "StaticCellProvider":
        ...
        'eu-frankfurt/cell_1=aws-eu-frankfurt-x7ahko.justdestack.com'
        'eu-frankfurt/cell_2=aws-eu-frankfurt-21uza3.justdestack.com'
        """
        from destack.language import CellInfo
