...
import type { User, EditEvent, CollectionConstraint, EntitlementEvent, Entity, MembershipJoinedEvent, PasteEvent, Role, Database, HistogramMetric, Color, Font, Method, Arrow2D, CutEvent, ConstantDefinition, Quaternion, Reaction, GridSpan2, TimerResumedEvent, DragEndEvent, Timer, ActionDefinition, Space, File, TimerStartedEvent, TimerPausedEvent, StarRemovedEvent, CustomEvent, Stage, Join, SliderInputView, EntitlementGrantedEvent, Layer, Rectangle2D, ViewEvent, LabelView, Axis2, CustomProperty, Snapshot, SingleClickEvent, FollowRemovedEvent, MouseEvent, Migration, SpanEvent, Metric, TimerCancelledEvent, StringConstraint, GradientStop, Function, Branch, PropertyDefinition, HistogramMeasurementEvent, Value, CustomStruct, Length, SanctionExpiredEvent, TextView, ClipboardEvent, EnumDefinition, Machine, Entity3D, NotificationReadEvent, PointerEnterEvent, Aggregation, ConstraintDefinition, FocusInEvent, ColorStyle, SanctionRequestedEvent, NumberInputView, GradientStyle, ClickEvent, LayoutView, Border, RunResumedEvent, RunResumeRequestedEvent, SanctionRevokedEvent, PolygonShape2D, Script, RunFailedEvent, TraitDefinition, InviteEvent, Invite, Tagging, EntitlementRequestedEvent, TransitionStyle, RoleEvent, RunStopRequestedEvent, Vector3i, BuiltinDefinition, EntitlementExpiredEvent, NotificationRescindedEvent, Schedule, Action, InviteRescindedEvent, Effect, StrokePath, BorderStyle, NotificationSentEvent, SignalEvent, FillStyle, NumberConstraint, PointerMoveEvent, Run, ShadowStyle, PointerOverEvent, SceneEvent, CustomOption, Condition, InputEvent, StrokePoint, StructDefinitionReference, Record, MembershipEvent, Star, MigrationDefinition, StrokeStyle, PointerEvent, OptionDefinition, Palette, FollowAddedEvent, ReactionEvent, SanctionGrantedEvent, Type, Sort, Vector4, InviteSentEvent, Struct, DatumMutable, ArrowShape2D, NodeDefinition, Text, Style, StrokeCap, Icon, Datum, RoleUnassignedEvent, FontStyle, Client, Resource, Inset2, DragEvent, KeyUpEvent, DragEnterEvent, CounterMeasurementEvent, Select, Transition, Sanction, DoubleClickEvent, Expression, Permission, GaugeMeasurementEvent, Vector2i, StarEvent, Axis3, InviteAcceptedEvent, RunStartedEvent, KeyPressEvent, MembershipLeftEvent, Route, RunEvent, ReactionRemovedEvent, RectangleShape2D, RoleAssignedEvent, TimerEvent, Gradient, Variant, StructDefinition, Service, PathShape2D, SplitView, Index, Stroke, FollowEvent, Grid2, Path2D, KeyEvent, Shape3D, Notification, MigrationOperationDefinition, PropertyReference, ObjectDefinitionReference, Entity2D, RunCompletedEvent, Theme, PermissionDefinition, DragStartEvent, Fill, Follow, Folder, Shape2D, PointerUpEvent, Vector4i, Offset2, Query, InviteRejectedEvent, IndexDefinition, Ellipse2D, LineShape2D, DragLeaveEvent, GaugeMetric, NotificationDismissedEvent, FocusOutEvent, TextSpan, Line2D, TripleClickEvent, Polygon2D, Vector3, Corner2, PointerLeaveEvent, TimerCompletedEvent, Vector2, Organization, StarAddedEvent, MethodDefinition, SanctionEvent, Universe, FocusEvent, Handle, NodeDefinitionReference, LogEvent, Scene, PointerLongPressEvent, DragOverEvent, TriggerEvent, CustomEnum, RunPausedEvent, Entitlement, ReactionAddedEvent, Tag, MigrationOperation, DropEvent, NodeReference, FrameView, Event, NotificationEvent, InputView, WheelEvent, EffectStyle, ContentView, TagDefinition, CopyEvent, View, Node, Constraint, Membership, PointerDownEvent, Trigger, NotificationExpiredEvent, Team, EntitlementRevokedEvent, Shadow, KeyDownEvent, Environment, CounterMetric, EllipseShape2D, RunPauseRequestedEvent, MeasurementEvent } from '@destack/language';
import { DragOverEventProto, FollowRemovedEventProto, Vector4Proto, PropertyDefinitionProto, Vector2iProto, PointerEnterEventProto, EffectStyleProto, StrokePathProto, SanctionEventProto, PermissionDefinitionProto, ColorStyleProto, MigrationDefinitionProto, TimerCompletedEventProto, IndexDefinitionProto, MigrationOperationDefinitionProto, EntitlementGrantedEventProto, HistogramMeasurementEventProto, EditEventProto, Ellipse2DProto, TextViewProto, RunPauseRequestedEventProto, IndexProto, ReactionAddedEventProto, ShadowStyleProto, OrganizationProto, TextSpanProto, Vector2Proto, ObjectDefinitionReferenceProto, UniverseProto, SanctionGrantedEventProto, PermissionProto, FontProto, TripleClickEventProto, KeyEventProto, TimerPausedEventProto, CustomOptionProto, ValueProto, GradientStopProto, TextProto, CustomPropertyProto, LayerProto, GridSpan2Proto, StringConstraintProto, EllipseShape2DProto, StrokePointProto, TypeProto, FileProto, ContentViewProto, FollowAddedEventProto, EffectProto, Corner2Proto, StructDefinitionProto, PropertyReferenceProto, SpanEventProto, PointerLongPressEventProto, StageProto, TagProto, EntitlementEventProto, LayoutViewProto, SelectProto, NotificationRescindedEventProto, SignalEventProto, TimerProto, CopyEventProto, NumberConstraintProto, ViewEventProto, OptionDefinitionProto, StrokeStyleProto, Grid2Proto, ActionDefinitionProto, ActionProto, DropEventProto, LogEventProto, CustomEnumProto, VariantProto, SanctionProto, DoubleClickEventProto, NumberInputViewProto, ConditionProto, NotificationEventProto, EntityProto, RunResumeRequestedEventProto, ExpressionProto, FocusOutEventProto, ConstraintProto, Shape2DProto, ClipboardEventProto, WheelEventProto, ReactionRemovedEventProto, FrameViewProto, EntitlementRequestedEventProto, RoleProto, UserProto, NodeProto, KeyDownEventProto, TaggingProto, StarRemovedEventProto, ConstantDefinitionProto, InputEventProto, FillStyleProto, Entity3DProto, ClickEventProto, InviteRejectedEventProto, MetricProto, DatabaseProto, MeasurementEventProto, SanctionExpiredEventProto, ReactionEventProto, StarProto, EntitlementProto, Polygon2DProto, NotificationProto, HistogramMetricProto, MachineProto, StarAddedEventProto, GaugeMeasurementEventProto, RoleAssignedEventProto, ReactionProto, FolderProto, Vector3Proto, FontStyleProto, LabelViewProto, CutEventProto, IconProto, RunStopRequestedEventProto, DragEndEventProto, AggregationProto, Entity2DProto, TimerStartedEventProto, RoleEventProto, ColorProto, CounterMetricProto, FillProto, Arrow2DProto, StyleProto, NodeDefinitionProto, TimerCancelledEventProto, QueryProto, PolygonShape2DProto, Shape3DProto, GradientStyleProto, EnvironmentProto, DragEventProto, ScriptProto, NodeReferenceProto, TraitDefinitionProto, TransitionProto, Offset2Proto, HandleProto, FocusInEventProto, BuiltinDefinitionProto, LengthProto, RunStartedEventProto, PointerMoveEventProto, EntitlementExpiredEventProto, StrokeProto, PointerLeaveEventProto, SnapshotProto, ClientProto, FunctionProto, ScheduleProto, RunFailedEventProto, CollectionConstraintProto, MigrationOperationProto, RecordProto, RunResumedEventProto, TimerEventProto, InviteProto, KeyUpEventProto, MigrationProto, SingleClickEventProto, Path2DProto, MembershipProto, BorderProto, SpaceProto, ServiceProto, Inset2Proto, SanctionRevokedEventProto, PointerDownEventProto, StrokeCapProto, TriggerEventProto, SanctionRequestedEventProto, InputViewProto, MembershipEventProto, ConstraintDefinitionProto, QuaternionProto, LineShape2DProto, ResourceProto, TagDefinitionProto, NotificationReadEventProto, RunPausedEventProto, EntitlementRevokedEventProto, FocusEventProto, Vector4iProto, TriggerProto, PaletteProto, EnumDefinitionProto, PointerUpEventProto, RectangleShape2DProto, StructProto, NotificationExpiredEventProto, Vector3iProto, BranchProto, TransitionStyleProto, TimerResumedEventProto, NotificationSentEventProto, SceneEventProto, CounterMeasurementEventProto, RunProto, SplitViewProto, StarEventProto, MouseEventProto, Line2DProto, PathShape2DProto, SliderInputViewProto, InviteRescindedEventProto, MembershipJoinedEventProto, InviteSentEventProto, DragStartEventProto, RouteProto, MembershipLeftEventProto, DatumProto, RunEventProto, FollowProto, InviteAcceptedEventProto, CustomStructProto, ThemeProto, DragEnterEventProto, DragLeaveEventProto, GaugeMetricProto, SortProto, Axis2Proto, JoinProto, EventProto, BorderStyleProto, MethodDefinitionProto, NodeDefinitionReferenceProto, NotificationDismissedEventProto, DatumMutableProto, MethodProto, ArrowShape2DProto, Axis3Proto, FollowEventProto, PointerEventProto, SceneProto, StructDefinitionReferenceProto, Rectangle2DProto, KeyPressEventProto, PointerOverEventProto, RunCompletedEventProto, PasteEventProto, InviteEventProto, TeamProto, ShadowProto, CustomEventProto, RoleUnassignedEventProto, ViewProto, GradientProto } from '@destack/proto';
