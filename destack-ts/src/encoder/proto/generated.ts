...
import type { FollowRemovedEvent, FollowEvent, KeyDownEvent, Scene, Vector2i, FocusOutEvent, Font, Variant, PathShape2D, Text, TimerCancelledEvent, ContentView, CopyEvent, TripleClickEvent, Entity2D, NodeDefinitionReference, DragEndEvent, PointerUpEvent, Effect, Stroke, TimerStartedEvent, LineShape2D, InputEvent, EntitlementGrantedEvent, TriggerEvent, Expression, Reaction, ArrowShape2D, StrokePoint, RoleAssignedEvent, Theme, StructDefinition, FontStyle, EffectStyle, ClickEvent, TagDefinition, Select, CustomEvent, BuiltinDefinition, Grid2, MigrationDefinition, ObjectDefinitionReference, Membership, Ellipse2D, CustomStruct, Entity, Space, InviteSentEvent, ConstraintDefinition, Star, ActionDefinition, Offset2, MigrationOperation, MembershipLeftEvent, GaugeMetric, PermissionDefinition, RunResumeRequestedEvent, NotificationReadEvent, DragOverEvent, SanctionExpiredEvent, View, Handle, Query, Node, PointerDownEvent, Shape2D, PolygonShape2D, PropertyReference, Event, MembershipJoinedEvent, NotificationDismissedEvent, Arrow2D, Struct, Axis3, RunFailedEvent, Environment, Vector3i, Rectangle2D, Border, OptionDefinition, Entitlement, InviteRejectedEvent, Role, Tag, EntitlementEvent, FocusInEvent, Permission, InviteAcceptedEvent, Vector3, Organization, Sanction, DragStartEvent, Fill, Join, KeyEvent, Entity3D, MembershipEvent, Type, Layer, TextView, Icon, Axis2, PointerEnterEvent, TimerResumedEvent, Vector2, PointerOverEvent, KeyPressEvent, EntitlementRequestedEvent, Record, StarEvent, CounterMetric, GradientStop, DropEvent, Timer, InviteRescindedEvent, Folder, Database, GridSpan2, NumberConstraint, ShadowStyle, Service, Path2D, MouseEvent, SplitView, Trigger, Aggregation, TextSpan, CustomProperty, TimerEvent, RoleUnassignedEvent, EllipseShape2D, SceneEvent, Quaternion, NotificationEvent, ReactionEvent, Team, Metric, Run, NotificationRescindedEvent, NotificationSentEvent, RunStartedEvent, TraitDefinition, CounterMeasurementEvent, WheelEvent, File, Transition, MeasurementEvent, Notification, Length, ReactionRemovedEvent, SanctionRevokedEvent, RectangleShape2D, DoubleClickEvent, Route, Script, Condition, EntitlementExpiredEvent, SliderInputView, Stage, ConstantDefinition, LogEvent, StarRemovedEvent, NodeReference, ColorStyle, DragEnterEvent, PointerLongPressEvent, Datum, Polygon2D, RunPausedEvent, FollowAddedEvent, Tagging, Palette, CutEvent, NodeDefinition, EnumDefinition, RoleEvent, Shape3D, Color, Constraint, SignalEvent, FrameView, Snapshot, Shadow, SanctionGrantedEvent, HistogramMeasurementEvent, NumberInputView, Sort, IndexDefinition, Value, TransitionStyle, Gradient, CustomEnum, LayoutView, SpanEvent, StringConstraint, InputView, PointerLeaveEvent, Machine, Style, Inset2, PasteEvent, RunCompletedEvent, Resource, FocusEvent, KeyUpEvent, CustomOption, RunPauseRequestedEvent, RunResumedEvent, RunStopRequestedEvent, Action, ViewEvent, NotificationExpiredEvent, Function, StrokeCap, MigrationOperationDefinition, Method, MethodDefinition, SingleClickEvent, Corner2, SanctionEvent, ClipboardEvent, Invite, StrokeStyle, DatumMutable, StrokePath, DragLeaveEvent, TimerCompletedEvent, Branch, PointerMoveEvent, BorderStyle, PointerEvent, Schedule, InviteEvent, Client, CollectionConstraint, Line2D, SanctionRequestedEvent, TimerPausedEvent, RunEvent, LabelView, GaugeMeasurementEvent, StructDefinitionReference, Index, Vector4i, StarAddedEvent, EditEvent, ReactionAddedEvent, User, PropertyDefinition, Vector4, GradientStyle, Migration, EntitlementRevokedEvent, Follow, DragEvent, FillStyle, Universe, HistogramMetric } from '@destack/language';
import { FollowRemovedEventProto, SnapshotProto, FunctionProto, NodeProto, KeyEventProto, CounterMetricProto, HandleProto, RunPausedEventProto, InviteEventProto, LabelViewProto, ScheduleProto, HistogramMeasurementEventProto, MembershipProto, SanctionProto, RoleEventProto, VariantProto, BorderStyleProto, PointerUpEventProto, NumberInputViewProto, ReactionRemovedEventProto, MigrationOperationDefinitionProto, GradientStyleProto, TimerCompletedEventProto, RectangleShape2DProto, RunEventProto, GaugeMetricProto, FollowProto, StrokeCapProto, StructDefinitionProto, ClipboardEventProto, QuaternionProto, UniverseProto, TriggerProto, MembershipLeftEventProto, KeyPressEventProto, DropEventProto, ActionDefinitionProto, ThemeProto, PathShape2DProto, Shape2DProto, Line2DProto, ReactionProto, ActionProto, FillStyleProto, StarRemovedEventProto, RecordProto, TypeProto, NotificationSentEventProto, CutEventProto, Vector3iProto, GaugeMeasurementEventProto, ClickEventProto, InviteRejectedEventProto, RunStartedEventProto, TimerResumedEventProto, ColorProto, TaggingProto, Vector2iProto, SpaceProto, DragEnterEventProto, ConditionProto, Path2DProto, TagDefinitionProto, RoleAssignedEventProto, SortProto, Entity2DProto, LineShape2DProto, TransitionStyleProto, FollowAddedEventProto, NotificationDismissedEventProto, OrganizationProto, Axis2Proto, JoinProto, KeyDownEventProto, DatumProto, BorderProto, TriggerEventProto, RunCompletedEventProto, ArrowShape2DProto, CounterMeasurementEventProto, Corner2Proto, StarEventProto, MethodProto, MachineProto, MigrationProto, MembershipJoinedEventProto, EffectStyleProto, CustomStructProto, Grid2Proto, PermissionDefinitionProto, FocusEventProto, LayerProto, FillProto, FileProto, EnvironmentProto, PointerEnterEventProto, ObjectDefinitionReferenceProto, OptionDefinitionProto, ValueProto, StarProto, GridSpan2Proto, SignalEventProto, CustomEnumProto, QueryProto, MetricProto, PropertyReferenceProto, TimerProto, FocusOutEventProto, EventProto, StyleProto, FollowEventProto, Entity3DProto, SpanEventProto, IndexDefinitionProto, DatabaseProto, PointerLeaveEventProto, HistogramMetricProto, LayoutViewProto, PointerDownEventProto, Vector2Proto, DragStartEventProto, StrokeProto, DragLeaveEventProto, ServiceProto, TripleClickEventProto, SceneEventProto, PermissionProto, EllipseShape2DProto, InviteRescindedEventProto, StructDefinitionReferenceProto, PropertyDefinitionProto, DatumMutableProto, RunProto, FocusInEventProto, ScriptProto, SplitViewProto, TimerPausedEventProto, NotificationExpiredEventProto, TimerCancelledEventProto, Vector3Proto, ContentViewProto, CustomPropertyProto, DragOverEventProto, KeyUpEventProto, LengthProto, TimerStartedEventProto, RoleProto, PaletteProto, SanctionExpiredEventProto, ConstantDefinitionProto, FolderProto, FrameViewProto, StrokePathProto, EntitlementExpiredEventProto, DragEndEventProto, Arrow2DProto, InviteSentEventProto, UserProto, EffectProto, AggregationProto, ConstraintProto, StageProto, PolygonShape2DProto, MouseEventProto, ReactionAddedEventProto, PointerEventProto, TransitionProto, GradientProto, ClientProto, NodeReferenceProto, EntitlementRequestedEventProto, CopyEventProto, TeamProto, EntitlementRevokedEventProto, RunResumeRequestedEventProto, EntityProto, Inset2Proto, Ellipse2DProto, CustomOptionProto, LogEventProto, SanctionRevokedEventProto, TraitDefinitionProto, EditEventProto, InviteAcceptedEventProto, Shape3DProto, MeasurementEventProto, StrokePointProto, EntitlementGrantedEventProto, DoubleClickEventProto, SanctionGrantedEventProto, PointerOverEventProto, ShadowStyleProto, RouteProto, StarAddedEventProto, NotificationReadEventProto, ResourceProto, ExpressionProto, RunResumedEventProto, TextProto, ViewEventProto, InviteProto, SanctionRequestedEventProto, ColorStyleProto, NotificationEventProto, SceneProto, MigrationOperationProto, TextViewProto, PasteEventProto, EntitlementEventProto, SliderInputViewProto, PointerLongPressEventProto, InputEventProto, FontProto, Axis3Proto, StrokeStyleProto, NotificationRescindedEventProto, SingleClickEventProto, WheelEventProto, NodeDefinitionProto, NodeDefinitionReferenceProto, StringConstraintProto, NumberConstraintProto, ShadowProto, Vector4Proto, RunPauseRequestedEventProto, TimerEventProto, Offset2Proto, Polygon2DProto, IconProto, MigrationDefinitionProto, SelectProto, SanctionEventProto, TagProto, GradientStopProto, FontStyleProto, BranchProto, RunFailedEventProto, ViewProto, NotificationProto, MethodDefinitionProto, PointerMoveEventProto, BuiltinDefinitionProto, RoleUnassignedEventProto, ReactionEventProto, DragEventProto, StructProto, IndexProto, EntitlementProto, EnumDefinitionProto, TextSpanProto, Rectangle2DProto, Vector4iProto, InputViewProto, ConstraintDefinitionProto, RunStopRequestedEventProto, CustomEventProto, MembershipEventProto, CollectionConstraintProto } from '@destack/proto';
