...
import type { SanctionRequestedEvent, Environment, StringConstraint, Node, IndexDefinition, Vector2i, StarRemovedEvent, RectangleShape2D, Transition, Follow, Rectangle2D, StrokePoint, SplitView, PointerOverEvent, Scene, StrokePath, Layer, SanctionEvent, Role, Run, RoleUnassignedEvent, EntitlementExpiredEvent, Record, Folder, Offset2, DragEndEvent, Variant, Palette, Permission, Invite, RunResumedEvent, Icon, Query, StrokeStyle, HistogramMeasurementEvent, Client, Text, PolygonShape2D, MigrationOperationDefinition, InputView, PermissionDefinition, ClipboardEvent, KeyDownEvent, RunCompletedEvent, SceneEvent, EditEvent, GaugeMeasurementEvent, DatumMutable, SingleClickEvent, Notification, OptionDefinition, Function, DragOverEvent, PasteEvent, FrameView, LineShape2D, PointerUpEvent, TraitDefinition, CustomProperty, Entity3D, PropertyDefinition, Action, FocusInEvent, SanctionRevokedEvent, GradientStop, Aggregation, Branch, Value, MembershipEvent, SpanEvent, Condition, Gradient, FocusOutEvent, Length, Polygon2D, ReactionAddedEvent, Database, Timer, BuiltinDefinition, Ellipse2D, RoleEvent, ArrowShape2D, HistogramMetric, DoubleClickEvent, Metric, Organization, Inset2, MembershipLeftEvent, CustomEnum, MigrationDefinition, StructDefinitionReference, Join, CustomOption, MembershipJoinedEvent, KeyEvent, NodeReference, MethodDefinition, EllipseShape2D, Stroke, InviteEvent, DropEvent, Entitlement, Route, Trigger, StarEvent, MouseEvent, Expression, Schedule, FontStyle, Axis3, Sanction, File, Migration, TimerCancelledEvent, Vector4, CustomEvent, RunStopRequestedEvent, Shape3D, EntitlementEvent, WheelEvent, RoleAssignedEvent, Service, MeasurementEvent, CounterMetric, Index, Line2D, Tagging, Space, SliderInputView, Team, ReactionRemovedEvent, Axis2, Shadow, PointerEnterEvent, SanctionExpiredEvent, Path2D, Reaction, StructDefinition, Vector2, NotificationRescindedEvent, Vector3, TransitionStyle, ConstraintDefinition, Method, KeyUpEvent, MigrationOperation, ShadowStyle, PointerMoveEvent, ClickEvent, ViewEvent, ConstantDefinition, InviteSentEvent, StrokeCap, Vector3i, Shape2D, FollowRemovedEvent, DragEvent, Star, TextSpan, TagDefinition, View, NotificationSentEvent, Membership, PointerLongPressEvent, Handle, Sort, FillStyle, NotificationEvent, Theme, CopyEvent, InputEvent, Grid2, BorderStyle, ActionDefinition, RunPauseRequestedEvent, Resource, KeyPressEvent, RunResumeRequestedEvent, Entity2D, PathShape2D, ReactionEvent, Vector4i, CollectionConstraint, NotificationDismissedEvent, Select, LayoutView, PointerEvent, GaugeMetric, Font, Tag, User, FollowEvent, SanctionGrantedEvent, CounterMeasurementEvent, Datum, FollowAddedEvent, EffectStyle, NotificationExpiredEvent, Type, CutEvent, Color, Arrow2D, CustomStruct, ContentView, TextView, Event, InviteRejectedEvent, Entity, EntitlementGrantedEvent, Border, RunFailedEvent, DragEnterEvent, TimerCompletedEvent, DragStartEvent, ObjectDefinitionReference, InviteAcceptedEvent, RunPausedEvent, TimerResumedEvent, NotificationReadEvent, TimerEvent, Quaternion, SignalEvent, ColorStyle, PointerDownEvent, Script, NodeDefinitionReference, RunStartedEvent, Effect, LogEvent, Struct, Machine, Corner2, PropertyReference, EnumDefinition, PointerLeaveEvent, EntitlementRequestedEvent, EntitlementRevokedEvent, TriggerEvent, FocusEvent, Constraint, Universe, RunEvent, TimerPausedEvent, Style, GridSpan2, StarAddedEvent, Snapshot, NodeDefinition, NumberInputView, TripleClickEvent, GradientStyle, Stage, Fill, LabelView, TimerStartedEvent, DragLeaveEvent, InviteRescindedEvent, NumberConstraint } from '@destack/language';
import { NotificationEventProto, RoleAssignedEventProto, RoleUnassignedEventProto, Axis3Proto, Shape2DProto, EditEventProto, Polygon2DProto, FillStyleProto, Entity2DProto, MigrationOperationDefinitionProto, DragStartEventProto, DragEndEventProto, NotificationExpiredEventProto, CounterMeasurementEventProto, Path2DProto, RoleProto, GridSpan2Proto, NodeReferenceProto, MethodDefinitionProto, Rectangle2DProto, StarEventProto, CustomStructProto, MeasurementEventProto, CutEventProto, FocusEventProto, FollowAddedEventProto, EnumDefinitionProto, LineShape2DProto, FocusOutEventProto, ReactionRemovedEventProto, FillProto, FontProto, RunProto, TriggerEventProto, MouseEventProto, StructDefinitionReferenceProto, Ellipse2DProto, SanctionRequestedEventProto, DragEventProto, TimerStartedEventProto, InviteRescindedEventProto, SceneEventProto, TagProto, KeyEventProto, ValueProto, DatumMutableProto, FollowEventProto, DoubleClickEventProto, HistogramMetricProto, StructProto, SanctionProto, ClientProto, GaugeMeasurementEventProto, Vector4Proto, CustomOptionProto, RectangleShape2DProto, PointerLongPressEventProto, EntitlementRequestedEventProto, TextProto, Vector4iProto, PointerOverEventProto, ConstraintProto, RunResumedEventProto, RunStopRequestedEventProto, TimerResumedEventProto, RunFailedEventProto, PointerMoveEventProto, FolderProto, JoinProto, VariantProto, EffectStyleProto, UserProto, StringConstraintProto, EntitlementProto, RoleEventProto, TriggerProto, ContentViewProto, RouteProto, MetricProto, SceneProto, TimerEventProto, SelectProto, CounterMetricProto, QueryProto, EffectProto, WheelEventProto, UniverseProto, ServiceProto, TimerCompletedEventProto, HistogramMeasurementEventProto, BuiltinDefinitionProto, SignalEventProto, RecordProto, GradientProto, ShadowProto, ActionProto, RunStartedEventProto, TaggingProto, EntitlementGrantedEventProto, StrokeCapProto, InviteProto, SanctionEventProto, EntityProto, EntitlementExpiredEventProto, Grid2Proto, CustomEnumProto, TransitionProto, QuaternionProto, Vector3iProto, FileProto, ViewEventProto, SingleClickEventProto, Corner2Proto, MethodProto, ReactionProto, PaletteProto, FocusInEventProto, Vector2iProto, KeyPressEventProto, RunPausedEventProto, LabelViewProto, SanctionGrantedEventProto, DragLeaveEventProto, CollectionConstraintProto, NotificationReadEventProto, EventProto, PointerEventProto, LengthProto, EnvironmentProto, InviteSentEventProto, Entity3DProto, TripleClickEventProto, InviteRejectedEventProto, BorderStyleProto, AggregationProto, EntitlementRevokedEventProto, ArrowShape2DProto, LogEventProto, ViewProto, NotificationProto, FontStyleProto, RunPauseRequestedEventProto, DatabaseProto, SortProto, ExpressionProto, IconProto, MigrationDefinitionProto, ActionDefinitionProto, MembershipProto, InputEventProto, TextViewProto, NotificationSentEventProto, ConstraintDefinitionProto, StrokePathProto, NodeProto, NumberConstraintProto, MembershipJoinedEventProto, TimerPausedEventProto, ScheduleProto, CustomPropertyProto, FollowProto, PropertyReferenceProto, SpanEventProto, NotificationDismissedEventProto, StructDefinitionProto, TextSpanProto, Offset2Proto, TimerProto, ThemeProto, ScriptProto, KeyUpEventProto, PointerUpEventProto, RunEventProto, Inset2Proto, SliderInputViewProto, LayerProto, FunctionProto, InviteAcceptedEventProto, SanctionExpiredEventProto, HandleProto, StageProto, Arrow2DProto, TimerCancelledEventProto, StrokeProto, ColorStyleProto, MembershipEventProto, PathShape2DProto, InviteEventProto, MembershipLeftEventProto, PointerLeaveEventProto, CustomEventProto, Shape3DProto, GradientStopProto, StarAddedEventProto, PasteEventProto, OptionDefinitionProto, FollowRemovedEventProto, DragEnterEventProto, ObjectDefinitionReferenceProto, ReactionEventProto, DragOverEventProto, GradientStyleProto, StarProto, FrameViewProto, ClickEventProto, DropEventProto, LayoutViewProto, IndexDefinitionProto, Line2DProto, Vector3Proto, DatumProto, PointerEnterEventProto, ResourceProto, RunResumeRequestedEventProto, PointerDownEventProto, GaugeMetricProto, NodeDefinitionProto, NumberInputViewProto, BorderProto, TransitionStyleProto, BranchProto, OrganizationProto, PropertyDefinitionProto, MigrationProto, CopyEventProto, RunCompletedEventProto, PolygonShape2DProto, SplitViewProto, ConditionProto, StrokeStyleProto, IndexProto, ShadowStyleProto, StarRemovedEventProto, KeyDownEventProto, ConstantDefinitionProto, EntitlementEventProto, StrokePointProto, MigrationOperationProto, StyleProto, SanctionRevokedEventProto, NotificationRescindedEventProto, TeamProto, TraitDefinitionProto, TagDefinitionProto, ClipboardEventProto, PermissionDefinitionProto, Vector2Proto, SpaceProto, EllipseShape2DProto, PermissionProto, MachineProto, TypeProto, ColorProto, Axis2Proto, SnapshotProto, NodeDefinitionReferenceProto, ReactionAddedEventProto, InputViewProto } from '@destack/proto';
