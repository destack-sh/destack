...
import type { InputView, InputEvent, Join, CustomOption, Snapshot, Border, Variant, DragOverEvent, LayoutView, LogEvent, SpanEvent, TagDefinition, Constraint, TextView, File, TimerCompletedEvent, Polygon2D, RunPauseRequestedEvent, PathShape2D, GaugeMeasurementEvent, TimerCancelledEvent, FollowEvent, Folder, IndexDefinition, RectangleShape2D, CutEvent, EntitlementEvent, ReactionEvent, GaugeMetric, ReactionRemovedEvent, FollowRemovedEvent, StrokePath, StructDefinition, EllipseShape2D, InviteEvent, Vector4, Expression, Condition, TimerEvent, Grid2, ColorStyle, Gradient, MembershipEvent, MigrationOperationDefinition, StrokeStyle, SignalEvent, Vector3, Team, Transition, SanctionGrantedEvent, ActionDefinition, Service, Entity3D, Axis3, Action, PointerEvent, PointerLeaveEvent, TimerResumedEvent, Script, Fill, CollectionConstraint, Vector4i, ViewEvent, InviteAcceptedEvent, CounterMetric, GradientStop, SplitView, Branch, DragEndEvent, Ellipse2D, MouseEvent, Trigger, InviteSentEvent, Type, Star, LabelView, PointerEnterEvent, ConstraintDefinition, DragEnterEvent, EntitlementRequestedEvent, CustomStruct, WheelEvent, Shape2D, Index, DatumMutable, Function, SanctionEvent, RunStopRequestedEvent, Route, Vector2i, Node, Role, FocusEvent, Corner2, Migration, MigrationOperation, ArrowShape2D, User, Length, BuiltinDefinition, CustomProperty, RunStartedEvent, NodeReference, EntitlementRevokedEvent, Environment, NumberInputView, PasteEvent, Machine, SliderInputView, ContentView, StrokeCap, DragStartEvent, Palette, TriggerEvent, Inset2, Aggregation, Color, SanctionRevokedEvent, CustomEvent, TransitionStyle, PointerDownEvent, Database, RoleEvent, SingleClickEvent, Tagging, OptionDefinition, PointerUpEvent, MeasurementEvent, Invite, ConstantDefinition, MethodDefinition, Timer, Struct, InviteRejectedEvent, StructDefinitionReference, NotificationDismissedEvent, Theme, GridSpan2, CopyEvent, TextSpan, NotificationSentEvent, FocusInEvent, EntitlementGrantedEvent, TimerPausedEvent, Sanction, Follow, FontStyle, NumberConstraint, Effect, Arrow2D, SanctionRequestedEvent, Offset2, Axis2, Entitlement, RunCompletedEvent, Stroke, PointerOverEvent, ReactionAddedEvent, MembershipJoinedEvent, Universe, Datum, Vector3i, ClipboardEvent, Vector2, RunFailedEvent, Entity, FillStyle, Client, EditEvent, ClickEvent, EntitlementExpiredEvent, Space, KeyEvent, Organization, Quaternion, FocusOutEvent, KeyUpEvent, Rectangle2D, Shape3D, NodeDefinitionReference, StrokePoint, PropertyDefinition, Membership, Shadow, Notification, Font, Event, DragEvent, Stage, FollowAddedEvent, EnumDefinition, StringConstraint, Value, Tag, RoleAssignedEvent, ShadowStyle, StarRemovedEvent, PointerMoveEvent, EffectStyle, View, Scene, Handle, RunEvent, NotificationReadEvent, Run, NodeDefinition, Style, ObjectDefinitionReference, NotificationEvent, RunPausedEvent, NotificationExpiredEvent, Select, Record, Permission, TimerStartedEvent, RoleUnassignedEvent, TripleClickEvent, Entity2D, HistogramMetric, Layer, Reaction, TraitDefinition, InviteRescindedEvent, StarEvent, Method, Schedule, PointerLongPressEvent, DragLeaveEvent, PropertyReference, KeyPressEvent, Path2D, NotificationRescindedEvent, GradientStyle, FrameView, StarAddedEvent, BorderStyle, CounterMeasurementEvent, KeyDownEvent, HistogramMeasurementEvent, SanctionExpiredEvent, RunResumedEvent, Text, DropEvent, SceneEvent, Metric, Line2D, LineShape2D, PermissionDefinition, CustomEnum, MembershipLeftEvent, DoubleClickEvent, Sort, Icon, RunResumeRequestedEvent, PolygonShape2D, Resource, MigrationDefinition, Query } from '@destack/language';
import { SnapshotProto, ConstantDefinitionProto, Vector4Proto, PointerDownEventProto, FocusOutEventProto, RunPauseRequestedEventProto, ColorStyleProto, ClientProto, SanctionExpiredEventProto, NumberInputViewProto, FillProto, SpanEventProto, EntitlementRequestedEventProto, TimerResumedEventProto, EnvironmentProto, ViewEventProto, IndexProto, MethodProto, FileProto, DoubleClickEventProto, FollowEventProto, ContentViewProto, UniverseProto, FontStyleProto, SanctionRevokedEventProto, NotificationEventProto, PasteEventProto, StarAddedEventProto, ScriptProto, NodeDefinitionProto, TimerProto, Entity2DProto, SpaceProto, ShadowProto, DragEnterEventProto, Path2DProto, CustomPropertyProto, TimerEventProto, StarEventProto, SanctionProto, RunPausedEventProto, DragEventProto, FollowRemovedEventProto, ScheduleProto, PathShape2DProto, FrameViewProto, PermissionProto, DragStartEventProto, MembershipJoinedEventProto, ValueProto, Ellipse2DProto, HandleProto, BorderStyleProto, EditEventProto, SignalEventProto, TeamProto, IconProto, StrokeCapProto, KeyPressEventProto, StructProto, Vector2iProto, InviteRejectedEventProto, PointerUpEventProto, ClickEventProto, EntityProto, RunStopRequestedEventProto, RoleUnassignedEventProto, KeyEventProto, CopyEventProto, TimerCancelledEventProto, NotificationExpiredEventProto, Grid2Proto, PointerMoveEventProto, LogEventProto, MetricProto, SliderInputViewProto, DatumMutableProto, RunResumeRequestedEventProto, FocusInEventProto, LabelViewProto, StringConstraintProto, ViewProto, GradientProto, StarProto, CustomStructProto, Inset2Proto, ReactionEventProto, RunProto, Vector2Proto, MigrationOperationDefinitionProto, Vector4iProto, VariantProto, ActionDefinitionProto, CustomEventProto, MigrationProto, PointerLongPressEventProto, StructDefinitionReferenceProto, SceneEventProto, RunEventProto, ResourceProto, FillStyleProto, Rectangle2DProto, PaletteProto, DatabaseProto, DragEndEventProto, PointerEnterEventProto, RoleAssignedEventProto, TimerCompletedEventProto, Vector3iProto, StrokePathProto, EntitlementExpiredEventProto, SanctionRequestedEventProto, EntitlementRevokedEventProto, NotificationDismissedEventProto, Axis3Proto, ClipboardEventProto, TraitDefinitionProto, FontProto, ConditionProto, Entity3DProto, ExpressionProto, Polygon2DProto, PointerEventProto, ReactionAddedEventProto, PropertyReferenceProto, TimerPausedEventProto, ArrowShape2DProto, TransitionProto, NumberConstraintProto, LengthProto, FunctionProto, Offset2Proto, MigrationOperationProto, SelectProto, DatumProto, MethodDefinitionProto, ThemeProto, CustomEnumProto, StructDefinitionProto, LayoutViewProto, MembershipEventProto, StyleProto, CutEventProto, EventProto, PropertyDefinitionProto, NodeProto, FollowAddedEventProto, InviteSentEventProto, InputEventProto, EntitlementEventProto, StrokePointProto, HistogramMetricProto, OptionDefinitionProto, InviteAcceptedEventProto, CollectionConstraintProto, SanctionEventProto, TagProto, RoleProto, StrokeProto, TriggerProto, MigrationDefinitionProto, ActionProto, JoinProto, ConstraintProto, BorderProto, Axis2Proto, RunFailedEventProto, SplitViewProto, MachineProto, SingleClickEventProto, GaugeMetricProto, LineShape2DProto, CounterMeasurementEventProto, Vector3Proto, BranchProto, EntitlementGrantedEventProto, NotificationProto, ObjectDefinitionReferenceProto, Arrow2DProto, QuaternionProto, TaggingProto, PointerLeaveEventProto, FolderProto, CounterMetricProto, TextProto, LayerProto, TagDefinitionProto, EffectStyleProto, SanctionGrantedEventProto, RunCompletedEventProto, RunStartedEventProto, StrokeStyleProto, BuiltinDefinitionProto, ConstraintDefinitionProto, SortProto, QueryProto, PermissionDefinitionProto, EffectProto, RectangleShape2DProto, RunResumedEventProto, EnumDefinitionProto, NotificationReadEventProto, TriggerEventProto, NotificationSentEventProto, DragOverEventProto, PolygonShape2DProto, RecordProto, ColorProto, TransitionStyleProto, NotificationRescindedEventProto, EllipseShape2DProto, GaugeMeasurementEventProto, MeasurementEventProto, NodeReferenceProto, MouseEventProto, TextSpanProto, SceneProto, KeyDownEventProto, TextViewProto, FollowProto, ShadowStyleProto, ServiceProto, AggregationProto, RoleEventProto, WheelEventProto, Line2DProto, UserProto, DragLeaveEventProto, StageProto, GradientStopProto, StarRemovedEventProto, InviteEventProto, GradientStyleProto, ReactionRemovedEventProto, Corner2Proto, TripleClickEventProto, InputViewProto, FocusEventProto, RouteProto, HistogramMeasurementEventProto, Shape2DProto, EntitlementProto, PointerOverEventProto, KeyUpEventProto, ReactionProto, TypeProto, Shape3DProto, GridSpan2Proto, OrganizationProto, CustomOptionProto, NodeDefinitionReferenceProto, InviteProto, MembershipLeftEventProto, MembershipProto, DropEventProto, TimerStartedEventProto, IndexDefinitionProto, InviteRescindedEventProto } from '@destack/proto';
