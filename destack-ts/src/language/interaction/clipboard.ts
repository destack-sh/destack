...
export class CopyEvent extends ClipboardEvent {
  ...
  constructor(options: {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for CopyEvent`);
      }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for CopyEvent`);
      }
  ...
  toCson(): { [key: string]: any } {
    return CopyEvent.__packCson__(this);
  }

  static __packCson__(object: CopyEvent): { [key: string]: any } {
...
export class CutEvent extends ClipboardEvent {
  ...
  constructor(options: {
    ...
    if (_branch === null) {
      _branch = ACTIVE_BRANCH.get();
      if (_branch === null) {
        throw new Error(`no active Branch for CutEvent`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
    ...
    if (_snapshot === null) {
      _snapshot = ACTIVE_SNAPSHOT.get();
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for CutEvent`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
  ...
  toCson(): { [key: string]: any } {
    return CutEvent.__packCson__(this);
  }

  static __packCson__(object: CutEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
...
export class PasteEvent extends ClipboardEvent {
  ...
  constructor(options: {
    ...
    if (_branch === null) {
      _branch = ACTIVE_BRANCH.get();
      if (_branch === null) {
        throw new Error(`no active Branch for PasteEvent`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
    ...
    if (_snapshot === null) {
      _snapshot = ACTIVE_SNAPSHOT.get();
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for PasteEvent`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
  ...
  toCson(): { [key: string]: any } {
    return PasteEvent.__packCson__(this);
  }

  static __packCson__(object: PasteEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
