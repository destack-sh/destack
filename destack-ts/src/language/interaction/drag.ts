...
export class DragStartEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DragStartEvent.isExtensible is required`);
    }
  ...
  static fromCson(
    ...
    return DragStartEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class DragEndEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DragEndEvent.isExtensible is required`);
    }
    this.isExtensible = _isExtensible;
    let _node = options.node ?? null;
    if (_node != null && _node.metatype != StructType.NODE_REFERENCE) {
  ...
  static fromCson(
    ...
    return DragEndEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class DragOverEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DragOverEvent.isExtensible is required`);
    }
    this.isExtensible = _isExtensible;
    let _node = options.node ?? null;
    if (_node != null && _node.metatype != StructType.NODE_REFERENCE) {
  ...
  static fromCson(
    ...
    return DragOverEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class DragEnterEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DragEnterEvent.isExtensible is required`);
    }
    this.isExtensible = _isExtensible;
    let _node = options.node ?? null;
    if (_node != null && _node.metatype != StructType.NODE_REFERENCE) {
  ...
  static fromCson(
    ...
    return DragEnterEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class DragLeaveEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DragLeaveEvent.isExtensible is required`);
    }
    this.isExtensible = _isExtensible;
    let _node = options.node ?? null;
    if (_node != null && _node.metatype != StructType.NODE_REFERENCE) {
  ...
  static fromCson(
    ...
    return DragLeaveEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class DropEvent extends DragEvent {
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`DropEvent.isExtensible is required`);
    }
    this.isExtensible = _isExtensible;
    let _node = options.node ?? null;
    if (_node != null && _node.metatype != StructType.NODE_REFERENCE) {
  ...
  static fromCson(
    ...
    return DropEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
