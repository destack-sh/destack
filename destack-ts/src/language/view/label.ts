 ...
 */
export class LabelView extends LayoutView {
   ...
   */
  get precededBy(): LabelView | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as LabelView | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    precededBy?: LabelView | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for LabelView`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for LabelView`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`LabelView.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for LabelView`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`LabelView.snapshot is required`);
    }
    ...
    if (options.id == null) {
      ...
      if (
        ...
        throw new Error(
          `LabelView.createdAt and LabelView.updatedAt are required for existing Nodes`,
        );
      }
  ...
  toCson(): { [key: string]: any } {
    return LabelView.__packCson__(this);
  }

  static __packCson__(object: LabelView): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return LabelView.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return LabelView.__unpackProto__(objectProto, _session, _graph, _connection);
  }
