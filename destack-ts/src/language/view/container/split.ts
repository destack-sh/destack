import { IsTracked, Dimension, IsExtensible, ACTIVE_SESSION, Distribute, Window, IsVisual, Position, Spatial, Value, EnumType, IsOrdered, MaterializationType, Entity, AnnotationShape, Direction, Space, StructType, CustomView, Vector2, Struct, Axis2, ContainerView, IsScriptable, LabelView, PlaneShape, Layout, Scene, NodeReference, GridSpan, Axis3, Border, NodeType, Graph, User, Corners, Layer, Agent, IsTaggable, Insets, Fill, Node, QueryConnection, Align, View, CustomViewDefinition, StructFrozen, Script, Canvas, Supergraph, IsDeletable, FrameView, BuiltinObject, Session, activeSession, Shadow, Grid } from '@/language';
import { Temporal } from 'temporal-polyfill'; // until Temporal ships natively

/* ==== DESTACK_GENERATED_START:NODE:10040 ==== */
export class SplitView extends Node implements Spatial, Entity, IsTracked, IsDeletable, IsExtensible, IsOrdered, IsTaggable, IsScriptable, IsVisual, View, ContainerView {
  readonly id: string;
  ...
  __toRef__(): NodeReference {
    return new NodeReference(NodeType.SPLIT_VIEW, this.id, this.spacePtr?.id ?? null, null, this._supergraph);
  }
