...
/* ==== DESTACK_GENERATED_START:NODE:520200 ==== */
/**
...
export class FrameView extends ContainerView {
   ...
   */
  get predecessor(): FrameView | null {
  ...
  constructor(options: {
    ...
    predecessor?: FrameView | NodeReference | null;
    template?: FrameView | NodeReference | null;
    ...
    if (_space === null) {
      if (this._session === null) {
        throw new Error(`FrameView has no Session`);
      }
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`FrameView has no Space`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
  ...
  static __packProto__(object: FrameView): FrameViewProto {
    const objectProto: Partial<FrameViewProto> = { metatype: 520200 };
...
/* ==== DESTACK_GENERATED_END:NODE:520200 ==== */
