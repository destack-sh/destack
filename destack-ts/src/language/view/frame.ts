 ...
 */
export class FrameView extends LayoutView {
  ...
  get precededBy(): FrameView | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as FrameView | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return FrameView.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return FrameView.__unpackProto__(objectProto, _session, _graph, _connection);
  }
