  ...
  implements IsOwnable, IsJoinable, IsOrdered, IsStarable, IsFollowable, IsReactable
{
  ...
  get parent(): Space | Folder | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Space | Folder | null;
    }
    return null;
  }
  ...
  get precededBy(): Folder | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Folder | null;
    }
    return null;
  }
  ...
  static __unpackCson__(
    ...
    const unpackedMainScenePtr =
      mainScenePtrValue != undefined
        ? _NodeReference.fromCson(mainScenePtrValue, _session, _graph, _connection)
        : null;
  ...
  static fromCson(
    ...
    return Folder.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Folder.__unpackProto__(objectProto, _session, _graph, _connection);
  }
