import { Agent, BuiltinObject, ACTIVE_SESSION, Folder, Session, StructFrozen, Graph, Struct, activeSession, Global, StructType, NodeType, Supergraph, QueryConnection, NodeReference, MaterializationType, IsOwnable, User, Spatial, LikeFollow, Space, IsDeletable, Entity, EnumType, Node, IsTracked } from '@/language';
