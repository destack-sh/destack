...
export class Follow extends Entity implements IsOwned {
  ...
  get parent(): (Entity & IsFollowable) | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as (Entity & IsFollowable) | null;
    }
    return null;
  }
  ...
  get precededBy(): Follow | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Follow | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Follow`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Follow`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Follow.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Follow`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Follow.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Follow.__packCson__(this);
  }

  static __packCson__(object: Follow): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Follow.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Follow.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class FollowEvent extends Event {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`no active Space for FollowEvent`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      _branch = ACTIVE_BRANCH.get();
      if (_branch === null) {
        throw new Error(`no active Branch for FollowEvent`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`FollowEvent.branch is required`);
    }
    this.branchPtr = _branch as NodeReference;
    let _snapshot = options.snapshot ?? null;
    if (_snapshot != null && _snapshot.constructor.name != "NodeReference") {
    ...
    if (_snapshot === null) {
      _snapshot = ACTIVE_SNAPSHOT.get();
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for FollowEvent`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`FollowEvent.snapshot is required`);
    }
    this.snapshotPtr = _snapshot as NodeReference;
    let _precededBy = options.precededBy ?? null;
    if (_precededBy != null && _precededBy.constructor.name != "NodeReference") {
  ...
  toCson(): { [key: string]: any } {
    return FollowEvent.__packCson__(this);
  }

  static __packCson__(object: FollowEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
  ...
  static fromCson(
    ...
    return FollowEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return FollowEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class FollowAddedEvent extends FollowEvent {
  ...
  toCson(): { [key: string]: any } {
    return FollowAddedEvent.__packCson__(this);
  }

  static __packCson__(object: FollowAddedEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
  ...
  static fromCson(
    ...
    return FollowAddedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return FollowAddedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class FollowRemovedEvent extends FollowEvent {
  ...
  toCson(): { [key: string]: any } {
    return FollowRemovedEvent.__packCson__(this);
  }

  static __packCson__(object: FollowRemovedEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
  ...
  static fromCson(
    ...
    return FollowRemovedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return FollowRemovedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
