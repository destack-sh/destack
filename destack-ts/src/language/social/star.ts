import { User, IsOwnable, NodeReference, Entity, Supergraph, EnumType, StructType, Space, IsTracked, Spatial, Folder, MaterializationType, Session, QueryConnection, Global, IsDeletable, Node, BuiltinObject, Graph, Agent, NodeType, Struct, StructFrozen } from '@/language';
