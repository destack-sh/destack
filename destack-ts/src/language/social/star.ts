 ...
 */
export class Star extends Entity implements IsDeletable, IsOwned {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      if (this._session === null) {
        throw new Error(`Star has no Session`);
      }
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`Star has no Space`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
  ...
  static fromValue(
    ...
    return Star.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }
...
export class StarEvent extends Event {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      if (this._session === null) {
        throw new Error(`StarEvent has no Session`);
      }
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`StarEvent has no Space`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
  ...
  static fromValue(
    ...
    return StarEvent.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }
...
export class StarAddedEvent extends StarEvent {
  ...
  static fromValue(
    ...
    return StarAddedEvent.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }
...
export class StarRemovedEvent extends StarEvent {
  ...
  static fromValue(
    ...
    return StarRemovedEvent.__unpackValue__(
      objectValue,
      _session,
      _supergraph,
      _graph,
