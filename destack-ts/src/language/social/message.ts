import { BorderStyle, GaugeMeasurement, Window, ShadowStyle, Interruption, Span, Database, PlaneShape, TextView, InviteEvent, CustomStructDefinition, Membership, IsTracked, Role, EffectStyle, Team, ArrowShape, Sanction, Theme, Palette, Friendship, MembershipEvent, HistogramMeasurement, User, NodeType, Thread, StructFrozen, TimerEvent, EntitlementEvent, CustomEnumDefinition, Handle, NodeReference, Machine, Entity, Tagging, Notification, Supergraph, Star, SplitView, Client, SanctionEvent, Folder, Canvas, CounterMeasurement, Script, Session, HistogramMetric, Layer, Reaction, Action, Log, Route, SceneEvent, Struct, CustomEvent, CustomView, IsReactable, CustomEntityDefinition, EnumType, AnnotationShape, StructType, Invite, GradientStyle, Space, IsTaggable, ScreenCursor, Run, Spatial, RoleEvent, TransitionStyle, ThreadView, Text, IsDeletable, Node, BuiltinObject, CustomEventDefinition, NotificationEvent, LineShape, Permission, Agent, Option, Trigger, ThreadCursor, WizardView, FriendshipInviteEvent, LabelView, FriendshipInvite, SliderInputView, Branch, IsOwnable, Environment, Scene, Entitlement, TriggerEvent, GaugeMetric, EditEvent, NumberInputView, EventCursor, CustomViewDefinition, ColorStyle, Service, Organization, CounterMetric, Timer, Link, MaterializationType, QueryConnection, Follow, Field, FontStyle, FrameView, Tag, Graph, FillStyle, File, RunEvent, Variant, Snapshot, CustomEntity } from '@/language';
