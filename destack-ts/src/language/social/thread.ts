import { Folder, IsTaggable, EnumType, StructType, Node, QueryConnection, User, IsDeletable, NodeReference, Graph, Spatial, IsOwnable, IsJoinable, Role, Agent, Space, Team, StructFrozen, Struct, BuiltinObject, Organization, NodeType, Session, MaterializationType, Entity, Supergraph, IsTracked } from '@/language';
