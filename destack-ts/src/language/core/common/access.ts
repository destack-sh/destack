...
import { MaterializationProto, PermissionProto } from "@destack/proto";
...
export class Permission extends Entity {
  ...
  get precededBy(): Permission | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Permission | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Permission`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Permission`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Permission.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Permission`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Permission.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Permission.__packCson__(this);
  }

  static __packCson__(object: Permission): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Permission.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Permission.__unpackProto__(objectProto, _session, _graph, _connection);
  }
