 ...
 */
export class CustomEnum extends Entity {
  ...
  get precededBy(): CustomEnum | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as CustomEnum | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for CustomEnum`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for CustomEnum`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`CustomEnum.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return CustomEnum.__packCson__(this);
  }

  static __packCson__(object: CustomEnum): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return CustomEnum.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return CustomEnum.__unpackProto__(objectProto, _session, _graph, _connection);
  }
 ...
 * CustomOption
 */
export class CustomOption extends Entity {
  ...
  get precededBy(): CustomOption | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as CustomOption | null;
    }
    return null;
  }
  readonly precededByPtr: NodeReference | null;
  ...
  constructor(options: {
    ...
    if (_space === null) {
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`no active Space for CustomOption`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_snapshot === null) {
      _snapshot = ACTIVE_SNAPSHOT.get();
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for CustomOption`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`CustomOption.snapshot is required`);
    }
    this.snapshotPtr = _snapshot as NodeReference;
    let _precededBy = options.precededBy ?? null;
    if (_precededBy != null && _precededBy.constructor.name != "NodeReference") {
  ...
  toCson(): { [key: string]: any } {
    return CustomOption.__packCson__(this);
  }

  static __packCson__(object: CustomOption): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 20400;
    objectCson["2"] = String(object.id);
    if (object.parentPtr != null) {
  ...
  static fromCson(
    ...
    return CustomOption.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return CustomOption.__unpackProto__(objectProto, _session, _graph, _connection);
  }
