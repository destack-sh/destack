...
export class Index extends Entity {
  ...
  get precededBy(): Index | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Index | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return Index.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Index.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class Constraint extends Entity {
  ...
  get precededBy(): Constraint | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Constraint | null;
    }
    return null;
  }
  readonly precededByPtr: NodeReference | null;
  ...
  static fromCson(
    ...
    return Constraint.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Constraint.__unpackProto__(objectProto, _session, _graph, _connection);
  }
