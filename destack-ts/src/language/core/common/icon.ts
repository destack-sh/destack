import { Supergraph, EnumType, Graph, Session, QueryConnection, StructType, File, Color, NodeReference, NodeType, Struct, StructFrozen, Node, BuiltinObject } from '@/language';
