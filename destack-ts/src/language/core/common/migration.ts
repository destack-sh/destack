...
export class MigrationDefinition extends BuiltinDefinition {
  ...
  static fromCson(
    ...
    return MigrationDefinition.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return MigrationDefinition.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class MigrationOperationDefinition extends BuiltinDefinition {
  ...
  static fromCson(
    ...
    return MigrationOperationDefinition.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return MigrationOperationDefinition.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class Migration extends Entity {
  ...
  get precededBy(): Migration | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Migration | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return Migration.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Migration.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class MigrationOperation extends Entity {
  ...
  get precededBy(): MigrationOperation | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as MigrationOperation | null;
    }
    return null;
  }
  readonly precededByPtr: NodeReference | null;
  ...
  static fromCson(
    ...
    return MigrationOperation.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return MigrationOperation.__unpackProto__(objectProto, _session, _graph, _connection);
  }
