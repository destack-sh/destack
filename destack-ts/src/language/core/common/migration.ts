  ...
  constructor(options: {
    ...
    if (_space === null) {
      if (this._session === null) {
        throw new Error(`Migration has no Session`);
      }
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`Migration has no Space`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
...
export class MigrationOperation extends Entity {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      if (this._session === null) {
        throw new Error(`MigrationOperation has no Session`);
      }
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`MigrationOperation has no Space`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
