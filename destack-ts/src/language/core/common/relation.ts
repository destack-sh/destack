import { Supergraph, EnumType, Graph, Session, QueryConnection, StructType, Region, TraitType, CustomEntityDefinition, Field, NodeType, Struct, StructFrozen, Node, BuiltinObject } from '@/language';
