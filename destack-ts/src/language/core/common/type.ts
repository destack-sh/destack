import { BorderStyle, GaugeMeasurement, Window, ShadowStyle, Interruption, Span, Database, PlaneShape, TextView, InviteEvent, CustomStructDefinition, Membership, Role, EffectStyle, Team, ArrowShape, Sanction, Theme, Value, TraitType, Palette, Friendship, MembershipEvent, HistogramMeasurement, User, NodeType, Thread, StructFrozen, TypeCardinality, TimerEvent, EntitlementEvent, CustomEnumDefinition, ScalarType, Handle, NodeReference, Machine, Tagging, Notification, Supergraph, Star, SplitView, Client, SanctionEvent, Folder, Canvas, CounterMeasurement, Script, Session, HistogramMetric, Layer, Reaction, Action, Log, Route, SceneEvent, Struct, CustomEvent, CustomView, CustomEntityDefinition, EnumType, AnnotationShape, StructType, Invite, GradientStyle, Space, Run, ScreenCursor, TransitionStyle, RoleEvent, ThreadView, Node, BuiltinObject, CustomEventDefinition, NotificationEvent, LineShape, Permission, Agent, Option, Trigger, ThreadCursor, PrimitiveType, WizardView, FriendshipInviteEvent, LabelView, FriendshipInvite, SliderInputView, Branch, Scene, Environment, Entitlement, TriggerEvent, GaugeMetric, EditEvent, NumberInputView, EventCursor, CustomViewDefinition, ColorStyle, Service, Organization, CounterMetric, Timer, DefaultFactory, Link, Message, QueryConnection, Follow, Field, FontStyle, FrameView, Tag, Graph, FillStyle, File, RunEvent, Variant, Snapshot, CustomEntity } from '@/language';
