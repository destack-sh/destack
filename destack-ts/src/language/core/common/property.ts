...
export class CustomProperty extends Entity {
  ...
  static __packCson__(object: CustomProperty): { [key: string]: any } {
    ...
    if (object._customDefinitionPtr != null) {
      objectCson["116"] = object._customDefinitionPtr.toCson();
    }
  ...
  static fromCson(
    ...
    return CustomProperty.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static __packProto__(object: CustomProperty): CustomPropertyProto {
    ...
    if (object._customDefinitionPtr != null) {
      objectProto.customDefinitionPtr = object._customDefinitionPtr.toProto();
    }
    if (object._keyType != null) {
  ...
  static fromProto(
    ...
    return CustomProperty.__unpackProto__(objectProto, _session, _graph, _connection);
  }
