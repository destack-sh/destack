...
export class Branch extends Entity implements IsOwnable {
  ...
  constructor(options: {
    ...
    if (_orderKey === null) {
      throw new Error(`Branch.orderKey is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Branch.__packCson__(this);
  }

  static __packCson__(object: Branch): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Branch.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static __packProto__(object: Branch): BranchProto {
    ...
    objectProto.type = Number(object._type) as BranchTypeProto;
  ...
  static fromProto(
    ...
    return Branch.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
/* ==== DESTACK_GENERATED_START:NODE:2100 ==== */
/**
...
export class Snapshot extends Entity implements IsOwnable {
  ...
  constructor(options: {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Snapshot`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Snapshot.branch is required`);
    }
    this.branchPtr = _branch as NodeReference;
    let _snapshot = options.snapshot ?? null;
    if (_snapshot != null && _snapshot.constructor.name != "NodeReference") {
    ...
    if (_orderKey === null) {
      throw new Error(`Snapshot.orderKey is required`);
    }
    this.orderKey = _orderKey;
    let _customValues = options.customValues ?? null;
    if (_customValues === null) {
  ...
  toCson(): { [key: string]: any } {
    return Snapshot.__packCson__(this);
  }

  static __packCson__(object: Snapshot): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 2100;
    objectCson["2"] = String(object.id);
    if (object.parentPtr != null) {
  ...
  static fromCson(
    ...
    return Snapshot.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Snapshot.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
/* ==== DESTACK_GENERATED_END:NODE:2100 ==== */

/* ==== DESTACK_GENERATED_START:ENUM:2000 ==== */
/**
 * BranchType
 */
...
registerEnumClass(EnumType.BRANCH_TYPE, BranchType);
/* ==== DESTACK_GENERATED_END:ENUM:2000 ==== */

/* ==== DESTACK_GENERATED_START:ENUM:2100 ==== */
/**
 * SnapshotType
 */
...
/* ==== DESTACK_GENERATED_END:ENUM:2100 ==== */

/* ==== DESTACK_GENERATED_START:ENUM:2101 ==== */
/**
 * SnapshotStatus
 */
...
/* ==== DESTACK_GENERATED_END:ENUM:2101 ==== */
