...
export class Branch extends Entity implements IsOwnable {
  ...
  static fromCson(
    ...
    return Branch.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
...
export class Snapshot extends Entity implements IsOwnable {
  ...
  static fromCson(
    ...
    return Snapshot.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
