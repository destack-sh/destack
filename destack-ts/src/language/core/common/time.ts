...
export class Snapshot extends Entity implements IsOwnable {
  ...
  static __packProto__(object: Snapshot): SnapshotProto {
    const objectProto: Partial<SnapshotProto> = { metatype: 11100 };
...
export class Branch extends Entity implements IsOwnable {
  ...
  static __packProto__(object: Branch): BranchProto {
    const objectProto: Partial<BranchProto> = { metatype: 11000 };
    objectProto.id = String(object.id);
    if (object.parentPtr != null) {
      objectProto.parentPtr = object.parentPtr.toProto();
    }
...
/* ==== DESTACK_GENERATED_START:ENUM:11100 ==== */
/**
 * SnapshotType
 */
...
/* ==== DESTACK_GENERATED_END:ENUM:11100 ==== */

/* ==== DESTACK_GENERATED_START:ENUM:11101 ==== */
/**
 * SnapshotStatus
 */
...
/* ==== DESTACK_GENERATED_END:ENUM:11101 ==== */
