...
export class Tag extends Entity implements IsOrdered {
  ...
  static fromCson(
    ...
    return Tag.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Tag.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class Tagging extends Entity implements IsOrdered {
  ...
  constructor(options: {
    ...
    if (_tag != null && _tag.constructor.name != "NodeReference") {
      _tag = (_tag as Node).toRef();
    }
    if (_tag === null) {
      throw new Error(`Tagging.tag is required`);
    }
    this._tagPtr = _tag as NodeReference;
  ...
  static __unpackCson__(
    ...
    const unpackedKey = keyValue != undefined ? keyValue : null;
    return new Tagging({
      tag: _NodeReference.fromCson(objectCson["110"], _session, _graph, _connection),
      parent: unpackedParentPtr,
      materialization: Number(objectCson["10"]),
      definition: unpackedDefinitionPtr,
      branch: _NodeReference.fromCson(objectCson["12"], _session, _graph, _connection),
  ...
  static fromCson(
    ...
    return Tagging.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static __unpackProto__(
    ...
    return new Tagging({
      tag: _NodeReference.fromProto(objectProto.tagPtr!, _session, _graph, _graph, _connection),
      parent:
        objectProto.parentPtr != undefined
          ? _NodeReference.fromProto(objectProto.parentPtr!, _session, _graph, _graph, _connection)
          : null,
  ...
  static fromProto(
    ...
    return Tagging.__unpackProto__(objectProto, _session, _graph, _connection);
  }
