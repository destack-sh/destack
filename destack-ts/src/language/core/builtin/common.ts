...
export enum NodeType {
  ...
  CUSTOM_ENTITY = 2001,
  CUSTOM_TRAIT_DEFINITION = 2002,
  CUSTOM_EVENT_DEFINITION = 4300,
  CUSTOM_EVENT = 4301,
  ...
  INVITE = 520,
  INVITE_EVENT = 521,
  INVITE_SENT_EVENT = 522,
  INVITE_RESCINDED_EVENT = 523,
  INVITE_ACCEPTED_EVENT = 524,
  INVITE_REJECTED_EVENT = 525,
  ROLE = 540,
  ROLE_EVENT = 541,
  ...
  TIMER_COMPLETED_EVENT = 3111,
  TIMER_CANCELLED_EVENT = 3112,
  CURSOR = 3200,
  EVENT_CURSOR = 3201,
  SCREEN_CURSOR = 3202,
  THREAD_CURSOR = 3203,
  ...
  LOG_EVENT = 4100,
  METRIC = 4200,
  MEASUREMENT_EVENT = 4220,
  GAUGE_METRIC = 4240,
  GAUGE_MEASUREMENT_EVENT = 4241,
  COUNTER_METRIC = 4260,
  COUNTER_MEASUREMENT_EVENT = 4261,
  HISTOGRAM_METRIC = 4280,
  HISTOGRAM_MEASUREMENT_EVENT = 4281,
  EDIT_EVENT = 4302,
  ENVIRONMENT = 4500,
  THREAD = 5500,
  MESSAGE = 5520,
  ...
  INPUT_EVENT = 9500,
  POINTER_EVENT = 9510,
  POINTER_DOWN_EVENT = 9511,
  POINTER_UP_EVENT = 9512,
  POINTER_MOVE_EVENT = 9513,
  POINTER_ENTER_EVENT = 9514,
  POINTER_OVER_EVENT = 9515,
  POINTER_LEAVE_EVENT = 9516,
  LONG_PRESS_EVENT = 9517,
  MOUSE_EVENT = 9520,
  CLICK_EVENT = 9521,
  LEFT_CLICK_EVENT = 9522,
  RIGHT_CLICK_EVENT = 9523,
  MIDDLE_CLICK_EVENT = 9524,
  DOUBLE_CLICK_EVENT = 9525,
  WHEEL_EVENT = 9526,
  KEYBOARD_EVENT = 9530,
  KEY_DOWN_EVENT = 9531,
  KEY_UP_EVENT = 9532,
  KEY_PRESS_EVENT = 9533,
  DRAG_EVENT = 9540,
  DRAG_START_EVENT = 9541,
  DRAG_END_EVENT = 9542,
  DRAG_OVER_EVENT = 9543,
  DRAG_ENTER_EVENT = 9544,
  DRAG_LEAVE_EVENT = 9545,
  DROP_EVENT = 9546,
  CLIPBOARD_EVENT = 9550,
  COPY_EVENT = 9551,
  CUT_EVENT = 9552,
  PASTE_EVENT = 9553,
  FOCUS_EVENT = 9560,
  FOCUS_IN_EVENT = 9561,
  FOCUS_OUT_EVENT = 9562,
  ...
  TEXT_VIEW = 10220,
  INPUT_VIEW = 10400,
  NUMBER_INPUT_VIEW = 10420,
  SLIDER_INPUT_VIEW = 10440,
  INTERNAL_VIEW = 10600,
  CANVAS = 11000,
  SHAPE = 11020,
  LINE_SHAPE = 11040,
  ...
  BORDER_STYLE = 12063,
  SHADOW_STYLE = 12064,
  GRADIENT_STYLE = 12065,
  TRANSITION_STYLE = 12066,
  EFFECT_STYLE = 12067,
  STROKE_STYLE = 12068,
...
/* ==== DESTACK_GENERATED_START:ENUM:50014 ==== */
/**
 * MaterializationType
 */
...
/* ==== DESTACK_GENERATED_END:ENUM:50014 ==== */
