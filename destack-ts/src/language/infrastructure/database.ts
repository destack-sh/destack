...
export class Database extends Resource {
  ...
  get precededBy(): Database | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Database | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return Database.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Database.__unpackProto__(objectProto, _session, _graph, _connection);
  }
