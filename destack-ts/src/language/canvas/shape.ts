 ...
 */
export class Shape extends Node implements ContainerView {
  ...
  constructor(options: {
    ...
    if (_orderKey === null) {
      throw new Error(`Shape.orderKey is required`);
    }
  ...
  repr(): string {
    ...
    return `<Shape '${this.path}' ${propertyReprs.join(" ")}>`;
  }

  toValue(): { [key: string]: any } {
    return Shape.__packValue__(this);
  }

  static __packValue__(object: Shape): { [key: string]: any } {
  ...
  static fromValue(
    ...
    return Shape.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }

  toProto(): ShapeProto {
    return Shape.__packProto__(this);
  }

  static __packProto__(object: Shape): ShapeProto {
    const objectProto: Partial<ShapeProto> = { metatype: 11020 };
    ...
    return objectProto as ShapeProto;
  }

  static __unpackProto__(
    objectProto: ShapeProto,
    _session?: Session | null,
    _supergraph?: Supergraph | null,
    _graph?: any | null,
    _connection?: any | null,
  ...
  static fromProto(
    ...
    return Shape.__unpackProto__(objectProto, _session, _supergraph, _graph, _connection);
  }

  static fromProtoString(packedProtoString: string): Shape {
    const packedProtoBytes = base64Decode(packedProtoString);
    const packedProto = ShapeProto.fromBinary(packedProtoBytes);
