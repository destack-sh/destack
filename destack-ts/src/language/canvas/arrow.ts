...
export class ArrowShape extends Shape {
  ...
  set startType(value: ArrowHeadType) {
    const oldValue = this.#startType;
    if (this._dirty == null) {
      this._dirty = {};
    }
    if (this._dirty["startType"] === undefined) {
      this._dirty["startType"] = oldValue;
    }
    if (!this._session.dirty[this.id]) {
      this._session.dirty[this.id] = this;
    }
  ...
  set endType(value: ArrowHeadType) {
    const oldValue = this.#endType;
    if (this._dirty == null) {
      this._dirty = {};
    }
    if (this._dirty["endType"] === undefined) {
      this._dirty["endType"] = oldValue;
    }
    if (!this._session.dirty[this.id]) {
      this._session.dirty[this.id] = this;
    }
  ...
  constructor(options: {
    ...
    template?: ArrowShape | NodeReference | null;
