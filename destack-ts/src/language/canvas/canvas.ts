import { IsTracked, Dimension, IsExtensible, ACTIVE_SESSION, Distribute, Window, IsVisual, Position, Spatial, Value, EnumType, IsOrdered, MaterializationType, Entity, AnnotationShape, Direction, Space, StructType, CustomView, SplitView, Vector2, Struct, Axis2, ContainerView, IsScriptable, LabelView, PlaneShape, Layout, Scene, NodeReference, GridSpan, Axis3, Border, NodeType, Graph, User, Corners, Layer, Agent, IsTaggable, Insets, Fill, Node, QueryConnection, Align, View, CustomViewDefinition, StructFrozen, Script, Supergraph, IsDeletable, FrameView, BuiltinObject, Session, activeSession, Shadow, Grid } from '@/language';
...
export class Canvas extends Node implements Spatial, Entity, IsTracked, IsDeletable, IsExtensible, IsOrdered, IsTaggable, IsScriptable, IsVisual, View, ContainerView {
  ...
  constructor(options: {
    ...
    this.type = options.type ?? CanvasType.SHAPE;
