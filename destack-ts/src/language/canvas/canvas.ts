import { Layer, Vector2, Agent, PlaneShape, Scene, Supergraph, StructFrozen, CustomViewDefinition, Border, IsDeletable, EnumType, Distribute, Struct, SplitView, Session, ContainerView, NodeReference, User, Position, Axis2, Shadow, Script, MaterializationType, BuiltinObject, Spatial, Graph, Grid, Direction, GridSpan, Dimension, CustomView, Align, NodeType, IsOrdered, Node, StructType, IsTracked, Value, QueryConnection, Layout, Insets, IsVisual, LabelView, FrameView, View, IsExtensible, AnnotationShape, IsTaggable, Corners, Window, Entity, IsScriptable, Fill, Space, Axis3 } from '@/language';
...
export class Canvas extends Node implements Spatial, Entity, IsTracked, IsDeletable, IsExtensible, IsOrdered, IsTaggable, IsScriptable, IsVisual, View, ContainerView {
  readonly id: string;
  ...
  __toRef__(): NodeReference {
    return new NodeReference(NodeType.CANVAS, this.id, this.spacePtr?.id ?? null, null, this._supergraph);
  }
