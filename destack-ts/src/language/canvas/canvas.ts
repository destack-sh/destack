...
export class Canvas extends ContainerView {
   ...
   */
  get predecessor(): Canvas | null {
    const nodePtr: NodeReference | null = this.predecessorPtr;
    if (nodePtr !== null) {
      return this._supergraph.get(nodePtr.id) as Canvas | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    predecessor?: Canvas | NodeReference | null;
    template?: Canvas | NodeReference | null;
    ...
    if (_materialization === null) {
      throw new Error(`Canvas.materialization is required`);
    }
    ...
    if (_type === null) {
      throw new Error(`Canvas.type is required`);
    }
    this._type = _type;
    ...
    if (options.id == null) {
      ...
      if (options.createdAt == null || options.updatedAt == null) {
        throw new Error(`Canvas.createdAt and Canvas.updatedAt are required for existing Nodes`);
      }
  ...
  static __packProto__(object: Canvas): CanvasProto {
    ...
    objectProto.type = Number(object._type) as CanvasTypeProto;
