 ...
 */
export class Line extends StructFrozen {
  static metatype: StructType = StructType.LINE;
  ...
  toCson(): { [key: string]: any } {
    if (this._cson === null) {
      // @ts-expect-error(readonly)
      this._cson = Line.__packCson__(this);
    }
    return this._cson;
  }

  static __packCson__(object: Line): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 1900100;
  ...
  static fromCson(
    ...
    return Line.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }

  toProto(): LineProto {
    if (this._proto === null) {
      // @ts-expect-error(readonly)
      this._proto = Line.__packProto__(this);
    }
    return this._proto as LineProto;
  }
  ...
  static fromProto(
    ...
    return Line.__unpackProto__(objectProto, _session, _supergraph, _graph, _connection);
  }

  static fromProtoString(packedProtoString: string): Line {
    const packedProtoBytes = base64Decode(packedProtoString);
    const packedProto = LineProto.fromBinary(packedProtoBytes);
...
export class LineShape extends Shape {
   ...
   */
  get precededBy(): LineShape | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._supergraph.get(nodePtr.id) as LineShape | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    precededBy?: LineShape | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for LineShape`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for LineShape`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`LineShape.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for LineShape`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`LineShape.snapshot is required`);
    }
    ...
    if (options.id == null) {
      ...
      if (
        ...
        throw new Error(
          `LineShape.createdAt and LineShape.updatedAt are required for existing Nodes`,
        );
      }
  ...
  toCson(): { [key: string]: any } {
    return LineShape.__packCson__(this);
  }

  static __packCson__(object: LineShape): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 1900100;
  ...
  static fromCson(
    ...
    return LineShape.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
