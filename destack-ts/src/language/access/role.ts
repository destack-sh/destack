...
/* ==== DESTACK_GENERATED_START:NODE:360201 ==== */
/**
...
/* ==== DESTACK_GENERATED_END:NODE:360201 ==== */

/* ==== DESTACK_GENERATED_START:NODE:360202 ==== */
/**
 * A Event regarding a Role.
 */
export class RoleAssignedEvent extends RoleEvent {
  ...
  readonly actorPtr: NodeReference;
  ...
  toCson(): { [key: string]: any } {
    return RoleAssignedEvent.__packCson__(this);
  }

  static __packCson__(object: RoleAssignedEvent): { [key: string]: any } {
    ...
    objectCson["110"] = object.actorPtr.toCson();
    return objectCson;
  }
  ...
  static __unpackCson__(
    ...
    return new RoleAssignedEvent({
      ...
      actor: _NodeReference.fromCson(objectCson["110"], _session, _graph, _connection),
  ...
  static fromCson(
    ...
    return RoleAssignedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static __packProto__(object: RoleAssignedEvent): RoleAssignedEventProto {
    ...
    objectProto.actorPtr = object.actorPtr.toProto();
  ...
  static __unpackProto__(
    ...
    return new RoleAssignedEvent({
      ...
      actor: _NodeReference.fromProto(objectProto.actorPtr!, _session, _graph, _graph, _connection),
      definition:
  ...
  static fromProto(
    ...
    return RoleAssignedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
/* ==== DESTACK_GENERATED_END:NODE:360202 ==== */

/* ==== DESTACK_GENERATED_START:NODE:360203 ==== */
/**
 * A Event regarding a Role.
 */
export class RoleUnassignedEvent extends RoleEvent {
  ...
  toCson(): { [key: string]: any } {
    return RoleUnassignedEvent.__packCson__(this);
  }

  static __packCson__(object: RoleUnassignedEvent): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 360203;
    objectCson["2"] = String(object.id);
    objectCson["5"] = object.spacePtr.toCson();
  ...
  static fromCson(
    ...
    return RoleUnassignedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return RoleUnassignedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
/* ==== DESTACK_GENERATED_END:NODE:360203 ==== */

/* ==== DESTACK_GENERATED_START:NODE:360200 ==== */
/**
 * A Role for Actors to take.
 */
export class Role extends Entity implements IsActor {
  ...
  toCson(): { [key: string]: any } {
    return Role.__packCson__(this);
  }

  static __packCson__(object: Role): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 360200;
    objectCson["2"] = String(object.id);
  ...
  static fromCson(
    ...
    return Role.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Role.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
/* ==== DESTACK_GENERATED_END:NODE:360200 ==== */
