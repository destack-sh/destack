...
export class RoleAssignedEvent extends RoleEvent {
  ...
  constructor(options: {
    ...
    if (_actor != null && _actor.metatype != StructType.NODE_REFERENCE) {
  ...
  static __unpackCson__(
    ...
    return new RoleAssignedEvent({
      ...
      actor: _NodeReference.fromCson(objectCson["110"], _session, _supergraph, _graph, _connection),
  ...
  static fromCson(
    ...
    return RoleAssignedEvent.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
  ...
  static __unpackProto__(
    ...
    return new RoleAssignedEvent({
      ...
      actor: _NodeReference.fromProto(
        objectProto.actorPtr!,
        _session,
        _supergraph,
        _graph,
        _connection,
...
export class RoleUnassignedEvent extends RoleEvent {
  ...
  static fromCson(
    ...
    return RoleUnassignedEvent.__unpackCson__(
      objectCson,
      _session,
      _supergraph,
      _graph,
...
export class Role extends Entity implements IsActor {
  ...
  static fromCson(
    ...
    return Role.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
