...
import { AgentProto, MaterializationProto } from "@destack/proto";
import { base64Decode } from "@destack/utils";
import { hashString } from "@destack/utils/hash";
import { Temporal } from "temporal-polyfill";

/* ==== DESTACK_GENERATED_START:NODE:60600 ==== */
/**
  ...
  implements IsSpatial, IsOwner, IsFollowable, IsDeletable, IsSubject
{
   ...
   */
  get predecessor(): Agent | null {
    const nodePtr: NodeReference | null = this.predecessorPtr;
    if (nodePtr !== null) {
      return this._supergraph.get(nodePtr.id) as Agent | null;
    }
    return null;
  }
  ...
  static __packValue__(object: Agent): { readonly [key: string]: any } {
    ...
    if (object._cursorPtr != null) {
      objectValue["110"] = object._cursorPtr.toValue();
    }
    return objectValue;
  }
  ...
  static __packProto__(object: Agent): AgentProto {
    const objectProto: Partial<AgentProto> = { metatype: 60600 };
...
/* ==== DESTACK_GENERATED_END:NODE:60600 ==== */
