...
export class SanctionRequestedEvent extends SanctionEvent {
  ...
  static fromCson(
    ...
    return SanctionRequestedEvent.__unpackCson__(
      objectCson,
      _session,
      _supergraph,
      _graph,
...
export class SanctionGrantedEvent extends SanctionEvent {
  ...
  static fromCson(
    ...
    return SanctionGrantedEvent.__unpackCson__(
      objectCson,
      _session,
      _supergraph,
      _graph,
...
export class SanctionRevokedEvent extends SanctionEvent {
  ...
  static fromCson(
    ...
    return SanctionRevokedEvent.__unpackCson__(
      objectCson,
      _session,
      _supergraph,
      _graph,
...
export class SanctionExpiredEvent extends SanctionEvent {
  ...
  static fromCson(
    ...
    return SanctionExpiredEvent.__unpackCson__(
      objectCson,
      _session,
      _supergraph,
      _graph,
 ...
 */
export class Sanction extends Entity implements IsExtensible {
  ...
  get parent(): (Entity & IsActor) | (Entity & IsJoinable) | null {
    ...
    if (nodePtr != null) {
      return this._supergraph.get(nodePtr.id) as (Entity & IsActor) | (Entity & IsJoinable) | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_isExtensible === null) {
      throw new Error(`Sanction.isExtensible is required`);
    }
  ...
  static fromCson(
    ...
    return Sanction.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
