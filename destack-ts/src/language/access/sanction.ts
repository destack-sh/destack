...
export abstract class SanctionEvent extends Event {
  ...
  declare readonly targetRef: NodeReference;
...
export class SanctionRequestedEvent extends SanctionEvent {
  ...
  get node(): Sanction | null {
    ...
    if (nodeRef != null) {
      return this._session.graph.get(nodeRef) as Sanction | null;
    }
    return null;
  }
  ...
  readonly targetRef: NodeReference;
  ...
  constructor(options: {
    ...
    this.targetRef = _target as NodeReference;
...
export class Sanction extends Entity {
  ...
  constructor(options: {
    ...
    this._targetRef = _target as NodeReference;
