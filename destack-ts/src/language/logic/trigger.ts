...
export class Trigger extends Entity {
  ...
  static __unpackCson__(
    ...
    const unpackedEvent =
      eventValue != undefined
        ? _NodeDefinitionReference.fromCson(eventValue, _session, _graph, _connection)
        : null;
  ...
  static fromCson(
    ...
    return Trigger.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Trigger.__unpackProto__(objectProto, _session, _graph, _connection);
  }
