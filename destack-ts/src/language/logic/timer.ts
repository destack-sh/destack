...
export class TimerStartedEvent extends TimerEvent {
  ...
  get node(): Timer | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Timer | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for TimerStartedEvent`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for TimerStartedEvent`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`TimerStartedEvent.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for TimerStartedEvent`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`TimerStartedEvent.snapshot is required`);
    }
  ...
  static fromCson(
    ...
    return TimerStartedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return TimerStartedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class TimerPausedEvent extends TimerEvent {
  ...
  static fromCson(
    ...
    return TimerPausedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return TimerPausedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class TimerResumedEvent extends TimerEvent {
  ...
  static fromCson(
    ...
    return TimerResumedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return TimerResumedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class Timer extends Entity {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      _space = ACTIVE_SPACE.get();
      if (_space === null) {
        throw new Error(`no active Space for Timer`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_snapshot === null) {
      _snapshot = ACTIVE_SNAPSHOT.get();
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Timer`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Timer.snapshot is required`);
    }
    this.snapshotPtr = _snapshot as NodeReference;
    let _precededBy = options.precededBy ?? null;
    if (_precededBy != null && _precededBy.constructor.name != "NodeReference") {
  ...
  static __unpackCson__(
    ...
    const unpackedSchedule =
      scheduleValue != undefined
        ? _Schedule.fromCson(scheduleValue, _session, _graph, _connection)
        : null;
  ...
  static fromCson(
    ...
    return Timer.__unpackCson__(objectCson, _session, _graph, _connection);
  }
    ...
    return new Timer({
      ...
      schedule:
        objectProto.schedule != undefined
          ? _Schedule.fromProto(objectProto.schedule!, _session, _graph, _graph, _connection)
          : null,
      parent:
  ...
  static fromProto(
    ...
    return Timer.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class TimerCompletedEvent extends TimerEvent {
  ...
  static fromCson(
    ...
    return TimerCompletedEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return TimerCompletedEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class TimerCancelledEvent extends TimerEvent {
  ...
  static fromCson(
    ...
    return TimerCancelledEvent.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return TimerCancelledEvent.__unpackProto__(objectProto, _session, _graph, _connection);
  }
