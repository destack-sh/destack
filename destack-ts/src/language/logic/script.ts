 ...
 * A Script.
 */
export class Script extends Entity implements IsOrdered {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Script`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Script`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Script.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Script`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Script.snapshot is required`);
    }
    ...
    if (options.id == null) {
      ...
      if (
        ...
        throw new Error(`Script.createdAt and Script.updatedAt are required for existing Nodes`);
      }
  ...
  repr(): string {
    ...
    return `<Script "${this.path}" ${propertyReprs.join(" ")}>`;
  }

  toCson(): { [key: string]: any } {
    return Script.__packCson__(this);
  }

  static __packCson__(object: Script): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Script.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Script.__unpackProto__(objectProto, _session, _graph, _connection);
  }
