...
import { Entity, Vector2i } from "@destack/language/core/common";
 ...
 */
export class Cursor extends Node implements IsSpatial, IsOwnable, Entity {
  ...
  constructor(options: {
    ...
    if (_status === null) {
      throw new Error(`Cursor.status is required`);
    }
    this.status = _status;
  ...
  repr(): string {
    ...
    return `<Cursor '${this.path}' ${propertyReprs.join(" ")}>`;
  }

  toValue(): { [key: string]: any } {
    return Cursor.__packValue__(this);
  }

  static __packValue__(object: Cursor): { [key: string]: any } {
  ...
  static fromValue(
    ...
    return Cursor.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }

  toProto(): CursorProto {
    return Cursor.__packProto__(this);
  }

  static __packProto__(object: Cursor): CursorProto {
    const objectProto: Partial<CursorProto> = { metatype: 3200 };
    ...
    return objectProto as CursorProto;
  }

  static __unpackProto__(
    objectProto: CursorProto,
    _session?: Session | null,
    _supergraph?: Supergraph | null,
    _graph?: any | null,
    _connection?: any | null,
  ...
  static fromProto(
    ...
    return Cursor.__unpackProto__(objectProto, _session, _supergraph, _graph, _connection);
  }

  static fromProtoString(packedProtoString: string): Cursor {
    const packedProtoBytes = base64Decode(packedProtoString);
    const packedProto = CursorProto.fromBinary(packedProtoBytes);
 ...
 */
export class EventCursor extends Node implements Cursor {
 ...
 */
export class ScreenCursor extends Node implements Cursor {
 ...
 */
export class ThreadCursor extends Node implements Cursor {
  ...
  static fromValue(
    ...
    return ThreadCursor.__unpackValue__(objectValue, _session, _supergraph, _graph, _connection);
  }

  toProto(): ThreadCursorProto {
    return ThreadCursor.__packProto__(this);
  }
