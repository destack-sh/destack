...
/* ==== DESTACK_GENERATED_START:NODE:108000 ==== */
/**
...
/* ==== DESTACK_GENERATED_END:NODE:108000 ==== */

/* ==== DESTACK_GENERATED_START:NODE:108100 ==== */
/**
...
export class EventCursor extends Cursor {
  ...
  static __packProto__(object: EventCursor): EventCursorProto {
    const objectProto: Partial<EventCursorProto> = { metatype: 108100 };
...
/* ==== DESTACK_GENERATED_END:NODE:108100 ==== */

/* ==== DESTACK_GENERATED_START:NODE:108200 ==== */
/**
...
export class ScreenCursor extends Cursor {
  ...
  static __packProto__(object: ScreenCursor): ScreenCursorProto {
    const objectProto: Partial<ScreenCursorProto> = { metatype: 108200 };
    objectProto.id = String(object.id);
    if (object.parentPtr != null) {
      objectProto.parentPtr = object.parentPtr.toProto();
    }
...
/* ==== DESTACK_GENERATED_END:NODE:108200 ==== */

/* ==== DESTACK_GENERATED_START:NODE:108300 ==== */
/**
 * A ThreadCursor is a cursor corresponding to a Thread.
 */
export class ThreadCursor extends Cursor {
   ...
   * The previous Entity this Entity is based on (from another Snapshot).
   */
  get predecessor(): ThreadCursor | null {
    const nodePtr: NodeReference | null = this.predecessorPtr;
    if (nodePtr !== null) {
      return this._supergraph.get(nodePtr.id) as ThreadCursor | null;
    }
    return null;
  }
  readonly predecessorPtr: NodeReference | null;
  ...
  constructor(options: {
    ...
    materialization?: Materialization;
    snapshot?: Snapshot | NodeReference | null;
    predecessor?: ThreadCursor | NodeReference | null;
  ...
  static __packProto__(object: ThreadCursor): ThreadCursorProto {
    const objectProto: Partial<ThreadCursorProto> = { metatype: 108300 };
    objectProto.id = String(object.id);
    if (object.parentPtr != null) {
      objectProto.parentPtr = object.parentPtr.toProto();
    }
...
/* ==== DESTACK_GENERATED_END:NODE:108300 ==== */
