...
export class Fill extends ImmutableStruct {
  ...
  get style(): FillStyle | null {
    ...
    if (nodeRef != null) {
      ...
      return this._session.graph.get(nodeRef) as FillStyle | null;
    }
    return null;
  }
   ...
   */
  get image(): File | null {
    const nodeRef: NodeReference | null = this.imageRef;
    if (nodeRef != null) {
      if (this._session === null) {
        return null;
      }
  ...
  readonly imageRef: NodeReference | null;
  ...
  constructor(options: {
    ...
    this.imageRef = _image as NodeReference | null;
  ...
  equals(other: any): boolean {
    ...
    if (!(this.imageRef?.id === other.imageRef?.id)) {
      return false;
    }
  ...
  hash(): number {
    ...
    if (this.imageRef != null) {
      h = (h * 31 + hashString(this.imageRef.id)) & 0xffffffff;
    }
    if (this.position != null) {
...
export class FillStyle extends Style {
  ...
  set image(node: File | null) {
    if (node === null) {
      ...
      this.imageRef = node.toRef();
    }
  }
  /**
   * FillStyle.image
   */
  get imageRef(): NodeReference | null {
    return this._imageRef;
  }
  set imageRef(value: NodeReference | null) {
    const prop = (this.constructor as NodeClass).__properties__["image"];
    this._session.updateSetProperty(this, prop, value);
    this._imageRef = value;
  }
  _imageRef: NodeReference | null;
  ...
  constructor(options: {
    ...
    this._imageRef = _image as NodeReference | null;
    let _position = options.position ?? null;
  ...
  equals(other: any): boolean {
    ...
    if (!(this._imageRef?.id === other._imageRef?.id)) {
      return false;
    }
  ...
  hash(): number {
    ...
    if (this._imageRef != null) {
      h = (h * 31 + hashString(this._imageRef.id)) & 0xffffffff;
    }
