...
export class Palette extends Entity {
  ...
  get precededBy(): Palette | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Palette | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return Palette.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Palette.__unpackProto__(objectProto, _session, _graph, _connection);
  }
