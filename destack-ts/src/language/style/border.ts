...
export class Border extends StructFrozen {
  ...
  toCson(): { [key: string]: any } {
    if (this._cson === null) {
      // @ts-expect-error(readonly)
      this._cson = Border.__packCson__(this);
    }
    return this._cson;
  }

  static __packCson__(object: Border): { [key: string]: any } {
    ...
    if (object.width != null) {
      objectCson["102"] = object.width.toCson();
    }
    if (object.stylePtr != null) {
      objectCson["103"] = object.stylePtr.toCson();
    }
    return objectCson;
  }
...
export class BorderStyle extends Style {
  ...
  constructor(options: {
    ...
    this._stylePtr = _style as NodeReference | null;
  ...
  toCson(): { [key: string]: any } {
    return BorderStyle.__packCson__(this);
  }

  static __packCson__(object: BorderStyle): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 2100600;
    ...
    if (object._width != null) {
      objectCson["201"] = object._width.toCson();
    }
    if (object._stylePtr != null) {
      objectCson["202"] = object._stylePtr.toCson();
    }
    return objectCson;
  }
