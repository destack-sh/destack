import { Session, Spatial, Entity, IsDeletable, Color, CustomViewDefinition, CustomView, Insets, Canvas, Style, Layer, User, NodeReference, BuiltinObject, ArrowShape, Agent, MaterializationType, PlaneShape, IsTracked, IsVisual, AnnotationShape, IsTaggable, Scene, Graph, SliderInputView, WizardView, FrameView, LabelView, LineShape, TextView, Struct, Theme, ThreadView, Supergraph, NumberInputView, QueryConnection, SplitView, NodeType, IsOrdered, Node, Space } from '@/language';
...
export class Border extends BuiltinObject {
  type: BorderType;
