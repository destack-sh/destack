...
export class Theme extends Entity {
   ...
   */
  get precededBy(): Theme | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Theme | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    precededBy?: Theme | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Theme`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
      throw new Error(`Theme.space is required`);
    }
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Theme`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Theme.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Theme`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Theme.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Theme.__packCson__(this);
  }

  static __packCson__(object: Theme): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Theme.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Theme.__unpackProto__(objectProto, _session, _graph, _connection);
  }
