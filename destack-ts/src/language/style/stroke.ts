...
/* ==== DESTACK_GENERATED_START:NODE:2701100 ==== */
/**
 * A StrokeStyle.
 */
export class StrokeStyle extends Style {
  ...
  static __packProto__(object: StrokeStyle): StrokeStyleProto {
    const objectProto: Partial<StrokeStyleProto> = { metatype: 2701100 };
...
/* ==== DESTACK_GENERATED_END:NODE:2701100 ==== */

/* ==== DESTACK_GENERATED_START:STRUCT:2701100 ==== */
/**
 * A Stroke.
 */
export class Stroke extends StructFrozen {
  ...
  static __packProto__(object: Stroke): StrokeProto {
    const objectProto: Partial<StrokeProto> = { metatype: 2701100 };
    objectProto.type = Number(object.type) as StrokeTypeProto;
    objectProto.size = object.size;
    objectProto.thinning = object.thinning;
    objectProto.smoothing = object.smoothing;
...
/* ==== DESTACK_GENERATED_END:STRUCT:2701100 ==== */

/* ==== DESTACK_GENERATED_START:STRUCT:2701101 ==== */
/**
 * A stroke cap.
 */
export class StrokeCap extends StructFrozen {
  ...
  static __packProto__(object: StrokeCap): StrokeCapProto {
    const objectProto: Partial<StrokeCapProto> = { metatype: 2701101 };
...
/* ==== DESTACK_GENERATED_END:STRUCT:2701101 ==== */

/* ==== DESTACK_GENERATED_START:STRUCT:2701103 ==== */
/**
...
export class StrokePoint extends StructFrozen {
  ...
  static __packProto__(object: StrokePoint): StrokePointProto {
    const objectProto: Partial<StrokePointProto> = { metatype: 2701103 };
...
/* ==== DESTACK_GENERATED_END:STRUCT:2701103 ==== */

/* ==== DESTACK_GENERATED_START:STRUCT:2701102 ==== */
/**
 * A stroke path.
 */
export class StrokePath extends StructFrozen {
  ...
  static __packProto__(object: StrokePath): StrokePathProto {
    const objectProto: Partial<StrokePathProto> = { metatype: 2701102 };
    if (object.points) {
      const packedPoints: any[] = [];
      for (const item of object.points) {
...
/* ==== DESTACK_GENERATED_END:STRUCT:2701102 ==== */
