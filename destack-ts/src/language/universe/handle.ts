...
export class Handle extends Entity {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Handle`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
      throw new Error(`Handle.space is required`);
    }
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Handle`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Handle.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Handle`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Handle.snapshot is required`);
    }
    ...
    if (_orderKey === null) {
      throw new Error(`Handle.orderKey is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Handle.__packCson__(this);
  }

  static __packCson__(object: Handle): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Handle.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Handle.__unpackProto__(objectProto, _session, _graph, _connection);
  }
