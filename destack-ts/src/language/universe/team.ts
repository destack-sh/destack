 ...
 */
export class Team extends Entity implements IsActor, IsJoinable {
   ...
   */
  get precededBy(): Team | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Team | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    precededBy?: Team | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Team`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Team`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Team.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Team`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Team.snapshot is required`);
    }
    ...
    if (_orderKey === null) {
      throw new Error(`Team.orderKey is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Team.__packCson__(this);
  }

  static __packCson__(object: Team): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Team.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Team.__unpackProto__(objectProto, _session, _graph, _connection);
  }
