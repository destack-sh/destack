...
import { MaterializationProto, Rectangle2DProto, RectangleShape2DProto } from "@destack/proto";
...
/* ==== DESTACK_GENERATED_START:NODE:2411300 ==== */
/**
...
export class RectangleShape2D extends Shape2D {
  ...
  static __packProto__(object: RectangleShape2D): RectangleShape2DProto {
    const objectProto: Partial<RectangleShape2DProto> = { metatype: 2411300 };
...
/* ==== DESTACK_GENERATED_END:NODE:2411300 ==== */
