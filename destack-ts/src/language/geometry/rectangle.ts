...
export class Rectangle2D extends StructFrozen {
  ...
  toCson(): { [key: string]: any } {
    if (this._cson === null) {
      // @ts-expect-error(readonly)
      this._cson = Rectangle2D.__packCson__(this);
    }
    return this._cson;
  }

  static __packCson__(object: Rectangle2D): { [key: string]: any } {
    ...
    if (object.width != null) {
      objectCson["210"] = object.width.toCson();
    }
    if (object.height != null) {
      objectCson["220"] = object.height.toCson();
    }
    return objectCson;
  }
  ...
  toProto(): Rectangle2DProto {
    if (this._proto === null) {
      // @ts-expect-error(readonly)
      this._proto = Rectangle2D.__packProto__(this);
    }
    return this._proto as Rectangle2DProto;
  }

  static __packProto__(object: Rectangle2D): Rectangle2DProto {
  ...
  static fromProtoString(packedProtoString: string): Rectangle2D {
    ...
    const packedProto = Rectangle2DProto.fromBinary(packedProtoBytes);
...
export class RectangleShape2D extends Shape2D {
  static metatype: NodeType = NodeType.RECTANGLE_SHAPE2D;
  ...
  /**
   * RectangleShape2D.width
   */
  /**
   * RectangleShape2D.width
   */
  get width(): Vector2 | null {
    return this._width;
  }
  set width(value: Vector2 | null) {
  ...
  /**
   * RectangleShape2D.height
   */
  /**
   * RectangleShape2D.height
   */
  get height(): Vector2 | null {
    return this._height;
  }
  set height(value: Vector2 | null) {
    const prop = (this.constructor as NodeClass).__properties__["height"];
    this._session.updateSetProperty(this, prop, value);
    this._height = value;
  }
  _height: Vector2 | null;
  ...
  constructor(options: {
    ...
    precededBy?: RectangleShape2D | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for RectangleShape2D`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
      throw new Error(`RectangleShape2D.space is required`);
    }
    ...
    if (_materialization === null) {
      throw new Error(`RectangleShape2D.materialization is required`);
    }
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for RectangleShape2D`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`RectangleShape2D.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for RectangleShape2D`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`RectangleShape2D.snapshot is required`);
    }
    ...
    if (_name === null) {
      _name = "RectangleShape2D";
    }
    if (_name === null) {
      throw new Error(`RectangleShape2D.name is required`);
    }
    this._name = _name;
    ...
    if (_isExtensible === null) {
      throw new Error(`RectangleShape2D.isExtensible is required`);
    }
    ...
    if (options.id == null) {
      ...
      if (
        ...
        throw new Error(
          `RectangleShape2D.createdAt and RectangleShape2D.updatedAt are required for existing Nodes`,
        );
      }
  ...
  __toRef__(): NodeReference {
    ...
    return new _NodeReference({
      type: NodeType.RECTANGLE_SHAPE2D,
      id: this.id,
  ...
  repr(): string {
    ...
    return `<RectangleShape2D "${this.path}" ${propertyReprs.join(" ")}>`;
  }

  toCson(): { [key: string]: any } {
    return RectangleShape2D.__packCson__(this);
  }

  static __packCson__(object: RectangleShape2D): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    ...
    if (object._width != null) {
      objectCson["210"] = object._width.toCson();
    }
    if (object._height != null) {
      objectCson["220"] = object._height.toCson();
    }
    return objectCson;
  }
  ...
  toProto(): RectangleShape2DProto {
    return RectangleShape2D.__packProto__(this);
  }

  static __packProto__(object: RectangleShape2D): RectangleShape2DProto {
  ...
  static fromProtoString(packedProtoString: string): RectangleShape2D {
    const packedProtoBytes = base64Decode(packedProtoString);
    const packedProto = RectangleShape2DProto.fromBinary(packedProtoBytes);
    return this.fromProto(packedProto);
  }
