...
export class Ellipse2D extends StructFrozen {
  ...
  static fromCson(
    ...
    return Ellipse2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Ellipse2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class EllipseShape2D extends Shape2D {
  ...
  get precededBy(): EllipseShape2D | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as EllipseShape2D | null;
    }
    return null;
  }
  ...
  static fromCson(
    ...
    return EllipseShape2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return EllipseShape2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
