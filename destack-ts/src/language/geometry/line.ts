...
import { AnchorProto, Line2DProto, LineShape2DProto, MaterializationProto } from "@destack/proto";
...
export class Line2D extends StructFrozen {
  ...
  static __unpackCson__(
    ...
    return new Line2D({
      ...
      start: _Vector2.fromCson(objectCson["210"], _session, _graph, _connection),
      end: _Vector2.fromCson(objectCson["220"], _session, _graph, _connection),
      _cson: objectCson,
      _graph,
    });
  }
  ...
  static fromCson(
    ...
    return Line2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Line2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class LineShape2D extends Shape2D {
  ...
  get precededBy(): LineShape2D | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as LineShape2D | null;
    }
    return null;
  }
  ...
  static __unpackCson__(
    ...
    return new LineShape2D({
      start: _Vector2.fromCson(objectCson["200"], _session, _graph, _connection),
      end: _Vector2.fromCson(objectCson["210"], _session, _graph, _connection),
      stroke: unpackedStroke,
  ...
  static fromCson(
    ...
    return LineShape2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return LineShape2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
