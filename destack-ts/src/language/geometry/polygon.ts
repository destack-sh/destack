...
/* ==== DESTACK_GENERATED_START:STRUCT:2411000 ==== */
/**
...
/* ==== DESTACK_GENERATED_END:STRUCT:2411000 ==== */

/* ==== DESTACK_GENERATED_START:NODE:2411000 ==== */
/**
...
export class PolygonShape2D extends Shape2D {
  ...
  get precededBy(): PolygonShape2D | null {
    ...
    if (nodePtr != null) {
      return this._session.graph.get(nodePtr) as PolygonShape2D | null;
    }
    return null;
  }
...
/* ==== DESTACK_GENERATED_END:NODE:2411000 ==== */
