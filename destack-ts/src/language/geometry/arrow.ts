...
export class Arrow2D extends StructFrozen {
  ...
  static __unpackCson__(
    ...
    return new Arrow2D({
      ...
      start: _Vector2.fromCson(objectCson["201"], _session, _graph, _connection),
      endType: Number(objectCson["210"]),
      end: _Vector2.fromCson(objectCson["211"], _session, _graph, _connection),
      _cson: objectCson,
      _graph,
    });
  }
  ...
  static fromCson(
    ...
    return Arrow2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static __unpackProto__(
    ...
    return new Arrow2D({
      ...
      start: _Vector2.fromProto(objectProto.start!, _session, _graph, _graph, _connection),
      endType: Number(objectProto.endType) as ArrowHeadType,
      end: _Vector2.fromProto(objectProto.end!, _session, _graph, _graph, _connection),
      _proto: objectProto,
      _graph,
    });
  }
  ...
  static fromProto(
    ...
    return Arrow2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
...
export class ArrowShape2D extends Shape2D {
  ...
  get precededBy(): ArrowShape2D | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as ArrowShape2D | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_orderKey === null) {
      throw new Error(`ArrowShape2D.orderKey is required`);
    }
  ...
  static fromCson(
    ...
    return ArrowShape2D.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return ArrowShape2D.__unpackProto__(objectProto, _session, _graph, _connection);
  }
