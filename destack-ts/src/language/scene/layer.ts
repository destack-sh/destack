 ...
 */
export class Layer extends Entity implements IsOwnable, IsOrdered, IsScriptable {
  ...
  static fromCson(
    ...
    return Layer.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
