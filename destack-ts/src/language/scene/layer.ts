 ...
 */
export class Layer extends Entity implements IsOwnable, IsOrdered {
  ...
  get precededBy(): Layer | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Layer | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Layer`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Layer`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Layer.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Layer`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Layer.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Layer.__packCson__(this);
  }

  static __packCson__(object: Layer): { [key: string]: any } {
  ...
  static fromCson(
    ...
    return Layer.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Layer.__unpackProto__(objectProto, _session, _graph, _connection);
  }
