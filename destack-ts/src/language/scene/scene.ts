...
export class Scene extends Entity implements IsOwnable, IsOrdered {
  ...
  static __unpackCson__(
    ...
    const unpackedRootViewPtr =
      rootViewPtrValue != undefined
        ? _NodeReference.fromCson(rootViewPtrValue, _session, _supergraph, _graph, _connection)
        : null;
  ...
  static fromCson(
    ...
    return Scene.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
