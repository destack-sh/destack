 ...
 */
export class Scene extends Entity implements IsOwnable, IsOrdered {
  ...
  get precededBy(): Scene | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as Scene | null;
    }
    return null;
  }
  ...
  get rootView(): LayoutView | null {
    ...
    if (nodePtr != null) {
      return this._graph.get(nodePtr.id) as LayoutView | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Scene`);
      }
  ...
  toCson(): { [key: string]: any } {
    return Scene.__packCson__(this);
  }

  static __packCson__(object: Scene): { [key: string]: any } {
    ...
    if (object._rootViewPtr != null) {
      objectCson["200"] = object._rootViewPtr.toCson();
    }
    return objectCson;
  }
  ...
  static __unpackCson__(
    ...
    const unpackedRootViewPtr =
      rootViewPtrValue != undefined
        ? _NodeReference.fromCson(rootViewPtrValue, _session, _graph, _connection)
        : null;
  ...
  static fromCson(
    ...
    return Scene.__unpackCson__(objectCson, _session, _graph, _connection);
  }
  ...
  static fromProto(
    ...
    return Scene.__unpackProto__(objectProto, _session, _graph, _connection);
  }
