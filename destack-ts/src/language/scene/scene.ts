  ...
  constructor(options: {
    ...
    if (options.id == null) {
      ...
      if (options.createdAt == null) {
        throw new Error(`SceneEnteredEvent.createdAt is required for existing Events`);
      }
...
export class SceneExitedEvent extends SceneEvent {
  ...
  constructor(options: {
    ...
    if (options.id == null) {
      ...
      if (options.createdAt == null) {
        throw new Error(`SceneExitedEvent.createdAt is required for existing Events`);
      }
      this.createdAt = options.createdAt;
      this.createdByPtr =
        options.createdBy != null
 ...
 */
export class Scene extends ContainerView implements IsOwnable {
  ...
  get rootViewPtr(): NodeReference | null {
    return this.#rootViewPtr;
  }
  set rootViewPtr(value: NodeReference | null) {
    const oldValue = this.#rootViewPtr;
    if (this._dirty == null) {
      this._dirty = {};
    }
  ...
  static __packValue__(object: Scene): { [key: string]: any } {
    ...
    if (object.#rootViewPtr != null) {
      objectValue["200"] = object.#rootViewPtr.toValue();
    }
    return objectValue;
  }
