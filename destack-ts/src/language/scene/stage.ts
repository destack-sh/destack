 ...
 */
export class Stage extends Entity implements IsOwnable, IsOrdered, IsJoinable {
  ...
  constructor(options: {
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Stage`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Stage`);
      }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Stage`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Stage.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Stage.__packCson__(this);
  }

  static __packCson__(object: Stage): { [key: string]: any } {
