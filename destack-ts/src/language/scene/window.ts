...
export class Window extends Entity implements IsOwnable, IsOrdered, IsScriptable {
   ...
   */
  get precededBy(): Window | null {
    const nodePtr: NodeReference | null = this.precededByPtr;
    if (nodePtr != null) {
      return this._supergraph.get(nodePtr.id) as Window | null;
    }
    return null;
  }
  ...
  constructor(options: {
    ...
    precededBy?: Window | NodeReference | null;
    ...
    if (_space === null) {
      ...
      if (_space === null) {
        throw new Error(`no active Space for Window`);
      }
      _space = _space.toRef();
    }
    if (_space === null) {
    ...
    if (_branch === null) {
      ...
      if (_branch === null) {
        throw new Error(`no active Branch for Window`);
      }
      _branch = _branch.toRef();
    }
    if (_branch === null) {
      throw new Error(`Window.branch is required`);
    }
    ...
    if (_snapshot === null) {
      ...
      if (_snapshot === null) {
        throw new Error(`no active Snapshot for Window`);
      }
      _snapshot = _snapshot.toRef();
    }
    if (_snapshot === null) {
      throw new Error(`Window.snapshot is required`);
    }
  ...
  toCson(): { [key: string]: any } {
    return Window.__packCson__(this);
  }

  static __packCson__(object: Window): { [key: string]: any } {
    const objectCson: { [key: string]: any } = {};
    objectCson["1"] = 1700100;
  ...
  static fromCson(
    ...
    return Window.__unpackCson__(objectCson, _session, _supergraph, _graph, _connection);
  }
