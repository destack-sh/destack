...
export interface RpcMetadata {
     ...
     * Client
     *
     * @generated from protobuf field: optional symbol.destack.ClientType client_type = 2;
     */
...
class RpcMetadata$Type extends MessageType<RpcMetadata> {
    constructor() {
        super("symbol.destack.RpcMetadata", [
            { no: 2, name: "client_type", kind: "enum", opt: true, T: () => ["symbol.destack.ClientType", ClientType, "CLIENT_TYPE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RpcMetadata): RpcMetadata {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional symbol.destack.ClientType client_type */ 2:
    ...
    internalBinaryWrite(message: RpcMetadata, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional symbol.destack.ClientType client_type = 2; */
