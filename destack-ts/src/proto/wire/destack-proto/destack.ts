...
class ResolveSpacesRequest$Type extends MessageType<ResolveSpacesRequest> {
    constructor() {
        super("symbol.destack.ResolveSpacesRequest", [
            { no: 1, name: "spaces", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ResolveSpacesRequest_SpaceKey }
        ]);
    }
...
class ResolveSpacesResponse$Type extends MessageType<ResolveSpacesResponse> {
    constructor() {
        super("symbol.destack.ResolveSpacesResponse", [
            { no: 1, name: "spaces", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ResolveSpacesResponse_SpaceInfo }
        ]);
    }
...
/**
 * @generated ServiceType for protobuf service symbol.destack.Destack
 */
export const Destack = new ServiceType("symbol.destack.Destack", [
