...
// @generated from protobuf file "destack-proto/google/type/timeofday.proto" (package "google.type", syntax proto3)
// tslint:disable
//
...
class TimeOfDay$Type extends MessageType<TimeOfDay> {
  ...
  create(value?: PartialMessage<TimeOfDay>): TimeOfDay {
    ...
    message.seconds = 0;
    message.nanos = 0;
    if (value !== undefined) reflectionMergePartial<TimeOfDay>(this, message, value);
    return message;
  }
  internalBinaryRead(
  ...
  internalBinaryWrite(
    ...
    /* int32 hours = 1; */
    if (message.hours !== 0) writer.tag(1, WireType.Varint).int32(message.hours);
    /* int32 minutes = 2; */
    if (message.minutes !== 0) writer.tag(2, WireType.Varint).int32(message.minutes);
    /* int32 seconds = 3; */
    if (message.seconds !== 0) writer.tag(3, WireType.Varint).int32(message.seconds);
    /* int32 nanos = 4; */
    if (message.nanos !== 0) writer.tag(4, WireType.Varint).int32(message.nanos);
