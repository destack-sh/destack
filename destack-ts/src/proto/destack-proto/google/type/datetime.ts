...
// @generated from protobuf file "destack-proto/google/type/datetime.proto" (package "google.type", syntax proto3)
// tslint:disable
//
...
import { MessageType, PbLong, reflectionMergePartial, UnknownFieldHandler, WireType } from "@protobuf-ts/runtime";
...
class DateTime$Type extends MessageType<DateTime> {
  ...
  toJsDate(message: DateTime): globalThis.Date {
    ...
    if (to) {
      if (to.oneofKind === "timeZone") throw new globalThis.Error("IANA time zone not supported");
  ...
  create(value?: PartialMessage<DateTime>): DateTime {
    ...
    if (value !== undefined) reflectionMergePartial<DateTime>(this, message, value);
    return message;
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.Duration utc_offset */ 8:
          message.timeOffset = {
            oneofKind: "utcOffset",
            utcOffset: Duration.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.timeOffset as any).utcOffset,
            ),
          };
          break;
        case /* google.type.TimeZone time_zone */ 9:
          message.timeOffset = {
            oneofKind: "timeZone",
            timeZone: TimeZone.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.timeOffset as any).timeZone,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(message: DateTime, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* int32 year = 1; */
    if (message.year !== 0) writer.tag(1, WireType.Varint).int32(message.year);
    /* int32 month = 2; */
    if (message.month !== 0) writer.tag(2, WireType.Varint).int32(message.month);
    /* int32 day = 3; */
    if (message.day !== 0) writer.tag(3, WireType.Varint).int32(message.day);
    /* int32 hours = 4; */
    if (message.hours !== 0) writer.tag(4, WireType.Varint).int32(message.hours);
    /* int32 minutes = 5; */
    if (message.minutes !== 0) writer.tag(5, WireType.Varint).int32(message.minutes);
    /* int32 seconds = 6; */
    if (message.seconds !== 0) writer.tag(6, WireType.Varint).int32(message.seconds);
    /* int32 nanos = 7; */
    if (message.nanos !== 0) writer.tag(7, WireType.Varint).int32(message.nanos);
    /* google.protobuf.Duration utc_offset = 8; */
    if (message.timeOffset.oneofKind === "utcOffset")
      Duration.internalBinaryWrite(
        message.timeOffset.utcOffset,
        writer.tag(8, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* google.type.TimeZone time_zone = 9; */
    if (message.timeOffset.oneofKind === "timeZone")
      TimeZone.internalBinaryWrite(
        message.timeOffset.timeZone,
...
class TimeZone$Type extends MessageType<TimeZone> {
  ...
  create(value?: PartialMessage<TimeZone>): TimeZone {
    ...
    message.id = "";
    message.version = "";
    if (value !== undefined) reflectionMergePartial<TimeZone>(this, message, value);
    return message;
  }
