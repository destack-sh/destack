...
class RpcMetadata$Type extends MessageType<RpcMetadata> {
    ...
    super("symbol.destack.RpcMetadata", [
      {
        ...
        kind: "enum",
        opt: true,
        T: () => ["symbol.destack.ClientTypeProto", ClientTypeProto],
      },
  ...
  create(value?: PartialMessage<RpcMetadata>): RpcMetadata {
    ...
    if (value !== undefined) reflectionMergePartial<RpcMetadata>(this, message, value);
    return message;
  }
  internalBinaryRead(
  ...
  internalBinaryWrite(message: RpcMetadata, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.clientType !== undefined) writer.tag(2, WireType.Varint).int32(message.clientType);
    /* optional string client_id = 3; */
    if (message.clientId !== undefined) writer.tag(3, WireType.LengthDelimited).string(message.clientId);
    /* optional string client_nonce = 4; */
    if (message.clientNonce !== undefined) writer.tag(4, WireType.LengthDelimited).string(message.clientNonce);
