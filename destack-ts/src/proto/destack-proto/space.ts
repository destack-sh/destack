...
class QueryResponse$Type extends MessageType<QueryResponse> {
  constructor() {
    super("symbol.destack.QueryResponse", [{ no: 1, name: "result", kind: "message", T: () => QueryResultProto }]);
  }
  ...
  internalBinaryWrite(message: QueryResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.result)
      QueryResultProto.internalBinaryWrite(
        message.result,
...
class CommitRequest$Type extends MessageType<CommitRequest> {
  ...
  internalBinaryWrite(message: CommitRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.changes.length; i++)
      ChangeProto.internalBinaryWrite(
        message.changes[i],
...
class CommitResponse$Type extends MessageType<CommitResponse> {
  ...
  internalBinaryWrite(message: CommitResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.results.length; i++)
      ChangeResultProto.internalBinaryWrite(
        message.results[i],
...
class SubscribeRequest$Type extends MessageType<SubscribeRequest> {
  constructor() {
    super("symbol.destack.SubscribeRequest", [{ no: 1, name: "query", kind: "message", T: () => QueryProto }]);
  }
...
class SubscribeResponse$Type extends MessageType<SubscribeResponse> {
  constructor() {
    super("symbol.destack.SubscribeResponse", [{ no: 1, name: "update", kind: "message", T: () => QueryUpdateProto }]);
  }
  create(value?: PartialMessage<SubscribeResponse>): SubscribeResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    if (value !== undefined) reflectionMergePartial<SubscribeResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: SubscribeResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.update)
      QueryUpdateProto.internalBinaryWrite(
        message.update,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class UploadFilesRequest$Type extends MessageType<UploadFilesRequest> {
  ...
  create(value?: PartialMessage<UploadFilesRequest>): UploadFilesRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.files = [];
    if (value !== undefined) reflectionMergePartial<UploadFilesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class UploadFilesResponse$Type extends MessageType<UploadFilesResponse> {
    ...
    super("symbol.destack.UploadFilesResponse", [
      {
        ...
        T: () => UploadFilesResponse_UploadHandle,
      },
    ]);
  }
  create(value?: PartialMessage<UploadFilesResponse>): UploadFilesResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.handles = [];
    if (value !== undefined) reflectionMergePartial<UploadFilesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(message: UploadFilesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.handles.length; i++)
      UploadFilesResponse_UploadHandle.internalBinaryWrite(
        message.handles[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class UploadFilesResponse_UploadHandle$Type extends MessageType<UploadFilesResponse_UploadHandle> {
  ...
  create(value?: PartialMessage<UploadFilesResponse_UploadHandle>): UploadFilesResponse_UploadHandle {
    ...
    message.postUrl = "";
    message.getUrl = "";
    if (value !== undefined) reflectionMergePartial<UploadFilesResponse_UploadHandle>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: UploadFilesResponse_UploadHandle,
  ...
  internalBinaryWrite(
    message: UploadFilesResponse_UploadHandle,
    ...
    /* string post_url = 2; */
    if (message.postUrl !== "") writer.tag(2, WireType.LengthDelimited).string(message.postUrl);
    /* google.protobuf.Struct fields = 3; */
    if (message.fields)
      Struct.internalBinaryWrite(message.fields, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    /* string get_url = 4; */
    if (message.getUrl !== "") writer.tag(4, WireType.LengthDelimited).string(message.getUrl);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class DownloadFilesRequest$Type extends MessageType<DownloadFilesRequest> {
  ...
  create(value?: PartialMessage<DownloadFilesRequest>): DownloadFilesRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.files = [];
    if (value !== undefined) reflectionMergePartial<DownloadFilesRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
...
class DownloadFilesResponse$Type extends MessageType<DownloadFilesResponse> {
    ...
    super("symbol.destack.DownloadFilesResponse", [
      {
        ...
        kind: "message",
        repeat: 2 /*RepeatType.UNPACKED*/,
        T: () => DownloadFilesResponse_DownloadHandle,
      },
    ]);
  }
  create(value?: PartialMessage<DownloadFilesResponse>): DownloadFilesResponse {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.handles = [];
    if (value !== undefined) reflectionMergePartial<DownloadFilesResponse>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated symbol.destack.DownloadFilesResponse.DownloadHandle handles */ 1:
          message.handles.push(
            DownloadFilesResponse_DownloadHandle.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.handles.length; i++)
      DownloadFilesResponse_DownloadHandle.internalBinaryWrite(
        message.handles[i],
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class DownloadFilesResponse_DownloadHandle$Type extends MessageType<DownloadFilesResponse_DownloadHandle> {
  ...
  create(value?: PartialMessage<DownloadFilesResponse_DownloadHandle>): DownloadFilesResponse_DownloadHandle {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.getUrl = "";
    if (value !== undefined) reflectionMergePartial<DownloadFilesResponse_DownloadHandle>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    length: number,
    options: BinaryReadOptions,
    target?: DownloadFilesResponse_DownloadHandle,
  ...
  internalBinaryWrite(
    message: DownloadFilesResponse_DownloadHandle,
    writer: IBinaryWriter,
    options: BinaryWriteOptions,
  ): IBinaryWriter {
    /* symbol.destack.FileProto file = 1; */
    if (message.file)
      FileProto.internalBinaryWrite(message.file, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* string get_url = 2; */
    if (message.getUrl !== "") writer.tag(2, WireType.LengthDelimited).string(message.getUrl);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
export const Space = new ServiceType(
  "symbol.destack.Space",
  [
