...
/** The repository or checkout export a space follows for its declared records. */
export const spaceSource = table(
    "space_source",
    {
        ...
        spaceId: identifier("space_id", "space")
            ...
            .notNull()
            .references(() => space.id),
        /** The repository ref or host-qualified checkout followed by this space. */
        selection: json("selection", StackSelection).notNull(),
