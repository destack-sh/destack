    ...
    (relation) => ({
        ...
        resourceMigration: {
            snapshot: relation.one.snapshot({
                from: [
                    relation.resourceMigration.resourceId,
                    relation.resourceMigration.snapshotId,
                ],
                to: [relation.snapshot.resourceId, relation.snapshot.id],
                optional: true,
            }),
            space: relation.one.space({
                from: [relation.resourceMigration.spaceId],
                to: [relation.space.id],
                optional: false,
            }),
            spaceMigration: relation.one.spaceMigration({
                from: [
                    relation.resourceMigration.spaceId,
                    relation.resourceMigration.spaceMigrationId,
                ],
        ...
        resource: {
            space: relation.one.space({
                from: [relation.resource.spaceId],
                to: [relation.space.id],
                optional: false,
            }),
        },
