...
CREATE TABLE "resource" (
	...
	CONSTRAINT "resource_provenance_account" CHECK ("provenance" IS NULL OR ("provenance"::jsonb ->> 'kind') <> 'account' OR ("provenance"::jsonb ->> 'accountId') = "account_id"),
...
CREATE TABLE "space_source" (
	...
	CONSTRAINT "space_source_reference" CHECK ("reference" LIKE 'refs/heads/_%' OR "reference" LIKE 'refs/tags/_%'),
