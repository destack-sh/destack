...
CREATE TABLE `resource` (
	...
	CONSTRAINT "resource_provenance_account" CHECK("provenance" IS NULL OR json_extract("provenance", '$.kind') <> 'account' OR json_extract("provenance", '$.accountId') = "account_id"),
