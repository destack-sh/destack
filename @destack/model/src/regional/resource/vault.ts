...
export const secretVersion = table(
    "secret_version",
    {
        /** The owning secret. */
        secretId: identifier("secret_id", "secret")
            .notNull()
            .references((): Column<Identifier<"secret">> => secret.id, {
                onDelete: "restrict",
            }),
...
export const secretBinding = table(
    "secret_binding",
    {
...
export const deploymentSecretBinding = table(
    "deployment_secret_binding",
    {
