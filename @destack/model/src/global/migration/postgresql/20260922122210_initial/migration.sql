...
CREATE UNIQUE INDEX "preference_account" ON "preference" ("account_id","package_id","name") WHERE "user_id" IS NULL AND "device_id" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "preference_user" ON "preference" ("account_id","user_id","package_id","name") WHERE "user_id" IS NOT NULL AND "device_id" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "preference_device" ON "preference" ("account_id","user_id","device_id","package_id","name") WHERE "device_id" IS NOT NULL;--> statement-breakpoint
