...
CREATE TABLE `space` (
	...
	CONSTRAINT `fk_space_account_id_authority_host_id_host_account_id_id_fk` FOREIGN KEY (`account_id`,`authority_host_id`) REFERENCES `host`(`account_id`,`id`) ON DELETE RESTRICT,
