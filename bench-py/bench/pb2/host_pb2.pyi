...
class QueryRequest(_message.Message):
    ...
    def __init__(self, scope: _Optional[_Union[_language_pb2.ScopeData, _Mapping]] = ..., query: _Optional[_Union[_language_pb2.QueryData, _Mapping]] = ...) -> None: ...
...
class CommitRequest(_message.Message):
    ...
    def __init__(self, scope: _Optional[_Union[_language_pb2.ScopeData, _Mapping]] = ..., changes: _Optional[_Iterable[_Union[_language_pb2.ChangeData, _Mapping]]] = ...) -> None: ...
...
class UploadFilesRequest(_message.Message):
    ...
    def __init__(self, scope: _Optional[_Union[_language_pb2.ScopeData, _Mapping]] = ..., files: _Optional[_Iterable[_Union[_language_pb2.FileData, _Mapping]]] = ...) -> None: ...
...
class UploadFilesResponse(_message.Message):
    ...
    class UploadHandle(_message.Message):
        ...
        get_url: str
        def __init__(self, file: _Optional[_Union[_language_pb2.FileData, _Mapping]] = ..., post_url: _Optional[str] = ..., fields: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., get_url: _Optional[str] = ...) -> None: ...
...
class DownloadFilesRequest(_message.Message):
    ...
    def __init__(self, scope: _Optional[_Union[_language_pb2.ScopeData, _Mapping]] = ..., files: _Optional[_Iterable[_Union[_language_pb2.NodeReferenceData, _Mapping]]] = ...) -> None: ...
...
class DownloadFilesResponse(_message.Message):
    ...
    class DownloadHandle(_message.Message):
        ...
        file: _language_pb2.FileData
        get_url: str
        def __init__(self, file: _Optional[_Union[_language_pb2.FileData, _Mapping]] = ..., get_url: _Optional[str] = ...) -> None: ...
    HANDLES_FIELD_NUMBER: _ClassVar[int]
