CREATE TABLE `space_migration` (
	...
	CONSTRAINT `fk_space_migration_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `resource_migration` (
	...
	CONSTRAINT `fk_resource_migration_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `resource` (
	...
	`deletion_requested_at` integer,
	`finalizers` text DEFAULT '[]' NOT NULL,
	CONSTRAINT `fk_resource_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `repository_reference` (
	...
	`deleted_at` integer,
	CONSTRAINT `repository_reference_pk` PRIMARY KEY(`repository_id`, `name`),
	CONSTRAINT `fk_repository_reference_repository_id_repository_id_fk` FOREIGN KEY (`repository_id`) REFERENCES `repository`(`id`) ON DELETE CASCADE,
	CONSTRAINT "repository_reference_name" CHECK("name" LIKE 'refs/%'),
	CONSTRAINT "repository_reference_object" CHECK(length("object") IN (40, 64) AND "object" NOT GLOB '*[^0-9a-f]*'),
	CONSTRAINT "repository_reference_commit" CHECK("commit" IS NULL OR (length("commit") IN (40, 64) AND "commit" NOT GLOB '*[^0-9a-f]*')),
...
CREATE TABLE `package_policy` (
	...
	CONSTRAINT `fk_package_policy_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `role` (
	...
	CONSTRAINT `fk_role_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `role_binding` (
	...
	CONSTRAINT `fk_role_binding_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`),
...
CREATE TABLE `service_account` (
	...
	`revoked_at` integer,
	CONSTRAINT `fk_service_account_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`),
...
CREATE TABLE `space_host` (
	...
	CONSTRAINT `fk_space_host_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `network_policy` (
	...
	`generation` integer DEFAULT 1 NOT NULL,
	`current_revision_id` text,
	CONSTRAINT `fk_network_policy_account_id_space_id_space_account_id_id_fk` FOREIGN KEY (`account_id`,`space_id`) REFERENCES `space`(`account_id`,`id`) ON DELETE RESTRICT,
...
CREATE TABLE `space_configuration` (
	...
	CONSTRAINT `fk_space_configuration_space_id_applied_revision_id_stack_revision_space_id_id_fk` FOREIGN KEY (`space_id`,`applied_revision_id`) REFERENCES `stack_revision`(`space_id`,`id`) ON DELETE RESTRICT,
	CONSTRAINT `fk_space_configuration_space_id_space_id_fk` FOREIGN KEY (`space_id`) REFERENCES `space`(`id`),
	...
	CONSTRAINT "space_configuration_space_id_not_null" CHECK("space_id" IS NOT NULL)
);
--> statement-breakpoint
CREATE TABLE `stack_revision` (
	...
	`digest` text NOT NULL,
	`created_at` integer NOT NULL,
	CONSTRAINT `fk_stack_revision_space_id_space_id_fk` FOREIGN KEY (`space_id`) REFERENCES `space`(`id`),
	...
	CONSTRAINT "stack_revision_digest" CHECK(length("digest") = 64 AND "digest" NOT GLOB '*[^a-f0-9]*'),
	CONSTRAINT "stack_revision_id_not_null" CHECK("id" IS NOT NULL)
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX `secret_source` ON `secret` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "secret"."source" IS NOT NULL AND "secret"."source_detached_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX `resource_source` ON `resource` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "resource"."source" IS NOT NULL AND "resource"."source_detached_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX `installation_source` ON `installation` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "installation"."source" IS NOT NULL AND "installation"."source_detached_at" IS NULL;--> statement-breakpoint
CREATE INDEX `installation_release` ON `installation` (`package_id`,`version`);--> statement-breakpoint
CREATE UNIQUE INDEX `package_policy_source` ON `package_policy` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "package_policy"."source" IS NOT NULL AND "package_policy"."source_detached_at" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX `role_binding_active` ON `role_binding` (`role_id`,`space_id`,coalesce("account_membership_id", "group_id", "service_account_id", "account_service_account_id")) WHERE "role_binding"."revoked_at" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX `schedule_source` ON `schedule` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "schedule"."source" IS NOT NULL AND "schedule"."source_detached_at" IS NULL;--> statement-breakpoint
CREATE INDEX `schedule_installation` ON `schedule` (`installation_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `network_policy_source` ON `network_policy` (json_extract("source", '$.kind'),coalesce(json_extract("source", '$.spaceId'), json_extract("source", '$.installationId')),json_extract("source", '$.name')) WHERE "network_policy"."source" IS NOT NULL AND "network_policy"."source_detached_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX `instance_host_state` ON `instance` (`host_id`,`state`);