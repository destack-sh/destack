...
export const AuditActor = defineSchema(schema.union([
    schema.object({
...
export const AuditTarget = defineSchema(schema.object({
...
export const auditEvent = table("audit_event", {
    ...
    delegation: json("delegation", schema.array(AuditActor)).notNull().default(sql`'[]'`),
