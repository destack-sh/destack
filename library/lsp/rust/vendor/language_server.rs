...
pub trait LanguageServer: Send + Sync + 'static {
	fn initialize(&self, _params: lsp_types::InitializeParams) -> jsonrpc::Result<lsp_types::InitializeResult> {
	...
	fn semantic_tokens_full(&self, _params: lsp_types::SemanticTokensParams) -> jsonrpc::Result<Option<lsp_types::SemanticTokensResult>> {
		Ok(None)
	}

	fn semantic_tokens_range(&self, _params: lsp_types::SemanticTokensRangeParams) -> jsonrpc::Result<Option<lsp_types::SemanticTokensRangeResult>> {
		Ok(None)
	}
