...
export declare class LanguageService {
  ...
  /** Apply watch events. */
  applyWatchEvents(events: Array<WorkspaceWatchEvent>): LanguageServiceResult
  /** Rescan all roots. */
  rescanAll(reason: LanguageServiceRescanReason): LanguageServiceResult
  /** Rescan selected roots. */
  rescanRoots(roots: Array<string>, analyze: boolean): LanguageServiceResult
...
export declare function defaultLanguageServiceOptions(): LanguageServiceOptions
...
export declare const enum LanguageServiceMessageKind {
...
export declare const enum LanguageServiceRescanReason {
...
export interface WorkspaceMessage {
  /** Message severity. */
  kind: LanguageServiceMessageKind
  /** Stable message code. */
  code: string
