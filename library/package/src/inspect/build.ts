...
export const BuildImport = defineSchema(schema.object({
...
export const BuildInput = defineSchema(schema.object({
    /** The module's origin. */
...
export const BuildOutput = defineSchema(schema.object({
...
export const BuildDescription = defineSchema(schema.object({
