...
export const NetworkDestination = defineSchema(schema.union([
    schema.object({
    ...
    schema.object({
        ...
        hostname: schema.string().max(253).regex(
...
export const NetworkRule = defineSchema(schema.object({
 ...
 */
export const NetworkPolicyDefinition = defineSchema(schema.object({
