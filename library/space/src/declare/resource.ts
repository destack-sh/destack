...
export const SpaceResource = defineSchema(schema.object({
...
export const SpaceSecret = defineSchema(schema.object({
...
export const SpaceResourceBinding = defineSchema(schema.union([
    schema.object({
...
export const SpaceSecretBinding = defineSchema(schema.object({
    /** The selected secret. */
    target: schema.union([
        schema.object({
