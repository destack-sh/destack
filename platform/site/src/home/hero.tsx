    ...
    return (
        <div class="grid min-w-0 grid-cols-[minmax(0,1fr)] gap-4 px-4 py-2 lg:grid-cols-[minmax(0,1fr)_29rem] lg:items-center">
            <section class="min-w-0">
                {/* title */}
                <h1 class="max-w-4xl text-[2.65rem] leading-none font-extrabold md:text-3xl">
                ...
                <p class="mt-4 max-w-3xl text-sm leading-6 font-bold text-neutral-700">
                    ...
                    correct, optimal, integrated software with a{" "}
                    <Underline>unified, native TypeScript++ toolchain</Underline>, VM, AOT
                    compiler, and deep code analysis
                </p>
