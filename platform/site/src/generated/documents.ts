...
export const documents = [
    {
        description: "Learn how the Destack language, toolchain, runtime, and libraries fit together.",
        markdownRoute: "/docs/index.md",
        order: 0,
        path: "index.md",
        route: "/docs/",
        tableOfContents: [{"depth":2,"id":"start-here","text":"Start Here"},{"depth":2,"id":"install-destack","text":"Install Destack"}],
