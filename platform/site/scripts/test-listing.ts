...
const source = 'import { BindingKind } from "destack:debug";';
const highlighted = highlightCode(source, "ds");
const rendered = renderMarkdown(`\`\`\`ds\n${source}\n\`\`\``, { assets: [] });
assert.equal(rendered.trim(), renderListing(highlighted, { label: "ds" }));
...
const listing = renderListing('<span class="hl-keyword">export</span>\n\nvalue', {
    title: 'src/a<&".ds', href: 'https://example.com/?a=1&b="2"', detail: "L1–3",
});
assert.equal(listing, [
    "<figure class=\"markdown-code\" data-publication-listing>",
    "<figcaption data-publication-caption><span data-publication-caption-title><a href=\"https://example.com/?a=1&amp;b=&quot;2&quot;\" rel=\"external noopener noreferrer\" target=\"_blank\">src/a&lt;&amp;&quot;.ds</a></span><span data-publication-caption-detail>L1–3</span></figcaption>",
    "<pre data-publication-body tabindex=\"0\" aria-label=\"src/a&lt;&amp;&quot;.ds\"><code class=\"markdown-code-lines\" data-publication-lines>",
