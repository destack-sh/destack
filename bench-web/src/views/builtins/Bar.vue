  ...
  >
    ...
    <Popover :placement="floatingPlacement" :reference-margin="4" :container-margin="4">
      <template #trigger="{ toggle, isOpen }">
        <button
          class="flex h-[30px] w-full select-none flex-row items-center rounded px-2.5 py-1 text-gray-700 hover:text-primary-700"
          @click="toggle"
        >
        ...
        <Menu v-outside.mousedown.stop="close" :items="BENCH_MENU_ITEMS">
          ...
          <template v-if="bench" #header>
            <div class="flex flex-row px-2.5 pb-2 pt-1.5">
              <div class="mr-2 w-10 rounded border border-gray-200 bg-gray-100 py-0.5 text-center text-lg">
    ...
    >
      <button
        ...
        class="rounded px-2.5 py-1 text-gray-700 hover:text-primary-700"
    ...
    >
      ...
      <template v-if="user">
        ...
        <Popover :placement="floatingPlacement" :reference-margin="4" :container-margin="4">
          <template #trigger="{ toggle, isOpen }">
            <button class="px-2 py-1 text-base text-gray-700 hover:text-primary-700" @click="toggle">
      ...
      <template v-else>
        <!-- Not logged in -->
        <button
          class="px-2 py-1 text-base text-gray-700 hover:text-primary-700"
