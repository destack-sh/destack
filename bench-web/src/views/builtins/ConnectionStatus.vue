              ...
              <div class="flex flex-row py-1">
                ...
                <span class="ml-auto flex flex-row pl-4 align-top">
                  ...
                  <template v-if="isDeveloperMode">
                    ...
                    <button class="rounded-sm px-1 hover:bg-primary-200" @click="connection.togglePaused()">
                      <i
                        :class="
                    ...
                    <!-- Send (toggle) -->
                    <button class="rounded-sm px-1 hover:bg-primary-200" @click="connection.txBuffer.togglePaused()">
                      <i
                        class="fas fa-up"
