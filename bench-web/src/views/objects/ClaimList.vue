...
import { isNodeActive, isRunnableNode } from "@/language/core/const";
  ...
  <div ref="containerRef" class="relative">
    <ul class="flex flex-col rounded">
      ...
      <li
        ...
        :key="claim.id"
        class="flex h-[30px] flex-row items-center px-1.5 transition-colors duration-75 hover:bg-gray-100"
        :data-node-id="claim.id"
        :data-node-ck="claim.ck"
        :data-node-type="claim.metatype"
        :data-node-bench-id="(claim as any).benchPtr?.id"
