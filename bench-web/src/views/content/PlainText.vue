...
<template>
  ...
  <div v-else>
    ...
    <div
      class="group mt-0.5 flex flex-row items-center rounded-md border border-gray-300 px-2 py-0.5  shadow-sm shadow-gray-300 focus-within:border-primary-400 focus-within:ring-1 focus-within:ring-primary-400"
