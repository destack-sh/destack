...
<template>
  <ViewContentWrapper :type="ViewType.TOGGLE" v-bind="props">
    <button
      ...
      class="relative inline-flex h-[20px] w-12 flex-shrink-0 cursor-pointer rounded-sm border border-gray-200 transition-colors duration-75 ease-in-out focus:outline-none"
    ...
    <input
      v-else
      type="checkbox"
      class="h-4 w-4 rounded-sm border-gray-200 focus:ring-0"
      :checked="modelValue"
