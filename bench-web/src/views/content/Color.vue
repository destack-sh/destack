...
<template>
  <ViewContentWrapper :type="ViewType.COLOR" v-bind="props">
    ...
    <!-- Inline Multi-Toggle -->
    <div v-else class="grid grid-cols-9 gap-x-0.5 gap-y-0.5 rounded-sm border-gray-200 bg-white px-1 py-1">
      <button
        ...
        :disabled="isDisabled || !isInput"
        class="rounded-sm border border-transparent px-1 py-0.5 outline-none hover:border-gray-200 hover:bg-gray-100 focus:ring-0 data-[active=true]:border-gray-200 data-[active=true]:bg-gray-100"
