...
<template>
  <ViewContentWrapper :type="ViewType.COLOR" v-bind="props">
    ...
    <button
      ...
      class="group flex w-full flex-row items-center rounded-sm border border-gray-300 px-2 py-1 hover:border-gray-300 data-[popover=true]:border-gray-300"
    >
      <!-- Current Value -->
    ...
    <!-- Inline Multi-Toggle -->
    <div v-else class="grid grid-cols-9 gap-x-0.5 gap-y-0.5 rounded-sm border-gray-300 bg-white px-1 py-1">
      <button
        ...
        :disabled="isDisabled || !isInput"
        class="rounded-sm border border-transparent px-1 py-0.5 outline-none hover:border-gray-300 hover:bg-gray-100 focus:ring-0 data-[active=true]:border-gray-300 data-[active=true]:bg-gray-100"
