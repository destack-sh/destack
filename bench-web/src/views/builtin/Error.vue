...
import { ErrorKind, ErrorType, type ErrorData, type RunData } from "@/proto/wire";
...
<template>
  <div class="rounded border border-red-500 bg-red-100 px-2 py-1.5">
    ...
    <div class="flex flex-row">
      <!-- Title -->
      <span class="max-w-60 truncate text-sm font-medium">{{ error.title ?? "Error" }}</span>
      <!-- Details -->
      <div class="ml-auto flex-shrink-0 pl-4 text-sm text-gray-700">
    ...
    >
      <Text id="text" is-small :model-value="error.text" is-minimal />
    </div>
