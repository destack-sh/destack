...
// specific :Builtins
export const BENCH_BENCH_AGENT_ID = "d6112a8b-2a41-5f7b-b693-dc48aeced05f";
export const BENCH_BENCH_AGENT_PTR = nodeReference(NodeType.AGENT, BENCH_BENCH_AGENT_ID, {
  ck: BENCH_BENCH_AGENT_ID,
  benchId: BENCH_ID,
});
export const BENCH_BENCH_UBUNTU_DESKTOP_ID = "66533e7a-782e-516c-8846-282843480f31";
export const BENCH_BENCH_UBUNTU_DESKTOP_PTR = nodeReference(NodeType.COMPUTER, BENCH_BENCH_UBUNTU_DESKTOP_ID, {
  ck: BENCH_BENCH_UBUNTU_DESKTOP_ID,
  benchId: BENCH_ID,
});
