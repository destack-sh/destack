      ...
      {parsed.value.chords.map((chord) => {
        ...
        return (
          ...
          <span class="flex flex-row gap-x-0.5">
            {keys.map((key) => (
              // Key
              <kbd class="min-w-5 rounded-sm border border-gray-200 bg-white px-1 py-0.5 text-center font-sans text-xs hover:border-orange-900 hover:bg-gray-100 hover:text-orange-900">
