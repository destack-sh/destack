...
// @generated from protobuf file "proto/common.proto" (package "symbol.bench", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message symbol.bench.RpcMetadata
 */
export interface RpcMetadata {
    /**
     * Client
     *
     * @generated from protobuf field: optional symbol.bench.ClientType client_type = 2;
     */
    ...
    /**
     * @generated from protobuf field: repeated symbol.bench.RpcMetadata.BadgeInfo badges = 6;
     */
 ...
 * Badges
 *
 * @generated from protobuf message symbol.bench.RpcMetadata.BadgeInfo
 */
...
/**
 * @generated from protobuf enum symbol.bench.ServiceKind
 */
...
class RpcMetadata$Type extends MessageType<RpcMetadata> {
    constructor() {
        super("symbol.bench.RpcMetadata", [
            { no: 2, name: "client_type", kind: "enum", opt: true, T: () => ["symbol.bench.ClientType", ClientType, "CLIENT_TYPE_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RpcMetadata): RpcMetadata {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* optional symbol.bench.ClientType client_type */ 2:
                ...
                case /* optional string client_access_token */ 5:
                    ...
                    break;
                case /* repeated symbol.bench.RpcMetadata.BadgeInfo badges */ 6:
    ...
    internalBinaryWrite(message: RpcMetadata, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional symbol.bench.ClientType client_type = 2; */
        ...
        /* repeated symbol.bench.RpcMetadata.BadgeInfo badges = 6; */
...
/**
 * @generated MessageType for protobuf message symbol.bench.RpcMetadata.BadgeInfo
 */
