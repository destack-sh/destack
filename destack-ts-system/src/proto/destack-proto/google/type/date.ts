...
// @generated from protobuf file "destack-proto/google/type/date.proto" (package "google.type", syntax proto3)
// tslint:disable
//
...
class Date$Type extends MessageType<Date> {
  ...
  create(value?: PartialMessage<Date>): Date {
    ...
    message.month = 0;
    message.day = 0;
    if (value !== undefined) reflectionMergePartial<Date>(this, message, value);
    return message;
  }
  internalBinaryRead(
