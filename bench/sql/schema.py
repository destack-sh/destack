...
PAGE_TABLE = Table(
    ...
    (
        ...
        Column("definition_ck", PrimitiveType.UUID, is_nullable=True),
        Column("definition_bench_id", PrimitiveType.UUID, is_nullable=True),
...
TASK_TABLE = Table(
    ...
    (
        ...
        Column("owned_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("owned_by_base_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("node_id", PrimitiveType.UUID),
        Column("node_ck", PrimitiveType.UUID),
        Column("node_type", PrimitiveType.INT16),
        Column("node_bench_id", PrimitiveType.UUID),
