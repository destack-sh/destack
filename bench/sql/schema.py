...
SCALER_TABLE = Table(
    ...
    (
        ...
        Column("region", PrimitiveType.INT16),
        Column("status", PrimitiveType.INT16),
        Column("requested_activate_at", PrimitiveType.DATETIME, is_nullable=True),
        Column("requested_deactivate_at", PrimitiveType.DATETIME, is_nullable=True),
        Column("requested_reset_at", PrimitiveType.DATETIME, is_nullable=True),
        Column("requested_suspend_at", PrimitiveType.DATETIME, is_nullable=True),
        Column("requested_decommission_at", PrimitiveType.DATETIME, is_nullable=True),
...
FLOW_TABLE = Table(
    ...
    (
        ...
        Column("model_name", PrimitiveType.STRING, is_nullable=True),
...
MESSAGE_TABLE = Table(
    ...
    (
        ...
        Column("resource_status", PrimitiveType.INT16, is_nullable=True),
        Column("model_developer", PrimitiveType.INT16, is_nullable=True),
        Column("model_provider", PrimitiveType.INT16, is_nullable=True),
        Column("model_id", PrimitiveType.STRING, is_nullable=True),
        Column("model_name", PrimitiveType.STRING, is_nullable=True),
...
TASK_TABLE = Table(
    ...
    (
        ...
        Column("assigned_to_id", PrimitiveType.UUID, is_nullable=True),
        Column("assigned_to_ck", PrimitiveType.UUID, is_nullable=True),
        Column("assigned_to_type", PrimitiveType.INT16, is_nullable=True),
        Column("assigned_to_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("nodes_id", PrimitiveType.UUID, is_array=True, is_nullable=True),
        Column("nodes_ck", PrimitiveType.UUID, is_array=True, is_nullable=True),
        Column("nodes_type", PrimitiveType.INT16, is_array=True, is_nullable=True),
        Column("nodes_bench_id", PrimitiveType.UUID, is_array=True, is_nullable=True),
