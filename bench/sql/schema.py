...
BENCH_TABLE = Table(
    ...
    (
        ...
        Column("created_by_run_id", PrimitiveType.UUID, is_nullable=True),
        Column(
            "updated_by_user_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_user",
        ...
        Column("updated_by_run_id", PrimitiveType.UUID, is_nullable=True),
...
DEPENDENCY_TABLE = Table(
    ...
    (
        ...
        Column("updated_by_run_id", PrimitiveType.UUID, is_nullable=True),
        Column("set_properties", PrimitiveType.INT32, is_array=True),
        Column("scopes_ck", PrimitiveType.UUID),
        Column(
            "scopes_bench_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_bench",
        ...
        Column("dependency_scopes_ck", PrimitiveType.UUID),
        Column(
            "dependency_scopes_bench_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_bench",
            on_delete=CascadeAction.SET_NULL,
        ),
...
BLOCK_TABLE = Table(
    ...
    (
        ...
        Column("policies", PrimitiveType.JSON, is_array=True, is_nullable=True),
        Column("bases_ck", PrimitiveType.UUID, is_nullable=True),
        Column(
            "bases_bench_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_bench",
...
INVITE_TABLE = Table(
    ...
    (
        ...
        Column("is_owner", PrimitiveType.BOOLEAN, default="false"),
        Column("roles_ck", PrimitiveType.UUID, is_nullable=True),
        Column(
            "roles_bench_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_bench",
...
SIGNAL_TABLE = Table(
    ...
    (
        ...
        Column("sender_ck", PrimitiveType.UUID, is_nullable=True),
        Column("sender_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("value_packed", PrimitiveType.JSON, is_nullable=True),
        Column("secret_value_packed", PrimitiveType.JSON, is_nullable=True, is_encrypted=True),
    ),
    indexes=(
