...
BENCH_TABLE = Table(
    ...
    (
        ...
        Column("owner_ck", PrimitiveType.UUID, is_nullable=True),
...
DEPENDENCY_TABLE = Table(
    ...
    (
        ...
        Column("dependency_ck", PrimitiveType.UUID),
        Column(
            "dependency_bench_id",
            PrimitiveType.UUID,
            is_foreign_key_to="bench_bench",
...
MEMBERSHIP_TABLE = Table(
    ...
    (
        ...
        Column("updated_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("set_properties", PrimitiveType.INT32, is_array=True),
        Column("user_ck", PrimitiveType.UUID),
...
INVITE_TABLE = Table(
    ...
    (
        ...
        Column("updated_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("set_properties", PrimitiveType.INT32, is_array=True),
        Column("user_ck", PrimitiveType.UUID, is_nullable=True),
...
SESSION_TABLE = Table(
    ...
    (
        ...
        Column("updated_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("set_properties", PrimitiveType.INT32, is_array=True),
        Column("server_ck", PrimitiveType.UUID, is_nullable=True),
...
HANDLE_TABLE = Table(
    ...
    (
        ...
        Column("bench_ck", PrimitiveType.UUID, is_nullable=True),
        Column("revision", PrimitiveType.INT64, default="0"),
        Column("created_at", PrimitiveType.DATETIME),
        Column("updated_at", PrimitiveType.DATETIME),
        Column("deleted_at", PrimitiveType.DATETIME, is_nullable=True),
