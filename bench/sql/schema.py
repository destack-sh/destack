...
BENCH_TABLE = Table(
    ...
    (
        ...
        Column("main_server_id", PrimitiveType.UUID, is_nullable=True),
        Column("main_drive_id", PrimitiveType.UUID, is_nullable=True),
        Column("main_vault_id", PrimitiveType.UUID, is_nullable=True),
        Column("main_cache_id", PrimitiveType.UUID, is_nullable=True),
