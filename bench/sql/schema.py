...
MESSAGE_TABLE = Table(
    ...
    (
        ...
        Column("class__id", PrimitiveType.UUID, is_nullable=True),
        Column("class__ck", PrimitiveType.UUID, is_nullable=True),
        Column("class__bench_id", PrimitiveType.UUID, is_nullable=True),
