...
TRIGGER_TABLE = Table(
    ...
    (
        ...
        Column("run_root_base_bench_id", PrimitiveType.UUID, is_nullable=True),
...
THREAD_TABLE = Table(
    ...
    (
        ...
        Column("channel_ck", PrimitiveType.UUID),
        Column("scope_id", PrimitiveType.UUID, is_nullable=True),
        Column("scope_ck", PrimitiveType.UUID, is_nullable=True),
        Column("scope_type", PrimitiveType.INT16, is_nullable=True),
        Column("scope_bench_id", PrimitiveType.UUID, is_nullable=True),
...
MESSAGE_TABLE = Table(
    ...
    (
        ...
        Column("selection", PrimitiveType.JSON, is_nullable=True),
        Column("created_interruption_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_interruption_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_interruption_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("created_interruption_base_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_run_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_run_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_run_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("created_run_base_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("created_thread_id", PrimitiveType.UUID, is_nullable=True),
    ),
    indexes=(
        Index("bench_idx_created_at", IndexType.BTREE, ("created_at",)),
        Index("bench_idx_parent_id", IndexType.BTREE, ("parent_id",), cover=("id",)),
...
MEMBERSHIP_TABLE = Table(
    ...
    (
        ...
        Column("to_ck", PrimitiveType.UUID),
...
INTERRUPTION_TABLE = Table(
    ...
    (
        ...
        Column("page_ck", PrimitiveType.UUID, is_nullable=True),
        ...
        Column("complete_trigger_id", PrimitiveType.UUID, is_nullable=True),
        Column("complete_trigger_ck", PrimitiveType.UUID, is_nullable=True),
...
PLAN_TABLE = Table(
    ...
    (
        ...
        Column("subnode_packed", PrimitiveType.JSON, is_nullable=True),
        Column("type", PrimitiveType.INT16),
        Column("execution", PrimitiveType.INT16),
        Column("on_terminate", PrimitiveType.INT16),
        Column("on_error", PrimitiveType.INT16),
        Column("status", PrimitiveType.INT16, default="1"),
        Column("started_by_id", PrimitiveType.UUID, is_nullable=True),
        Column("started_by_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("started_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("started_by_base_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("terminated_by_id", PrimitiveType.UUID, is_nullable=True),
        Column("terminated_by_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("terminated_by_base_ck", PrimitiveType.UUID, is_nullable=True),
        Column("terminated_by_base_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("title", PrimitiveType.STRING, is_nullable=True),
        Column("text", PrimitiveType.JSON, is_nullable=True),
