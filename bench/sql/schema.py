...
RUN_PLAN_TABLE = Table(
    ...
    (
        ...
        Column("runs_id", PrimitiveType.UUID, is_array=True),
        Column("runs_bench_id", PrimitiveType.UUID, is_array=True),
        Column("runs_base_ck", PrimitiveType.UUID, is_array=True, is_nullable=True),
        Column("runs_base_bench_id", PrimitiveType.UUID, is_array=True, is_nullable=True),
