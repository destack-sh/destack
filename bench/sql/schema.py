...
BENCH_TABLE = Table(
    ...
    (
        ...
        Column("owner_user_id", PrimitiveType.UUID, is_nullable=True),
        Column(
...
DEPENDENCY_TABLE = Table(
    ...
    (
        ...
        Column("dependency_package_id", PrimitiveType.UUID),
...
USER_TABLE = Table(
    ...
    (
        ...
        Column("icon", PrimitiveType.JSON, is_nullable=True),
        Column("main_bench_id", PrimitiveType.UUID, is_nullable=True),
        Column("status", PrimitiveType.INT16),
