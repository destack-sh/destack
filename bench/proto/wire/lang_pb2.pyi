...
class PathTokenType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PATH_TOKEN_TYPE_PACKAGE: _ClassVar[PathTokenType]
...
PATH_TOKEN_TYPE_PACKAGE: PathTokenType
...
class BrowserData(_message.Message):
    __slots__ = ("metatype", "id", "parent_ptr", "bench_ptr", "created_at", "created_by_ptr", "created_epoch", "updated_at", "updated_by_ptr", "updated_epoch", "deleted_at", "subnode_packed", "type", "title", "status", "text", "region", "occupancy", "owned_by_ptr", "activated_at", "deactivated_at", "reset_at", "suspended_at", "decommissioned_at", "active_at", "version", "target_version", "external_name", "external_id", "connection_uri", "debugger_uri", "view_uri", "client_ptr", "size", "is_headless", "is_insecure", "mode")
    METATYPE_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    PARENT_PTR_FIELD_NUMBER: _ClassVar[int]
    BENCH_PTR_FIELD_NUMBER: _ClassVar[int]
...
class SomeNodeData(_message.Message):
    __slots__ = ("bench", "user", "handle", "client", "organization", "membership", "invite", "server", "store", "drive", "vault", "cache", "machine", "browser", "file", "stream", "secret", "package", "dependency", "space", "block", "trigger", "field", "query", "view", "step", "pipe", "message", "record", "session", "run", "interrupt", "log", "skip")
