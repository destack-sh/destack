...
class ContextData(_message.Message):
    ...
    def __init__(self, metatype: _Optional[_Union[ObjectType, str]] = ..., runs_ptr: _Optional[_Iterable[_Union[NodeReferenceData, _Mapping]]] = ...) -> None: ...
...
class ContinuationData(_message.Message):
    ...
    def __init__(self, metatype: _Optional[_Union[ObjectType, str]] = ..., node_ptr: _Optional[_Union[NodeReferenceData, _Mapping]] = ...) -> None: ...
