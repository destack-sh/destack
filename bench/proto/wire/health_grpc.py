...
class HealthBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def check(self, request: 'health_pb2.HealthCheckRequest') -> 'health_pb2.HealthCheckResponse':
        pass

    @abc.abstractmethod
    async def watch(self, request: 'health_pb2.HealthCheckRequest') -> AsyncIterator['health_pb2.HealthCheckResponse']:
        pass
