...
class GraphIOBase(abc.ABC):
    ...
    async def GetNodes(
        self,
        stream: "grpclib.server.Stream[system_pb2.GetNodesRequest, system_pb2.GetNodesResponse]",
    ) -> None:
        pass
    ...
    async def WatchGet(
        self,
        stream: "grpclib.server.Stream[system_pb2.WatchGetRequest, system_pb2.WatchGetResponse]",
    ) -> None:
        pass
    ...
    async def SearchNodes(
        self,
        stream: "grpclib.server.Stream[system_pb2.SearchNodesRequest, system_pb2.SearchNodesResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def WatchSearch(
        self,
        stream: "grpclib.server.Stream[system_pb2.WatchSearchRequest, system_pb2.WatchSearchResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def AggregateNodes(
        self,
        stream: "grpclib.server.Stream[system_pb2.AggregateNodesRequest, system_pb2.AggregateNodesResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def WatchAggregate(
        self,
        stream: "grpclib.server.Stream[system_pb2.WatchAggregateRequest, system_pb2.WatchAggregateResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def CommitTransaction(
        self,
        stream: "grpclib.server.Stream[system_pb2.CommitTransactionRequest, system_pb2.CommitTransactionResponse]",
    ) -> None:
        pass
...
class SupervisorBase(abc.ABC):
    ...
    async def SignupUser(
        self,
        stream: "grpclib.server.Stream[system_pb2.SignupUserRequest, system_pb2.SignupUserResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def ChangeUserPassword(
        self,
        stream: "grpclib.server.Stream[system_pb2.ChangeUserPasswordRequest, system_pb2.ChangeUserPasswordResponse]",
    ) -> None:
        pass
    ...
    async def LoginUser(
        self,
        stream: "grpclib.server.Stream[system_pb2.LoginUserRequest, system_pb2.LoginUserResponse]",
    ) -> None:
        pass
    ...
    async def LogoutUser(
        self,
        stream: "grpclib.server.Stream[system_pb2.LogoutUserRequest, system_pb2.LogoutUserResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def CreateBench(
        self,
        stream: "grpclib.server.Stream[system_pb2.CreateBenchRequest, system_pb2.CreateBenchResponse]",
    ) -> None:
        pass

    @abc.abstractmethod
    async def ResolveHosts(
        self,
        stream: "grpclib.server.Stream[system_pb2.ResolveHostsRequest, system_pb2.ResolveHostsResponse]",
    ) -> None:
        pass
...
class HostBase(abc.ABC):
    ...
    async def UploadFiles(
        self,
        stream: "grpclib.server.Stream[system_pb2.UploadFilesRequest, system_pb2.UploadFilesResponse]",
    ) -> None:
        pass
    ...
    async def DownloadFiles(
        self,
        stream: "grpclib.server.Stream[system_pb2.DownloadFilesRequest, system_pb2.DownloadFilesResponse]",
    ) -> None:
        pass
