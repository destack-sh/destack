...
class GraphIOBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def get_nodes(self, request: 'system_pb2.GetNodesRequest') -> 'system_pb2.GetNodesResponse':
        pass

    @abc.abstractmethod
    async def watch_get(self, request: 'system_pb2.WatchGetRequest') -> AsyncIterator['system_pb2.WatchGetResponse']:
        pass

    @abc.abstractmethod
    async def search_nodes(self, request: 'system_pb2.SearchNodesRequest') -> 'system_pb2.SearchNodesResponse':
        pass

    @abc.abstractmethod
    async def watch_search(self, request: 'system_pb2.WatchSearchRequest') -> AsyncIterator['system_pb2.WatchSearchResponse']:
        pass

    @abc.abstractmethod
    async def aggregate_nodes(self, request: 'system_pb2.AggregateNodesRequest') -> 'system_pb2.AggregateNodesResponse':
        pass

    @abc.abstractmethod
    async def watch_aggregate(self, request: 'system_pb2.WatchAggregateRequest') -> AsyncIterator['system_pb2.WatchAggregateResponse']:
        pass

    @abc.abstractmethod
    async def commit_transaction(self, request: 'system_pb2.CommitTransactionRequest') -> 'system_pb2.CommitTransactionResponse':
        pass
...
class SupervisorBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def signup_user(self, request: 'system_pb2.SignupUserRequest') -> 'system_pb2.SignupUserResponse':
        pass

    @abc.abstractmethod
    async def change_user_password(self, request: 'system_pb2.ChangeUserPasswordRequest') -> 'system_pb2.ChangeUserPasswordResponse':
        pass

    @abc.abstractmethod
    async def login_user(self, request: 'system_pb2.LoginUserRequest') -> 'system_pb2.LoginUserResponse':
        pass

    @abc.abstractmethod
    async def logout_user(self, request: 'system_pb2.LogoutUserRequest') -> 'system_pb2.LogoutUserResponse':
        pass

    @abc.abstractmethod
    async def create_bench(self, request: 'system_pb2.CreateBenchRequest') -> 'system_pb2.CreateBenchResponse':
        pass

    @abc.abstractmethod
    async def resolve_hosts(self, request: 'system_pb2.ResolveHostsRequest') -> 'system_pb2.ResolveHostsResponse':
        pass
...
class HostBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def upload_files(self, request: 'system_pb2.UploadFilesRequest') -> 'system_pb2.UploadFilesResponse':
        pass

    @abc.abstractmethod
    async def download_files(self, request: 'system_pb2.DownloadFilesRequest') -> 'system_pb2.DownloadFilesResponse':
        pass
