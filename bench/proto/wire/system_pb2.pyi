...
class GetNodesRequest(_message.Message):
    ...
    scope: _lang_pb2.GraphScopeData | None
...
class SearchNodesRequest(_message.Message):
    __slots__ = ("scope", "node_type", "bases", "filter", "sort", "first", "skip", "count", "options", "no_cache")
    SCOPE_FIELD_NUMBER: _ClassVar[int]
    ...
    NO_CACHE_FIELD_NUMBER: _ClassVar[int]
    scope: _lang_pb2.GraphScopeData | None
    node_type: _lang_pb2.NodeType | None
...
class AggregateNodesRequest(_message.Message):
    ...
    filter: _lang_pb2.ExpressionData | None
    sort: _containers.RepeatedCompositeFieldContainer[_lang_pb2.ExpressionData]
    aggregation: _lang_pb2.ExpressionData | None
    no_cache: bool | None
...
class AggregateNodesResponse(_message.Message):
    ...
    scope: _lang_pb2.GraphScopeData | None
    connection_token: str | None
    aggregation: _lang_pb2.AggregationData | None
    epoch: int | None
...
class CommitTransactionResponse(_message.Message):
    __slots__ = ("revisions", "cascaded_edits", "epoch")
    ...
    cascaded_edits: _containers.RepeatedCompositeFieldContainer[_lang_pb2.EditData]
    epoch: int | None
    def __init__(self, revisions: _Optional[_Iterable[int]] = ..., cascaded_edits: _Optional[_Iterable[_Union[_lang_pb2.EditData, _Mapping]]] = ..., epoch: _Optional[int] = ...) -> None: ...
...
class ClientDataIn(_message.Message):
    ...
    id: str | None
    type: _lang_pb2.ClientType | None
    name: str | None
...
class SignupUserResponse(_message.Message):
    ...
    CLIENT_FIELD_NUMBER: _ClassVar[int]
    ACCESS_TOKEN_FIELD_NUMBER: _ClassVar[int]
    user: _lang_pb2.UserData | None
    client: _lang_pb2.ClientData | None
    access_token: str | None
...
class CreateOrganizationRequest(_message.Message):
    ...
    organization: _lang_pb2.OrganizationData | None
...
class CreateBenchRequest(_message.Message):
    ...
    owner: _lang_pb2.NodeReferenceData | None
    slug: str | None
    region: _lang_pb2.Region | None
    is_main: bool | None
...
class CreateBenchResponse(_message.Message):
    ...
    bench: _lang_pb2.BenchData | None
...
class ResolveHostsResponse(_message.Message):
    ...
    class HostInfo(_message.Message):
        ...
        domain: str | None
        grpc_port: int | None
        grpc_web_port: int | None
        ssl: bool | None
        bench: _lang_pb2.NodeReferenceData | None
...
class UploadFilesResponse(_message.Message):
    ...
    class UploadHandle(_message.Message):
        ...
        file: _lang_pb2.FileData | None
        post_url: str | None
        fields: _struct_pb2.Struct | None
        get_url: str | None
