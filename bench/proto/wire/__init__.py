...
AnyStructData = Union[SessionContextData, EditContextData, EditData, EditInfoData, EditOperationData, ChangeData, ChangeVignetteData, GraphScopeData, ClientOriginData, NodeReferenceData, PropertyReferenceData, PathData, PathTokenData, PolicyData, PolicyRuleData, SubjectData, AccessZoneData, AccessMatrixData, AccessData, TextData, TextLineData, TextSpanData, TypeInfoData, TypeConstraintData, ScheduleData, FileInfoData, FileReferenceData, IconData, SecretReferenceData, ExpressionData, AggregationResultData, SelectionData, SelectOptionsData, ValueData, ComputedValueData, CodeData, CodeLineData, RunErrorData, RunOptionsData, RunAttemptData, RunTraceData, RunFrameData, RunSpanData, RunEventData, ContextData, ContinuationData, BreakpointData, LogInfoData, ColorData, FontData, BoxData, OffsetData, TransformData, Vector2Data, Vector3Data, Vector4Data, LineData]
