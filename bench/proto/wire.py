...
class SomeNodeData(betterproto.Message):
    ...
    session: "SessionData" = betterproto.message_field(5, group="node")
    record: "RecordData" = betterproto.message_field(6, group="node")
    ...
    user: "UserData" = betterproto.message_field(16, group="node")
    ...
    trigger: "TriggerData" = betterproto.message_field(24, group="node")
    issue: "IssueData" = betterproto.message_field(25, group="node")
