...
class SomeNodeData(betterproto.Message):
    ...
    organization: "OrganizationData" = betterproto.message_field(10, group="node")
    bucket_object: "BucketObjectData" = betterproto.message_field(11, group="node")
    ...
    bench: "BenchData" = betterproto.message_field(21, group="node")
