...
class AggregationData(betterproto.Message):
    ...
    scalar: Optional[float] = betterproto.double_field(32, optional=True)
...
class TypeInfoData(betterproto.Message):
    ...
    length: Optional[int] = betterproto.int64_field(46, optional=True)
    precision: Optional[int] = betterproto.int64_field(47, optional=True)
    scale: Optional[int] = betterproto.int64_field(48, optional=True)
...
class FieldData(betterproto.Message):
    """
    Field(primitive_type: Optional[bench.language.const.PrimitiveType] = None,
    ...
    Optional[ForwardRef('Expression')] = None, length: Optional[int] = None,
    precision: Optional[int] = None, scale: Optional[int] = None, is_array:
    bool = False, is_required: bool = False, is_secret: bool = False, _fields:
    tuple['Field', ...] | None = None, _resolved_type:
    Optional[ForwardRef('TypeInfo')] = None, base_type_ptr: 'NodeReference' =
    None, _status: bench.language.const.NodeStatus = None, parent:
    Optional[ForwardRef('Block')] = None, name: str | None = None, order_key:
    str | None = None, dynamic_key: str | None = None, text: str | None = None,
    value_packed: typing.Any | None = None, is_output: bool = False, is_option:
    bool = False, _reflected_from: Optional[bench.language.node.Property] =
    None, parent_ptr: 'NodeReference' = None, id: uuid.UUID = None, ck:
    ...
    is_required: bool = betterproto.bool_field(51)
    is_secret: bool = betterproto.bool_field(52)
    is_output: bool = betterproto.bool_field(60)
    is_option: bool = betterproto.bool_field(61)
...
class SomeNodeData(betterproto.Message):
    ...
    package: "PackageData" = betterproto.message_field(6, group="node")
    worker: "WorkerData" = betterproto.message_field(7, group="node")
    run: "RunData" = betterproto.message_field(8, group="node")
    ...
    record: "RecordData" = betterproto.message_field(22, group="node")
