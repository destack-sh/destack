...
class SomeNodeData(betterproto.Message):
    ...
    trigger: "TriggerData" = betterproto.message_field(2, group="node")
    view: "ViewData" = betterproto.message_field(3, group="node")
    module: "ModuleData" = betterproto.message_field(4, group="node")
    link: "LinkData" = betterproto.message_field(5, group="node")
    issue: "IssueData" = betterproto.message_field(6, group="node")
    file: "FileData" = betterproto.message_field(7, group="node")
    ...
    record: "RecordData" = betterproto.message_field(16, group="node")
    bench: "BenchData" = betterproto.message_field(17, group="node")
    worker: "WorkerData" = betterproto.message_field(18, group="node")
    statement: "StatementData" = betterproto.message_field(19, group="node")
    notification: "NotificationData" = betterproto.message_field(20, group="node")
    client: "ClientData" = betterproto.message_field(21, group="node")
