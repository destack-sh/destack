...
class ContextData(betterproto.Message):
    ...
    order_key: Optional[str] = betterproto.string_field(5, optional=True)
    set_properties: List[int] = betterproto.int32_field(22)
    bench_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        30, optional=True
    )
    environment_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        31, optional=True
    )
    branch_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        32, optional=True
    )
    package_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        33, optional=True
    )
    module_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        34, optional=True
    )
    page_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        35, optional=True
    )
...
class ExpressionData(betterproto.Message):
    ...
    field_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        31, optional=True
    )
    property_ptr: Optional["PropertyReferenceData"] = betterproto.message_field(
        32, optional=True
    )
...
class FileData(betterproto.Message):
    ...
    content_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        36, optional=True
    )
...
class PathSegmentData(betterproto.Message):
    ...
    reference_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        33, optional=True
    )
...
class PolicyRuleData(betterproto.Message):
    ...
    object_properties_is_system: Optional[bool] = betterproto.bool_field(
        82, optional=True
    )
    object_properties_is_sensitive: Optional[bool] = betterproto.bool_field(
        83, optional=True
    )
    object_properties_is_kernel: Optional[bool] = betterproto.bool_field(
        84, optional=True
    )
...
class ReadOptionsData(betterproto.Message):
    ...
    related_properties_ptr: List["PropertyReferenceData"] = betterproto.message_field(
        33
    )
    include_properties_ptr: List["PropertyReferenceData"] = betterproto.message_field(
        40
    )
    exclude_properties_ptr: List["PropertyReferenceData"] = betterproto.message_field(
        41
    )
...
class RunCodeFrameData(betterproto.Message):
    ...
    ] = betterproto.message_field(33, optional=True)
...
class SelectionData(betterproto.Message):
    ...
    from_node_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        32, optional=True
    )
    to_node_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        33, optional=True
    )
...
class SubjectData(betterproto.Message):
    ...
    client_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        40, optional=True
    )
    user_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        41, optional=True
    )
    identity_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        42, optional=True
    )
...
class TypeInfoData(betterproto.Message):
    ...
    order_key: Optional[str] = betterproto.string_field(5, optional=True)
    set_properties: List[int] = betterproto.int32_field(22)
    primitive_type: Optional["PrimitiveType"] = betterproto.enum_field(
        40, optional=True
    )
    bench_type: Optional["BenchType"] = betterproto.enum_field(41, optional=True)
    base_type_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        42, optional=True
    )
    ...
    default_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(49, optional=True)
...
class BadgeData(betterproto.Message):
    ...
    parent_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        4, optional=True
    )
    ...
    created_by_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        17, optional=True
    )
    updated_by_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        18, optional=True
    )
    set_properties: List[int] = betterproto.int32_field(22)
...
class BenchData(betterproto.Message):
    ...
    set_properties: List[int] = betterproto.int32_field(22)
    main_handle_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        31, optional=True
    )
    ...
    owner_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        36, optional=True
    )
    ...
    main_branch_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        42, optional=True
    )
...
class BlockData(betterproto.Message):
    ...
    builtin_base: Optional["TypeInfoData"] = betterproto.message_field(
        37, optional=True
    )
...
class BranchData(betterproto.Message):
    ...
    main_package_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        40, optional=True
    )
...
class ClientData(betterproto.Message):
    ...
    main_space_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        60, optional=True
    )
...
class EnvironmentData(betterproto.Message):
    ...
    analytics_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        43, optional=True
    )
    drive_ptr: "NodeReferenceData" = betterproto.message_field(44)
    cache_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        45, optional=True
    )
...
class LogData(betterproto.Message):
    ...
    value_dynamic: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(36, optional=True)
    request: Optional["RequestData"] = betterproto.message_field(37, optional=True)
    session_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        40, optional=True
    )
    run_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        41, optional=True
    )
    block_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        42, optional=True
    )
...
class NotificationData(betterproto.Message):
    ...
    type_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        32, optional=True
    )
    expires_at: Optional[datetime] = betterproto.message_field(33, optional=True)
    read_at: Optional[datetime] = betterproto.message_field(34, optional=True)
    sender_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        35, optional=True
    )
...
class OrganizationData(betterproto.Message):
    ...
    text: Optional["TextData"] = betterproto.message_field(34, optional=True)
    icon: Optional["IconData"] = betterproto.message_field(35, optional=True)
    main_bench_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        36, optional=True
    )
...
class QueryData(betterproto.Message):
    ...
    base_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        33, optional=True
    )
...
class RecordData(betterproto.Message):
    ...
    value_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(30, optional=True)
    secret_value_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
...
class RunData(betterproto.Message):
    ...
    root_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        31, optional=True
    )
    server_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        32, optional=True
    )
    block_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        33, optional=True
    ...
    inputs_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(50, optional=True)
    inputs_secret_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(51, optional=True)
    outputs_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(52, optional=True)
    outputs_secret_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(53, optional=True)
    value_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(54, optional=True)
    value_secret_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(55, optional=True)
    error: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(56, optional=True)
...
class ServerData(betterproto.Message):
    ...
    current_profile: Optional["ServerProfile"] = betterproto.enum_field(
        51, optional=True
    )
...
class SignalData(betterproto.Message):
    ...
    value_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(34, optional=True)
    secret_value_packed: Optional[
        "betterproto_lib_google_protobuf.Struct"
    ] = betterproto.message_field(35, optional=True)
...
class TriggerData(betterproto.Message):
    ...
    signal_ptr: Optional["NodeReferenceData"] = betterproto.message_field(
        34, optional=True
    )
...
class EditData(betterproto.Message):
    ...
    subject: Optional["NodeReferenceData"] = betterproto.message_field(
        40, optional=True
    )
...
class GraphIoBase(ServiceBase):
    async def get_nodes(
        self, subject: "Subject", request: "GetNodesRequest"
    ) -> "GetNodesResponse":
...
AnyStructData = Union[PathData, PathSegmentData, PathTokenData, NodeReferenceData, PropertyReferenceData, ValueReferenceData, TypeInfoData, ContextData, ScheduleData, ProjectionData, FileData, IconData, PolicyData, PolicyRuleData, SubjectData, AccessZoneData, AccessMatrixData, AccessData, AccessTraceData, RequestData, ReadOptionsData, ExpressionData, AggregationData, AggregationBucketData, SelectionData, CodeData, CodeLineData, RunCodeFrameData, RunErrorData, ResourceCredentialData, TextData, TextLineData, TextSpanData, ColorData, FontData, BoxData, OffsetData]
