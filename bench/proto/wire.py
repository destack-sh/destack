...
class DriveData(betterproto.Message):
    ...
    handle: Optional[str] = betterproto.string_field(33, optional=True)
...
class EnvironmentData(betterproto.Message):
    ...
    index_ptr: "NodeReferenceData" = betterproto.message_field(41)
    drive_ptr: "NodeReferenceData" = betterproto.message_field(42)
    cache_ptr: "NodeReferenceData" = betterproto.message_field(43)
...
class ServerData(betterproto.Message):
    ...
    last_active_at: Optional[datetime] = betterproto.message_field(50, optional=True)
    last_bumped_at: Optional[datetime] = betterproto.message_field(51, optional=True)
    external_id: Optional[str] = betterproto.string_field(52, optional=True)
    access_token: Optional[str] = betterproto.string_field(53, optional=True)
...
class StoreData(betterproto.Message):
    """
    A store for database-like storage in a Bench. Virtualized on an actual
    physical database of the requested kind (may be a sub-schema or such).
    """
    ...
    text: Optional["RichTextData"] = betterproto.message_field(32, optional=True)
    handle: Optional[str] = betterproto.string_field(33, optional=True)
    username: Optional[str] = betterproto.string_field(34, optional=True)
    password: Optional[str] = betterproto.string_field(35, optional=True)
...
@dataclass(eq=False, repr=False)
class RollbackPreparedTransactionRequest(betterproto.Message):
    bench_id: Optional[str] = betterproto.string_field(1, optional=True)
    """scope"""
...
@dataclass(eq=False, repr=False)
class RollbackPreparedTransactionResponse(betterproto.Message):
    pass
...
class SupervisorStub(betterproto.ServiceStub):
    ...
    async def rollback_prepared_transaction(
        self,
        request: "RollbackPreparedTransactionRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/symbolx.bench.Supervisor/RollbackPreparedTransaction",
            request,
            RollbackPreparedTransactionResponse,
            timeout=timeout,
            deadline=deadline,
...
class BenchHostStub(betterproto.ServiceStub):
    ...
    async def rollback_prepared_transaction(
        ...
        *,
        ...
        return await self._unary_unary(
            "/symbolx.bench.BenchHost/RollbackPreparedTransaction",
            request,
            RollbackPreparedTransactionResponse,
            timeout=timeout,
            deadline=deadline,
...
class SupervisorBase(ServiceBase):
    ...
    async def __rpc_rollback_prepared_transaction(
        self,
        stream: "grpclib.server.Stream[RollbackPreparedTransactionRequest, RollbackPreparedTransactionResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.rollback_prepared_transaction(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/symbolx.bench.Supervisor/RollbackPreparedTransaction": grpclib.const.Handler(
                self.__rpc_rollback_prepared_transaction,
                grpclib.const.Cardinality.UNARY_UNARY,
...
class BenchHostBase(ServiceBase):
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/symbolx.bench.BenchHost/RollbackPreparedTransaction": grpclib.const.Handler(
                self.__rpc_rollback_prepared_transaction,
                grpclib.const.Cardinality.UNARY_UNARY,
                RollbackPreparedTransactionRequest,
                RollbackPreparedTransactionResponse,
