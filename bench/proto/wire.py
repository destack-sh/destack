...
class BenchPathData(betterproto.Message):
    ...
    fields/properties. Absolute or relative.     Path are case-insensitive,
    support alphanum + spaces and use '/' as a primary separator.     Sub-nodes
    inside a block are prefixed by a ':', fields are accessed (and separated)
    by '.'.      flotothemoon/Mirror/Notion/Databases/Landscape     ^ bench
    ...
    ^ field      flotothemoon.name     ^ bench      ^ field     flotothemoon-
    tests/Tests/Databases/TestPopulate.code     ^ bench            ^ blocks
    ^ field      ../../Header Screen:Header/Title.theme.primary.color     ^
    blocks           ^ sub-nodes  ^ field     ../../../../Graphs     ^
    ...
    ../../Something/../SomethingElse     X (invalid, cannot go up and down in
    the same path)      The general syntax is:     [bench-name][@branch-
...
class RichTextSpanData(betterproto.Message):
    ...
    reference_ptr: bench.proto.wire.NodeReferenceData = None, _status:
    bench.language.const.NodeStatus = None)
    """
...
class FieldData(betterproto.Message):
    ...
    bench.proto.wire.NodeReferenceData = None, reference_ptr:
    bench.proto.wire.NodeReferenceData = None, _status:
    ...
    reference_ptr: Optional["NodeReferenceData"] = betterproto.message_field(38, optional=True)
...
class TriggerData(betterproto.Message):
    ...
    interval: Optional[int] = betterproto.int64_field(35, optional=True)
...
class SomeNodeData(betterproto.Message):
    ...
    client: "ClientData" = betterproto.message_field(3, group="node")
    ...
    session: "SessionData" = betterproto.message_field(8, group="node")
    badge: "BadgeData" = betterproto.message_field(9, group="node")
    issue: "IssueData" = betterproto.message_field(10, group="node")
    notification: "NotificationData" = betterproto.message_field(11, group="node")
    worker_set: "WorkerSetData" = betterproto.message_field(12, group="node")
    handle: "HandleData" = betterproto.message_field(13, group="node")
    pause: "PauseData" = betterproto.message_field(14, group="node")
    trigger: "TriggerData" = betterproto.message_field(15, group="node")
    ...
    bucket_object: "BucketObjectData" = betterproto.message_field(19, group="node")
    user: "UserData" = betterproto.message_field(20, group="node")
    worker: "WorkerData" = betterproto.message_field(21, group="node")
    tagging: "TaggingData" = betterproto.message_field(22, group="node")
