...
class IconData(betterproto.Message):
    """
    Icon(builtin_name: str = <factory>, custom_file:
    Optional[bench.language.file.File] = <factory>, _status:
    bench.language.const.NodeStatus = None)
    """

    metatype: "BenchType" = betterproto.enum_field(1)
    builtin_name: str = betterproto.string_field(30)
    custom_file: Optional["FileData"] = betterproto.message_field(31, optional=True)
...
class BlockData(betterproto.Message):
    ...
    primary_screen_ptr: Optional["NodeReferenceData"] = betterproto.message_field(46, optional=True)
...
class FieldData(betterproto.Message):
    ...
    value_packed: typing.Any | None = None, is_input: bool = False, is_output:
    bool = False, is_option: bool = False, _reflected_from:
...
class SomeNodeData(betterproto.Message):
    bucket_object: "BucketObjectData" = betterproto.message_field(1, group="node")
    link: "LinkData" = betterproto.message_field(2, group="node")
    ...
    organization: "OrganizationData" = betterproto.message_field(8, group="node")
    ...
    record: "RecordData" = betterproto.message_field(12, group="node")
...
class EditData(betterproto.Message):
    ...
    properties: List[int] = betterproto.int32_field(5)
