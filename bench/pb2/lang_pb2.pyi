...
class PositionData(_message.Message):
    ...
    x: float
    y: float
    def __init__(self, metatype: _Optional[_Union[ObjectType, str]] = ..., type: _Optional[_Union[PositionType, str]] = ..., x: _Optional[float] = ..., y: _Optional[float] = ...) -> None: ...
