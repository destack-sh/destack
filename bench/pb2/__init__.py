...
BenchNodeData = Union[BenchData, HandleData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, OptionData, TagData, FlowData, ActionData, LinkData, TriggerData, ImplementationData, ViewData, DatabaseData, ChannelData, RoleData, PlanData, TaskData, SpaceData, ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData, SessionData, RunData, RunSpanData, InterruptionData, LogData]
...
SourceNodeData = Union[PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, OptionData, TagData, FlowData, ActionData, LinkData, TriggerData, ImplementationData, ViewData, DatabaseData, ChannelData, RoleData, SpaceData]
InlineSourceNodeData = Union[PageData, ChoiceData, ClassData, TagData, FlowData, ImplementationData, ViewData, DatabaseData, ChannelData, RoleData]
...
StateNodeData = Union[ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData]
