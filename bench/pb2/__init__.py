...
# extra utility types
AnyNodeData = Union[BenchData, HandleData, UserData, OrganizationData, TeamData, ClientData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, FlowData, ActionData, PipeData, TriggerData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData, SpaceData, ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData, SessionData, RunData, RunSpanData, InterruptionData, LogData, PlanData, SkipData, EmptyData]
...
BenchNodeData = Union[BenchData, HandleData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, FlowData, ActionData, PipeData, TriggerData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData, SpaceData, ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData, SessionData, RunData, RunSpanData, InterruptionData, LogData, PlanData]
