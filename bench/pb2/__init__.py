...
# extra utility types
AnyNodeData = Union[BenchData, UserData, HandleData, ClientData, OrganizationData, MembershipData, InviteData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, BlockData, FieldData, ViewData, ActionData, PipeData, SpaceData, MessageData, RecordData, SessionData, RunData, RunSpanData, InterruptionData, LogData, SkipData, EmptyData]
...
BenchNodeData = Union[BenchData, HandleData, ClientData, MembershipData, InviteData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, BlockData, FieldData, ViewData, ActionData, PipeData, SpaceData, MessageData, RecordData, SessionData, RunData, RunSpanData, InterruptionData, LogData]
PackageNodeData = Union[DependencyData, BlockData, FieldData, ViewData, ActionData, PipeData, SpaceData]
...
SourceNodeData = Union[DependencyData, BlockData, FieldData, ViewData, ActionData, PipeData, SpaceData]
