...
# extra utility types
AnyNodeData = Union[BenchData, HandleData, UserData, OrganizationData, TeamData, ClientData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, FlowData, ActionData, PipeData, TriggerData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData, SpaceData, ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData, SessionData, RunData, RunSpanData, RunPlanData, InterruptionData, LogData, SkipData, EmptyData]
...
BenchNodeData = Union[BenchData, HandleData, ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, FlowData, ActionData, PipeData, TriggerData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData, SpaceData, ThreadData, MessageData, NotificationData, RecordData, MembershipData, InviteData, SessionData, RunData, RunSpanData, RunPlanData, InterruptionData, LogData]
ResourceNodeData = Union[ScalerData, StoreData, MachineData, BrowserData, FileData, StreamData, SecretData]
...
SourceNodeData = Union[PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, FlowData, ActionData, PipeData, TriggerData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData, SpaceData]
InlineSourceNodeData = Union[PageData, ChoiceData, ClassData, FlowData, ViewData, DatabaseData, ChannelData, RoleData, IdentityData]
