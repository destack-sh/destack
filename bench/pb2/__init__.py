...
PageNodeData = Union[ScalerData, StoreData, ComputerData, FileData, StreamData, LinkData, PageData, ChoiceData, ClassData, TagData, FlowData, KitData, DatabaseData, ChannelData, ThreadData, TeamData, RoleData, AgentData, PlanData, TaskData, ViewData]
