...
BenchNodeData = Union[BenchData, HandleData, ScalerData, StoreData, ComputerData, ApplicationData, FileData, StreamData, LinkData, PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, OptionData, TagData, FlowData, KitData, ActionData, TransitionData, TriggerData, DatabaseData, ChannelData, ThreadData, MessageData, NotificationData, TeamData, MembershipData, InviteData, RoleData, AgentData, SessionData, RunData, SpanData, InterruptionData, LogData, PlanData, TaskData, ClaimData, CursorData, ViewData, SpaceData, RecordData]
ResourceNodeData = Union[ScalerData, StoreData, ComputerData, ApplicationData, FileData, StreamData, LinkData]
SourceNodeData = Union[PackageData, DependencyData, PageData, BlockData, ChoiceData, ClassData, FieldData, OptionData, TagData, FlowData, KitData, ActionData, TransitionData, TriggerData, DatabaseData]
InlineNodeData = Union[ScalerData, StoreData, ComputerData, ApplicationData, FileData, StreamData, LinkData, PageData, ChoiceData, ClassData, TagData, FlowData, KitData, DatabaseData, ChannelData, ThreadData, TeamData, RoleData, AgentData, PlanData, TaskData, ViewData]
...
ClaimableNodeData = Union[ScalerData, StoreData, ComputerData, ApplicationData, FileData, StreamData, LinkData, PageData, FlowData, KitData, ActionData, DatabaseData, AgentData, PlanData, TaskData, ViewData, RecordData]
OwnableNodeData = Union[BenchData, ScalerData, StoreData, ComputerData, ApplicationData, FileData, StreamData, LinkData, PackageData, PageData, FlowData, KitData, DatabaseData, ThreadData, MessageData, AgentData, PlanData, TaskData, ClaimData, CursorData, ViewData, SpaceData, RecordData]
