...
class SupervisorBase(abc.ABC):
    ...
    async def signup_user(
        self,
        request: "system_pb2.SignupUserRequest",
        session: "Session",
    ...
    async def change_user_password(
        self,
        request: "system_pb2.ChangeUserPasswordRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def login_user(
        self,
        request: "system_pb2.LoginUserRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def logout_user(
        self,
        request: "system_pb2.LogoutUserRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def resolve_hosts(
        self,
        request: "system_pb2.ResolveHostsRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
...
class HostBase(abc.ABC):
    ...
    async def query(
        self,
        request: "system_pb2.QueryRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    def subscribe(
        self,
        request: "system_pb2.SubscribeRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def commit(
        self,
        request: "system_pb2.CommitRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def upload_files(
        self,
        request: "system_pb2.UploadFilesRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
    ...
    async def download_files(
        self,
        request: "system_pb2.DownloadFilesRequest",
        session: "Session",
        subject: "IsSubject | None",
        client: "Client | None",
        metadata: "RpcMetadata",
