...
class GraphIOBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def aggregate_nodes(self, request: 'system_pb2.AggregateNodesRequest', headers: Mapping) -> 'system_pb2.AggregateNodesResponse':
        pass

    @abc.abstractmethod
    def watch_aggregate(self, request: 'system_pb2.WatchAggregateRequest', headers: Mapping) -> AsyncIterator['system_pb2.WatchAggregateResponse']:
        pass
