...
class HealthBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def check(self, request: 'health_pb2.HealthCheckRequest', session: 'Session', subject: 'IsSubject | None', client: 'Client | None', metadata: 'RpcMetadata') -> 'health_pb2.HealthCheckResponse':
        pass

    @abc.abstractmethod
    async def watch(self, request: 'health_pb2.HealthCheckRequest', session: 'Session', subject: 'IsSubject | None', client: 'Client | None', metadata: 'RpcMetadata') -> 'health_pb2.HealthCheckResponse':
        pass
