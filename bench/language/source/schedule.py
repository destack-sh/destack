...
class Schedule(Struct):
    ...
    start: datetime | None = p_regular(32, default=None)
    end: datetime | None = p_regular(33, default=None)
    count: int | None = p_regular(34, default=None)
    week_start: Day | None = p_regular(35, default=None)
    by_set_pos: list[int] = p_regular(36, array=True)
    by_month: list[Month] = p_regular(37, array=True)
    by_month_day: list[int] = p_regular(38, array=True)
    by_year_day: list[int] = p_regular(39, array=True)
    by_easter: list[int] = p_regular(40, array=True)
    by_week_no: list[int] = p_regular(41, array=True)
    by_week_day: list[Day] = p_regular(42, array=True)
    by_hour: list[int] = p_regular(43, array=True)
    by_minute: list[int] = p_regular(44, array=True)
    by_second: list[int] = p_regular(45, array=True)
