...
# sources: bench/language/wire.proto
...
class LogEntryData(betterproto.Message):
    id: str = betterproto.string_field(20)
...
class RunErrorData(betterproto.Message):
    ...
    traceback: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(24)
...
class RunData(betterproto.Message):
    ...
    last_changed_at: datetime = betterproto.message_field(14)
    revision: int = betterproto.int64_field(15)
    statement_ck: str = betterproto.string_field(22)
    statement_path: str = betterproto.string_field(23)
    scheduled_at: datetime = betterproto.message_field(24)
    started_at: datetime = betterproto.message_field(25)
    terminated_at: datetime = betterproto.message_field(26)
    trigger_type: str = betterproto.string_field(27)
    trigger_ck: str = betterproto.string_field(28)
    access_level: int = betterproto.int64_field(29)
    status: "RunStatus" = betterproto.enum_field(30)
    inputs: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(31)
    outputs: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(32)
    error: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(33)
...
class SessionData(betterproto.Message):
    ...
    worker_node_id: str = betterproto.string_field(21)
    worker_process_id: str = betterproto.string_field(22)
    trigger_type: "TriggerType" = betterproto.enum_field(23)
    trigger_id: str = betterproto.string_field(24)
    opened_at: datetime = betterproto.message_field(25)
    closed_at: datetime = betterproto.message_field(26)
    inference_timeout: int = betterproto.int64_field(27)
    inference_retries: int = betterproto.int64_field(28)
...
class ViewData(betterproto.Message):
    ...
    query: "betterproto_lib_google_protobuf.Struct" = betterproto.message_field(22)
    sort: List["betterproto_lib_google_protobuf.Struct"] = betterproto.message_field(23)
...
class SomeNodeData(betterproto.Message):
    ...
    field: "FieldData" = betterproto.message_field(4, group="node")
    ...
    resolved_field: "ResolvedFieldData" = betterproto.message_field(8, group="node")
...
class SomeStructData(betterproto.Message):
    ...
    tagging: "TaggingData" = betterproto.message_field(2, group="struct")
    file: "FileData" = betterproto.message_field(3, group="struct")
    blob: "BlobData" = betterproto.message_field(4, group="struct")
    field: "FieldData" = betterproto.message_field(5, group="struct")
    run: "RunData" = betterproto.message_field(6, group="struct")
    run_error: "RunErrorData" = betterproto.message_field(7, group="struct")
    trigger: "TriggerData" = betterproto.message_field(8, group="struct")
    environment: "EnvironmentData" = betterproto.message_field(9, group="struct")
    record: "RecordData" = betterproto.message_field(10, group="struct")
    expression: "ExpressionData" = betterproto.message_field(11, group="struct")
    resolved_field: "ResolvedFieldData" = betterproto.message_field(12, group="struct")
    issue: "IssueData" = betterproto.message_field(13, group="struct")
    session: "SessionData" = betterproto.message_field(14, group="struct")
    statement: "StatementData" = betterproto.message_field(15, group="struct")
    module: "ModuleData" = betterproto.message_field(16, group="struct")
    secret: "SecretData" = betterproto.message_field(17, group="struct")
    worker_set: "WorkerSetData" = betterproto.message_field(18, group="struct")
    view: "ViewData" = betterproto.message_field(19, group="struct")
    run_code_frame: "RunCodeFrameData" = betterproto.message_field(20, group="struct")
