...
const FILE_GLOBS_TO_UPDATE: &[&str] = &[
    ...
    "bridge/elixir/mix.exs",
    "bridge/elixir/lib/destack.ex",
    "bridge/elixir/lib/destack/native.ex",
    "bridge/elixir/c_src/destack_nif.c",
    "bridge/swift/Sources/Destack/Client.swift",
    "bridge/ruby/ext/destack_ext/destack_ext.c",
    "bridge/typescript/src/index.ts",
    "bridge/rust/README.md",
    "bridge/rust/compat/destack-rs/README.md",
    "bridge/python/README.md",
    "bridge/python/src/destack/client.py",
    "bridge/python/pyproject.toml",
    "bridge/python/compat/destack-py/pyproject.toml",
    "bridge/rust/compat/destack-rs/Cargo.toml",
