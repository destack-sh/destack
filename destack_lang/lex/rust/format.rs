...
pub fn render_tokens(tokens: &[Token], source: &str) -> String {
    ...
    for tok in tokens {
        ...
        match tok.r#type {
            ...
            TokenType::DoubleDot => out.push_str(".."),
            TokenType::TripleDot => out.push_str("..."),
            ...
            TokenType::DoubleMinus => out.push_str("--"),
            TokenType::TripleMinus => out.push_str("---"),
            TokenType::ThinArrow => out.push_str("->"),
            TokenType::And => out.push('&'),
            TokenType::Or => out.push('|'),
            TokenType::Plus => out.push('+'),
            TokenType::DoublePlus => out.push_str("++"),
            TokenType::TriplePlus => out.push_str("+++"),
