...
const GENERATED_HEADER: &str = "# generated client target, do not edit";
const FORMATTER: &str = "ruff==0.15.18";
const FORMAT_PATHS: &[&str] = &["src", "tests"];

/// Format generated Python client files.
pub(in crate::generate) fn format(root: &Path) -> Result<()> {
    let mut command = Command::new("uv");
    command.current_dir(root.join("client/python")).arg("run");
...
pub(super) fn prune_outputs(root: &Path, schema: &Schema) -> Result<()> {
    let generated_root = root.join("client/python/src/destack/_generated");
    if generated_root.exists() {
        fs::remove_dir_all(generated_root)?;
    }

    prune_directory(root, "client/python/src/destack/session")?;
...
/// Return whether one Python directory only contains generated client files.
...
pub(super) fn module_facade_path(schema: &Schema, module: &SchemaModule) -> String {
    ...
    format!("client/python/src/destack/_generated/{path}.py")
}
...
pub(super) fn package_facade_path(package: &PythonPackage) -> String {
    ...
    format!("client/python/src/destack/{path}/__init__.py")
}
...
pub(super) fn package_stub_path(package: &PythonPackage) -> String {
    ...
    format!("client/python/src/destack/{path}/__init__.pyi")
}
...
pub(super) fn generated_package_facade_path(package: &PythonPackage) -> String {
    ...
    format!("client/python/src/destack/_generated/{path}/__init__.py")
}
...
pub(super) fn generated_package_stub_path(package: &PythonPackage) -> String {
    ...
    format!("client/python/src/destack/_generated/{path}/__init__.pyi")
}
