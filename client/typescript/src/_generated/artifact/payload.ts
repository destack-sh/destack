...
import type { MirDeclared } from "./mir.js";
...
import {
    decodeDirMaterialized,
    encodeDirMaterialized,
    fromJsonDirMaterialized,
    toJsonDirMaterialized,
} from "./dir.js";
...
import {
    decodeEnvironmentBound,
    encodeEnvironmentBound,
    fromJsonEnvironmentBound,
    toJsonEnvironmentBound,
} from "./environment.js";
import {
    decodeEnvironmentDeclared,
    encodeEnvironmentDeclared,
    fromJsonEnvironmentDeclared,
    toJsonEnvironmentDeclared,
} from "./environment.js";
import {
    decodeModuleGraph,
    encodeModuleGraph,
...
import {
    decodeProgramIndex,
    encodeProgramIndex,
    fromJsonProgramIndex,
    toJsonProgramIndex,
} from "./index.js";
import {
    decodeModuleLinted,
    encodeModuleLinted,
    fromJsonModuleLinted,
    toJsonModuleLinted,
} from "./lint.js";
import {
    decodeProgramLinted,
    encodeProgramLinted,
    fromJsonProgramLinted,
    toJsonProgramLinted,
} from "./lint.js";
import {
    decodeMirAnalyzed,
...
import {
    decodeMirElaborated,
    encodeMirElaborated,
    fromJsonMirElaborated,
    toJsonMirElaborated,
} from "./mir.js";
import {
    decodeMirInstantiated,
    encodeMirInstantiated,
    fromJsonMirInstantiated,
    toJsonMirInstantiated,
} from "./mir.js";
...
import {
    ...
    encodeProgramAnalysis,
    fromJsonProgramAnalysis,
    toJsonProgramAnalysis,
} from "./mir.js";
import {
    decodeMirVerified,
    encodeMirVerified,
...
export type ArtifactPayload =
    ...
    | {
          readonly kind: "mirDeclared";
          readonly mir_declared: MirDeclared;
      }
...
export const ArtifactPayload = {
    ...
    /** The declarations one module lowers ahead of its bodies. */
    mirDeclared(mir_declared: MirDeclared): ArtifactPayload {
        return { kind: "mirDeclared", mir_declared };
    },
...
export function encodeArtifactPayload(writer: BinaryWriter, value: ArtifactPayload): void {
    switch (value.kind) {
        ...
        case "mirDeclared":
            ...
            encodeMirDeclared(writer, value.mir_declared);
            return;
        case "mirLowered":
...
export function decodeArtifactPayload(reader: BinaryReader): ArtifactPayload {
    ...
    switch (variant) {
        ...
        case 15: {
            const mir_declared = decodeMirDeclared(reader);
...
export function toJsonArtifactPayload(value: ArtifactPayload): Json {
    switch (value.kind) {
        ...
        case "mirDeclared":
            return {
                kind: "mirDeclared",
                mir_declared: toJsonMirDeclared(value.mir_declared),
            };
        case "mirLowered":
            return {
                kind: "mirLowered",
...
export function fromJsonArtifactPayload(value: Json): ArtifactPayload {
    ...
    switch (kind) {
        ...
        case "environmentDeclared":
            return {
                kind,
                environment_declared: fromJsonEnvironmentDeclared(
                    jsonField(object, "environment_declared"),
                ),
            };
        case "dirElaborated":
            return {
        ...
        case "mirDeclared":
            return {
                kind,
                mir_declared: fromJsonMirDeclared(jsonField(object, "mir_declared")),
            };
        case "mirLowered":
            return {
                kind,
