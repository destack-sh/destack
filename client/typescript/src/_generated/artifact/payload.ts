...
export type ArtifactPayload =
    ...
    | {
          ...
          readonly program: Uint8Array | readonly number[];
      }
...
export const ArtifactPayload = {
    ...
    /** Program for one package target. */
    program(program: Uint8Array | readonly number[]): ArtifactPayload {
...
export function toJsonArtifactPayload(value: ArtifactPayload): Json {
    switch (value.kind) {
        ...
        case "program":
            return {
                kind: "program",
                program: bytesToJson(value.program),
            };
        case "product":
            return {
                kind: "product",
...
export function fromJsonArtifactPayload(value: Json): ArtifactPayload {
    ...
    switch (kind) {
        ...
        case "program":
            return {
                kind,
                program: bytesFromJson(jsonField(object, "program")),
            };
        case "product":
            return {
                kind,
