...
import {
    decodeAtomicRmwOperator,
    encodeAtomicRmwOperator,
    fromJsonAtomicRmwOperator,
    toJsonAtomicRmwOperator,
} from "./memory.js";
import {
    decodeCompareExchangeAccess,
    encodeCompareExchangeAccess,
    fromJsonCompareExchangeAccess,
    toJsonCompareExchangeAccess,
} from "./memory.js";
import {
    decodeFenceAccess,
    encodeFenceAccess,
...
import {
    decodeVectorReduceOperator,
    encodeVectorReduceOperator,
    fromJsonVectorReduceOperator,
    toJsonVectorReduceOperator,
} from "./vector.js";
...
export const Instruction = {
    ...
    functionAddr(
        destination: Value,
        function_: LocalNodeId,
        arguments_: ReadonlyArray<GenericArgument>,
    ): Instruction {
        return { kind: "functionAddr", destination, function: function_, arguments: arguments_ };
    },
    ...
    /** Release one unique representation's backing allocation to the heap (`release`). */
    release(value: Value): Instruction {
