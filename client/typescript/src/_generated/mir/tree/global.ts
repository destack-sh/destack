...
import { BinaryReader, BinaryWriter, Json, SerdeError, bytesFromJson, bytesToJson, jsonArray, jsonBigint, jsonField, jsonObject, jsonOptional, jsonString } from "../../../protocol/serde.js";
...
export const GlobalInitializer = {
    ...
    /** One string value, rewritten into its representation's fields by the constant encoder. */
    "string"(string_: StringId): GlobalInitializer {
        return { kind: "string", string: string_ };
    },

    /** One bigint value, rewritten into its representation's fields by the constant encoder. */
    bigInt(big_int: bigint): GlobalInitializer {
        return { kind: "bigInt", big_int };
    },
...
export function encodeGlobalInitializer(writer: BinaryWriter, value: GlobalInitializer): void {
    switch (value.kind) {
        ...
        case "bigInt":
            ...
            writer.writeSigned(value.big_int);
            return;
    }
...
export function decodeGlobalInitializer(reader: BinaryReader): GlobalInitializer {
    ...
    switch (variant) {
        ...
        case 7: {
            const big_int = reader.readSigned();
...
export function toJsonGlobalInitializer(value: GlobalInitializer): Json {
    switch (value.kind) {
        ...
        case "bigInt":
            return {
                kind: "bigInt",
                big_int: value.big_int.toString(),
            };
    }
...
export function fromJsonGlobalInitializer(value: Json): GlobalInitializer {
    ...
    switch (kind) {
        ...
        case "bigInt":
            return {
                kind,
                big_int: jsonBigint(jsonField(object, "big_int")),
            };
    }
