...
export const MemoryTarget = {
    /** Access through a reference value. */
    reference(reference: Value): MemoryTarget {
...
export function encodeMemoryTarget(writer: BinaryWriter, value: MemoryTarget): void {
    switch (value.kind) {
        case "reference":
            writer.writeUnsigned(0);
            encodeValue(writer, value.reference);
            return;
        case "local":
            writer.writeUnsigned(1);
...
export function decodeMemoryTarget(reader: BinaryReader): MemoryTarget {
    ...
    switch (variant) {
        case 0: {
            const reference = decodeValue(reader);
...
export function toJsonMemoryTarget(value: MemoryTarget): Json {
    switch (value.kind) {
        case "reference":
            return {
                kind: "reference",
                reference: toJsonValue(value.reference),
            };
        case "local":
            return {
                kind: "local",
...
export function fromJsonMemoryTarget(value: Json): MemoryTarget {
    ...
    switch (kind) {
        case "reference":
            return {
                kind,
                reference: fromJsonValue(jsonField(object, "reference")),
            };
        case "local":
            return {
                kind,
