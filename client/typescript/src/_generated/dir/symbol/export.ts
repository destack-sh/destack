...
export const ExportTarget = {
    /** One declaration symbol. */
    "symbol"(symbol_: GlobalSymbolId): ExportTarget {
...
export function encodeLocalExport(writer: BinaryWriter, value: LocalExport): void {
    ...
    encodeExportForm(writer, value.form);
    writer.writeOption(value.item, (value3) => {
...
export function decodeLocalExport(reader: BinaryReader): LocalExport {
    ...
    const form = decodeExportForm(reader);
...
export function toJsonLocalExport(value: LocalExport): Json {
    return {
        ...
        form: toJsonExportForm(value.form),
...
export function fromJsonLocalExport(value: Json): LocalExport {
    ...
    return {
        ...
        form: fromJsonExportForm(jsonField(object, "form")),
