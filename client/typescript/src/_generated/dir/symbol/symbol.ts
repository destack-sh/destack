...
export function encodeSymbol(writer: BinaryWriter, value: Symbol): void {
    ...
    writer.writeOption(value.bindingSpace, (value4) => {
        encodeSpace(writer, value4);
    });
    encodeSymbolOrigin(writer, value.origin);
    writer.writeOption(value.key, (value6) => {
        encodeStaticKey(writer, value6);
    });
    encodeLocalScope(writer, value.scope);
    writer.writeOption(value.exportKind, (value8) => {
        encodeExportKind(writer, value8);
    });
    writer.writeOption(value.declaration, (value9) => {
        encodeGlobalNodeIdAny(writer, value9);
    });
}
...
export function decodeSymbol(reader: BinaryReader): Symbol {
    ...
    const bindingSpace = reader.readOption(() => decodeSpace(reader));
    ...
    return {
        ...
        ...(bindingSpace === undefined ? {} : { bindingSpace }),
        origin,
        ...(key === undefined ? {} : { key }),
        scope,
...
export function toJsonSymbol(value: Symbol): Json {
    return {
        ...
        ...(value.bindingMutability === undefined
            ? {}
            : { bindingMutability: toJsonMutability(value.bindingMutability) }),
        ...(value.bindingSpace === undefined
            ? {}
            : { bindingSpace: toJsonSpace(value.bindingSpace) }),
        ...
        ...(value.exportKind === undefined
            ? {}
            : { exportKind: toJsonExportKind(value.exportKind) }),
...
export function fromJsonSymbol(value: Json): Symbol {
    ...
    return {
        ...
        bindingMutability: jsonOptional(object, "bindingMutability", (value) =>
            fromJsonMutability(value),
        ),
        bindingSpace: jsonOptional(object, "bindingSpace", (value) => fromJsonSpace(value)),
