...
import {
    decodeImportAttributeClause,
    encodeImportAttributeClause,
    fromJsonImportAttributeClause,
    toJsonImportAttributeClause,
} from "./import.js";
...
export function decodeCondition(reader: BinaryReader): Condition {
    const operands = (() => {
        ...
        const items0: Array<ConditionOperand> = [];
        for (let index = 0; index < length0; index += 1) {
            items0.push(decodeConditionOperand(reader));
        }
        return items0;
    })();
...
export function fromJsonCondition(value: Json): Condition {
    ...
    return {
        operands: jsonArray(jsonField(object, "operands")).map((item0) =>
            fromJsonConditionOperand(item0),
        ),
    };
}
...
export const Expression = {
    ...
    import(
        ...
        attributes: ImportAttributeClause | undefined,
    ): Expression {
    ...
    let(
        kind: LetKind,
        export_: ExportKind | undefined,
        mutability: Mutability,
        declarators: ReadonlyArray<LocalNodeId>,
        isAmbient: boolean,
        place: PlaceModifier | undefined,
    ): Expression {
        return {
            kind: "let",
            kindValue: kind,
    ...
    letElse(
        kind: LetKind,
        mutability: Mutability,
        declarator: LocalNodeId,
        elseBranch: LocalNodeId,
    ): Expression {
    ...
    if(
        ...
        elseExpression: LocalNodeId | undefined,
    ): Expression {
    ...
    for(
        label: StringId | undefined,
        initialization: LocalNodeId | undefined,
    ...
    try(
        body: LocalNodeId,
        catch_: LocalNodeId | undefined,
        finally_: LocalNodeId | undefined,
    ): Expression {
    ...
    /** Range expression. */
    rangeExpression(
        start: LocalNodeId | undefined,
        end: LocalNodeId | undefined,
        endKind: RangeEnd,
    ): Expression {
    ...
    taggedTemplateExpression(
        tag: LocalNodeId,
        genericArguments: ReadonlyArray<LocalNodeId>,
    ...
    /** A TreeExpression constructs a tree fragment with attributes and children. */
    treeExpression(
        left: LocalNodeId | undefined,
        genericArguments: ReadonlyArray<LocalNodeId>,
        attributes: ReadonlyArray<LocalNodeId> | undefined,
        children: ReadonlyArray<LocalNodeId> | undefined,
    ): Expression {
...
export function decodeExpression(reader: BinaryReader): Expression {
    ...
    switch (variant) {
        ...
        case 36: {
            ...
            const attributes = reader.readOption(() =>
                (() => {
                    const length3 = reader.readNumber();
                    const items3: Array<LocalNodeId> = [];
                    for (let index = 0; index < length3; index += 1) {
            ...
            const children = reader.readOption(() =>
                (() => {
    ...
    switch (value.kind) {
        ...
        case "import":
            return {
                ...
                ...(value.attributes === undefined
                    ? {}
                    : { attributes: toJsonImportAttributeClause(value.attributes) }),
            };
        case "export":
            return {
                kind: "export",
        ...
        case "for":
            return {
                ...
                ...(value.initialization === undefined
                    ? {}
                    : { initialization: toJsonLocalNodeId(value.initialization) }),
        ...
        case "try":
            return {
                ...
                ...(value.finally === undefined
                    ? {}
                    : { finally: toJsonLocalNodeId(value.finally) }),
            };
        case "match":
            return {
                kind: "match",
        ...
        case "treeExpression":
            return {
                ...
                ...(value.attributes === undefined
                    ? {}
                    : { attributes: value.attributes.map((item0) => toJsonLocalNodeId(item0)) }),
                ...(value.children === undefined
                    ? {}
                    : { children: value.children.map((item0) => toJsonLocalNodeId(item0)) }),
            };
        case "type":
            return {
                kind: "type",
        ...
        case "borrowOf":
            return {
                kind: "borrowOf",
                ...(value.mutability === undefined
                    ? {}
                    : { mutability: toJsonMutability(value.mutability) }),
                ...(value.variance === undefined
                    ? {}
                    : { variance: toJsonVarianceBound(value.variance) }),
                right: toJsonLocalNodeId(value.right),
            };
        case "member":
            return {
    ...
    switch (kind) {
        ...
        case "import":
            return {
                ...
                attributes: jsonOptional(object, "attributes", (value) =>
                    fromJsonImportAttributeClause(value),
                ),
            };
        case "export":
            return {
        ...
        case "if":
            return {
                ...
                elseExpression: jsonOptional(object, "elseExpression", (value) =>
        ...
        case "match":
            return {
                ...
                arms: jsonArray(jsonField(object, "arms")).map((item0) =>
                    fromJsonLocalNodeId(item0),
                ),
            };
        case "switch":
        ...
        case "treeExpression":
            return {
                ...
                children: jsonOptional(object, "children", (value) =>
                    jsonArray(value).map((item0) => fromJsonLocalNodeId(item0)),
                ),
            };
        case "type":
        ...
        case "borrowOf":
            return {
                kind,
                mutability: jsonOptional(object, "mutability", (value) =>
                    fromJsonMutability(value),
                ),
