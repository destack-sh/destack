...
import {
    decodeDecoratorTarget,
    encodeDecoratorTarget,
    fromJsonDecoratorTarget,
    toJsonDecoratorTarget,
...
export function decodeDecoratorsResponse(reader: BinaryReader): DecoratorsResponse {
    const decorators = (() => {
        ...
        const items0: Array<DecoratorItem> = [];
        for (let index = 0; index < length0; index += 1) {
            items0.push(decodeDecoratorItem(reader));
        }
        return items0;
    })();
