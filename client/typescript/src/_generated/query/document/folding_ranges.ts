...
export function encodeFoldingRangesRequest(
    writer: BinaryWriter,
    value: FoldingRangesRequest,
): void {
...
export function encodeFoldingRangesResponse(
    writer: BinaryWriter,
    value: FoldingRangesResponse,
): void {
...
export function decodeFoldingRangesResponse(reader: BinaryReader): FoldingRangesResponse {
    const ranges = (() => {
        ...
        const items0: Array<FoldingRange> = [];
        for (let index = 0; index < length0; index += 1) {
            items0.push(decodeFoldingRange(reader));
        }
        return items0;
    })();
