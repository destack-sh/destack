...
export function encodeCompletionDetailsMode(
    writer: BinaryWriter,
    value: CompletionDetailsMode,
): void {
    switch (value) {
        case "eager":
...
export function encodeCompletionDetailsRequest(
    writer: BinaryWriter,
    value: CompletionDetailsRequest,
): void {
...
export function decodeCompletionDetailsRequest(reader: BinaryReader): CompletionDetailsRequest {
    ...
    const additionalEdits = (() => {
        ...
        const items3: Array<Patch> = [];
        for (let index = 0; index < length3; index += 1) {
            items3.push(decodePatch(reader));
        }
        return items3;
    })();
...
export function fromJsonCompletionDetailsRequest(value: Json): CompletionDetailsRequest {
    ...
    return {
        ...
        additionalEdits: jsonArray(jsonField(object, "additionalEdits")).map((item0) =>
            fromJsonPatch(item0),
        ),
    };
}
...
export function encodeCompletionDetailsResponse(
    writer: BinaryWriter,
    value: CompletionDetailsResponse,
): void {
...
export function decodeCompletionDetailsResponse(reader: BinaryReader): CompletionDetailsResponse {
    ...
    const additionalEdits = (() => {
        ...
        const items2: Array<Patch> = [];
        for (let index = 0; index < length2; index += 1) {
            items2.push(decodePatch(reader));
        }
        return items2;
    })();
...
export function decodeCompletionEntry(reader: BinaryReader): CompletionEntry {
    ...
    const matchPositions = (() => {
        ...
        const items8: Array<number> = [];
        for (let index = 0; index < length8; index += 1) {
            items8.push(reader.readNumber());
        }
        return items8;
    })();
...
export function toJsonCompletionEntry(value: CompletionEntry): Json {
    return {
        ...
        ...(value.details === undefined
            ? {}
            : { details: toJsonCompletionEntryDetails(value.details) }),
    };
}
...
export function fromJsonCompletionEntry(value: Json): CompletionEntry {
    ...
    return {
        ...
        matchPositions: jsonArray(jsonField(object, "matchPositions")).map((item0) =>
            jsonInteger(item0),
        ),
...
export function encodeCompletionEntryDetails(
    writer: BinaryWriter,
    value: CompletionEntryDetails,
): void {
    switch (value.kind) {
        case "deferred":
            writer.writeUnsigned(0);
...
export function decodeCompletionResponse(reader: BinaryReader): CompletionResponse {
    const entries = (() => {
        ...
        const items0: Array<CompletionEntry> = [];
        for (let index = 0; index < length0; index += 1) {
            items0.push(decodeCompletionEntry(reader));
        }
        return items0;
    })();
