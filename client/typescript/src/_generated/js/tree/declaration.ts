...
export function toJsonClassDeclaration(value: ClassDeclaration): Json {
    return {
        ...
        ...(value.extendsExpression === undefined
            ? {}
            : { extendsExpression: toJsonLocalNodeId(value.extendsExpression) }),
...
export function fromJsonClassDeclaration(value: Json): ClassDeclaration {
    ...
    return {
        ...
        extendsExpression: jsonOptional(object, "extendsExpression", (value) =>
