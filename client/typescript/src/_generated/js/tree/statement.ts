...
export const Statement = {
    /** Import items. */
    "import"(target: StringId, targetModule: ModuleId | undefined, items: ReadonlyArray<LocalNodeId> | undefined, attributes: DependencyAttributeClause | undefined): Statement {
        return { kind: "import", target, targetModule, items, attributes };
    },

    /** Export items. */
    "export"(target: StringId | undefined, targetModule: ModuleId | undefined, items: ReadonlyArray<LocalNodeId>, attributes: DependencyAttributeClause | undefined): Statement {
    ...
    /** Let binding. */
    "let"(isExported: boolean, mutability: Mutability, declarators: ReadonlyArray<LocalNodeId>): Statement {
    ...
    /** Using binding. */
    using(asynchrony: Asynchrony, isExported: boolean, declarators: ReadonlyArray<LocalNodeId>): Statement {
