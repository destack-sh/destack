...
export const Expression = {
    ...
    /** Member access. */
    member(left: LocalNodeId, name: StringId, isOptional: boolean): Expression {
    ...
    /** Index. */
    index(left: LocalNodeId, right: LocalNodeId, isOptional: boolean): Expression {
        return { kind: "index", left, right, isOptional };
    },

    /** Call. */
    call(left: LocalNodeId, arguments_: ReadonlyArray<LocalNodeId>, isOptional: boolean): Expression {
        return { kind: "call", left, arguments: arguments_, isOptional };
    },
    ...
    /** New. */
    "new"(left: LocalNodeId, arguments_: ReadonlyArray<LocalNodeId>): Expression {
        return { kind: "new", left, arguments: arguments_ };
    },

    /** Arrow function expression. */
    arrowFunction(asynchrony: Asynchrony, parameters: ReadonlyArray<LocalNodeId>, body: ArrowFunctionBody): Expression {
        return { kind: "arrowFunction", asynchrony, parameters, body };
    },

    /** If ternary. */
    ifTernary(condition: LocalNodeId, thenExpression: LocalNodeId, elseExpression: LocalNodeId): Expression {
...
export function encodeExpression(writer: BinaryWriter, value: Expression): void {
    switch (value.kind) {
        ...
        case "ifTernary":
            ...
            encodeLocalNodeId(writer, value.elseExpression);
            return;
        case "error":
...
export function decodeExpression(reader: BinaryReader): Expression {
    ...
    switch (variant) {
        ...
        case 26: {
            ...
            const elseExpression = decodeLocalNodeId(reader);
    ...
    switch (value.kind) {
        ...
        case "ifTernary":
            return {
                ...
                elseExpression: toJsonLocalNodeId(value.elseExpression),
            };
        case "error":
            return {
                kind: "error",
    ...
    switch (kind) {
        ...
        case "ifTernary":
            return {
                ...
                elseExpression: fromJsonLocalNodeId(jsonField(object, "elseExpression")),
            };
        case "error":
            return {
                kind,
