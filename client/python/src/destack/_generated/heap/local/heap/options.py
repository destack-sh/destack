...
def encode_heap_options(writer: BinaryWriter, value: HeapOptions) -> None:
    ...
    writer.write_unsigned(value.heap_young_size_bytes)
    writer.write_unsigned(value.max_heap_young_allocation_size_bytes)
...
def decode_heap_options(reader: BinaryReader) -> HeapOptions:
    ...
    heap_young_size_bytes = reader.read_number()
    max_heap_young_allocation_size_bytes = reader.read_number()
    ...
    return HeapOptions(
        ...
        heap_young_size_bytes=heap_young_size_bytes,
        max_heap_young_allocation_size_bytes=max_heap_young_allocation_size_bytes,
...
def to_json_heap_options(value: HeapOptions) -> Json:
    ...
    return {
        ...
        "heapYoungSizeBytes": value.heap_young_size_bytes,
        "maxHeapYoungAllocationSizeBytes": value.max_heap_young_allocation_size_bytes,
...
def from_json_heap_options(value: Json) -> HeapOptions:
    ...
    return HeapOptions(
        ...
        heap_young_size_bytes=json_int(json_field(object_, "heapYoungSizeBytes")),
        max_heap_young_allocation_size_bytes=json_int(
            json_field(object_, "maxHeapYoungAllocationSizeBytes")
        ),
