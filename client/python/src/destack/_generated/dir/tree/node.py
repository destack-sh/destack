...
def decode_global_node_id_any(reader: BinaryReader) -> GlobalNodeIdAny:
    ...
    local_id = decode_local_node_id_any(reader)
...
def to_json_global_node_id_any(value: GlobalNodeIdAny) -> Json:
    ...
    return {
        ...
        "localId": to_json_local_node_id_any(value.local_id),
    }
...
def from_json_global_node_id_any(value: Json) -> GlobalNodeIdAny:
    ...
    return GlobalNodeIdAny(
        ...
        local_id=from_json_local_node_id_any(json_field(object_, "localId")),
    )
...
def from_json_node_type(value: Json) -> NodeType:
    ...
    if variant == "expression":
        ...
        return "typeMember"
    elif variant == "typeMappedParameter":
        return "typeMappedParameter"
    elif variant == "member":
        return "member"
    elif variant == "enumField":
        return "enumField"
    elif variant == "whereClause":
        return "whereClause"
...
def encode_global_node_id(writer: BinaryWriter, value: GlobalNodeId) -> None:
    ...
    encode_local_node_id(writer, value.local_id)


def decode_global_node_id(reader: BinaryReader) -> GlobalNodeId:
    """Decode one GlobalNodeId."""
    module_id = destack._generated.source.file.model.module.decode_module_id(reader)
    local_id = decode_local_node_id(reader)
...
def to_json_global_node_id(value: GlobalNodeId) -> Json:
    ...
    return {
        ...
        "localId": to_json_local_node_id(value.local_id),
    }
...
def from_json_global_node_id(value: Json) -> GlobalNodeId:
    ...
    return GlobalNodeId(
        ...
        local_id=from_json_local_node_id(json_field(object_, "localId")),
    )
