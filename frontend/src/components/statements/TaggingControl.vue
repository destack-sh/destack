...
<template>
  <div class="group relative flex flex-row gap-1.5">
    ...
    <button
      ...
      :key="tagging.id"
      class="flex h-fit max-h-fit flex-row rounded-xl bg-emerald-100 px-1.5 text-emerald-900 ring-1 ring-inset ring-emerald-600/20 hover:bg-emerald-200 focus:bg-emerald-200 focus:outline-none focus:ring-emerald-600/80"
