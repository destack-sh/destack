...
<template>
  <div class="flex flex-row gap-2">
    ...
    <button
      ...
      tabindex="-1"
      @click="insertOutput()"
      class="relative w-fit select-none items-baseline rounded-sm px-0.5 text-gray-400 outline-none hover:bg-orange-100 hover:text-gray-700 focus:bg-orange-100"
    >
      +output
    </button>
    <!-- Output type -->
