...
export interface EditData {
  ...
  properties: string[];
  /**
   * @generated from protobuf field: ClientOrigin origin = 5;
   */
  origin?: ClientOrigin;
}
//
...
/**
 * @generated from protobuf message LogoutUserResponse
 */
...
export interface CommitEditsRequest {
   ...
   *
   * @generated from protobuf field: repeated EditData bypassed_edits = 2;
   */
...
/**
 * @generated from protobuf message PushEditsRequest
 */
export interface PushEditsRequest {
  /**
   * @generated from protobuf field: repeated EditData bypassed_edits = 1;
   */
  bypassedEdits: EditData[];
}
/**
...
class ClientOrigin$Type extends MessageType<ClientOrigin> {
  ...
  internalBinaryWrite(message: ClientOrigin, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.clientNonce !== "") writer.tag(2, WireType.LengthDelimited).string(message.clientNonce);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CreateUserResponse$Type extends MessageType<CreateUserResponse> {
  ...
  internalBinaryWrite(message: CreateUserResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.accessToken !== "") writer.tag(2, WireType.LengthDelimited).string(message.accessToken);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
/**
 * @generated MessageType for protobuf message LoginUserRequest
 */
...
/**
 * @generated MessageType for protobuf message LoginUserResponse
 */
...
class LogoutUserRequest$Type extends MessageType<LogoutUserRequest> {
  constructor() {
    super("LogoutUserRequest", [{ no: 1, name: "user", kind: "message", T: () => UserData }]);
  }
...
/**
 * @generated MessageType for protobuf message LogoutUserRequest
 */
...
class LogoutUserResponse$Type extends MessageType<LogoutUserResponse> {
  constructor() {
    super("LogoutUserResponse", [{ no: 1, name: "user", kind: "message", T: () => UserData }]);
  }
...
/**
 * @generated MessageType for protobuf message LogoutUserResponse
 */
...
class CommitEditsRequest$Type extends MessageType<CommitEditsRequest> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated EditData edits */ 1:
          ...
          break;
        case /* repeated EditData bypassed_edits */ 2:
  ...
  internalBinaryWrite(message: CommitEditsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    for (let i = 0; i < message.bypassedEdits.length; i++)
      EditData.internalBinaryWrite(
        message.bypassedEdits[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
...
class PushEditsRequest$Type extends MessageType<PushEditsRequest> {
  ...
  create(value?: PartialMessage<PushEditsRequest>): PushEditsRequest {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.bypassedEdits = [];
    if (value !== undefined) reflectionMergePartial<PushEditsRequest>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      let [fieldNo, wireType] = reader.tag();
      switch (fieldNo) {
        case /* repeated EditData bypassed_edits */ 1:
          message.bypassedEdits.push(EditData.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
          let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message PushEditsRequest
 */
...
class RunProxyStatementRequest$Type extends MessageType<RunProxyStatementRequest> {
  ...
  internalBinaryWrite(
    ...
    /* string run_ck = 5; */
    if (message.runCk !== "") writer.tag(5, WireType.LengthDelimited).string(message.runCk);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class StartRunRequest$Type extends MessageType<StartRunRequest> {
  ...
  internalBinaryWrite(message: StartRunRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.keyedInputs !== false) writer.tag(11, WireType.Varint).bool(message.keyedInputs);
    /* bool keyed_outputs = 12; */
    if (message.keyedOutputs !== false) writer.tag(12, WireType.Varint).bool(message.keyedOutputs);
...
export const ModuleHost = new ServiceType("ModuleHost", [
  ...
  { name: "PushEdits", options: {}, I: PushEditsRequest, O: Empty },
...
/**
 * @generated ServiceType for protobuf service Worker
 */
export const Worker = new ServiceType("Worker", [
