...
export interface FileData {
    ...
    /**
     * @generated from protobuf field: int32 status = 35;
     */
    status: number;
}
/**
...
export interface SessionData {
    ...
    /**
     * @generated from protobuf field: optional int32 trigger_type = 33;
     */
    triggerType?: number;
    /**
...
class FileData$Type extends MessageType<FileData> {
    constructor() {
        super("symbolx.bench.FileData", [
            ...
            { no: 35, name: "status", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
...
class SessionData$Type extends MessageType<SessionData> {
    constructor() {
        super("symbolx.bench.SessionData", [
            ...
            { no: 33, name: "trigger_type", kind: "scalar", opt: true, T: 5 /*ScalarType.INT32*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional string server_process_id */ 32:
                    ...
                    break;
                case /* optional int32 trigger_type */ 33:
    ...
    internalBinaryWrite(message: SessionData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional int32 trigger_type = 33; */
