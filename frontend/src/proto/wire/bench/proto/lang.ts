...
export interface SomeNodeData {
  ...
  node:
    ...
    | {
        ...
        /**
         * @generated from protobuf field: symbolx.bench.BucketObjectData bucket_object = 5;
         */
    ...
    | {
        oneofKind: "package";
        /**
         * @generated from protobuf field: symbolx.bench.PackageData package = 6;
         */
        package: PackageData;
      }
    | {
    ...
    | {
        oneofKind: "run";
        /**
         * @generated from protobuf field: symbolx.bench.RunData run = 8;
         */
        run: RunData;
      }
    | {
    ...
    | {
        oneofKind: "workerSet";
        /**
         * @generated from protobuf field: symbolx.bench.WorkerSetData worker_set = 12;
         */
    ...
    | {
        oneofKind: "client";
        /**
         * @generated from protobuf field: symbolx.bench.ClientData client = 21;
         */
        client: ClientData;
      }
    | {
        oneofKind: "record";
        /**
         * @generated from protobuf field: symbolx.bench.RecordData record = 22;
         */
        record: RecordData;
      }
    | {
...
class FieldData$Type extends MessageType<FieldData> {
  ...
  internalBinaryWrite(message: FieldData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.isSecret !== false) writer.tag(52, WireType.Varint).bool(message.isSecret);
    /* bool is_output = 60; */
    if (message.isOutput !== false) writer.tag(60, WireType.Varint).bool(message.isOutput);
    /* bool is_option = 61; */
    if (message.isOption !== false) writer.tag(61, WireType.Varint).bool(message.isOption);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class SomeNodeData$Type extends MessageType<SomeNodeData> {
  constructor() {
    super("symbolx.bench.SomeNodeData", [
      ...
      { no: 5, name: "bucket_object", kind: "message", oneof: "node", T: () => BucketObjectData },
      { no: 6, name: "package", kind: "message", oneof: "node", T: () => PackageData },
      { no: 7, name: "worker", kind: "message", oneof: "node", T: () => WorkerData },
      { no: 8, name: "run", kind: "message", oneof: "node", T: () => RunData },
      ...
      { no: 12, name: "worker_set", kind: "message", oneof: "node", T: () => WorkerSetData },
      ...
      { no: 21, name: "client", kind: "message", oneof: "node", T: () => ClientData },
      { no: 22, name: "record", kind: "message", oneof: "node", T: () => RecordData },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* symbolx.bench.NotificationData notification */ 4:
          ...
          break;
        case /* symbolx.bench.BucketObjectData bucket_object */ 5:
          message.node = {
            oneofKind: "bucketObject",
          ...
          break;
        case /* symbolx.bench.PackageData package */ 6:
          message.node = {
            oneofKind: "package",
        ...
        case /* symbolx.bench.WorkerData worker */ 7:
          ...
          break;
        case /* symbolx.bench.RunData run */ 8:
          message.node = {
            oneofKind: "run",
        ...
        case /* symbolx.bench.OrganizationData organization */ 11:
          ...
          break;
        case /* symbolx.bench.WorkerSetData worker_set */ 12:
          message.node = {
            oneofKind: "workerSet",
  ...
  internalBinaryWrite(message: SomeNodeData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    /* symbolx.bench.BucketObjectData bucket_object = 5; */
    ...
    /* symbolx.bench.PackageData package = 6; */
    ...
    /* symbolx.bench.RunData run = 8; */
    if (message.node.oneofKind === "run")
      RunData.internalBinaryWrite(message.node.run, writer.tag(8, WireType.LengthDelimited).fork(), options).join();
    ...
    /* symbolx.bench.WorkerSetData worker_set = 12; */
    ...
    /* symbolx.bench.ClientData client = 21; */
    ...
    /* symbolx.bench.RecordData record = 22; */
