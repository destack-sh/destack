...
assert_job_has_tier1_lanes "build-artifacts" "${tier1_file}" "${needs_file}" "${missing_file}"
assert_job_has_tier1_lanes "build-cli-binaries" "${tier1_file}" "${needs_file}" "${missing_file}"
