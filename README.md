...
The architecture of Destack is optimized for "do-it-yourself software" over "ready-to-wear software", as a sort of meta-framework for developing and maintaining correct, optimal, integrated software stacks.
